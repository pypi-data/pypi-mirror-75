...
def to_get_lyrics(files, a, s, t):
    """Welcome to lyric_scraper :)
       ...
       1. lyric: it will prompt to enter song details, Lyrics wll be printed on standard output.

       2. lyric [FILES] : it will take files as argument, and will get lyrics from metadata.

       THANKS. Happy Coding :)

       Source Code at https://github.com/prakhar1965/lyric-scrapper.
