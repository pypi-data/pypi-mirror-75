...
C -> h | ^"""]
    ...
    def test_construct_table(self):
        # self.assertCountEqual({0: {'id': 's1', '(': 's4', '*': '', '+': '', ')': '', '$': '', 'F': 5, 'E': 2, 'T': 3},
        #                       1: {'id': '', '(': '', '*': 'r7', '+': 'r7', ')': 'r7', '$': 'r7', 'F': '', 'E': '',
        #                           'T': ''},
        #                       2: {'id': '', '(': '', '*': '', '+': 's6', ')': '', '$': 'acc', 'F': '', 'E': '',
        #                           'T': ''},
        #                       3: {'id': '', '(': '', '*': 's7', '+': 'r3', ')': 'r3', '$': 'r3', 'F': '', 'E': '',
        #                           'T': ''},
        #                       4: {'id': 's1', '(': 's4', '*': '', '+': '', ')': '', '$': '', 'F': 5, 'E': 8, 'T': 3},
        #                       5: {'id': '', '(': '', '*': 'r5', '+': 'r5', ')': 'r5', '$': 'r5', 'F': '', 'E': '',
        #                           'T': ''},
        #                       6: {'id': 's1', '(': 's4', '*': '', '+': '', ')': '', '$': '', 'F': 5, 'E': '', 'T': 9},
        #                       7: {'id': 's1', '(': 's4', '*': '', '+': '', ')': '', '$': '', 'F': 10, 'E': '', 'T': ''},
        #                       8: {'id': '', '(': '', '*': '', '+': 's6', ')': 's11', '$': '', 'F': '', 'E': '',
        #                           'T': ''},
        #                       9: {'id': '', '(': '', '*': 's7', '+': 'r2', ')': 'r2', '$': 'r2', 'F': '', 'E': '',
        #                           'T': ''},
        #                       10: {'id': '', '(': '', '*': 'r4', '+': 'r4', ')': 'r4', '$': 'r4', 'F': '', 'E': '',
        #                            'T': ''},
        #                       11: {'id': '', '(': '', '*': 'r6', '+': 'r6', ')': 'r6', '$': 'r6', 'F': '', 'E': '',
        #                            'T': ''}}, self.slr_parser.construct_table())
        None
