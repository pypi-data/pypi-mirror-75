...
class WebhookCreateRequest(Model):
    ...
    :param mailing_list: The list of recipients to be notified when a webhook
     fails <span class='property-internal'>Required</span> <span
    ...
    _validation = {
        ...
        'webhook_description': {'required': True},
    ...
    def __init__(self, webhook_name, webhook_description, webhook_event_type_id, mailing_list, url, secret):
        super(WebhookCreateRequest, self).__init__()
