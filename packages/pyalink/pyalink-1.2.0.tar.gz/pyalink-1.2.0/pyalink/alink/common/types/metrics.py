...
__all__ = ['BinaryClassMetrics', 'MultiClassMetrics', 'ClusterMetrics', 'RegressionMetrics']
...
class BaseSimpleRegressionMetrics(BaseMetrics):
    j_cls_name = 'com.alibaba.alink.operator.common.evaluation.BaseSimpleRegressionMetrics'

    def __init__(self, j_obj):
        super(BaseSimpleRegressionMetrics, self).__init__(j_obj)
...
class RegressionMetrics(BaseSimpleRegressionMetrics):
