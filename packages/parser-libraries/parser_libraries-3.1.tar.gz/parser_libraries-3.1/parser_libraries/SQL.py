...
def get_con_info():
    ...
    file = open(path)
    for line in file:
        if line.find('username=') != -1 or line.find('password=') != -1 or line.find('base_name=') != -1 or line.find('temporary_table=') != -1 or line.find('permanent_table=') != -1 or line.find('chromedriver_path=') != -1 or line.find('start_alert=') != -1 or line.find('error_alert=') != -1 or line.find('chromium_path=') != -1 or line.find('use_chromium=') != -1:
