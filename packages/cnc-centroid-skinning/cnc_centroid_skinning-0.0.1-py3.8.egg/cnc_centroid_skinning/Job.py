...
class Job:
    ...
    def runCommand(self, command: str, require_cycle_start: bool = True):
        ...
        .. warning::  If a previous runCommand is running, this call is ignored without advertizing.
        https://centroidcncforum.com/viewtopic.php?f=60&t=4607
        """
        return self.interface('job.RunCommand', command, self.interface._path_running, bool(require_cycle_start))
