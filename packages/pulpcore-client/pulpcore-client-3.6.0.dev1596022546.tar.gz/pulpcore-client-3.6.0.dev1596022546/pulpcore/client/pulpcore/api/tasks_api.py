...
class TasksApi(object):
    ...
    def list(self, **kwargs):  # noqa: E501
        ...
        :param async_req bool: execute request asynchronously
        :param str child_tasks: child_tasks
        :param str created_resources: created_resources
        :param str finished_at: finished_at
        :param str finished_at__gt: finished_at__gt
        :param str finished_at__gte: finished_at__gte
        :param str finished_at__lt: finished_at__lt
        :param str finished_at__lte: finished_at__lte
        :param str finished_at__range: finished_at__range
        :param int limit: Number of results to return per page.
        :param str name: name
        :param str name__contains: name__contains
        :param int offset: The initial index from which to return the results.
        :param str ordering: Which field to use when ordering the results.
        :param str parent_task: parent_task
        :param str reserved_resources_record: reserved_resources_record
        :param str started_at: started_at
        :param str started_at__gt: started_at__gt
        :param str started_at__gte: started_at__gte
        :param str started_at__lt: started_at__lt
        :param str started_at__lte: started_at__lte
        :param str started_at__range: started_at__range
        :param str state: state
        :param str state__in: state__in
        :param str task_group: task_group
        :param str worker: worker
        :param str worker__in: worker__in
    ...
    def partial_update(self, task_href, patched_task_cancel, **kwargs):  # noqa: E501
        """Cancel a task  # noqa: E501

        This operation cancels a task.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.partial_update(task_href, patched_task_cancel, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.partial_update_with_http_info(task_href, patched_task_cancel, **kwargs)  # noqa: E501

    def partial_update_with_http_info(self, task_href, patched_task_cancel, **kwargs):  # noqa: E501
        """Cancel a task  # noqa: E501

        This operation cancels a task.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.partial_update_with_http_info(task_href, patched_task_cancel, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('task_href' not in local_var_params or  # noqa: E501
                                                        local_var_params['task_href'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `task_href` when calling `partial_update`")  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('patched_task_cancel' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `patched_task_cancel` when calling `partial_update`")  # noqa: E501
