...
class WorkersApi(object):
    ...
    def list(self, **kwargs):  # noqa: E501
        ...
        :param str last_heartbeat: last_heartbeat
        :param str last_heartbeat__gt: last_heartbeat__gt
        :param str last_heartbeat__gte: last_heartbeat__gte
        :param str last_heartbeat__lt: last_heartbeat__lt
        :param str last_heartbeat__lte: last_heartbeat__lte
        :param str last_heartbeat__range: last_heartbeat__range
        :param int limit: Number of results to return per page.
        :param str missing: missing
        :param str name: name
        :param str name__in: name__in
        :param int offset: The initial index from which to return the results.
        :param str online: online
    ...
    def read(self, worker_href, **kwargs):  # noqa: E501
        ...
        :param async_req bool: execute request asynchronously
        :param str worker_href: (required)
        :param str fields: A list of fields to include in the response.
        :param str exclude_fields: A list of fields to exclude from the response.
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
    ...
    def read_with_http_info(self, worker_href, **kwargs):  # noqa: E501
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(WorkerResponse, status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='WorkerResponse',  # noqa: E501
            auth_settings=auth_settings,
            async_req=local_var_params.get('async_req'),
            _return_http_data_only=local_var_params.get('_return_http_data_only'),  # noqa: E501
            _preload_content=local_var_params.get('_preload_content', True),
