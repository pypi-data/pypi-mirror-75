...
from cral.models.object_detection.YoloV3.base import yolo_head
...
class Yolo_Loss(LossFunctionWrapper):
    """docstring for Yolo_loss"""
    # input_shape, candidate_anchors, grid_shape, num_classes, ignore_thresh=.5
    def __init__(self, **kwargs):
        super(Yolo_Loss, self).__init__(fn=customized_yolo_loss, name='yolo_loss', **kwargs)
        # self.arg = arg
...
def customized_yolo_loss(y_true, y_pred, input_shape, candidate_anchors, grid_shape, num_classes, ignore_thresh=.5):
    ...
    grid, raw_pred, pred_xy, pred_wh = yolo_head(y_pred,
         candidate_anchors, num_classes, input_shape, calc_loss=True)
