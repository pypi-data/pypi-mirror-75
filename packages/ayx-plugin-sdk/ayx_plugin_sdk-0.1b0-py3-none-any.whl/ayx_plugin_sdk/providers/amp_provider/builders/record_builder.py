...
from ayx_plugin_sdk.providers.amp_provider.builders.packers import (
    _BlobPacker,
    _BoolFalsePacker,
    _BoolPacker,
    _BoolTruePacker,
...
class RecordBuilder:
    """Utilities for conerting records between protobuf and core format objects."""
    ...
    _field_type_to_packer: Dict[Any, _Packer] = {
        ...
        AMPFieldType.UINT8: _IntegerPacker(),
        AMPFieldType.INT16: _IntegerPacker(),
        ...
        AMPFieldType.DATE: _UnsignedIntegerPacker(),
        AMPFieldType.DATETIME: _StringPacker(),
        AMPFieldType.TIME: _UnsignedIntegerPacker(),
