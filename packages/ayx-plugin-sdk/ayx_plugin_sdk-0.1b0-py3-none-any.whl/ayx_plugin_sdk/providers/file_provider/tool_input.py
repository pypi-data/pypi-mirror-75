...
class ToolInput(BaseModel):
    ...
    ----------
    tool
        A ToolDefinition object with two inputs, path and plugin, that contain the path
    ...
    inputs
     ...
     outputs
        A list of AnchorDefinition objects with three inputs, anchor_name, records, and metadata, that specify the anchor
