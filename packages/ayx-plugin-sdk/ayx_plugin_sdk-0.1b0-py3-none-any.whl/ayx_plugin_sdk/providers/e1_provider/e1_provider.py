...
from ayx_plugin_sdk.providers.e1_provider.e1_output_anchor import E1OutputAnchor

if TYPE_CHECKING:
    from ayx_plugin_sdk.providers.e1_provider.config.workflow_config import (
