...
def roiPlot(inifile):
    ...
    for i in filesFound:
        ...
        mySpaceScale, myRadius, myResolution, myFontScale = 40, 20, 1500, 1
            ...
            if ret == True:
                ...
                for rectangle in range(noRectangles):
                    ...
                    for bodyparts in range(len(trackedBodyParts)):
                        ...
                        cv2.putText(borderImage, str(rectangleEntries[rectangle][bodyparts]), ((int(borderImageWidth-(borderImageWidth/10))), (height - (height + 10) + spacingScale*addSpacer)), cv2.FONT_HERSHEY_TRIPLEX, textScale, RectangleColors[rectangle], 2)
                        addSpacer += 1
                ...
                for circle in range(noCircles):
                    ...
                    for bodyparts in range(len(trackedBodyParts)):
                        ...
                        cv2.putText(borderImage, str(circleEntries[circle][bodyparts]), ((int(borderImageWidth-(borderImageWidth/10))), (height - (height + 10) + spacingScale*addSpacer)), cv2.FONT_HERSHEY_TRIPLEX, textScale, CircleColors[circle], 2)
                        addSpacer += 1
                ...
                for polygon in range(noPolygons):
                    ...
                    for bodyparts in range(len(trackedBodyParts)):
                        ...
                        cv2.putText(borderImage, str(polyGonEntries[polygon][bodyparts]), ((int(borderImageWidth-(borderImageWidth/10))), (height - (height + 10) + spacingScale*addSpacer)), cv2.FONT_HERSHEY_TRIPLEX, textScale, polygonColor[polygon], 2)
                        addSpacer += 1
