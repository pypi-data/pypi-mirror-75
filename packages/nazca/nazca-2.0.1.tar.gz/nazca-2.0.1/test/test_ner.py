        ...
        self.assertEqual(
            ...
            [
                ...
                (
                    ...
                    None,
                    Token(
                        word="me", start=26, end=28, sentence=Sentence(indice=0, start=0, end=38)
                    ),
                ),
                (
                    "http://example.com/me",
        ...
        self.assertEqual(
            ...
            [
                (
                    ...
                    None,
                    Token(
                        word="Toto", start=6, end=10, sentence=Sentence(indice=0, start=0, end=34)
                    ),
                )
            ],
        )
        ...
        self.assertEqual(
            ...
            [
                ...
                (
                    ...
                    None,
                    Token(
                        word="me", start=22, end=24, sentence=Sentence(indice=0, start=0, end=34)
                    ),
                ),
                (
                    "http://example.com/me",
                    None,
                    Token(
                        word="me", start=39, end=41, sentence=Sentence(indice=1, start=35, end=42)
                    ),
                ),
            ],
        )
        ...
        self.assertEqual(
            ...
            [
                ...
                (
                    ...
                    None,
                    Token(
                        word="me", start=29, end=31, sentence=Sentence(indice=0, start=0, end=41)
                    ),
                ),
                (
                    "http://example.com/me",
                    None,
                    Token(
                        word="me", start=46, end=48, sentence=Sentence(indice=1, start=42, end=49)
                    ),
                ),
            ],
        )
