...
class ValidXHTMLPrettyPrintTest(unittest.TestCase):
    def test_valid(self):
        ...
        self.assertTrue(ValidXHTMLPrettyPrint().is_valid("<p>coucou</p>"))
    ...
    def test_valid_unicode(self):
        ...
        if int(etree.__version__ < "3.2.0"):
            # https://bugs.launchpad.net/lxml/+bug/673205
            self.skipTest("Lxml version to old for ValidXHTMLPrettyPrint")
        self.assertTrue(ValidXHTMLPrettyPrint().is_valid("<p>hé</p>"))
    ...
    def test_invalid(self):
        ...
        if int(etree.__version__ < "3.2.0"):
            # https://bugs.launchpad.net/lxml/+bug/673205
            self.skipTest("Lxml version to old for ValidXHTMLPrettyPrint")
        self.assertFalse(ValidXHTMLPrettyPrint().is_valid("<p><div>coucou</div></p>"))
    ...
    def test_prettyprint(self):
        ...
        self.assertEqual(
            html,
            (
                'Hello <a href="http://example.com/everyone">everyone</a>, '
                'this is   <a href="http://example.com/me">me</a> speaking. '
                'And <a href="http://example.com/me">me</a>.'
            ),
        )
    ...
    def test_prettyprint_class(self):
        ...
        self.assertEqual(
            html,
            (
                'Hello <a href="http://example.com/everyone" class="ner">everyone</a>, '
                'this is   <a href="http://example.com/me" class="ner">me</a> speaking. '
                'And <a href="http://example.com/me" class="ner">me</a>.'
            ),
        )
...
class DataIOTestCase(unittest.TestCase):
    def test_parser(self):
        data = parsefile(path.join(TESTDIR, "data", "file2parse"), [0, (2, 3), 4, 1], delimiter=",")
        self.assertEqual(
            [
                [1, (12, 19), "apple", "house"],
        ...
        data = parsefile(
            path.join(TESTDIR, "data", "file2parse"),
            [0, (2, 3), 4, 1],
            delimiter=",",
            formatopt={2: str},
        )
    ...
    def test_autocast(self):
        ...
        self.assertEqual(autocast("1."), 1.0)
        self.assertEqual(autocast("1,"), 1.0)
        self.assertEqual(autocast("1,2"), 1.2)
        self.assertEqual(autocast("1,2X"), "1,2X")
        self.assertEqual(autocast("tété"), "tété")
        self.assertEqual(autocast("tété", encoding="utf-8"), "tété")
        ...
        self.assertEqual(
            ...
            [
                [
                    ...
                    "http://dbpedia.org/resource/Guido_van_Rossum",
                ],
                [
