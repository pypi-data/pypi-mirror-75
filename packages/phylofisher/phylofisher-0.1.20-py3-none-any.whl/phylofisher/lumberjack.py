...
from phylofisher import help_formatter, build_dataset
...
if __name__ == '__main__':
    ...
    optional.add_argument('--to_exclude', type=str, metavar='to_exclude.txt',
                          help=textwrap.dedent("""\
                          Path to .txt file containing taxa, by Unique ID, to exclude from 
    ...
    in_help = 'Path to forest output directory to use for dataset addition.'
