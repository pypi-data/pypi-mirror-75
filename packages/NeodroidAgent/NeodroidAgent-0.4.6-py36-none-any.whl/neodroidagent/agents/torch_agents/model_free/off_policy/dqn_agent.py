...
from neodroidagent.common import (Architecture, DuelingQMLP, Memory, TransitionPoint, TransitionPointPrioritisedBuffer)
...
"""
    ...
    self.value_model: Module = self._value_arch_spec().to(self._device)
    self._target_value_model: Module = (
