...
class MultiHeadAttention(nn.Module):
    ...
    def forward(self, query, key=None, value=None, mask=None):
        ...
        assert mask is not None, f"Mask is {mask}, please specify a mask"
        ...
        attn_weights = self.attn_dropout(F.softmax(dot_prod / scale, dim="T_key")) #TODO: use log_softmax? Check dim maybe it should be 1
