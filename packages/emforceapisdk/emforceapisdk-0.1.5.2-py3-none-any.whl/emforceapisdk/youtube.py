...
class Youtube:
    ...
    def channel_detail(self, channel_id):
        ...
        if check_data:
            ...
            return_data["country"] = check_data['snippet']['country'],
            ...
            return_data["topicIds"] = check_data['topicDetails']['topicIds'],
            return_data["topicCategories"] = check_data['topicDetails']['topicCategories'],
