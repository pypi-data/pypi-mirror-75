...
from wommit.autocomplete import WommitCompleter, get_prompt_info, IssueCompleter
...
class Questioneer:
    ...
    def autocomp(self):
        ...
        prompttext, style = get_prompt_info() # Give better name for prompt_stuff. E.g compose_info, compose_prompt
    ...
    def questions(self) -> list:
        ...
        issuecomp = IssueCompleter(ApiHandler())
