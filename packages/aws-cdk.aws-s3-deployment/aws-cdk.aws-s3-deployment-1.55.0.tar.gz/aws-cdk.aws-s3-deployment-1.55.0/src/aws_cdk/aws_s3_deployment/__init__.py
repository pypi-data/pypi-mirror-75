...
class BucketDeployment(
    ...
    def __init__(
        ...
        *,
        ...
        destination_key_prefix: typing.Optional[str] = None,
        distribution: typing.Optional[aws_cdk.aws_cloudfront.IDistribution] = None,
        distribution_paths: typing.Optional[typing.List[str]] = None,
        expires: typing.Optional["Expires"] = None,
        memory_limit: typing.Optional[jsii.Number] = None,
        metadata: typing.Optional["UserDefinedObjectMetadata"] = None,
        prune: typing.Optional[bool] = None,
        retain_on_delete: typing.Optional[bool] = None,
        role: typing.Optional[aws_cdk.aws_iam.IRole] = None,
        server_side_encryption: typing.Optional["ServerSideEncryption"] = None,
        server_side_encryption_aws_kms_key_id: typing.Optional[str] = None,
        server_side_encryption_customer_algorithm: typing.Optional[str] = None,
...
class BucketDeploymentProps:
    ...
    @builtins.property
    def prune(self) -> typing.Optional[bool]:
...
class CacheControl(
    metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-s3-deployment.CacheControl"
):
...
class ISource(jsii.compat.Protocol):
    ...
    def bind(
        self, scope: aws_cdk.core.Construct, *, handler_role: aws_cdk.aws_iam.IRole
    ) -> "SourceConfig":
...
class SourceConfig:
    def __init__(self, *, bucket: aws_cdk.aws_s3.IBucket, zip_object_key: str) -> None:
        """
