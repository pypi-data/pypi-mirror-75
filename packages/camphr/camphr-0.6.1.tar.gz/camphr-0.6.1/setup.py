...
['catalogue>=1.0.0,<2.0.0',
 ...
 'toolz>=0.10.0,<0.11.0',
 'torch>=1.0,<2.0',
 'transformers>=2.10,<3.0',
 'typing-extensions>=3.7.4']

extras_require = \
{'all': ['allennlp>=1.0.0,<2.0.0',
         'unofficial-udify>=0.2.1,<0.3.0',
         'mojimoji>=0.0.11,<0.0.12',
         'unofficial-pyknp',
         'mecab-python3>=1.0,<1.1'],
 'allennlp': ['allennlp>=1.0.0,<2.0.0', 'boto3>=1.14,<2.0'],
 'juman': ['mojimoji>=0.0.11,<0.0.12', 'unofficial-pyknp'],
 'mecab': ['mecab-python3>=1.0,<1.1'],
 'udify': ['allennlp>=1.0.0,<2.0.0',
           'boto3>=1.14,<2.0',
           'unofficial-udify>=0.2.1,<0.3.0']}
