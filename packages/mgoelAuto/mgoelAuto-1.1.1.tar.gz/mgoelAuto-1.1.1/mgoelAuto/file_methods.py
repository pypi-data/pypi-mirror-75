...
from mgoelAuto.appLogger import AppLogger
import pathlib
HERE = pathlib.Path(__file__).parent
fileOperationLogs = HERE/"logs"/"fileOperationLogs.txt"
...
class FileOperation:
    ...
    def __init__(self):
        #self.file_object = open('pneuro/logs/fileOperationLogs.txt', 'a+')
        self.file_object = open(fileOperationLogs, 'a+')
