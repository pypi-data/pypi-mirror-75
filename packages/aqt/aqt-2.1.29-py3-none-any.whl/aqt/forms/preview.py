...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.fill_empty = QtWidgets.QCheckBox(self.preview_box)
        self.fill_empty.setText("FILL_EMPTY")
        self.fill_empty.setObjectName("fill_empty")
        self.horizontalLayout.addWidget(self.fill_empty)
