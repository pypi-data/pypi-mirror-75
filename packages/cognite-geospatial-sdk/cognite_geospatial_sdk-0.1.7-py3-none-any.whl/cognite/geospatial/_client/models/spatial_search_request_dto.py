...
class SpatialSearchRequestDTO(object):
    ...
    def limit(self, limit):
        ...
        :type limit: int
        """
        if self.local_vars_configuration.client_side_validation and limit is not None and limit > 1000:  # noqa: E501
            raise ValueError("Invalid value for `limit`, must be a value less than or equal to `1000`")  # noqa: E501
        if self.local_vars_configuration.client_side_validation and limit is not None and limit < 1:  # noqa: E501
    ...
    def external_id_prefix(self, external_id_prefix):
        ...
        if (
            ...
            and external_id_prefix is not None
            and len(external_id_prefix) > 255
        ):
            raise ValueError(
                "Invalid value for `external_id_prefix`, length must be less than or equal to `255`"
            )  # noqa: E501
