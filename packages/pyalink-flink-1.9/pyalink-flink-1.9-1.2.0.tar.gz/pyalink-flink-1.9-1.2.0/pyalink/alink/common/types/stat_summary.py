...
class BaseSummary(JavaObjectWrapperWithAutoTypeConversion):
    j_cls_name = 'com.alibaba.alink.operator.common.statistics.basicstatistic.BaseSummary'
...
class TableSummary(BaseSummary):
    j_cls_name = 'com.alibaba.alink.operator.common.statistics.basicstatistic.TableSummary'
...
class BaseVectorSummary(BaseSummary):
    j_cls_name = 'com.alibaba.alink.operator.common.statistics.basicstatistic.BaseVectorSummary'
...
class SparseVectorSummary(BaseVectorSummary):
    j_cls_name = 'com.alibaba.alink.operator.common.statistics.basicstatistic.SparseVectorSummary'
...
class DenseVectorSummary(BaseVectorSummary):
    j_cls_name = 'com.alibaba.alink.operator.common.statistics.basicstatistic.DenseVectorSummary'
...
class CorrelationResult(JavaObjectWrapperWithAutoTypeConversion):
    j_cls_name = 'com.alibaba.alink.operator.common.statistics.basicstatistic.CorrelationResult'
...
class ChiSquareTestResult(JavaObjectWrapperWithAutoTypeConversion):
    j_cls_name = 'com.alibaba.alink.operator.common.statistics.ChiSquareTestResult'
