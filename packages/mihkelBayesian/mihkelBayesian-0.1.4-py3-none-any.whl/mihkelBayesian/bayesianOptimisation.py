...
def runRosenbrock(a,b, iteratsiooni, boundaries=np.array([[-100.0, 100.0],[-100.0,100.0]])):
    ...
    no_startingPoints=n_iterations/5
    #Number of evaluation before applying restricted boundries
    tavalist=n_iterations/5*2
    suurem=5000
