...
def play(maze, func):
    ...
    brick = pygame.image.load('magame/icons/brick.png')
    brick = pygame.transform.scale(brick, (50, 50))
    dot = pygame.image.load('magame/icons/dot.png')
    ...
    while run:
        ...
        if not win:
            ...
            if x_change == 0 and y_change == -1:
                pac = pygame.image.load('magame/icons/pacman_up.png')
            elif x_change == 0 and y_change == 1:
                pac = pygame.image.load('magame/icons/pacman_down.png')
            elif x_change == 1 and y_change == 0:
                pac = pygame.image.load('magame/icons/pacman_right.png')
            else:
                pac = pygame.image.load('magame/icons/pacman_left.png')
