...
setup(
    ...
    url='https://github.com/jingxu85/theta-etl',
    ...
    entry_points={
        'console_scripts': [
            'thetaetl=thetaetl.cli:cli',
        ],
    },
    project_urls={
        'Bug Reports': 'https://github.com/jingxu85/theta-etl/issues',
        'Source': 'https://github.com/jingxu85/theta-etl',
    },
)
