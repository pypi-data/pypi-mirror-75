...
class Binomial(Distribution):
    ...
    def calculate_stdev(self):
        ...
        p,n=self.prob,self.size
        self.stdev=math.sqrt(p*n*(1-p))       
        return self.stdev
    ...
    def replace_stats_with_data(self):
        ...
        self.prob=sum(self.data)/len(self.data)
    ...
    def pdf(self, k):
        ...
        a=math.factorial(self.size)/(math.factorial(self.size-k)*math.factorial(k))
    ...
    def __add__(self, other):
        ...
        binom=Binomial()
        binom.size=self.size+other.size
        binom.prob=self.prob
        binom.calculate_mean()
        binom.calculate_stdev()
        return binom
    ...
    def __repr__(self):
        ...
        print('mean {}, standard deviation {}, p {}, n {}'.format(self.mean,self.stdev,self.prob,self.size))
