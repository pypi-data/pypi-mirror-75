...
class ContentAdvisoriesApi(object):
    ...
    def list(self, **kwargs):  # noqa: E501
        ...
        :param str severity__in: severity__in
        :param str severity__ne: severity__ne
        :param str status: status
        :param str status__in: status__in
        :param str status__ne: status__ne
        :param str type: type
        :param str type__in: type__in
        :param str type__ne: type__ne
    ...
    def read(self, update_record_href, **kwargs):  # noqa: E501
        ...
        :param async_req bool: execute request asynchronously
        :param str update_record_href: (required)
        :param str fields: A list of fields to include in the response.
        :param str exclude_fields: A list of fields to exclude from the response.
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
