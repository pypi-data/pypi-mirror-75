...
class RpmRpmRepositoryResponse(object):
    ...
    def __init__(self, pulp_href=None, pulp_created=None, versions_href=None, latest_version_href=None, name=None, description=None, metadata_signing_service=None, retain_package_versions=None, local_vars_configuration=None):  # noqa: E501
