...
class RepositoriesRpmApi(object):
    ...
    def delete(self, rpm_repository_href, **kwargs):  # noqa: E501
        ...
        :param async_req bool: execute request asynchronously
        :param str rpm_repository_href: (required)
        :param str name: name
    ...
    def modify(self, rpm_repository_href, repository_add_remove_content, **kwargs):  # noqa: E501
        """Modify Repository Content  # noqa: E501

        Trigger an asynchronous task to create a new repository version.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.modify(rpm_repository_href, repository_add_remove_content, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.modify_with_http_info(rpm_repository_href, repository_add_remove_content, **kwargs)  # noqa: E501

    def modify_with_http_info(self, rpm_repository_href, repository_add_remove_content, **kwargs):  # noqa: E501
        """Modify Repository Content  # noqa: E501

        Trigger an asynchronous task to create a new repository version.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.modify_with_http_info(rpm_repository_href, repository_add_remove_content, async_req=True)
        >>> result = thread.get()
    ...
    def partial_update(self, rpm_repository_href, patchedrpm_rpm_repository, **kwargs):  # noqa: E501
        """partial_update  # noqa: E501

        Trigger an asynchronous partial update task  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.partial_update(rpm_repository_href, patchedrpm_rpm_repository, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.partial_update_with_http_info(rpm_repository_href, patchedrpm_rpm_repository, **kwargs)  # noqa: E501

    def partial_update_with_http_info(self, rpm_repository_href, patchedrpm_rpm_repository, **kwargs):  # noqa: E501
        """partial_update  # noqa: E501

        Trigger an asynchronous partial update task  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.partial_update_with_http_info(rpm_repository_href, patchedrpm_rpm_repository, async_req=True)
        >>> result = thread.get()
    ...
    def sync(self, rpm_repository_href, rpm_repository_sync_url, **kwargs):  # noqa: E501
        """Sync from remote  # noqa: E501

        Trigger an asynchronous task to sync RPM content.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.sync(rpm_repository_href, rpm_repository_sync_url, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.sync_with_http_info(rpm_repository_href, rpm_repository_sync_url, **kwargs)  # noqa: E501

    def sync_with_http_info(self, rpm_repository_href, rpm_repository_sync_url, **kwargs):  # noqa: E501
        """Sync from remote  # noqa: E501

        Trigger an asynchronous task to sync RPM content.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.sync_with_http_info(rpm_repository_href, rpm_repository_sync_url, async_req=True)
        >>> result = thread.get()
    ...
    def update(self, rpm_repository_href, rpm_rpm_repository, **kwargs):  # noqa: E501
        """update  # noqa: E501

        Trigger an asynchronous update task  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update(rpm_repository_href, rpm_rpm_repository, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.update_with_http_info(rpm_repository_href, rpm_rpm_repository, **kwargs)  # noqa: E501

    def update_with_http_info(self, rpm_repository_href, rpm_rpm_repository, **kwargs):  # noqa: E501
        """update  # noqa: E501

        Trigger an asynchronous update task  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_with_http_info(rpm_repository_href, rpm_rpm_repository, async_req=True)
        >>> result = thread.get()
