...
class ContentPackagesApi(object):
    ...
    def list(self, **kwargs):  # noqa: E501
        ...
        :param async_req bool: execute request asynchronously
        :param str arch: arch
        :param str arch__in: arch__in
        :param str arch__ne: arch__ne
        :param str checksum_type: checksum_type
        :param str checksum_type__in: checksum_type__in
        :param str checksum_type__ne: checksum_type__ne
        :param str epoch: epoch
        :param str epoch__in: epoch__in
        :param str epoch__ne: epoch__ne
        :param int limit: Number of results to return per page.
        :param str name: name
        :param str name__in: name__in
        :param str name__ne: name__ne
        :param int offset: The initial index from which to return the results.
        :param str ordering: Which field to use when ordering the results.
        :param str pkg_id: pkgId
        :param str pkg_id__in: pkgId__in
        :param str release: release
        :param str release__in: release__in
        :param str release__ne: release__ne
        ...
        :param str version__in: version__in
        :param str version__ne: version__ne
    ...
    def read(self, package_href, **kwargs):  # noqa: E501
        ...
        :param async_req bool: execute request asynchronously
        :param str package_href: (required)
        :param str fields: A list of fields to include in the response.
        :param str exclude_fields: A list of fields to exclude from the response.
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
