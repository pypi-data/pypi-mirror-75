...
PARAMS: Dict[str, OrgParams] = {
    "launch-darkly": {
        ...
        "aws_saml_url": "https://launchdarkly.okta.com/home/amazon_aws/0oaj4aow7gPk26Fy6356/272",
        "aws_okta_params": {
            "mfa_provider": "OKTA",
    ...
    "sym": {
        ...
        "domain": "symops.io",
        "aws_okta_params": {},
        "saml2aws_params": {"mfa": "Auto"},
        "profiles": {
            "chris": Profile(
                display_name="Chris",
                region="us-east-1",
                arn="arn:aws:iam::185243338273:role/SSMDemo",
                aws_saml_url="https://dev-291131.okta.com/home/amazon_aws/0oaizjxdwPw8eoNCm4x6/272",
            ),
            "jon": Profile(
                display_name="Jon",
                region="us-east-1",
                arn="arn:aws:iam::838419636750:role/JonSSMDemo",
                aws_saml_url="https://dev-291131.okta.com/home/amazon_aws/0oakt491rxntIE1bx4x6/272",
            ),
        },
    },
}
