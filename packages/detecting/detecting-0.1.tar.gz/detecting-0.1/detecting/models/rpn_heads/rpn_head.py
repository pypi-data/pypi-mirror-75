...
class RPNHead(tf.keras.Model):
    ...
    # rpn层loss定义
    def loss(self, rpn_class_logits, rpn_deltas, gt_boxes, gt_class_ids, img_metas, anchors, valid_flags):
        '''Calculate rpn loss
        '''
    ...
    def get_proposals(self, 
        ...
        # 取出anchor的某个概率值（2个中的1的，哪个都可以），用来表示anchor正样本的概率
        ...
        # 返回proposals数据，计算proposals时不会进行梯度计算
