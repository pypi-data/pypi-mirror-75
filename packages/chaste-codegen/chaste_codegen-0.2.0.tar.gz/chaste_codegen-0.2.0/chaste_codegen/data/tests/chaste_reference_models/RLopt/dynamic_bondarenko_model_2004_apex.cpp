...
#include "dynamic_bondarenko_model_2004_apex.hpp"
#include <cmath>
#include <cassert>
#include <memory>
...
#include "MathsCustomFunctions.hpp"
    ...
    boost::shared_ptr<RegularStimulus> Dynamicbondarenko_model_2004_apexFromCellMLRushLarsenOpt::UseCellMLDefaultStimulus()
    {
    ...
    Dynamicbondarenko_model_2004_apexFromCellMLRushLarsenOpt::Dynamicbondarenko_model_2004_apexFromCellMLRushLarsenOpt(boost::shared_ptr<AbstractIvpOdeSolver> /* unused; should be empty */, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
                ...
                pIntracellularStimulus)
    {
        ...
        //
        this->mpSystemInfo = OdeSystemInformation<Dynamicbondarenko_model_2004_apexFromCellMLRushLarsenOpt>::Instance();
        Init();
    ...
    Dynamicbondarenko_model_2004_apexFromCellMLRushLarsenOpt::~Dynamicbondarenko_model_2004_apexFromCellMLRushLarsenOpt()
    {
    }
    
    double Dynamicbondarenko_model_2004_apexFromCellMLRushLarsenOpt::GetIIonic(const std::vector<double>* pStateVariables)
    {
    ...
    void Dynamicbondarenko_model_2004_apexFromCellMLRushLarsenOpt::EvaluateEquations(double var_chaste_interface__environment__time, std::vector<double> &rDY, std::vector<double> &rAlphaOrTau, std::vector<double> &rBetaOrInf)
    {
    ...
    void Dynamicbondarenko_model_2004_apexFromCellMLRushLarsenOpt::ComputeOneStepExceptVoltage(const std::vector<double> &rDY, const std::vector<double> &rAlphaOrTau, const std::vector<double> &rBetaOrInf)
    {
        std::vector<double>& rY = rGetStateVariables();
    ...
    std::vector<double> Dynamicbondarenko_model_2004_apexFromCellMLRushLarsenOpt::ComputeDerivedQuantities(double var_chaste_interface__environment__time, const std::vector<double> & rY)
    {
        // Inputs:
        // Time units: millisecond
...
template<>
void OdeSystemInformation<Dynamicbondarenko_model_2004_apexFromCellMLRushLarsenOpt>::Initialise(void)
{
...
extern "C"
{
    ...
    {
        return new Dynamicbondarenko_model_2004_apexFromCellMLRushLarsenOpt(pSolver, pStimulus);
    }
