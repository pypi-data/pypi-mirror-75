#ifndef DYNAMICVISWANATHAN_MODEL_1999_EPIFROMCELLMLGRL2OPT_HPP_
#define DYNAMICVISWANATHAN_MODEL_1999_EPIFROMCELLMLGRL2OPT_HPP_
...
public:
    ...
    Dynamicviswanathan_model_1999_epiFromCellMLGRL2Opt(boost::shared_ptr<AbstractIvpOdeSolver> /* unused; should be empty */, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus);
    ~Dynamicviswanathan_model_1999_epiFromCellMLGRL2Opt();
...
namespace boost
{
    namespace serialization
    {
        ...
        inline void save_construct_data(
            Archive & ar, const Dynamicviswanathan_model_1999_epiFromCellMLGRL2Opt * t, const unsigned int fileVersion)
        {
        ...
        inline void load_construct_data(
            Archive & ar, Dynamicviswanathan_model_1999_epiFromCellMLGRL2Opt * t, const unsigned int fileVersion)
        {
            boost::shared_ptr<AbstractIvpOdeSolver> p_solver;
            boost::shared_ptr<AbstractStimulusFunction> p_stimulus;
            ar >> p_solver;
            ar >> p_stimulus;
            ::new(t)Dynamicviswanathan_model_1999_epiFromCellMLGRL2Opt(p_solver, p_stimulus);
        }
...
#endif // DYNAMICVISWANATHAN_MODEL_1999_EPIFROMCELLMLGRL2OPT_HPP_