#ifndef DYNAMICDEMIR_MODEL_1994FROMCELLMLGRL1_HPP_
#define DYNAMICDEMIR_MODEL_1994FROMCELLMLGRL1_HPP_
...
class Dynamicdemir_model_1994FromCellMLGRL1 : public AbstractGeneralizedRushLarsenCardiacCell, public AbstractDynamicallyLoadableEntity
{
...
CHASTE_CLASS_EXPORT(Dynamicdemir_model_1994FromCellMLGRL1)
...
namespace boost
{
    namespace serialization
    {
        ...
        inline void save_construct_data(
            Archive & ar, const Dynamicdemir_model_1994FromCellMLGRL1 * t, const unsigned int fileVersion)
        {
        ...
        inline void load_construct_data(
            Archive & ar, Dynamicdemir_model_1994FromCellMLGRL1 * t, const unsigned int fileVersion)
        {
            boost::shared_ptr<AbstractIvpOdeSolver> p_solver;
            boost::shared_ptr<AbstractStimulusFunction> p_stimulus;
            ar >> p_solver;
            ar >> p_stimulus;
            ::new(t)Dynamicdemir_model_1994FromCellMLGRL1(p_solver, p_stimulus);
        }
...
#endif // DYNAMICDEMIR_MODEL_1994FROMCELLMLGRL1_HPP_