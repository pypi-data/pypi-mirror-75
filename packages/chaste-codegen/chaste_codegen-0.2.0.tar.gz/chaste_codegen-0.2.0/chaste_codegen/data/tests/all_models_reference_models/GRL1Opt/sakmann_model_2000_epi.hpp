#ifndef CELLSAKMANN_MODEL_2000_EPIFROMCELLMLGRL1OPT_HPP_
#define CELLSAKMANN_MODEL_2000_EPIFROMCELLMLGRL1OPT_HPP_
...
class Cellsakmann_model_2000_epiFromCellMLGRL1Opt : public AbstractGeneralizedRushLarsenCardiacCell
{
...
public:
    ...
    Cellsakmann_model_2000_epiFromCellMLGRL1Opt(boost::shared_ptr<AbstractIvpOdeSolver> /* unused; should be empty */, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus);
    ~Cellsakmann_model_2000_epiFromCellMLGRL1Opt();
...
namespace boost
{
    namespace serialization
    {
        ...
        inline void save_construct_data(
            Archive & ar, const Cellsakmann_model_2000_epiFromCellMLGRL1Opt * t, const unsigned int fileVersion)
        {
        ...
        inline void load_construct_data(
            Archive & ar, Cellsakmann_model_2000_epiFromCellMLGRL1Opt * t, const unsigned int fileVersion)
        {
            boost::shared_ptr<AbstractIvpOdeSolver> p_solver;
            boost::shared_ptr<AbstractStimulusFunction> p_stimulus;
            ar >> p_solver;
            ar >> p_stimulus;
            ::new(t)Cellsakmann_model_2000_epiFromCellMLGRL1Opt(p_solver, p_stimulus);
        }
...
#endif // CELLSAKMANN_MODEL_2000_EPIFROMCELLMLGRL1OPT_HPP_