...
#include "MathsCustomFunctions.hpp"
    ...
    Celliyer_model_2007FromCellMLCvodeDataClamp::Celliyer_model_2007FromCellMLCvodeDataClamp(boost::shared_ptr<AbstractIvpOdeSolver> pOdeSolver /* unused; should be empty */, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
                ...
                pIntracellularStimulus)
    {
        ...
        //
        this->mpSystemInfo = OdeSystemInformation<Celliyer_model_2007FromCellMLCvodeDataClamp>::Instance();
        Init();
        
        NV_Ith_S(this->mParameters, 0) = 0.0; // (var_membrane_data_clamp_current_conductance) [dimensionless]
    }

    Celliyer_model_2007FromCellMLCvodeDataClamp::~Celliyer_model_2007FromCellMLCvodeDataClamp()
    {
    }
    
    double Celliyer_model_2007FromCellMLCvodeDataClamp::GetIIonic(const std::vector<double>* pStateVariables)
    {
    ...
    void Celliyer_model_2007FromCellMLCvodeDataClamp::EvaluateYDerivatives(double var_chaste_interface__environment__time, const N_Vector rY, N_Vector rDY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : NV_Ith_S(rY, 0));
        ...
        else
        {
            ...
            if (mDataClampIsOn)
            {
                var_chaste_interface__membrane_data_clamp_current = (-GetExperimentalVoltageAtTimeT(var_chaste_interface__environment__time) + var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V) * NV_Ith_S(mParameters, 0); // uA_per_cm2
            }
            d_dt_chaste_interface_var_COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V = -var_COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__i_tot - var_chaste_interface__membrane_data_clamp_current; // mV / ms
        }
    ...
    N_Vector Celliyer_model_2007FromCellMLCvodeDataClamp::ComputeDerivedQuantities(double var_chaste_interface__environment__time, const N_Vector & rY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : NV_Ith_S(rY, 0));
        ...
        NV_Ith_S(dqs, 2) = var_I_stimulus__i_Stim_converted;
        return dqs;
    }

template<>
void OdeSystemInformation<Celliyer_model_2007FromCellMLCvodeDataClamp>::Initialise(void)
{
