#ifndef CELLPANDIT_MODEL_2001_EPIFROMCELLMLGRL2OPT_HPP_
#define CELLPANDIT_MODEL_2001_EPIFROMCELLMLGRL2OPT_HPP_
...
class Cellpandit_model_2001_epiFromCellMLGRL2Opt : public AbstractGeneralizedRushLarsenCardiacCell
{
...
public:
    ...
    Cellpandit_model_2001_epiFromCellMLGRL2Opt(boost::shared_ptr<AbstractIvpOdeSolver> /* unused; should be empty */, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus);
    ~Cellpandit_model_2001_epiFromCellMLGRL2Opt();
...
namespace boost
{
    namespace serialization
    {
        ...
        inline void save_construct_data(
            Archive & ar, const Cellpandit_model_2001_epiFromCellMLGRL2Opt * t, const unsigned int fileVersion)
        {
        ...
        inline void load_construct_data(
            Archive & ar, Cellpandit_model_2001_epiFromCellMLGRL2Opt * t, const unsigned int fileVersion)
        {
            boost::shared_ptr<AbstractIvpOdeSolver> p_solver;
            boost::shared_ptr<AbstractStimulusFunction> p_stimulus;
            ar >> p_solver;
            ar >> p_stimulus;
            ::new(t)Cellpandit_model_2001_epiFromCellMLGRL2Opt(p_solver, p_stimulus);
        }
...
#endif // CELLPANDIT_MODEL_2001_EPIFROMCELLMLGRL2OPT_HPP_