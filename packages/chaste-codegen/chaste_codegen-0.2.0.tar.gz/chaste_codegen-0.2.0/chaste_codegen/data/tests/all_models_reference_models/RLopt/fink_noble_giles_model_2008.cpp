...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellfink_noble_giles_model_2008FromCellMLRushLarsenOpt::EvaluateEquations(double var_chaste_interface__Environment__time, std::vector<double> &rDY, std::vector<double> &rAlphaOrTau, std::vector<double> &rBetaOrInf)
    {
        ...
        const double var_iCaL_d_gate__d_inf = 1 / (1.0 + exp(0.66666666666666663 - 0.13333333333333333 * var_chaste_interface__cell__V)); // dimensionless
        const double var_iCaL_d_gate__tau_d = 1 / (1.0 + exp(2.5 - 0.050000000000000003 * var_chaste_interface__cell__V)) + 1.3999999999999999 * (0.25 + 1.3999999999999999 / (1.0 + exp(-2.6923076923076925 - 0.076923076923076927 * var_chaste_interface__cell__V))) / (1.0 + exp(1.0 + 0.20000000000000001 * var_chaste_interface__cell__V)); // millisecond
        ...
        const double d_dt_chaste_interface_var_iKr_Markov__Cr1 = var_chaste_interface__iKr_Markov__Cr2 * exp(-2.0190000000000001 - 0.060299999999999999 * var_chaste_interface__cell__V) - 1.0 * var_chaste_interface__iKr_Markov__Cr1 * exp(-1.5790000000000006 + 0.0112 * var_chaste_interface__cell__V); // 1 / millisecond
        const double d_dt_chaste_interface_var_iKr_Markov__Cr2 = -(exp(-3.1680000000000028) + exp(-2.0190000000000001 - 0.060299999999999999 * var_chaste_interface__cell__V)) * var_chaste_interface__iKr_Markov__Cr2 + var_chaste_interface__iKr_Markov__Cr1 * exp(-1.5790000000000006 + 0.0112 * var_chaste_interface__cell__V) + var_chaste_interface__iKr_Markov__Cr3 * exp(-2.5140000000000011); // 1 / millisecond
        const double d_dt_chaste_interface_var_iKr_Markov__Cr3 = -(exp(-2.5140000000000011) + exp(-3.8160000000000025 + 0.036499999999999998 * var_chaste_interface__cell__V)) * var_chaste_interface__iKr_Markov__Cr3 + var_chaste_interface__iKr_Markov__Cr2 * exp(-3.1680000000000028) + var_chaste_interface__iKr_Markov__Or4 * exp(-8.3940000000000019 - 0.039899999999999998 * var_chaste_interface__cell__V); // 1 / millisecond
        const double d_dt_chaste_interface_var_iKr_Markov__Ir5 = var_chaste_interface__iKr_Markov__Or4 * exp(-0.87200000000000344 + 0.0223 * var_chaste_interface__cell__V) - 1.0 * var_chaste_interface__iKr_Markov__Ir5 * exp(-3.1820000000000022 - 0.031199999999999999 * var_chaste_interface__cell__V); // 1 / millisecond
        const double d_dt_chaste_interface_var_iKr_Markov_Sotalol_block__BCr1 = var_chaste_interface__iKr_Markov_Sotalol_block__BCr2 * exp(-2.0190000000000001 - 0.060299999999999999 * var_chaste_interface__cell__V) - 1.0 * var_chaste_interface__iKr_Markov_Sotalol_block__BCr1 * exp(-1.5790000000000006 + 0.0112 * var_chaste_interface__cell__V); // 1 / millisecond
        const double d_dt_chaste_interface_var_iKr_Markov_Sotalol_block__BCr2 = -(exp(-3.1680000000000028) + exp(-2.0190000000000001 - 0.060299999999999999 * var_chaste_interface__cell__V)) * var_chaste_interface__iKr_Markov_Sotalol_block__BCr2 + var_chaste_interface__iKr_Markov_Sotalol_block__BCr1 * exp(-1.5790000000000006 + 0.0112 * var_chaste_interface__cell__V) + var_chaste_interface__iKr_Markov_Sotalol_block__BCr3 * exp(-2.5140000000000011); // 1 / millisecond
        const double d_dt_chaste_interface_var_iKr_Markov_Sotalol_block__BCr3 = -(exp(-2.5140000000000011) + exp(-3.8160000000000025 + 0.036499999999999998 * var_chaste_interface__cell__V)) * var_chaste_interface__iKr_Markov_Sotalol_block__BCr3 + var_chaste_interface__iKr_Markov_Sotalol_block__BCr2 * exp(-3.1680000000000028) + var_chaste_interface__iKr_Markov_Sotalol_block__BOr4 * exp(-8.3940000000000019 - 0.039899999999999998 * var_chaste_interface__cell__V); // 1 / millisecond
        const double d_dt_chaste_interface_var_iKr_Markov_Sotalol_block__BIr5 = var_chaste_interface__iKr_Markov_Sotalol_block__BOr4 * exp(-0.87200000000000344 + 0.0223 * var_chaste_interface__cell__V) - 1.0 * var_chaste_interface__iKr_Markov_Sotalol_block__BIr5 * exp(-3.1820000000000022 - 0.031199999999999999 * var_chaste_interface__cell__V); // 1 / millisecond
        const double d_dt_chaste_interface_var_iKr_Markov__Or4 = 0.00125 * var_chaste_interface__iKr_Markov_Sotalol_block__BOr4 - (exp(-0.87200000000000344 + 0.0223 * var_chaste_interface__cell__V) + exp(-8.3940000000000019 - 0.039899999999999998 * var_chaste_interface__cell__V)) * var_chaste_interface__iKr_Markov__Or4 + var_chaste_interface__iKr_Markov__Cr3 * exp(-3.8160000000000025 + 0.036499999999999998 * var_chaste_interface__cell__V) + var_chaste_interface__iKr_Markov__Ir5 * exp(-3.1820000000000022 - 0.031199999999999999 * var_chaste_interface__cell__V); // 1 / millisecond
        const double d_dt_chaste_interface_var_iKr_Markov_Sotalol_block__BOr4 = -0.00125 * var_chaste_interface__iKr_Markov_Sotalol_block__BOr4 - (exp(-0.87200000000000344 + 0.0223 * var_chaste_interface__cell__V) + exp(-8.3940000000000019 - 0.039899999999999998 * var_chaste_interface__cell__V)) * var_chaste_interface__iKr_Markov_Sotalol_block__BOr4 + var_chaste_interface__iKr_Markov_Sotalol_block__BCr3 * exp(-3.8160000000000025 + 0.036499999999999998 * var_chaste_interface__cell__V) + var_chaste_interface__iKr_Markov_Sotalol_block__BIr5 * exp(-3.1820000000000022 - 0.031199999999999999 * var_chaste_interface__cell__V); // 1 / millisecond
        ...
        const double var_iNa_h_gate__h_inf = 1 / pow((1.0 + exp(9.6298788694481825 + 0.13458950201884254 * var_chaste_interface__cell__V)), 2); // dimensionless
        const double var_iNa_h_gate__tau_h = 1 / (((var_chaste_interface__cell__V < -40.0) ? (0.057000000000000002 * exp(-11.764705882352942 - 0.14705882352941177 * var_chaste_interface__cell__V)) : (0)) + ((var_chaste_interface__cell__V < -40.0) ? (310000.0 * exp(0.34849999999999998 * var_chaste_interface__cell__V) + 2.7000000000000002 * exp(0.079000000000000001 * var_chaste_interface__cell__V)) : (5.9230769230769234 / (1.0 + exp(-0.96036036036036043 - 0.0900900900900901 * var_chaste_interface__cell__V))))); // millisecond
        const double var_iNa_j_gate__j_inf = 1 / pow((1.0 + exp(9.6298788694481825 + 0.13458950201884254 * var_chaste_interface__cell__V)), 2); // dimensionless
        const double var_iNa_j_gate__tau_j = 1 / (((var_chaste_interface__cell__V < -40.0) ? (0.024240000000000001 * exp(-0.01052 * var_chaste_interface__cell__V) / (1.0 + exp(-5.5312920000000005 - 0.13780000000000001 * var_chaste_interface__cell__V))) : (0.59999999999999998 * exp(0.057000000000000002 * var_chaste_interface__cell__V) / (1.0 + exp(-3.2000000000000002 - 0.10000000000000001 * var_chaste_interface__cell__V)))) + ((var_chaste_interface__cell__V < -40.0) ? ((37.780000000000001 + var_chaste_interface__cell__V) * (-25428.0 * exp(0.24440000000000001 * var_chaste_interface__cell__V) - 6.9480000000000002e-6 * exp(-0.043909999999999998 * var_chaste_interface__cell__V)) / (1.0 + exp(24.640530000000002 + 0.311 * var_chaste_interface__cell__V))) : (0))); // millisecond
        ...
        const double var_iNa_m_gate__tau_m = (0.10000000000000001 / (1.0 + exp(7.0 + 0.20000000000000001 * var_chaste_interface__cell__V)) + 0.10000000000000001 / (1.0 + exp(-0.25 + 0.0050000000000000001 * var_chaste_interface__cell__V))) / (1.0 + exp(-12.0 - 0.20000000000000001 * var_chaste_interface__cell__V)); // millisecond
