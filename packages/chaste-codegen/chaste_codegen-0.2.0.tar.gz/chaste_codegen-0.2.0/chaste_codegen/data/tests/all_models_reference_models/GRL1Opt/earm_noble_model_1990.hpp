#ifndef CELLEARM_NOBLE_MODEL_1990FROMCELLMLGRL1OPT_HPP_
#define CELLEARM_NOBLE_MODEL_1990FROMCELLMLGRL1OPT_HPP_
...
class Cellearm_noble_model_1990FromCellMLGRL1Opt : public AbstractGeneralizedRushLarsenCardiacCell
{
...
public:
    ...
    Cellearm_noble_model_1990FromCellMLGRL1Opt(boost::shared_ptr<AbstractIvpOdeSolver> /* unused; should be empty */, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus);
    ~Cellearm_noble_model_1990FromCellMLGRL1Opt();
...
namespace boost
{
    namespace serialization
    {
        ...
        inline void save_construct_data(
            Archive & ar, const Cellearm_noble_model_1990FromCellMLGRL1Opt * t, const unsigned int fileVersion)
        {
        ...
        inline void load_construct_data(
            Archive & ar, Cellearm_noble_model_1990FromCellMLGRL1Opt * t, const unsigned int fileVersion)
        {
            boost::shared_ptr<AbstractIvpOdeSolver> p_solver;
            boost::shared_ptr<AbstractStimulusFunction> p_stimulus;
            ar >> p_solver;
            ar >> p_stimulus;
            ::new(t)Cellearm_noble_model_1990FromCellMLGRL1Opt(p_solver, p_stimulus);
        }
...
#endif // CELLEARM_NOBLE_MODEL_1990FROMCELLMLGRL1OPT_HPP_