...
#include "MathsCustomFunctions.hpp"
    ...
    boost::shared_ptr<RegularStimulus> Cellluo_rudy_1994FromCellMLCvodeDataClamp::UseCellMLDefaultStimulus()
    {
    ...
    double Cellluo_rudy_1994FromCellMLCvodeDataClamp::GetIntracellularCalciumConcentration()
    {
        return NV_Ith_S(mStateVariables, 1);
    }
    
    Cellluo_rudy_1994FromCellMLCvodeDataClamp::Cellluo_rudy_1994FromCellMLCvodeDataClamp(boost::shared_ptr<AbstractIvpOdeSolver> pOdeSolver /* unused; should be empty */, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
                ...
                pIntracellularStimulus)
    {
        ...
        //
        this->mpSystemInfo = OdeSystemInformation<Cellluo_rudy_1994FromCellMLCvodeDataClamp>::Instance();
        Init();
    ...
    Cellluo_rudy_1994FromCellMLCvodeDataClamp::~Cellluo_rudy_1994FromCellMLCvodeDataClamp()
    {
    }
    
    double Cellluo_rudy_1994FromCellMLCvodeDataClamp::GetIIonic(const std::vector<double>* pStateVariables)
    {
    ...
    void Cellluo_rudy_1994FromCellMLCvodeDataClamp::EvaluateYDerivatives(double var_chaste_interface__environment__time, const N_Vector rY, N_Vector rDY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : NV_Ith_S(rY, 0));
        ...
        else
        {
            ...
            const double var_membrane__dV_dt = (-var_L_type_Ca_channel__i_Ca_L - var_Na_Ca_exchanger__i_NaCa - var_calcium_background_current__i_Ca_b - var_fast_sodium_current__i_Na - var_chaste_interface__membrane_data_clamp_current - var_non_specific_calcium_activated_current__i_ns_Ca - var_plateau_potassium_current__i_Kp - var_sarcolemmal_calcium_pump__i_p_Ca - var_sodium_background_current__i_Na_b - var_sodium_potassium_pump__i_NaK - var_time_dependent_potassium_current__i_K - var_time_independent_potassium_current__i_K1 + var_membrane__I_st) / NV_Ith_S(mParameters, 3); // mV_per_ms
    ...
    N_Vector Cellluo_rudy_1994FromCellMLCvodeDataClamp::ComputeDerivedQuantities(double var_chaste_interface__environment__time, const N_Vector & rY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : NV_Ith_S(rY, 0));
...
template<>
void OdeSystemInformation<Cellluo_rudy_1994FromCellMLCvodeDataClamp>::Initialise(void)
{
...
CHASTE_CLASS_EXPORT(Cellluo_rudy_1994FromCellMLCvodeDataClamp)
