...
#include "CardiacNewtonSolver.hpp"
    ...
    boost::shared_ptr<RegularStimulus> CellFaberRudy2000FromCellMLBackwardEuler::UseCellMLDefaultStimulus()
    {
    ...
    void CellFaberRudy2000FromCellMLBackwardEuler::ComputeJacobian(double var_chaste_interface__environment__time_converted, const double rCurrentGuess[12], double rJacobian[12][12])
    {
        ...
        const double var_x6 = 0.037435883507802616 * var_chaste_interface__membrane__V;
        const double var_x7 = 1 / (1.0 + 0.1245 * exp(-0.003743588350780262 * var_chaste_interface__membrane__V) + 0.036499999999999998 * (-0.14285714285714285 + 0.14285714285714285 * exp(1.961367013372957)) * exp(-var_x6));
        const double var_x8 = 1 / (1.0 + exp(1.2521739130434781 - 0.16722408026755853 * var_chaste_interface__membrane__V));
        const double var_x9 = -26.712338705498265 * var_x3 + var_chaste_interface__membrane__V;
        const double var_x10 = 2299968.0 * var_chaste_interface__calcium_dynamics__Cai;
        const double var_x11 = pow(var_chaste_interface__ionic_concentrations__Nai, 3);
        const double var_x12 = exp(var_x6);
        const double var_x13 = 1.8 * var_x11 * var_x12;
        const double var_x14 = var_x13 - var_x10;
        const double var_x15 = exp(-0.031820500981632228 * var_chaste_interface__membrane__V);
        const double var_x16 = 1.0 + 0.0001 * var_x15 * (var_x10 + var_x13);
        const double var_x17 = var_x15 / var_x16;
        const double var_x18 = var_x14 * var_x17;
        const double var_x19 = exp(-14.1227775 + 0.23849999999999999 * var_chaste_interface__membrane__V - 6.3708927812613361 * var_x3);
        const double var_x20 = 1.0 + var_x19;
        const double var_x21 = 1 / var_x20;
        const double var_x22 = exp(-2.4444678999999998 + 13.738155796237757 * var_x3 - 0.51429999999999998 * var_chaste_interface__membrane__V);
        const double var_x23 = 1.0 + var_x22;
        const double var_x24 = 1 / var_x23;
        const double var_x25 = exp(0.43983232 + 0.080320000000000003 * var_chaste_interface__membrane__V - 2.1455350448256207 * var_x3);
        const double var_x26 = exp(-36.698642499999998 + 0.061749999999999999 * var_chaste_interface__membrane__V - 1.6494869150645177 * var_x3);
        const double var_x27 = var_x26 + 0.49124000000000001 * var_x25;
        const double var_x28 = var_x24 * var_x27;
        const double var_x29 = 1 / (1000.0 * var_x28 + 1020.0 * var_x21);
        const double var_x30 = var_x21 * var_x29;
        const double var_x31 = pow(var_chaste_interface__fast_sodium_current_m_gate__m, 3) * var_chaste_interface__fast_sodium_current_h_gate__h * var_chaste_interface__fast_sodium_current_j_gate__j;
        const double var_x32 = mParameters[0] * var_chaste_interface__rapid_delayed_rectifier_potassium_current_xr_gate__xr / (1.0 + exp(0.4017857142857143 + 0.044642857142857144 * var_chaste_interface__membrane__V));
        const double var_x33 = pow(var_chaste_interface__transient_outward_current_zdv_gate__zdv, 3) * mParameters[2] * var_chaste_interface__transient_outward_current_ydv_gate__ydv * exp(0.01 * var_chaste_interface__membrane__V);
        ...
        const double var_x38 = 0.018329999999999999 * var_chaste_interface__ionic_concentrations__Nai + var_chaste_interface__ionic_concentrations__Ki;
        const double var_x39 = mParameters[1] * var_chaste_interface__slow_delayed_rectifier_potassium_current_xs1_gate__xs1 * var_chaste_interface__slow_delayed_rectifier_potassium_current_xs2_gate__xs2;
        const double var_x40 = var_x39 * (-26.712338705498265 * log(6.9195599999999997 / var_x38) + var_chaste_interface__membrane__V);
        const double var_x41 = 0.75 * var_x12;
        const double var_x42 = -99.0 + var_x41 * var_chaste_interface__ionic_concentrations__Nai;
        const double var_x43 = 1 / (-1.0 + var_x12);
        const double var_x44 = var_chaste_interface__L_type_Ca_channel_d_gate__d * var_chaste_interface__L_type_Ca_channel_f_gate__f * var_chaste_interface__membrane__V;
        ...
        const double var_x47 = -3.375 + var_x41 * var_chaste_interface__ionic_concentrations__Ki;
        const double var_x48 = log(1.8 * var_x34);
        const double var_x49 = 0.00050000000000000001 + var_chaste_interface__calcium_dynamics__Cai;
        const double var_x50 = 1.1499999999999999 / var_x49;
        const double var_x51 = pow(var_chaste_interface__T_type_Ca_channel_b_gate__b, 2) * var_chaste_interface__T_type_Ca_channel_g_gate__g;
        const double var_x52 = exp(0.074871767015605231 * var_chaste_interface__membrane__V);
        const double var_x53 = 1 / (-1.0 + var_x52);
        const double var_x54 = var_x53 * (-0.61380000000000001 + var_x52 * var_chaste_interface__calcium_dynamics__Cai);
        const double var_x55 = 7.8019226357407252 * var_x45;
        const double var_x56 = -0.040282206767891383 * var_x48 + var_x50 * var_chaste_interface__calcium_dynamics__Cai + var_x54 * var_x55 + 0.050000000000000003 * var_x51 * (-13.356169352749133 * var_x48 + var_chaste_interface__membrane__V);
        const double var_x57 = (var_chaste_interface__calcium_dynamics__APtrack > 0.17999999999999999) && (var_chaste_interface__calcium_dynamics__APtrack < 0.20000000000000001);
        const double var_x58 = 1.0 - var_chaste_interface__calcium_dynamics__APtrack2;
        ...
        const double var_x62 = 60000.0 * var_x60 * var_x61;
        const double var_x63 = var_x58 * var_x62;
        ...
        const double var_x70 = var_x69 * (-var_chaste_interface__calcium_dynamics__Ca_JSR + var_chaste_interface__calcium_dynamics__Cai);
        const double var_x71 = var_chaste_interface__calcium_dynamics__OVRLDtrack2 > 0;
        const double var_x72 = ((var_x64) ? (var_x63 * var_chaste_interface__calcium_dynamics__APtrack2) : ((var_x71) ? (4000.0 * (1.0 - var_chaste_interface__calcium_dynamics__OVRLDtrack2) * var_chaste_interface__calcium_dynamics__OVRLDtrack2) : (0)));
        const double var_x73 = var_x72 * (-var_chaste_interface__calcium_dynamics__Cai + var_chaste_interface__calcium_dynamics__Ca_JSR);
        const double var_x74 = 60000.0 * var_x58 * var_chaste_interface__calcium_dynamics__APtrack2;
        const double var_x75 = ((var_x64) ? (var_x60 * var_x74 - var_x61 * var_x74 / pow(var_x59, 2)) : (0));
        const double var_x76 = ((var_x64) ? (0) : ((var_x71) ? (4000.0 - 8000.0 * var_chaste_interface__calcium_dynamics__OVRLDtrack2) : (0)));
        const double var_x77 = 0.00092000000000000003 + var_chaste_interface__calcium_dynamics__Cai;
        const double var_x78 = 1 / var_x77;
        const double var_x79 = var_chaste_interface__calcium_dynamics__Cai / pow(var_x77, 2);
        const double var_x80 = 0.0023800000000000002 + var_chaste_interface__calcium_dynamics__Cai;
        const double var_x81 = pow(var_x49, (-2));
        const double var_x82 = 1.0 + 0.00011900000000000002 / pow(var_x80, 2) + 3.5000000000000004e-5 * var_x81;
        const double var_x83 = 1 / var_x82;
        const double var_x84 = 0.001 * var_x83;
        const double var_x85 = var_x84 * (0.0070588235294117632 * var_chaste_interface__calcium_dynamics__Ca_JSR - 0.0070588235294117632 * var_chaste_interface__calcium_dynamics__Cai);
        const double var_x86 = 0.71029411764705874 * var_x78;
        const double var_x87 = var_x14 * pow(var_x15, 2) / pow(var_x16, 2);
        const double var_x88 = var_x44 / pow((0.00059999999999999995 + var_chaste_interface__calcium_dynamics__Cai), 2);
        const double var_x89 = var_x50 + 0.040282206767891383 * var_x34 + 0.6678084676374566 * var_x34 * var_x51 - 1.1499999999999999 * var_x81 * var_chaste_interface__calcium_dynamics__Cai - 0.0046811535814444347 * var_x54 * var_x88 + var_x52 * var_x53 * var_x55;
        const double var_x90 = 1 / M_PI;
        const double var_x91 = 0.090316078310111333 * var_x90;
        const double var_x92 = var_x12 * var_x4;
        const double var_x93 = var_x17 * var_x92;
        const double var_x94 = var_x87 * var_x92;
        const double var_x95 = var_chaste_interface__calcium_dynamics__APtrack > 0.20000000000000001;
        const double var_x96 = var_chaste_interface__calcium_dynamics__OVRLDtrack > 0.97999999999999998;
        const double var_x97 = var_x43 * var_x88;
        const double var_x98 = 0.00018063215662022267 * var_x90;
        const double var_x99 = var_x19 * var_x2 / pow(var_x20, 2);
        const double var_x100 = var_x39 * (-0.433 - 0.25979999999999998 * var_x37) * (0.14451785951707913 * var_chaste_interface__ionic_concentrations__Ki + 0.0026490123649480601 * var_chaste_interface__ionic_concentrations__Nai) / pow(var_x38, 2);
        const double var_x101 = var_x12 * var_x46;
        const double var_x102 = var_x7 / (var_x11 * pow((0.01 + var_x5), 2));
        
        
        rJacobian[0][0] = 1.0 - (mDt * (0.001 * (((var_x56 + 0.00025000000000000001 * var_x18 + 0.0070160275741043606 * var_chaste_interface__membrane__V - 0.10684935482199306 * var_x1 - 7.3656881518639831e-7 * var_x3 + GetIntracellularAreaStimulus(var_chaste_interface__environment__time_converted) / HeartConfig::Instance()->GetCapacitance() + 0.5 * var_x33 * var_x9 + 16.0 * var_x31 * (-26.712338705498265 * var_x1 + var_chaste_interface__membrane__V) + 1.6875 * var_x7 / (1.0 + 100.0 * var_x5) + 0.0055199999999999997 * var_x8 * var_x9 + 0.433 * var_x40 * (1.0 + 0.59999999999999998 * var_x37) + 0.0024381008236689767 * var_x42 * var_x46 + 0.00069711623550831479 * var_x46 * var_x47 + 698.34626081908675 * var_x30 * var_x9 + 0.023862446088641735 * var_x32 * var_x9) / mParameters[3] < -150000.0) ? (-100500.0) : (-500.0))));
        rJacobian[0][1] = 0.0;
        rJacobian[0][2] = 0.0;
        rJacobian[0][3] = 0.0;
        rJacobian[0][4] = 0.0;
        ...
        rJacobian[0][11] = 0.0;
        rJacobian[1][0] = 0.0;
        rJacobian[1][1] = 1.0 - (mDt * (0.001 * ((var_x57) ? (-100500.0) : (-500.0))));
        rJacobian[1][2] = 0.0;
        rJacobian[1][3] = 0.0;
        rJacobian[1][4] = 0.0;
        rJacobian[1][5] = 0.0;
        ...
        rJacobian[2][0] = 0.0;
        rJacobian[2][1] = 0.0;
        rJacobian[2][2] = 1.0 - (mDt * (0.001 * ((var_x57) ? (-100500.0) : (-10.0))));
        rJacobian[2][3] = 0.0;
        rJacobian[2][4] = 0.0;
        rJacobian[2][5] = 0.0;
        rJacobian[2][6] = 0.0;
        ...
        rJacobian[2][11] = 0.0;
        rJacobian[3][0] = 0.0;
        rJacobian[3][1] = -(mDt * (var_x65 * var_x70));
        rJacobian[3][2] = 0.0;
        rJacobian[3][3] = 1.0 - (mDt * (var_x69 * (-5.5555555555555554 - var_x72) + 0.00025000000000000001 * (-var_x73 + 5.5555555555555554 * var_chaste_interface__calcium_dynamics__Ca_NSR - 5.5555555555555554 * var_chaste_interface__calcium_dynamics__Ca_JSR) / (pow(var_x66, 3) * pow((0.125 + var_x67), 2))));
        rJacobian[3][4] = -(mDt * (0.0055555555555555558 * var_x68));
        rJacobian[3][5] = -(mDt * (var_x69 * var_x72));
        rJacobian[3][6] = -(mDt * (var_x70 * var_x75));
        rJacobian[3][7] = 0.0;
        rJacobian[3][8] = -(mDt * (var_x70 * var_x76));
        rJacobian[3][9] = 0.0;
        rJacobian[3][10] = 0.0;
        rJacobian[3][11] = 0.0;
        rJacobian[4][0] = 0.0;
        ...
        rJacobian[4][5] = -(mDt * (0.0087500000000000008 * var_x78 - 0.0087500000000000008 * var_x79));
        rJacobian[4][6] = 0.0;
        rJacobian[4][7] = 0.0;
        rJacobian[4][8] = 0.0;
        rJacobian[4][9] = 0.0;
        ...
        rJacobian[4][11] = 0.0;
        rJacobian[5][0] = 0.0;
        rJacobian[5][1] = -(mDt * (var_x65 * var_x85));
        rJacobian[5][2] = 0.0;
        rJacobian[5][3] = -(mDt * (7.0588235294117632e-6 * var_x72 * var_x83));
        rJacobian[5][4] = -(mDt * (4.7352941176470584e-5 * var_x83));
        rJacobian[5][5] = 1.0 - (mDt * (var_x84 * (-var_x86 + 0.71029411764705874 * var_x79 - 0.0070588235294117632 * var_x72 - var_x91 * (var_x89 + 1149.9839999999999 * var_x17 + 0.11499840000000001 * var_x87)) + 0.001 * (0.00023800000000000004 / pow(var_x80, 3) + 7.0000000000000007e-5 / pow(var_x49, 3)) * (0.047352941176470584 * var_chaste_interface__calcium_dynamics__Ca_NSR + 0.0070588235294117632 * var_x73 - var_x86 * var_chaste_interface__calcium_dynamics__Cai - var_x91 * (var_x56 + 0.003016 * var_chaste_interface__membrane__V - 0.00050000000000000001 * var_x18)) / pow(var_x82, 2)));
        rJacobian[5][6] = -(mDt * (var_x75 * var_x85));
        rJacobian[5][7] = 0.0;
        rJacobian[5][8] = -(mDt * (var_x76 * var_x85));
        rJacobian[5][9] = 0.0;
        rJacobian[5][10] = 0.0;
        rJacobian[5][11] = -(mDt * (-9.0316078310111333e-5 * var_x83 * var_x90 * (2.7000000000000001e-7 * var_x94 - 0.0027000000000000001 * var_x93)));
        rJacobian[6][0] = 0.0;
        rJacobian[6][1] = 0.0;
        rJacobian[6][2] = 0.0;
        rJacobian[6][3] = 0.0;
        rJacobian[6][4] = 0.0;
        rJacobian[6][5] = -(mDt * (0.001 * ((var_x95) ? (-var_x91 * (var_x89 + 574.99199999999996 * var_x17 + 0.057499200000000007 * var_x87)) : (0))));
        rJacobian[6][6] = 1.0 - (mDt * (0.001 * (((var_x95) || (var_chaste_interface__calcium_dynamics__APtrack2 > 0.01)) ? (0) : (-500.0))));
        rJacobian[6][7] = 0.0;
        rJacobian[6][8] = 0.0;
        rJacobian[6][9] = 0.0;
        rJacobian[6][10] = 0.0;
        rJacobian[6][11] = -(mDt * (0.001 * ((var_x95) ? (-var_x91 * (1.35e-7 * var_x94 - 0.0013500000000000001 * var_x93)) : (0))));
        rJacobian[7][0] = 0.0;
        rJacobian[7][1] = 0.0;
        rJacobian[7][2] = 0.0;
        rJacobian[7][3] = 0.0;
        ...
        rJacobian[8][6] = 0.0;
        rJacobian[8][7] = 0.0;
        rJacobian[8][8] = 1.0 - (mDt * (0.001 * (((var_x96) && (var_chaste_interface__calcium_dynamics__OVRLDtrack2 < 0.97999999999999998)) ? (-50000.0) : (-500.0))));
        rJacobian[8][9] = 0.0;
        rJacobian[8][10] = 0.0;
        rJacobian[8][11] = 0.0;
        rJacobian[9][0] = 0.0;
        ...
        rJacobian[9][7] = 0.0;
        rJacobian[9][8] = 0.0;
        rJacobian[9][9] = 1.0 - (mDt * (0.001 * (((var_x96) && (var_chaste_interface__calcium_dynamics__OVRLDtrack3 < 0.97999999999999998)) ? (-50000.0) : (-10.0))));
        rJacobian[9][10] = 0.0;
        rJacobian[9][11] = 0.0;
        rJacobian[10][0] = 0.0;
        rJacobian[10][1] = 0.0;
        ...
        rJacobian[10][3] = 0.0;
        rJacobian[10][4] = 0.0;
        rJacobian[10][5] = -(mDt * (var_x98 * (4.1826974130498884e-7 * var_x47 * var_x97 - 2.3575679435995052e-7 * var_x34 * var_x35 * var_x40 / pow(var_x36, 2))));
        rJacobian[10][6] = 0.0;
        rJacobian[10][7] = 0.0;
        rJacobian[10][8] = 0.0;
        rJacobian[10][9] = 0.0;
        rJacobian[10][10] = 1.0 - (mDt * (var_x98 * (184.83763041301756 * var_x100 - 0.00052283717663123607 * var_x101 - 7.3656881518639831e-7 * var_x2 - 18654.461852717679 * var_x2 * var_x30 - 0.63742174226149029 * var_x2 * var_x32 - 0.14745210965435041 * var_x2 * var_x8 - 13.356169352749133 * var_x2 * var_x33 + 4449.089151873166 * var_x29 * var_x9 * var_x99 - 0.00067122862439358594 * var_x21 * var_x9 * (6498.310636886562 * var_x99 - 1000.0 * var_x24 * (1.053972635420138 * var_x2 * var_x25 + 1.6494869150645177 * var_x2 * var_x26) - 13738.155796237757 * var_x2 * var_x22 * var_x27 / pow(var_x23, 2)) / pow((var_x21 + 0.98039215686274506 * var_x28), 2))));
        rJacobian[10][11] = -(mDt * (var_x98 * (3.3880737654706117 * var_x100 + 0.067500000000000004 * var_x102)));
        rJacobian[11][0] = 0.0;
        rJacobian[11][1] = 0.0;
        rJacobian[11][2] = 0.0;
        rJacobian[11][3] = 0.0;
        rJacobian[11][4] = 0.0;
        rJacobian[11][5] = -(mDt * (var_x98 * (0.1724976 * var_x87 + 1724.9760000000001 * var_x17 + 1.4628604942013857e-6 * var_x42 * var_x97)));
        rJacobian[11][6] = 0.0;
        rJacobian[11][7] = 0.0;
        rJacobian[11][8] = 0.0;
        rJacobian[11][9] = 0.0;
        rJacobian[11][10] = 0.0;
        rJacobian[11][11] = 1.0 - (mDt * (var_x98 * (4.0500000000000004e-7 * var_x94 - 0.0040499999999999998 * var_x93 - 0.10684935482199306 * var_x0 - 0.0018285756177517324 * var_x101 - 0.10125000000000001 * var_x102 - 427.39741928797224 * var_x0 * var_x31)));
    }
