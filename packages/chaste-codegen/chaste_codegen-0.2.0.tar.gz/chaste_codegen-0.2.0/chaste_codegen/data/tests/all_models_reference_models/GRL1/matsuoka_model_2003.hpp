#ifndef CELLMATSUOKA_MODEL_2003FROMCELLMLGRL1_HPP_
#define CELLMATSUOKA_MODEL_2003FROMCELLMLGRL1_HPP_
...
class Cellmatsuoka_model_2003FromCellMLGRL1 : public AbstractGeneralizedRushLarsenCardiacCell
{
...
public:
    ...
    Cellmatsuoka_model_2003FromCellMLGRL1(boost::shared_ptr<AbstractIvpOdeSolver> /* unused; should be empty */, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus);
    ~Cellmatsuoka_model_2003FromCellMLGRL1();
...
namespace boost
{
    namespace serialization
    {
        ...
        inline void save_construct_data(
            Archive & ar, const Cellmatsuoka_model_2003FromCellMLGRL1 * t, const unsigned int fileVersion)
        {
        ...
        inline void load_construct_data(
            Archive & ar, Cellmatsuoka_model_2003FromCellMLGRL1 * t, const unsigned int fileVersion)
        {
            boost::shared_ptr<AbstractIvpOdeSolver> p_solver;
            boost::shared_ptr<AbstractStimulusFunction> p_stimulus;
            ar >> p_solver;
            ar >> p_stimulus;
            ::new(t)Cellmatsuoka_model_2003FromCellMLGRL1(p_solver, p_stimulus);
        }
...
#endif // CELLMATSUOKA_MODEL_2003FROMCELLMLGRL1_HPP_