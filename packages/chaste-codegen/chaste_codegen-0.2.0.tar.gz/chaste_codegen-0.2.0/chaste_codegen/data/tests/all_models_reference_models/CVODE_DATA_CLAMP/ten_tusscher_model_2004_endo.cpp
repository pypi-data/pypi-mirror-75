...
#include "MathsCustomFunctions.hpp"
    ...
    Cellten_tusscher_model_2004_endoFromCellMLCvodeDataClamp::Cellten_tusscher_model_2004_endoFromCellMLCvodeDataClamp(boost::shared_ptr<AbstractIvpOdeSolver> pOdeSolver /* unused; should be empty */, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
                ...
                pIntracellularStimulus)
    {
        ...
        //
        this->mpSystemInfo = OdeSystemInformation<Cellten_tusscher_model_2004_endoFromCellMLCvodeDataClamp>::Instance();
        Init();
        ...
        NV_Ith_S(this->mParameters, 4) = 0.072999999999999995; // (var_transient_outward_current__g_to) [nanoS_per_picoF]
    }
    ...
    void Cellten_tusscher_model_2004_endoFromCellMLCvodeDataClamp::EvaluateYDerivatives(double var_chaste_interface__environment__time, const N_Vector rY, N_Vector rDY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : NV_Ith_S(rY, 0));
    ...
    N_Vector Cellten_tusscher_model_2004_endoFromCellMLCvodeDataClamp::ComputeDerivedQuantities(double var_chaste_interface__environment__time, const N_Vector & rY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : NV_Ith_S(rY, 0));
...
template<>
void OdeSystemInformation<Cellten_tusscher_model_2004_endoFromCellMLCvodeDataClamp>::Initialise(void)
{
