...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellten_tusscher_model_2004_endoFromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x227 = var_x226 * (-0.0082319999999999997 - var_x108);
        ...
        const double var_x234 = (0.0031224512033090025 * var_x12 - 0.00011688549744401942 * var_chaste_interface__membrane__V) * NV_Ith_S(mParameters, 2);
        const double var_x235 = 0.0031224512033090025 * var_x12 - 0.00011688549744401942 * var_chaste_interface__membrane__V;
        ...
        IJth(rJacobian, 11, 0) = -0.20000000000000001 * var_x216 * var_x219 / pow(var_x217, 2) - 0.001 * var_x218 * (-0.13400000000000001 - 0.002 * var_chaste_interface__membrane__V) * (-var_chaste_interface__transient_outward_current_s_gate__s + 1 / var_x217) / pow((0.0080000000000000002 + var_x218), 2);
        IJth(rJacobian, 12, 0) = 0.16666666666666666 * var_x220 * var_x223 / pow(var_x221, 2) - 0.10526315789473684 * var_x222 * (-0.044444444444444446 - 0.0011111111111111111 * var_chaste_interface__membrane__V) * (-var_chaste_interface__transient_outward_current_r_gate__r + 1 / var_x221) / pow((0.084210526315789472 + var_x222), 2);
        ...
        IJth(rJacobian, 16, 0) = 0.00026864670518789814 * var_x48 + 3.79059668210955e-6 * var_x39 - 2.8537261917770623e-7 * var_x30 - 0.00011688549744401942 * var_x27 - 6.3176611368492499e-5 * var_x25 - 1.7065282626826835e-6 * var_x3 - 2.8636946873784758e-5 * var_x0 - 0.00011688549744401942 * var_x33 - var_x233 * var_x41;
        ...
        IJth(rJacobian, 16, 16) = 0.00010126109252331096 * var_x93 - 0.0073440052301827737 * var_x85 - 0.0031224512033090025 * var_x92 - 0.0016876848753885161 * var_x88 - 4.5587787568311439e-5 * var_x87 - 0.0031224512033090025 * var_x89 - var_x233 * var_x91;
    }
