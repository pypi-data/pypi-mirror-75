#ifndef CELLTEN_TUSSCHER_MODEL_2006_EPIFROMCELLMLGRL1OPT_HPP_
#define CELLTEN_TUSSCHER_MODEL_2006_EPIFROMCELLMLGRL1OPT_HPP_
...
class Cellten_tusscher_model_2006_epiFromCellMLGRL1Opt : public AbstractGeneralizedRushLarsenCardiacCell
{
...
public:
    ...
    Cellten_tusscher_model_2006_epiFromCellMLGRL1Opt(boost::shared_ptr<AbstractIvpOdeSolver> /* unused; should be empty */, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus);
    ~Cellten_tusscher_model_2006_epiFromCellMLGRL1Opt();
...
namespace boost
{
    namespace serialization
    {
        ...
        inline void save_construct_data(
            Archive & ar, const Cellten_tusscher_model_2006_epiFromCellMLGRL1Opt * t, const unsigned int fileVersion)
        {
        ...
        inline void load_construct_data(
            Archive & ar, Cellten_tusscher_model_2006_epiFromCellMLGRL1Opt * t, const unsigned int fileVersion)
        {
            boost::shared_ptr<AbstractIvpOdeSolver> p_solver;
            boost::shared_ptr<AbstractStimulusFunction> p_stimulus;
            ar >> p_solver;
            ar >> p_stimulus;
            ::new(t)Cellten_tusscher_model_2006_epiFromCellMLGRL1Opt(p_solver, p_stimulus);
        }
...
#endif // CELLTEN_TUSSCHER_MODEL_2006_EPIFROMCELLMLGRL1OPT_HPP_