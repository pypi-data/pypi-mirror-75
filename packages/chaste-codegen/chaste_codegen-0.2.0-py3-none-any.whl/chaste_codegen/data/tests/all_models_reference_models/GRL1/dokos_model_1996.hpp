#ifndef CELLDOKOS_MODEL_1996FROMCELLMLGRL1_HPP_
#define CELLDOKOS_MODEL_1996FROMCELLMLGRL1_HPP_
...
class Celldokos_model_1996FromCellMLGRL1 : public AbstractGeneralizedRushLarsenCardiacCell
{
...
public:
    ...
    Celldokos_model_1996FromCellMLGRL1(boost::shared_ptr<AbstractIvpOdeSolver> /* unused; should be empty */, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus);
    ~Celldokos_model_1996FromCellMLGRL1();
...
namespace boost
{
    namespace serialization
    {
        ...
        inline void save_construct_data(
            Archive & ar, const Celldokos_model_1996FromCellMLGRL1 * t, const unsigned int fileVersion)
        {
        ...
        inline void load_construct_data(
            Archive & ar, Celldokos_model_1996FromCellMLGRL1 * t, const unsigned int fileVersion)
        {
            boost::shared_ptr<AbstractIvpOdeSolver> p_solver;
            boost::shared_ptr<AbstractStimulusFunction> p_stimulus;
            ar >> p_solver;
            ar >> p_stimulus;
            ::new(t)Celldokos_model_1996FromCellMLGRL1(p_solver, p_stimulus);
        }
...
#endif // CELLDOKOS_MODEL_1996FROMCELLMLGRL1_HPP_