#ifndef CELLEARM_NOBLE_MODEL_1990FROMCELLMLGRL2_HPP_
#define CELLEARM_NOBLE_MODEL_1990FROMCELLMLGRL2_HPP_
...
class Cellearm_noble_model_1990FromCellMLGRL2 : public AbstractGeneralizedRushLarsenCardiacCell
{
...
public:
    ...
    Cellearm_noble_model_1990FromCellMLGRL2(boost::shared_ptr<AbstractIvpOdeSolver> /* unused; should be empty */, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus);
    ~Cellearm_noble_model_1990FromCellMLGRL2();
...
namespace boost
{
    namespace serialization
    {
        ...
        inline void save_construct_data(
            Archive & ar, const Cellearm_noble_model_1990FromCellMLGRL2 * t, const unsigned int fileVersion)
        {
        ...
        inline void load_construct_data(
            Archive & ar, Cellearm_noble_model_1990FromCellMLGRL2 * t, const unsigned int fileVersion)
        {
            boost::shared_ptr<AbstractIvpOdeSolver> p_solver;
            boost::shared_ptr<AbstractStimulusFunction> p_stimulus;
            ar >> p_solver;
            ar >> p_stimulus;
            ::new(t)Cellearm_noble_model_1990FromCellMLGRL2(p_solver, p_stimulus);
        }
...
#endif // CELLEARM_NOBLE_MODEL_1990FROMCELLMLGRL2_HPP_