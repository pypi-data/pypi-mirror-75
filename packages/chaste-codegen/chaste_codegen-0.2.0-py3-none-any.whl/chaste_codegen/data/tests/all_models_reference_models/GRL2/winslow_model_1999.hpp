#ifndef CELLWINSLOW_MODEL_1999FROMCELLMLGRL2_HPP_
#define CELLWINSLOW_MODEL_1999FROMCELLMLGRL2_HPP_
...
class Cellwinslow_model_1999FromCellMLGRL2 : public AbstractGeneralizedRushLarsenCardiacCell
{
...
public:
    ...
    Cellwinslow_model_1999FromCellMLGRL2(boost::shared_ptr<AbstractIvpOdeSolver> /* unused; should be empty */, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus);
    ~Cellwinslow_model_1999FromCellMLGRL2();
...
CHASTE_CLASS_EXPORT(Cellwinslow_model_1999FromCellMLGRL2)
...
namespace boost
{
    namespace serialization
    {
        ...
        inline void save_construct_data(
            Archive & ar, const Cellwinslow_model_1999FromCellMLGRL2 * t, const unsigned int fileVersion)
        {
        ...
        inline void load_construct_data(
            Archive & ar, Cellwinslow_model_1999FromCellMLGRL2 * t, const unsigned int fileVersion)
        {
            boost::shared_ptr<AbstractIvpOdeSolver> p_solver;
            boost::shared_ptr<AbstractStimulusFunction> p_stimulus;
            ar >> p_solver;
            ar >> p_stimulus;
            ::new(t)Cellwinslow_model_1999FromCellMLGRL2(p_solver, p_stimulus);
        }
...
#endif // CELLWINSLOW_MODEL_1999FROMCELLMLGRL2_HPP_