#ifndef CELLASLANIDI_MODEL_2009FROMCELLMLGRL2_HPP_
#define CELLASLANIDI_MODEL_2009FROMCELLMLGRL2_HPP_
...
class Cellaslanidi_model_2009FromCellMLGRL2 : public AbstractGeneralizedRushLarsenCardiacCell
{
...
public:
    ...
    Cellaslanidi_model_2009FromCellMLGRL2(boost::shared_ptr<AbstractIvpOdeSolver> /* unused; should be empty */, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus);
    ~Cellaslanidi_model_2009FromCellMLGRL2();
...
namespace boost
{
    namespace serialization
    {
        ...
        inline void save_construct_data(
            Archive & ar, const Cellaslanidi_model_2009FromCellMLGRL2 * t, const unsigned int fileVersion)
        {
        ...
        inline void load_construct_data(
            Archive & ar, Cellaslanidi_model_2009FromCellMLGRL2 * t, const unsigned int fileVersion)
        {
            boost::shared_ptr<AbstractIvpOdeSolver> p_solver;
            boost::shared_ptr<AbstractStimulusFunction> p_stimulus;
            ar >> p_solver;
            ar >> p_stimulus;
            ::new(t)Cellaslanidi_model_2009FromCellMLGRL2(p_solver, p_stimulus);
        }
...
#endif // CELLASLANIDI_MODEL_2009FROMCELLMLGRL2_HPP_