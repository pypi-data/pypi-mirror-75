...
#include "MathsCustomFunctions.hpp"
    ...
    boost::shared_ptr<RegularStimulus> Cellnygren_atrial_model_1998FromCellMLOpt::UseCellMLDefaultStimulus()
    {
    ...
    double Cellnygren_atrial_model_1998FromCellMLOpt::GetIntracellularCalciumConcentration()
    {
        return mStateVariables[1];
    }
    Cellnygren_atrial_model_1998FromCellMLOpt::Cellnygren_atrial_model_1998FromCellMLOpt(boost::shared_ptr<AbstractIvpOdeSolver> pSolver, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
        : AbstractCardiacCell(
                pSolver,
                29,
                0,
                pIntracellularStimulus)
    {
        ...
        //
        this->mpSystemInfo = OdeSystemInformation<Cellnygren_atrial_model_1998FromCellMLOpt>::Instance();
        Init();
    ...
    Cellnygren_atrial_model_1998FromCellMLOpt::~Cellnygren_atrial_model_1998FromCellMLOpt()
    {
    }
    
    double Cellnygren_atrial_model_1998FromCellMLOpt::GetIIonic(const std::vector<double>* pStateVariables)
    {
    ...
    void Cellnygren_atrial_model_1998FromCellMLOpt::EvaluateYDerivatives(double var_chaste_interface__environment__time_converted, const std::vector<double>& rY, std::vector<double>& rDY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
    ...
    std::vector<double> Cellnygren_atrial_model_1998FromCellMLOpt::ComputeDerivedQuantities(double var_chaste_interface__environment__time_converted, const std::vector<double> & rY)
    {
        // Inputs:
        // Time units: millisecond
...
template<>
void OdeSystemInformation<Cellnygren_atrial_model_1998FromCellMLOpt>::Initialise(void)
{
...
CHASTE_CLASS_EXPORT(Cellnygren_atrial_model_1998FromCellMLOpt)
