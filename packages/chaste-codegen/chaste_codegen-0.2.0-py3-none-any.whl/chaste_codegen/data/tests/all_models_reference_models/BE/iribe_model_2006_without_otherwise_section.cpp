...
#include "CardiacNewtonSolver.hpp"
    ...
    void Celliribe_model_2006_without_otherwise_sectionFromCellMLBackwardEuler::ComputeJacobian(double var_chaste_interface__environment__time_converted, const double rCurrentGuess[15], double rJacobian[15][15])
    {
        ...
        const double var_x12 = exp(3.7433890822745473 - var_x11);
        const double var_x13 = exp(3.7433890822745473);
        const double var_x14 = (-50.0 + var_chaste_interface__membrane_potential__V) * mParameters[0] * var_chaste_interface__L_type_Ca_channel_d_gate__d * var_chaste_interface__L_type_Ca_channel_f_gate__f;
        const double var_x15 = var_x14 / (1.0 - var_x12);
        const double var_x16 = 0.03668521300629056 * var_x15;
        const double var_x17 = var_x16 * (-2.0 * var_x12 + var_x13 * var_chaste_interface__intracellular_calcium_concentration__Ca_i);
        const double var_x18 = -0.037433890822745473 * var_chaste_interface__membrane_potential__V;
        const double var_x19 = exp(1.8716945411372736 + var_x18);
        const double var_x20 = exp(1.8716945411372736);
        const double var_x21 = var_x14 / (1.0 - var_x19);
        const double var_x22 = 1.8342606503145281e-5 * var_x21;
        const double var_x23 = var_x22 * (-4.0 * var_x19 + var_x20 * var_chaste_interface__intracellular_potassium_concentration__K_i);
        const double var_x24 = 9.1713032515726407e-5 * var_x21;
        const double var_x25 = var_x24 * (-140.0 * var_x19 + var_x20 * var_chaste_interface__intracellular_sodium_concentration__Na_i);
        const double var_x26 = 61250.0 * var_chaste_interface__intracellular_calcium_concentration__Ca_i;
        const double var_x27 = var_x13 * var_x16;
        const double var_x28 = var_x20 * var_chaste_interface__RyR__F_1;
        ...
        const double var_x63 = 0.018716945411372737 * var_chaste_interface__membrane_potential__V;
        const double var_x64 = exp(-var_x63);
        const double var_x65 = mParameters[6] / (1.0 + 144.92753623188406 * var_chaste_interface__intracellular_calcium_concentration__Ca_i);
        const double var_x66 = var_x64 * var_x65;
        const double var_x67 = exp(var_x63);
        const double var_x68 = (2.0 * var_x67 * pow(var_chaste_interface__intracellular_sodium_concentration__Na_i, 3) - 2744000.0 * var_x64 * var_chaste_interface__intracellular_calcium_concentration__Ca_i) * mParameters[6] / pow((0.0068999999999999999 + var_chaste_interface__intracellular_calcium_concentration__Ca_i), 2);
        const double var_x69 = var_x65 * var_x67 * pow(var_chaste_interface__intracellular_sodium_concentration__Na_i, 2);
        ...
        const double var_x77 = exp(-0.74867781645490938 + var_x11 - 2.0 * var_x76);
        const double var_x78 = 1.0 + var_x77;
        const double var_x79 = var_x20 * var_x21;
        const double var_x80 = 1 / (1.0 + 0.035299999999999998 * exp(var_x18) + 0.1245 * exp(-0.0037433890822745472 * var_chaste_interface__membrane_potential__V));
        ...
        const double var_x83 = pow(var_chaste_interface__fast_sodium_current_m_gate__m, 3) * (0.00085421412300683362 * var_chaste_interface__intracellular_potassium_concentration__K_i + 0.0071184510250569474 * var_chaste_interface__intracellular_sodium_concentration__Na_i) * mParameters[3] * var_chaste_interface__fast_sodium_current_h_gate__h / pow((var_chaste_interface__intracellular_sodium_concentration__Na_i + 0.12 * var_chaste_interface__intracellular_potassium_concentration__K_i), 2);
        ...
        rJacobian[6][4] = 0.0;
        rJacobian[6][5] = 0.0;
        rJacobian[6][6] = 1.0 - (mDt * (-0.0018 + var_x10 + var_x17 + var_x23 + var_x25 - var_x9));
        ...
        rJacobian[10][13] = 0.0;
        rJacobian[10][14] = 0.0;
        rJacobian[11][0] = -(mDt * (-5069.4444444444434 * var_x34));
        ...
        rJacobian[11][11] = 1.0 - (mDt * (-5.8000000000000007 + var_x55 + var_x62 - var_x61 + 1.152e-10 * var_x53 - 1733.6962431696716 * var_x66 - 1.0548821632800683e-6 / var_chaste_interface__intracellular_calcium_concentration__Ca_i - 4.3595131479120748e-6 * var_x68 - 10138.888888888887 * var_x52 - 4.7302475136018565e-5 * var_x13 * var_x15));
        rJacobian[11][12] = 0.0;
        rJacobian[11][13] = -(mDt * (0.0037908809981844131 * var_x69));
        ...
        rJacobian[12][10] = 0.0;
        rJacobian[12][11] = 0.0;
        rJacobian[12][12] = 1.0 - (mDt * (-1.0126868767488654e-5 * var_x75 - 4.7302475136018567e-8 * var_x79 - 4.5129535692671587e-6 * mParameters[2] * var_chaste_interface__time_dependent_rectifier_potassium_current_x_gate__x - 0.0048223184607088833 * var_x75 / var_x78 - 8.4390573062405455e-5 * var_x75 * var_chaste_interface__transient_outward_current_r_gate__r * var_chaste_interface__transient_outward_current_s_gate__s + 0.00036103628554137268 * var_x75 * var_x77 * (-26.713760659695652 * var_x76 + var_chaste_interface__membrane_potential__V) / pow(var_x78, 2)));
        ...
        rJacobian[13][9] = 0.0;
        rJacobian[13][10] = 0.0;
        rJacobian[13][11] = -(mDt * (5201.0887295090151 * var_x66 + 1.3078539443736224e-5 * var_x68));
        rJacobian[13][12] = -(mDt * (-0.28452450489136122 * var_x83));
        rJacobian[13][13] = 1.0 - (mDt * (4.3794501115171722e-6 * var_x82 - 0.011372642994553239 * var_x69 - 1.0126868767488654e-5 / var_chaste_interface__intracellular_sodium_concentration__Na_i - 2.3651237568009284e-7 * var_x79 - 0.0020622392630123207 * var_x81 - 2.371037540761344 * var_x83));
        rJacobian[13][14] = 0.0;
        rJacobian[14][0] = 0.0;
    ...
    void Celliribe_model_2006_without_otherwise_sectionFromCellMLBackwardEuler::ComputeOneStepExceptVoltage(double var_chaste_interface__environment__time_converted)
    {
        ...
        const double var_fast_sodium_current_h_gate__alpha_h = 20.0 * exp(-9.375 + 0.125 * mParameters[5] - 0.125 * var_chaste_interface__membrane_potential__V);
        const double var_fast_sodium_current_h_gate__beta_h = 2000.0 / (1.0 + 320.0 * exp(-7.5 + 0.10000000000000001 * mParameters[5] - 0.10000000000000001 * var_chaste_interface__membrane_potential__V));
        const double var_fast_sodium_current_h_gate__h_inf = 0.01 * mParameters[4] + (1.0 - 0.01 * mParameters[4]) * var_fast_sodium_current_h_gate__alpha_h / (var_fast_sodium_current_h_gate__alpha_h + var_fast_sodium_current_h_gate__beta_h);
    ...
    std::vector<double> Celliribe_model_2006_without_otherwise_sectionFromCellMLBackwardEuler::ComputeDerivedQuantities(double var_chaste_interface__environment__time_converted, const std::vector<double> & rY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane_potential__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
