#ifndef CELLWINSLOW_MODEL_1999FROMCELLMLRUSHLARSENOPT_HPP_
#define CELLWINSLOW_MODEL_1999FROMCELLMLRUSHLARSENOPT_HPP_
...
class Cellwinslow_model_1999FromCellMLRushLarsenOpt : public AbstractRushLarsenCardiacCell
{
...
namespace boost
{
    namespace serialization
    {
        ...
        inline void save_construct_data(
            Archive & ar, const Cellwinslow_model_1999FromCellMLRushLarsenOpt * t, const unsigned int fileVersion)
        {
        ...
        inline void load_construct_data(
            Archive & ar, Cellwinslow_model_1999FromCellMLRushLarsenOpt * t, const unsigned int fileVersion)
        {
            boost::shared_ptr<AbstractIvpOdeSolver> p_solver;
            boost::shared_ptr<AbstractStimulusFunction> p_stimulus;
            ar >> p_solver;
            ar >> p_stimulus;
            ::new(t)Cellwinslow_model_1999FromCellMLRushLarsenOpt(p_solver, p_stimulus);
        }
...
#endif // CELLWINSLOW_MODEL_1999FROMCELLMLRUSHLARSENOPT_HPP_