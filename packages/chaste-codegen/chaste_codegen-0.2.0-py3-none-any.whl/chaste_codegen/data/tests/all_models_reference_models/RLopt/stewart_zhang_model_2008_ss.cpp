...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellstewart_zhang_model_2008_ssFromCellMLRushLarsenOpt::EvaluateEquations(double var_chaste_interface__environment__time, std::vector<double> &rDY, std::vector<double> &rAlphaOrTau, std::vector<double> &rBetaOrInf)
    {
        ...
        const double var_fast_sodium_current_m_gate__tau_m = (0.10000000000000001 / (1.0 + exp(7.0 + 0.20000000000000001 * var_chaste_interface__membrane__V)) + 0.10000000000000001 / (1.0 + exp(-0.25 + 0.0050000000000000001 * var_chaste_interface__membrane__V))) / (1.0 + exp(-12.0 - 0.20000000000000001 * var_chaste_interface__membrane__V)); // millisecond
        const double var_hyperpolarization_activated_current_y_gate__tau_y = 4000.0 / (exp(3.6000000000000001 + 0.11 * var_chaste_interface__membrane__V) + exp(-2.8999999999999999 - 0.040000000000000001 * var_chaste_interface__membrane__V)); // millisecond
        ...
        const double d_dt_chaste_interface_var_calcium_dynamics__Ca_i = (0.0038 * var_chaste_interface__calcium_dynamics__Ca_ss + 2.40087783467447e-5 * var_chaste_interface__calcium_dynamics__Ca_SR + 4.6212277808973232e-7 * log(2.0 / var_chaste_interface__calcium_dynamics__Ca_i) - 0.0038240087783467445 * var_chaste_interface__calcium_dynamics__Ca_i - 3.4598107243429746e-8 * var_chaste_interface__membrane__V - 0.00042515544989027063 / (1.0 + 6.2499999999999997e-8 / pow(var_chaste_interface__calcium_dynamics__Ca_i, 2)) - 7.2352122917848019e-6 * var_chaste_interface__calcium_dynamics__Ca_i / (0.00050000000000000001 + var_chaste_interface__calcium_dynamics__Ca_i) + 1.0129554625362472e-11 * (2.0 * pow(var_chaste_interface__sodium_dynamics__Na_i, 3) * exp(0.013101861787960915 * var_chaste_interface__membrane__V) - 6860000.0 * var_chaste_interface__calcium_dynamics__Ca_i * exp(-0.024332029034784559 * var_chaste_interface__membrane__V)) * mParameters[5] / (1.0 + 0.10000000000000001 * exp(-0.024332029034784559 * var_chaste_interface__membrane__V))) / (1.0 + 0.00020000000000000001 / pow((0.001 + var_chaste_interface__calcium_dynamics__Ca_i), 2)); // millimolar / millisecond
        const double d_dt_chaste_interface_var_sodium_dynamics__Na_i = 9.0551084895961074e-7 * log(140.0 / var_chaste_interface__sodium_dynamics__Na_i) - 3.389679425876563e-8 * var_chaste_interface__membrane__V - 1.7024840244711204e-6 * (-26.713760659695652 * log(140.0 / var_chaste_interface__sodium_dynamics__Na_i) + var_chaste_interface__membrane__V) * var_chaste_interface__hyperpolarization_activated_current_y_gate__y - 3.0388663876087416e-11 * (2.0 * pow(var_chaste_interface__sodium_dynamics__Na_i, 3) * exp(0.013101861787960915 * var_chaste_interface__membrane__V) - 6860000.0 * var_chaste_interface__calcium_dynamics__Ca_i * exp(-0.024332029034784559 * var_chaste_interface__membrane__V)) * mParameters[5] / (1.0 + 0.10000000000000001 * exp(-0.024332029034784559 * var_chaste_interface__membrane__V)) - 0.00080594011556369446 * var_chaste_interface__sodium_dynamics__Na_i / ((40.0 + var_chaste_interface__sodium_dynamics__Na_i) * (1.0 + 0.035299999999999998 * exp(-0.037433890822745473 * var_chaste_interface__membrane__V) + 0.1245 * exp(-0.0037433890822745472 * var_chaste_interface__membrane__V))) - 0.00011688549744401942 * pow(var_chaste_interface__fast_sodium_current_m_gate__m, 3) * (-26.713760659695652 * log(140.0 / var_chaste_interface__sodium_dynamics__Na_i) + var_chaste_interface__membrane__V) * mParameters[1] * var_chaste_interface__fast_sodium_current_h_gate__h * var_chaste_interface__fast_sodium_current_j_gate__j; // millimolar / millisecond
        ...
        const double d_dt_chaste_interface_var_potassium_dynamics__K_i = -2.6533007919792409e-6 * (-26.713760659695652 * log(5.4000000000000004 / var_chaste_interface__potassium_dynamics__K_i) + var_chaste_interface__membrane__V) / (1.0 + exp(0.29411764705882354 - 0.058823529411764705 * var_chaste_interface__membrane__V)) - 2.7491468998833366e-5 * pow(var_chaste_interface__slow_time_dependent_potassium_current_Xs_gate__Xs, 2) * (-26.713760659695652 * log(9.5999999999999996 / (0.029999999999999999 * var_chaste_interface__sodium_dynamics__Na_i + var_chaste_interface__potassium_dynamics__K_i)) + var_chaste_interface__membrane__V) - 2.7391648784016175e-6 * (-26.713760659695652 * log(5.4000000000000004 / var_chaste_interface__potassium_dynamics__K_i) + var_chaste_interface__membrane__V) * var_chaste_interface__hyperpolarization_activated_current_y_gate__y - 1.7065282626826835e-6 * (-26.713760659695652 * log(5.4000000000000004 / var_chaste_interface__potassium_dynamics__K_i) + var_chaste_interface__membrane__V) / (1.0 + exp(4.1806020066889626 - 0.16722408026755853 * var_chaste_interface__membrane__V)) - 7.5975573338612623e-6 * (-8.0 - 26.713760659695652 * log(5.4000000000000004 / var_chaste_interface__potassium_dynamics__K_i) + var_chaste_interface__membrane__V) / (1.0 + exp(7.5440000000000005 + 0.10000000000000001 * var_chaste_interface__membrane__V)) + 0.00053729341037579627 * var_chaste_interface__sodium_dynamics__Na_i / ((40.0 + var_chaste_interface__sodium_dynamics__Na_i) * (1.0 + 0.035299999999999998 * exp(-0.037433890822745473 * var_chaste_interface__membrane__V) + 0.1245 * exp(-0.0037433890822745472 * var_chaste_interface__membrane__V))) - 9.5659091108185493e-6 * (-26.713760659695652 * log(5.4000000000000004 / var_chaste_interface__potassium_dynamics__K_i) + var_chaste_interface__membrane__V) * var_chaste_interface__transient_outward_current_r_gate__r * var_chaste_interface__transient_outward_current_s_gate__s - 0.00011688549744401942 * (-26.713760659695652 * log(5.4000000000000004 / var_chaste_interface__potassium_dynamics__K_i) + var_chaste_interface__membrane__V) * mParameters[4] * var_chaste_interface__rapid_time_dependent_potassium_current_Xr1_gate__Xr1 * var_chaste_interface__rapid_time_dependent_potassium_current_Xr2_gate__Xr2; // millimolar / millisecond
        ...
        {
            d_dt_chaste_interface_var_membrane__V = 0.0079072731552699126 * log(2.0 / var_chaste_interface__calcium_dynamics__Ca_i) + 0.0077469905913117388 * log(140.0 / var_chaste_interface__sodium_dynamics__Na_i) - 0.00088199999999999997 * var_chaste_interface__membrane__V - 0.0234346 * (-26.713760659695652 * log(5.4000000000000004 / var_chaste_interface__potassium_dynamics__K_i) + var_chaste_interface__membrane__V) * var_chaste_interface__hyperpolarization_activated_current_y_gate__y - 0.065000000000000002 * (-8.0 - 26.713760659695652 * log(5.4000000000000004 / var_chaste_interface__potassium_dynamics__K_i) + var_chaste_interface__membrane__V) / (1.0 + exp(7.5440000000000005 + 0.10000000000000001 * var_chaste_interface__membrane__V)) - 0.014565399999999999 * (-26.713760659695652 * log(140.0 / var_chaste_interface__sodium_dynamics__Na_i) + var_chaste_interface__membrane__V) * var_chaste_interface__hyperpolarization_activated_current_y_gate__y - 0.12379999999999999 * var_chaste_interface__calcium_dynamics__Ca_i / (0.00050000000000000001 + var_chaste_interface__calcium_dynamics__Ca_i) - 0.022700000000000001 * (-26.713760659695652 * log(5.4000000000000004 / var_chaste_interface__potassium_dynamics__K_i) + var_chaste_interface__membrane__V) / (1.0 + exp(0.29411764705882354 - 0.058823529411764705 * var_chaste_interface__membrane__V)) - 0.0146 * (-26.713760659695652 * log(5.4000000000000004 / var_chaste_interface__potassium_dynamics__K_i) + var_chaste_interface__membrane__V) / (1.0 + exp(4.1806020066889626 - 0.16722408026755853 * var_chaste_interface__membrane__V)) - 0.23519999999999999 * pow(var_chaste_interface__slow_time_dependent_potassium_current_Xs_gate__Xs, 2) * (-26.713760659695652 * log(9.5999999999999996 / (0.029999999999999999 * var_chaste_interface__sodium_dynamics__Na_i + var_chaste_interface__potassium_dynamics__K_i)) + var_chaste_interface__membrane__V) - 0.081839999999999996 * (-26.713760659695652 * log(5.4000000000000004 / var_chaste_interface__potassium_dynamics__K_i) + var_chaste_interface__membrane__V) * var_chaste_interface__transient_outward_current_r_gate__r * var_chaste_interface__transient_outward_current_s_gate__s - 8.666220229942447e-8 * (2.0 * pow(var_chaste_interface__sodium_dynamics__Na_i, 3) * exp(0.013101861787960915 * var_chaste_interface__membrane__V) - 6860000.0 * var_chaste_interface__calcium_dynamics__Ca_i * exp(-0.024332029034784559 * var_chaste_interface__membrane__V)) * mParameters[5] / (1.0 + 0.10000000000000001 * exp(-0.024332029034784559 * var_chaste_interface__membrane__V)) - 2.2983750000000001 * var_chaste_interface__sodium_dynamics__Na_i / ((40.0 + var_chaste_interface__sodium_dynamics__Na_i) * (1.0 + 0.035299999999999998 * exp(-0.037433890822745473 * var_chaste_interface__membrane__V) + 0.1245 * exp(-0.0037433890822745472 * var_chaste_interface__membrane__V))) - 1.0 * (-26.713760659695652 * log(5.4000000000000004 / var_chaste_interface__potassium_dynamics__K_i) + var_chaste_interface__membrane__V) * mParameters[4] * var_chaste_interface__rapid_time_dependent_potassium_current_Xr1_gate__Xr1 * var_chaste_interface__rapid_time_dependent_potassium_current_Xr2_gate__Xr2 - 1.0 * pow(var_chaste_interface__fast_sodium_current_m_gate__m, 3) * (-26.713760659695652 * log(140.0 / var_chaste_interface__sodium_dynamics__Na_i) + var_chaste_interface__membrane__V) * mParameters[1] * var_chaste_interface__fast_sodium_current_h_gate__h * var_chaste_interface__fast_sodium_current_j_gate__j - 14447.286958825251 * (-2.0 + 0.25 * var_chaste_interface__calcium_dynamics__Ca_ss * exp(-1.1230167246823641 + 0.074867781645490947 * var_chaste_interface__membrane__V)) * (-15.0 + var_chaste_interface__membrane__V) * mParameters[0] * var_chaste_interface__L_type_Ca_current_d_gate__d * var_chaste_interface__L_type_Ca_current_f2_gate__f2 * var_chaste_interface__L_type_Ca_current_fCass_gate__fCass * var_chaste_interface__L_type_Ca_current_f_gate__f / (-1.0 + exp(-1.1230167246823641 + 0.074867781645490947 * var_chaste_interface__membrane__V)); // millivolt / millisecond
        }
        
        rDY[0] = d_dt_chaste_interface_var_membrane__V;
        rDY[1] = d_dt_chaste_interface_var_calcium_dynamics__Ca_i;
        rAlphaOrTau[2] = var_hyperpolarization_activated_current_y_gate__tau_y;
        rBetaOrInf[2] = var_hyperpolarization_activated_current_y_gate__y_inf;
        rAlphaOrTau[3] = var_rapid_time_dependent_potassium_current_Xr1_gate__tau_xr1;
        rBetaOrInf[3] = var_rapid_time_dependent_potassium_current_Xr1_gate__xr1_inf;
        rAlphaOrTau[4] = var_rapid_time_dependent_potassium_current_Xr2_gate__tau_xr2;
        rBetaOrInf[4] = var_rapid_time_dependent_potassium_current_Xr2_gate__xr2_inf;
        rAlphaOrTau[5] = var_slow_time_dependent_potassium_current_Xs_gate__tau_xs;
        rBetaOrInf[5] = var_slow_time_dependent_potassium_current_Xs_gate__xs_inf;
        rAlphaOrTau[6] = var_fast_sodium_current_m_gate__tau_m;
        rBetaOrInf[6] = var_fast_sodium_current_m_gate__m_inf;
        rAlphaOrTau[7] = var_fast_sodium_current_h_gate__tau_h;
        rBetaOrInf[7] = var_fast_sodium_current_h_gate__h_inf;
        rAlphaOrTau[8] = var_fast_sodium_current_j_gate__tau_j;
        rBetaOrInf[8] = var_fast_sodium_current_j_gate__j_inf;
        rAlphaOrTau[9] = var_L_type_Ca_current_d_gate__tau_d;
        rBetaOrInf[9] = var_L_type_Ca_current_d_gate__d_inf;
        rAlphaOrTau[10] = var_L_type_Ca_current_f_gate__tau_f;
        rBetaOrInf[10] = var_L_type_Ca_current_f_gate__f_inf;
        rAlphaOrTau[11] = var_L_type_Ca_current_f2_gate__tau_f2;
        rBetaOrInf[11] = var_L_type_Ca_current_f2_gate__f2_inf;
        rDY[12] = d_dt_chaste_interface_var_L_type_Ca_current_fCass_gate__fCass;
        rAlphaOrTau[13] = var_transient_outward_current_s_gate__tau_s;
        rBetaOrInf[13] = var_transient_outward_current_s_gate__s_inf;
        rAlphaOrTau[14] = var_transient_outward_current_r_gate__tau_r;
        rBetaOrInf[14] = var_transient_outward_current_r_gate__r_inf;
