...
#include "MathsCustomFunctions.hpp"
    ...
    double Cellnoble_noble_SAN_model_1984FromCellMLCvodeDataClamp::GetIntracellularCalciumConcentration()
    {
        return NV_Ith_S(mStateVariables, 1);
    }
    
    Cellnoble_noble_SAN_model_1984FromCellMLCvodeDataClamp::Cellnoble_noble_SAN_model_1984FromCellMLCvodeDataClamp(boost::shared_ptr<AbstractIvpOdeSolver> pOdeSolver /* unused; should be empty */, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
                ...
                pIntracellularStimulus)
    {
        ...
        //
        this->mpSystemInfo = OdeSystemInformation<Cellnoble_noble_SAN_model_1984FromCellMLCvodeDataClamp>::Instance();
        Init();
    ...
    Cellnoble_noble_SAN_model_1984FromCellMLCvodeDataClamp::~Cellnoble_noble_SAN_model_1984FromCellMLCvodeDataClamp()
    {
    }
    
    double Cellnoble_noble_SAN_model_1984FromCellMLCvodeDataClamp::GetIIonic(const std::vector<double>* pStateVariables)
    {
    ...
    void Cellnoble_noble_SAN_model_1984FromCellMLCvodeDataClamp::EvaluateYDerivatives(double var_chaste_interface__environment__time_converted, const N_Vector rY, N_Vector rDY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : NV_Ith_S(rY, 0));
    ...
    N_Vector Cellnoble_noble_SAN_model_1984FromCellMLCvodeDataClamp::ComputeDerivedQuantities(double var_chaste_interface__environment__time_converted, const N_Vector & rY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : NV_Ith_S(rY, 0));
...
template<>
void OdeSystemInformation<Cellnoble_noble_SAN_model_1984FromCellMLCvodeDataClamp>::Initialise(void)
{
