...
#include "MathsCustomFunctions.hpp"
    ...
    boost::shared_ptr<RegularStimulus> Cellaslanidi_model_2009FromCellMLCvodeDataClamp::UseCellMLDefaultStimulus()
    {
    ...
    Cellaslanidi_model_2009FromCellMLCvodeDataClamp::~Cellaslanidi_model_2009FromCellMLCvodeDataClamp()
    {
    }
    
    double Cellaslanidi_model_2009FromCellMLCvodeDataClamp::GetIIonic(const std::vector<double>* pStateVariables)
    {
    ...
    void Cellaslanidi_model_2009FromCellMLCvodeDataClamp::EvaluateYDerivatives(double var_chaste_interface__environment__time_converted, const N_Vector rY, N_Vector rDY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : NV_Ith_S(rY, 0));
    ...
    N_Vector Cellaslanidi_model_2009FromCellMLCvodeDataClamp::ComputeDerivedQuantities(double var_chaste_interface__environment__time_converted, const N_Vector & rY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : NV_Ith_S(rY, 0));
...
template<>
void OdeSystemInformation<Cellaslanidi_model_2009FromCellMLCvodeDataClamp>::Initialise(void)
{
