...
#include "MathsCustomFunctions.hpp"
    ...
    Cellzhang_SAN_model_2000_allFromCellMLCvodeDataClamp::Cellzhang_SAN_model_2000_allFromCellMLCvodeDataClamp(boost::shared_ptr<AbstractIvpOdeSolver> pOdeSolver /* unused; should be empty */, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
                ...
                pIntracellularStimulus)
    {
        ...
        //
        this->mpSystemInfo = OdeSystemInformation<Cellzhang_SAN_model_2000_allFromCellMLCvodeDataClamp>::Instance();
        Init();
        
        NV_Ith_S(this->mParameters, 0) = 0.0; // (var_membrane_data_clamp_current_conductance) [dimensionless]
    }

    Cellzhang_SAN_model_2000_allFromCellMLCvodeDataClamp::~Cellzhang_SAN_model_2000_allFromCellMLCvodeDataClamp()
    {
    }
    
    double Cellzhang_SAN_model_2000_allFromCellMLCvodeDataClamp::GetIIonic(const std::vector<double>* pStateVariables)
    {
    ...
    void Cellzhang_SAN_model_2000_allFromCellMLCvodeDataClamp::EvaluateYDerivatives(double var_chaste_interface__environment__time_converted, const N_Vector rY, N_Vector rDY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : NV_Ith_S(rY, 0));
    ...
    N_Vector Cellzhang_SAN_model_2000_allFromCellMLCvodeDataClamp::ComputeDerivedQuantities(double var_chaste_interface__environment__time_converted, const N_Vector & rY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : NV_Ith_S(rY, 0));
...
template<>
void OdeSystemInformation<Cellzhang_SAN_model_2000_allFromCellMLCvodeDataClamp>::Initialise(void)
{
