#ifndef CELLDECKER_2009FROMCELLMLGRL2OPT_HPP_
#define CELLDECKER_2009FROMCELLMLGRL2OPT_HPP_
...
class Celldecker_2009FromCellMLGRL2Opt : public AbstractGeneralizedRushLarsenCardiacCell
{
...
public:
    ...
    Celldecker_2009FromCellMLGRL2Opt(boost::shared_ptr<AbstractIvpOdeSolver> /* unused; should be empty */, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus);
    ~Celldecker_2009FromCellMLGRL2Opt();
...
namespace boost
{
    namespace serialization
    {
        ...
        inline void save_construct_data(
            Archive & ar, const Celldecker_2009FromCellMLGRL2Opt * t, const unsigned int fileVersion)
        {
        ...
        inline void load_construct_data(
            Archive & ar, Celldecker_2009FromCellMLGRL2Opt * t, const unsigned int fileVersion)
        {
            boost::shared_ptr<AbstractIvpOdeSolver> p_solver;
            boost::shared_ptr<AbstractStimulusFunction> p_stimulus;
            ar >> p_solver;
            ar >> p_stimulus;
            ::new(t)Celldecker_2009FromCellMLGRL2Opt(p_solver, p_stimulus);
        }
...
#endif // CELLDECKER_2009FROMCELLMLGRL2OPT_HPP_