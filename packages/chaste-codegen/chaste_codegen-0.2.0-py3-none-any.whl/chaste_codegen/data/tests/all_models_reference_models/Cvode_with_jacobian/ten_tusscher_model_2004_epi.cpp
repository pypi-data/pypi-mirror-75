...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellten_tusscher_model_2004_epiFromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x72 = -26.713760659695652 * log(140.0 * var_x71) + var_chaste_interface__membrane__V;
        ...
        const double var_x122 = -var_chaste_interface__rapid_time_dependent_potassium_current_Xr1_gate__Xr1 + 1 / var_x121;
        ...
        const double var_x130 = exp(3.6666666666666665 + 0.041666666666666664 * var_chaste_interface__membrane__V);
        const double var_x131 = 1.0 + var_x130;
        const double var_x132 = -var_chaste_interface__rapid_time_dependent_potassium_current_Xr2_gate__Xr2 + 1 / var_x131;
        ...
        const double var_x139 = exp(-0.35714285714285715 - 0.071428571428571425 * var_chaste_interface__membrane__V);
        const double var_x140 = 1.0 + var_x139;
        const double var_x141 = -var_chaste_interface__slow_time_dependent_potassium_current_Xs_gate__Xs + 1 / var_x140;
        ...
        const double var_x154 = -var_chaste_interface__fast_sodium_current_m_gate__m + 1 / pow(var_x153, 2);
        ...
        const double var_x160 = 1 / pow(var_x159, 2);
        ...
        const double var_x231 = var_x230 * (-0.0082319999999999997 - var_x108);
        ...
        const double var_x238 = (0.0031224512033090025 * var_x12 - 0.00011688549744401942 * var_chaste_interface__membrane__V) * NV_Ith_S(mParameters, 2);
        const double var_x239 = 0.0031224512033090025 * var_x12 - 0.00011688549744401942 * var_chaste_interface__membrane__V;
        
        // Matrix entries
        IJth(rJacobian, 0, 0) = mSetVoltageDerivativeToZero ? 0.0 : (-0.00088199999999999997 - var_x27 - var_x36 + 1081.6363254030778 * var_x58 + 0.03243 * var_x39 - 0.245 * var_x0 - 0.0146 * var_x3 - 0.0024414715719063545 * var_x30 - 1081.6363254030778 * var_x61 - 8.6662202299424464e-5 * var_x10 - 0.54050000000000009 * var_x25 - 1.1491875 * var_x48 - 2.1086672225679691e-7 * var_x32 - 1.0 * var_x33 - var_x41 * var_x43 - var_x55 * var_chaste_interface__L_type_Ca_current_d_gate__d);
        IJth(rJacobian, 1, 0) = var_x98 * (-3.4598107243429746e-8 + 2.464726172537559e-11 * var_x32 + 1.0129554625362472e-8 * var_x10 + 0.06321379997413 * var_x58 - 0.06321379997413 * var_x61 - var_x94 * var_chaste_interface__L_type_Ca_current_d_gate__d);
        ...
        IJth(rJacobian, 3, 0) = 0.01488095238095238 * var_x129 * var_x132 * var_x133 - 0.041666666666666664 * var_x130 * var_x135 / pow(var_x131, 2) - 0.050000000000000003 * var_x128 * var_x132 * var_x134;
        ...
        IJth(rJacobian, 5, 0) = 0.22148394241417499 * var_x152 * var_x157 / pow(var_x153, 3) - 0.20000000000000001 * var_x151 * var_x154 * var_x155 + 99.999999999999986 * var_x154 * var_x156 * (0.02 * var_x145 / pow(var_x146, 2) + 0.00050000000000000001 * var_x148 / pow(var_x149, 2)) / pow((var_x147 + var_x150), 2);
        IJth(rJacobian, 6, 0) = (var_x160 - var_chaste_interface__fast_sodium_current_h_gate__h) * (((var_x162) ? (-0.008382352941176471 * var_x161) : (0)) + ((var_x162) ? (108035.0 * var_x163 + 0.21330000000000002 * var_x164) : (0.53361053361053368 * var_x165 / pow(var_x166, 2)))) - var_x169 * (var_x167 + var_x168);
        IJth(rJacobian, 7, 0) = (var_x160 - var_chaste_interface__fast_sodium_current_j_gate__j) * (((var_x162) ? (-0.00025500480000000003 * var_x173 + 0.0033402720000000005 * var_x170 * var_x172 / pow(var_x171, 2)) : (0.034200000000000001 * var_x177 + 0.059999999999999998 * var_x174 * var_x176 / pow(var_x175, 2))) + ((var_x162) ? (var_x184 + var_x183 * var_x185 * (3.0508668000000001e-7 * var_x179 - 6214.6032000000005 * var_x178) - 0.311 * var_x180 * var_x181 * var_x185 / pow(var_x182, 2)) : (0))) - var_x169 * (var_x186 + var_x187);
        IJth(rJacobian, 8, 0) = 0.51020408163265307 * (-var_chaste_interface__L_type_Ca_current_d_gate__d + 1 / var_x199) * (-0.050000000000000003 * var_x188 / pow(var_x189, 2) + 0.27999999999999997 * var_x191 * var_x196 / pow(var_x192, 2) - 0.15076923076923074 * var_x193 * var_x194 / pow(var_x195, 2)) / pow((var_x197 + 0.7142857142857143 * var_x190), 2) + 0.13333333333333333 * var_x198 * var_x200 / pow(var_x199, 2);
        IJth(rJacobian, 9, 0) = 7.9012345679012348e-7 * (-var_chaste_interface__L_type_Ca_current_f_gate__f + 1 / var_x206) * (-var_x207 * (-0.22500000000000001 - 0.0083333333333333332 * var_chaste_interface__membrane__V) - 16.5 * var_x201 / pow(var_x202, 2)) / pow((0.071111111111111111 + var_x204 + 0.14666666666666667 * var_x203), 2) - 0.14285714285714285 * var_x205 * var_x208 / pow(var_x206, 2);
        ...
        IJth(rJacobian, 12, 0) = 0.16666666666666666 * var_x224 * var_x227 / pow(var_x225, 2) - 0.10526315789473684 * var_x226 * (-0.044444444444444446 - 0.0011111111111111111 * var_chaste_interface__membrane__V) * (-var_chaste_interface__transient_outward_current_r_gate__r + 1 / var_x225) / pow((0.084210526315789472 + var_x226), 2);
        ...
        IJth(rJacobian, 16, 0) = 0.00026864670518789814 * var_x48 + 3.79059668210955e-6 * var_x39 - 2.8537261917770623e-7 * var_x30 - 0.00011688549744401942 * var_x27 - 6.3176611368492499e-5 * var_x25 - 1.7065282626826835e-6 * var_x3 - 2.8636946873784758e-5 * var_x0 - 0.00011688549744401942 * var_x33 - var_x237 * var_x41;
        IJth(rJacobian, 0, 1) = mSetVoltageDerivativeToZero ? 0.0 : (0.82499999999999996 * var_x65 + 594.50270777405183 * var_x66 - 0.82499999999999996 * var_x63 - 0.0079072731552699126 * var_x64 - 14447.286958825251 * var_x67);
        ...
        IJth(rJacobian, 13, 1) = var_x230 * (8.0000000000000007e-5 + var_x101);
        IJth(rJacobian, 14, 1) = ((var_x236) ? (0) : ((var_x233) ? (-5.5147968749999998e-21 * pow(var_chaste_interface__calcium_dynamics__Ca_i, 5) / pow((1.8382656249999998e-21 + var_x234), 2)) : (-4.0567542199219961e-55 * pow(var_chaste_interface__calcium_dynamics__Ca_i, 15) / pow((5.0709427749024951e-56 + var_x235), 2))));
        IJth(rJacobian, 15, 1) = 0.20846623418995969 * var_x66;
        IJth(rJacobian, 0, 2) = mSetVoltageDerivativeToZero ? 0.0 : (var_x68 * var_chaste_interface__rapid_time_dependent_potassium_current_Xr2_gate__Xr2);
        IJth(rJacobian, 2, 2) = -var_x125;
        IJth(rJacobian, 16, 2) = var_x238 * var_chaste_interface__rapid_time_dependent_potassium_current_Xr2_gate__Xr2;
        IJth(rJacobian, 0, 3) = mSetVoltageDerivativeToZero ? 0.0 : (var_x68 * var_chaste_interface__rapid_time_dependent_potassium_current_Xr1_gate__Xr1);
        IJth(rJacobian, 3, 3) = -var_x135;
        IJth(rJacobian, 16, 3) = var_x238 * var_chaste_interface__rapid_time_dependent_potassium_current_Xr1_gate__Xr1;
        IJth(rJacobian, 0, 4) = mSetVoltageDerivativeToZero ? 0.0 : (-0.48999999999999999 * var_x70);
        IJth(rJacobian, 4, 4) = -0.00090909090909090909 * var_x143;
        IJth(rJacobian, 16, 4) = -5.7273893747569515e-5 * var_x70;
        IJth(rJacobian, 0, 5) = mSetVoltageDerivativeToZero ? 0.0 : (-3 * var_x74);
        IJth(rJacobian, 5, 5) = -1.0 * var_x157;
        IJth(rJacobian, 15, 5) = -0.00035065649233205829 * var_x74;
        IJth(rJacobian, 0, 6) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x75);
        IJth(rJacobian, 6, 6) = -var_x167 - var_x168;
        IJth(rJacobian, 15, 6) = -0.00011688549744401942 * var_x75;
        IJth(rJacobian, 0, 7) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x76);
        IJth(rJacobian, 7, 7) = -var_x186 - var_x187;
        IJth(rJacobian, 15, 7) = -0.00011688549744401942 * var_x76;
        IJth(rJacobian, 0, 8) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x55 * var_chaste_interface__membrane__V);
        IJth(rJacobian, 1, 8) = var_x98 * (var_x110 - var_x94 * var_chaste_interface__membrane__V);
        IJth(rJacobian, 8, 8) = -var_x200;
        IJth(rJacobian, 13, 8) = var_x231 * var_chaste_interface__calcium_dynamics__g;
        IJth(rJacobian, 0, 9) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x59 * var_x77);
        IJth(rJacobian, 1, 9) = -var_x112 * var_x59;
        IJth(rJacobian, 9, 9) = -var_x208;
        IJth(rJacobian, 0, 10) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x77 * var_x78);
        ...
        IJth(rJacobian, 11, 11) = -var_x223;
        IJth(rJacobian, 16, 11) = var_x239 * var_x26;
        IJth(rJacobian, 0, 12) = mSetVoltageDerivativeToZero ? 0.0 : (var_x79 * var_x80);
        IJth(rJacobian, 12, 12) = -var_x227;
        IJth(rJacobian, 16, 12) = var_x239 * var_x80;
        IJth(rJacobian, 1, 13) = var_x98 * (8.0000000000000007e-5 + var_x115 * (var_x113 - var_x114));
        IJth(rJacobian, 13, 13) = var_x230 * (-8.0000000000000007e-5 + var_x115 * (var_x114 - var_x113)) + 9.9963436928702016 * (var_x103 + var_x104 - var_x102 - var_x111) / (pow(var_x228, 3) * pow((0.33333333333333337 + var_x229), 2));
        IJth(rJacobian, 1, 14) = var_x109 * var_x98 * var_chaste_interface__L_type_Ca_current_d_gate__d;
        IJth(rJacobian, 13, 14) = var_x231 * var_chaste_interface__L_type_Ca_current_d_gate__d;
        IJth(rJacobian, 14, 14) = ((var_x236) ? (0) : (-0.5));
        IJth(rJacobian, 0, 15) = mSetVoltageDerivativeToZero ? 0.0 : (0.00071824218750000002 * var_x83 - 26.713760659695652 * var_x86 - 0.00051997321379654684 * var_x84 - 1.884922952148125 * var_x85 - 1.1491875 * var_x82 - 0.0077469905913117388 * var_x71);
        IJth(rJacobian, 1, 15) = 6.0777327752174836e-8 * var_x84 * var_x97;
        IJth(rJacobian, 15, 15) = 2.5185628611365452e-7 * var_x83 - 9.0551084895961074e-7 * var_x71 - 1.823319832565245e-7 * var_x84 - 0.0031224512033090025 * var_x86 - 0.00040297005778184723 * var_x82;
        ...
        IJth(rJacobian, 16, 16) = 0.00010126109252331096 * var_x93 - 0.0073440052301827737 * var_x85 - 0.0031224512033090025 * var_x92 - 0.0016876848753885161 * var_x88 - 4.5587787568311439e-5 * var_x87 - 0.0031224512033090025 * var_x89 - var_x237 * var_x91;
    }
