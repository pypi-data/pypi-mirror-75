...
#include "MathsCustomFunctions.hpp"
    ...
    void CellFaberRudy2000FromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time_converted, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x178 = 9.0316078310111333e-5 * var_x177;
        ...
        const double var_x197 = var_x105 * var_x137;
        const double var_x198 = 0.00070463905573898956 * var_x177;
        const double var_x199 = var_x105 * var_x139;
        const double var_x200 = ((var_x188) ? (var_x187 - var_x186 * var_chaste_interface__calcium_dynamics__APtrack2) : (0));
        const double var_x201 = var_x194 * (0.0070588235294117632 * var_chaste_interface__calcium_dynamics__Ca_JSR - 0.0070588235294117632 * var_chaste_interface__calcium_dynamics__Cai);
        const double var_x202 = 60000.0 * var_x182 * var_chaste_interface__calcium_dynamics__APtrack2;
        const double var_x203 = ((var_x188) ? (var_x184 * var_x202 - var_x185 * var_x202 / pow(var_x183, 2)) : (0));
        const double var_x204 = ((var_x188) ? (0) : ((var_x189) ? (4000.0 - 8000.0 * var_chaste_interface__calcium_dynamics__OVRLDtrack2) : (0)));
        ...
        const double var_x212 = 0.001 * var_chaste_interface__fast_sodium_current_h_gate__h;
        ...
        const double var_x219 = 0.001 * var_chaste_interface__fast_sodium_current_j_gate__j;
        ...
        const double var_x245 = 5.6089743589743595 * var_x236 * var_x240;
        const double var_x246 = ((var_x241) ? (0) : (var_x244 - var_x243 * var_x245 - var_x237 * var_x245 / pow(var_x242, 2)));
        const double var_x247 = 1.0 - var_chaste_interface__L_type_Ca_channel_d_gate__d;
        const double var_x248 = ((var_x241) ? (218.40000000000003) : (var_x240 * var_x244));
        const double var_x249 = 0.00016025641025641026 * var_x236 * var_x248 / pow(var_x237, 2);
        const double var_x250 = exp(-0.113569 * pow((1 + 0.10000000000000001 * var_chaste_interface__membrane__V), 2));
        const double var_x251 = 19.699999999999999 * var_x250;
        const double var_x252 = 0.001 - 0.001 * var_chaste_interface__L_type_Ca_channel_f_gate__f;
        const double var_x253 = exp(2.5 - 0.050000000000000003 * var_chaste_interface__membrane__V);
        const double var_x254 = 1.0 + var_x253;
        const double var_x255 = 0.029999999999999999 * var_x253 / pow(var_x254, 2);
        const double var_x256 = exp(4.0 + 0.125 * var_chaste_interface__membrane__V);
        const double var_x257 = 1.0 + var_x256;
        const double var_x258 = 0.125 * var_x256 / pow(var_x257, 2);
        ...
        const double var_x264 = -0.022713800000000003 - 0.0022713799999999999 * var_chaste_interface__membrane__V;
        const double var_x265 = 1.0 - var_x261 - var_x262;
        const double var_x266 = exp(-1.2962962962962963 - 0.092592592592592587 * var_chaste_interface__membrane__V);
        ...
        const double var_x272 = exp(10.714285714285715 + 0.17857142857142858 * var_chaste_interface__membrane__V);
        ...
        const double var_x276 = exp(-2.8666666666666667 - 0.13333333333333333 * var_chaste_interface__membrane__V);
        ...
        const double var_x281 = 0.60999999999999999 * var_x280;
        ...
        const double var_x285 = 1.3799999999999999 * var_x284;
        ...
        const double var_x288 = exp(0.089820359281437126 - 0.059880239520958084 * var_chaste_interface__membrane__V);
        ...
        const double var_x294 = 0.13100000000000001 * var_x293;
        ...
        const double var_x298 = 0.071899999999999992 * var_x297;
        const double var_x299 = 30.0 + var_chaste_interface__membrane__V;
        const double var_x300 = var_x291 * var_x299 / pow(var_x292, 2);
        const double var_x301 = var_x295 * var_x299 / pow(var_x296, 2);
        const double var_x302 = 5.9880239520958083e-5 * var_x288 / pow(var_x289, 2);
        const double var_x303 = var_x293 * var_x299;
        const double var_x304 = var_x297 * var_x299;
        const double var_x305 = 0.032750000000000001 * var_x293;
        const double var_x306 = 0.017974999999999998 * var_x297;
        ...
        const double var_x314 = 10000.0 * var_x310 + 10000.0 * var_x313;
        const double var_x315 = 1 / var_x314;
        const double var_x316 = 10.0 * var_x310;
        const double var_x317 = 400.0 * var_x310;
        const double var_x318 = 400.0 * pow(var_x311, 2) / pow(var_x312, 2);
        const double var_x319 = pow(var_x308, 2) / pow(var_x309, 2);
        const double var_x320 = 400.0 * var_x319;
        const double var_x321 = 400.0 * var_x313;
        const double var_x322 = 0.40000000000000002 * var_x315;
        ...
        const double var_x330 = 15.0 * var_x326 + 100.0 * var_x329;
        const double var_x331 = var_x324 / pow(var_x325, 2);
        const double var_x332 = 3.0 * var_x331;
        const double var_x333 = 20.0 * pow(var_x327, 2) / pow(var_x328, 2);
        const double var_x334 = 20.0 * var_x329;
        const double var_x335 = 1 / var_x330;
        ...
        const double var_x341 = var_x340 * (-var_chaste_interface__calcium_dynamics__Ca_JSR + var_chaste_interface__calcium_dynamics__Cai);
        ...
        const double var_x344 = 0.70463905573898955 * var_x176;
        const double var_x345 = var_chaste_interface__calcium_dynamics__OVRLDtrack > 0.97999999999999998;
        const double var_x346 = var_x25 * var_x32;
        const double var_x347 = 0.00018063215662022267 * var_x176;
        const double var_x348 = 0.0028901145059235626 * var_x176;
        const double var_x349 = var_x138 * var_x176;
        const double var_x350 = 4.4039940983686847e-7 * var_x82;
        const double var_x351 = var_x140 * var_x176;
        const double var_x352 = -0.433 - var_x55;
        const double var_x353 = var_x122 * var_x352;
        const double var_x354 = 1.2592160903483795e-7 * var_x85;
        const double var_x355 = var_x121 * var_x347 * var_x352 * NV_Ith_S(mParameters, 1);
        ...
        IJth(rJacobian, 2, 0) = (0.001 - 0.001 * var_chaste_interface__fast_sodium_current_m_gate__m) * ((var_x210) ? (var_x208 - 32.0 * var_x206 * var_x209 / pow(var_x207, 2)) : (0)) + 0.0072727272727272727 * var_x211 * var_chaste_interface__fast_sodium_current_m_gate__m;
        IJth(rJacobian, 3, 0) = (0.001 - var_x212) * ((var_x214) ? (-19.852941176470587 * var_x213) : (0)) - var_x212 * ((var_x214) ? (281.24000000000001 * var_x215 + 108500000.0 * var_x216) : (693.00069300069299 * var_x217 / pow(var_x218, 2)));
        IJth(rJacobian, 4, 0) = (0.001 - var_x219) * ((var_x214) ? (var_x226 + var_x225 * var_x227 * (1.5254334000000001e-6 * var_x221 - 31073.016 * var_x220) - 311.0 * var_x222 * var_x223 * var_x227 / pow(var_x224, 2)) : (0)) - var_x219 * ((var_x214) ? (-1.2750239999999999 * var_x231 + 16.701360000000001 * var_x228 * var_x230 / pow(var_x229, 2)) : (-7.6049999999999992e-5 * var_x235 + 30.0 * var_x232 * var_x234 / pow(var_x233, 2)));
        IJth(rJacobian, 5, 0) = var_x247 * var_x249 + var_x249 * var_chaste_interface__L_type_Ca_channel_d_gate__d + var_x238 * var_x246 * var_x247 + var_x239 * var_x246 * var_chaste_interface__L_type_Ca_channel_d_gate__d;
        IJth(rJacobian, 6, 0) = var_x252 * (20.0 + var_x251) * (var_x255 - var_x258) + var_x260 * (var_x258 - var_x255) * var_chaste_interface__L_type_Ca_channel_f_gate__f + var_x251 * var_x252 * var_x263 * var_x264 - var_x259 * var_x264 * var_x265 * var_chaste_interface__L_type_Ca_channel_f_gate__f;
        IJth(rJacobian, 7, 0) = 9.2592592592592588e-5 * var_x266 * var_x271 / pow(var_x267, 2) + 0.036429872495446262 * var_x268 * (-var_chaste_interface__T_type_Ca_channel_b_gate__b + 1 / var_x267) / (pow(var_x269, 2) * pow((0.60655737704918034 + var_x270), 2));
        IJth(rJacobian, 8, 0) = (0.001 / var_x273 - 0.001 * var_chaste_interface__T_type_Ca_channel_g_gate__g) * ((var_x274) ? (6.0763888888888884 / pow((1 - 0.072916666666666671 * var_chaste_interface__membrane__V), 2)) : (0)) - 0.00017857142857142857 * var_x272 * var_x275 / pow(var_x273, 2);
        IJth(rJacobian, 9, 0) = (0.001 / var_x277 - 0.001 * var_chaste_interface__rapid_delayed_rectifier_potassium_current_xr_gate__xr) * (var_x281 + var_x285 - 0.16973999999999997 * var_x282 * var_x286 / pow(var_x283, 2) - 0.088449999999999987 * var_x278 * var_x287 / pow(var_x279, 2)) + 0.00013333333333333334 * var_x276 * (var_x281 * var_x287 + var_x285 * var_x286) / pow(var_x277, 2);
        IJth(rJacobian, 10, 0) = var_x302 * (var_x294 * var_x299 + var_x298 * var_x299) + (var_x290 - var_x148) * (var_x294 + var_x298 - 0.0089997000000000011 * var_x300 - 0.0106412 * var_x301);
        IJth(rJacobian, 11, 0) = var_x302 * (var_x299 * var_x305 + var_x299 * var_x306) + (var_x290 - var_x146) * (var_x305 + var_x306 - 0.0022499250000000003 * var_x300 - 0.0026603 * var_x301);
        IJth(rJacobian, 12, 0) = var_x314 * (var_x310 * var_x322 - var_x319 * var_x322 + 9.9999999999999995e-8 * var_x310 * (var_x320 + var_x321 - var_x317 - var_x318) / pow((var_x310 + var_x313), 2)) + (-0.001 * var_chaste_interface__transient_outward_current_zdv_gate__zdv + var_x315 * var_x316) * (var_x317 + var_x318 - var_x320 - var_x321);
        IJth(rJacobian, 13, 0) = var_x330 * (-0.0030000000000000001 * var_x331 * var_x335 + 1.5e-6 * var_x326 * (var_x332 + var_x333 - var_x334) / pow((var_x329 + 0.14999999999999999 * var_x326), 2)) + (-0.001 * var_chaste_interface__transient_outward_current_ydv_gate__ydv + var_x335 * var_x336) * (var_x334 - var_x332 - var_x333);
        IJth(rJacobian, 19, 0) = 0.001 * ((var_x343) ? (-var_x193 * (var_x172 + var_x50 - var_x65 - var_x67)) : (0));
        IJth(rJacobian, 23, 0) = var_x347 * (-0.0040000000000000001 + var_x96 - var_x22 - var_x84 - var_x91 + 2.386537573622417e-5 * var_x49 - 5.0625 * var_x346 - 0.00075000000000000002 * var_x64 - 5.0538442735533534e-5 * var_x66);
        IJth(rJacobian, 24, 0) = var_x347 * (-2.7574104360798206e-8 + var_x353 + var_x74 + var_x89 + var_x95 - var_x18 - var_x3 - var_x37 - var_x39 - var_x62 - var_x72 - var_x87 - var_x88 - var_x92 + 3.375 * var_x346);
        IJth(rJacobian, 0, 1) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x111 * (var_x124 + var_x128 - var_x112 - var_x114 - var_x118 - var_x119));
        IJth(rJacobian, 1, 1) = var_x194 * (-var_x181 - var_x191 + 0.71029411764705874 * var_x192 - var_x193 * (var_x128 + 1149.9839999999999 * var_x48 + 0.11499840000000001 * var_x113)) + 0.001 * (0.00023800000000000004 / pow(var_x173, 3) + 7.0000000000000007e-5 / pow(var_x125, 3)) * (0.047352941176470584 * var_chaste_interface__calcium_dynamics__Ca_NSR + var_x191 * var_x195 - var_x181 * var_chaste_interface__calcium_dynamics__Cai - var_x193 * (var_x196 + 0.003016 * var_chaste_interface__membrane__V - 0.00050000000000000001 * var_x49)) / pow(var_x174, 2);
        IJth(rJacobian, 14, 1) = var_x190 * var_x340;
        IJth(rJacobian, 15, 1) = 0.0087500000000000008 * var_x180 - 0.0087500000000000008 * var_x192;
        IJth(rJacobian, 19, 1) = 0.001 * ((var_x343) ? (-var_x193 * (var_x112 + var_x114 + var_x128)) : (0));
        IJth(rJacobian, 23, 1) = var_x347 * (var_x118 + 0.1724976 * var_x113 + 1724.9760000000001 * var_x48);
        IJth(rJacobian, 24, 1) = var_x347 * (var_x119 - var_x124);
        IJth(rJacobian, 0, 2) = mSetVoltageDerivativeToZero ? 0.0 : (-0.048000000000000001 * var_x110 * var_x133);
        IJth(rJacobian, 2, 2) = -0.001 * ((var_x210) ? (var_x208 * var_x209) : (3200.0)) - 0.080000000000000002 * var_x211;
        ...
        IJth(rJacobian, 3, 3) = -0.001 * ((var_x214) ? (135.0 * var_x213) : (0)) - 0.001 * ((var_x214) ? (3560.0 * var_x215 + 310000000.0 * var_x216) : (7692.3076923076924 / var_x218));
        IJth(rJacobian, 23, 3) = -var_x134 * var_x348;
        IJth(rJacobian, 0, 4) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x135 * var_x136);
        IJth(rJacobian, 4, 4) = -0.001 * ((var_x214) ? (121.2 * var_x231) : (300.0 * var_x235)) - 0.001 * ((var_x214) ? (var_x226 * var_x227) : (0));
        IJth(rJacobian, 23, 4) = -var_x136 * var_x348;
        IJth(rJacobian, 0, 5) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x111 * (var_x106 * var_x137 + var_x138 * var_x83 + var_x138 * var_x86));
        IJth(rJacobian, 1, 5) = -var_x197 * var_x198;
        IJth(rJacobian, 5, 5) = var_x239 * var_x248 - var_x238 * var_x248;
        IJth(rJacobian, 19, 5) = 0.001 * ((var_x343) ? (-var_x197 * var_x344) : (0));
        IJth(rJacobian, 23, 5) = -var_x349 * var_x350;
        IJth(rJacobian, 24, 5) = -var_x349 * var_x354;
        IJth(rJacobian, 0, 6) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x111 * (var_x106 * var_x139 + var_x140 * var_x83 + var_x140 * var_x86));
        IJth(rJacobian, 1, 6) = -var_x198 * var_x199;
        IJth(rJacobian, 6, 6) = var_x260 * var_x263 + var_x260 * var_x265;
        IJth(rJacobian, 19, 6) = 0.001 * ((var_x343) ? (-var_x199 * var_x344) : (0));
        IJth(rJacobian, 23, 6) = -var_x350 * var_x351;
        IJth(rJacobian, 24, 6) = -var_x351 * var_x354;
        IJth(rJacobian, 0, 7) = mSetVoltageDerivativeToZero ? 0.0 : (-0.0001 * var_x110 * var_x143);
        IJth(rJacobian, 1, 7) = -9.0316078310111336e-6 * var_x143 * var_x177;
        IJth(rJacobian, 7, 7) = -0.001 * var_x271;
        IJth(rJacobian, 19, 7) = 0.001 * ((var_x343) ? (-0.0090316078310111337 * var_x143 * var_x176) : (0));
        IJth(rJacobian, 0, 8) = mSetVoltageDerivativeToZero ? 0.0 : (-5.0000000000000002e-5 * var_x110 * var_x144);
        IJth(rJacobian, 1, 8) = -4.5158039155055668e-6 * var_x144 * var_x177;
        IJth(rJacobian, 8, 8) = -0.001 * var_x275;
        IJth(rJacobian, 19, 8) = 0.001 * ((var_x343) ? (-0.0045158039155055668 * var_x144 * var_x176) : (0));
        IJth(rJacobian, 0, 9) = mSetVoltageDerivativeToZero ? 0.0 : (-2.3862446088641737e-5 * var_x110 * var_x145);
        IJth(rJacobian, 9, 9) = -0.0013799999999999999 * var_x284 * var_x286 - 0.00060999999999999997 * var_x280 * var_x287;
        ...
        IJth(rJacobian, 10, 10) = -0.00013100000000000001 * var_x303 - 7.1899999999999999e-5 * var_x304;
        IJth(rJacobian, 24, 10) = var_x355 * var_chaste_interface__slow_delayed_rectifier_potassium_current_xs2_gate__xs2;
        IJth(rJacobian, 0, 11) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x147 * var_x148);
        IJth(rJacobian, 11, 11) = -3.2750000000000003e-5 * var_x303 - 1.7975e-5 * var_x304;
        IJth(rJacobian, 24, 11) = var_x355 * var_chaste_interface__slow_delayed_rectifier_potassium_current_xs1_gate__xs1;
        IJth(rJacobian, 0, 12) = mSetVoltageDerivativeToZero ? 0.0 : (-0.0015 * var_x110 * var_x149);
        IJth(rJacobian, 12, 12) = -var_x316 - 10.0 * var_x313;
        ...
        IJth(rJacobian, 13, 13) = -var_x336 - 0.10000000000000001 * var_x329;
        IJth(rJacobian, 24, 13) = -9.0316078310111333e-5 * var_x150 * var_x176;
        IJth(rJacobian, 1, 14) = 7.0588235294117632e-6 * var_x175 * var_x190;
        IJth(rJacobian, 14, 14) = var_x340 * (-5.5555555555555554 - var_x190) + 0.00025000000000000001 * (5.5555555555555554 * var_chaste_interface__calcium_dynamics__Ca_NSR - 5.5555555555555554 * var_chaste_interface__calcium_dynamics__Ca_JSR - var_x190 * var_x195) / (pow(var_x337, 3) * pow((0.125 + var_x338), 2));
        IJth(rJacobian, 15, 14) = 0.00048309178743961351;
        IJth(rJacobian, 1, 15) = 4.7352941176470584e-5 * var_x175;
        IJth(rJacobian, 14, 15) = 0.0055555555555555558 * var_x339;
        IJth(rJacobian, 15, 15) = -0.001066425120772947;
        IJth(rJacobian, 16, 16) = 0.001 * ((var_x110 * (var_x196 + 0.00025000000000000001 * var_x49 + 0.0070160275741043606 * var_chaste_interface__membrane__V - 0.10684935482199306 * var_x130 - 7.3656881518639831e-7 * var_x5 + var_x131 * var_x22 + var_x152 * var_x26 + var_x18 * var_x38 + var_x3 * var_x38 + var_x37 * var_x38 + var_x38 * var_x62 + var_x84 * var_chaste_interface__membrane__V + var_x87 * var_chaste_interface__membrane__V + GetIntracellularAreaStimulus(var_chaste_interface__environment__time_converted) / HeartConfig::Instance()->GetCapacitance() + 0.433 * var_x123 * (1.0 + 0.59999999999999998 * var_x54)) < -150000.0) ? (-100500.0) : (-500.0));
        IJth(rJacobian, 1, 17) = var_x200 * var_x201;
        IJth(rJacobian, 14, 17) = var_x200 * var_x341;
        IJth(rJacobian, 17, 17) = 0.001 * ((var_x342) ? (-100500.0) : (-500.0));
        IJth(rJacobian, 18, 18) = 0.001 * ((var_x342) ? (-100500.0) : (-10.0));
        IJth(rJacobian, 1, 19) = var_x201 * var_x203;
        IJth(rJacobian, 14, 19) = var_x203 * var_x341;
        IJth(rJacobian, 19, 19) = 0.001 * (((var_x343) || (var_chaste_interface__calcium_dynamics__APtrack2 > 0.01)) ? (0) : (-500.0));
        ...
        IJth(rJacobian, 1, 21) = var_x201 * var_x204;
        IJth(rJacobian, 14, 21) = var_x204 * var_x341;
        IJth(rJacobian, 21, 21) = 0.001 * (((var_x345) && (var_chaste_interface__calcium_dynamics__OVRLDtrack2 < 0.97999999999999998)) ? (-50000.0) : (-500.0));
        IJth(rJacobian, 22, 22) = 0.001 * (((var_x345) && (var_chaste_interface__calcium_dynamics__OVRLDtrack3 < 0.97999999999999998)) ? (-50000.0) : (-10.0));
        ...
        IJth(rJacobian, 19, 23) = 0.001 * ((var_x343) ? (-var_x193 * (var_x159 - var_x156)) : (0));
        IJth(rJacobian, 23, 23) = var_x347 * (-var_x151 - var_x157 - var_x162 + 4.0500000000000004e-7 * var_x158 - 0.0040499999999999998 * var_x155 - 0.10125000000000001 * var_x153);
        IJth(rJacobian, 24, 23) = var_x347 * (3.3880737654706117 * var_x356 + 0.067500000000000004 * var_x153);
        ...
        IJth(rJacobian, 24, 24) = var_x347 * (var_x170 - var_x163 - var_x164 - var_x165 - var_x166 - var_x168 - var_x169 - var_x171 + 184.83763041301756 * var_x356);
    }
