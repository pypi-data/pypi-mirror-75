...
#include "MathsCustomFunctions.hpp"
    ...
    boost::shared_ptr<RegularStimulus> Cellhund_rudy_2004_aFromCellMLRushLarsen::UseCellMLDefaultStimulus()
    {
    ...
    double Cellhund_rudy_2004_aFromCellMLRushLarsen::GetIntracellularCalciumConcentration()
    {
        return mStateVariables[1];
    }
    Cellhund_rudy_2004_aFromCellMLRushLarsen::Cellhund_rudy_2004_aFromCellMLRushLarsen(boost::shared_ptr<AbstractIvpOdeSolver> /* unused; should be empty */, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
                ...
                pIntracellularStimulus)
    {
        ...
        //
        this->mpSystemInfo = OdeSystemInformation<Cellhund_rudy_2004_aFromCellMLRushLarsen>::Instance();
        Init();
    ...
    Cellhund_rudy_2004_aFromCellMLRushLarsen::~Cellhund_rudy_2004_aFromCellMLRushLarsen()
    {
    }
    
    double Cellhund_rudy_2004_aFromCellMLRushLarsen::GetIIonic(const std::vector<double>* pStateVariables)
    {
    ...
    void Cellhund_rudy_2004_aFromCellMLRushLarsen::EvaluateEquations(double var_chaste_interface__Environment__time, std::vector<double> &rDY, std::vector<double> &rAlphaOrTau, std::vector<double> &rBetaOrInf)
    {
    ...
    void Cellhund_rudy_2004_aFromCellMLRushLarsen::ComputeOneStepExceptVoltage(const std::vector<double> &rDY, const std::vector<double> &rAlphaOrTau, const std::vector<double> &rBetaOrInf)
    {
        std::vector<double>& rY = rGetStateVariables();
    ...
    std::vector<double> Cellhund_rudy_2004_aFromCellMLRushLarsen::ComputeDerivedQuantities(double var_chaste_interface__Environment__time, const std::vector<double> & rY)
    {
        // Inputs:
        // Time units: millisecond
...
template<>
void OdeSystemInformation<Cellhund_rudy_2004_aFromCellMLRushLarsen>::Initialise(void)
{
