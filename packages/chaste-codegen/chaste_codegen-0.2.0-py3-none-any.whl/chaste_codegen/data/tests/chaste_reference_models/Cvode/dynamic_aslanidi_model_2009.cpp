...
#include "MathsCustomFunctions.hpp"
    ...
    boost::shared_ptr<RegularStimulus> Dynamicaslanidi_model_2009FromCellMLCvodeOpt::UseCellMLDefaultStimulus()
    {
        // Use the default stimulus specified by CellML metadata
        const double var_chaste_interface__membrane__stim_amplitude_converted = -0.019999999999999997 * HeartConfig::Instance()->GetCapacitance() / NV_Ith_S(mParameters, 0); // uA_per_cm2
    ...
    Dynamicaslanidi_model_2009FromCellMLCvodeOpt::Dynamicaslanidi_model_2009FromCellMLCvodeOpt(boost::shared_ptr<AbstractIvpOdeSolver> pOdeSolver /* unused; should be empty */, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
                ...
                pIntracellularStimulus)
    {
        ...
        //
        this->mpSystemInfo = OdeSystemInformation<Dynamicaslanidi_model_2009FromCellMLCvodeOpt>::Instance();
        Init();
    ...
    Dynamicaslanidi_model_2009FromCellMLCvodeOpt::~Dynamicaslanidi_model_2009FromCellMLCvodeOpt()
    {
    }
    
    double Dynamicaslanidi_model_2009FromCellMLCvodeOpt::GetIIonic(const std::vector<double>* pStateVariables)
    {
    ...
    void Dynamicaslanidi_model_2009FromCellMLCvodeOpt::EvaluateYDerivatives(double var_chaste_interface__environment__time_converted, const N_Vector rY, N_Vector rDY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : mp_membrane_voltage_modifier->Calc(NV_Ith_S(rY, 0), var_chaste_interface__environment__time_converted));
        // Units: millivolt; Initial value: -80.0
        double var_chaste_interface__sodium_current_m_gate__m = NV_Ith_S(rY, 1);
        // Units: dimensionless; Initial value: 0.01309
        double var_chaste_interface__sodium_current_h1_gate__h1 = NV_Ith_S(rY, 2);
    ...
    N_Vector Dynamicaslanidi_model_2009FromCellMLCvodeOpt::ComputeDerivedQuantities(double var_chaste_interface__environment__time_converted, const N_Vector & rY)
    {
        // Inputs:
        // Time units: millisecond
        
        // Mathematics
        const double var_membrane__Cm_converted = mp_membrane_capacitance_modifier->Calc(0.001 * NV_Ith_S(mParameters, 0), var_chaste_interface__environment__time_converted); // uF
...
template<>
void OdeSystemInformation<Dynamicaslanidi_model_2009FromCellMLCvodeOpt>::Initialise(void)
{
...
extern "C"
{
    ...
    {
        return new Dynamicaslanidi_model_2009FromCellMLCvodeOpt(pSolver, pStimulus);
    }
