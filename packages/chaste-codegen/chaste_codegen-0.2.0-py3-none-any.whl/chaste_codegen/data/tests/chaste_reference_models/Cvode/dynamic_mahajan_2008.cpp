...
#include "dynamic_mahajan_2008.hpp"
#include <cmath>
#include <cassert>
#include <memory>
...
#include "MathsCustomFunctions.hpp"
    ...
    N_Vector Dynamicmahajan_2008FromCellMLCvode::ComputeDerivedQuantities(double var_chaste_interface__Environment__time, const N_Vector & rY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__Ca__Ca_i_converted = NV_Ith_S(rY, 1);
