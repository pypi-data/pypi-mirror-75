    ...
    def __init__(self, param):
        if param == 'T':
            ...
            sqlafricab = """select distinct b.symbol,ba.prio from benchmark_master b join
                benchmark_all ba on b.symbol=ba.symbol where ba.prio=2 and ba.symbol='TA100.INDX'
        ...
        with conn:
            ...
            if len(results)>0:
                ...
                print("For africa run, no stocks were found with stocks under israeli index")
            ...
            if len(resultsb)>0:
                ...
                print("For africa run, no benchmarks were found with benchmarks under israeli index")
