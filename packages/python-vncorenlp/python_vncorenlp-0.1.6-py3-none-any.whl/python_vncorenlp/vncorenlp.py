...
def load_autoclass():
    ...
    return autoclass('java.util.ArrayList'), \
        autoclass('vn.corenlp.wordsegmenter.Vocabulary'), \
        autoclass('vn.pipeline.LexicalInitializer'), \
        autoclass('vn.corenlp.wordsegmenter.WordSegmenter'). \
        autoclass('vn.corenlp.postagger.PosTagger'), \
        autoclass('vn.corenlp.ner.NerRecognizer'), \
        autoclass('vn.corenlp.parser.DependencyParser'), \
        autoclass('vn.pipeline.VnCoreNLP')
...
class Package:
    ...
    @classmethod
    def load_class(cls):
        cls.ArrayList, cls.Vocabulary, cls.LexicalInitializer, cls.WordSegmenter, cls.PosTagger, cls.NerRecognizer, cls.DependencyParser, cls.VnCoreNLP = load_autoclass()
