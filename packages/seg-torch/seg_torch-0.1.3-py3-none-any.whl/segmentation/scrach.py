...
if __name__ == '__main__':
    ...
    model.to(device)
    logger.load_models(model, 'epoch_153')
    # Optimizers
    ...
    #                   train_loader, test_loader, epoch=154, check_point_epoch_stride=check_point_stride)
    # trainer.train()

    # Get result
    predict(model, r'C:\Dropbox\Dropbox\python\pytorch\docs\exam_result\input2.png',
             r'C:\Dropbox\Dropbox\python\pytorch\docs\exam_result\output2.png')
