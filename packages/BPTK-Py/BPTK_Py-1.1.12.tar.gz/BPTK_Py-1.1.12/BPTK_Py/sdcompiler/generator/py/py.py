...
def savediv_(*args):
    ...
    return '0' if onzero is None else str(onzero) + ' if ' + denominator + ' == 0 else ' + nominator + ' / ' + denominator
...
def permutations_(*args):
    ...
    return "( math.factorial( {} ) / math.factorial( {} - {} ) )".format(n,n,r)
...
builtins = {
    ...
    'savediv': lambda *args: savediv_(args),
