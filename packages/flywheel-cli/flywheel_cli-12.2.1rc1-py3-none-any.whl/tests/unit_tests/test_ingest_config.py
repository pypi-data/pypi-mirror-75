...
def test_add_arguments():
    class DummyConfig(config.BaseConfig):
        param1: bool
        param2: str
        param3: bool = False
        param4: str = "default"
    ...
    cfg = DummyConfig
    parser = mock.Mock()
    config.add_arguments(cfg, parser)
    ...
    assert parser.mock_calls == [
        ...
        mock.call.add_argument(
            "--param2", dest="param2", help="param2 value", metavar="param2", nargs="??"
        ),
        mock.call.add_argument(
            "-p",
            "--param3",
            action="store_true",
            dest="param3",
            help="param3 value (default: False)",
        ),
        mock.call.add_argument(
            "-x", "--param4", dest="param4", help="param4 value (default: default)"
        ),
    ]
