...
class FolderImporter(AbstractImporter):
    ...
    def __init__(
        ...
        super(FolderImporter, self).__init__(
            group, project, repackage_archives, context, config
        )
    ...
    def visit_dir(self, walker, queue, target):  # pylint: disable=too-many-branches
            ...
            for dirname in dirs:
                ...
                if not child_context.get("ignore", False):
                    ...
                    if next_node and next_node.node_type == "scanner":
                        ...
                        queue.put(
                            VisitTarget(
                                child_path, resolve_child, child_context, next_node
                            )
                        )
