...
class SurfingEntrance(object):
    ...
    def calc_fund_estimated_nav(self):
        ...
        from .data.fund.basic.basic_data_helper import BasicDataHelper
        from .data.fund.basic.basic_data_part3_estimated_nav import BasicDataPart3
        basic_data_processor = BasicDataPart3(BasicDataHelper())
        basic_data_processor.calc_fund_estimated_nav(stock_minute_df)
