...
class ReportHelper:
    ...
    def get_rebalance_detail(self):
        ...
        turnover_df = trade_df.groupby('trade_date').sum()[['amount']].join(fund_mv).copy()
        ...
        _rb_df = _rb_df[['trade_date','rebalance reason']].set_index('trade_date').copy()
        turnover_df['turnover'] = turnover_df['amount'] / turnover_df['mv'] / 2
        ...
        return turnover_df[['turnover','hold_year','rebalance reason']]
