...
class FundEstimatedNav(Base):
    '''基金估算净值表'''

    __tablename__ = 'fund_estimated_nav'
    fund_id = Column(CHAR(20), primary_key=True) # 合约代码
    datetime = Column(DATETIME, primary_key=True) # 估算时间
    ...
    __table_args__ = (
        Index('idx_fund_estimated_nav_datetime', 'datetime'),
    )
