...
class FundScoreExtended(Base):
    ...
    ret = Column(DOUBLE(asdecimal=False), nullable=False)  # ret
    vol = Column(DOUBLE(asdecimal=False), nullable=False)  # volatility
    ...
    mdd = Column(DOUBLE(asdecimal=False), nullable=False)  # max drawdown
    timing = Column(DOUBLE(asdecimal=False))  # timing
    ret_score = Column(DOUBLE(asdecimal=False), nullable=False)  # score of ret
    vol_score = Column(DOUBLE(asdecimal=False), nullable=False)  # score of volatility
    ...
    mdd_score = Column(DOUBLE(asdecimal=False), nullable=False)  # score of max drawdown
    return_score = Column(DOUBLE(asdecimal=False), nullable=False)  # score of return
    robust_score = Column(DOUBLE(asdecimal=False), nullable=False)  # score of robust
    timing_score = Column(DOUBLE(asdecimal=False))  # score of timing
    return_rank = Column(DOUBLE(asdecimal=False), nullable=False)  # rank of return
    robust_rank = Column(DOUBLE(asdecimal=False), nullable=False)  # rank of robust
    ...
    total_rank = Column(DOUBLE(asdecimal=False), nullable=False)  # rank of total

    __table_args__ = (
        Index('idx_fund_score_extended_datetime', 'datetime'),
    )
