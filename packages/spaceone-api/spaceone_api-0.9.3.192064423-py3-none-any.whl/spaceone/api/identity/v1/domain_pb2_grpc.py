...
class Domain(object):
    ...
    def get_domain_key(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/spaceone.api.identity.v1.Domain/get_domain_key',
            spaceone_dot_api_dot_core_dot_v1_dot_handler__pb2.AuthenticationRequest.SerializeToString,
            spaceone_dot_api_dot_identity_dot_v1_dot_domain__pb2.DomainKeyResponse.FromString,
            options, channel_credentials,
            call_credentials, compression, wait_for_ready, timeout, metadata)
