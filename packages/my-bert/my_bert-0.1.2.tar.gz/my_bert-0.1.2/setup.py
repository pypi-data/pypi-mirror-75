...
setuptools.setup(
    name="my_bert",                                     # 包的分发名称，使用字母、数字、_、-
    version="0.1.2",                                        # 版本号, 版本号规范：https://www.python.org/dev/peps/pep-0440/
    author="hzfei",                                       # 作者名字
    author_email="1027551108@qq.com",                      # 作者邮箱
    description="just a bert tool",                            # 包的简介描述
    ...
    url="https://github.com/hzfei/my-bert",                              # 项目开源地址，我这里写的是同性交友官网，大家可以写自己真实的开源网址
