...
class LambdaToS3(
    ...
    def __init__(
        ...
        id: str,
        *,
        bucket_permissions: typing.Optional[typing.List[str]] = None,
...
class LambdaToS3Props:
    ...
    @builtins.property
    def bucket_permissions(self) -> typing.Optional[typing.List[str]]:
        ...
        """
        return self._values.get("bucket_permissions")
