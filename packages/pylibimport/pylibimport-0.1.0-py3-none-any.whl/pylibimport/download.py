...
if __name__ == '__main__':
    ...
    P.add_argument('version', type=str, help="Version number you want to download.")
    ...
    FILENAME = HttpListVersions.download(ARGS.package, ARGS.version, download_dir=ARGS.download_dir,
