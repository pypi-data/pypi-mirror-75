...
class Binomial(Distribution):
    ...
    def __init__(self, mu=0, sigma=1, prob=.5, size=20):
        ...
        """ initialization method of the binomial distribution 
        ...
        Args:   
            ...
            data_list (list of floats): a list of floats to be extracted 
                                            from the data file
            p (float): the probability of an event occuring 
            n (int): the total number of trials 
    ...
    def calculate_mean(self):
        ...
        """ A method to calculate the mean of a binomial distribution
    ...
    def calculate_stdev(self):
        """ A method to calculate the standard deviation of a 
        ...
        Return:
            float: The standard deviation of a binomial distribution
        """
    ...
    def pdf(self, k):
        ...
        combinatorics = 1.0 * math.factorial(self.n) / math.factorial(k) * math.factorial(self.n - k)
        x = math.pow(self.p, k) * math.pow(1 - p, n - k)
