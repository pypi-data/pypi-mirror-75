...
class MySprite(pygame.sprite.Sprite):
    def __init__(self, init_pos: Vector2, width: int, height: int):
        super().__init__()
...
class RectangleSprite(MySprite):
    def __init__(self, init_pos: Vector2, color: Color, width: int, height: int):
        # Call the parent class (Sprite) constructor
        MySprite.__init__(self, init_pos, width, height)
