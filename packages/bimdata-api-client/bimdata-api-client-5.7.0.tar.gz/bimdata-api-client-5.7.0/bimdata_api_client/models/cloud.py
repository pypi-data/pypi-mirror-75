...
class Cloud(object):
    ...
    def __init__(self, id=None, name=None, features=None, creator=None, creator_app=None, is_default=None, created_at=None, image=None, updated_at=None, local_vars_configuration=None):  # noqa: E501
