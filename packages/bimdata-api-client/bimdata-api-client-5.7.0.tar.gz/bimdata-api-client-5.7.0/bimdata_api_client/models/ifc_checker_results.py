...
class IfcCheckerResults(object):
    ...
    def __init__(self, id=None, error_detail=None, status=None, result=None, collisions=None, created_at=None, updated_at=None, checker=None, local_vars_configuration=None):  # noqa: E501
    ...
    def checker(self, checker):
        ...
        :type: int
        """
        if self.local_vars_configuration.client_side_validation and checker is None:  # noqa: E501
