...
class IfcCheckerCheckplan(object):
    ...
    def __init__(self, id=None, name=None, description=None, created_at=None, updated_at=None, protected=None, project=None, local_vars_configuration=None):  # noqa: E501
