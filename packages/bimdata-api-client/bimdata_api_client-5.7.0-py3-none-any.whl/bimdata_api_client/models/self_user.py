...
class SelfUser(object):
    ...
    def __init__(self, id=None, email=None, company=None, firstname=None, lastname=None, created_at=None, updated_at=None, clouds=None, projects=None, provider=None, provider_sub=None, sub=None, local_vars_configuration=None):  # noqa: E501
    ...
    def sub(self, sub):
        ...
        """
        if (self.local_vars_configuration.client_side_validation and
                sub is not None and len(sub) > 255):
