...
class IfcFiles(object):
    ...
    def __init__(self, structure_file=None, systems_file=None, map_file=None, gltf_file=None, bvh_tree_file=None, viewer_360_file=None, xkt_file=None, local_vars_configuration=None):  # noqa: E501
