...
class Feature(object):
    ...
    def __init__(self, name=None, viewer_url=None, local_vars_configuration=None):  # noqa: E501
    ...
    def name(self, name):
        ...
        if (self.local_vars_configuration.client_side_validation and
                name is not None and len(name) > 127):
    ...
    def viewer_url(self, viewer_url):
        ...
        """
        if (self.local_vars_configuration.client_side_validation and
                viewer_url is not None and len(viewer_url) > 512):
