...
class PythonScriptStep(_PythonScriptStepBase):
    ...
    .. remarks::
        ...
        :class:`azureml.pipeline.core.pipeline_output_dataset.PipelineOutputTabularDataset`,
        :class:`azureml.pipeline.core.pipeline_output_dataset.PipelineOutputFileDataset`,
