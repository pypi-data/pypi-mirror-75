...
function GetOciCommandsToLongParams_data_catalog() {
    $ociCommandsToLongParams = @{
        'data-catalog attribute create' = 'catalog-id data-asset-key description display-name entity-key external-data-type from-json help is-incremental-data is-nullable length max-wait-seconds position precision properties scale time-external wait-for-state wait-interval-seconds'
        ...
        'data-catalog attribute list' = 'all catalog-id created-by-id data-asset-key display-name entity-key external-key external-type-name fields from-json help is-incremental-data is-nullable length lifecycle-state limit page page-size position precision scale sort-by sort-order time-created time-external time-updated updated-by-id'
        'data-catalog attribute update' = 'attribute-key catalog-id data-asset-key description display-name entity-key external-data-type force from-json help if-match is-incremental-data is-nullable length max-wait-seconds position precision properties scale time-external wait-for-state wait-interval-seconds'
        ...
        'data-catalog connection list' = 'all catalog-id created-by-id data-asset-key display-name external-key fields from-json help is-default lifecycle-state limit page page-size sort-by sort-order time-created time-status-updated time-updated updated-by-id'
        ...
        'data-catalog data-asset list' = 'all catalog-id created-by-id display-name external-key fields from-json help lifecycle-state limit page page-size sort-by sort-order time-created time-updated type-key updated-by-id'
        ...
        'data-catalog entity list' = 'all catalog-id created-by-id data-asset-key display-name external-key fields folder-key from-json harvest-status help is-logical is-partition last-job-key lifecycle-state limit page page-size path sort-by sort-order time-created time-external time-status-updated time-updated updated-by-id'
        ...
        'data-catalog folder list' = 'all catalog-id created-by-id data-asset-key display-name external-key fields from-json harvest-status help last-job-key lifecycle-state limit page page-size parent-folder-key path sort-by sort-order time-created time-updated updated-by-id'
        ...
        'data-catalog glossary list' = 'all catalog-id created-by-id display-name fields from-json help lifecycle-state limit page page-size sort-by sort-order time-created time-updated updated-by-id'
        ...
        'data-catalog job list' = 'all catalog-id connection-key created-by-id display-name execution-count fields from-json help job-definition-key job-type lifecycle-state limit page page-size schedule-cron-expression schedule-type sort-by sort-order time-created time-of-latest-execution time-schedule-begin time-schedule-end time-updated updated-by-id'
        ...
        'data-catalog job-definition list' = 'all catalog-id connection-key created-by-id data-asset-key display-name fields from-json help is-incremental job-type lifecycle-state limit page page-size sample-data-size-in-mbs sort-by sort-order time-created time-updated updated-by-id'
        ...
        'data-catalog job-metric list' = 'all batch-key catalog-id category created-by-id display-name fields from-json help job-execution-key job-key limit page page-size sort-by sort-order sub-category time-created time-inserted time-updated unit updated-by-id value'
        ...
        'data-catalog tag list' = 'all catalog-id display-name fields from-json help lifecycle-state limit page page-size sort-by sort-order'
        ...
        'data-catalog term list' = 'all catalog-id display-name fields from-json glossary-key help is-allowed-to-have-child-terms lifecycle-state limit page page-size parent-term-key path sort-by sort-order workflow-status'
        ...
        'data-catalog term-relationship list' = 'all catalog-id display-name fields from-json glossary-key help lifecycle-state limit page page-size sort-by sort-order term-key'
