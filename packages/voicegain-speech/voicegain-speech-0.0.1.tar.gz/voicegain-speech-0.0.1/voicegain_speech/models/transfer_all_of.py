...
class TransferAllOf(object):
    ...
    @property
    def method(self):
        """Gets the method of this TransferAllOf.  # noqa: E501

        method the text was output (Voice UI or GUI)  # noqa: E501

        :return: The method of this TransferAllOf.  # noqa: E501
        :rtype: str
        """
        return self._method
    ...
    def method(self, method):
        """Sets the method of this TransferAllOf.

        method the text was output (Voice UI or GUI)  # noqa: E501

        :param method: The method of this TransferAllOf.  # noqa: E501
        :type: str
        """
    ...
    @property
    def outcome(self):
        """Gets the outcome of this TransferAllOf.  # noqa: E501

        outcome of the transfer  # noqa: E501

        :return: The outcome of this TransferAllOf.  # noqa: E501
        :rtype: str
        """
    ...
    def outcome(self, outcome):
        """Sets the outcome of this TransferAllOf.

        outcome of the transfer  # noqa: E501

        :param outcome: The outcome of this TransferAllOf.  # noqa: E501
        :type: str
        """
    ...
    def outcome_detail(self):
        """Gets the outcome_detail of this TransferAllOf.  # noqa: E501
        ...
        :return: The outcome_detail of this TransferAllOf.  # noqa: E501
        :rtype: str
        """
    ...
    def outcome_detail(self, outcome_detail):
        """Sets the outcome_detail of this TransferAllOf.

        Detailed reason for \"outcome==fail\", e.g. \"NO_ANSWER\", see: https://freeswitch.org/confluence/display/FREESWITCH/Hangup+Cause+Code+Table   # noqa: E501

        :param outcome_detail: The outcome_detail of this TransferAllOf.  # noqa: E501
        :type: str
        """
    ...
    @text.setter
    def text(self, text):
        """Sets the text of this TransferAllOf.

        (optional) text of the prompt (dis)played before transfer - will include all resolved variables if applicable  # noqa: E501

        :param text: The text of this TransferAllOf.  # noqa: E501
        :type: str
        """
    ...
    def transfer_destination(self):
        """Gets the transfer_destination of this TransferAllOf.  # noqa: E501
        ...
        :return: The transfer_destination of this TransferAllOf.  # noqa: E501
        :rtype: str
        """
    ...
    def transfer_destination(self, transfer_destination):
        """Sets the transfer_destination of this TransferAllOf.

        Destination of the transfer, e.g.</br> + if transferType=logic then transferDestination will be the logic name e.g. \"unavailables\" + if transferType=conference the transferDestination will be the name of the conference + if transferType=phone the transferDestination will be the phone number   # noqa: E501

        :param transfer_destination: The transfer_destination of this TransferAllOf.  # noqa: E501
        :type: str
        """
    ...
    def transfer_type(self):
        """Gets the transfer_type of this TransferAllOf.  # noqa: E501
        ...
        :return: The transfer_type of this TransferAllOf.  # noqa: E501
        :rtype: str
        """
    ...
    def transfer_type(self, transfer_type):
        """Sets the transfer_type of this TransferAllOf.

        + `logic` - transfer to different IVR logic.</br> + `conference` - transfer to FreeSWITCH conference.</br> + `phone` - transfer to a telephone.   # noqa: E501

        :param transfer_type: The transfer_type of this TransferAllOf.  # noqa: E501
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, TransferAllOf):
            return False
