...
class AIVRPrompt(object):
    ...
    def audio_properties(self):
        """Gets the audio_properties of this AIVRPrompt.  # noqa: E501


        :return: The audio_properties of this AIVRPrompt.  # noqa: E501
    ...
    def audio_properties(self, audio_properties):
        """Sets the audio_properties of this AIVRPrompt.


        :param audio_properties: The audio_properties of this AIVRPrompt.  # noqa: E501
    ...
    def html_properties(self):
        """Gets the html_properties of this AIVRPrompt.  # noqa: E501


        :return: The html_properties of this AIVRPrompt.  # noqa: E501
    ...
    def html_properties(self, html_properties):
        """Sets the html_properties of this AIVRPrompt.


        :param html_properties: The html_properties of this AIVRPrompt.  # noqa: E501
    ...
    @property
    def wait_msec(self):
        """Gets the wait_msec of this AIVRPrompt.  # noqa: E501
        ...
        :return: The wait_msec of this AIVRPrompt.  # noqa: E501
        :rtype: int
        """
    ...
    def wait_msec(self, wait_msec):
        """Sets the wait_msec of this AIVRPrompt.

        Wait time in milliseconds after playing or displaying the prompt before a callback will be made.</br> Meant mainly for GUI and has different meanings for prompt and a question:</br> **for prompt**  It is recommended to use so that interactions are paced in such a way so that the caller has sufficient time to read the prompt.</br> **for question** It is fully optional and can be used as a sort of timeout, that will allow to proceed if caller does not provide requested input.   # noqa: E501

        :param wait_msec: The wait_msec of this AIVRPrompt.  # noqa: E501
        :type: int
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AIVRPrompt):
            return False
