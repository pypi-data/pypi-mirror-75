...
class RequestedContent(object):
    ...
    """
    openapi_types = {
        'full': 'list[ContentType]',
        'incremental': 'list[ContentType]'
    }
    ...
    def __init__(self, full=["progress","transcript"], incremental=None, local_vars_configuration=None):  # noqa: E501
        """RequestedContent - a model defined in OpenAPI"""  # noqa: E501
    ...
    def full(self):
        ...
        Types of content to be returned when ASR is done with processing all audio.  Note, to suppress full result, specify empty array to replace the default.   # noqa: E501
    ...
    def incremental(self):
        """Gets the incremental of this RequestedContent.  # noqa: E501

        Types of incremental content to be returned from ASR while it is processing the audio: + **progress** - progress information + **words** - words with confidence and timing info + **word-tree** -- words with confidence and timing info plus word and parent ids - enables constructing a tree with recognition alternatives + **transcript** - just the text of transcription + **captions** - captions             There is no default but if **missing** then: + if **polling** with parameter **full=false** - only **progress** will be returned + if **callback** requested then **no** incremental callback will be made   # noqa: E501

        :return: The incremental of this RequestedContent.  # noqa: E501
        :rtype: list[ContentType]
        """
    ...
    def incremental(self, incremental):
        """Sets the incremental of this RequestedContent.

        Types of incremental content to be returned from ASR while it is processing the audio: + **progress** - progress information + **words** - words with confidence and timing info + **word-tree** -- words with confidence and timing info plus word and parent ids - enables constructing a tree with recognition alternatives + **transcript** - just the text of transcription + **captions** - captions             There is no default but if **missing** then: + if **polling** with parameter **full=false** - only **progress** will be returned + if **callback** requested then **no** incremental callback will be made   # noqa: E501

        :param incremental: The incremental of this RequestedContent.  # noqa: E501
        :type: list[ContentType]
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, RequestedContent):
            return False
