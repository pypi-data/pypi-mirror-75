...
class WordItemTiming(object):
    ...
    def __init__(self, duration=None, start=None, local_vars_configuration=None):  # noqa: E501
        """WordItemTiming - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def duration(self):
        """Gets the duration of this WordItemTiming.  # noqa: E501

        duration of the word (in msec)  # noqa: E501

        :return: The duration of this WordItemTiming.  # noqa: E501
        :rtype: float
        """
    ...
    def duration(self, duration):
        """Sets the duration of this WordItemTiming.

        duration of the word (in msec)  # noqa: E501

        :param duration: The duration of this WordItemTiming.  # noqa: E501
        :type: float
        """
    ...
    @property
    def start(self):
        """Gets the start of this WordItemTiming.  # noqa: E501

        start time (in msec) of the word since the beginning of the audio  # noqa: E501

        :return: The start of this WordItemTiming.  # noqa: E501
        :rtype: int
        """
        return self._start
    ...
    def start(self, start):
        """Sets the start of this WordItemTiming.

        start time (in msec) of the word since the beginning of the audio  # noqa: E501

        :param start: The start of this WordItemTiming.  # noqa: E501
        :type: int
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, WordItemTiming):
            return False
