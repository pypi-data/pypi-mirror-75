...
class StreamResp(object):
    ...
    def port(self, port):
        ...
        if (self.local_vars_configuration.client_side_validation and
                port is not None and port < 5000):  # noqa: E501
            raise ValueError("Invalid value for `port`, must be a value greater than or equal to `5000`")  # noqa: E501
    ...
    def sid(self, sid):
        ...
        """
        if (self.local_vars_configuration.client_side_validation and
                sid is not None and sid > 65535):  # noqa: E501
            raise ValueError("Invalid value for `sid`, must be a value less than or equal to `65535`")  # noqa: E501
        if (self.local_vars_configuration.client_side_validation and
                sid is not None and sid < 1):  # noqa: E501
            raise ValueError("Invalid value for `sid`, must be a value greater than or equal to `1`")  # noqa: E501

        self._sid = sid

    @property
    def websocket_url(self):
        """Gets the websocket_url of this StreamResp.  # noqa: E501

        For WEBSOCKET protocol only - URL to which the audio data should be streamed to (as binary data in Websocket messages).  # noqa: E501

        :return: The websocket_url of this StreamResp.  # noqa: E501
        :rtype: str
        """
    ...
    def websocket_url(self, websocket_url):
        """Sets the websocket_url of this StreamResp.

        For WEBSOCKET protocol only - URL to which the audio data should be streamed to (as binary data in Websocket messages).  # noqa: E501

        :param websocket_url: The websocket_url of this StreamResp.  # noqa: E501
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, StreamResp):
            return False
