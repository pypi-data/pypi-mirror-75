...
class CallbackResp(object):
    ...
    def __init__(self, uri=None, local_vars_configuration=None):  # noqa: E501
        """CallbackResp - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def uri(self):
        """Gets the uri of this CallbackResp.  # noqa: E501

        (Required) uri to which the callback will be made ( after substitution of any {sessionId} parameters).  # noqa: E501

        :return: The uri of this CallbackResp.  # noqa: E501
        :rtype: str
        """
        return self._uri
    ...
    @uri.setter
    def uri(self, uri):
        """Sets the uri of this CallbackResp.

        (Required) uri to which the callback will be made ( after substitution of any {sessionId} parameters).  # noqa: E501

        :param uri: The uri of this CallbackResp.  # noqa: E501
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CallbackResp):
            return False
