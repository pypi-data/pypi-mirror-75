...
class AIVRPromptPropertiesHtml(object):
    ...
    def __init__(self, group=None, local_vars_configuration=None):  # noqa: E501
        """AIVRPromptPropertiesHtml - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def group(self):
        """Gets the group of this AIVRPromptPropertiesHtml.  # noqa: E501

        name of the group that is to be used to wrap this prompt  # noqa: E501

        :return: The group of this AIVRPromptPropertiesHtml.  # noqa: E501
        :rtype: str
        """
        return self._group
    ...
    def group(self, group):
        """Sets the group of this AIVRPromptPropertiesHtml.

        name of the group that is to be used to wrap this prompt  # noqa: E501

        :param group: The group of this AIVRPromptPropertiesHtml.  # noqa: E501
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AIVRPromptPropertiesHtml):
            return False
