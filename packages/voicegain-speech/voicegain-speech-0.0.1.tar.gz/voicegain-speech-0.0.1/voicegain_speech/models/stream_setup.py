...
class StreamSetup(object):
    ...
    def __init__(self, auth_conf=None, control_websocket=None, protocol=None, local_vars_configuration=None):  # noqa: E501
        """StreamSetup - a model defined in OpenAPI"""  # noqa: E501
    ...
    def auth_conf(self):
        ...
        Name or UUID of the Authentication Config used to specify the allowed src_ip of the client.  If absent only stream coming from the same IP as the web API request will be allowed.</br> Can be defined via Voicegain Portal. **(Not implemented yet)**   # noqa: E501
    ...
    def control_websocket(self):
        ...
        :rtype: str
        """
        return self._control_websocket

    @control_websocket.setter
    ...
    @property
    def protocol(self):
        """Gets the protocol of this StreamSetup.  # noqa: E501


        :return: The protocol of this StreamSetup.  # noqa: E501
        :rtype: StreamingProtocol
        """
        return self._protocol

    @protocol.setter
    def protocol(self, protocol):
        """Sets the protocol of this StreamSetup.


        :param protocol: The protocol of this StreamSetup.  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, StreamSetup):
            return False
