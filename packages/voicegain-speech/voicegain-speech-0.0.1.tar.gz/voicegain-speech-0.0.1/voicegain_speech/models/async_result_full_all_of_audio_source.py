...
class AsyncResultFullAllOfAudioSource(object):
    ...
    """
    openapi_types = {
        'data_store': 'AsyncResultFullAllOfAudioSourceDataStore'
    }
    ...
    def __init__(self, data_store=None, local_vars_configuration=None):  # noqa: E501
        """AsyncResultFullAllOfAudioSource - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def data_store(self):
        """Gets the data_store of this AsyncResultFullAllOfAudioSource.  # noqa: E501


        :return: The data_store of this AsyncResultFullAllOfAudioSource.  # noqa: E501
        :rtype: AsyncResultFullAllOfAudioSourceDataStore
        """
        return self._data_store

    @data_store.setter
    def data_store(self, data_store):
        """Sets the data_store of this AsyncResultFullAllOfAudioSource.


        :param data_store: The data_store of this AsyncResultFullAllOfAudioSource.  # noqa: E501
        :type: AsyncResultFullAllOfAudioSourceDataStore
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AsyncResultFullAllOfAudioSource):
            return False
