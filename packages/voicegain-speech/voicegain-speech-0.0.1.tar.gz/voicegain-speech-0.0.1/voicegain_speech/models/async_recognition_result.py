...
class AsyncRecognitionResult(object):
    ...
    def alternatives(self):
        """Gets the alternatives of this AsyncRecognitionResult.  # noqa: E501

        provides list of alternative recognition hypotheses  # noqa: E501

        :return: The alternatives of this AsyncRecognitionResult.  # noqa: E501
        :rtype: list[RecoAlt]
        """
    ...
    def alternatives(self, alternatives):
        """Sets the alternatives of this AsyncRecognitionResult.

        provides list of alternative recognition hypotheses  # noqa: E501

        :param alternatives: The alternatives of this AsyncRecognitionResult.  # noqa: E501
        :type: list[RecoAlt]
        """
    ...
    @property
    def last_event(self):
        """Gets the last_event of this AsyncRecognitionResult.  # noqa: E501


        :return: The last_event of this AsyncRecognitionResult.  # noqa: E501
    ...
    def last_event(self, last_event):
        """Sets the last_event of this AsyncRecognitionResult.


        :param last_event: The last_event of this AsyncRecognitionResult.  # noqa: E501
    ...
    @property
    def message(self):
        """Gets the message of this AsyncRecognitionResult.  # noqa: E501
        ...
        :return: The message of this AsyncRecognitionResult.  # noqa: E501
        :rtype: str
        """
    ...
    def message(self, message):
        """Sets the message of this AsyncRecognitionResult.

        (optional) message accompanying the status value, e.g. if status==ERROR, then message may contain the reason for the error  # noqa: E501

        :param message: The message of this AsyncRecognitionResult.  # noqa: E501
        :type: str
        """
    ...
    @property
    def status(self):
        """Gets the status of this AsyncRecognitionResult.  # noqa: E501


        :return: The status of this AsyncRecognitionResult.  # noqa: E501
    ...
    def status(self, status):
        """Sets the status of this AsyncRecognitionResult.


        :param status: The status of this AsyncRecognitionResult.  # noqa: E501
    ...
    @property
    def final(self):
        """Gets the final of this AsyncRecognitionResult.  # noqa: E501

        Whether the result is final or if it can still change  # noqa: E501

        :return: The final of this AsyncRecognitionResult.  # noqa: E501
        :rtype: bool
        """
        return self._final
    ...
    def final(self, final):
        """Sets the final of this AsyncRecognitionResult.

        Whether the result is final or if it can still change  # noqa: E501

        :param final: The final of this AsyncRecognitionResult.  # noqa: E501
        :type: bool
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AsyncRecognitionResult):
            return False
