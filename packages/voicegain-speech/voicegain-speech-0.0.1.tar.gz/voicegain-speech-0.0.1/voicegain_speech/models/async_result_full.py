...
class AsyncResultFull(object):
    ...
    def __init__(self, debug=None, progress=None, session=None, audio=None, result=None, local_vars_configuration=None):  # noqa: E501
    ...
    @property
    def debug(self):
        """Gets the debug of this AsyncResultFull.  # noqa: E501


        :return: The debug of this AsyncResultFull.  # noqa: E501
        :rtype: DebugInfo
        """
        return self._debug
    ...
    def debug(self, debug):
        """Sets the debug of this AsyncResultFull.


        :param debug: The debug of this AsyncResultFull.  # noqa: E501
        :type: DebugInfo
        """
    ...
    @property
    def progress(self):
        """Gets the progress of this AsyncResultFull.  # noqa: E501


        :return: The progress of this AsyncResultFull.  # noqa: E501
        :rtype: Progress
        """
    ...
    def progress(self, progress):
        """Sets the progress of this AsyncResultFull.


        :param progress: The progress of this AsyncResultFull.  # noqa: E501
        :type: Progress
        """
    ...
    @property
    def session(self):
        """Gets the session of this AsyncResultFull.  # noqa: E501


        :return: The session of this AsyncResultFull.  # noqa: E501
        :rtype: AsyncSessionShortInfo
        """
        return self._session

    @session.setter
    def session(self, session):
        """Sets the session of this AsyncResultFull.


        :param session: The session of this AsyncResultFull.  # noqa: E501
        :type: AsyncSessionShortInfo
        """
    ...
    @property
    def audio(self):
        """Gets the audio of this AsyncResultFull.  # noqa: E501


        :return: The audio of this AsyncResultFull.  # noqa: E501
        :rtype: AsyncResultFullAllOfAudio
        """
        return self._audio

    @audio.setter
    def audio(self, audio):
        """Sets the audio of this AsyncResultFull.


        :param audio: The audio of this AsyncResultFull.  # noqa: E501
        :type: AsyncResultFullAllOfAudio
        """
    ...
    @property
    def result(self):
        """Gets the result of this AsyncResultFull.  # noqa: E501


        :return: The result of this AsyncResultFull.  # noqa: E501
        :rtype: AsyncResultFullAllOfResult
        """
        return self._result

    @result.setter
    def result(self, result):
        """Sets the result of this AsyncResultFull.


        :param result: The result of this AsyncResultFull.  # noqa: E501
        :type: AsyncResultFullAllOfResult
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AsyncResultFull):
            return False
