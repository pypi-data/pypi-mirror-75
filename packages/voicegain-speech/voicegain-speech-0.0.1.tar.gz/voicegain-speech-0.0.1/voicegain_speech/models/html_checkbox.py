...
class HtmlCheckbox(object):
    ...
    def __init__(self, items=None, local_vars_configuration=None):  # noqa: E501
        """HtmlCheckbox - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def items(self):
        """Gets the items of this HtmlCheckbox.  # noqa: E501


        :return: The items of this HtmlCheckbox.  # noqa: E501
    ...
    def items(self, items):
        """Sets the items of this HtmlCheckbox.


        :param items: The items of this HtmlCheckbox.  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, HtmlCheckbox):
            return False
