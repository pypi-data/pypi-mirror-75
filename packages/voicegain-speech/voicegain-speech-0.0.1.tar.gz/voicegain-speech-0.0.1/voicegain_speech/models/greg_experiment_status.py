...
class GregExperimentStatus(object):
    ...
    allowable_values = [MODIFIED, STARTING, IMPORTING, PROCESSING, READY, ERROR]  # noqa: E501
    ...
    def __init__(self, local_vars_configuration=None):  # noqa: E501
        """GregExperimentStatus - a model defined in OpenAPI"""  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GregExperimentStatus):
            return False
