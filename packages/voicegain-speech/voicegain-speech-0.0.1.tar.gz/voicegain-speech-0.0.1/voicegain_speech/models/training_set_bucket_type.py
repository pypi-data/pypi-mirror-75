...
class TrainingSetBucketType(object):
    ...
    allowable_values = [RAW, PROCESSED]  # noqa: E501
    ...
    def __init__(self, local_vars_configuration=None):  # noqa: E501
        """TrainingSetBucketType - a model defined in OpenAPI"""  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, TrainingSetBucketType):
            return False
