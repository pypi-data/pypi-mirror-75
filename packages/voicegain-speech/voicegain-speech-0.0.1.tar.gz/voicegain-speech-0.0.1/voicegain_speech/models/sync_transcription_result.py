...
class SyncTranscriptionResult(object):
    ...
    """
    openapi_types = {
        'alternatives': 'list[TranscribeAlt]',
    ...
    def __init__(self, alternatives=None, last_event=None, message=None, status=None, local_vars_configuration=None):  # noqa: E501
        """SyncTranscriptionResult - a model defined in OpenAPI"""  # noqa: E501
    ...
    def alternatives(self):
        """Gets the alternatives of this SyncTranscriptionResult.  # noqa: E501

        Provides list of alternative transcription hypotheses.  Each alternative is a sequence of words starting from the beginning of the audio stream.   # noqa: E501

        :return: The alternatives of this SyncTranscriptionResult.  # noqa: E501
        :rtype: list[TranscribeAlt]
        """
        return self._alternatives

    @alternatives.setter
    def alternatives(self, alternatives):
        """Sets the alternatives of this SyncTranscriptionResult.

        Provides list of alternative transcription hypotheses.  Each alternative is a sequence of words starting from the beginning of the audio stream.   # noqa: E501

        :param alternatives: The alternatives of this SyncTranscriptionResult.  # noqa: E501
        :type: list[TranscribeAlt]
        """
    ...
    @property
    def last_event(self):
        """Gets the last_event of this SyncTranscriptionResult.  # noqa: E501


        :return: The last_event of this SyncTranscriptionResult.  # noqa: E501
    ...
    def last_event(self, last_event):
        """Sets the last_event of this SyncTranscriptionResult.


        :param last_event: The last_event of this SyncTranscriptionResult.  # noqa: E501
    ...
    @property
    def message(self):
        """Gets the message of this SyncTranscriptionResult.  # noqa: E501
        ...
        :return: The message of this SyncTranscriptionResult.  # noqa: E501
        :rtype: str
        """
    ...
    def message(self, message):
        """Sets the message of this SyncTranscriptionResult.

        (optional) message accompanying the status value, e.g. if status==ERROR, then message may contain the reason for the error  # noqa: E501

        :param message: The message of this SyncTranscriptionResult.  # noqa: E501
        :type: str
        """
    ...
    @property
    def status(self):
        """Gets the status of this SyncTranscriptionResult.  # noqa: E501


        :return: The status of this SyncTranscriptionResult.  # noqa: E501
    ...
    def status(self, status):
        """Sets the status of this SyncTranscriptionResult.


        :param status: The status of this SyncTranscriptionResult.  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SyncTranscriptionResult):
            return False
