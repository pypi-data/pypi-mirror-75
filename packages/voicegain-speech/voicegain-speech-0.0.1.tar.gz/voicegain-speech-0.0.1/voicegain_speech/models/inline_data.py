...
class InlineData(object):
    ...
    def __init__(self, data=None, local_vars_configuration=None):  # noqa: E501
        """InlineData - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def data(self):
        """Gets the data of this InlineData.  # noqa: E501

        (Required) base64-encoded data  # noqa: E501

        :return: The data of this InlineData.  # noqa: E501
        :rtype: str
        """
        return self._data
    ...
    @data.setter
    def data(self, data):
        """Sets the data of this InlineData.

        (Required) base64-encoded data  # noqa: E501

        :param data: The data of this InlineData.  # noqa: E501
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, InlineData):
            return False
