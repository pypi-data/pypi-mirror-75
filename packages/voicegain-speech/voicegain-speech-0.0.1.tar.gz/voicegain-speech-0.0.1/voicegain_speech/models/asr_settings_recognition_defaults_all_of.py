...
class AsrSettingsRecognitionDefaultsAllOf(object):
    ...
    def no_input_timeout(self):
        """Gets the no_input_timeout of this AsrSettingsRecognitionDefaultsAllOf.  # noqa: E501

        Used to determine if NOINPUT should be returned (in msec)  # noqa: E501

        :return: The no_input_timeout of this AsrSettingsRecognitionDefaultsAllOf.  # noqa: E501
        :rtype: int
        """
    ...
    def no_input_timeout(self, no_input_timeout):
        """Sets the no_input_timeout of this AsrSettingsRecognitionDefaultsAllOf.

        Used to determine if NOINPUT should be returned (in msec)  # noqa: E501

        :param no_input_timeout: The no_input_timeout of this AsrSettingsRecognitionDefaultsAllOf.  # noqa: E501
        :type: int
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AsrSettingsRecognitionDefaultsAllOf):
            return False
