...
class MRCPv1AsrSettings(object):
    ...
    def __init__(self, rtsp_port=554, server_ip=None, local_vars_configuration=None):  # noqa: E501
        """MRCPv1AsrSettings - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def rtsp_port(self):
        """Gets the rtsp_port of this MRCPv1AsrSettings.  # noqa: E501

        MRCP server RTSP port  # noqa: E501

        :return: The rtsp_port of this MRCPv1AsrSettings.  # noqa: E501
        :rtype: float
        """
        return self._rtsp_port

    @rtsp_port.setter
    def rtsp_port(self, rtsp_port):
        """Sets the rtsp_port of this MRCPv1AsrSettings.

        MRCP server RTSP port  # noqa: E501

        :param rtsp_port: The rtsp_port of this MRCPv1AsrSettings.  # noqa: E501
        :type: float
        """
        if (self.local_vars_configuration.client_side_validation and
                rtsp_port is not None and rtsp_port > 65535):  # noqa: E501
            raise ValueError("Invalid value for `rtsp_port`, must be a value less than or equal to `65535`")  # noqa: E501
        if (self.local_vars_configuration.client_side_validation and
                rtsp_port is not None and rtsp_port < 1000):  # noqa: E501
            raise ValueError("Invalid value for `rtsp_port`, must be a value greater than or equal to `1000`")  # noqa: E501

        self._rtsp_port = rtsp_port

    @property
    def server_ip(self):
        """Gets the server_ip of this MRCPv1AsrSettings.  # noqa: E501

        MRCP server IP address  # noqa: E501

        :return: The server_ip of this MRCPv1AsrSettings.  # noqa: E501
        :rtype: str
        """
    ...
    def server_ip(self, server_ip):
        """Sets the server_ip of this MRCPv1AsrSettings.

        MRCP server IP address  # noqa: E501

        :param server_ip: The server_ip of this MRCPv1AsrSettings.  # noqa: E501
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, MRCPv1AsrSettings):
            return False
