...
class GregAudioSetBase(object):
    ...
    def __init__(self, audio_ids=None, name=None, size=None, local_vars_configuration=None):  # noqa: E501
        """GregAudioSetBase - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def audio_ids(self):
        """Gets the audio_ids of this GregAudioSetBase.  # noqa: E501

        ids of the GREG audio objects contained in this set  # noqa: E501

        :return: The audio_ids of this GregAudioSetBase.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def audio_ids(self, audio_ids):
        """Sets the audio_ids of this GregAudioSetBase.

        ids of the GREG audio objects contained in this set  # noqa: E501

        :param audio_ids: The audio_ids of this GregAudioSetBase.  # noqa: E501
        :type: list[str]
        """
    ...
    @property
    def name(self):
        """Gets the name of this GregAudioSetBase.  # noqa: E501

        unique audio set name  # noqa: E501

        :return: The name of this GregAudioSetBase.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this GregAudioSetBase.

        unique audio set name  # noqa: E501

        :param name: The name of this GregAudioSetBase.  # noqa: E501
        :type: str
        """
    ...
    @property
    def size(self):
        """Gets the size of this GregAudioSetBase.  # noqa: E501

        size of the audio set  # noqa: E501

        :return: The size of this GregAudioSetBase.  # noqa: E501
        :rtype: int
        """
        return self._size
    ...
    @size.setter
    def size(self, size):
        """Sets the size of this GregAudioSetBase.

        size of the audio set  # noqa: E501

        :param size: The size of this GregAudioSetBase.  # noqa: E501
        :type: int
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GregAudioSetBase):
            return False
