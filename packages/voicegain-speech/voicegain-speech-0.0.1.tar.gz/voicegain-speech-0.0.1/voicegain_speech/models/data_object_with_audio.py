...
class DataObjectWithAudio(object):
    ...
    def __init__(self, content_type=None, description=None, name=None, tags=None, transcoded=False, audio=None, local_vars_configuration=None):  # noqa: E501
    ...
    def content_type(self):
        """Gets the content_type of this DataObjectWithAudio.  # noqa: E501

        Type of the data stored with this Data Object. This type will be used in response when retrieving it raw.  # noqa: E501

        :return: The content_type of this DataObjectWithAudio.  # noqa: E501
        :rtype: str
        """
    ...
    def content_type(self, content_type):
        """Sets the content_type of this DataObjectWithAudio.

        Type of the data stored with this Data Object. This type will be used in response when retrieving it raw.  # noqa: E501

        :param content_type: The content_type of this DataObjectWithAudio.  # noqa: E501
        :type: str
        """
    ...
    def description(self):
        """Gets the description of this DataObjectWithAudio.  # noqa: E501

        User provided description of the data object (optional).  # noqa: E501

        :return: The description of this DataObjectWithAudio.  # noqa: E501
        :rtype: str
        """
    ...
    def description(self, description):
        """Sets the description of this DataObjectWithAudio.

        User provided description of the data object (optional).  # noqa: E501

        :param description: The description of this DataObjectWithAudio.  # noqa: E501
        :type: str
        """
    ...
    @property
    def name(self):
        """Gets the name of this DataObjectWithAudio.  # noqa: E501
        ...
        :return: The name of this DataObjectWithAudio.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this DataObjectWithAudio.

        Human friendly identifier (does not have to be unique).</br> It is optional, but an object that does not have a name may be difficult to query.</br> Characters **not allowed** in a name are: star `*`, question mark `?`, colon `:`, pipe `|`, slash `/`, backslash `\\`, quote `\"`, any control characters including `NUL`</br> Name may not start with: any whitespace, period `.`, tilde `~`. </br> Name may not end with: any whitespace.</br>   # noqa: E501

        :param name: The name of this DataObjectWithAudio.  # noqa: E501
        :type: str
        """
    ...
    @property
    def tags(self):
        """Gets the tags of this DataObjectWithAudio.  # noqa: E501

        List of short strings (tags) with interpretation dependent on the use of the object  # noqa: E501

        :return: The tags of this DataObjectWithAudio.  # noqa: E501
        :rtype: list[str]
        """
        return self._tags
    ...
    @tags.setter
    def tags(self, tags):
        """Sets the tags of this DataObjectWithAudio.

        List of short strings (tags) with interpretation dependent on the use of the object  # noqa: E501

        :param tags: The tags of this DataObjectWithAudio.  # noqa: E501
        :type: list[str]
        """
    ...
    @property
    def transcoded(self):
        """Gets the transcoded of this DataObjectWithAudio.  # noqa: E501

        (read-only) If present, indicates if the data stored has been transcoded. Applicable, to audio data only.  # noqa: E501

        :return: The transcoded of this DataObjectWithAudio.  # noqa: E501
        :rtype: bool
        """
    ...
    def transcoded(self, transcoded):
        """Sets the transcoded of this DataObjectWithAudio.

        (read-only) If present, indicates if the data stored has been transcoded. Applicable, to audio data only.  # noqa: E501

        :param transcoded: The transcoded of this DataObjectWithAudio.  # noqa: E501
        :type: bool
        """
    ...
    @property
    def audio(self):
        """Gets the audio of this DataObjectWithAudio.  # noqa: E501


        :return: The audio of this DataObjectWithAudio.  # noqa: E501
    ...
    def audio(self, audio):
        """Sets the audio of this DataObjectWithAudio.


        :param audio: The audio of this DataObjectWithAudio.  # noqa: E501
        :type: AudioInputData
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DataObjectWithAudio):
            return False
