...
class LangModelStatus(object):
    ...
    allowable_values = [MODIFIED, STARTING, PROCESSING, ERROR, READY]  # noqa: E501
    ...
    def __init__(self, local_vars_configuration=None):  # noqa: E501
        """LangModelStatus - a model defined in OpenAPI"""  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, LangModelStatus):
            return False
