...
class GregAudioSetInclusive(object):
    ...
    def __init__(self, audio_set_id=None, audio=None, name=None, size=None, local_vars_configuration=None):  # noqa: E501
        """GregAudioSetInclusive - a model defined in OpenAPI"""  # noqa: E501
    ...
    def audio_set_id(self):
        """Gets the audio_set_id of this GregAudioSetInclusive.  # noqa: E501


        :return: The audio_set_id of this GregAudioSetInclusive.  # noqa: E501
        :rtype: str
        """
    ...
    def audio_set_id(self, audio_set_id):
        """Sets the audio_set_id of this GregAudioSetInclusive.


        :param audio_set_id: The audio_set_id of this GregAudioSetInclusive.  # noqa: E501
        :type: str
        """
    ...
    @property
    def audio(self):
        """Gets the audio of this GregAudioSetInclusive.  # noqa: E501

        GREG audio objects contained in this set  # noqa: E501

        :return: The audio of this GregAudioSetInclusive.  # noqa: E501
    ...
    def audio(self, audio):
        """Sets the audio of this GregAudioSetInclusive.

        GREG audio objects contained in this set  # noqa: E501

        :param audio: The audio of this GregAudioSetInclusive.  # noqa: E501
    ...
    @property
    def name(self):
        """Gets the name of this GregAudioSetInclusive.  # noqa: E501

        unique audio set name  # noqa: E501

        :return: The name of this GregAudioSetInclusive.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this GregAudioSetInclusive.

        unique audio set name  # noqa: E501

        :param name: The name of this GregAudioSetInclusive.  # noqa: E501
        :type: str
        """
    ...
    @property
    def size(self):
        """Gets the size of this GregAudioSetInclusive.  # noqa: E501

        size of the audio set  # noqa: E501

        :return: The size of this GregAudioSetInclusive.  # noqa: E501
        :rtype: int
        """
        return self._size
    ...
    @size.setter
    def size(self, size):
        """Sets the size of this GregAudioSetInclusive.

        size of the audio set  # noqa: E501

        :param size: The size of this GregAudioSetInclusive.  # noqa: E501
        :type: int
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GregAudioSetInclusive):
            return False
