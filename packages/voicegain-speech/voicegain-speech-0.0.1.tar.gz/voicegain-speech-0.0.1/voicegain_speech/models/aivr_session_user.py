...
class AIVRSessionUser(object):
    ...
    def __init__(self, participant_name=None, fs_name=None, fs_password=None, video_conf_index=None, local_vars_configuration=None):  # noqa: E501
        """AIVRSessionUser - a model defined in OpenAPI"""  # noqa: E501
    ...
    def participant_name(self):
        """Gets the participant_name of this AIVRSessionUser.  # noqa: E501

        distinct (within session) name, e.g. caller1, agent1, agent2  # noqa: E501

        :return: The participant_name of this AIVRSessionUser.  # noqa: E501
        :rtype: str
        """
    ...
    def participant_name(self, participant_name):
        """Sets the participant_name of this AIVRSessionUser.

        distinct (within session) name, e.g. caller1, agent1, agent2  # noqa: E501

        :param participant_name: The participant_name of this AIVRSessionUser.  # noqa: E501
        :type: str
        """
        if self.local_vars_configuration.client_side_validation and participant_name is None:  # noqa: E501
            raise ValueError("Invalid value for `participant_name`, must not be `None`")  # noqa: E501

        self._participant_name = participant_name

    @property
    def fs_name(self):
        """Gets the fs_name of this AIVRSessionUser.  # noqa: E501

        random user name under freeswitch  # noqa: E501

        :return: The fs_name of this AIVRSessionUser.  # noqa: E501
        :rtype: str
        """
    ...
    def fs_name(self, fs_name):
        """Sets the fs_name of this AIVRSessionUser.

        random user name under freeswitch  # noqa: E501

        :param fs_name: The fs_name of this AIVRSessionUser.  # noqa: E501
        :type: str
        """
    ...
    def fs_password(self):
        """Gets the fs_password of this AIVRSessionUser.  # noqa: E501

        random password under freeswitch  # noqa: E501

        :return: The fs_password of this AIVRSessionUser.  # noqa: E501
        :rtype: str
        """
    ...
    def fs_password(self, fs_password):
        """Sets the fs_password of this AIVRSessionUser.

        random password under freeswitch  # noqa: E501

        :param fs_password: The fs_password of this AIVRSessionUser.  # noqa: E501
        :type: str
        """
    ...
    def video_conf_index(self):
        """Gets the video_conf_index of this AIVRSessionUser.  # noqa: E501
        ...
        :return: The video_conf_index of this AIVRSessionUser.  # noqa: E501
        :rtype: int
        """
    ...
    def video_conf_index(self, video_conf_index):
        """Sets the video_conf_index of this AIVRSessionUser.

        Index of the video conference this user will be submitting his video feed too. For example, if value of fsConferenceExtVideo is \"c_1hd7je99gjkd-ext-video-\"  and  videoConfIndex is 2 then the conference to which this user should be sending video to is \"c_1hd7je99gjkd-ext-video-2\"   # noqa: E501

        :param video_conf_index: The video_conf_index of this AIVRSessionUser.  # noqa: E501
        :type: int
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AIVRSessionUser):
            return False
