...
class AsyncResultFullAllOfAudioSourceDataStore(object):
    ...
    def __init__(self, uuid=None, local_vars_configuration=None):  # noqa: E501
        """AsyncResultFullAllOfAudioSourceDataStore - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def uuid(self):
        """Gets the uuid of this AsyncResultFullAllOfAudioSourceDataStore.  # noqa: E501

        (optional) UUID in DataStore of the audio that was transcribed  # noqa: E501

        :return: The uuid of this AsyncResultFullAllOfAudioSourceDataStore.  # noqa: E501
        :rtype: str
        """
        return self._uuid
    ...
    @uuid.setter
    def uuid(self, uuid):
        """Sets the uuid of this AsyncResultFullAllOfAudioSourceDataStore.

        (optional) UUID in DataStore of the audio that was transcribed  # noqa: E501

        :param uuid: The uuid of this AsyncResultFullAllOfAudioSourceDataStore.  # noqa: E501
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AsyncResultFullAllOfAudioSourceDataStore):
            return False
