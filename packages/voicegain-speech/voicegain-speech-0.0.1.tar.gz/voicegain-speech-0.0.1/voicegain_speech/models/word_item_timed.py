...
class WordItemTimed(object):
    ...
    def __init__(self, confidence=None, utterance=None, alternatives=None, duration=None, start=None, local_vars_configuration=None):  # noqa: E501
    ...
    @property
    def confidence(self):
        """Gets the confidence of this WordItemTimed.  # noqa: E501

        confidence of the recognition  # noqa: E501

        :return: The confidence of this WordItemTimed.  # noqa: E501
        :rtype: float
        """
    ...
    def confidence(self, confidence):
        """Sets the confidence of this WordItemTimed.

        confidence of the recognition  # noqa: E501

        :param confidence: The confidence of this WordItemTimed.  # noqa: E501
        :type: float
        """
    ...
    def alternatives(self):
        """Gets the alternatives of this WordItemTimed.  # noqa: E501

        alternative transcriptions at this position in time (if any)  # noqa: E501

        :return: The alternatives of this WordItemTimed.  # noqa: E501
    ...
    def alternatives(self, alternatives):
        """Sets the alternatives of this WordItemTimed.

        alternative transcriptions at this position in time (if any)  # noqa: E501

        :param alternatives: The alternatives of this WordItemTimed.  # noqa: E501
        :type: list[WordsItem]
        """
    ...
    @property
    def duration(self):
        """Gets the duration of this WordItemTimed.  # noqa: E501

        duration of the word (in msec)  # noqa: E501

        :return: The duration of this WordItemTimed.  # noqa: E501
        :rtype: float
        """
    ...
    def duration(self, duration):
        """Sets the duration of this WordItemTimed.

        duration of the word (in msec)  # noqa: E501

        :param duration: The duration of this WordItemTimed.  # noqa: E501
        :type: float
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    @property
    def start(self):
        """Gets the start of this WordItemTimed.  # noqa: E501

        start time (in msec) of the word since the beginning of the audio  # noqa: E501

        :return: The start of this WordItemTimed.  # noqa: E501
        :rtype: int
        """
        return self._start
    ...
    def start(self, start):
        """Sets the start of this WordItemTimed.

        start time (in msec) of the word since the beginning of the audio  # noqa: E501

        :param start: The start of this WordItemTimed.  # noqa: E501
        :type: int
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, WordItemTimed):
            return False
