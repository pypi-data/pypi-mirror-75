...
class GregTruthUpdates(object):
    ...
    openapi_types = {
        'question_id': 'str',
        'true_recognitions': 'list[GregTruthUpdate]',
        'truth_reasoning': 'str',
        'truth_source': 'str'
    }
    ...
    attribute_map = {
        ...
        'true_recognitions': 'trueRecognitions',
        'truth_reasoning': 'truthReasoning',
        'truth_source': 'truthSource'
    }

    def __init__(self, question_id=None, true_recognitions=None, truth_reasoning=None, truth_source=None, local_vars_configuration=None):  # noqa: E501
        """GregTruthUpdates - a model defined in OpenAPI"""  # noqa: E501
        if local_vars_configuration is None:
            local_vars_configuration = Configuration()
        self.local_vars_configuration = local_vars_configuration

        self._question_id = None
        self._true_recognitions = None
        self._truth_reasoning = None
        self._truth_source = None
        self.discriminator = None

        if question_id is not None:
            self.question_id = question_id
        if true_recognitions is not None:
            self.true_recognitions = true_recognitions
        if truth_reasoning is not None:
            self.truth_reasoning = truth_reasoning
        if truth_source is not None:
            self.truth_source = truth_source

    @property
    def question_id(self):
        """Gets the question_id of this GregTruthUpdates.  # noqa: E501

        Id of the question. (Optional - not needed if passed as path parameter)  # noqa: E501

        :return: The question_id of this GregTruthUpdates.  # noqa: E501
        :rtype: str
        """
    ...
    def question_id(self, question_id):
        """Sets the question_id of this GregTruthUpdates.

        Id of the question. (Optional - not needed if passed as path parameter)  # noqa: E501

        :param question_id: The question_id of this GregTruthUpdates.  # noqa: E501
        :type: str
        """
    ...
    @property
    def true_recognitions(self):
        """Gets the true_recognitions of this GregTruthUpdates.  # noqa: E501


        :return: The true_recognitions of this GregTruthUpdates.  # noqa: E501
        :rtype: list[GregTruthUpdate]
        """
        return self._true_recognitions

    @true_recognitions.setter
    def true_recognitions(self, true_recognitions):
        """Sets the true_recognitions of this GregTruthUpdates.


        :param true_recognitions: The true_recognitions of this GregTruthUpdates.  # noqa: E501
        :type: list[GregTruthUpdate]
        """

        self._true_recognitions = true_recognitions

    @property
    def truth_reasoning(self):
        """Gets the truth_reasoning of this GregTruthUpdates.  # noqa: E501

        string describing the reasoning behind setting the true values, e.g. \"assumed\", \"confidence > 0.95\", \"manual review\"  # noqa: E501

        :return: The truth_reasoning of this GregTruthUpdates.  # noqa: E501
        :rtype: str
        """
        return self._truth_reasoning

    @truth_reasoning.setter
    def truth_reasoning(self, truth_reasoning):
        """Sets the truth_reasoning of this GregTruthUpdates.

        string describing the reasoning behind setting the true values, e.g. \"assumed\", \"confidence > 0.95\", \"manual review\"  # noqa: E501

        :param truth_reasoning: The truth_reasoning of this GregTruthUpdates.  # noqa: E501
        :type: str
        """

        self._truth_reasoning = truth_reasoning

    @property
    def truth_source(self):
        """Gets the truth_source of this GregTruthUpdates.  # noqa: E501

        string describing the source, e.g. \"runtime\" or \"browser\"  # noqa: E501

        :return: The truth_source of this GregTruthUpdates.  # noqa: E501
        :rtype: str
        """
        return self._truth_source

    @truth_source.setter
    def truth_source(self, truth_source):
        """Sets the truth_source of this GregTruthUpdates.

        string describing the source, e.g. \"runtime\" or \"browser\"  # noqa: E501

        :param truth_source: The truth_source of this GregTruthUpdates.  # noqa: E501
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GregTruthUpdates):
            return False
