...
class ExperimentPlatform(object):
    ...
    allowable_values = [VOICEGAIN, EXTERNALASR, UPLOAD]  # noqa: E501
    ...
    def __init__(self, local_vars_configuration=None):  # noqa: E501
        """ExperimentPlatform - a model defined in OpenAPI"""  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ExperimentPlatform):
            return False
