...
class AIVRLogicMedia(object):
    ...
    allowable_values = [SPEECH, WEB]  # noqa: E501
    ...
    def __init__(self, local_vars_configuration=None):  # noqa: E501
        """AIVRLogicMedia - a model defined in OpenAPI"""  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AIVRLogicMedia):
            return False
