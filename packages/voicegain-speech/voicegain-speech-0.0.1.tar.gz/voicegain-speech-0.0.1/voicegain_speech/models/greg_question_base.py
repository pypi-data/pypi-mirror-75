...
class GregQuestionBase(object):
    ...
    def __init__(self, ivr_element=None, name=None, prompt=None, slots=None, local_vars_configuration=None):  # noqa: E501
    ...
    def ivr_element(self):
        """Gets the ivr_element of this GregQuestionBase.  # noqa: E501

        Map describing where in the IVR the question occurs.  # noqa: E501

        :return: The ivr_element of this GregQuestionBase.  # noqa: E501
        :rtype: object
        """
    ...
    def ivr_element(self, ivr_element):
        """Sets the ivr_element of this GregQuestionBase.

        Map describing where in the IVR the question occurs.  # noqa: E501

        :param ivr_element: The ivr_element of this GregQuestionBase.  # noqa: E501
        :type: object
        """
    ...
    @property
    def name(self):
        """Gets the name of this GregQuestionBase.  # noqa: E501

        unique question name  # noqa: E501

        :return: The name of this GregQuestionBase.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this GregQuestionBase.

        unique question name  # noqa: E501

        :param name: The name of this GregQuestionBase.  # noqa: E501
        :type: str
        """
    ...
    @property
    def prompt(self):
        """Gets the prompt of this GregQuestionBase.  # noqa: E501

        question prompt  # noqa: E501

        :return: The prompt of this GregQuestionBase.  # noqa: E501
        :rtype: str
        """
        return self._prompt
    ...
    def prompt(self, prompt):
        """Sets the prompt of this GregQuestionBase.

        question prompt  # noqa: E501

        :param prompt: The prompt of this GregQuestionBase.  # noqa: E501
        :type: str
        """
    ...
    @property
    def slots(self):
        """Gets the slots of this GregQuestionBase.  # noqa: E501

        names of the slots to be filled from the response to the question  # noqa: E501

        :return: The slots of this GregQuestionBase.  # noqa: E501
        :rtype: list[str]
        """
        return self._slots
    ...
    def slots(self, slots):
        """Sets the slots of this GregQuestionBase.

        names of the slots to be filled from the response to the question  # noqa: E501

        :param slots: The slots of this GregQuestionBase.  # noqa: E501
        :type: list[str]
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GregQuestionBase):
            return False
