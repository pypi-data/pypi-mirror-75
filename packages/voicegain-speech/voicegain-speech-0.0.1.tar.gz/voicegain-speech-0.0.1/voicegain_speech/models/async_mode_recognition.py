...
class AsyncModeRecognition(object):
    ...
    """
    REAL_TIME = "REAL-TIME"
    SEMI_REAL_TIME = "SEMI-REAL-TIME"
    OFF_LINE = "OFF-LINE"
    OFF_LINE_RT = "OFF-LINE-RT"

    allowable_values = [REAL_TIME, SEMI_REAL_TIME, OFF_LINE, OFF_LINE_RT]  # noqa: E501
    ...
    def __init__(self, local_vars_configuration=None):  # noqa: E501
        """AsyncModeRecognition - a model defined in OpenAPI"""  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AsyncModeRecognition):
            return False
