...
class PortalOutputInit(object):
    ...
    def __init__(self, label=None, persist=3600000, local_vars_configuration=None):  # noqa: E501
        """PortalOutputInit - a model defined in OpenAPI"""  # noqa: E501
    ...
    def label(self):
        ...
        Label for the result. </br> May contain only us-asci letters, digits, and following symbols `.` `-` `_`  </br> Consecutive symbols are not allowed. Must start and end with digit or letter.    # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PortalOutputInit):
            return False
