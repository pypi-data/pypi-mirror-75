...
class GregGrammarBase(object):
    ...
    def __init__(self, input=None, name=None, resolved=None, local_vars_configuration=None):  # noqa: E501
        """GregGrammarBase - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def input(self):
        """Gets the input of this GregGrammarBase.  # noqa: E501
        ...
        :return: The input of this GregGrammarBase.  # noqa: E501
        :rtype: list[str]
        """
        return self._input
    ...
    def input(self, input):
        """Sets the input of this GregGrammarBase.

        URIs of the grammars that are combined to form the final grammar used by GREG.</br> Absent if GREG grammar is not obtained from URLs.   # noqa: E501

        :param input: The input of this GregGrammarBase.  # noqa: E501
        :type: list[str]
        """
    ...
    @property
    def name(self):
        """Gets the name of this GregGrammarBase.  # noqa: E501

        unique grammar name  # noqa: E501

        :return: The name of this GregGrammarBase.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this GregGrammarBase.

        unique grammar name  # noqa: E501

        :param name: The name of this GregGrammarBase.  # noqa: E501
        :type: str
        """
    ...
    @property
    def resolved(self):
        """Gets the resolved of this GregGrammarBase.  # noqa: E501

        serialized resolved grammars that were obtained from provided input  # noqa: E501

        :return: The resolved of this GregGrammarBase.  # noqa: E501
        :rtype: list[object]
        """
    ...
    def resolved(self, resolved):
        """Sets the resolved of this GregGrammarBase.

        serialized resolved grammars that were obtained from provided input  # noqa: E501

        :param resolved: The resolved of this GregGrammarBase.  # noqa: E501
        :type: list[object]
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GregGrammarBase):
            return False
