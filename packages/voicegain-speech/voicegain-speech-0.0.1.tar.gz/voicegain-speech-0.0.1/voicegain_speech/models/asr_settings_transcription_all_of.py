...
class AsrSettingsTranscriptionAllOf(object):
    ...
    @property
    def hints(self):
        """Gets the hints of this AsrSettingsTranscriptionAllOf.  # noqa: E501
        ...
        :return: The hints of this AsrSettingsTranscriptionAllOf.  # noqa: E501
        :rtype: list[str]
        """
        return self._hints
    ...
    def hints(self, hints):
        """Sets the hints of this AsrSettingsTranscriptionAllOf.

        Can be provided to indicate that given words/phrases are more likely to appear in the audio input. No special characters allowed except for '_'   # noqa: E501

        :param hints: The hints of this AsrSettingsTranscriptionAllOf.  # noqa: E501
        :type: list[str]
        """
    ...
    @property
    def lang_model(self):
        """Gets the lang_model of this AsrSettingsTranscriptionAllOf.  # noqa: E501

        Name or UUID of the language model (arpa grammar) to use. If absent then will use default language model.  # noqa: E501

        :return: The lang_model of this AsrSettingsTranscriptionAllOf.  # noqa: E501
        :rtype: str
        """
    ...
    def lang_model(self, lang_model):
        """Sets the lang_model of this AsrSettingsTranscriptionAllOf.

        Name or UUID of the language model (arpa grammar) to use. If absent then will use default language model.  # noqa: E501

        :param lang_model: The lang_model of this AsrSettingsTranscriptionAllOf.  # noqa: E501
        :type: str
        """
    ...
    def speech_analytics_config(self):
        """Gets the speech_analytics_config of this AsrSettingsTranscriptionAllOf.  # noqa: E501

        Name or UUID of the Speech Analytics configuration to use. If absent then will not perform Speech Analytics.  # noqa: E501

        :return: The speech_analytics_config of this AsrSettingsTranscriptionAllOf.  # noqa: E501
        :rtype: str
        """
    ...
    def speech_analytics_config(self, speech_analytics_config):
        """Sets the speech_analytics_config of this AsrSettingsTranscriptionAllOf.

        Name or UUID of the Speech Analytics configuration to use. If absent then will not perform Speech Analytics.  # noqa: E501

        :param speech_analytics_config: The speech_analytics_config of this AsrSettingsTranscriptionAllOf.  # noqa: E501
        :type: str
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    def topic_discovery_config(self):
        """Gets the topic_discovery_config of this AsrSettingsTranscriptionAllOf.  # noqa: E501

        Name or UUID of the Topic discovery configuration to use. If absent then will not perform Topic Discovery.  # noqa: E501

        :return: The topic_discovery_config of this AsrSettingsTranscriptionAllOf.  # noqa: E501
        :rtype: str
        """
    ...
    def topic_discovery_config(self, topic_discovery_config):
        """Sets the topic_discovery_config of this AsrSettingsTranscriptionAllOf.

        Name or UUID of the Topic discovery configuration to use. If absent then will not perform Topic Discovery.  # noqa: E501

        :param topic_discovery_config: The topic_discovery_config of this AsrSettingsTranscriptionAllOf.  # noqa: E501
        :type: str
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AsrSettingsTranscriptionAllOf):
            return False
