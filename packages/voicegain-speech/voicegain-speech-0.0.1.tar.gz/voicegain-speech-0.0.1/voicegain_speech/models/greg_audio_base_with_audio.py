...
class GregAudioBaseWithAudio(object):
    ...
    def __init__(self, source=None, source_of_truth=None, true_interpretations=None, true_utterance=None, audio=None, local_vars_configuration=None):  # noqa: E501
    ...
    @property
    def source(self):
        """Gets the source of this GregAudioBaseWithAudio.  # noqa: E501

        Map containing various attributes describing where audio comes from  # noqa: E501

        :return: The source of this GregAudioBaseWithAudio.  # noqa: E501
    ...
    def source(self, source):
        """Sets the source of this GregAudioBaseWithAudio.

        Map containing various attributes describing where audio comes from  # noqa: E501

        :param source: The source of this GregAudioBaseWithAudio.  # noqa: E501
    ...
    def source_of_truth(self):
        """Gets the source_of_truth of this GregAudioBaseWithAudio.  # noqa: E501


        :return: The source_of_truth of this GregAudioBaseWithAudio.  # noqa: E501
    ...
    def source_of_truth(self, source_of_truth):
        """Sets the source_of_truth of this GregAudioBaseWithAudio.


        :param source_of_truth: The source_of_truth of this GregAudioBaseWithAudio.  # noqa: E501
    ...
    def true_interpretations(self):
        """Gets the true_interpretations of this GregAudioBaseWithAudio.  # noqa: E501


        :return: The true_interpretations of this GregAudioBaseWithAudio.  # noqa: E501
    ...
    def true_interpretations(self, true_interpretations):
        """Sets the true_interpretations of this GregAudioBaseWithAudio.


        :param true_interpretations: The true_interpretations of this GregAudioBaseWithAudio.  # noqa: E501
    ...
    def true_utterance(self):
        """Gets the true_utterance of this GregAudioBaseWithAudio.  # noqa: E501

        complete and accurate utterance from the audio file  # noqa: E501

        :return: The true_utterance of this GregAudioBaseWithAudio.  # noqa: E501
        :rtype: str
        """
    ...
    def true_utterance(self, true_utterance):
        """Sets the true_utterance of this GregAudioBaseWithAudio.

        complete and accurate utterance from the audio file  # noqa: E501

        :param true_utterance: The true_utterance of this GregAudioBaseWithAudio.  # noqa: E501
        :type: str
        """
    ...
    @property
    def audio(self):
        """Gets the audio of this GregAudioBaseWithAudio.  # noqa: E501


        :return: The audio of this GregAudioBaseWithAudio.  # noqa: E501
        :rtype: AudioInputData
        """
        return self._audio

    @audio.setter
    def audio(self, audio):
        """Sets the audio of this GregAudioBaseWithAudio.


        :param audio: The audio of this GregAudioBaseWithAudio.  # noqa: E501
        :type: AudioInputData
        """
        if self.local_vars_configuration.client_side_validation and audio is None:  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GregAudioBaseWithAudio):
            return False
