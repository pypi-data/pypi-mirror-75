...
class SessionInitRecognition(object):
    ...
    def __init__(self, async_mode=None, callback=None, extra_params=None, poll=None, local_vars_configuration=None):  # noqa: E501
    ...
    @property
    def async_mode(self):
        """Gets the async_mode of this SessionInitRecognition.  # noqa: E501


        :return: The async_mode of this SessionInitRecognition.  # noqa: E501
        :rtype: AsyncModeRecognition
        """
        return self._async_mode

    @async_mode.setter
    def async_mode(self, async_mode):
        """Sets the async_mode of this SessionInitRecognition.


        :param async_mode: The async_mode of this SessionInitRecognition.  # noqa: E501
        :type: AsyncModeRecognition
        """
    ...
    @property
    def callback(self):
        """Gets the callback of this SessionInitRecognition.  # noqa: E501


        :return: The callback of this SessionInitRecognition.  # noqa: E501
        :rtype: CallbackReq
        """
    ...
    def callback(self, callback):
        """Sets the callback of this SessionInitRecognition.


        :param callback: The callback of this SessionInitRecognition.  # noqa: E501
        :type: CallbackReq
        """
    ...
    def extra_params(self):
        """Gets the extra_params of this SessionInitRecognition.  # noqa: E501

        Additional undocumented parameters in query type format, e.g. `foo=bar&abc=xyz`  # noqa: E501

        :return: The extra_params of this SessionInitRecognition.  # noqa: E501
        :rtype: str
        """
    ...
    def extra_params(self, extra_params):
        """Sets the extra_params of this SessionInitRecognition.

        Additional undocumented parameters in query type format, e.g. `foo=bar&abc=xyz`  # noqa: E501

        :param extra_params: The extra_params of this SessionInitRecognition.  # noqa: E501
        :type: str
        """
    ...
    @property
    def poll(self):
        """Gets the poll of this SessionInitRecognition.  # noqa: E501


        :return: The poll of this SessionInitRecognition.  # noqa: E501
        :rtype: PollReq
        """
        return self._poll
    ...
    @poll.setter
    def poll(self, poll):
        """Sets the poll of this SessionInitRecognition.


        :param poll: The poll of this SessionInitRecognition.  # noqa: E501
        :type: PollReq
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SessionInitRecognition):
            return False
