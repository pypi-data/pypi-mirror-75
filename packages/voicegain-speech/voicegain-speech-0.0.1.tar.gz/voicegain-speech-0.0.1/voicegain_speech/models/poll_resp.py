...
class PollResp(object):
    ...
    def __init__(self, afterlife=15000, persist=300000, url=None, local_vars_configuration=None):  # noqa: E501
        """PollResp - a model defined in OpenAPI"""  # noqa: E501
        if local_vars_configuration is None:
            local_vars_configuration = Configuration()
        self.local_vars_configuration = local_vars_configuration

        self._afterlife = None
        self._persist = None
        self._url = None
    ...
    @property
    def afterlife(self):
        """Gets the afterlife of this PollResp.  # noqa: E501

        Time (in msec) to retain the result/outcome data in memory after processing has completed.    # noqa: E501

        :return: The afterlife of this PollResp.  # noqa: E501
        :rtype: float
        """
        return self._afterlife

    @afterlife.setter
    def afterlife(self, afterlife):
        """Sets the afterlife of this PollResp.

        Time (in msec) to retain the result/outcome data in memory after processing has completed.    # noqa: E501

        :param afterlife: The afterlife of this PollResp.  # noqa: E501
        :type: float
        """
        if self.local_vars_configuration.client_side_validation and afterlife is None:  # noqa: E501
            raise ValueError("Invalid value for `afterlife`, must not be `None`")  # noqa: E501
        if (self.local_vars_configuration.client_side_validation and
                afterlife is not None and afterlife > 300000):  # noqa: E501
            raise ValueError("Invalid value for `afterlife`, must be a value less than or equal to `300000`")  # noqa: E501
        if (self.local_vars_configuration.client_side_validation and
                afterlife is not None and afterlife < 0):  # noqa: E501
            raise ValueError("Invalid value for `afterlife`, must be a value greater than or equal to `0`")  # noqa: E501

        self._afterlife = afterlife

    @property
    def persist(self):
        """Gets the persist of this PollResp.  # noqa: E501

        Time (in msec) to retain the result/outcome data after processing has completed. Data can be retained indefinitely if value is -1.  As long as the persist has not expired the data will be available for the poll request.   # noqa: E501

        :return: The persist of this PollResp.  # noqa: E501
        :rtype: float
        """
    ...
    def persist(self, persist):
        """Sets the persist of this PollResp.

        Time (in msec) to retain the result/outcome data after processing has completed. Data can be retained indefinitely if value is -1.  As long as the persist has not expired the data will be available for the poll request.   # noqa: E501

        :param persist: The persist of this PollResp.  # noqa: E501
        :type: float
        """
    ...
    @property
    def url(self):
        """Gets the url of this PollResp.  # noqa: E501

        Exact complete URL to use to poll for intermediate and/or final result.  # noqa: E501

        :return: The url of this PollResp.  # noqa: E501
        :rtype: str
        """
        return self._url
    ...
    @url.setter
    def url(self, url):
        """Sets the url of this PollResp.

        Exact complete URL to use to poll for intermediate and/or final result.  # noqa: E501

        :param url: The url of this PollResp.  # noqa: E501
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PollResp):
            return False
