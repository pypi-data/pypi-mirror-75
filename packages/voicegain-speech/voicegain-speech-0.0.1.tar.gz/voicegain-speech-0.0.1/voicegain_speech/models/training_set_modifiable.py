...
class TrainingSetModifiable(object):
    ...
    openapi_types = {
        ...
        'status': 'TrainingSetStatusModifiable',
        'status_msg': 'str'
    }
    ...
    def __init__(self, acoustic_model_used=None, defaults=None, statistics=None, status=None, status_msg=None, local_vars_configuration=None):  # noqa: E501
    ...
    def acoustic_model_used(self):
        """Gets the acoustic_model_used of this TrainingSetModifiable.  # noqa: E501

        Provides Id of the Acoustic Model to be used to process this training set. If the status is `starting` or `processing` then an attempt to set acousticModelUsed should return an error.   # noqa: E501

        :return: The acoustic_model_used of this TrainingSetModifiable.  # noqa: E501
        :rtype: str
        """
    ...
    def acoustic_model_used(self, acoustic_model_used):
        """Sets the acoustic_model_used of this TrainingSetModifiable.

        Provides Id of the Acoustic Model to be used to process this training set. If the status is `starting` or `processing` then an attempt to set acousticModelUsed should return an error.   # noqa: E501

        :param acoustic_model_used: The acoustic_model_used of this TrainingSetModifiable.  # noqa: E501
        :type: str
        """
    ...
    @property
    def defaults(self):
        """Gets the defaults of this TrainingSetModifiable.  # noqa: E501


        :return: The defaults of this TrainingSetModifiable.  # noqa: E501
    ...
    def defaults(self, defaults):
        """Sets the defaults of this TrainingSetModifiable.


        :param defaults: The defaults of this TrainingSetModifiable.  # noqa: E501
    ...
    @property
    def statistics(self):
        """Gets the statistics of this TrainingSetModifiable.  # noqa: E501


        :return: The statistics of this TrainingSetModifiable.  # noqa: E501
    ...
    def statistics(self, statistics):
        """Sets the statistics of this TrainingSetModifiable.


        :param statistics: The statistics of this TrainingSetModifiable.  # noqa: E501
    ...
    @property
    def status(self):
        """Gets the status of this TrainingSetModifiable.  # noqa: E501


        :return: The status of this TrainingSetModifiable.  # noqa: E501
        :rtype: TrainingSetStatusModifiable
        """
        return self._status

    @status.setter
    def status(self, status):
        """Sets the status of this TrainingSetModifiable.


        :param status: The status of this TrainingSetModifiable.  # noqa: E501
        :type: TrainingSetStatusModifiable
        """
    ...
    @property
    def status_msg(self):
        """Gets the status_msg of this TrainingSetModifiable.  # noqa: E501

        Message providing additional info related to the status  # noqa: E501

        :return: The status_msg of this TrainingSetModifiable.  # noqa: E501
        :rtype: str
        """
    ...
    def status_msg(self, status_msg):
        """Sets the status_msg of this TrainingSetModifiable.

        Message providing additional info related to the status  # noqa: E501

        :param status_msg: The status_msg of this TrainingSetModifiable.  # noqa: E501
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, TrainingSetModifiable):
            return False
