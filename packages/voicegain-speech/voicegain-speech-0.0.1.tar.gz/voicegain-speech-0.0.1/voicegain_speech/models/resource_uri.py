...
class ResourceUri(object):
    ...
    @property
    def auth_conf(self):
        """Gets the auth_conf of this ResourceUri.  # noqa: E501
        ...
        :return: The auth_conf of this ResourceUri.  # noqa: E501
        :rtype: str
        """
    ...
    def auth_conf(self, auth_conf):
        """Sets the auth_conf of this ResourceUri.

        Name or UUID of the authentication config for accessing the URI, if missing then no authentication will be attempted. Can be defined via Voicegain Portal. **(Not implemented yet)**   # noqa: E501

        :param auth_conf: The auth_conf of this ResourceUri.  # noqa: E501
        :type: str
        """
    ...
    @property
    def url(self):
        """Gets the url of this ResourceUri.  # noqa: E501

        (Required) URI for the resource  # noqa: E501

        :return: The url of this ResourceUri.  # noqa: E501
        :rtype: str
        """
        return self._url
    ...
    @url.setter
    def url(self, url):
        """Sets the url of this ResourceUri.

        (Required) URI for the resource  # noqa: E501

        :param url: The url of this ResourceUri.  # noqa: E501
        :type: str
        """
