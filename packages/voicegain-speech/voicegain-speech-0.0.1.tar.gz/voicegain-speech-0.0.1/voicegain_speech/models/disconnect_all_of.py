...
class DisconnectAllOf(object):
    ...
    def __init__(self, method=None, termination=None, text=None, local_vars_configuration=None):  # noqa: E501
        """DisconnectAllOf - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def method(self):
        """Gets the method of this DisconnectAllOf.  # noqa: E501

        method the text was output (Voice UI or GUI)  # noqa: E501

        :return: The method of this DisconnectAllOf.  # noqa: E501
        :rtype: str
        """
        return self._method
    ...
    def method(self, method):
        """Sets the method of this DisconnectAllOf.

        method the text was output (Voice UI or GUI)  # noqa: E501

        :param method: The method of this DisconnectAllOf.  # noqa: E501
        :type: str
        """
    ...
    def termination(self):
        """Gets the termination of this DisconnectAllOf.  # noqa: E501

        Type of disconnect - may be either `requested` by the dialog logic or `error` if some condition occurs that makes it impossible to continue the call.   # noqa: E501

        :return: The termination of this DisconnectAllOf.  # noqa: E501
        :rtype: str
        """
    ...
    def termination(self, termination):
        """Sets the termination of this DisconnectAllOf.

        Type of disconnect - may be either `requested` by the dialog logic or `error` if some condition occurs that makes it impossible to continue the call.   # noqa: E501

        :param termination: The termination of this DisconnectAllOf.  # noqa: E501
        :type: str
        """
        allowed_values = ["requested", "error"]  # noqa: E501
        if self.local_vars_configuration.client_side_validation and termination not in allowed_values:  # noqa: E501
            raise ValueError(
                "Invalid value for `termination` ({0}), must be one of {1}"  # noqa: E501
                .format(termination, allowed_values)
            )
    ...
    @property
    def text(self):
        """Gets the text of this DisconnectAllOf.  # noqa: E501

        (optional) text of the prompt (dis)played before disconnect - will include all resolved variables if applicable  # noqa: E501

        :return: The text of this DisconnectAllOf.  # noqa: E501
        :rtype: str
        """
        return self._text
    ...
    @text.setter
    def text(self, text):
        """Sets the text of this DisconnectAllOf.

        (optional) text of the prompt (dis)played before disconnect - will include all resolved variables if applicable  # noqa: E501

        :param text: The text of this DisconnectAllOf.  # noqa: E501
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DisconnectAllOf):
            return False
