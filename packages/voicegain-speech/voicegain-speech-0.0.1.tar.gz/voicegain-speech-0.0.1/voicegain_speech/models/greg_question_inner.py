...
class GregQuestionInner(object):
    ...
    def __init__(self, question_id=None, ivr_element=None, name=None, prompt=None, slots=None, local_vars_configuration=None):  # noqa: E501
        """GregQuestionInner - a model defined in OpenAPI"""  # noqa: E501
    ...
    def question_id(self):
        """Gets the question_id of this GregQuestionInner.  # noqa: E501

        Unique ID of the GREG Question  # noqa: E501

        :return: The question_id of this GregQuestionInner.  # noqa: E501
        :rtype: str
        """
    ...
    def question_id(self, question_id):
        """Sets the question_id of this GregQuestionInner.

        Unique ID of the GREG Question  # noqa: E501

        :param question_id: The question_id of this GregQuestionInner.  # noqa: E501
        :type: str
        """
    ...
    def ivr_element(self):
        """Gets the ivr_element of this GregQuestionInner.  # noqa: E501

        Map describing where in the IVR the question occurs.  # noqa: E501

        :return: The ivr_element of this GregQuestionInner.  # noqa: E501
        :rtype: object
        """
    ...
    def ivr_element(self, ivr_element):
        """Sets the ivr_element of this GregQuestionInner.

        Map describing where in the IVR the question occurs.  # noqa: E501

        :param ivr_element: The ivr_element of this GregQuestionInner.  # noqa: E501
        :type: object
        """
    ...
    @property
    def name(self):
        """Gets the name of this GregQuestionInner.  # noqa: E501

        unique question name  # noqa: E501

        :return: The name of this GregQuestionInner.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this GregQuestionInner.

        unique question name  # noqa: E501

        :param name: The name of this GregQuestionInner.  # noqa: E501
        :type: str
        """
    ...
    @property
    def prompt(self):
        """Gets the prompt of this GregQuestionInner.  # noqa: E501

        question prompt  # noqa: E501

        :return: The prompt of this GregQuestionInner.  # noqa: E501
        :rtype: str
        """
        return self._prompt
    ...
    def prompt(self, prompt):
        """Sets the prompt of this GregQuestionInner.

        question prompt  # noqa: E501

        :param prompt: The prompt of this GregQuestionInner.  # noqa: E501
        :type: str
        """
    ...
    @property
    def slots(self):
        """Gets the slots of this GregQuestionInner.  # noqa: E501

        names of the slots to be filled from the response to the question  # noqa: E501

        :return: The slots of this GregQuestionInner.  # noqa: E501
        :rtype: list[str]
        """
        return self._slots
    ...
    def slots(self, slots):
        """Sets the slots of this GregQuestionInner.

        names of the slots to be filled from the response to the question  # noqa: E501

        :param slots: The slots of this GregQuestionInner.  # noqa: E501
        :type: list[str]
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GregQuestionInner):
            return False
