...
class AsyncTranscriptionResponse(object):
    ...
    discriminator_value_class_map = {
        'AsyncResultIncremental': 'AsyncResultIncremental',
        'AsyncResultFull': 'AsyncResultFull'
    }

    def __init__(self, response_type=None, local_vars_configuration=None):  # noqa: E501
        """AsyncTranscriptionResponse - a model defined in OpenAPI"""  # noqa: E501
    ...
    def response_type(self):
        """Gets the response_type of this AsyncTranscriptionResponse.  # noqa: E501

        Whether the result is incremental or full  # noqa: E501

        :return: The response_type of this AsyncTranscriptionResponse.  # noqa: E501
        :rtype: str
        """
    ...
    def response_type(self, response_type):
        """Sets the response_type of this AsyncTranscriptionResponse.

        Whether the result is incremental or full  # noqa: E501

        :param response_type: The response_type of this AsyncTranscriptionResponse.  # noqa: E501
        :type: str
        """
        ...
        allowed_values = ["AsyncResultFull", "AsyncResultIncremental"]  # noqa: E501
        if self.local_vars_configuration.client_side_validation and response_type not in allowed_values:  # noqa: E501
            raise ValueError(
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AsyncTranscriptionResponse):
            return False
