...
class BUILTIN(object):
    ...
    def __init__(self, name=None, parameters=None, local_vars_configuration=None):  # noqa: E501
        """BUILTIN - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def name(self):
        """Gets the name of this BUILTIN.  # noqa: E501
        ...
        :return: The name of this BUILTIN.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this BUILTIN.

        Name of the built-in grammar. Use `dtmf/` prefix to identify a specific built-in **dtmf** grammar (without prefix it is assumed that it is a **speech** grammar)   # noqa: E501

        :param name: The name of this BUILTIN.  # noqa: E501
        :type: str
        """
    ...
    @property
    def parameters(self):
        """Gets the parameters of this BUILTIN.  # noqa: E501

        map with parameters that will be passed to built-in grammar  # noqa: E501

        :return: The parameters of this BUILTIN.  # noqa: E501
    ...
    def parameters(self, parameters):
        """Sets the parameters of this BUILTIN.

        map with parameters that will be passed to built-in grammar  # noqa: E501

        :param parameters: The parameters of this BUILTIN.  # noqa: E501
