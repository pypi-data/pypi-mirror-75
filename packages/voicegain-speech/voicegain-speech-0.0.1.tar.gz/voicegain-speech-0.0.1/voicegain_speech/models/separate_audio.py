...
class SeparateAudio(object):
    ...
    """
    openapi_types = {
        'ensure_sequence': 'bool',
        'piggyback_polling': 'bool'
    }

    attribute_map = {
        'ensure_sequence': 'ensureSequence',
        'piggyback_polling': 'piggybackPolling'
    }

    def __init__(self, ensure_sequence=False, piggyback_polling=False, local_vars_configuration=None):  # noqa: E501
        """SeparateAudio - a model defined in OpenAPI"""  # noqa: E501
        if local_vars_configuration is None:
            local_vars_configuration = Configuration()
        self.local_vars_configuration = local_vars_configuration

        self._ensure_sequence = None
        self._piggyback_polling = None
        self.discriminator = None

        if ensure_sequence is not None:
            self.ensure_sequence = ensure_sequence
        if piggyback_polling is not None:
            self.piggyback_polling = piggyback_polling

    @property
    def ensure_sequence(self):
        """Gets the ensure_sequence of this SeparateAudio.  # noqa: E501

        If **true** then each audio chunk requires a sequence id. Receiving side will process data in sequence and report any out of sequence or missinng chunks. Normally this is not necessary as the chunks are sent over HTTP. Might be useful if small chunks are sent over long distances.</br> If **false** then chunks will be processed in order they are received.   # noqa: E501

        :return: The ensure_sequence of this SeparateAudio.  # noqa: E501
        :rtype: bool
        """
        return self._ensure_sequence

    @ensure_sequence.setter
    def ensure_sequence(self, ensure_sequence):
        """Sets the ensure_sequence of this SeparateAudio.

        If **true** then each audio chunk requires a sequence id. Receiving side will process data in sequence and report any out of sequence or missinng chunks. Normally this is not necessary as the chunks are sent over HTTP. Might be useful if small chunks are sent over long distances.</br> If **false** then chunks will be processed in order they are received.   # noqa: E501

        :param ensure_sequence: The ensure_sequence of this SeparateAudio.  # noqa: E501
        :type: bool
        """

        self._ensure_sequence = ensure_sequence

    @property
    def piggyback_polling(self):
        """Gets the piggyback_polling of this SeparateAudio.  # noqa: E501

        If **true** then the response will contain data normally included in polling response. Separate polling requests are then not needed (except for the final one)</br> If **false** then the response will just contain an acknowledgement and some statistics. Separate polling will be needed if desired.   # noqa: E501

        :return: The piggyback_polling of this SeparateAudio.  # noqa: E501
        :rtype: bool
        """
        return self._piggyback_polling

    @piggyback_polling.setter
    def piggyback_polling(self, piggyback_polling):
        """Sets the piggyback_polling of this SeparateAudio.

        If **true** then the response will contain data normally included in polling response. Separate polling requests are then not needed (except for the final one)</br> If **false** then the response will just contain an acknowledgement and some statistics. Separate polling will be needed if desired.   # noqa: E501

        :param piggyback_polling: The piggyback_polling of this SeparateAudio.  # noqa: E501
        :type: bool
        """

        self._piggyback_polling = piggyback_polling
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SeparateAudio):
            return False
