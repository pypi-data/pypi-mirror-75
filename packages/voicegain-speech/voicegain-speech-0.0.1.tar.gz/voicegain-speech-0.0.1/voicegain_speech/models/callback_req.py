...
class CallbackReq(object):
    ...
    @property
    def uri(self):
        """Gets the uri of this CallbackReq.  # noqa: E501

        (Required) uri to which the callback should be made. Allows substitution of {sessionId} parameter.  # noqa: E501

        :return: The uri of this CallbackReq.  # noqa: E501
        :rtype: str
        """
        return self._uri
    ...
    @uri.setter
    def uri(self, uri):
        """Sets the uri of this CallbackReq.

        (Required) uri to which the callback should be made. Allows substitution of {sessionId} parameter.  # noqa: E501

        :param uri: The uri of this CallbackReq.  # noqa: E501
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CallbackReq):
            return False
