...
class AIVRLogicTransfer(object):
    ...
    @property
    def vars(self):
        """Gets the vars of this AIVRLogicTransfer.  # noqa: E501
    ...
    @vars.setter
    def vars(self, vars):
        """Sets the vars of this AIVRLogicTransfer.
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AIVRLogicTransfer):
            return False
