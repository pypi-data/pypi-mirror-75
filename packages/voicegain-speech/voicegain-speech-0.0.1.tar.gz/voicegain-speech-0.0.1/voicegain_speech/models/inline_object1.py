...
class InlineObject1(object):
    ...
    def __init__(self, file=None, objectdata=None, local_vars_configuration=None):  # noqa: E501
    ...
    def file(self):
        ...
        Part of the form labeled 'file' contains file to be uploaded  # noqa: E501
    ...
    @property
    def objectdata(self):
        """Gets the objectdata of this InlineObject1.  # noqa: E501

        Second, optional, part of the form containing accompanying metadata.  Labeled 'objectdata'.  Payload contained in this part of the form has to be valid JSON following the Data object schema   # noqa: E501

        :return: The objectdata of this InlineObject1.  # noqa: E501
        :rtype: file
        """
        return self._objectdata

    @objectdata.setter
    def objectdata(self, objectdata):
        """Sets the objectdata of this InlineObject1.

        Second, optional, part of the form containing accompanying metadata.  Labeled 'objectdata'.  Payload contained in this part of the form has to be valid JSON following the Data object schema   # noqa: E501

        :param objectdata: The objectdata of this InlineObject1.  # noqa: E501
        :type: file
        """
