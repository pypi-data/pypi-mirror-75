...
class Disconnect(object):
    ...
    def __init__(self, method=None, termination=None, text=None, local_vars_configuration=None):  # noqa: E501
        """Disconnect - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def method(self):
        """Gets the method of this Disconnect.  # noqa: E501

        method the text was output (Voice UI or GUI)  # noqa: E501

        :return: The method of this Disconnect.  # noqa: E501
        :rtype: str
        """
        return self._method
    ...
    def method(self, method):
        """Sets the method of this Disconnect.

        method the text was output (Voice UI or GUI)  # noqa: E501

        :param method: The method of this Disconnect.  # noqa: E501
        :type: str
        """
    ...
    def termination(self):
        """Gets the termination of this Disconnect.  # noqa: E501
        ...
        :return: The termination of this Disconnect.  # noqa: E501
        :rtype: str
        """
    ...
    def termination(self, termination):
        """Sets the termination of this Disconnect.

        Type of disconnect - may be either `requested` by the dialog logic or `error` if some condition occurs that makes it impossible to continue the call.   # noqa: E501

        :param termination: The termination of this Disconnect.  # noqa: E501
        :type: str
        """
    ...
    @text.setter
    def text(self, text):
        """Sets the text of this Disconnect.

        (optional) text of the prompt (dis)played before disconnect - will include all resolved variables if applicable  # noqa: E501

        :param text: The text of this Disconnect.  # noqa: E501
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, Disconnect):
            return False
