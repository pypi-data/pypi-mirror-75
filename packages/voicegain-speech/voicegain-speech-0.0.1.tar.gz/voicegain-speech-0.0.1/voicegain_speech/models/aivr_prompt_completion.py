...
class AIVRPromptCompletion(object):
    ...
    def __init__(self, end_reason=None, local_vars_configuration=None):  # noqa: E501
        """AIVRPromptCompletion - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def end_reason(self):
        """Gets the end_reason of this AIVRPromptCompletion.  # noqa: E501

        If prompt finished playing it will provide the reason why prompt finished  # noqa: E501

        :return: The end_reason of this AIVRPromptCompletion.  # noqa: E501
        :rtype: str
        """
    ...
    def end_reason(self, end_reason):
        """Sets the end_reason of this AIVRPromptCompletion.

        If prompt finished playing it will provide the reason why prompt finished  # noqa: E501

        :param end_reason: The end_reason of this AIVRPromptCompletion.  # noqa: E501
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AIVRPromptCompletion):
            return False
