...
class StreamingProtocol(object):
    ...
    allowable_values = [RTP, ASCALON, ASCALON_C, WEBSOCKET]  # noqa: E501
    ...
    def __init__(self, local_vars_configuration=None):  # noqa: E501
        """StreamingProtocol - a model defined in OpenAPI"""  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, StreamingProtocol):
            return False
