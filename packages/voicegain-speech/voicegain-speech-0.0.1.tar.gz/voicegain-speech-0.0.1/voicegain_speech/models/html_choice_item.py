...
class HtmlChoiceItem(object):
    ...
    def __init__(self, selected_by_default=None, text=None, value=None, local_vars_configuration=None):  # noqa: E501
        """HtmlChoiceItem - a model defined in OpenAPI"""  # noqa: E501
    ...
    def selected_by_default(self):
        """Gets the selected_by_default of this HtmlChoiceItem.  # noqa: E501

        if true then this item will be selected by default  # noqa: E501

        :return: The selected_by_default of this HtmlChoiceItem.  # noqa: E501
        :rtype: bool
        """
    ...
    def selected_by_default(self, selected_by_default):
        """Sets the selected_by_default of this HtmlChoiceItem.

        if true then this item will be selected by default  # noqa: E501

        :param selected_by_default: The selected_by_default of this HtmlChoiceItem.  # noqa: E501
        :type: bool
        """
    ...
    @property
    def text(self):
        """Gets the text of this HtmlChoiceItem.  # noqa: E501

        text to be shown next to the item  # noqa: E501

        :return: The text of this HtmlChoiceItem.  # noqa: E501
        :rtype: str
        """
        return self._text
    ...
    @text.setter
    def text(self, text):
        """Sets the text of this HtmlChoiceItem.

        text to be shown next to the item  # noqa: E501

        :param text: The text of this HtmlChoiceItem.  # noqa: E501
        :type: str
        """
    ...
    @property
    def value(self):
        """Gets the value of this HtmlChoiceItem.  # noqa: E501

        value to be returned if item selected  # noqa: E501

        :return: The value of this HtmlChoiceItem.  # noqa: E501
        :rtype: str
        """
        return self._value
    ...
    def value(self, value):
        """Sets the value of this HtmlChoiceItem.

        value to be returned if item selected  # noqa: E501

        :param value: The value of this HtmlChoiceItem.  # noqa: E501
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, HtmlChoiceItem):
            return False
