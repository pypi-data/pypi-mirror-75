...
class GregExperimentBasePlatformData(object):
    ...
    """
    openapi_types = {
        'external_asr': 'GregExperimentPlatformExternalASR',
        'upload': 'GregExperimentPlatformUpload',
        'voicegain': 'GregExperimentPlatformVoicegain'
    }

    attribute_map = {
        'external_asr': 'externalASR',
        'upload': 'upload',
        'voicegain': 'voicegain'
    }

    def __init__(self, external_asr=None, upload=None, voicegain=None, local_vars_configuration=None):  # noqa: E501
        """GregExperimentBasePlatformData - a model defined in OpenAPI"""  # noqa: E501
        ...
        self._upload = None
        self._voicegain = None
        self.discriminator = None

        if external_asr is not None:
            self.external_asr = external_asr
        if upload is not None:
            self.upload = upload
        if voicegain is not None:
            self.voicegain = voicegain

    @property
    def external_asr(self):
        """Gets the external_asr of this GregExperimentBasePlatformData.  # noqa: E501


        :return: The external_asr of this GregExperimentBasePlatformData.  # noqa: E501
        :rtype: GregExperimentPlatformExternalASR
        """
        return self._external_asr

    @external_asr.setter
    def external_asr(self, external_asr):
        """Sets the external_asr of this GregExperimentBasePlatformData.


        :param external_asr: The external_asr of this GregExperimentBasePlatformData.  # noqa: E501
        :type: GregExperimentPlatformExternalASR
        """

        self._external_asr = external_asr

    @property
    def upload(self):
        """Gets the upload of this GregExperimentBasePlatformData.  # noqa: E501


        :return: The upload of this GregExperimentBasePlatformData.  # noqa: E501
        :rtype: GregExperimentPlatformUpload
        """
        return self._upload

    @upload.setter
    def upload(self, upload):
        """Sets the upload of this GregExperimentBasePlatformData.


        :param upload: The upload of this GregExperimentBasePlatformData.  # noqa: E501
        :type: GregExperimentPlatformUpload
        """
    ...
    @property
    def voicegain(self):
        """Gets the voicegain of this GregExperimentBasePlatformData.  # noqa: E501


        :return: The voicegain of this GregExperimentBasePlatformData.  # noqa: E501
        :rtype: GregExperimentPlatformVoicegain
        """
        return self._voicegain

    @voicegain.setter
    def voicegain(self, voicegain):
        """Sets the voicegain of this GregExperimentBasePlatformData.


        :param voicegain: The voicegain of this GregExperimentBasePlatformData.  # noqa: E501
        :type: GregExperimentPlatformVoicegain
        """

        self._voicegain = voicegain
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GregExperimentBasePlatformData):
            return False
