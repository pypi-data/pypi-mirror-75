...
class GregGrammarInner(object):
    ...
    def __init__(self, grammar_id=None, input=None, name=None, local_vars_configuration=None):  # noqa: E501
        """GregGrammarInner - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def grammar_id(self):
        """Gets the grammar_id of this GregGrammarInner.  # noqa: E501

        Unique Id of the GREG Grammar  # noqa: E501

        :return: The grammar_id of this GregGrammarInner.  # noqa: E501
        :rtype: str
        """
    ...
    def grammar_id(self, grammar_id):
        """Sets the grammar_id of this GregGrammarInner.

        Unique Id of the GREG Grammar  # noqa: E501

        :param grammar_id: The grammar_id of this GregGrammarInner.  # noqa: E501
        :type: str
        """
    ...
    @property
    def input(self):
        """Gets the input of this GregGrammarInner.  # noqa: E501

        URIs of the grammars to be combined and used  # noqa: E501

        :return: The input of this GregGrammarInner.  # noqa: E501
        :rtype: list[str]
        """
        return self._input
    ...
    def input(self, input):
        """Sets the input of this GregGrammarInner.

        URIs of the grammars to be combined and used  # noqa: E501

        :param input: The input of this GregGrammarInner.  # noqa: E501
        :type: list[str]
        """
    ...
    @property
    def name(self):
        """Gets the name of this GregGrammarInner.  # noqa: E501

        unique grammar name  # noqa: E501

        :return: The name of this GregGrammarInner.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this GregGrammarInner.

        unique grammar name  # noqa: E501

        :param name: The name of this GregGrammarInner.  # noqa: E501
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GregGrammarInner):
            return False
