...
class DataObjectBase(object):
    ...
    def description(self):
        """Gets the description of this DataObjectBase.  # noqa: E501

        User provided description of the data object (optional).  # noqa: E501

        :return: The description of this DataObjectBase.  # noqa: E501
        :rtype: str
        """
    ...
    def description(self, description):
        """Sets the description of this DataObjectBase.

        User provided description of the data object (optional).  # noqa: E501

        :param description: The description of this DataObjectBase.  # noqa: E501
        :type: str
        """
    ...
    @property
    def name(self):
        """Gets the name of this DataObjectBase.  # noqa: E501
        ...
        :return: The name of this DataObjectBase.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this DataObjectBase.

        Human friendly identifier (does not have to be unique).</br> It is optional, but an object that does not have a name may be difficult to query.</br> Characters **not allowed** in a name are: star `*`, question mark `?`, colon `:`, pipe `|`, slash `/`, backslash `\\`, quote `\"`, any control characters including `NUL`</br> Name may not start with: any whitespace, period `.`, tilde `~`. </br> Name may not end with: any whitespace.</br>   # noqa: E501

        :param name: The name of this DataObjectBase.  # noqa: E501
        :type: str
        """
    ...
    @property
    def tags(self):
        """Gets the tags of this DataObjectBase.  # noqa: E501

        List of short strings (tags) with interpretation dependent on the use of the object  # noqa: E501

        :return: The tags of this DataObjectBase.  # noqa: E501
        :rtype: list[str]
        """
        return self._tags
    ...
    @tags.setter
    def tags(self, tags):
        """Sets the tags of this DataObjectBase.

        List of short strings (tags) with interpretation dependent on the use of the object  # noqa: E501

        :param tags: The tags of this DataObjectBase.  # noqa: E501
        :type: list[str]
        """
    ...
    def transcoded(self, transcoded):
        """Sets the transcoded of this DataObjectBase.

        (read-only) If present, indicates if the data stored has been transcoded. Applicable, to audio data only.  # noqa: E501

        :param transcoded: The transcoded of this DataObjectBase.  # noqa: E501
        :type: bool
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DataObjectBase):
            return False
