...
class GregTruthUpdate(object):
    ...
    def __init__(self, audio_hash=None, audio_id=None, interpretation=None, status=None, utterance=None, local_vars_configuration=None):  # noqa: E501
        """GregTruthUpdate - a model defined in OpenAPI"""  # noqa: E501
        if local_vars_configuration is None:
            local_vars_configuration = Configuration()
        self.local_vars_configuration = local_vars_configuration

        self._audio_hash = None
        self._audio_id = None
    ...
    @property
    def audio_hash(self):
        """Gets the audio_hash of this GregTruthUpdate.  # noqa: E501

        Identifies the Audio (either audioHash or audioId are required)  # noqa: E501

        :return: The audio_hash of this GregTruthUpdate.  # noqa: E501
        :rtype: str
        """
        return self._audio_hash

    @audio_hash.setter
    def audio_hash(self, audio_hash):
        """Sets the audio_hash of this GregTruthUpdate.

        Identifies the Audio (either audioHash or audioId are required)  # noqa: E501

        :param audio_hash: The audio_hash of this GregTruthUpdate.  # noqa: E501
        :type: str
        """
    ...
    @property
    def audio_id(self):
        """Gets the audio_id of this GregTruthUpdate.  # noqa: E501

        Identifies the Audio (either audioId or audioHash are required)  # noqa: E501

        :return: The audio_id of this GregTruthUpdate.  # noqa: E501
        :rtype: str
        """
    ...
    def audio_id(self, audio_id):
        """Sets the audio_id of this GregTruthUpdate.

        Identifies the Audio (either audioId or audioHash are required)  # noqa: E501

        :param audio_id: The audio_id of this GregTruthUpdate.  # noqa: E501
        :type: str
        """
    ...
    def interpretation(self):
        """Gets the interpretation of this GregTruthUpdate.  # noqa: E501

        map of slot names to slot values  # noqa: E501

        :return: The interpretation of this GregTruthUpdate.  # noqa: E501
    ...
    def interpretation(self, interpretation):
        """Sets the interpretation of this GregTruthUpdate.

        map of slot names to slot values  # noqa: E501

        :param interpretation: The interpretation of this GregTruthUpdate.  # noqa: E501
    ...
    @property
    def status(self):
        """Gets the status of this GregTruthUpdate.  # noqa: E501


        :return: The status of this GregTruthUpdate.  # noqa: E501
        :rtype: GregReviewStatus
        """
        return self._status

    @status.setter
    def status(self, status):
        """Sets the status of this GregTruthUpdate.


        :param status: The status of this GregTruthUpdate.  # noqa: E501
        :type: GregReviewStatus
        """
    ...
    @property
    def utterance(self):
        """Gets the utterance of this GregTruthUpdate.  # noqa: E501

        true utterance  # noqa: E501

        :return: The utterance of this GregTruthUpdate.  # noqa: E501
        :rtype: str
        """
    ...
    def utterance(self, utterance):
        """Sets the utterance of this GregTruthUpdate.

        true utterance  # noqa: E501

        :param utterance: The utterance of this GregTruthUpdate.  # noqa: E501
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GregTruthUpdate):
            return False
