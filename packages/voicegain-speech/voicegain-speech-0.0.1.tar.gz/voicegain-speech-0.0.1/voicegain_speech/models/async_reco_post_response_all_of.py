...
class AsyncRecoPostResponseAllOf(object):
    ...
    def __init__(self, sessions=None, local_vars_configuration=None):  # noqa: E501
        """AsyncRecoPostResponseAllOf - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def sessions(self):
        """Gets the sessions of this AsyncRecoPostResponseAllOf.  # noqa: E501

        Data describing the established async session(s).  # noqa: E501

        :return: The sessions of this AsyncRecoPostResponseAllOf.  # noqa: E501
    ...
    def sessions(self, sessions):
        """Sets the sessions of this AsyncRecoPostResponseAllOf.

        Data describing the established async session(s).  # noqa: E501

        :param sessions: The sessions of this AsyncRecoPostResponseAllOf.  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AsyncRecoPostResponseAllOf):
            return False
