...
class GregExperimentPlatformVoicegain(object):
    ...
    openapi_types = {
        'acoustic_model': 'str',
        'asr_settings': 'AsrSettingsRecognitionDefaults'
    }
    ...
    def __init__(self, acoustic_model=None, asr_settings=None, local_vars_configuration=None):  # noqa: E501
        """GregExperimentPlatformVoicegain - a model defined in OpenAPI"""  # noqa: E501
        if local_vars_configuration is None:
            local_vars_configuration = Configuration()
        self.local_vars_configuration = local_vars_configuration

        self._acoustic_model = None
        self._asr_settings = None
    ...
    def acoustic_model(self):
        """Gets the acoustic_model of this GregExperimentPlatformVoicegain.  # noqa: E501

        name of the acoustic model used  # noqa: E501

        :return: The acoustic_model of this GregExperimentPlatformVoicegain.  # noqa: E501
        :rtype: str
        """
    ...
    def acoustic_model(self, acoustic_model):
        """Sets the acoustic_model of this GregExperimentPlatformVoicegain.

        name of the acoustic model used  # noqa: E501

        :param acoustic_model: The acoustic_model of this GregExperimentPlatformVoicegain.  # noqa: E501
        :type: str
        """
    ...
    def asr_settings(self):
        """Gets the asr_settings of this GregExperimentPlatformVoicegain.  # noqa: E501


        :return: The asr_settings of this GregExperimentPlatformVoicegain.  # noqa: E501
        :rtype: AsrSettingsRecognitionDefaults
        """
        return self._asr_settings

    @asr_settings.setter
    def asr_settings(self, asr_settings):
        """Sets the asr_settings of this GregExperimentPlatformVoicegain.


        :param asr_settings: The asr_settings of this GregExperimentPlatformVoicegain.  # noqa: E501
        :type: AsrSettingsRecognitionDefaults
        """

        self._asr_settings = asr_settings
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GregExperimentPlatformVoicegain):
            return False
