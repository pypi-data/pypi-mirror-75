...
class GregQuestion(object):
    ...
    attribute_map = {
        ...
        'ivr_element': 'ivrElement',
        'name': 'name',
        'prompt': 'prompt',
        'slots': 'slots'
    }

    def __init__(self, question_id=None, account_id=None, context_id=None, ivr_element=None, name=None, prompt=None, slots=None, local_vars_configuration=None):  # noqa: E501
        """GregQuestion - a model defined in OpenAPI"""  # noqa: E501
    ...
    def question_id(self):
        """Gets the question_id of this GregQuestion.  # noqa: E501

        Unique ID of the GREG Question  # noqa: E501

        :return: The question_id of this GregQuestion.  # noqa: E501
        :rtype: str
        """
    ...
    def question_id(self, question_id):
        """Sets the question_id of this GregQuestion.

        Unique ID of the GREG Question  # noqa: E501

        :param question_id: The question_id of this GregQuestion.  # noqa: E501
        :type: str
        """
        if self.local_vars_configuration.client_side_validation and question_id is None:  # noqa: E501
    ...
    @property
    def account_id(self):
        """Gets the account_id of this GregQuestion.  # noqa: E501

        Account Id  # noqa: E501

        :return: The account_id of this GregQuestion.  # noqa: E501
        :rtype: str
        """
    ...
    def account_id(self, account_id):
        """Sets the account_id of this GregQuestion.

        Account Id  # noqa: E501

        :param account_id: The account_id of this GregQuestion.  # noqa: E501
        :type: str
        """
    ...
    @property
    def context_id(self):
        """Gets the context_id of this GregQuestion.  # noqa: E501

        Context Id  # noqa: E501

        :return: The context_id of this GregQuestion.  # noqa: E501
        :rtype: str
        """
    ...
    def context_id(self, context_id):
        """Sets the context_id of this GregQuestion.

        Context Id  # noqa: E501

        :param context_id: The context_id of this GregQuestion.  # noqa: E501
        :type: str
        """
    ...
    @property
    def ivr_element(self):
        """Gets the ivr_element of this GregQuestion.  # noqa: E501

        Map describing where in the IVR the question occurs.  # noqa: E501

        :return: The ivr_element of this GregQuestion.  # noqa: E501
        :rtype: object
        """
        return self._ivr_element

    @ivr_element.setter
    def ivr_element(self, ivr_element):
        """Sets the ivr_element of this GregQuestion.

        Map describing where in the IVR the question occurs.  # noqa: E501

        :param ivr_element: The ivr_element of this GregQuestion.  # noqa: E501
        :type: object
        """

        self._ivr_element = ivr_element

    @property
    def name(self):
        """Gets the name of this GregQuestion.  # noqa: E501

        unique question name  # noqa: E501

        :return: The name of this GregQuestion.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this GregQuestion.

        unique question name  # noqa: E501

        :param name: The name of this GregQuestion.  # noqa: E501
        :type: str
        """
    ...
    @property
    def prompt(self):
        """Gets the prompt of this GregQuestion.  # noqa: E501

        question prompt  # noqa: E501

        :return: The prompt of this GregQuestion.  # noqa: E501
        :rtype: str
        """
        return self._prompt
    ...
    def prompt(self, prompt):
        """Sets the prompt of this GregQuestion.

        question prompt  # noqa: E501

        :param prompt: The prompt of this GregQuestion.  # noqa: E501
        :type: str
        """
    ...
    @property
    def slots(self):
        """Gets the slots of this GregQuestion.  # noqa: E501

        names of the slots to be filled from the response to the question  # noqa: E501

        :return: The slots of this GregQuestion.  # noqa: E501
        :rtype: list[str]
        """
        return self._slots
    ...
    def slots(self, slots):
        """Sets the slots of this GregQuestion.

        names of the slots to be filled from the response to the question  # noqa: E501

        :param slots: The slots of this GregQuestion.  # noqa: E501
        :type: list[str]
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GregQuestion):
            return False
