...
class Websocket(object):
    ...
    def __init__(self, account_id=None, context_id=None, default=False, delay=0, messages=None, name=None, public=True, local_vars_configuration=None):  # noqa: E501
        """Websocket - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def account_id(self):
        """Gets the account_id of this Websocket.  # noqa: E501


        :return: The account_id of this Websocket.  # noqa: E501
        :rtype: str
        """
    ...
    def account_id(self, account_id):
        """Sets the account_id of this Websocket.


        :param account_id: The account_id of this Websocket.  # noqa: E501
        :type: str
        """
    ...
    @property
    def context_id(self):
        """Gets the context_id of this Websocket.  # noqa: E501


        :return: The context_id of this Websocket.  # noqa: E501
        :rtype: str
        """
    ...
    def context_id(self, context_id):
        """Sets the context_id of this Websocket.


        :param context_id: The context_id of this Websocket.  # noqa: E501
        :type: str
        """
    ...
    @property
    def default(self):
        """Gets the default of this Websocket.  # noqa: E501

        Identifies the default socket for an Account. This is only used when streaming from the Edge Deployment which includes Audio Sender within Kubernetes.   # noqa: E501

        :return: The default of this Websocket.  # noqa: E501
        :rtype: bool
        """
    ...
    def default(self, default):
        """Sets the default of this Websocket.

        Identifies the default socket for an Account. This is only used when streaming from the Edge Deployment which includes Audio Sender within Kubernetes.   # noqa: E501

        :param default: The default of this Websocket.  # noqa: E501
        :type: bool
        """
    ...
    @property
    def delay(self):
        """Gets the delay of this Websocket.  # noqa: E501

        delay in msec for the delayed version of the websocket  # noqa: E501

        :return: The delay of this Websocket.  # noqa: E501
        :rtype: int
        """
        return self._delay
    ...
    def delay(self, delay):
        """Sets the delay of this Websocket.

        delay in msec for the delayed version of the websocket  # noqa: E501

        :param delay: The delay of this Websocket.  # noqa: E501
        :type: int
        """
        if (self.local_vars_configuration.client_side_validation and
                delay is not None and delay > 300000):  # noqa: E501
            raise ValueError("Invalid value for `delay`, must be a value less than or equal to `300000`")  # noqa: E501
        if (self.local_vars_configuration.client_side_validation and
    ...
    @property
    def messages(self):
        """Gets the messages of this Websocket.  # noqa: E501

        Persistent messages for this websocket  # noqa: E501

        :return: The messages of this Websocket.  # noqa: E501
        :rtype: list[WebsocketMsg]
        """
        return self._messages

    @messages.setter
    def messages(self, messages):
        """Sets the messages of this Websocket.

        Persistent messages for this websocket  # noqa: E501

        :param messages: The messages of this Websocket.  # noqa: E501
        :type: list[WebsocketMsg]
        """
    ...
    @property
    def name(self):
        """Gets the name of this Websocket.  # noqa: E501

        Globally unique name under which the websocket will be available.</br> May contain only us-asci letters, digits, dash `-` , and underscore `_`  </br> Consecutive symbols are not allowed. Must start and end with digit or letter. </br> To achieve uniqueness it is suggested that your business name is part of the websocket name, see example. If the example is followed, the final URL to access the websocket would be: </br> wss://api.voicegain.ai/nats-websocket/port/acme-EventA-live    # noqa: E501

        :return: The name of this Websocket.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this Websocket.

        Globally unique name under which the websocket will be available.</br> May contain only us-asci letters, digits, dash `-` , and underscore `_`  </br> Consecutive symbols are not allowed. Must start and end with digit or letter. </br> To achieve uniqueness it is suggested that your business name is part of the websocket name, see example. If the example is followed, the final URL to access the websocket would be: </br> wss://api.voicegain.ai/nats-websocket/port/acme-EventA-live    # noqa: E501

        :param name: The name of this Websocket.  # noqa: E501
        :type: str
        """
    ...
    @property
    def public(self):
        """Gets the public of this Websocket.  # noqa: E501

        If true, then access to the websocket will not require any authentication  # noqa: E501

        :return: The public of this Websocket.  # noqa: E501
        :rtype: bool
        """
        return self._public
    ...
    def public(self, public):
        """Sets the public of this Websocket.

        If true, then access to the websocket will not require any authentication  # noqa: E501

        :param public: The public of this Websocket.  # noqa: E501
        :type: bool
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, Websocket):
            return False
