...
class GregRecogBaseNoExpObjOrNlsml(object):
    ...
    discriminator_value_class_map = {
        'RecogObjNoExp': 'RecogObjNoExp',
        'RecogNlsmlNoExp': 'RecogNlsmlNoExp'
    }

    def __init__(self, type=None, local_vars_configuration=None):  # noqa: E501
        """GregRecogBaseNoExpObjOrNlsml - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def type(self):
        """Gets the type of this GregRecogBaseNoExpObjOrNlsml.  # noqa: E501

        type of Recognition data  # noqa: E501

        :return: The type of this GregRecogBaseNoExpObjOrNlsml.  # noqa: E501
        :rtype: str
        """
        return self._type
    ...
    @type.setter
    def type(self, type):
        """Sets the type of this GregRecogBaseNoExpObjOrNlsml.

        type of Recognition data  # noqa: E501

        :param type: The type of this GregRecogBaseNoExpObjOrNlsml.  # noqa: E501
        :type: str
        """
        if self.local_vars_configuration.client_side_validation and type is None:  # noqa: E501
            raise ValueError("Invalid value for `type`, must not be `None`")  # noqa: E501
        allowed_values = ["RecogObjNoExp", "RecogNlsmlNoExp"]  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GregRecogBaseNoExpObjOrNlsml):
            return False
