...
class HtmlRadioButtons(object):
    ...
    def __init__(self, items=None, local_vars_configuration=None):  # noqa: E501
        """HtmlRadioButtons - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def items(self):
        """Gets the items of this HtmlRadioButtons.  # noqa: E501


        :return: The items of this HtmlRadioButtons.  # noqa: E501
        :rtype: list[HtmlChoiceItem]
        """
        return self._items

    @items.setter
    def items(self, items):
        """Sets the items of this HtmlRadioButtons.


        :param items: The items of this HtmlRadioButtons.  # noqa: E501
        :type: list[HtmlChoiceItem]
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, HtmlRadioButtons):
            return False
