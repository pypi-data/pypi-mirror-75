...
class GregAudioSetResponse(object):
    ...
    discriminator_value_class_map = {
        'GregAudioSet': 'GregAudioSet',
        'GregAudioSetInclusive': 'GregAudioSetInclusive'
    }

    def __init__(self, response_type=None, local_vars_configuration=None):  # noqa: E501
        """GregAudioSetResponse - a model defined in OpenAPI"""  # noqa: E501
    ...
    def response_type(self):
        """Gets the response_type of this GregAudioSetResponse.  # noqa: E501

        Whether the response is base or if it has references included  # noqa: E501

        :return: The response_type of this GregAudioSetResponse.  # noqa: E501
        :rtype: str
        """
    ...
    def response_type(self, response_type):
        """Sets the response_type of this GregAudioSetResponse.

        Whether the response is base or if it has references included  # noqa: E501

        :param response_type: The response_type of this GregAudioSetResponse.  # noqa: E501
        :type: str
        """
        ...
        allowed_values = ["GregAudioSet", "GregAudioSetInclusive"]  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GregAudioSetResponse):
            return False
