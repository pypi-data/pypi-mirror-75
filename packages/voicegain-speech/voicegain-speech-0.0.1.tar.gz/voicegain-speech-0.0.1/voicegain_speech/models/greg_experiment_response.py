...
class GregExperimentResponse(object):
    ...
    discriminator_value_class_map = {
        'GregExperimentInclusive': 'GregExperimentInclusive',
        'GregExperiment': 'GregExperiment'
    }

    def __init__(self, response_type=None, local_vars_configuration=None):  # noqa: E501
        """GregExperimentResponse - a model defined in OpenAPI"""  # noqa: E501
    ...
    def response_type(self):
        """Gets the response_type of this GregExperimentResponse.  # noqa: E501

        Whether the response is base or if it has references included  # noqa: E501

        :return: The response_type of this GregExperimentResponse.  # noqa: E501
        :rtype: str
        """
    ...
    def response_type(self, response_type):
        """Sets the response_type of this GregExperimentResponse.

        Whether the response is base or if it has references included  # noqa: E501

        :param response_type: The response_type of this GregExperimentResponse.  # noqa: E501
        :type: str
        """
        ...
        allowed_values = ["GregExperiment", "GregExperimentInclusive"]  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GregExperimentResponse):
            return False
