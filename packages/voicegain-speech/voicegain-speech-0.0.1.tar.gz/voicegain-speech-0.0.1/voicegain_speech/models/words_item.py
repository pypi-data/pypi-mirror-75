...
class WordsItem(object):
    ...
    @property
    def confidence(self):
        """Gets the confidence of this WordsItem.  # noqa: E501

        confidence of the recognition  # noqa: E501

        :return: The confidence of this WordsItem.  # noqa: E501
        :rtype: float
        """
    ...
    def confidence(self, confidence):
        """Sets the confidence of this WordsItem.

        confidence of the recognition  # noqa: E501

        :param confidence: The confidence of this WordsItem.  # noqa: E501
        :type: float
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, WordsItem):
            return False
