...
class AIVRPromptPlaying(object):
    ...
    def __init__(self, audio_properties=None, html_properties=None, text=None, wait_msec=None, end_reason=None, local_vars_configuration=None):  # noqa: E501
        """AIVRPromptPlaying - a model defined in OpenAPI"""  # noqa: E501
    ...
    def audio_properties(self):
        """Gets the audio_properties of this AIVRPromptPlaying.  # noqa: E501


        :return: The audio_properties of this AIVRPromptPlaying.  # noqa: E501
    ...
    def audio_properties(self, audio_properties):
        """Sets the audio_properties of this AIVRPromptPlaying.


        :param audio_properties: The audio_properties of this AIVRPromptPlaying.  # noqa: E501
    ...
    def html_properties(self):
        """Gets the html_properties of this AIVRPromptPlaying.  # noqa: E501


        :return: The html_properties of this AIVRPromptPlaying.  # noqa: E501
    ...
    def html_properties(self, html_properties):
        """Sets the html_properties of this AIVRPromptPlaying.


        :param html_properties: The html_properties of this AIVRPromptPlaying.  # noqa: E501
    ...
    @property
    def text(self):
        """Gets the text of this AIVRPromptPlaying.  # noqa: E501

        text to be said or displayed  # noqa: E501

        :return: The text of this AIVRPromptPlaying.  # noqa: E501
        :rtype: str
        """
        return self._text
    ...
    @text.setter
    def text(self, text):
        """Sets the text of this AIVRPromptPlaying.

        text to be said or displayed  # noqa: E501

        :param text: The text of this AIVRPromptPlaying.  # noqa: E501
        :type: str
        """
    ...
    @property
    def wait_msec(self):
        """Gets the wait_msec of this AIVRPromptPlaying.  # noqa: E501
        ...
        :return: The wait_msec of this AIVRPromptPlaying.  # noqa: E501
        :rtype: int
        """
    ...
    def wait_msec(self, wait_msec):
        """Sets the wait_msec of this AIVRPromptPlaying.

        Wait time in milliseconds after playing or displaying the prompt before a callback will be made.</br> Meant mainly for GUI and has different meanings for prompt and a question:</br> **for prompt**  It is recommended to use so that interactions are paced in such a way so that the caller has sufficient time to read the prompt.</br> **for question** It is fully optional and can be used as a sort of timeout, that will allow to proceed if caller does not provide requested input.   # noqa: E501

        :param wait_msec: The wait_msec of this AIVRPromptPlaying.  # noqa: E501
        :type: int
        """
    ...
    @property
    def end_reason(self):
        """Gets the end_reason of this AIVRPromptPlaying.  # noqa: E501

        If prompt finished playing it will provide the reason why prompt finished  # noqa: E501

        :return: The end_reason of this AIVRPromptPlaying.  # noqa: E501
        :rtype: str
        """
    ...
    def end_reason(self, end_reason):
        """Sets the end_reason of this AIVRPromptPlaying.
        ...
        if self.local_vars_configuration.client_side_validation and end_reason not in allowed_values:  # noqa: E501
            raise ValueError(
                ...
                .format(end_reason, allowed_values)
            )
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AIVRPromptPlaying):
            return False
