...
class AsyncRecognitionResultAllOf(object):
    ...
    def __init__(self, final=None, local_vars_configuration=None):  # noqa: E501
        """AsyncRecognitionResultAllOf - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def final(self):
        """Gets the final of this AsyncRecognitionResultAllOf.  # noqa: E501

        Whether the result is final or if it can still change  # noqa: E501

        :return: The final of this AsyncRecognitionResultAllOf.  # noqa: E501
        :rtype: bool
        """
        return self._final
    ...
    def final(self, final):
        """Sets the final of this AsyncRecognitionResultAllOf.

        Whether the result is final or if it can still change  # noqa: E501

        :param final: The final of this AsyncRecognitionResultAllOf.  # noqa: E501
        :type: bool
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AsyncRecognitionResultAllOf):
            return False
