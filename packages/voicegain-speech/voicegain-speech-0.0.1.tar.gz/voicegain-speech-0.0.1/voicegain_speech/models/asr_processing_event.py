...
class AsrProcessingEvent(object):
    ...
    allowable_values = [START_OF_INPUT, RECOGNITION_COMPLETE]  # noqa: E501
    ...
    def __init__(self, local_vars_configuration=None):  # noqa: E501
        """AsrProcessingEvent - a model defined in OpenAPI"""  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AsrProcessingEvent):
            return False
