...
class SettingsRecognition(object):
    ...
    def __init__(self, asr=None, debug=None, preemptible=False, local_vars_configuration=None):  # noqa: E501
        """SettingsRecognition - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def asr(self):
        """Gets the asr of this SettingsRecognition.  # noqa: E501


        :return: The asr of this SettingsRecognition.  # noqa: E501
        :rtype: AsrSettingsRecognition
        """
        return self._asr

    @asr.setter
    def asr(self, asr):
        """Sets the asr of this SettingsRecognition.


        :param asr: The asr of this SettingsRecognition.  # noqa: E501
        :type: AsrSettingsRecognition
        """
        if self.local_vars_configuration.client_side_validation and asr is None:  # noqa: E501
            raise ValueError("Invalid value for `asr`, must not be `None`")  # noqa: E501

        self._asr = asr

    @property
    def debug(self):
        """Gets the debug of this SettingsRecognition.  # noqa: E501


        :return: The debug of this SettingsRecognition.  # noqa: E501
        :rtype: DebugSettings
        """
        return self._debug
    ...
    def debug(self, debug):
        """Sets the debug of this SettingsRecognition.


        :param debug: The debug of this SettingsRecognition.  # noqa: E501
        :type: DebugSettings
        """
    ...
    def preemptible(self):
        """Gets the preemptible of this SettingsRecognition.  # noqa: E501

        Reserved parameter for future use.   # noqa: E501

        :return: The preemptible of this SettingsRecognition.  # noqa: E501
        :rtype: bool
        """
    ...
    def preemptible(self, preemptible):
        """Sets the preemptible of this SettingsRecognition.

        Reserved parameter for future use.   # noqa: E501

        :param preemptible: The preemptible of this SettingsRecognition.  # noqa: E501
        :type: bool
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SettingsRecognition):
            return False
