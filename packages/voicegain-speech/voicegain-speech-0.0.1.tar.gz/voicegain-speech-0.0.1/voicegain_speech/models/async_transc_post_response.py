...
class AsyncTranscPostResponse(object):
    ...
    openapi_types = {
        ...
        'debug': 'DebugInfo',
        'preemptible': 'bool',
        'sessions': 'list[AsyncTranscSessionEstablished]'
    }
    ...
    def __init__(self, audio=None, debug=None, preemptible=False, sessions=None, local_vars_configuration=None):  # noqa: E501
        """AsyncTranscPostResponse - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def audio(self):
        """Gets the audio of this AsyncTranscPostResponse.  # noqa: E501


        :return: The audio of this AsyncTranscPostResponse.  # noqa: E501
    ...
    def audio(self, audio):
        """Sets the audio of this AsyncTranscPostResponse.


        :param audio: The audio of this AsyncTranscPostResponse.  # noqa: E501
    ...
    @property
    def debug(self):
        """Gets the debug of this AsyncTranscPostResponse.  # noqa: E501


        :return: The debug of this AsyncTranscPostResponse.  # noqa: E501
        :rtype: DebugInfo
        """
        return self._debug
    ...
    def debug(self, debug):
        """Sets the debug of this AsyncTranscPostResponse.


        :param debug: The debug of this AsyncTranscPostResponse.  # noqa: E501
        :type: DebugInfo
        """
    ...
    def preemptible(self):
        """Gets the preemptible of this AsyncTranscPostResponse.  # noqa: E501

        Reserved parameter for future use.   # noqa: E501

        :return: The preemptible of this AsyncTranscPostResponse.  # noqa: E501
        :rtype: bool
        """
    ...
    def preemptible(self, preemptible):
        """Sets the preemptible of this AsyncTranscPostResponse.

        Reserved parameter for future use.   # noqa: E501

        :param preemptible: The preemptible of this AsyncTranscPostResponse.  # noqa: E501
        :type: bool
        """
    ...
    @property
    def sessions(self):
        """Gets the sessions of this AsyncTranscPostResponse.  # noqa: E501

        Data describing the established async session(s).  # noqa: E501

        :return: The sessions of this AsyncTranscPostResponse.  # noqa: E501
        :rtype: list[AsyncTranscSessionEstablished]
        """
        return self._sessions

    @sessions.setter
    def sessions(self, sessions):
        """Sets the sessions of this AsyncTranscPostResponse.

        Data describing the established async session(s).  # noqa: E501

        :param sessions: The sessions of this AsyncTranscPostResponse.  # noqa: E501
        :type: list[AsyncTranscSessionEstablished]
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AsyncTranscPostResponse):
            return False
