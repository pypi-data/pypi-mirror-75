...
class InputAllOf(object):
    ...
    def __init__(self, gui_input=None, message=None, method=None, name=None, vui_alternatives=None, vui_result=None, local_vars_configuration=None):  # noqa: E501
        """InputAllOf - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def gui_input(self):
        """Gets the gui_input of this InputAllOf.  # noqa: E501


        :return: The gui_input of this InputAllOf.  # noqa: E501
        :rtype: list[GuiInput]
        """
    ...
    def gui_input(self, gui_input):
        """Sets the gui_input of this InputAllOf.


        :param gui_input: The gui_input of this InputAllOf.  # noqa: E501
        :type: list[GuiInput]
        """
    ...
    @property
    def message(self):
        """Gets the message of this InputAllOf.  # noqa: E501
        ...
        :return: The message of this InputAllOf.  # noqa: E501
        :rtype: str
        """
    ...
    def message(self, message):
        """Sets the message of this InputAllOf.

        (optional) message accompanying the vui result , e.g. if vuiResult==ERROR, then message may contain the reason for the error  # noqa: E501

        :param message: The message of this InputAllOf.  # noqa: E501
        :type: str
        """
    ...
    @property
    def method(self):
        """Gets the method of this InputAllOf.  # noqa: E501

        method the text was input (Voice UI or GUI)  # noqa: E501

        :return: The method of this InputAllOf.  # noqa: E501
        :rtype: str
        """
        return self._method
    ...
    def method(self, method):
        """Sets the method of this InputAllOf.

        method the text was input (Voice UI or GUI)  # noqa: E501

        :param method: The method of this InputAllOf.  # noqa: E501
        :type: str
        """
    ...
    @property
    def name(self):
        """Gets the name of this InputAllOf.  # noqa: E501

        name of the question  # noqa: E501

        :return: The name of this InputAllOf.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this InputAllOf.

        name of the question  # noqa: E501

        :param name: The name of this InputAllOf.  # noqa: E501
        :type: str
        """
    ...
    def vui_alternatives(self):
        """Gets the vui_alternatives of this InputAllOf.  # noqa: E501
        ...
        :return: The vui_alternatives of this InputAllOf.  # noqa: E501
        :rtype: list[RecoAlt]
        """
    ...
    def vui_alternatives(self, vui_alternatives):
        """Sets the vui_alternatives of this InputAllOf.

        (applies to speech input only) List of alternative recognition hypotheses. Ordered by confidence (highest confidence at top).  # noqa: E501

        :param vui_alternatives: The vui_alternatives of this InputAllOf.  # noqa: E501
        :type: list[RecoAlt]
        """
    ...
    @property
    def vui_result(self):
        """Gets the vui_result of this InputAllOf.  # noqa: E501


        :return: The vui_result of this InputAllOf.  # noqa: E501
    ...
    def vui_result(self, vui_result):
        """Sets the vui_result of this InputAllOf.


        :param vui_result: The vui_result of this InputAllOf.  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, InputAllOf):
            return False
