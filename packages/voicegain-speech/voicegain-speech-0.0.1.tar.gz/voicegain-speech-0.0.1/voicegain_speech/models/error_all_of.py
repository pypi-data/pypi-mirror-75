...
class ErrorAllOf(object):
    ...
    def __init__(self, detail=None, reason=None, local_vars_configuration=None):  # noqa: E501
        """ErrorAllOf - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def detail(self):
        """Gets the detail of this ErrorAllOf.  # noqa: E501

        Provides details of the error  # noqa: E501

        :return: The detail of this ErrorAllOf.  # noqa: E501
        :rtype: str
        """
        return self._detail
    ...
    def detail(self, detail):
        """Sets the detail of this ErrorAllOf.

        Provides details of the error  # noqa: E501

        :param detail: The detail of this ErrorAllOf.  # noqa: E501
        :type: str
        """
    ...
    @property
    def reason(self):
        """Gets the reason of this ErrorAllOf.  # noqa: E501

        States the error - generally fixed string so that the error handling code can match specific error reasons  # noqa: E501

        :return: The reason of this ErrorAllOf.  # noqa: E501
        :rtype: str
        """
        return self._reason
    ...
    def reason(self, reason):
        """Sets the reason of this ErrorAllOf.

        States the error - generally fixed string so that the error handling code can match specific error reasons  # noqa: E501

        :param reason: The reason of this ErrorAllOf.  # noqa: E501
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ErrorAllOf):
            return False
