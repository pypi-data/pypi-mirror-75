...
class PollReq(object):
    ...
    def __init__(self, afterlife=15000, persist=300000, local_vars_configuration=None):  # noqa: E501
        """PollReq - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def afterlife(self):
        """Gets the afterlife of this PollReq.  # noqa: E501

        Time (in msec) to retain the result/outcome data in memory after processing has completed.  Incremental results can only be retrieved from memory, so if doing incremental polling, make sure to set the value accordingly.   # noqa: E501

        :return: The afterlife of this PollReq.  # noqa: E501
        :rtype: float
        """
    ...
    def afterlife(self, afterlife):
        """Sets the afterlife of this PollReq.

        Time (in msec) to retain the result/outcome data in memory after processing has completed.  Incremental results can only be retrieved from memory, so if doing incremental polling, make sure to set the value accordingly.   # noqa: E501

        :param afterlife: The afterlife of this PollReq.  # noqa: E501
        :type: float
        """
    ...
    def persist(self):
        ...
        Time (in msec) to retain the full result data after processing has completed.  For Cloud, maximum persistence is 7 days. For On-Prem deployments data can be retained indefinitely if value is -1.  As long as the persist has not expired the data will be available for the poll request.   # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PollReq):
            return False
