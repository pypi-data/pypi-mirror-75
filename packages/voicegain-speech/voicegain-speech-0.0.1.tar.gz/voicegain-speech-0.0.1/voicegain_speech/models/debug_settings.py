...
class DebugSettings(object):
    ...
    def __init__(self, level=3, local_vars_configuration=None):  # noqa: E501
        """DebugSettings - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def level(self):
        """Gets the level of this DebugSettings.  # noqa: E501

        from 0 least detail to 7 most detail  # noqa: E501

        :return: The level of this DebugSettings.  # noqa: E501
        :rtype: int
        """
        return self._level
    ...
    def level(self, level):
        """Sets the level of this DebugSettings.

        from 0 least detail to 7 most detail  # noqa: E501

        :param level: The level of this DebugSettings.  # noqa: E501
        :type: int
        """
        if (self.local_vars_configuration.client_side_validation and
                level is not None and level > 7):  # noqa: E501
            raise ValueError("Invalid value for `level`, must be a value less than or equal to `7`")  # noqa: E501
        if (self.local_vars_configuration.client_side_validation and
