...
class SyncTranscriptionResponse(object):
    ...
    openapi_types = {
        ...
        'session': 'SyncSessionEstablished'
    }
    ...
    def __init__(self, captured_audio=None, debug=None, result=None, session=None, local_vars_configuration=None):  # noqa: E501
        """SyncTranscriptionResponse - a model defined in OpenAPI"""  # noqa: E501
        ...
        if captured_audio is not None:
            self.captured_audio = captured_audio
    ...
    def captured_audio(self):
        """Gets the captured_audio of this SyncTranscriptionResponse.  # noqa: E501

        uuid that can be used to get captured audio (present only if capture was requested)  # noqa: E501

        :return: The captured_audio of this SyncTranscriptionResponse.  # noqa: E501
        :rtype: str
        """
        return self._captured_audio

    @captured_audio.setter
    def captured_audio(self, captured_audio):
        """Sets the captured_audio of this SyncTranscriptionResponse.

        uuid that can be used to get captured audio (present only if capture was requested)  # noqa: E501

        :param captured_audio: The captured_audio of this SyncTranscriptionResponse.  # noqa: E501
        :type: str
        """

        self._captured_audio = captured_audio

    @property
    def debug(self):
        """Gets the debug of this SyncTranscriptionResponse.  # noqa: E501


        :return: The debug of this SyncTranscriptionResponse.  # noqa: E501
        :rtype: DebugInfo
        """
        return self._debug
    ...
    def debug(self, debug):
        """Sets the debug of this SyncTranscriptionResponse.


        :param debug: The debug of this SyncTranscriptionResponse.  # noqa: E501
        :type: DebugInfo
        """
    ...
    @property
    def result(self):
        """Gets the result of this SyncTranscriptionResponse.  # noqa: E501


        :return: The result of this SyncTranscriptionResponse.  # noqa: E501
        :rtype: SyncTranscriptionResult
        """
        return self._result

    @result.setter
    def result(self, result):
        """Sets the result of this SyncTranscriptionResponse.


        :param result: The result of this SyncTranscriptionResponse.  # noqa: E501
        :type: SyncTranscriptionResult
        """
    ...
    @property
    def session(self):
        """Gets the session of this SyncTranscriptionResponse.  # noqa: E501


        :return: The session of this SyncTranscriptionResponse.  # noqa: E501
        :rtype: SyncSessionEstablished
        """
        return self._session

    @session.setter
    def session(self, session):
        """Sets the session of this SyncTranscriptionResponse.


        :param session: The session of this SyncTranscriptionResponse.  # noqa: E501
        :type: SyncSessionEstablished
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SyncTranscriptionResponse):
            return False
