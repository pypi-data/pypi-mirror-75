...
class WebsocketResp(object):
    ...
    def __init__(self, name=None, url=None, local_vars_configuration=None):  # noqa: E501
        """WebsocketResp - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def url(self):
        """Gets the url of this WebsocketResp.  # noqa: E501

        (Required) Complete URL of the websocket messaging service that will provide transcription output.  # noqa: E501

        :return: The url of this WebsocketResp.  # noqa: E501
        :rtype: str
        """
        return self._url
    ...
    @url.setter
    def url(self, url):
        """Sets the url of this WebsocketResp.

        (Required) Complete URL of the websocket messaging service that will provide transcription output.  # noqa: E501

        :param url: The url of this WebsocketResp.  # noqa: E501
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, WebsocketResp):
            return False
