...
class SyncRecognitionResponse(object):
    ...
    def __init__(self, captured_audio=None, debug=None, result=None, session=None, local_vars_configuration=None):  # noqa: E501
        """SyncRecognitionResponse - a model defined in OpenAPI"""  # noqa: E501
    ...
    def captured_audio(self):
        """Gets the captured_audio of this SyncRecognitionResponse.  # noqa: E501

        uuid that can be used to get captured audio (present only if capture was requested)  # noqa: E501

        :return: The captured_audio of this SyncRecognitionResponse.  # noqa: E501
        :rtype: str
        """
    ...
    def captured_audio(self, captured_audio):
        """Sets the captured_audio of this SyncRecognitionResponse.

        uuid that can be used to get captured audio (present only if capture was requested)  # noqa: E501

        :param captured_audio: The captured_audio of this SyncRecognitionResponse.  # noqa: E501
        :type: str
        """
    ...
    @property
    def debug(self):
        """Gets the debug of this SyncRecognitionResponse.  # noqa: E501


        :return: The debug of this SyncRecognitionResponse.  # noqa: E501
        :rtype: DebugInfo
        """
        return self._debug
    ...
    def debug(self, debug):
        """Sets the debug of this SyncRecognitionResponse.


        :param debug: The debug of this SyncRecognitionResponse.  # noqa: E501
        :type: DebugInfo
        """
    ...
    @property
    def result(self):
        """Gets the result of this SyncRecognitionResponse.  # noqa: E501


        :return: The result of this SyncRecognitionResponse.  # noqa: E501
    ...
    def result(self, result):
        """Sets the result of this SyncRecognitionResponse.


        :param result: The result of this SyncRecognitionResponse.  # noqa: E501
    ...
    @property
    def session(self):
        """Gets the session of this SyncRecognitionResponse.  # noqa: E501


        :return: The session of this SyncRecognitionResponse.  # noqa: E501
    ...
    def session(self, session):
        """Sets the session of this SyncRecognitionResponse.


        :param session: The session of this SyncRecognitionResponse.  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SyncRecognitionResponse):
            return False
