...
class JJSGFAllOf(object):
    ...
    def __init__(self, examples=None, grammar=None, imports=None, parameters=None, public=None, rules=None, local_vars_configuration=None):  # noqa: E501
    ...
    @property
    def examples(self):
        """Gets the examples of this JJSGFAllOf.  # noqa: E501

        Examples of phrases matched by grammar. For documentation and testing purposes.  # noqa: E501

        :return: The examples of this JJSGFAllOf.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def examples(self, examples):
        """Sets the examples of this JJSGFAllOf.

        Examples of phrases matched by grammar. For documentation and testing purposes.  # noqa: E501

        :param examples: The examples of this JJSGFAllOf.  # noqa: E501
        :type: list[str]
        """
    ...
    @property
    def grammar(self):
        """Gets the grammar of this JJSGFAllOf.  # noqa: E501

        name of the JJSGF grammar  # noqa: E501

        :return: The grammar of this JJSGFAllOf.  # noqa: E501
        :rtype: str
        """
    ...
    def grammar(self, grammar):
        """Sets the grammar of this JJSGFAllOf.

        name of the JJSGF grammar  # noqa: E501

        :param grammar: The grammar of this JJSGFAllOf.  # noqa: E501
        :type: str
        """
        if (self.local_vars_configuration.client_side_validation and
                grammar is not None and len(grammar) > 128):
            raise ValueError("Invalid value for `grammar`, length must be less than or equal to `128`")  # noqa: E501

        self._grammar = grammar

    @property
    def imports(self):
        """Gets the imports of this JJSGFAllOf.  # noqa: E501

        imports of other JJSGF grammars  # noqa: E501

        :return: The imports of this JJSGFAllOf.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def imports(self, imports):
        """Sets the imports of this JJSGFAllOf.

        imports of other JJSGF grammars  # noqa: E501

        :param imports: The imports of this JJSGFAllOf.  # noqa: E501
        :type: list[str]
        """
    ...
    @property
    def parameters(self):
        """Gets the parameters of this JJSGFAllOf.  # noqa: E501

        JJSGF grammar parameters (TBD)  # noqa: E501

        :return: The parameters of this JJSGFAllOf.  # noqa: E501
        :rtype: object
        """
    ...
    def parameters(self, parameters):
        """Sets the parameters of this JJSGFAllOf.

        JJSGF grammar parameters (TBD)  # noqa: E501

        :param parameters: The parameters of this JJSGFAllOf.  # noqa: E501
        :type: object
        """
    ...
    @property
    def public(self):
        """Gets the public of this JJSGFAllOf.  # noqa: E501

        Top level rule. Only one.   For example:  basicCmd : \"\\<startPolite\\> \\<command\\> \\<endPolite\\>\"   # noqa: E501

        :return: The public of this JJSGFAllOf.  # noqa: E501
        :rtype: dict(str, str)
        """
        return self._public
    ...
    def public(self, public):
        """Sets the public of this JJSGFAllOf.

        Top level rule. Only one.   For example:  basicCmd : \"\\<startPolite\\> \\<command\\> \\<endPolite\\>\"   # noqa: E501

        :param public: The public of this JJSGFAllOf.  # noqa: E501
        :type: dict(str, str)
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, JJSGFAllOf):
            return False
