...
class GregAudioSetBaseInclusive(object):
    ...
    def __init__(self, audio=None, name=None, size=None, local_vars_configuration=None):  # noqa: E501
        """GregAudioSetBaseInclusive - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def audio(self):
        """Gets the audio of this GregAudioSetBaseInclusive.  # noqa: E501

        GREG audio objects contained in this set  # noqa: E501

        :return: The audio of this GregAudioSetBaseInclusive.  # noqa: E501
    ...
    def audio(self, audio):
        """Sets the audio of this GregAudioSetBaseInclusive.

        GREG audio objects contained in this set  # noqa: E501

        :param audio: The audio of this GregAudioSetBaseInclusive.  # noqa: E501
    ...
    @property
    def name(self):
        """Gets the name of this GregAudioSetBaseInclusive.  # noqa: E501

        unique audio set name  # noqa: E501

        :return: The name of this GregAudioSetBaseInclusive.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this GregAudioSetBaseInclusive.

        unique audio set name  # noqa: E501

        :param name: The name of this GregAudioSetBaseInclusive.  # noqa: E501
        :type: str
        """
    ...
    @property
    def size(self):
        """Gets the size of this GregAudioSetBaseInclusive.  # noqa: E501

        size of the audio set  # noqa: E501

        :return: The size of this GregAudioSetBaseInclusive.  # noqa: E501
        :rtype: int
        """
        return self._size
    ...
    @size.setter
    def size(self, size):
        """Sets the size of this GregAudioSetBaseInclusive.

        size of the audio set  # noqa: E501

        :param size: The size of this GregAudioSetBaseInclusive.  # noqa: E501
        :type: int
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GregAudioSetBaseInclusive):
            return False
