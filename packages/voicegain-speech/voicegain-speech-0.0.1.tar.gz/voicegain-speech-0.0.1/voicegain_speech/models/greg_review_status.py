...
class GregReviewStatus(object):
    ...
    allowable_values = [NOT_REVIEWED, INCOMPETE, COMPLETE, FOR_TRAINING]  # noqa: E501
    ...
    def __init__(self, local_vars_configuration=None):  # noqa: E501
        """GregReviewStatus - a model defined in OpenAPI"""  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GregReviewStatus):
            return False
