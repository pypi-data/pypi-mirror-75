...
class GregAudioSetCore(object):
    ...
    def __init__(self, audio_set_id=None, audio_ids=None, name=None, size=None, local_vars_configuration=None):  # noqa: E501
        """GregAudioSetCore - a model defined in OpenAPI"""  # noqa: E501
    ...
    def audio_set_id(self):
        """Gets the audio_set_id of this GregAudioSetCore.  # noqa: E501


        :return: The audio_set_id of this GregAudioSetCore.  # noqa: E501
        :rtype: str
        """
    ...
    def audio_set_id(self, audio_set_id):
        """Sets the audio_set_id of this GregAudioSetCore.


        :param audio_set_id: The audio_set_id of this GregAudioSetCore.  # noqa: E501
        :type: str
        """
    ...
    @property
    def audio_ids(self):
        """Gets the audio_ids of this GregAudioSetCore.  # noqa: E501

        ids of the GREG audio objects contained in this set  # noqa: E501

        :return: The audio_ids of this GregAudioSetCore.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def audio_ids(self, audio_ids):
        """Sets the audio_ids of this GregAudioSetCore.

        ids of the GREG audio objects contained in this set  # noqa: E501

        :param audio_ids: The audio_ids of this GregAudioSetCore.  # noqa: E501
        :type: list[str]
        """
    ...
    @property
    def name(self):
        """Gets the name of this GregAudioSetCore.  # noqa: E501

        unique audio set name  # noqa: E501

        :return: The name of this GregAudioSetCore.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this GregAudioSetCore.

        unique audio set name  # noqa: E501

        :param name: The name of this GregAudioSetCore.  # noqa: E501
        :type: str
        """
    ...
    @property
    def size(self):
        """Gets the size of this GregAudioSetCore.  # noqa: E501

        size of the audio set  # noqa: E501

        :return: The size of this GregAudioSetCore.  # noqa: E501
        :rtype: int
        """
        return self._size
    ...
    @size.setter
    def size(self, size):
        """Sets the size of this GregAudioSetCore.

        size of the audio set  # noqa: E501

        :param size: The size of this GregAudioSetCore.  # noqa: E501
        :type: int
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GregAudioSetCore):
            return False
