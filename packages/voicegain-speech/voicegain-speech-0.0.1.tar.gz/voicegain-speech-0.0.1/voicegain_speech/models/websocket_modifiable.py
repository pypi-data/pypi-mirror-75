...
class WebsocketModifiable(object):
    ...
    def __init__(self, context_id=None, default=False, delay=0, name=None, public=True, local_vars_configuration=None):  # noqa: E501
        """WebsocketModifiable - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def context_id(self):
        """Gets the context_id of this WebsocketModifiable.  # noqa: E501


        :return: The context_id of this WebsocketModifiable.  # noqa: E501
        :rtype: str
        """
    ...
    def context_id(self, context_id):
        """Sets the context_id of this WebsocketModifiable.


        :param context_id: The context_id of this WebsocketModifiable.  # noqa: E501
        :type: str
        """
    ...
    @property
    def default(self):
        """Gets the default of this WebsocketModifiable.  # noqa: E501

        Identifies a default socket for an account.  # noqa: E501

        :return: The default of this WebsocketModifiable.  # noqa: E501
        :rtype: bool
        """
    ...
    def default(self, default):
        """Sets the default of this WebsocketModifiable.

        Identifies a default socket for an account.  # noqa: E501

        :param default: The default of this WebsocketModifiable.  # noqa: E501
        :type: bool
        """
    ...
    @property
    def delay(self):
        """Gets the delay of this WebsocketModifiable.  # noqa: E501

        delay in msec for the delayed version of the websocket  # noqa: E501

        :return: The delay of this WebsocketModifiable.  # noqa: E501
        :rtype: int
        """
        return self._delay
    ...
    def delay(self, delay):
        """Sets the delay of this WebsocketModifiable.

        delay in msec for the delayed version of the websocket  # noqa: E501

        :param delay: The delay of this WebsocketModifiable.  # noqa: E501
        :type: int
        """
    ...
    @property
    def name(self):
        """Gets the name of this WebsocketModifiable.  # noqa: E501
        ...
        :return: The name of this WebsocketModifiable.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this WebsocketModifiable.

        Globally unique name under which the websocket will be available.</br> May contain only us-asci letters, digits, dash `-` , and underscore `_`  </br> Consecutive symbols are not allowed. Must start and end with digit or letter. </br> To achieve uniqueness it is suggested that your business name is part of the websocket name, see example. If the example is followed, the final URL to access the websocket would be: </br> wss://api.voicegain.ai/nats-websocket/port/acme-EventA-live     # noqa: E501

        :param name: The name of this WebsocketModifiable.  # noqa: E501
        :type: str
        """
    ...
    @property
    def public(self):
        """Gets the public of this WebsocketModifiable.  # noqa: E501

        If true, then access to the websocket will not require any authentication  # noqa: E501

        :return: The public of this WebsocketModifiable.  # noqa: E501
        :rtype: bool
        """
        return self._public
    ...
    def public(self, public):
        """Sets the public of this WebsocketModifiable.

        If true, then access to the websocket will not require any authentication  # noqa: E501

        :param public: The public of this WebsocketModifiable.  # noqa: E501
        :type: bool
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, WebsocketModifiable):
            return False
