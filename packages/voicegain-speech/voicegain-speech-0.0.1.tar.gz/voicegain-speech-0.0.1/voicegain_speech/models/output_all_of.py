...
class OutputAllOf(object):
    ...
    def __init__(self, end_reason=None, method=None, text=None, local_vars_configuration=None):  # noqa: E501
        """OutputAllOf - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def end_reason(self):
        """Gets the end_reason of this OutputAllOf.  # noqa: E501

        applies only to played prompt  # noqa: E501

        :return: The end_reason of this OutputAllOf.  # noqa: E501
        :rtype: str
        """
    ...
    def end_reason(self, end_reason):
        """Sets the end_reason of this OutputAllOf.

        applies only to played prompt  # noqa: E501

        :param end_reason: The end_reason of this OutputAllOf.  # noqa: E501
        :type: str
        """
    ...
    @property
    def method(self):
        """Gets the method of this OutputAllOf.  # noqa: E501

        method the text was output (Voice UI or GUI)  # noqa: E501

        :return: The method of this OutputAllOf.  # noqa: E501
        :rtype: str
        """
        return self._method
    ...
    def method(self, method):
        """Sets the method of this OutputAllOf.

        method the text was output (Voice UI or GUI)  # noqa: E501

        :param method: The method of this OutputAllOf.  # noqa: E501
        :type: str
        """
    ...
    @property
    def text(self):
        """Gets the text of this OutputAllOf.  # noqa: E501

        text of the prompt (dis)played - will include all resolved variables if applicable  # noqa: E501

        :return: The text of this OutputAllOf.  # noqa: E501
        :rtype: str
        """
        return self._text
    ...
    @text.setter
    def text(self, text):
        """Sets the text of this OutputAllOf.

        text of the prompt (dis)played - will include all resolved variables if applicable  # noqa: E501

        :param text: The text of this OutputAllOf.  # noqa: E501
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, OutputAllOf):
            return False
