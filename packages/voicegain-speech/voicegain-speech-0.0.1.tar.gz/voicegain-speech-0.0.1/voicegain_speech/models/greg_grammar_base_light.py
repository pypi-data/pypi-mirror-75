...
class GregGrammarBaseLight(object):
    ...
    def __init__(self, input=None, name=None, local_vars_configuration=None):  # noqa: E501
        """GregGrammarBaseLight - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def input(self):
        """Gets the input of this GregGrammarBaseLight.  # noqa: E501

        URIs of the grammars to be combined and used  # noqa: E501

        :return: The input of this GregGrammarBaseLight.  # noqa: E501
        :rtype: list[str]
        """
        return self._input
    ...
    def input(self, input):
        """Sets the input of this GregGrammarBaseLight.

        URIs of the grammars to be combined and used  # noqa: E501

        :param input: The input of this GregGrammarBaseLight.  # noqa: E501
        :type: list[str]
        """
    ...
    @property
    def name(self):
        """Gets the name of this GregGrammarBaseLight.  # noqa: E501

        unique grammar name  # noqa: E501

        :return: The name of this GregGrammarBaseLight.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this GregGrammarBaseLight.

        unique grammar name  # noqa: E501

        :param name: The name of this GregGrammarBaseLight.  # noqa: E501
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GregGrammarBaseLight):
            return False
