...
class GregExperimentStatusModifiable(object):
    ...
    allowable_values = [PROCESSING, READY, ERROR]  # noqa: E501
    ...
    def __init__(self, local_vars_configuration=None):  # noqa: E501
        """GregExperimentStatusModifiable - a model defined in OpenAPI"""  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GregExperimentStatusModifiable):
            return False
