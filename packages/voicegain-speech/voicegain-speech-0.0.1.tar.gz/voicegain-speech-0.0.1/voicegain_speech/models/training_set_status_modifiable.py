...
class TrainingSetStatusModifiable(object):
    ...
    allowable_values = [MODIFIED, STARTING, PROCESSING, READY, ERROR]  # noqa: E501
    ...
    def __init__(self, local_vars_configuration=None):  # noqa: E501
        """TrainingSetStatusModifiable - a model defined in OpenAPI"""  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, TrainingSetStatusModifiable):
            return False
