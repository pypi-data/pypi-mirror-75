...
class MRCPv2AsrSettings(object):
    ...
    def __init__(self, server_ip=None, sip_port=5060, local_vars_configuration=None):  # noqa: E501
        """MRCPv2AsrSettings - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def server_ip(self):
        """Gets the server_ip of this MRCPv2AsrSettings.  # noqa: E501

        MRCP server IP address  # noqa: E501

        :return: The server_ip of this MRCPv2AsrSettings.  # noqa: E501
        :rtype: str
        """
    ...
    def server_ip(self, server_ip):
        """Sets the server_ip of this MRCPv2AsrSettings.

        MRCP server IP address  # noqa: E501

        :param server_ip: The server_ip of this MRCPv2AsrSettings.  # noqa: E501
        :type: str
        """
    ...
    @property
    def sip_port(self):
        """Gets the sip_port of this MRCPv2AsrSettings.  # noqa: E501

        MRCP server SIP port  # noqa: E501

        :return: The sip_port of this MRCPv2AsrSettings.  # noqa: E501
        :rtype: float
        """
    ...
    def sip_port(self, sip_port):
        """Sets the sip_port of this MRCPv2AsrSettings.

        MRCP server SIP port  # noqa: E501

        :param sip_port: The sip_port of this MRCPv2AsrSettings.  # noqa: E501
        :type: float
        """
        if (self.local_vars_configuration.client_side_validation and
                sip_port is not None and sip_port > 65535):  # noqa: E501
            raise ValueError("Invalid value for `sip_port`, must be a value less than or equal to `65535`")  # noqa: E501
        if (self.local_vars_configuration.client_side_validation and
                sip_port is not None and sip_port < 1000):  # noqa: E501
            raise ValueError("Invalid value for `sip_port`, must be a value greater than or equal to `1000`")  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, MRCPv2AsrSettings):
            return False
