...
class AudioInputSync(object):
    ...
    @property
    def source(self):
        """Gets the source of this AudioInputSync.  # noqa: E501


        :return: The source of this AudioInputSync.  # noqa: E501
        :rtype: SyncAudioInputSource
        """
        return self._source

    @source.setter
    def source(self, source):
        """Sets the source of this AudioInputSync.


        :param source: The source of this AudioInputSync.  # noqa: E501
        :type: SyncAudioInputSource
        """
    ...
    @property
    def capture(self):
        """Gets the capture of this AudioInputSync.  # noqa: E501
        ...
        :return: The capture of this AudioInputSync.  # noqa: E501
        :rtype: bool
        """
    ...
    def capture(self, capture):
        """Sets the capture of this AudioInputSync.

        If **true** then Audio data will be captured, exactly as it was sent to ASR.  The captured audio data can be retrieved using a **uuid** of a DataObject,  which will be returned in the **response** to this request in a field **audio.capturedAudio**   # noqa: E501

        :param capture: The capture of this AudioInputSync.  # noqa: E501
        :type: bool
        """
    ...
    @property
    def channel(self):
        """Gets the channel of this AudioInputSync.  # noqa: E501


        :return: The channel of this AudioInputSync.  # noqa: E501
        :rtype: AudioChannel
        """
    ...
    def channel(self, channel):
        """Sets the channel of this AudioInputSync.


        :param channel: The channel of this AudioInputSync.  # noqa: E501
        :type: AudioChannel
        """
    ...
    @property
    def format(self):
        """Gets the format of this AudioInputSync.  # noqa: E501


        :return: The format of this AudioInputSync.  # noqa: E501
        :rtype: AudioFormat
        """
        return self._format
    ...
    def format(self, format):
        """Sets the format of this AudioInputSync.


        :param format: The format of this AudioInputSync.  # noqa: E501
        :type: AudioFormat
        """
    ...
    @property
    def rate(self):
        """Gets the rate of this AudioInputSync.  # noqa: E501


        :return: The rate of this AudioInputSync.  # noqa: E501
        :rtype: SampleRate
        """
        return self._rate
    ...
    @rate.setter
    def rate(self, rate):
        """Sets the rate of this AudioInputSync.


        :param rate: The rate of this AudioInputSync.  # noqa: E501
        :type: SampleRate
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AudioInputSync):
            return False
