...
class Caption(object):
    ...
    @property
    def duration(self):
        """Gets the duration of this Caption.  # noqa: E501

        duration of the caption (how long it should be displayed)  # noqa: E501

        :return: The duration of this Caption.  # noqa: E501
        :rtype: float
        """
    ...
    def duration(self, duration):
        """Sets the duration of this Caption.

        duration of the caption (how long it should be displayed)  # noqa: E501

        :param duration: The duration of this Caption.  # noqa: E501
        :type: float
        """
    ...
    @property
    def text(self):
        """Gets the text of this Caption.  # noqa: E501

        the text of the caption  # noqa: E501

        :return: The text of this Caption.  # noqa: E501
        :rtype: str
        """
        return self._text
    ...
    @text.setter
    def text(self, text):
        """Sets the text of this Caption.

        the text of the caption  # noqa: E501

        :param text: The text of this Caption.  # noqa: E501
        :type: str
        """
    ...
    @property
    def time(self):
        """Gets the time of this Caption.  # noqa: E501

        start time of the caption in msec since beginning of the audio stream  # noqa: E501

        :return: The time of this Caption.  # noqa: E501
        :rtype: int
        """
        return self._time
    ...
    @time.setter
    def time(self, time):
        """Sets the time of this Caption.

        start time of the caption in msec since beginning of the audio stream  # noqa: E501

        :param time: The time of this Caption.  # noqa: E501
        :type: int
        """
