...
class WebsocketMsg(object):
    ...
    def __init__(self, date=None, tags=None, text=None, time=None, local_vars_configuration=None):  # noqa: E501
        """WebsocketMsg - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def date(self):
        """Gets the date of this WebsocketMsg.  # noqa: E501

        this is just YYYY-MM-DD (we keep date and time separate to make it easy to delete old messages)  # noqa: E501

        :return: The date of this WebsocketMsg.  # noqa: E501
        :rtype: str
        """
        return self._date
    ...
    @date.setter
    def date(self, date):
        """Sets the date of this WebsocketMsg.

        this is just YYYY-MM-DD (we keep date and time separate to make it easy to delete old messages)  # noqa: E501

        :param date: The date of this WebsocketMsg.  # noqa: E501
        :type: str
        """
    ...
    @property
    def tags(self):
        """Gets the tags of this WebsocketMsg.  # noqa: E501

        list of tags, e.g. [\"rtp\", \"announce\"]  # noqa: E501

        :return: The tags of this WebsocketMsg.  # noqa: E501
        :rtype: list[str]
        """
        return self._tags
    ...
    @tags.setter
    def tags(self, tags):
        """Sets the tags of this WebsocketMsg.

        list of tags, e.g. [\"rtp\", \"announce\"]  # noqa: E501

        :param tags: The tags of this WebsocketMsg.  # noqa: E501
        :type: list[str]
        """
    ...
    @property
    def text(self):
        """Gets the text of this WebsocketMsg.  # noqa: E501

        the text of the message  # noqa: E501

        :return: The text of this WebsocketMsg.  # noqa: E501
        :rtype: str
        """
        return self._text
    ...
    @text.setter
    def text(self, text):
        """Sets the text of this WebsocketMsg.

        the text of the message  # noqa: E501

        :param text: The text of this WebsocketMsg.  # noqa: E501
        :type: str
        """
    ...
    @property
    def time(self):
        """Gets the time of this WebsocketMsg.  # noqa: E501

        this is just hh:mm:ss,sss  # noqa: E501

        :return: The time of this WebsocketMsg.  # noqa: E501
        :rtype: str
        """
        return self._time
    ...
    @time.setter
    def time(self, time):
        """Sets the time of this WebsocketMsg.

        this is just hh:mm:ss,sss  # noqa: E501

        :param time: The time of this WebsocketMsg.  # noqa: E501
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, WebsocketMsg):
            return False
