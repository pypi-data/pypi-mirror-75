...
class AIVRSessionUserBase(object):
    ...
    def __init__(self, participant_name=None, local_vars_configuration=None):  # noqa: E501
        """AIVRSessionUserBase - a model defined in OpenAPI"""  # noqa: E501
    ...
    def participant_name(self):
        """Gets the participant_name of this AIVRSessionUserBase.  # noqa: E501

        distinct (within session) name, e.g. caller1, agent1, agent2  # noqa: E501

        :return: The participant_name of this AIVRSessionUserBase.  # noqa: E501
        :rtype: str
        """
    ...
    def participant_name(self, participant_name):
        """Sets the participant_name of this AIVRSessionUserBase.

        distinct (within session) name, e.g. caller1, agent1, agent2  # noqa: E501

        :param participant_name: The participant_name of this AIVRSessionUserBase.  # noqa: E501
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AIVRSessionUserBase):
            return False
