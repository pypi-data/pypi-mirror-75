...
class GregGrammar(object):
    ...
    def __init__(self, grammar_id=None, account_id=None, context_id=None, input=None, name=None, resolved=None, local_vars_configuration=None):  # noqa: E501
        """GregGrammar - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def grammar_id(self):
        """Gets the grammar_id of this GregGrammar.  # noqa: E501

        Unique Id of the GREG Grammar  # noqa: E501

        :return: The grammar_id of this GregGrammar.  # noqa: E501
        :rtype: str
        """
    ...
    def grammar_id(self, grammar_id):
        """Sets the grammar_id of this GregGrammar.

        Unique Id of the GREG Grammar  # noqa: E501

        :param grammar_id: The grammar_id of this GregGrammar.  # noqa: E501
        :type: str
        """
        if self.local_vars_configuration.client_side_validation and grammar_id is None:  # noqa: E501
            raise ValueError("Invalid value for `grammar_id`, must not be `None`")  # noqa: E501

        self._grammar_id = grammar_id

    @property
    def account_id(self):
        """Gets the account_id of this GregGrammar.  # noqa: E501

        Account Id  # noqa: E501

        :return: The account_id of this GregGrammar.  # noqa: E501
        :rtype: str
        """
    ...
    def account_id(self, account_id):
        """Sets the account_id of this GregGrammar.

        Account Id  # noqa: E501

        :param account_id: The account_id of this GregGrammar.  # noqa: E501
        :type: str
        """
    ...
    @property
    def context_id(self):
        """Gets the context_id of this GregGrammar.  # noqa: E501

        Context Id  # noqa: E501

        :return: The context_id of this GregGrammar.  # noqa: E501
        :rtype: str
        """
    ...
    def context_id(self, context_id):
        """Sets the context_id of this GregGrammar.

        Context Id  # noqa: E501

        :param context_id: The context_id of this GregGrammar.  # noqa: E501
        :type: str
        """
    ...
    @property
    def input(self):
        """Gets the input of this GregGrammar.  # noqa: E501

        URIs of the grammars that are combined to form the final grammar used by GREG.</br> Absent if GREG grammar is not obtained from URLs.   # noqa: E501

        :return: The input of this GregGrammar.  # noqa: E501
        :rtype: list[str]
        """
        return self._input
    ...
    def input(self, input):
        """Sets the input of this GregGrammar.

        URIs of the grammars that are combined to form the final grammar used by GREG.</br> Absent if GREG grammar is not obtained from URLs.   # noqa: E501

        :param input: The input of this GregGrammar.  # noqa: E501
        :type: list[str]
        """
    ...
    @property
    def name(self):
        """Gets the name of this GregGrammar.  # noqa: E501

        unique grammar name  # noqa: E501

        :return: The name of this GregGrammar.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this GregGrammar.

        unique grammar name  # noqa: E501

        :param name: The name of this GregGrammar.  # noqa: E501
        :type: str
        """
    ...
    @property
    def resolved(self):
        """Gets the resolved of this GregGrammar.  # noqa: E501

        serialized resolved grammars that were obtained from provided input  # noqa: E501

        :return: The resolved of this GregGrammar.  # noqa: E501
        :rtype: list[object]
        """
    ...
    def resolved(self, resolved):
        """Sets the resolved of this GregGrammar.

        serialized resolved grammars that were obtained from provided input  # noqa: E501

        :param resolved: The resolved of this GregGrammar.  # noqa: E501
        :type: list[object]
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GregGrammar):
            return False
