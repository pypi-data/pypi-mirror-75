...
class AsrProcessingStatus(object):
    ...
    allowable_values = [INPROGRESS, NOINPUT, NOMATCH, MATCH, ERROR]  # noqa: E501
    ...
    def __init__(self, local_vars_configuration=None):  # noqa: E501
        """AsrProcessingStatus - a model defined in OpenAPI"""  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AsrProcessingStatus):
            return False
