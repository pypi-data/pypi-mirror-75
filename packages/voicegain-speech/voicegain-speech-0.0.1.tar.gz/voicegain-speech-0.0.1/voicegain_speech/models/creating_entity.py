...
class CreatingEntity(object):
    ...
    allowable_values = [VOICEGAIN, CUSTOMER]  # noqa: E501
    ...
    def __init__(self, local_vars_configuration=None):  # noqa: E501
        """CreatingEntity - a model defined in OpenAPI"""  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreatingEntity):
            return False
