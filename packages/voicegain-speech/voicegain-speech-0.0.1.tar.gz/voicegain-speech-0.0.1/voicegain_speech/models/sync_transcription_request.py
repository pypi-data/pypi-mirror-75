...
class SyncTranscriptionRequest(object):
    ...
    """
    openapi_types = {
        'audio': 'AudioInputSync',
        'settings': 'SettingsSyncTranscription'
    }
    ...
    def __init__(self, audio=None, settings=None, local_vars_configuration=None):  # noqa: E501
        """SyncTranscriptionRequest - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def audio(self):
        """Gets the audio of this SyncTranscriptionRequest.  # noqa: E501


        :return: The audio of this SyncTranscriptionRequest.  # noqa: E501
        :rtype: AudioInputSync
        """
        return self._audio

    @audio.setter
    def audio(self, audio):
        """Sets the audio of this SyncTranscriptionRequest.


        :param audio: The audio of this SyncTranscriptionRequest.  # noqa: E501
        :type: AudioInputSync
        """
    ...
    @property
    def settings(self):
        """Gets the settings of this SyncTranscriptionRequest.  # noqa: E501


        :return: The settings of this SyncTranscriptionRequest.  # noqa: E501
        :rtype: SettingsSyncTranscription
        """
        return self._settings

    @settings.setter
    def settings(self, settings):
        """Sets the settings of this SyncTranscriptionRequest.


        :param settings: The settings of this SyncTranscriptionRequest.  # noqa: E501
        :type: SettingsSyncTranscription
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SyncTranscriptionRequest):
            return False
