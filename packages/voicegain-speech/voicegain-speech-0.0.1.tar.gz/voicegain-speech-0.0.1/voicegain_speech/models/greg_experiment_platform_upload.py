...
class GregExperimentPlatformUpload(object):
    ...
    def __init__(self, description=None, local_vars_configuration=None):  # noqa: E501
        """GregExperimentPlatformUpload - a model defined in OpenAPI"""  # noqa: E501
    ...
    def description(self):
        """Gets the description of this GregExperimentPlatformUpload.  # noqa: E501

        Description of the uploaded data.  # noqa: E501

        :return: The description of this GregExperimentPlatformUpload.  # noqa: E501
        :rtype: str
        """
    ...
    def description(self, description):
        """Sets the description of this GregExperimentPlatformUpload.

        Description of the uploaded data.  # noqa: E501

        :param description: The description of this GregExperimentPlatformUpload.  # noqa: E501
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GregExperimentPlatformUpload):
            return False
