...
class SecurityApi(object):
    ...
    def security_jwt_get(self, aud, **kwargs):  # noqa: E501
        ...
        >>> thread = api.security_jwt_get(aud, async_req=True)
        >>> result = thread.get()
        ...
        return self.security_jwt_get_with_http_info(aud, **kwargs)  # noqa: E501
    ...
    def security_jwt_get_with_http_info(self, aud, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('aud' not in local_var_params or  # noqa: E501
                                                        local_var_params['aud'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `aud` when calling `security_jwt_get`")  # noqa: E501
