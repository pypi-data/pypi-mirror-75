...
class AivrApi(object):
    ...
    def aivr_get(self, ivr_sid, **kwargs):  # noqa: E501
        ...
        :return: CoreAIVRSession
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        return self.aivr_get_with_http_info(ivr_sid, **kwargs)  # noqa: E501
    ...
    def aivr_get_with_http_info(self, ivr_sid, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('ivr_sid' not in local_var_params or  # noqa: E501
