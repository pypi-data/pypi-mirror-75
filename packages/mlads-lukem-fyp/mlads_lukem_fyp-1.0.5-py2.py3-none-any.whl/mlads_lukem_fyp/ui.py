...
class GUI:
    ...
    def view_alert_details(self, table, focus):
        ...
        if len(values) == 0:
            details_window.wm_title("Error")
            label = ttk.Label(details_window, text='Please select a line to see more details...')
            label.pack()
            button = ttk.Button(details_window, text="Okay", command=details_window.destroy)
            button.pack()
        else:
    ...
    def analyse_window(self):
        ...
        if len(existing_files) == 0:
            file_var.set("No CSVs yet...")
            existing_files.append('No CSVs yet...')
        else:
    ...
    def analyse_file(self, filename):
        ...
        try:
            ...
            # If we can't read the file, tell us
            print(e)
