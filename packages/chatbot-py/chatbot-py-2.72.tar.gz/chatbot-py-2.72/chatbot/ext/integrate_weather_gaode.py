...
baidumap_api_key = '5oEtquqXoPReYb4YLINasLikoCWRZLMr'
...
if __name__ == '__main__':
    for i in range(10000):
        print(get_weather('秦淮河', '20190726'))
        print(get_weather('夫子庙', '20190726'))
        print(get_weather('南京中山陵', '20190726'))
        print(get_weather('玄武湖', '20190726'))
        print(get_weather('台江区', '20190726'))
        print(get_weather('福州', '20190726'))
        print(get_weather('南京', '20190726'))
