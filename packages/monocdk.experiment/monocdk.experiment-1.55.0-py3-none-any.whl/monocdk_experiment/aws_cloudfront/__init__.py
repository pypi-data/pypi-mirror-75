...
class Origin(
    ...
    def __init__(
        ...
        *,
        ...
        jsii.create(Origin, self, [domain_name, props])

    @jsii.member(jsii_name="bind")
    def bind(self, scope: _Construct_f50a3f53, *, origin_index: jsii.Number) -> None:
        ...
        :stability: experimental
        """
        options = OriginBindOptions(origin_index=origin_index)
    ...
    def render_origin(self) -> "CfnDistribution.OriginProperty":
...
@jsii.data_type(
    ...
    jsii_struct_bases=[],
    name_mapping={"origin_index": "originIndex"},
)
class OriginBindOptions:
    def __init__(self, *, origin_index: jsii.Number) -> None:
    ...
    @builtins.property
    def origin_index(self) -> jsii.Number:
        """The positional index of this origin within the distribution.

        Used for ensuring unique IDs.

        stability
        :stability: experimental
        """
        return self._values.get("origin_index")
