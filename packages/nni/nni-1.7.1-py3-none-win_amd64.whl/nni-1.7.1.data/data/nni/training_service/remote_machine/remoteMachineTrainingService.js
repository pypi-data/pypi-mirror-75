                ...
                try {
                    ...
                    for (const [rmMeta, executorManager] of this.machineExecutorManagerMap.entries()) {
                        ...
                        if (executor !== undefined) {
                            this.machineCopyExpCodeDirPromiseMap.set(rmMeta, executor.copyDirectoryToRemote(remoteMachineTrailConfig.codeDir, executor.getRemoteCodePath(experimentStartupInfo_1.getExperimentId())));
                        }
                    }
                }
                catch (error) {
