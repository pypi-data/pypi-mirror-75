...
class LogEntry(Model):
    ...
    def __init__(self, status=None, log=None, status_event=None, level=None, important=None, **kwargs):
        self.status = status
        self.log = log
...
class CustomModelServerRequestBase(Model):
    ...
    Keyword arguments:
    entrypoint -- path to a Python module that contains Predictor class
    python_path -- Python path to the Predictor
