...
from pneuro import appLogger
from pneuro import file_methods
#from appLogger import AppLogger


#from file_methods import FileOperation
...
class ClassificationModelTuner():
    ...
    def __init__(self):
        self.file_object = open('pneuro/logs/classificationModelsLogs.txt', 'a+')
        self.logger_object = appLogger.AppLogger()
        self.file_operation = file_methods.FileOperation()
