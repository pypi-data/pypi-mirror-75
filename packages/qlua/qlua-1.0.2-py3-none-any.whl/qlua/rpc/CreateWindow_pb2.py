...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='qlua/rpc/CreateWindow.proto',
  package='qlua.rpc.CreateWindow',
  syntax='proto3',
  serialized_options=_b('\n\010qlua.rpcH\001'),
  serialized_pb=_b('\n\x1bqlua/rpc/CreateWindow.proto\x12\x15qlua.rpc.CreateWindow\"\x14\n\x04\x41rgs\x12\x0c\n\x04t_id\x18\x01 \x01(\x05\"\x18\n\x06Result\x12\x0e\n\x06result\x18\x01 \x01(\x05\x42\x0c\n\x08qlua.rpcH\x01\x62\x06proto3')
)
...
_ARGS = _descriptor.Descriptor(
  name='Args',
  full_name='qlua.rpc.CreateWindow.Args',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='t_id', full_name='qlua.rpc.CreateWindow.Args.t_id', index=0,
...
_RESULT = _descriptor.Descriptor(
  name='Result',
  full_name='qlua.rpc.CreateWindow.Result',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='result', full_name='qlua.rpc.CreateWindow.Result.result', index=0,
      number=1, type=5, cpp_type=1, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
Args = _reflection.GeneratedProtocolMessageType('Args', (_message.Message,), dict(
  DESCRIPTOR = _ARGS,
  __module__ = 'qlua.rpc.CreateWindow_pb2'
