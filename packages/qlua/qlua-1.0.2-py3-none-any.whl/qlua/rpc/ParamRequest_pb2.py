...
_ARGS = _descriptor.Descriptor(
  name='Args',
  full_name='qlua.rpc.ParamRequest.Args',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='class_code', full_name='qlua.rpc.ParamRequest.Args.class_code', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='sec_code', full_name='qlua.rpc.ParamRequest.Args.sec_code', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='db_name', full_name='qlua.rpc.ParamRequest.Args.db_name', index=2,
...
Args = _reflection.GeneratedProtocolMessageType('Args', (_message.Message,), dict(
  DESCRIPTOR = _ARGS,
  __module__ = 'qlua.rpc.ParamRequest_pb2'
