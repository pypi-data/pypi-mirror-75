...
_ARGS = _descriptor.Descriptor(
  name='Args',
  full_name='qlua.rpc.getClassSecurities.Args',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='class_code', full_name='qlua.rpc.getClassSecurities.Args.class_code', index=0,
...
Args = _reflection.GeneratedProtocolMessageType('Args', (_message.Message,), dict(
  DESCRIPTOR = _ARGS,
  __module__ = 'qlua.rpc.getClassSecurities_pb2'
