...
_ARGS = _descriptor.Descriptor(
  name='Args',
  full_name='qlua.rpc.SetTableNotificationCallback.Args',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='t_id', full_name='qlua.rpc.SetTableNotificationCallback.Args.t_id', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='f_cb_def', full_name='qlua.rpc.SetTableNotificationCallback.Args.f_cb_def', index=1,
...
Args = _reflection.GeneratedProtocolMessageType('Args', (_message.Message,), dict(
  DESCRIPTOR = _ARGS,
  __module__ = 'qlua.rpc.SetTableNotificationCallback_pb2'
