...
class Binomial(Distribution):
    ...
    def pdf(self, k):
        ...
        binom_coeff = math.factorial(self.n) / (math.factorial(k)*math.factorial(self.n-k))
    ...
    def plot_bar_pdf(self):
        ...
        k_values = [k for k in range(self.n+1)]
        pdfs = list(map(self.pdf, k_values))
        plt.bar(k_values, pdfs)
    ...
    def __repr__(self):
        ...
        return Distribution.__repr__ + f', p {self.p}, n {self.n}'
