...
def xorcrypt_decrypt(str, key):
    return _ciphey_core_py.xorcrypt_decrypt(str, key)

def xorcrypt_encrypt(str, key):
    return _ciphey_core_py.xorcrypt_encrypt(str, key)
