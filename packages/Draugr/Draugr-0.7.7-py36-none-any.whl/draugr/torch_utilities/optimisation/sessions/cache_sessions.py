...
from draugr.torch_utilities.optimisation.sessions.model_sessions import  TorchEvalSession, TorchTrainSession
from draugr.torch_utilities.optimisation.sessions.device_sessions import global_torch_device,TorchCpuSession, TorchCudaSession
