...
def hyperlink_url(link: str, link_id=None, style: bool = False, prefix='https://') -> str:
...
def hyperlink_path(link: Path, link_id=None, style: bool = False, linux: bool = True) -> str:
  if linux:
