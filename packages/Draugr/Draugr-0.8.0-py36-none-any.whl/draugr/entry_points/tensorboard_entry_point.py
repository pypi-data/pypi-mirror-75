...
def main(keep_alive: bool = True) -> str:
    ...
    parser.add_argument(
        "NAME", metavar="Name", type=str, help="App name to open AppPath for"
    )
    parser.add_argument(
      "--author", metavar="Author", type=str, help="App author to open AppPath for", default=None
      )
    parser.add_argument(
      "--version", metavar="Version", type=str, help="App version to open AppPath for", default=None
      )
    parser.add_argument(
        "--clean",
        action="store_true",
