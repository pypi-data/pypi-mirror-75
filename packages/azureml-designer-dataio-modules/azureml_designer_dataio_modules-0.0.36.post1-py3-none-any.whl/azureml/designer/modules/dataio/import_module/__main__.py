    ...
    def run(cls, input_dict: dict = None) -> DataFrameDirectory:
        ...
        try:
            ...
            if error_code in [
                ...
                'ScriptExecution.DatabaseQuery.Timeout', 'ScriptExecution.DatabaseRead',
                'ScriptExecution.Transformation.Validation', 'ScriptExecution.StreamAccess.Throttling',
                'ScriptExecution.StreamAccess.TimeoutExpired', 'ScriptExecution.DatabaseRead.Unexpected'
            ]:
