...
def importSLEAPbottomUP(inifile, dataFolder, currIDList):
    ...
    for filename in filesFound:
        ...
        try:
            ...
            print('Warning: The video name could not be found in the .SLP meta-data table. SimBA therefore gives the imported CSV the same name as the SLP file. To be sure that SimBAs slp import function works, make sure the .SLP file and the associated video file has the same file name - e.g., "Video1.slp" and "Video1.slp" borefore importing the videos and SLP files to SimBA.')
