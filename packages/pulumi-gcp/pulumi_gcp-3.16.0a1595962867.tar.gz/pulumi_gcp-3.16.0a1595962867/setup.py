...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'gcp', '3.16.0-alpha.1595962867+8a0db4af'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource gcp 3.16.0-alpha.1595962867+8a0db4af`
                """)
            else:
                raise
