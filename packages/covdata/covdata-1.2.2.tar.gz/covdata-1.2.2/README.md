...
This server is mainly made to give the data related to covid-19 in India.
Thsi server mainly focused on showing the data in interactive way.
Link: [Covidindia Server](https://covdata.pythonanywhere.com/)
...
## Usage
     ...
     #shows the collected data in Dataframe format of Total Confimed daily count data.(if daily is false cumulative data will be shown)
     ...
     obj3.whole(typeof='confirmed',daily=False,xlabel='Dates',ylabel='Daily Counts')   #cumulative count plot of india of confirmed case .

     #cumulative recovery plot of Maharashtra between 3/6/2020 and 10/6/2020
     obj3.graph_by_date(startDate='3/6/2020', endDate='10/6/2020', typeof='recovered',title='recovery data', daily=False,state='mh')
