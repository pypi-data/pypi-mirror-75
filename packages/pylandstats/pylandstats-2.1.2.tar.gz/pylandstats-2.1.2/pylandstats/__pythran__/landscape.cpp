...
namespace __pythran_landscape
{
  ...
  {
    {
      static typename __transonic__::type::result_type tmp_global = pythonic::types::make_tuple(pythonic::types::str("0.4.3"));
      return tmp_global;
    }
  }
  template <typename argument_type0 , typename argument_type1 >
  typename compute_adjacency_arr::type<argument_type0, argument_type1>::result_type compute_adjacency_arr::operator()(argument_type0&& padded_arr, argument_type1&& num_classes) const
  {
    ...
    {
      long  __target140268324961976 = end;
      for (long  i=pythonic::operator_::add(num_cols_pixel, 1L); i < __target140268324961976; i += 1L)
      {
...
PYTHRAN_MODULE_INIT(landscape)(void) {
    ...
    PyObject * theDoc = Py_BuildValue("(sss)",
                                      "0.9.6",
                                      "2020-08-03 07:59:28.493598",
                                      "124b97909a89706d4f8d3f929b6cf00bc436ba5038f21d9194a14e8ea02eecf3");
    if(! theDoc)
        PYTHRAN_RETURN;
