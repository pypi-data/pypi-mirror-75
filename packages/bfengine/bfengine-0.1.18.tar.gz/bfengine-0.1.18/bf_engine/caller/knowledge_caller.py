...
class KnowledgeGraphCaller(CallerBase):
    ...
    def __init__(self, app_id):
        ...
        self.check_entity_repeat_url \
            = '{}:18811/xeonKgDal/entityManager/{}/checkRepeat/entity?entityName={}&entityId=&entityType=1'
        # 获取实体 app_id, parent_entity_id, keyword
        self.load_entity_url \
            = '{}:18811/xeonKgDal/entityProfile/{}/showEntityProfileDetail/{}?page=1&entityListKeyword={}'
        # 新增一级实体
        self.add_entity_url = '{}:18811/xeonKgDal/entityManager/{}/addEntity/root'.format(base_url, app_id)
        # 获取属性
        self.load_property_url = '{}:18811/xeonKgDal/{}/property/allCommon?page=1&keyword={}'
        # 新增屬性
        self.add_property_url = '{}:18811/xeonKgDal/{}/property'.format(base_url, app_id)
        # 查询属性值
        self.load_relation_url = '{}:18811/xeonKgDal/relation/{}/getDataOverViewRelationByRootEntity/{}?page=1&limit=20&entityListKeyword='
        # 新增属性值
        self.add_relation_url = '{}:18811/xeonKgDal/relation/{}/addRelation'.format(base_url, app_id)
        # 更新属性值
        self.update_relation_url = '{}:18811/xeonKgDal/relation/{}/updateRelation'.format(base_url, app_id)
        # 更新实体简介
        self.update_entity_intro_url = '{}:18811/xeonKgDal/entityProfile/{}/addEntityProfile/{}'
        # 更新属性简介
        self.update_property_intro_url = '{}:18811/xeonKgDal/{}/property/desc'.format(base_url, app_id)
        # 添加属性语料
        self.add_property_corpus_url = '{}:18811/xeonKgDal/{}/property/{}'
        # 词库 新增同义词 实体/属性
        self.wordbank_add_url = '{}:18811/xeonKgDal/synonym/{}/addSynonym'.format(base_url, app_id) + "/{}?type={}"
        # 词库 更新同义词 实体/属性
        self.wordbank_update_url = '{}:18811/xeonKgDal/synonym/{}/updateSynonym'.format(base_url,
                                                                                        app_id) + "/{}?type={}"
        # 词库 删除同义词 实体/属性
        self.wordbank_delete_url = '{}:18811/xeonKgDal/synonym/{}/deleteSynonym'.format(base_url,
                                                                                        app_id) + "/{}?type={}"
        # 词库 查询同义词 实体/属性
        self.wordbank_get_url = '{}:18811/xeonKgDal/synonym/{}/showSynonym'.format(base_url,
                                                                                   app_id) + "?show=matchId&type={}&object_id={}"

        # 词库 新增值同义词
        self.wordbank_value_add_url = '{}:18811/xeonKgDal/propertyKeyword/{}/addKeywordSynonym'.format(base_url, app_id)
        # 词库 更新值同义词
        self.wordbank_value_update_url = '{}:18811/xeonKgDal/propertyKeyword/{}/updateKeywordSynonym'.format(base_url,
                                                                                                             app_id)
        # 词库 删除同义词
        self.wordbank_value_delete_url = '{}:18811/xeonKgDal/propertyKeyword/{}/deleteKeywordSynonym'.format(base_url,
                                                                                                             app_id)
        # 词库 查询值同义词
        self.wordbank_value_get_url = '{}:18811/xeonKgDal/propertyKeyword/{}?target=getAll'.format(base_url, app_id)

        # 初始知识库
        self.init_url = '{}:18811/xeonKgDal/property/{}/initialProperty'.format(base_url, app_id)
    ...
    def init_data(self):
        ...
        try:
            ...
            msg = "kg: 初始化数据失败， 原因: Exception When POST '{}' : {}".format(self.init_url, traceback.format_exc())
            raise BfEngineException(ErrorCode.kg_init_error, msg)
    ...
    def _get_property_synonym(self, property_name: str):
        ...
        """
        try:
            property_object = self.load_entity(0, property_name)
            if property_object is not None:
                property_id = property_object['id']
    ...
    def _get_value_synonym(self, value_name: str):
        ...
        """
        try:
            response = requests.delete(url=self.wordbank_value_get_url)
            if self._response_failed(response):
