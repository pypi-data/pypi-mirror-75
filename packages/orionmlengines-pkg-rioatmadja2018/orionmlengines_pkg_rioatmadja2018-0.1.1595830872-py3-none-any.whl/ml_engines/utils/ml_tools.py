...
def find_best_parameters(df: DataFrame, response: str, iterations: int = 100, random_state: int = 150) -> DataFrame:
    """
    ...
    return pd.DataFrame(results).sort_values(by=['Accuracy', 'AUC', 'P-Rsquared'], ascending=False)
