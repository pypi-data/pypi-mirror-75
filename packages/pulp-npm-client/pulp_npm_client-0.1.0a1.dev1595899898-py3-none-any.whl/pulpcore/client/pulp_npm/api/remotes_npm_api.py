...
class RemotesNpmApi(object):
    ...
    def delete(self, npm_remote_href, **kwargs):  # noqa: E501
        ...
        :param async_req bool: execute request asynchronously
        :param str npm_remote_href: (required)
        :param str name: name
    ...
    def partial_update(self, npm_remote_href, patchednpm_npm_remote, **kwargs):  # noqa: E501
        """partial_update  # noqa: E501

        Trigger an asynchronous partial update task  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.partial_update(npm_remote_href, patchednpm_npm_remote, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.partial_update_with_http_info(npm_remote_href, patchednpm_npm_remote, **kwargs)  # noqa: E501

    def partial_update_with_http_info(self, npm_remote_href, patchednpm_npm_remote, **kwargs):  # noqa: E501
        """partial_update  # noqa: E501

        Trigger an asynchronous partial update task  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.partial_update_with_http_info(npm_remote_href, patchednpm_npm_remote, async_req=True)
        >>> result = thread.get()
    ...
    def update(self, npm_remote_href, npm_npm_remote, **kwargs):  # noqa: E501
        """update  # noqa: E501

        Trigger an asynchronous update task  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update(npm_remote_href, npm_npm_remote, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.update_with_http_info(npm_remote_href, npm_npm_remote, **kwargs)  # noqa: E501

    def update_with_http_info(self, npm_remote_href, npm_npm_remote, **kwargs):  # noqa: E501
        """update  # noqa: E501

        Trigger an asynchronous update task  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_with_http_info(npm_remote_href, npm_npm_remote, async_req=True)
        >>> result = thread.get()
