...
- API version: v3
- Package version: 0.1.0a1.dev01596158964
...
*DistributionsNpmApi* | [**partial_update**](docs/DistributionsNpmApi.md#partial_update) | **PATCH** {npm_distribution_href} | Update a npm distribution
...
*RemotesNpmApi* | [**partial_update**](docs/RemotesNpmApi.md#partial_update) | **PATCH** {npm_remote_href} | Update a npm remote
...
*RepositoriesNpmApi* | [**partial_update**](docs/RepositoriesNpmApi.md#partial_update) | **PATCH** {npm_repository_href} | Update a npm repository
...
*RepositoriesNpmVersionsApi* | [**list**](docs/RepositoriesNpmVersionsApi.md#list) | **GET** {npm_repository_version_href}versions/ | List repository versions
