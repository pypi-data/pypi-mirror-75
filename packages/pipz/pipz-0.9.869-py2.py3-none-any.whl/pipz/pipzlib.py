...
def install_private_package(ctx, package, secret):
    ...
    if secret is None:
        os.system("pip install {package} --quiet --no-cache  --no-cache-dir --upgrade --index-url http://s3.amazonaws.com/whl/{package}/index.html --find-links http://s3.amazonaws.com/whl/{package}/index.html --trusted-host s3.amazonaws.com".format(package=package))
    else:
        os.system("pip install {package} --quiet --no-cache  --no-cache-dir --upgrade --index-url http://s3.amazonaws.com/whl/{secret}/{package}/index.html --find-links http://s3.amazonaws.com/whl/{secret}/{package}/index.html --trusted-host s3.amazonaws.com".format(package=package, secret=secret))
