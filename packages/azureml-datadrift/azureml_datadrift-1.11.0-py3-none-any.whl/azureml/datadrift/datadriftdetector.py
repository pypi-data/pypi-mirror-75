...
class DataDriftDetector:
    ...
    datasets directly or having them inferred from a model name, version, and whitelist of webservice endpoints.
    ...
    .. remarks::
        ...
        * To create a model-based DataDriftDetector object, use
