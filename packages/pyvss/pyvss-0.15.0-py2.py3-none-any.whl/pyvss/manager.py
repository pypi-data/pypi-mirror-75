...
from pyvss.const import (
    ...
    VALID_VM_NIC_TYPE, VALID_VM_SCSI_CONTROLLER, VALID_VM_USAGE,
...
class VssManager:
    ...
    def get_group_members(self, g_id):
        ...
        """
        json = self.request(
            f'/group/{g_id}/member', method=self.GET
        )
        return json.get('data')
    ...
    def get_user_token(self, token_id):
        ...
        """
        json = self.request(
            f'/user/token/{token_id}', method=self.GET
        )
        return json.get('data')
    ...
    def disable_user_token(self, token_id):
        ...
        """
        json = self.request(
            f'/user/token/{token_id}', method=self.PUT
        )
        return json
    ...
    def delete_user_token(self, token_id):
        ...
        """
        json = self.request(
            f'/user/token/{token_id}', method=self.DELETE
        )
        return json
    ...
    def get_user_ssh_key(self, key_id):
        ...
        """
        json = self.request(
            f'/user/ssh-key/{key_id}', method=self.GET
        )
        return json.get('data')
    ...
    def delete_user_ssh_key(self, key_id):
        ...
        """
        json = self.request(
            f'/user/ssh-key/{key_id}', method=self.DELETE
        )
        return json
    ...
    def ack_user_message(self, m_id):
        ...
        """
        return self.request(
            f'/user/message/{m_id}', method=self.PATCH
        )
    ...
    def download_inventory_result(self, request_id, directory=None):
        ...
        response = self.request(
            f'/inventory/{request_id}', method=self.GET
        )
    ...
    def get_new_request_meta_data(self, request_id):
        ...
        """
        json = self.request(
            f'/request/new/{request_id}/meta_data'
        )
        return json.get('data')
    ...
    def get_new_request_custom_spec(self, request_id):
        ...
        """
        json = self.request(
            f'/request/new/{request_id}/custom_spec'
        )
        return json.get('data')
    ...
    def retry_new_request(self, request_id):
        ...
        """
        json = self.request(
            f'/request/new/{request_id}', method=self.PATCH
        )
        return json.get('data')
    ...
    def retry_change_request(self, request_id):
        ...
        """
        json = self.request(
            f'/request/change/{request_id}', method=self.PATCH
        )
        return json.get('data')
    ...
    def get_snapshot_request(self, request_id, **kwargs):
        ...
        """
        json = self.request(
            f'/request/snapshot/{request_id}', params=kwargs
        )
        return json.get('data')
    ...
    def get_inventory_request(self, request_id, **kwargs):
        ...
        """
        json = self.request(
            f'/request/inventory/{request_id}', params=kwargs
        )
        return json.get('data')
    ...
    def get_export_request(self, request_id, **kwargs):
        ...
        """
        json = self.request(
            f'/request/export/{request_id}', params=kwargs
        )
        return json.get('data')
    ...
    def get_folder_request(self, request_id, **kwargs):
        ...
        """
        json = self.request(
            f'/request/folder/{request_id}', params=kwargs
        )
        return json.get('data')
    ...
    def get_image_sync_request(self, request_id, **kwargs):
        ...
        """
        json = self.request(
            f'/request/image_sync/{request_id}', params=kwargs
        )
        return json.get('data')
    ...
    def get_vms_by_network(self, moref, **kwargs):
        ...
        """
        json = self.request(
            f'/network/{moref}/vm', params=kwargs
        )
        return json.get('data')
    ...
    def get_vm_tools(self, vm_id):
        ...
        """
        json = self.request(
            f'/vm/{vm_id}/guest/tools', method=self.GET
        )
        return json.get('data')
    ...
    def export_vm(self, vm_id):
        ...
        """
        json = self.request(
            f'/vm/{vm_id}/export', method=self.POST
        )
        return json.get('data')
    ...
    def create_vms_from_clone(
        ...
        **kwargs
        ...
        new_vms_spec['disks'] = disks if disks else source_spec['disks']
    ...
    def get_vm_console(self, vm_id, auth=None, client='flash'):
        ...
        if auth:
            ...
            kwargs['auth'] = _auth
        json = self.request(
            f'/vm/{vm_id}/console', params=params, **kwargs
        )
        return json.get('data')
    ...
    def get_supported_scsi_controllers(self, only_type=True):
    ...
    def create_vm_scsi_device(self, vm_id, types, **kwargs):
        """Create Virtual Machine SCSI controller.

        For every item in the `types` list, a new SCSI
        controller will be created matching the provided type.
            ...
            Example::
                ...
                vss.create_vm_scsi_device(vm_id, types)
        ...
        """
        json_payload = dict(
            value=[self.validate_vm_scsi_controller_type(t) for t in types]
        )
        json_payload.update(kwargs)
        json = self.request(
    ...
    def create_vm_disk(self, vm_id, values_in_gb, **kwargs):
        ...
        For every value in GB in the list a virtual disk will be assigned.
            ...
            Example::
                ...
                vss.create_vm_disk(vm_id, values_in_gb=disks)
    ...
    def delete_vm_vss_ha_group(self, vm_id):
        ...
        """
        json = self.request(
            f'/vm/{vm_id}/vss/ha_group', method=self.DELETE
        )
        return json.get('data')
    ...
    def migrate_vm_vss_ha_group(self, vm_id):
        ...
        """
        json = self.request(
            f'/vm/{vm_id}/vss/ha_group', method=self.PATCH
        )
        return json.get('data')
    ...
    def get_vm_extra_cfg_options(self, vm_id):
        """Get VM extra configuration (guestinfo.* options).
    ...
    def update_vm_extra_cfg_options(self, vm_id, options):
        """Update VM extra configuration settings using the guestinfo.* prefix.
    ...
    def create_vm_extra_cfg_options(self, vm_id, options):
        """Create VM extra configuration settings using the guestinfo.* prefix.
    ...
    def delete_vm_extra_cfg_option(self, vm_id, option):
        """Delete VM extra configuration key using the guestinfo.* prefix.
