...
use crate::transport::{Listener, Write};
...
pub fn handle_request<L: Listener>(
    ...
    match req.wsgi_environ::<L>(globals, py) {
        Ok(env) => {
...
mod tests {
    ...
    use crate::startresponse::{StartResponse, WriteResponse};
    use crate::transport::SetBlocking;
...
app = simple_app"#,
        ...
        match app {
            Ok(_) => {
                ...
                req.append(raw);
                req.parse_headers();
                handle_request::<MioTcpListener>(&app, &g, &mut req, py);
