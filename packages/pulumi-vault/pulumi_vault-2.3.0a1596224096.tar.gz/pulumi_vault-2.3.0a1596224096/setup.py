...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'vault', '2.3.0-alpha.1596224096+ad1f69ed'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource vault 2.3.0-alpha.1596224096+ad1f69ed`
                """)
            else:
                raise
