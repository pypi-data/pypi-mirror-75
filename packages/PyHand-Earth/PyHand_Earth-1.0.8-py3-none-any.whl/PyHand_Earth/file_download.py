...
class FileDownload():
    ...
    def get_drive_file(self):
        ...
        self.current_directory = fileDir + self.model_name
    ...
    def get_google_earth(self):
        ...
        self.current_directory = fileDir + '/google-earth'
        ...
        print("Downloading Googl Earth .deb package file")
