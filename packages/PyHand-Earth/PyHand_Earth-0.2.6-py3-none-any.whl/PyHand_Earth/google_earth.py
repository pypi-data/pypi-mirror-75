...
class GoogleEarth():
    ...
    def toggle_buttons_off(self):
        ...
        """
        sidebar_coords = self.keyboard_commands.locate_image('PyHand_Earth/images/clicked_sidebar.png')
    ...
    def start_up_tips(self):
        ...
        """       
        start_up_tips_coords = self.keyboard_commands.locate_image('PyHand_Earth/images/close.png')
    ...
    def check_if_fullscreen(self):
        fullscreen = self.keyboard_commands.locate_image('PyHand_Earth/images/fullscreen.png')
