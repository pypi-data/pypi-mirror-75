...
class Configuration(object):
    ...
    def add_group(self, project_id: int, name: str) -> dict:
    ...
    def add(self, config_group_id: int, name: str) -> dict:
    ...
    def update_group(self, config_group_id: int, name: str) -> dict:
    ...
    def update(self, config_id: int, name: str) -> dict:
    ...
    def delete_group(self, config_group_id: int) -> dict:
