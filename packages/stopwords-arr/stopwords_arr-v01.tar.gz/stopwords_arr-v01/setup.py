...
setup(
  ...
  version = 'v01',      # Start with a small number and increase it with every change you make
  ...
  download_url = 'https://github.com/ziyadmsq/stopwords_arr/archive/v01.tar.gz',    # I explain this later on
