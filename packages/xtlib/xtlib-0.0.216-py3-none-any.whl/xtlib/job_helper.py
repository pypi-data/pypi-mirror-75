...
# helper
def download_logs_from_storage(store, items: [str], job_id: str, node_index: int, store_path: str,
        dest_dir: str):

    job_path = "node-{}/{}".format(node_index, store_path)
    new_items = store.download_files_from_job(job_id, job_path, dest_dir)
