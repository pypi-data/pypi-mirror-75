...
class Store():
    ...
    def get_workspace_names(self):
        ...
        # use mongo for more reliable workspace names 
        names = self.mongo.get_workspace_names()
        return names
    ...
    def log_job_event(self, job_id, event_name, data_dict=None, event_time=None):
        if not event_time:
            event_time = utils.get_time()
