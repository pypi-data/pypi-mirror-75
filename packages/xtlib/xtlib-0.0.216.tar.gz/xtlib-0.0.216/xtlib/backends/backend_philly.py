...
class Philly(BackendBase):
    ...
    def wrap_cmd_line_for_philly_job(self, user_cmd, store_before_dir, store_output_dir, store_after_dir, 
        ...
        self.append(cmds, 'export XT_NODE_DIR=/mnt/node/' + node_store_path)
    ...
    def build_azure_volumes(self, input_container, data_container, output_container, data_action, data_writable,
        ...
        volumes = {
            ...
            "node": {"type": "blobfuseVolume", "storageAccount": store_name, "containerName": info_container, "path": "/mnt/node", "options": options},
            }
   ...
   # API call
    def add_service_log_copy_cmds(self, cmds, dest_dir):
        ...
        cmd = "cp -r -v $PHILLY_JOB_DIRECTORY/stdout/* {}".format(dest_dir)
