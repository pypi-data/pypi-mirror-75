...
class PoolBackend(BackendBase):
        ...
        for i, box_runs in enumerate(job_runs):
            ...
            if not fn_wrapped:
                ...
                fn_wrapped = super().wrap_user_command(cmd_parts, snapshot_dir, store_data_dir, data_action, 
                    ...
                    install_blobfuse=install_blobfuse, change_dir=change_dir, node_index=node_index,
                    run_name=run_name)   
    ...
    def run_job_on_box(self, job_id, run_data_list, box_index, box_info, app_info, pool_info,  
        ...
        fn_entry = psm_client.enqueue(team, job_id, run_name, box_index, fn_src_zip)
   ...
   # API call
    def add_service_log_copy_cmds(self, cmds, dest_dir):
        ...
        if self.gen_for_windows:
            ...
            self.append(cmds, "mkdir -p {} && cp $3 {}".format(dest_dir, dest_dir))
