...
class RunInfo():
    ...
    def wrapup_parent_prep_run(self):
        ...
        self.store.log_run_event(context.ws, self.run_name, "parent_script_completed", {"status": self.status})  # , is_aml=self.is_aml)
    ...
    def run_wrapup(self):
        ...
        if not self.killed_for_restart:
            ...
            #log_info("run_info: calling WRAPUP_RUN")
            ...
            if self.mri and self.mri_entry:
