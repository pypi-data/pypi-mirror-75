...
class PushNotificationConfig(google___protobuf___message___Message):
    DESCRIPTOR: google___protobuf___descriptor___Descriptor = ...
    organization_id: typing___Text = ...
    ...
    def HasField(self, field_name: typing_extensions___Literal[u"created_at",b"created_at",u"updated_at",b"updated_at"]) -> builtin___bool: ...
    def ClearField(self, field_name: typing_extensions___Literal[u"created_at",b"created_at",u"enabled",b"enabled",u"organization_id",b"organization_id",u"updated_at",b"updated_at",u"uri",b"uri"]) -> None: ...
type___PushNotificationConfig = PushNotificationConfig
...
class Organization(google___protobuf___message___Message):
    ...
    def HasField(self, field_name: typing_extensions___Literal[u"created_at",b"created_at",u"updated_at",b"updated_at"]) -> builtin___bool: ...
    def ClearField(self, field_name: typing_extensions___Literal[u"access_keys",b"access_keys",u"created_at",b"created_at",u"name",b"name",u"organization_id",b"organization_id",u"updated_at",b"updated_at"]) -> None: ...
...
class SetPushNotificationConfigRequest(google___protobuf___message___Message):
    ...
    def __init__(self,
        *,
        pushNotificationConfig : typing___Optional[type___PushNotificationConfig] = None,
        request_context : typing___Optional[common_pb2___RequestContext] = None,
        ) -> None: ...
    def HasField(self, field_name: typing_extensions___Literal[u"pushNotificationConfig",b"pushNotificationConfig",u"request_context",b"request_context"]) -> builtin___bool: ...
    def ClearField(self, field_name: typing_extensions___Literal[u"pushNotificationConfig",b"pushNotificationConfig",u"request_context",b"request_context"]) -> None: ...
type___SetPushNotificationConfigRequest = SetPushNotificationConfigRequest
...
class AcceptOrganizationUserInviteResponse(google___protobuf___message___Message):
    ...
    def ClearField(self, field_name: typing_extensions___Literal[u"organization_user",b"organization_user"]) -> None: ...
