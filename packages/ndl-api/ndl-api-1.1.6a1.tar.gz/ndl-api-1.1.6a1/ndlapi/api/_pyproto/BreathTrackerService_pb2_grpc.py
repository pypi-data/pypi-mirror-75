...
class BreathTrackerStub(object):
  ...
  def __init__(self, channel):
    ...
    self.process_video_stream = channel.stream_stream(
        '/cul.BreathTracker/process_video_stream',
...
class BreathTrackerServicer(object):
  # missing associated documentation comment in .proto file
  pass
...
def add_BreathTrackerServicer_to_server(servicer, server):
  rpc_method_handlers = {
  ...
  generic_handler = grpc.method_handlers_generic_handler(
      'cul.BreathTracker', rpc_method_handlers)
