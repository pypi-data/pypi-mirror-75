...
class SingleFrameEmotionStub(object):
  ...
  def __init__(self, channel):
    ...
    self.process_video_stream = channel.stream_stream(
        '/cul.SingleFrameEmotion/process_video_stream',
    ...
    self.process_images_stream = channel.stream_stream(
        '/cul.SingleFrameEmotion/process_images_stream',
...
class SingleFrameEmotionServicer(object):
  # missing associated documentation comment in .proto file
  pass
...
def add_SingleFrameEmotionServicer_to_server(servicer, server):
  rpc_method_handlers = {
  ...
  generic_handler = grpc.method_handlers_generic_handler(
      'cul.SingleFrameEmotion', rpc_method_handlers)
