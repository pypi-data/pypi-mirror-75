...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'newrelic', '3.2.0-alpha.1596567157+cfce3cbc'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource newrelic 3.2.0-alpha.1596567157+cfce3cbc`
                """)
            else:
                raise
