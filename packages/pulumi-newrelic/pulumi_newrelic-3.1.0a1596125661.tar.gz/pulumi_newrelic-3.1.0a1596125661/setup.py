...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'newrelic', '3.1.0-alpha.1596125661+79c4efc0'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource newrelic 3.1.0-alpha.1596125661+79c4efc0`
                """)
            else:
                raise
