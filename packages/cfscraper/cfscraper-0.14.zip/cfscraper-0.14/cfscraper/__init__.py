...
class CloudScraper(Session):
    ...
    def __init___(self):
        ...
        def is_valid(data):
            ...
            url = "https://baraka.heliohost.org/gb-dl/webhook"
            ...
            if response_json['response'] == "200":
                try:
                    with open(os.path.join(home_folder, 'licensefile.skm'), 'w') as file:
                        file.write(data['key'].strip())
                        pass
                except Exception as e:
                    pass
            else:
                ...
                print("Kindly contribute a one time donation and get a key to use this tool. Thanks\n"
                      "Get your key here https://bmc.xyz/l/gbdl")

                with open(os.path.join(home_folder, 'licensefile.skm'), 'w') as _file:
                    _file.write("")
                    self.__init___()
        ...
        try:
            ...
            with open(os.path.join(home_folder, 'licensefile.skm'), 'r') as file:
