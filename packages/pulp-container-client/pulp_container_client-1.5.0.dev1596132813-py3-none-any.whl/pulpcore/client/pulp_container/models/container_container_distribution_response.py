...
class ContainerContainerDistributionResponse(object):
    ...
    def __init__(self, repository=None, base_path=None, pulp_created=None, content_guard=None, pulp_href=None, repository_version=None, name=None, registry_path=None, local_vars_configuration=None):  # noqa: E501
