...
class RepositoriesContainerVersionsApi(object):
    ...
    def list(self, container_repository_version_href, **kwargs):  # noqa: E501
        """list  # noqa: E501

        ContainerRepositoryVersion represents a single container repository version.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.list(container_repository_version_href, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.list_with_http_info(container_repository_version_href, **kwargs)  # noqa: E501

    def list_with_http_info(self, container_repository_version_href, **kwargs):  # noqa: E501
        """list  # noqa: E501

        ContainerRepositoryVersion represents a single container repository version.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.list_with_http_info(container_repository_version_href, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('container_repository_version_href' not in local_var_params or  # noqa: E501
                                                        local_var_params['container_repository_version_href'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `container_repository_version_href` when calling `list`")  # noqa: E501
    ...
    def repair(self, container_repository_version_href, repository_version, **kwargs):  # noqa: E501
        """repair  # noqa: E501

        Trigger an asynchronous task to repair a repositroy version.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.repair(container_repository_version_href, repository_version, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.repair_with_http_info(container_repository_version_href, repository_version, **kwargs)  # noqa: E501

    def repair_with_http_info(self, container_repository_version_href, repository_version, **kwargs):  # noqa: E501
        """repair  # noqa: E501

        Trigger an asynchronous task to repair a repositroy version.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.repair_with_http_info(container_repository_version_href, repository_version, async_req=True)
        >>> result = thread.get()
