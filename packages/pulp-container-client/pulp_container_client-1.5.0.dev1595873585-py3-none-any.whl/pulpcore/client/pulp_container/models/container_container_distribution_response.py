...
class ContainerContainerDistributionResponse(object):
    ...
    def __init__(self, base_path=None, pulp_created=None, repository=None, repository_version=None, name=None, pulp_href=None, content_guard=None, registry_path=None, local_vars_configuration=None):  # noqa: E501
