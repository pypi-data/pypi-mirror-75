...
class DistributionsContainerApi(object):
    ...
    def delete(self, container_distribution_href, **kwargs):  # noqa: E501
        ...
        :param async_req bool: execute request asynchronously
        :param str container_distribution_href: (required)
    ...
    def partial_update(self, container_distribution_href, patchedcontainer_container_distribution, **kwargs):  # noqa: E501
        """partial_update  # noqa: E501

        Trigger an asynchronous partial update task  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.partial_update(container_distribution_href, patchedcontainer_container_distribution, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.partial_update_with_http_info(container_distribution_href, patchedcontainer_container_distribution, **kwargs)  # noqa: E501

    def partial_update_with_http_info(self, container_distribution_href, patchedcontainer_container_distribution, **kwargs):  # noqa: E501
        """partial_update  # noqa: E501

        Trigger an asynchronous partial update task  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.partial_update_with_http_info(container_distribution_href, patchedcontainer_container_distribution, async_req=True)
        >>> result = thread.get()
    ...
    def update(self, container_distribution_href, container_container_distribution, **kwargs):  # noqa: E501
        """update  # noqa: E501

        Trigger an asynchronous update task  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update(container_distribution_href, container_container_distribution, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.update_with_http_info(container_distribution_href, container_container_distribution, **kwargs)  # noqa: E501

    def update_with_http_info(self, container_distribution_href, container_container_distribution, **kwargs):  # noqa: E501
        """update  # noqa: E501

        Trigger an asynchronous update task  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_with_http_info(container_distribution_href, container_container_distribution, async_req=True)
        >>> result = thread.get()
