...
class ContainerContainerDistributionResponse(object):
    ...
    def __init__(self, name=None, repository_version=None, base_path=None, content_guard=None, pulp_href=None, repository=None, pulp_created=None, registry_path=None, local_vars_configuration=None):  # noqa: E501
