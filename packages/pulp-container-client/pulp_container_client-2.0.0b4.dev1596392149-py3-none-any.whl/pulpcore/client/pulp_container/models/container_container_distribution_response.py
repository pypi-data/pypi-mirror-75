...
class ContainerContainerDistributionResponse(object):
    ...
    def __init__(self, content_guard=None, name=None, base_path=None, pulp_created=None, repository=None, repository_version=None, pulp_href=None, registry_path=None, local_vars_configuration=None):  # noqa: E501
