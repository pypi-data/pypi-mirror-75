...
- API version: v3
- Package version: 2.0.0b4.dev01596219813
...
*DistributionsContainerApi* | [**partial_update**](docs/DistributionsContainerApi.md#partial_update) | **PATCH** {container_distribution_href} | Update a container distribution
...
*RemotesContainerApi* | [**partial_update**](docs/RemotesContainerApi.md#partial_update) | **PATCH** {container_remote_href} | Update a container remote
...
*RepositoriesContainerApi* | [**partial_update**](docs/RepositoriesContainerApi.md#partial_update) | **PATCH** {container_repository_href} | Update a container repository
...
*RepositoriesContainerPushApi* | [**partial_update**](docs/RepositoriesContainerPushApi.md#partial_update) | **PATCH** {container_push_repository_href} | Update a container push repository
...
*RepositoriesContainerVersionsApi* | [**list**](docs/RepositoriesContainerVersionsApi.md#list) | **GET** {container-push_repository_version_href}versions/ | List repository versions
*RepositoriesContainerVersionsApi* | [**list_0**](docs/RepositoriesContainerVersionsApi.md#list_0) | **GET** {container_repository_version_href}versions/ | List repository versions
