...
class TalosConsumer(object):
    ...
    def __init__(self, consumerGroup=None, consumerConfig=None,
        ...
        if consumerClient:
            ...
            self.renewWorkerClient = self.talosClientFactory.new_consumer_client()
            self.queryWorkerClient = self.talosClientFactory.new_consumer_client()
    ...
    def renew_task(self):
        ...
        while maxRetry > 0:
            try:
                renewResponse = self.renewWorkerClient.renew(renewRequest)
    ...
    def get_worker_info(self):
        ...
        queryWorkerResponse = self.queryWorkerClient.query_worker(queryWorkerRequest)
