...
class KinesisFirehoseToAnalyticsAndS3(
    ...
    def __init__(
        ...
        *,
        ...
        kinesis_analytics_props: typing.Optional[
            aws_cdk.aws_kinesisanalytics.CfnApplicationProps
        ] = None,
        kinesis_firehose_props: typing.Optional[
    ...
    def kinesis_firehose_log_group(self) -> aws_cdk.aws_logs.LogGroup:
        return jsii.get(self, "kinesisFirehoseLogGroup")
...
class KinesisFirehoseToAnalyticsAndS3Props:
    def __init__(
        ...
        *,
        ...
        if isinstance(kinesis_analytics_props, dict):
            kinesis_analytics_props = aws_cdk.aws_kinesisanalytics.CfnApplicationProps(
                **kinesis_analytics_props
            )
        if isinstance(kinesis_firehose_props, dict):
            kinesis_firehose_props = aws_cdk.aws_kinesisfirehose.CfnDeliveryStreamProps(
    ...
    @builtins.property
    def kinesis_firehose_props(
        self,
    ) -> typing.Optional[aws_cdk.aws_kinesisfirehose.CfnDeliveryStreamProps]:
