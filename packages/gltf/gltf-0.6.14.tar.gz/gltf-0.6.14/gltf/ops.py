...
def analyze(model):
    ...
    return {
        'features': {
            ...
            'rows': [
                (label, count, recommended, count < recommended)
                for label, count, recommended in
                [
                    ("Mesh Vertices", vertex_count, 30_000),
                    ("Instanced Vertices", instanced_vertex_count, 30_000),
                    ("Triangle Count", triangle_count, 100_000),
                    ("Rendered Triangle Count", rendered_triangle_count, 100_000),
                    ("Meshes", mesh_count, 10),
                    ("Materials", mat_count, 10),
                    ("Animation Targets", animation_target_count, 254),
                    ("Animation Samplers", sampler_count, 9999),
                ]
            ]
        },
        'sizes': {
