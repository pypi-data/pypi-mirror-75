...
setup(
  name = 'weatherfetch',         # How you named your package folder (MyLib)
  packages = ['weatherfetch'],   # Chose the same as "name"
  ...
  author = 'Sai Teja Merla',                   # Type in your name
  author_email = 'saitejamerla.mst@gmail.com',      # Type in your E-Mail
