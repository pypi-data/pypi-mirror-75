...
class SwaggerParser(object):
    """Parse a swagger_diff YAML file.
    Get definitions examples, routes default data, and routes validator.
    This only works with swagger_diff 2.0.
    Attributes:
    ...
    def __init__(self, swagger_path=None, swagger_dict=None, swagger_yaml=None, use_example=True):
        ...
        Args:
            swagger_path: path of the swagger_diff file.
            swagger_dict: swagger_diff dict.
        ...
        Raises:
            - ValueError: if no swagger_path or swagger_dict is specified.
                          Or if the given swagger_diff is not valid.
        """
        try:
    ...
    def build_definitions_example(self):
        """Parse all definitions in the swagger_diff specification."""
    ...
    def check_type(value, type_def):
        ...
        Args:
            ...
            type_def: string representing the type in swagger_diff.
        Returns:
    ...
    def _definition_from_example(example):
        """Generates a swagger_diff definition json from a given example
           Works only for simple types in the dict
        Args:
            example: The example for which we want a definition
                     Type is DICT
        Returns:
            A dict that is the swagger_diff definition json
        """
    ...
    def get_paths_data(self):
        """Get data for each paths in the swagger_diff specification.
        ...
        for path, path_spec in self.specification['paths'].items():
            ...
            for http_method in path_spec.keys():
                ...
                # Get summary
                if 'summary' in action.keys():
                    self.paths[path][http_method]['summary'] = action['summary']
