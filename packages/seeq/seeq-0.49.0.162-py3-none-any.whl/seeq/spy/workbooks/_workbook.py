...
class Workbook(ItemWithOwnerAndAcl):
    ...
    def save(self, workbook_folder=None, *, overwrite=False, render_topic_documents=False):
        ...
        for worksheet in self.worksheets:
            worksheet.save(workbook_folder, render_topic_documents=render_topic_documents)
            definition_dict['Worksheets'].append(worksheet.id)

        if render_topic_documents:
