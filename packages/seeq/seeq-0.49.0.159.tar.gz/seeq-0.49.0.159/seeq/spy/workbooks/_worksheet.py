...
class Worksheet(Item):
    ...
    def pull(item_id, *, workbook=None, extra_workstep_tuples=None):
        ...
        worksheet.pull_worksheet(item_id, extra_workstep_tuples=extra_workstep_tuples)
        return worksheet

    def pull_worksheet(self, worksheet_id, extra_workstep_tuples=None):
...
class AnalysisWorksheet(Worksheet):
    ...
    def _get_display_range(self):
        ...
        :return:
        """
        return self._current_workstep().display_range
    ...
    def _get_investigate_range(self):
        ...
        """
        return self._current_workstep().investigate_range
    ...
    def _get_display_items(self):
        ...
        """
        return self._current_workstep().display_items
    ...
    def _get_worksheet_view(self):
        return self._current_workstep().view
    ...
    def _get_scorecard_date_display(self):
        return self._current_workstep().scorecard_date_display
    ...
    def _get_scorecard_date_format(self):
        return self._current_workstep().scorecard_date_format
    ...
    def _get_scatter_plot_series(self):
        return self._current_workstep().scatter_plot_series
        ...
        dict
            A dictionary of a 'Background' and a 'Cron Schedule' for document's schedule
                ...
                Cron Schedule         The document's update schedule as a cron
                                      schedule. This should be a cron expression such
                                      as '0 */5 * * * ?'. See
