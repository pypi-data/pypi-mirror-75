...
def pull(workbooks_df: Union[pd.DataFrame, str], *, include_referenced_workbooks: bool = True,
    ...
    include_rendered_content : bool, default False
        If True, any Organizer Topics pulled will include rendered content images,
        which will cause spy.workbooks.save() to include a folder for each
        Topic Document with its HTML and images such that it can be loaded and
        viewed in a browser.
