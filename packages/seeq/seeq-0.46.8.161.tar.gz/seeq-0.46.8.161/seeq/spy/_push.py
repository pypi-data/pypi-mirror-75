...
def _push_workbooks(push_result_df, workbook_path, workbooks, datasource, status: _common.Status):
    ...
    return spy.workbooks.push(workbooks, path=workbook_path, refresh=False, include_inventory=False,
                              datasource=datasource, status=status.create_inner('Push Workbooks'))
