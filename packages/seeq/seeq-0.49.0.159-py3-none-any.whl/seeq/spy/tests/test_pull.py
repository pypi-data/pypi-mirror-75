...
def test_pull_input_params_property():
    ...
    with tempfile.TemporaryDirectory() as dir_path:
        df.to_pickle(Path(dir_path, 'pull.pkl'))
        df = pd.read_pickle(Path(dir_path, 'pull.pkl'))
    ...
    with tempfile.TemporaryDirectory() as dir_path:
        pull_results.to_pickle(Path(dir_path, 'pull.pkl'))
        pull_results = pd.read_pickle(Path(dir_path, 'pull.pkl'))
