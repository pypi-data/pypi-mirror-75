    ...
    if script_params:
        for key in script_params:
            if isinstance(script_params[key], DataReference) \
                ...
                data_reference_inputs.append(script_params[key])
            elif isinstance(script_params[key], DatasetConsumptionConfig):
                dataset_inputs.append(script_params[key])
...
def _get_arguments(script_params):
    ...
    if script_params_copy:
        for key in script_params_copy:
            if isinstance(script_params_copy[key], DataReference):
            ...
            elif isinstance(script_params_copy[key], DatasetConsumptionConfig):
                ...
                if script_params_copy[key].mode.lower() == 'download' or \
                        script_params_copy[key].mode.lower() == 'mount':
                    ...
                    script_params_copy[key] = 'DatasetConsumptionConfig:' + script_params_copy[key].name
