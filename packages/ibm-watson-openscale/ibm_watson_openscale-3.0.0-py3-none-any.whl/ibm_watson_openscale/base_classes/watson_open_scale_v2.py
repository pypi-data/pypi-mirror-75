    ...
    def add(self,
        ...
        **kwargs
        ...
        if scoring_ids is None:
            raise ValueError('scoring_ids must be provided')
        headers = {}
        sdk_headers = get_sdk_headers(service_name=self.watson_open_scale.DEFAULT_SERVICE_NAME,
                                      service_version='V2',
...
class AssetDeployment():
    ...
    :attr str deployment_type: (optional)
    :attr str created_at: (optional)
...
class DataMartGetMonitorInstanceMetricsGroupsItemMetricsItem():
    ...
    def __init__(self,
                 ...
                 *,
                 ...
                 min: 'DataMartGetMonitorInstanceMetricsGroupsItemMetricsItemMin' = None) -> None:
        """
...
class GetExplanationTasksResponse():
    ...
    :attr List[str] explanation_values: The list of explanation values.
    """
    ...
    def __init__(self,
                 ...
                 explanation_values: List[str]) -> None:
        """
        ...
        :param List[str] explanation_values: The list of explanation values.
        """
    ...
    def from_dict(cls, _dict: Dict) -> 'GetExplanationTasksResponse':
        ...
        if 'explanation_values' in _dict:
            ...
            raise ValueError('Required property \'explanation_values\' not present in GetExplanationTasksResponse JSON')
        return cls(**args)
...
class IntegratedSystemCollection():
    ...
    :attr List[IntegratedSystem] integrated_systems:
    """

    def __init__(self,
                 integrated_systems: List['IntegratedSystem']) -> None:
        """
        Initialize a IntegratedSystemCollection object.

        :param List[IntegratedSystem] integrated_systems:
        """
    ...
    def from_dict(cls, _dict: Dict) -> 'IntegratedSystemCollection':
        ...
        if 'integrated_systems' in _dict:
            args['integrated_systems'] = [IntegratedSystem.from_dict(x) for x in _dict.get('integrated_systems')]
        else:
...
class PatchDocument():
    ...
    :attr dict value: (optional) The value to be used within the operations.
    ...
    def __init__(self,
        ...
        :param dict value: (optional) The value to be used within the operations.
...
class WMLCredentialsCP4D(MLCredentials):
    ...
    # The set of defined properties for the class
    _properties = frozenset(['url', 'instance_id', 'username', 'password'])
...
class WMLCredentialsCloud(MLCredentials):
    ...
    # The set of defined properties for the class
    _properties = frozenset(['apikey', 'url', 'instance_id'])
    ...
    def from_dict(cls, _dict: Dict) -> 'WMLCredentialsCloud':
        ...
        if 'apikey' in _dict:
            ...
            raise ValueError('Required property \'apikey\' not present in WMLCredentialsCloud JSON')
        if 'url' in _dict:
            args['url'] = _dict.get('url')
        else:
