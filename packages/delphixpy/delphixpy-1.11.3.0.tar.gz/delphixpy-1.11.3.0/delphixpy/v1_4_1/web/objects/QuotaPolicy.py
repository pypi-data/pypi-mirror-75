    ...
    *(extends* :py:class:`v1_4_1.web.vo.Policy` *)* This policy limits the
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._crit_threshold[0] is not None and obj._crit_threshold[0] is not obj.__undef__:
            assert isinstance(obj._crit_threshold[0], int), ("Expected one of [u'integer'], but got %s of type %s" % (obj._crit_threshold[0], type(obj._crit_threshold[0])))
        ...
        if obj._warn_alert_time[0] is not None and obj._warn_alert_time[0] is not obj.__undef__:
            assert isinstance(obj._warn_alert_time[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._warn_alert_time[0], type(obj._warn_alert_time[0])))
        ...
        if obj._warn_threshold[0] is not None and obj._warn_threshold[0] is not obj.__undef__:
            assert isinstance(obj._warn_threshold[0], int), ("Expected one of [u'integer'], but got %s of type %s" % (obj._warn_threshold[0], type(obj._warn_threshold[0])))
        ...
        if obj._crit_alert_time[0] is not None and obj._crit_alert_time[0] is not obj.__undef__:
            assert isinstance(obj._crit_alert_time[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._crit_alert_time[0], type(obj._crit_alert_time[0])))
    ...
    def to_dict(self, dirty=False, belongs_to_parent=False):
        ...
        def dictify(obj, prop_is_list_or_vo=False):
            if isinstance(obj, list):
                ...
                return obj
        if "crit_threshold" == "type" or (self.crit_threshold is not self.__undef__ and (not (dirty and not self._crit_threshold[1]) or isinstance(self.crit_threshold, list) or belongs_to_parent)):
        ...
        if "warn_threshold" == "type" or (self.warn_threshold is not self.__undef__ and (not (dirty and not self._warn_threshold[1]) or isinstance(self.warn_threshold, list) or belongs_to_parent)):
    ...
    def is_dirty(self):
        return any([self._crit_threshold[1], self._warn_alert_time[1], self._warn_threshold[1], self._crit_alert_time[1], self._size[1]])
