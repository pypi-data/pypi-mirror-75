    ...
    *(extends* :py:class:`v1_4_1.web.vo.JSUsageData` *)* Information about the
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._weekly_duration[0] is not None and obj._weekly_duration[0] is not obj.__undef__:
            assert isinstance(obj._weekly_duration[0], int), ("Expected one of [u'integer'], but got %s of type %s" % (obj._weekly_duration[0], type(obj._weekly_duration[0])))
        ...
        if obj._weekly_count[0] is not None and obj._weekly_count[0] is not obj.__undef__:
            assert isinstance(obj._weekly_count[0], int), ("Expected one of [u'integer'], but got %s of type %s" % (obj._weekly_count[0], type(obj._weekly_count[0])))
