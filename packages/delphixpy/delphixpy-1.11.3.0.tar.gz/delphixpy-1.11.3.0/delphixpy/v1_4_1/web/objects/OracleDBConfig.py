    ...
    *(extends* :py:class:`v1_4_1.web.vo.OracleBaseDBConfig` *)* The source
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._unique_name[0] is not None and obj._unique_name[0] is not obj.__undef__:
            assert isinstance(obj._unique_name[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._unique_name[0], type(obj._unique_name[0])))
        ...
        if obj._non_sys_user[0] is not None and obj._non_sys_user[0] is not obj.__undef__:
            assert isinstance(obj._non_sys_user[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._non_sys_user[0], type(obj._non_sys_user[0])))
        ...
        if obj._cdb_type[0] is not None and obj._cdb_type[0] is not obj.__undef__:
            assert isinstance(obj._cdb_type[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._cdb_type[0], type(obj._cdb_type[0])))
            assert obj._cdb_type[0] in [u'UNKNOWN', u'CDB', u'NON_CDB'], "Expected enum [u'UNKNOWN', u'CDB', u'NON_CDB'] but got %s" % obj._cdb_type[0]
    ...
    def to_dict(self, dirty=False, belongs_to_parent=False):
        ...
        if "cdb_type" == "type" or (self.cdb_type is not self.__undef__ and (not (dirty and not self._cdb_type[1]) or isinstance(self.cdb_type, list) or belongs_to_parent)):
