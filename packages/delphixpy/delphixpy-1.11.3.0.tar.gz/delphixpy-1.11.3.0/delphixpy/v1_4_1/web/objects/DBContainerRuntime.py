    ...
    *(extends* :py:class:`v1_4_1.web.vo.TypedObject` *)* Runtime properties of
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._log_sync_active[0] is not None and obj._log_sync_active[0] is not obj.__undef__:
            assert isinstance(obj._log_sync_active[0], bool), ("Expected one of [u'boolean'], but got %s of type %s" % (obj._log_sync_active[0], type(obj._log_sync_active[0])))
    ...
    def pre_provisioning_status(self):
        ...
        :rtype: :py:class:`v1_4_1.web.vo.PreProvisioningRuntime`
        """
