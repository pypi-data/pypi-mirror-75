    ...
    *(extends* :py:class:`v1_8_0.web.vo.TypedObject` *)* The parameters to use
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._ignore[0] is not None and obj._ignore[0] is not obj.__undef__:
            assert isinstance(obj._ignore[0], bool), ("Expected one of [u'boolean'], but got %s of type %s" % (obj._ignore[0], type(obj._ignore[0])))
        ...
        if obj._comments[0] is not None and obj._comments[0] is not obj.__undef__:
            assert isinstance(obj._comments[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._comments[0], type(obj._comments[0])))
