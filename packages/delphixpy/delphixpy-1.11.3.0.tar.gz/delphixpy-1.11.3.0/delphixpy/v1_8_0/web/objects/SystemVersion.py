    ...
    *(extends* :py:class:`v1_8_0.web.vo.NamedUserObject` *)* Describes a
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._status[0] is not None and obj._status[0] is not obj.__undef__:
            ...
            assert obj._status[0] in [u'PREVIOUS', u'CURRENTLY_RUNNING', u'DEFERRED', u'UPLOADED', u'UNPACKING', u'DELETING', u'VERIFYING', u'VERIFIED', u'APPLYING', u'UNKNOWN'], "Expected enum [u'PREVIOUS', u'CURRENTLY_RUNNING', u'DEFERRED', u'UPLOADED', u'UNPACKING', u'DELETING', u'VERIFYING', u'VERIFIED', u'APPLYING', u'UNKNOWN'] but got %s" % obj._status[0]
        ...
        if obj._verify_date[0] is not None and obj._verify_date[0] is not obj.__undef__:
            assert isinstance(obj._verify_date[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._verify_date[0], type(obj._verify_date[0])))
        ...
        if obj._build_date[0] is not None and obj._build_date[0] is not obj.__undef__:
            assert isinstance(obj._build_date[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._build_date[0], type(obj._build_date[0])))
        ...
        if obj._install_date[0] is not None and obj._install_date[0] is not obj.__undef__:
            assert isinstance(obj._install_date[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._install_date[0], type(obj._install_date[0])))
        ...
        if obj._os_running[0] is not None and obj._os_running[0] is not obj.__undef__:
            assert isinstance(obj._os_running[0], bool), ("Expected one of [u'boolean'], but got %s of type %s" % (obj._os_running[0], type(obj._os_running[0])))
        ...
        if obj._min_os_version[0] is not None and obj._min_os_version[0] is not obj.__undef__:
            assert isinstance(obj._min_os_version[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._min_os_version[0], type(obj._min_os_version[0])))
        ...
        if obj._os_version[0] is not None and obj._os_version[0] is not obj.__undef__:
            assert isinstance(obj._os_version[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._os_version[0], type(obj._os_version[0])))
        ...
        if obj._min_version[0] is not None and obj._min_version[0] is not obj.__undef__:
            assert isinstance(obj._min_version[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._min_version[0], type(obj._min_version[0])))
