    ...
    *(extends* :py:class:`v1_8_0.web.vo.TypedObject` *)* An opaque type
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._toolkit_name[0] is not None and obj._toolkit_name[0] is not obj.__undef__:
            assert isinstance(obj._toolkit_name[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._toolkit_name[0], type(obj._toolkit_name[0])))
        ...
        if obj._message_id[0] is not None and obj._message_id[0] is not obj.__undef__:
            assert isinstance(obj._message_id[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._message_id[0], type(obj._message_id[0])))
