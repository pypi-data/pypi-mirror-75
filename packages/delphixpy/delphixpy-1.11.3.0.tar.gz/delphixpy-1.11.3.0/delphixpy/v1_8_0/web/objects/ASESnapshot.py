...
class ASESnapshot(TimeflowSnapshot):
    ...
    *(extends* :py:class:`v1_8_0.web.vo.TimeflowSnapshot` *)* Provisionable
    ...
    def to_dict(self, dirty=False, belongs_to_parent=False):
        dct = super(ASESnapshot, self).to_dict(dirty, belongs_to_parent)
    ...
    def is_dirty(self):
        return any([self._latest_change_point[1], self._runtime[1], self._first_change_point[1], self._internal_version[1]])
