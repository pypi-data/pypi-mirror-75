    ...
    *(extends* :py:class:`v1_8_0.web.vo.HostCreateParameters` *)* The
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._connector_keystore[0] is not None and obj._connector_keystore[0] is not obj.__undef__:
            assert isinstance(obj._connector_keystore[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._connector_keystore[0], type(obj._connector_keystore[0])))
        ...
        if obj._connector_certificate_password[0] is not None and obj._connector_certificate_password[0] is not obj.__undef__:
            assert isinstance(obj._connector_certificate_password[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._connector_certificate_password[0], type(obj._connector_certificate_password[0])))
        ...
        if obj._connector_keystore_password[0] is not None and obj._connector_keystore_password[0] is not obj.__undef__:
            assert isinstance(obj._connector_keystore_password[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._connector_keystore_password[0], type(obj._connector_keystore_password[0])))
