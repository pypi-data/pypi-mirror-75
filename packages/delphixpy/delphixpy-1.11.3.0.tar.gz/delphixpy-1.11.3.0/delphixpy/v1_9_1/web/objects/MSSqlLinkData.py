    ...
    *(extends* :py:class:`v1_9_1.web.vo.LinkData` *)* MSSQL specific parameters
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._delphix_managed_status[0] is not None and obj._delphix_managed_status[0] is not obj.__undef__:
            assert isinstance(obj._delphix_managed_status[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._delphix_managed_status[0], type(obj._delphix_managed_status[0])))
    ...
    def is_dirty(self):
        return any([self._operations[1], self._ppt_host_user[1], self._external_file_path[1], self._validated_sync_mode[1], self._db_user[1], self._ppt_repository[1], self._backup_location_credentials[1], self._shared_backup_location[1], self._staging_post_script[1], self._delphix_managed_status[1], self._backup_location_user[1], self._source_host_user[1], self._staging_pre_script[1], self._config[1], self._encryption_key[1], self._db_credentials[1], self._sync_parameters[1]])
