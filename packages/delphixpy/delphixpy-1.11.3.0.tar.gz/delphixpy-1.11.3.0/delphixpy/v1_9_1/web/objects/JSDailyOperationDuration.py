    ...
    *(extends* :py:class:`v1_9_1.web.vo.JSUsageData` *)* Information about the
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._daily_average_duration[0] is not None and obj._daily_average_duration[0] is not obj.__undef__:
            assert isinstance(obj._daily_average_duration[0], int), ("Expected one of [u'integer'], but got %s of type %s" % (obj._daily_average_duration[0], type(obj._daily_average_duration[0])))
        ...
        if obj._daily_max_duration[0] is not None and obj._daily_max_duration[0] is not obj.__undef__:
            assert isinstance(obj._daily_max_duration[0], int), ("Expected one of [u'integer'], but got %s of type %s" % (obj._daily_max_duration[0], type(obj._daily_max_duration[0])))
        ...
        if obj._daily_count[0] is not None and obj._daily_count[0] is not obj.__undef__:
            assert isinstance(obj._daily_count[0], int), ("Expected one of [u'integer'], but got %s of type %s" % (obj._daily_count[0], type(obj._daily_count[0])))
        ...
        if obj._daily_min_duration[0] is not None and obj._daily_min_duration[0] is not obj.__undef__:
            assert isinstance(obj._daily_min_duration[0], int), ("Expected one of [u'integer'], but got %s of type %s" % (obj._daily_min_duration[0], type(obj._daily_min_duration[0])))
    ...
    def is_dirty(self):
        return any([self._daily_average_duration[1], self._operation[1], self._daily_max_duration[1], self._daily_count[1], self._daily_min_duration[1]])
    ...
    def __eq__(self, other):
        ...
        return super(JSDailyOperationDuration, self).__eq__(other) and \
               ...
               self.daily_min_duration == other.daily_min_duration
