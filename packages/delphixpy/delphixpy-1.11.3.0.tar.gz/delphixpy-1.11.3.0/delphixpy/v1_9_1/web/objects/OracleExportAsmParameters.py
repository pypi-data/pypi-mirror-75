    ...
    *(extends* :py:class:`v1_9_1.web.vo.ExportParameters` *)* The parameters to
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._parallel[0] is not None and obj._parallel[0] is not obj.__undef__:
            assert isinstance(obj._parallel[0], int), ("Expected one of [u'integer'], but got %s of type %s" % (obj._parallel[0], type(obj._parallel[0])))
        ...
        if obj._redo_diskgroup[0] is not None and obj._redo_diskgroup[0] is not obj.__undef__:
            assert isinstance(obj._redo_diskgroup[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._redo_diskgroup[0], type(obj._redo_diskgroup[0])))
        ...
        if obj._data_diskgroup[0] is not None and obj._data_diskgroup[0] is not obj.__undef__:
            assert isinstance(obj._data_diskgroup[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._data_diskgroup[0], type(obj._data_diskgroup[0])))
    ...
    def is_dirty(self):
        return any([self._source[1], self._source_config[1], self._parallel[1], self._redo_diskgroup[1], self._data_diskgroup[1]])
    ...
    def __eq__(self, other):
        ...
        return super(OracleExportAsmParameters, self).__eq__(other) and \
               ...
               self.data_diskgroup == other.data_diskgroup
