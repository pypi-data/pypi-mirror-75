    ...
    *(extends* :py:class:`v1_9_1.web.vo.TypedObject` *)* Result of the
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._total_size[0] is not None and obj._total_size[0] is not obj.__undef__:
            assert isinstance(obj._total_size[0], float), ("Expected one of [u'number'], but got %s of type %s" % (obj._total_size[0], type(obj._total_size[0])))
            common.validate_format(obj._total_size[0], "None", None, None)
        return obj

    def to_dict(self, dirty=False, belongs_to_parent=False):
        dct = super(SnapshotSpaceResult, self).to_dict(dirty, belongs_to_parent)
