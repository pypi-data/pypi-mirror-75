    ...
    *(extends* :py:class:`v1_9_1.web.vo.PersistentObject` *)* A representation
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._status[0] is not None and obj._status[0] is not obj.__undef__:
            assert isinstance(obj._status[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._status[0], type(obj._status[0])))
        ...
        if obj._date_resolved[0] is not None and obj._date_resolved[0] is not obj.__undef__:
            assert isinstance(obj._date_resolved[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._date_resolved[0], type(obj._date_resolved[0])))
        ...
        if obj._severity[0] is not None and obj._severity[0] is not obj.__undef__:
            assert isinstance(obj._severity[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._severity[0], type(obj._severity[0])))
        ...
        if obj._resolution_comments[0] is not None and obj._resolution_comments[0] is not obj.__undef__:
            assert isinstance(obj._resolution_comments[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._resolution_comments[0], type(obj._resolution_comments[0])))
        ...
        if obj._date_diagnosed[0] is not None and obj._date_diagnosed[0] is not obj.__undef__:
            assert isinstance(obj._date_diagnosed[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._date_diagnosed[0], type(obj._date_diagnosed[0])))
        ...
        if obj._action[0] is not None and obj._action[0] is not obj.__undef__:
            assert isinstance(obj._action[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._action[0], type(obj._action[0])))
        ...
        if obj._bundle_id[0] is not None and obj._bundle_id[0] is not obj.__undef__:
            assert isinstance(obj._bundle_id[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._bundle_id[0], type(obj._bundle_id[0])))
        ...
        if obj._response[0] is not None and obj._response[0] is not obj.__undef__:
            assert isinstance(obj._response[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._response[0], type(obj._response[0])))
    ...
    def is_dirty(self):
        return any([self._status[1], self._description[1], self._title[1], self._date_resolved[1], self._severity[1], self._resolution_comments[1], self._date_diagnosed[1], self._target_object_type[1], self._action[1], self._bundle_id[1], self._target_name[1], self._response[1], self._target[1]])
