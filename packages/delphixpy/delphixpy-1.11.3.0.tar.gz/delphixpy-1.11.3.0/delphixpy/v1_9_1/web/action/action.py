...
def get_all(engine, to_date=None, page_offset=None, search_text=None, page_size=None, parent_action=None, ascending=None, state=None, from_date=None, user=None, root_action_only=None, ignore_action_types=None, sort_by=None):
    """
    ...
    query_params = {"toDate": to_date, "pageOffset": page_offset, "searchText": search_text, "pageSize": page_size, "state": state, "ascending": ascending, "parentAction": parent_action, "fromDate": from_date, "user": user, "rootActionOnly": root_action_only, "ignoreActionTypes": ignore_action_types, "sortBy": sort_by}
