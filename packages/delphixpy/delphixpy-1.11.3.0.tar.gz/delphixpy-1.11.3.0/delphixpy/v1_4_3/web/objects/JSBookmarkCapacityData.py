    ...
    *(extends* :py:class:`v1_4_3.web.vo.TypedObject` *)* The capacity
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._data_layout[0] is not None and obj._data_layout[0] is not obj.__undef__:
            assert isinstance(obj._data_layout[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._data_layout[0], type(obj._data_layout[0])))
        ...
        if obj._referenced_by_branches[0] is not None and obj._referenced_by_branches[0] is not obj.__undef__:
            assert isinstance(obj._referenced_by_branches[0], float), ("Expected one of [u'number'], but got %s of type %s" % (obj._referenced_by_branches[0], type(obj._referenced_by_branches[0])))
        ...
        if obj._referenced_by_bookmarks[0] is not None and obj._referenced_by_bookmarks[0] is not obj.__undef__:
            assert isinstance(obj._referenced_by_bookmarks[0], float), ("Expected one of [u'number'], but got %s of type %s" % (obj._referenced_by_bookmarks[0], type(obj._referenced_by_bookmarks[0])))
        ...
        if obj._referenced_externally[0] is not None and obj._referenced_externally[0] is not obj.__undef__:
            assert isinstance(obj._referenced_externally[0], float), ("Expected one of [u'number'], but got %s of type %s" % (obj._referenced_externally[0], type(obj._referenced_externally[0])))
        ...
        if obj._unique[0] is not None and obj._unique[0] is not obj.__undef__:
            assert isinstance(obj._unique[0], float), ("Expected one of [u'number'], but got %s of type %s" % (obj._unique[0], type(obj._unique[0])))
    ...
    def is_dirty(self):
        return any([self._data_layout[1], self._bookmark[1], self._referencing_bookmarks[1], self._referenced_by_branches[1], self._referenced_by_bookmarks[1], self._referenced_externally[1], self._referencing_branches[1], self._unique[1]])
