    ...
    *(extends* :py:class:`v1_4_3.web.vo.SourceRepository` *)* The SAP ASE
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._server_name[0] is not None and obj._server_name[0] is not obj.__undef__:
            assert isinstance(obj._server_name[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._server_name[0], type(obj._server_name[0])))
    ...
    def is_dirty(self):
        return any([self._installation_path[1], self._internal_version[1], self._server_name[1], self._db_user[1], self._instance_owner[1], self._credentials[1], self._page_size[1], self._instance_name[1], self._ports[1]])
