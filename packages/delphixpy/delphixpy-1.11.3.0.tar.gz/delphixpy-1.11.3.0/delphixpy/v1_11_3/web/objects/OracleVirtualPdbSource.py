    ...
    *(extends* :py:class:`v1_11_3.web.vo.OracleVirtualSource` *)* A virtual
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._parent_tde_keystore_path[0] is not None and obj._parent_tde_keystore_path[0] is not obj.__undef__:
            assert isinstance(obj._parent_tde_keystore_path[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._parent_tde_keystore_path[0], type(obj._parent_tde_keystore_path[0])))
    ...
    def is_dirty(self):
        return any([self._config_params[1], self._node_listeners[1], self._redo_log_groups[1], self._redo_log_size_in_mb[1], self._archivelog_mode[1], self._parent_tde_keystore_path[1], self._config_template[1]])
