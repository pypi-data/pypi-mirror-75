    ...
    *(extends* :py:class:`v1_11_3.web.vo.TypedObject` *)* The status of a
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._mapping_memory[0] is not None and obj._mapping_memory[0] is not obj.__undef__:
            assert isinstance(obj._mapping_memory[0], float), ("Expected one of [u'number'], but got %s of type %s" % (obj._mapping_memory[0], type(obj._mapping_memory[0])))
        ...
        if obj._copied[0] is not None and obj._copied[0] is not obj.__undef__:
            assert isinstance(obj._copied[0], float), ("Expected one of [u'number'], but got %s of type %s" % (obj._copied[0], type(obj._copied[0])))
    ...
    def is_dirty(self):
        return any([self._mapping_memory[1], self._state[1], self._total[1], self._copied[1], self._start_time[1]])
