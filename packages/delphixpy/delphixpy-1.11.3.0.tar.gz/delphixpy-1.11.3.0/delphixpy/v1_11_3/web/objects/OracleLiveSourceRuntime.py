    ...
    *(extends* :py:class:`v1_11_3.web.vo.OracleBaseSourceRuntime` *)* Runtime
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._source_resetlogs_id_change_detected[0] is not None and obj._source_resetlogs_id_change_detected[0] is not obj.__undef__:
            assert isinstance(obj._source_resetlogs_id_change_detected[0], bool), ("Expected one of [u'boolean'], but got %s of type %s" % (obj._source_resetlogs_id_change_detected[0], type(obj._source_resetlogs_id_change_detected[0])))
        ...
        if obj._last_update_time[0] is not None and obj._last_update_time[0] is not obj.__undef__:
            assert isinstance(obj._last_update_time[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._last_update_time[0], type(obj._last_update_time[0])))
        ...
        if obj._non_logged_data_detected[0] is not None and obj._non_logged_data_detected[0] is not obj.__undef__:
            assert isinstance(obj._non_logged_data_detected[0], bool), ("Expected one of [u'boolean'], but got %s of type %s" % (obj._non_logged_data_detected[0], type(obj._non_logged_data_detected[0])))
        ...
        if obj._current_data_age[0] is not None and obj._current_data_age[0] is not obj.__undef__:
            assert isinstance(obj._current_data_age[0], int), ("Expected one of [u'integer'], but got %s of type %s" % (obj._current_data_age[0], type(obj._current_data_age[0])))
        ...
        if obj._apply_status[0] is not None and obj._apply_status[0] is not obj.__undef__:
            assert isinstance(obj._apply_status[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._apply_status[0], type(obj._apply_status[0])))
        ...
        if obj._unexpected_role_change_detected[0] is not None and obj._unexpected_role_change_detected[0] is not obj.__undef__:
            assert isinstance(obj._unexpected_role_change_detected[0], bool), ("Expected one of [u'boolean'], but got %s of type %s" % (obj._unexpected_role_change_detected[0], type(obj._unexpected_role_change_detected[0])))
        ...
        if obj._transport_status[0] is not None and obj._transport_status[0] is not obj.__undef__:
            assert isinstance(obj._transport_status[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._transport_status[0], type(obj._transport_status[0])))
        ...
        if obj._is_data_age_warning_exceeded[0] is not None and obj._is_data_age_warning_exceeded[0] is not obj.__undef__:
            assert isinstance(obj._is_data_age_warning_exceeded[0], bool), ("Expected one of [u'boolean'], but got %s of type %s" % (obj._is_data_age_warning_exceeded[0], type(obj._is_data_age_warning_exceeded[0])))
        ...
        if obj._source_database_timezone[0] is not None and obj._source_database_timezone[0] is not obj.__undef__:
            assert isinstance(obj._source_database_timezone[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._source_database_timezone[0], type(obj._source_database_timezone[0])))
    ...
    def is_dirty(self):
        return any([self._source_resetlogs_id_change_detected[1], self._last_update_time[1], self._non_logged_data_detected[1], self._current_data_age[1], self._apply_status[1], self._unexpected_role_change_detected[1], self._transport_status[1], self._is_data_age_warning_exceeded[1], self._source_database_timezone[1]])
