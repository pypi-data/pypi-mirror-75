...
class MinimalPhoneHome(TypedObject):
    ...
    *(extends* :py:class:`v1_11_3.web.vo.TypedObject` *)* Collect minimal
    ...
    def __init__(self, undef_enabled=True):
        super(MinimalPhoneHome, self).__init__()
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        obj = super(MinimalPhoneHome, cls).from_dict(data, dirty, undef_enabled)
    ...
    def to_dict(self, dirty=False, belongs_to_parent=False):
        dct = super(MinimalPhoneHome, self).to_dict(dirty, belongs_to_parent)
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, MinimalPhoneHome):
            return False
        return super(MinimalPhoneHome, self).__eq__(other) and \
