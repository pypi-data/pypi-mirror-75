    ...
    *(extends* :py:class:`v1_10_6.web.vo.LogFetchSSH` *)* Parameters to fetch
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._end_location[0] is not None and obj._end_location[0] is not obj.__undef__:
            assert isinstance(obj._end_location[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._end_location[0], type(obj._end_location[0])))
        ...
        if obj._start_location[0] is not None and obj._start_location[0] is not obj.__undef__:
            assert isinstance(obj._start_location[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._start_location[0], type(obj._start_location[0])))
