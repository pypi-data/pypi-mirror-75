    ...
    *(extends* :py:class:`v1_10_6.web.vo.TypedObject` *)* Configuration for the
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._masking_legacy_ports[0] is not None and obj._masking_legacy_ports[0] is not obj.__undef__:
            assert isinstance(obj._masking_legacy_ports[0], bool), ("Expected one of [u'boolean'], but got %s of type %s" % (obj._masking_legacy_ports[0], type(obj._masking_legacy_ports[0])))
        ...
        if obj._http_port[0] is not None and obj._http_port[0] is not obj.__undef__:
            assert isinstance(obj._http_port[0], int), ("Expected one of [u'integer'], but got %s of type %s" % (obj._http_port[0], type(obj._http_port[0])))
        ...
        if obj._https_port[0] is not None and obj._https_port[0] is not obj.__undef__:
            assert isinstance(obj._https_port[0], int), ("Expected one of [u'integer'], but got %s of type %s" % (obj._https_port[0], type(obj._https_port[0])))
        ...
        if obj._http_mode[0] is not None and obj._http_mode[0] is not obj.__undef__:
            assert isinstance(obj._http_mode[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._http_mode[0], type(obj._http_mode[0])))
            assert obj._http_mode[0] in [u'HTTP_ONLY', u'HTTPS_ONLY', u'HTTP_REDIRECT', u'BOTH', u'HTTP_REDIRECT_WITH_HSTS'], "Expected enum [u'HTTP_ONLY', u'HTTPS_ONLY', u'HTTP_REDIRECT', u'BOTH', u'HTTP_REDIRECT_WITH_HSTS'] but got %s" % obj._http_mode[0]
    ...
    def is_dirty(self):
        return any([self._masking_legacy_ports[1], self._tls_versions[1], self._http_port[1], self._https_port[1], self._http_mode[1], self._cipher_suites[1]])
    ...
    def __eq__(self, other):
        ...
        return super(HttpConnectorConfig, self).__eq__(other) and \
               self.masking_legacy_ports == other.masking_legacy_ports and \
