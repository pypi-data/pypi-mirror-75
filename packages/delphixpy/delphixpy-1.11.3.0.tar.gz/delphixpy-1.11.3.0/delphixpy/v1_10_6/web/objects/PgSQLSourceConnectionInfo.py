    ...
    *(extends* :py:class:`v1_10_6.web.vo.SourceConnectionInfo` *)* Contains
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._pg_data_directory[0] is not None and obj._pg_data_directory[0] is not obj.__undef__:
            assert isinstance(obj._pg_data_directory[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._pg_data_directory[0], type(obj._pg_data_directory[0])))
        ...
        if obj._jdbc_string[0] is not None and obj._jdbc_string[0] is not obj.__undef__:
            assert isinstance(obj._jdbc_string[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._jdbc_string[0], type(obj._jdbc_string[0])))
    ...
    def is_dirty(self):
        return any([self._host[1], self._pg_data_directory[1], self._port[1], self._jdbc_string[1], self._user[1]])
