    ...
    *(extends* :py:class:`v1_10_6.web.vo.TypedObject` *)* NTP (Network Time
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._multicast_address[0] is not None and obj._multicast_address[0] is not obj.__undef__:
            assert isinstance(obj._multicast_address[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._multicast_address[0], type(obj._multicast_address[0])))
        ...
        if obj._use_multicast[0] is not None and obj._use_multicast[0] is not obj.__undef__:
            assert isinstance(obj._use_multicast[0], bool), ("Expected one of [u'boolean'], but got %s of type %s" % (obj._use_multicast[0], type(obj._use_multicast[0])))
