    ...
    *(extends* :py:class:`v1_10_6.web.vo.TypedObject` *)* The parameters to use
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._defer[0] is not None and obj._defer[0] is not obj.__undef__:
            assert isinstance(obj._defer[0], bool), ("Expected one of [u'boolean'], but got %s of type %s" % (obj._defer[0], type(obj._defer[0])))
        ...
        if obj._reboot[0] is not None and obj._reboot[0] is not obj.__undef__:
            assert isinstance(obj._reboot[0], bool), ("Expected one of [u'boolean'], but got %s of type %s" % (obj._reboot[0], type(obj._reboot[0])))
    ...
    def is_dirty(self):
        return any([self._defer[1], self._enable_sources_on_failure[1], self._ignore_quiesce_sources_failures[1], self._verify[1], self._reboot[1], self._quiesce_sources[1]])
    ...
    def __eq__(self, other):
        ...
        return super(ApplyVersionParameters, self).__eq__(other) and \
               ...
               self.quiesce_sources == other.quiesce_sources
