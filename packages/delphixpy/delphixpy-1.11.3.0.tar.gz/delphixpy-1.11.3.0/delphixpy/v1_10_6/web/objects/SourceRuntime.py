    ...
    *(extends* :py:class:`v1_10_6.web.vo.TypedObject` *)* Runtime properties of
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._accessible[0] is not None and obj._accessible[0] is not obj.__undef__:
            assert isinstance(obj._accessible[0], bool), ("Expected one of [u'boolean'], but got %s of type %s" % (obj._accessible[0], type(obj._accessible[0])))
        ...
        if obj._accessible_timestamp[0] is not None and obj._accessible_timestamp[0] is not obj.__undef__:
            assert isinstance(obj._accessible_timestamp[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._accessible_timestamp[0], type(obj._accessible_timestamp[0])))
        ...
        if obj._enabled[0] is not None and obj._enabled[0] is not obj.__undef__:
            assert isinstance(obj._enabled[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._enabled[0], type(obj._enabled[0])))
        ...
        if obj._not_accessible_reason[0] is not None and obj._not_accessible_reason[0] is not obj.__undef__:
            assert isinstance(obj._not_accessible_reason[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._not_accessible_reason[0], type(obj._not_accessible_reason[0])))
        ...
        if obj._database_size[0] is not None and obj._database_size[0] is not obj.__undef__:
            assert isinstance(obj._database_size[0], float), ("Expected one of [u'number'], but got %s of type %s" % (obj._database_size[0], type(obj._database_size[0])))
