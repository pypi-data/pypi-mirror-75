...
def get_all(engine, to_date=None, page_offset=None, search_text=None, target=None, page_size=None, from_date=None, max_total=None):
    """
    ...
    query_params = {"toDate": to_date, "pageOffset": page_offset, "searchText": search_text, "target": target, "pageSize": page_size, "fromDate": from_date, "maxTotal": max_total}
