...
class ChecklistItemDetail(ChecklistItem):
    """
    *(extends* :py:class:`v1_6_1.web.vo.ChecklistItem` *)* Fields to indicate
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._message[0] is not None and obj._message[0] is not obj.__undef__:
            assert isinstance(obj._message[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._message[0], type(obj._message[0])))
