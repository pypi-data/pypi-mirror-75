...
class TimeflowPointEngineTime(TimeflowPointParameters):
    ...
    *(extends* :py:class:`v1_6_1.web.vo.TimeflowPointParameters` *)* TimeFlow
    ...
    def __init__(self, undef_enabled=True):
        super(TimeflowPointEngineTime, self).__init__()
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        obj = super(TimeflowPointEngineTime, cls).from_dict(data, dirty, undef_enabled)
    ...
    def to_dict(self, dirty=False, belongs_to_parent=False):
        dct = super(TimeflowPointEngineTime, self).to_dict(dirty, belongs_to_parent)
    ...
    def is_dirty(self):
        return any([self._timestamp[1], self._container[1]])
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, TimeflowPointEngineTime):
            return False
        return super(TimeflowPointEngineTime, self).__eq__(other) and \
