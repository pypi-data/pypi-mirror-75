    ...
    *(extends* :py:class:`v1_5_2.web.vo.NamedUserObject` *)* An operation that
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._undo_time[0] is not None and obj._undo_time[0] is not obj.__undef__:
            assert isinstance(obj._undo_time[0], TEXT_TYPE), ("Expected one of [u'string', u'null'], but got %s of type %s" % (obj._undo_time[0], type(obj._undo_time[0])))
    ...
    def is_dirty(self):
        return any([self._data_layout[1], self._data_parent[1], self._data_time[1], self._description[1], self._bookmark[1], self._root_action[1], self._start_time[1], self._undo_time[1], self._branch[1], self._operation[1], self._end_time[1]])
    ...
    def __eq__(self, other):
        ...
        return super(JSOperation, self).__eq__(other) and \
               ...
               self.undo_time == other.undo_time and \
