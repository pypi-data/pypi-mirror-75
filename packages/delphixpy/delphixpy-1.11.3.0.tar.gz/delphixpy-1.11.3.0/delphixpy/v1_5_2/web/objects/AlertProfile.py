...
class AlertProfile(PersistentObject):
    """
    *(extends* :py:class:`v1_5_2.web.vo.PersistentObject` *)* A profile that
    ...
    def is_dirty(self):
        return any([self._target_filter[1], self._event_filter[1], self._actions[1], self._severity_filter[1]])
    ...
    def __eq__(self, other):
        ...
        return super(AlertProfile, self).__eq__(other) and \
               ...
               self.severity_filter == other.severity_filter
    ...
    def actions(self):
        ...
        :rtype: ``list`` of :py:class:`v1_5_2.web.vo.AlertAction`
        """
