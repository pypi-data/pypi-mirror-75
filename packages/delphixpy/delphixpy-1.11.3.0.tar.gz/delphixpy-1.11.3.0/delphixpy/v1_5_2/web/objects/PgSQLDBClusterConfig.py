    ...
    *(extends* :py:class:`v1_5_2.web.vo.SourceConfig` *)* Configuration
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._cluster_data_directory[0] is not None and obj._cluster_data_directory[0] is not obj.__undef__:
            assert isinstance(obj._cluster_data_directory[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._cluster_data_directory[0], type(obj._cluster_data_directory[0])))
    ...
    def is_dirty(self):
        return any([self._repository[1], self._user[1], self._credentials[1], self._cluster_data_directory[1], self._port[1], self._connection_database[1]])
