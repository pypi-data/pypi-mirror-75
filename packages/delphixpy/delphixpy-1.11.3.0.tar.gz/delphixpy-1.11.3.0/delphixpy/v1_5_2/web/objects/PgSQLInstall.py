    ...
    *(extends* :py:class:`v1_5_2.web.vo.SourceRepository` *)* A PostgreSQL
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._segment_size[0] is not None and obj._segment_size[0] is not obj.__undef__:
            assert isinstance(obj._segment_size[0], int), ("Expected one of [u'integer'], but got %s of type %s" % (obj._segment_size[0], type(obj._segment_size[0])))
        ...
        if obj._variant[0] is not None and obj._variant[0] is not obj.__undef__:
            assert isinstance(obj._variant[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._variant[0], type(obj._variant[0])))
