    ...
    *(extends* :py:class:`v1_10_1.web.vo.SourceRepository` *)* The SQL Server
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._fulltext_installed[0] is not None and obj._fulltext_installed[0] is not obj.__undef__:
            assert isinstance(obj._fulltext_installed[0], bool), ("Expected one of [u'boolean'], but got %s of type %s" % (obj._fulltext_installed[0], type(obj._fulltext_installed[0])))
        ...
        if obj._internal_version[0] is not None and obj._internal_version[0] is not obj.__undef__:
            assert isinstance(obj._internal_version[0], int), ("Expected one of [u'integer'], but got %s of type %s" % (obj._internal_version[0], type(obj._internal_version[0])))
    ...
    def to_dict(self, dirty=False, belongs_to_parent=False):
        ...
        if "internal_version" == "type" or (self.internal_version is not self.__undef__ and (not (dirty and not self._internal_version[1]) or isinstance(self.internal_version, list) or belongs_to_parent)):
    ...
    def is_dirty(self):
        return any([self._fulltext_installed[1], self._internal_version[1]])
    ...
    def __eq__(self, other):
        ...
        return super(MSSqlRepository, self).__eq__(other) and \
               self.fulltext_installed == other.fulltext_installed and \
