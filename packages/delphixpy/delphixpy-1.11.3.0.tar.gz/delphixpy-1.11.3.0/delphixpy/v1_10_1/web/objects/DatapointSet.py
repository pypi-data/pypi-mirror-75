    ...
    *(extends* :py:class:`v1_10_1.web.vo.TypedObject` *)* A set of datapoints
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._overflow[0] is not None and obj._overflow[0] is not obj.__undef__:
            assert isinstance(obj._overflow[0], bool), ("Expected one of [u'boolean'], but got %s of type %s" % (obj._overflow[0], type(obj._overflow[0])))
        ...
        if obj._resolution[0] is not None and obj._resolution[0] is not obj.__undef__:
            assert isinstance(obj._resolution[0], int), ("Expected one of [u'integer'], but got %s of type %s" % (obj._resolution[0], type(obj._resolution[0])))
