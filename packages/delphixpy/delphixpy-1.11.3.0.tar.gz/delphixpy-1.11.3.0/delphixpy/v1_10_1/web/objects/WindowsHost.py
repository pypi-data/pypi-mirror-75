    ...
    *(extends* :py:class:`v1_10_1.web.vo.Host` *)* The representation of a
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._connector_authentication_key[0] is not None and obj._connector_authentication_key[0] is not obj.__undef__:
            assert isinstance(obj._connector_authentication_key[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._connector_authentication_key[0], type(obj._connector_authentication_key[0])))
        ...
        if obj._connector_port[0] is not None and obj._connector_port[0] is not obj.__undef__:
            assert isinstance(obj._connector_port[0], float), ("Expected one of [u'number'], but got %s of type %s" % (obj._connector_port[0], type(obj._connector_port[0])))
