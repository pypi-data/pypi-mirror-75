    ...
    *(extends* :py:class:`v1_10_1.web.vo.UserObject` *)* Certificate signing
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._request_in_pem[0] is not None and obj._request_in_pem[0] is not obj.__undef__:
            assert isinstance(obj._request_in_pem[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._request_in_pem[0], type(obj._request_in_pem[0])))
    ...
    def is_dirty(self):
        return any([self._request_in_pem[1], self._key_pair[1], self._subject_alternative_names[1], self._name[1], self._end_entity[1]])
