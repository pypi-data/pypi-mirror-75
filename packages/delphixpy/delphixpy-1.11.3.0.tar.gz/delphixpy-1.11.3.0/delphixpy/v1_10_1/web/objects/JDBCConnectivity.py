    ...
    *(extends* :py:class:`v1_10_1.web.vo.TypedObject` *)* Mechanism to test
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._url[0] is not None and obj._url[0] is not obj.__undef__:
            assert isinstance(obj._url[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._url[0], type(obj._url[0])))
    ...
    def to_dict(self, dirty=False, belongs_to_parent=False):
        dct = super(JDBCConnectivity, self).to_dict(dirty, belongs_to_parent)
        ...
        def dictify(obj, prop_is_list_or_vo=False):
            if isinstance(obj, list):
                ...
                return obj
        if "url" == "type" or (self.url is not self.__undef__ and (not (dirty and not self._url[1]) or isinstance(self.url, list) or belongs_to_parent)):
