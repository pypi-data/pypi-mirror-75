    ...
    *(extends* :py:class:`v1_8_2.web.vo.NamedUserObject` *)* Delphix users.
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._public_key[0] is not None and obj._public_key[0] is not obj.__undef__:
            assert isinstance(obj._public_key[0], TEXT_TYPE), ("Expected one of [u'string', u'null'], but got %s of type %s" % (obj._public_key[0], type(obj._public_key[0])))
        ...
        if obj._password_update_requested[0] is not None and obj._password_update_requested[0] is not obj.__undef__:
            assert isinstance(obj._password_update_requested[0], bool), ("Expected one of [u'boolean'], but got %s of type %s" % (obj._password_update_requested[0], type(obj._password_update_requested[0])))
    ...
    def is_dirty(self):
        return any([self._credential[1], self._authentication_type[1], self._first_name[1], self._user_type[1], self._locale[1], self._last_name[1], self._enabled[1], self._name[1], self._public_key[1], self._session_timeout[1], self._email_address[1], self._password_update_requested[1], self._principal[1], self._mobile_phone_number[1], self._work_phone_number[1], self._is_default[1], self._home_phone_number[1]])
