    ...
    *(extends* :py:class:`v1_8_2.web.vo.TypedObject` *)* Represent a schedule
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._cron_string[0] is not None and obj._cron_string[0] is not obj.__undef__:
            assert isinstance(obj._cron_string[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._cron_string[0], type(obj._cron_string[0])))
        ...
        if obj._cutoff_time[0] is not None and obj._cutoff_time[0] is not obj.__undef__:
            assert isinstance(obj._cutoff_time[0], int), ("Expected one of [u'integer'], but got %s of type %s" % (obj._cutoff_time[0], type(obj._cutoff_time[0])))
            common.validate_format(obj._cutoff_time[0], "None", None, None)
        return obj

    def to_dict(self, dirty=False, belongs_to_parent=False):
        dct = super(Schedule, self).to_dict(dirty, belongs_to_parent)
