    ...
    *(extends* :py:class:`v1_8_2.web.vo.AttachData` *)* Represents the
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._connection_database[0] is not None and obj._connection_database[0] is not obj.__undef__:
            assert isinstance(obj._connection_database[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._connection_database[0], type(obj._connection_database[0])))
    ...
    def to_dict(self, dirty=False, belongs_to_parent=False):
        dct = super(PgSQLAttachData, self).to_dict(dirty, belongs_to_parent)
