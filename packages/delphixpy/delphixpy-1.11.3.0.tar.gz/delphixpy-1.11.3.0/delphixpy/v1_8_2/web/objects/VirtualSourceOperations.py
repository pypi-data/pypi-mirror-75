...
class VirtualSourceOperations(TypedObject):
    ...
    *(extends* :py:class:`v1_8_2.web.vo.TypedObject` *)* Describes operations
    ...
    def is_dirty(self):
        return any([self._post_refresh[1], self._pre_start[1], self._pre_refresh[1], self._configure_clone[1], self._pre_snapshot[1], self._pre_stop[1], self._post_snapshot[1], self._pre_rollback[1], self._post_rollback[1], self._post_stop[1], self._post_start[1]])
