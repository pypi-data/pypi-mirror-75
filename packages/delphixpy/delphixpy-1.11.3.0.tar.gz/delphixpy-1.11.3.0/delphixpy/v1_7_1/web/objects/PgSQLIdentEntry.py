    ...
    *(extends* :py:class:`v1_7_1.web.vo.TypedObject` *)* An entry in the
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._map_name[0] is not None and obj._map_name[0] is not obj.__undef__:
            assert isinstance(obj._map_name[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._map_name[0], type(obj._map_name[0])))
        ...
        if obj._system_username[0] is not None and obj._system_username[0] is not obj.__undef__:
            assert isinstance(obj._system_username[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._system_username[0], type(obj._system_username[0])))
        ...
        if obj._database_username[0] is not None and obj._database_username[0] is not obj.__undef__:
            assert isinstance(obj._database_username[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._database_username[0], type(obj._database_username[0])))
