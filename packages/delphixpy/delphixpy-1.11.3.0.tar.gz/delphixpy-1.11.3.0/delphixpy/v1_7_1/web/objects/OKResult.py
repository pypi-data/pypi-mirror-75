...
class OKResult(CallResult):
    """
    *(extends* :py:class:`v1_7_1.web.vo.CallResult` *)* Result of a successful
    API call.
    """
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._job[0] is not None and obj._job[0] is not obj.__undef__:
            assert isinstance(obj._job[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._job[0], type(obj._job[0])))
        ...
        if obj._result[0] is not None and obj._result[0] is not obj.__undef__:
            assert isinstance(obj._result[0], dict) or isinstance(obj._result[0], list) or isinstance(obj._result[0], TEXT_TYPE), ("Expected one of [u'object', u'array', u'string'], but got %s of type %s" % (obj._result[0], type(obj._result[0])))
