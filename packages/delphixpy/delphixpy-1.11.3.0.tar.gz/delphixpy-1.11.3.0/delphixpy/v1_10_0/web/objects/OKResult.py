    ...
    *(extends* :py:class:`v1_10_0.web.vo.CallResult` *)* Result of a successful
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._result[0] is not None and obj._result[0] is not obj.__undef__:
            assert isinstance(obj._result[0], dict) or isinstance(obj._result[0], list) or isinstance(obj._result[0], TEXT_TYPE) or isinstance(obj._result[0], int), ("Expected one of [u'object', u'array', u'string', u'integer'], but got %s of type %s" % (obj._result[0], type(obj._result[0])))
