    ...
    *(extends* :py:class:`v1_10_0.web.vo.SshVerifyBase` *)* SSH verification
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._fingerprint_type[0] is not None and obj._fingerprint_type[0] is not obj.__undef__:
            assert isinstance(obj._fingerprint_type[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._fingerprint_type[0], type(obj._fingerprint_type[0])))
        ...
        if obj._fingerprint[0] is not None and obj._fingerprint[0] is not obj.__undef__:
            assert isinstance(obj._fingerprint[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._fingerprint[0], type(obj._fingerprint[0])))
