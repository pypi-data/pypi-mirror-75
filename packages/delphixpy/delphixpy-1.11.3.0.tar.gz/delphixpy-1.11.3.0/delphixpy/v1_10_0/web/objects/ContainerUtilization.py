    ...
    *(extends* :py:class:`v1_10_0.web.vo.TypedObject` *)* Represents the
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._deleted[0] is not None and obj._deleted[0] is not obj.__undef__:
            assert isinstance(obj._deleted[0], bool), ("Expected one of [u'boolean'], but got %s of type %s" % (obj._deleted[0], type(obj._deleted[0])))
        ...
        if obj._hidden[0] is not None and obj._hidden[0] is not obj.__undef__:
            assert isinstance(obj._hidden[0], bool), ("Expected one of [u'boolean'], but got %s of type %s" % (obj._hidden[0], type(obj._hidden[0])))
