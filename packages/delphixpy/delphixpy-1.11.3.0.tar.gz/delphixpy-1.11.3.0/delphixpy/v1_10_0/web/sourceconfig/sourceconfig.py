...
def get_all(engine, environment=None, cdb_config=None, repository=None, pdb_config_only=None):
    """
    ...
    assert API_VERSION == engine.API_VERSION, "Wrong API version (%s) for parameter 'engine' (%s)" % (API_VERSION, engine.API_VERSION)
    url = "/resources/json/delphix/sourceconfig"
    query_params = {"environment": environment, "repository": repository, "cdbConfig": cdb_config, "pdbConfigOnly": pdb_config_only}
