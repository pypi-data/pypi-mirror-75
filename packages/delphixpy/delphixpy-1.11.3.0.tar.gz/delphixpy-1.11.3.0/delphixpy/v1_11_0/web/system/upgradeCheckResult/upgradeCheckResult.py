...
def get_all(engine, status=None, page_offset=None, page_size=None, ascending=None, version=None, sort_by=None):
    """
    ...
    query_params = {"status": status, "pageOffset": page_offset, "pageSize": page_size, "ascending": ascending, "version": version, "sortBy": sort_by}
