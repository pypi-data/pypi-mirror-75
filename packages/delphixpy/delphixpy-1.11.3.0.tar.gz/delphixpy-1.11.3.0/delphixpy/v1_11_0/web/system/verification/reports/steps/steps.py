...
def get_all(engine, page_offset=None, page_size=None, run_status=None, ascending=None, version=None, sort_by=None):
    """
    ...
    query_params = {"pageOffset": page_offset, "pageSize": page_size, "runStatus": run_status, "ascending": ascending, "version": version, "sortBy": sort_by}
    ...
    return response_validator.parse_result(result, undef_enabled=True, return_types=[u'UpgradeVerificationSteps'], returns_list=True, raw_result=raw_result)
