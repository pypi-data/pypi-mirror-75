    ...
    *(extends* :py:class:`v1_11_0.web.vo.NamedUserObject` *)* Describes the
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._start_timestamp[0] is not None and obj._start_timestamp[0] is not obj.__undef__:
            assert isinstance(obj._start_timestamp[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._start_timestamp[0], type(obj._start_timestamp[0])))
        ...
        if obj._run_status[0] is not None and obj._run_status[0] is not obj.__undef__:
            assert isinstance(obj._run_status[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._run_status[0], type(obj._run_status[0])))
            assert obj._run_status[0] in [u'SUCCESS', u'FAILURE', u'SKIPPED'], "Expected enum [u'SUCCESS', u'FAILURE', u'SKIPPED'] but got %s" % obj._run_status[0]
        ...
        if obj._class_name[0] is not None and obj._class_name[0] is not obj.__undef__:
            assert isinstance(obj._class_name[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._class_name[0], type(obj._class_name[0])))
        ...
        if obj._duration[0] is not None and obj._duration[0] is not obj.__undef__:
            assert isinstance(obj._duration[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._duration[0], type(obj._duration[0])))
        ...
        if obj._run_status_message[0] is not None and obj._run_status_message[0] is not obj.__undef__:
            assert isinstance(obj._run_status_message[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._run_status_message[0], type(obj._run_status_message[0])))
        ...
        if obj._end_timestamp[0] is not None and obj._end_timestamp[0] is not obj.__undef__:
            assert isinstance(obj._end_timestamp[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._end_timestamp[0], type(obj._end_timestamp[0])))
    ...
    def is_dirty(self):
        return any([self._description[1], self._start_timestamp[1], self._run_status[1], self._class_name[1], self._notifications[1], self._duration[1], self._run_status_message[1], self._end_timestamp[1]])
