    ...
    *(extends* :py:class:`v1_11_0.web.vo.TypedObject` *)* The test results of
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._average_latency[0] is not None and obj._average_latency[0] is not obj.__undef__:
            assert isinstance(obj._average_latency[0], float), ("Expected one of [u'number'], but got %s of type %s" % (obj._average_latency[0], type(obj._average_latency[0])))
        ...
        if obj._load_scaling_grade[0] is not None and obj._load_scaling_grade[0] is not obj.__undef__:
            assert isinstance(obj._load_scaling_grade[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._load_scaling_grade[0], type(obj._load_scaling_grade[0])))
        ...
        if obj._jobs[0] is not None and obj._jobs[0] is not obj.__undef__:
            assert isinstance(obj._jobs[0], int), ("Expected one of [u'integer'], but got %s of type %s" % (obj._jobs[0], type(obj._jobs[0])))
        ...
        if obj._max_latency[0] is not None and obj._max_latency[0] is not obj.__undef__:
            assert isinstance(obj._max_latency[0], float), ("Expected one of [u'number'], but got %s of type %s" % (obj._max_latency[0], type(obj._max_latency[0])))
        ...
        if obj._min_latency[0] is not None and obj._min_latency[0] is not obj.__undef__:
            assert isinstance(obj._min_latency[0], float), ("Expected one of [u'number'], but got %s of type %s" % (obj._min_latency[0], type(obj._min_latency[0])))
        ...
        if obj._block_size[0] is not None and obj._block_size[0] is not obj.__undef__:
            assert isinstance(obj._block_size[0], int), ("Expected one of [u'integer'], but got %s of type %s" % (obj._block_size[0], type(obj._block_size[0])))
        ...
        if obj._latency_grade[0] is not None and obj._latency_grade[0] is not obj.__undef__:
            assert isinstance(obj._latency_grade[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._latency_grade[0], type(obj._latency_grade[0])))
        ...
        if obj._test_name[0] is not None and obj._test_name[0] is not obj.__undef__:
            assert isinstance(obj._test_name[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._test_name[0], type(obj._test_name[0])))
        ...
        if obj._latency95th_percentile[0] is not None and obj._latency95th_percentile[0] is not obj.__undef__:
            assert isinstance(obj._latency95th_percentile[0], float), ("Expected one of [u'number'], but got %s of type %s" % (obj._latency95th_percentile[0], type(obj._latency95th_percentile[0])))
        ...
        if obj._load_scaling[0] is not None and obj._load_scaling[0] is not obj.__undef__:
            assert isinstance(obj._load_scaling[0], float), ("Expected one of [u'number'], but got %s of type %s" % (obj._load_scaling[0], type(obj._load_scaling[0])))
        ...
        if obj._iops[0] is not None and obj._iops[0] is not obj.__undef__:
            assert isinstance(obj._iops[0], int), ("Expected one of [u'integer'], but got %s of type %s" % (obj._iops[0], type(obj._iops[0])))
        ...
        if obj._throughput[0] is not None and obj._throughput[0] is not obj.__undef__:
            assert isinstance(obj._throughput[0], float), ("Expected one of [u'number'], but got %s of type %s" % (obj._throughput[0], type(obj._throughput[0])))
        ...
        if obj._stddev_latency[0] is not None and obj._stddev_latency[0] is not obj.__undef__:
            assert isinstance(obj._stddev_latency[0], float), ("Expected one of [u'number'], but got %s of type %s" % (obj._stddev_latency[0], type(obj._stddev_latency[0])))
        ...
        if obj._test_type[0] is not None and obj._test_type[0] is not obj.__undef__:
            assert isinstance(obj._test_type[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._test_type[0], type(obj._test_type[0])))
    ...
    def is_dirty(self):
        return any([self._average_latency[1], self._load_scaling_grade[1], self._jobs[1], self._max_latency[1], self._min_latency[1], self._block_size[1], self._latency_grade[1], self._test_name[1], self._latency95th_percentile[1], self._load_scaling[1], self._iops[1], self._throughput[1], self._stddev_latency[1], self._test_type[1]])
