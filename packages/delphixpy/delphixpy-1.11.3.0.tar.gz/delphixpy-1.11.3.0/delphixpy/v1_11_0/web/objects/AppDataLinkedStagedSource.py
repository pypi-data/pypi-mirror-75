    ...
    *(extends* :py:class:`v1_11_0.web.vo.AppDataLinkedSource` *)* An AppData
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._staging_environment[0] is not None and obj._staging_environment[0] is not obj.__undef__:
            assert isinstance(obj._staging_environment[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._staging_environment[0], type(obj._staging_environment[0])))
        ...
        if obj._staging_mount_base[0] is not None and obj._staging_mount_base[0] is not obj.__undef__:
            assert isinstance(obj._staging_mount_base[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._staging_mount_base[0], type(obj._staging_mount_base[0])))
        ...
        if obj._staging_environment_user[0] is not None and obj._staging_environment_user[0] is not obj.__undef__:
            assert isinstance(obj._staging_environment_user[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._staging_environment_user[0], type(obj._staging_environment_user[0])))
    ...
    def is_dirty(self):
        return any([self._staging_environment[1], self._staging_mount_base[1], self._runtime_mount_information[1], self._staging_environment_user[1]])
