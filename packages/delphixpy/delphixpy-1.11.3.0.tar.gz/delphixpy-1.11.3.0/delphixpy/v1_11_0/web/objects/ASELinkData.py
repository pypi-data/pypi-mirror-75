    ...
    *(extends* :py:class:`v1_11_0.web.vo.LinkData` *)* SAP ASE specific
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._staging_repository[0] is not None and obj._staging_repository[0] is not obj.__undef__:
            assert isinstance(obj._staging_repository[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._staging_repository[0], type(obj._staging_repository[0])))
        ...
        if obj._load_backup_path[0] is not None and obj._load_backup_path[0] is not obj.__undef__:
            assert isinstance(obj._load_backup_path[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._load_backup_path[0], type(obj._load_backup_path[0])))
        ...
        if obj._mount_base[0] is not None and obj._mount_base[0] is not obj.__undef__:
            assert isinstance(obj._mount_base[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._mount_base[0], type(obj._mount_base[0])))
        ...
        if obj._staging_host_user[0] is not None and obj._staging_host_user[0] is not obj.__undef__:
            assert isinstance(obj._staging_host_user[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._staging_host_user[0], type(obj._staging_host_user[0])))
        ...
        if obj._dump_history_file_enabled[0] is not None and obj._dump_history_file_enabled[0] is not obj.__undef__:
            assert isinstance(obj._dump_history_file_enabled[0], bool), ("Expected one of [u'boolean'], but got %s of type %s" % (obj._dump_history_file_enabled[0], type(obj._dump_history_file_enabled[0])))
    ...
    def is_dirty(self):
        return any([self._operations[1], self._staging_repository[1], self._staging_pre_script[1], self._load_backup_path[1], self._external_file_path[1], self._validated_sync_mode[1], self._staging_operations[1], self._mount_base[1], self._staging_host_user[1], self._dump_history_file_enabled[1], self._staging_post_script[1], self._sync_parameters[1], self._db_credentials[1], self._db_user[1], self._source_host_user[1], self._dump_credentials[1], self._config[1], self._load_location[1]])
