...
class OracleLinkFromExternal(OracleBaseLinkData):
    ...
    *(extends* :py:class:`v1_11_0.web.vo.OracleBaseLinkData` *)* Represents
    ...
    def __init__(self, undef_enabled=True):
        super(OracleLinkFromExternal, self).__init__()
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        obj = super(OracleLinkFromExternal, cls).from_dict(data, dirty, undef_enabled)
    ...
    def to_dict(self, dirty=False, belongs_to_parent=False):
        dct = super(OracleLinkFromExternal, self).to_dict(dirty, belongs_to_parent)
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, OracleLinkFromExternal):
            return False
        return super(OracleLinkFromExternal, self).__eq__(other) and \
