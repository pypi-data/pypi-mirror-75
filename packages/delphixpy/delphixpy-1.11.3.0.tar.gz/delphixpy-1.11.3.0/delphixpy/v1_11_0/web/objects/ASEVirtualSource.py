...
class ASEVirtualSource(ASESource):
    ...
    *(extends* :py:class:`v1_11_0.web.vo.ASESource` *)* A virtual SAP ASE
    ...
    def to_dict(self, dirty=False, belongs_to_parent=False):
        dct = super(ASEVirtualSource, self).to_dict(dirty, belongs_to_parent)
    ...
    def is_dirty(self):
        return any([self._operations[1], self._config_params[1], self._file_mapping_rules[1], self._mount_base[1], self._allow_auto_vdb_restart_on_host_reboot[1], self._runtime_mount_information[1], self._runtime[1]])
