    ...
    *(extends* :py:class:`v1_11_0.web.vo.OracleSyncParameters` *)* The
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._do_not_resume[0] is not None and obj._do_not_resume[0] is not obj.__undef__:
            assert isinstance(obj._do_not_resume[0], bool), ("Expected one of [u'boolean'], but got %s of type %s" % (obj._do_not_resume[0], type(obj._do_not_resume[0])))
        ...
        if obj._force_full_backup[0] is not None and obj._force_full_backup[0] is not obj.__undef__:
            assert isinstance(obj._force_full_backup[0], bool), ("Expected one of [u'boolean'], but got %s of type %s" % (obj._force_full_backup[0], type(obj._force_full_backup[0])))
