    ...
    *(extends* :py:class:`v1_11_0.web.vo.TypedObject` *)* The parameters to use
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._role[0] is not None and obj._role[0] is not obj.__undef__:
            assert isinstance(obj._role[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._role[0], type(obj._role[0])))
    ...
    def to_dict(self, dirty=False, belongs_to_parent=False):
        dct = super(AuthGetByPropertiesParameters, self).to_dict(dirty, belongs_to_parent)
