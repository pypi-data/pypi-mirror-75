    ...
    *(extends* :py:class:`v1_11_0.web.vo.Notification` *)* An object to track
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._drop_count[0] is not None and obj._drop_count[0] is not obj.__undef__:
            assert isinstance(obj._drop_count[0], int), ("Expected one of [u'integer'], but got %s of type %s" % (obj._drop_count[0], type(obj._drop_count[0])))
            common.validate_format(obj._drop_count[0], "None", None, None)
        return obj

    def to_dict(self, dirty=False, belongs_to_parent=False):
        dct = super(NotificationDrop, self).to_dict(dirty, belongs_to_parent)
