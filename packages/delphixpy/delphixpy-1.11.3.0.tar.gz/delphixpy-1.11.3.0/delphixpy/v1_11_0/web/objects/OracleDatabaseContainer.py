    ...
    *(extends* :py:class:`v1_11_0.web.vo.DatabaseContainer` *)* Data container
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._tde_provisioning_enabled[0] is not None and obj._tde_provisioning_enabled[0] is not obj.__undef__:
            assert isinstance(obj._tde_provisioning_enabled[0], bool), ("Expected one of [u'boolean'], but got %s of type %s" % (obj._tde_provisioning_enabled[0], type(obj._tde_provisioning_enabled[0])))
    ...
    def is_dirty(self):
        return any([self._content_type[1], self._physical_standby[1], self._diagnose_no_logging_faults[1], self._tde_provisioning_enabled[1], self._sourcing_policy[1], self._performance_mode[1], self._pre_provisioning_enabled[1], self._runtime[1], self._live_source[1]])
