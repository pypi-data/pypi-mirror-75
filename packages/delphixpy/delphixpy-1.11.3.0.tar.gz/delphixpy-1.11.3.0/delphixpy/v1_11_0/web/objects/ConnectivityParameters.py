...
class ConnectivityParameters(TypedObject):
    ...
    *(extends* :py:class:`v1_11_0.web.vo.TypedObject` *)* Parameters required
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        obj = super(ConnectivityParameters, cls).from_dict(data, dirty, undef_enabled)
    ...
    def to_dict(self, dirty=False, belongs_to_parent=False):
        dct = super(ConnectivityParameters, self).to_dict(dirty, belongs_to_parent)
    ...
    def is_dirty(self):
        return any([self._username[1], self._credentials[1], self._address[1]])
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ConnectivityParameters):
            return False
        return super(ConnectivityParameters, self).__eq__(other) and \
