    ...
    *(extends* :py:class:`v1_11_0.web.vo.MySQLSyncParameters` *)* The
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._backup_location[0] is not None and obj._backup_location[0] is not obj.__undef__:
            assert isinstance(obj._backup_location[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._backup_location[0], type(obj._backup_location[0])))
    ...
    def replication_coordinates(self):
        ...
        :rtype: :py:class:`v1_11_0.web.vo.MySQLReplicationCoordinates`
        """
