    ...
    *(extends* :py:class:`v1_11_0.web.vo.TypedObject` *)* The attributes of a
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._explanation[0] is not None and obj._explanation[0] is not obj.__undef__:
            assert isinstance(obj._explanation[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._explanation[0], type(obj._explanation[0])))
        ...
        if obj._constraint_type[0] is not None and obj._constraint_type[0] is not obj.__undef__:
            assert isinstance(obj._constraint_type[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._constraint_type[0], type(obj._constraint_type[0])))
        ...
        if obj._value_type[0] is not None and obj._value_type[0] is not obj.__undef__:
            assert isinstance(obj._value_type[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._value_type[0], type(obj._value_type[0])))
            assert obj._value_type[0] in [u'INTEGER', u'BOOLEAN', u'STRING', u'HISTOGRAM', u'AVERAGE'], "Expected enum [u'INTEGER', u'BOOLEAN', u'STRING', u'HISTOGRAM', u'AVERAGE'] but got %s" % obj._value_type[0]
        ...
        if obj._axis_name[0] is not None and obj._axis_name[0] is not obj.__undef__:
            assert isinstance(obj._axis_name[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._axis_name[0], type(obj._axis_name[0])))
        ...
        if obj._stream_attribute[0] is not None and obj._stream_attribute[0] is not obj.__undef__:
            assert isinstance(obj._stream_attribute[0], bool), ("Expected one of [u'boolean'], but got %s of type %s" % (obj._stream_attribute[0], type(obj._stream_attribute[0])))
