    ...
    *(extends* :py:class:`v1_11_0.web.vo.TypedObject` *)* An aggregation for a
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._aggregate_size[0] is not None and obj._aggregate_size[0] is not obj.__undef__:
            assert isinstance(obj._aggregate_size[0], float), ("Expected one of [u'number', u'null'], but got %s of type %s" % (obj._aggregate_size[0], type(obj._aggregate_size[0])))
        ...
        if obj._manual_query[0] is not None and obj._manual_query[0] is not obj.__undef__:
            assert isinstance(obj._manual_query[0], TEXT_TYPE), ("Expected one of [u'string', u'null'], but got %s of type %s" % (obj._manual_query[0], type(obj._manual_query[0])))
        ...
        if obj._aggregate_label[0] is not None and obj._aggregate_label[0] is not obj.__undef__:
            assert isinstance(obj._aggregate_label[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._aggregate_label[0], type(obj._aggregate_label[0])))
    ...
    def is_dirty(self):
        return any([self._container_type[1], self._aggregate_size[1], self._manual_query[1], self._aggregate_label[1]])
    ...
    def __eq__(self, other):
        ...
        return super(SourceTypeAggregateIngestedSize, self).__eq__(other) and \
               ...
               self.manual_query == other.manual_query and \
