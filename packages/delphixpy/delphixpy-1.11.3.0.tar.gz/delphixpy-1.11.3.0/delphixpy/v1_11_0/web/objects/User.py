    ...
    *(extends* :py:class:`v1_11_0.web.vo.NamedUserObject` *)* Delphix users.
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._authentication_type[0] is not None and obj._authentication_type[0] is not obj.__undef__:
            assert isinstance(obj._authentication_type[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._authentication_type[0], type(obj._authentication_type[0])))
        ...
        if obj._name[0] is not None and obj._name[0] is not obj.__undef__:
            assert isinstance(obj._name[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._name[0], type(obj._name[0])))
        ...
        if obj._first_name[0] is not None and obj._first_name[0] is not obj.__undef__:
            assert isinstance(obj._first_name[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._first_name[0], type(obj._first_name[0])))
        ...
        if obj._locale[0] is not None and obj._locale[0] is not obj.__undef__:
            assert isinstance(obj._locale[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._locale[0], type(obj._locale[0])))
        ...
        if obj._last_name[0] is not None and obj._last_name[0] is not obj.__undef__:
            assert isinstance(obj._last_name[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._last_name[0], type(obj._last_name[0])))
        ...
        if obj._user_type[0] is not None and obj._user_type[0] is not obj.__undef__:
            assert isinstance(obj._user_type[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._user_type[0], type(obj._user_type[0])))
        ...
        if obj._session_timeout[0] is not None and obj._session_timeout[0] is not obj.__undef__:
            assert isinstance(obj._session_timeout[0], int), ("Expected one of [u'integer'], but got %s of type %s" % (obj._session_timeout[0], type(obj._session_timeout[0])))
        ...
        if obj._email_address[0] is not None and obj._email_address[0] is not obj.__undef__:
            assert isinstance(obj._email_address[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._email_address[0], type(obj._email_address[0])))
        ...
        if obj._api_user[0] is not None and obj._api_user[0] is not obj.__undef__:
            assert isinstance(obj._api_user[0], bool), ("Expected one of [u'boolean'], but got %s of type %s" % (obj._api_user[0], type(obj._api_user[0])))
        ...
        if obj._password_update_request[0] is not None and obj._password_update_request[0] is not obj.__undef__:
            assert isinstance(obj._password_update_request[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._password_update_request[0], type(obj._password_update_request[0])))
        ...
        if obj._principal[0] is not None and obj._principal[0] is not obj.__undef__:
            assert isinstance(obj._principal[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._principal[0], type(obj._principal[0])))
        ...
        if obj._mobile_phone_number[0] is not None and obj._mobile_phone_number[0] is not obj.__undef__:
            assert isinstance(obj._mobile_phone_number[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._mobile_phone_number[0], type(obj._mobile_phone_number[0])))
        ...
        if obj._work_phone_number[0] is not None and obj._work_phone_number[0] is not obj.__undef__:
            assert isinstance(obj._work_phone_number[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._work_phone_number[0], type(obj._work_phone_number[0])))
        ...
        if obj._is_default[0] is not None and obj._is_default[0] is not obj.__undef__:
            assert isinstance(obj._is_default[0], bool), ("Expected one of [u'boolean'], but got %s of type %s" % (obj._is_default[0], type(obj._is_default[0])))
        ...
        if obj._home_phone_number[0] is not None and obj._home_phone_number[0] is not obj.__undef__:
            assert isinstance(obj._home_phone_number[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._home_phone_number[0], type(obj._home_phone_number[0])))
    ...
    def is_dirty(self):
        return any([self._credential[1], self._authentication_type[1], self._name[1], self._first_name[1], self._public_key[1], self._locale[1], self._last_name[1], self._enabled[1], self._user_type[1], self._session_timeout[1], self._email_address[1], self._api_user[1], self._password_update_request[1], self._principal[1], self._mobile_phone_number[1], self._work_phone_number[1], self._is_default[1], self._home_phone_number[1]])
    ...
    def __eq__(self, other):
        ...
        return super(User, self).__eq__(other) and \
               ...
               self.api_user == other.api_user and \
               ...
               self.home_phone_number == other.home_phone_number
