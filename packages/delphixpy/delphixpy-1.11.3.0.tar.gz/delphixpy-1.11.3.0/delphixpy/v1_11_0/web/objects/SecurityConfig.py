    ...
    *(extends* :py:class:`v1_11_0.web.vo.TypedObject` *)* System wide security
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._enable_cors_supports_credentials[0] is not None and obj._enable_cors_supports_credentials[0] is not obj.__undef__:
            assert isinstance(obj._enable_cors_supports_credentials[0], bool), ("Expected one of [u'boolean'], but got %s of type %s" % (obj._enable_cors_supports_credentials[0], type(obj._enable_cors_supports_credentials[0])))
        ...
        if obj._allowed_cors_origins[0] is not None and obj._allowed_cors_origins[0] is not obj.__undef__:
            assert isinstance(obj._allowed_cors_origins[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._allowed_cors_origins[0], type(obj._allowed_cors_origins[0])))
        ...
        if obj._is_cors_enabled[0] is not None and obj._is_cors_enabled[0] is not obj.__undef__:
            assert isinstance(obj._is_cors_enabled[0], bool), ("Expected one of [u'boolean'], but got %s of type %s" % (obj._is_cors_enabled[0], type(obj._is_cors_enabled[0])))
        ...
        if obj._banner[0] is not None and obj._banner[0] is not obj.__undef__:
            assert isinstance(obj._banner[0], TEXT_TYPE), ("Expected one of [u'string', u'null'], but got %s of type %s" % (obj._banner[0], type(obj._banner[0])))
    ...
    def is_dirty(self):
        return any([self._enable_cors_supports_credentials[1], self._allowed_cors_origins[1], self._is_cors_enabled[1], self._banner[1]])
    ...
    def __eq__(self, other):
        ...
        return super(SecurityConfig, self).__eq__(other) and \
               self.enable_cors_supports_credentials == other.enable_cors_supports_credentials and \
