    ...
    *(extends* :py:class:`v1_6_2.web.vo.TypedObject` *)* The definition of a
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._input_type[0] is not None and obj._input_type[0] is not obj.__undef__:
            assert isinstance(obj._input_type[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._input_type[0], type(obj._input_type[0])))
    ...
    def to_dict(self, dirty=False, belongs_to_parent=False):
        ...
        def dictify(obj, prop_is_list_or_vo=False):
            if isinstance(obj, list):
                ...
                return obj
        if "input_type" == "type" or (self.input_type is not self.__undef__ and (not (dirty and not self._input_type[1]) or isinstance(self.input_type, list) or belongs_to_parent)):
    ...
    def is_dirty(self):
        return any([self._input_type[1], self._output_schema[1], self._name[1]])
