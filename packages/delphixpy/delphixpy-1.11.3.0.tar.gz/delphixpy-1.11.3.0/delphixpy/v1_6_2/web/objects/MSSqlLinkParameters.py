...
class MSSqlLinkParameters(LinkParameters):
    ...
    *(extends* :py:class:`v1_6_2.web.vo.LinkParameters` *)* MSSQL specific
    ...
    def is_dirty(self):
        return any([self._ppt_host_user[1], self._backup_uuid[1], self._container[1], self._source[1], self._staging_post_script[1], self._db_credentials[1], self._db_user[1], self._source_host_user[1], self._staging_pre_script[1], self._ppt_repository[1]])
