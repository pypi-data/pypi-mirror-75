    ...
    *(extends* :py:class:`v1_6_2.web.vo.TypedObject` *)* Schema object.
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._schema[0] is not None and obj._schema[0] is not obj.__undef__:
            assert isinstance(obj._schema[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._schema[0], type(obj._schema[0])))
            common.validate_format(obj._schema[0], "None", None, None)
        return obj

    def to_dict(self, dirty=False, belongs_to_parent=False):
        dct = super(Schema, self).to_dict(dirty, belongs_to_parent)
