    ...
    *(extends* :py:class:`v1_6_2.web.vo.AggregateCapacityData` *)* Capacity
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._total_space[0] is not None and obj._total_space[0] is not obj.__undef__:
            assert isinstance(obj._total_space[0], float), ("Expected one of [u'number'], but got %s of type %s" % (obj._total_space[0], type(obj._total_space[0])))
            common.validate_format(obj._total_space[0], "None", None, None)
        return obj

    def to_dict(self, dirty=False, belongs_to_parent=False):
        dct = super(BaseSystemCapacityData, self).to_dict(dirty, belongs_to_parent)
