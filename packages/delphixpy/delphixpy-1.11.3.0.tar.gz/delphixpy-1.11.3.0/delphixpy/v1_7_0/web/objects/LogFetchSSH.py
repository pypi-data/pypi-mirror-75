    ...
    *(extends* :py:class:`v1_7_0.web.vo.TypedObject` *)* Parameters to fetch
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._directory[0] is not None and obj._directory[0] is not obj.__undef__:
            assert isinstance(obj._directory[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._directory[0], type(obj._directory[0])))
    ...
    def to_dict(self, dirty=False, belongs_to_parent=False):
        dct = super(LogFetchSSH, self).to_dict(dirty, belongs_to_parent)
