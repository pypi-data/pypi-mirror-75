...
class MySQLAttachSourceParameters(AttachSourceParameters):
    ...
    *(extends* :py:class:`v1_7_0.web.vo.AttachSourceParameters` *)* The
    ...
    def __init__(self, undef_enabled=True):
        super(MySQLAttachSourceParameters, self).__init__()
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        obj = super(MySQLAttachSourceParameters, cls).from_dict(data, dirty, undef_enabled)
    ...
    def to_dict(self, dirty=False, belongs_to_parent=False):
        dct = super(MySQLAttachSourceParameters, self).to_dict(dirty, belongs_to_parent)
    ...
    def is_dirty(self):
        return any([self._staging_repository[1], self._staging_port[1], self._staging_host_user[1], self._source[1], self._db_user[1], self._db_credentials[1]])
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, MySQLAttachSourceParameters):
            return False
        return super(MySQLAttachSourceParameters, self).__eq__(other) and \
