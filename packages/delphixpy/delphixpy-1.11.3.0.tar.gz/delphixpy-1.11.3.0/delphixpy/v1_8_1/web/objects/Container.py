    ...
    *(extends* :py:class:`v1_8_1.web.vo.NamedUserObject` *)* A container
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._group[0] is not None and obj._group[0] is not obj.__undef__:
            assert isinstance(obj._group[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._group[0], type(obj._group[0])))
        ...
        if obj._current_timeflow[0] is not None and obj._current_timeflow[0] is not obj.__undef__:
            assert isinstance(obj._current_timeflow[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._current_timeflow[0], type(obj._current_timeflow[0])))
        ...
        if obj._restoration[0] is not None and obj._restoration[0] is not obj.__undef__:
            assert isinstance(obj._restoration[0], bool), ("Expected one of [u'boolean'], but got %s of type %s" % (obj._restoration[0], type(obj._restoration[0])))
        ...
        if obj._previous_timeflow[0] is not None and obj._previous_timeflow[0] is not obj.__undef__:
            assert isinstance(obj._previous_timeflow[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._previous_timeflow[0], type(obj._previous_timeflow[0])))
        ...
        if obj._masked[0] is not None and obj._masked[0] is not obj.__undef__:
            assert isinstance(obj._masked[0], bool), ("Expected one of [u'boolean'], but got %s of type %s" % (obj._masked[0], type(obj._masked[0])))
        ...
        if obj._provision_container[0] is not None and obj._provision_container[0] is not obj.__undef__:
            assert isinstance(obj._provision_container[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._provision_container[0], type(obj._provision_container[0])))
        ...
        if obj._transformation[0] is not None and obj._transformation[0] is not obj.__undef__:
            assert isinstance(obj._transformation[0], bool), ("Expected one of [u'boolean'], but got %s of type %s" % (obj._transformation[0], type(obj._transformation[0])))
