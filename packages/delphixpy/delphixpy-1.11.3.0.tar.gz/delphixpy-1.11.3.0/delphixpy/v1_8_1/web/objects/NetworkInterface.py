    ...
    *(extends* :py:class:`v1_8_1.web.vo.UserObject` *)* Configuration of an IP
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._mac_address[0] is not None and obj._mac_address[0] is not obj.__undef__:
            assert isinstance(obj._mac_address[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._mac_address[0], type(obj._mac_address[0])))
        ...
        if obj._mtu[0] is not None and obj._mtu[0] is not obj.__undef__:
            assert isinstance(obj._mtu[0], int), ("Expected one of [u'integer'], but got %s of type %s" % (obj._mtu[0], type(obj._mtu[0])))
        ...
        if obj._data_node[0] is not None and obj._data_node[0] is not obj.__undef__:
            assert isinstance(obj._data_node[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._data_node[0], type(obj._data_node[0])))
        ...
        if obj._device[0] is not None and obj._device[0] is not obj.__undef__:
            assert isinstance(obj._device[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._device[0], type(obj._device[0])))
        ...
        if obj._mtu_range[0] is not None and obj._mtu_range[0] is not obj.__undef__:
            assert isinstance(obj._mtu_range[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._mtu_range[0], type(obj._mtu_range[0])))
