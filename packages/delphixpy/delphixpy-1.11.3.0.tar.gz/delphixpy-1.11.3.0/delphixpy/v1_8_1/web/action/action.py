...
def get_all(engine, to_date=None, root_action_only=None, search_text=None, page_size=None, state=None, page_offset=None, ascending=None, parent_action=None, from_date=None, sort_by=None, user=None):
    """
    ...
    query_params = {"toDate": to_date, "pageOffset": page_offset, "searchText": search_text, "pageSize": page_size, "rootActionOnly": root_action_only, "parentAction": parent_action, "ascending": ascending, "state": state, "fromDate": from_date, "sortBy": sort_by, "user": user}
