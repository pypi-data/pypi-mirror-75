    ...
    *(extends* :py:class:`v1_9_3.web.vo.TypedObject` *)* SMTP configuration.
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._username[0] is not None and obj._username[0] is not obj.__undef__:
            assert isinstance(obj._username[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._username[0], type(obj._username[0])))
        ...
        if obj._from_address[0] is not None and obj._from_address[0] is not obj.__undef__:
            assert isinstance(obj._from_address[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._from_address[0], type(obj._from_address[0])))
        ...
        if obj._send_timeout[0] is not None and obj._send_timeout[0] is not obj.__undef__:
            assert isinstance(obj._send_timeout[0], int), ("Expected one of [u'integer'], but got %s of type %s" % (obj._send_timeout[0], type(obj._send_timeout[0])))
        ...
        if obj._tls_enabled[0] is not None and obj._tls_enabled[0] is not obj.__undef__:
            assert isinstance(obj._tls_enabled[0], bool), ("Expected one of [u'boolean'], but got %s of type %s" % (obj._tls_enabled[0], type(obj._tls_enabled[0])))
        ...
        if obj._server[0] is not None and obj._server[0] is not obj.__undef__:
            assert isinstance(obj._server[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._server[0], type(obj._server[0])))
        ...
        if obj._authentication_enabled[0] is not None and obj._authentication_enabled[0] is not obj.__undef__:
            assert isinstance(obj._authentication_enabled[0], bool), ("Expected one of [u'boolean'], but got %s of type %s" % (obj._authentication_enabled[0], type(obj._authentication_enabled[0])))
        ...
        if obj._password[0] is not None and obj._password[0] is not obj.__undef__:
            assert isinstance(obj._password[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._password[0], type(obj._password[0])))
        ...
        if obj._port[0] is not None and obj._port[0] is not obj.__undef__:
            assert isinstance(obj._port[0], int), ("Expected one of [u'integer'], but got %s of type %s" % (obj._port[0], type(obj._port[0])))
    ...
    def is_dirty(self):
        return any([self._username[1], self._from_address[1], self._send_timeout[1], self._enabled[1], self._tls_enabled[1], self._server[1], self._authentication_enabled[1], self._password[1], self._port[1]])
