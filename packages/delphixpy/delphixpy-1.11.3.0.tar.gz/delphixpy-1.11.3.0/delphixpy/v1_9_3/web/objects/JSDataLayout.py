    ...
    *(extends* :py:class:`v1_9_3.web.vo.NamedUserObject` *)* A Jet Stream data
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._first_operation[0] is not None and obj._first_operation[0] is not obj.__undef__:
            assert isinstance(obj._first_operation[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._first_operation[0], type(obj._first_operation[0])))
        ...
        if obj._active_branch[0] is not None and obj._active_branch[0] is not obj.__undef__:
            assert isinstance(obj._active_branch[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._active_branch[0], type(obj._active_branch[0])))
        ...
        if obj._last_operation[0] is not None and obj._last_operation[0] is not obj.__undef__:
            assert isinstance(obj._last_operation[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._last_operation[0], type(obj._last_operation[0])))
