    ...
    *(extends* :py:class:`v1_9_3.web.vo.TypedObject` *)* Description of an
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._command_output[0] is not None and obj._command_output[0] is not obj.__undef__:
            assert isinstance(obj._command_output[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._command_output[0], type(obj._command_output[0])))
        ...
        if obj._details[0] is not None and obj._details[0] is not obj.__undef__:
            assert isinstance(obj._details[0], dict) or isinstance(obj._details[0], TEXT_TYPE), ("Expected one of [u'object', u'string'], but got %s of type %s" % (obj._details[0], type(obj._details[0])))
    ...
    def is_dirty(self):
        return any([self._action[1], self._diagnoses[1], self._command_output[1], self._details[1], self._id[1]])
