    ...
    *(extends* :py:class:`v1_9_2.web.vo.UserObject` *)* Splunk HTTP Event
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._metrics_index[0] is not None and obj._metrics_index[0] is not obj.__undef__:
            assert isinstance(obj._metrics_index[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._metrics_index[0], type(obj._metrics_index[0])))
    ...
    def is_dirty(self):
        return any([self._main_index[1], self._hec_port[1], self._hec_token[1], self._enabled[1], self._enable_metrics[1], self._enable_ssl[1], self._host[1], self._metrics_index[1]])
