...
class Certificate(UserObject):
    ...
    *(extends* :py:class:`v1_9_2.web.vo.UserObject` *)* Public Key Certificate.
    ...
    def is_dirty(self):
        return any([self._name[1], self._sha1_fingerprint[1], self._not_before[1], self._serial_number[1], self._issued_by_dn[1], self._md5_fingerprint[1], self._not_after[1], self._issuer[1]])
