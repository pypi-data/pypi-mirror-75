    ...
    *(extends* :py:class:`v1_9_2.web.vo.X500DistinguishedName` *)* The
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._city[0] is not None and obj._city[0] is not obj.__undef__:
            assert isinstance(obj._city[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._city[0], type(obj._city[0])))
        ...
        if obj._common_name[0] is not None and obj._common_name[0] is not obj.__undef__:
            assert isinstance(obj._common_name[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._common_name[0], type(obj._common_name[0])))
        ...
        if obj._organization_unit[0] is not None and obj._organization_unit[0] is not obj.__undef__:
            assert isinstance(obj._organization_unit[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._organization_unit[0], type(obj._organization_unit[0])))
        ...
        if obj._state_region[0] is not None and obj._state_region[0] is not obj.__undef__:
            assert isinstance(obj._state_region[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._state_region[0], type(obj._state_region[0])))
        ...
        if obj._organization[0] is not None and obj._organization[0] is not obj.__undef__:
            assert isinstance(obj._organization[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._organization[0], type(obj._organization[0])))
    ...
    def is_dirty(self):
        return any([self._city[1], self._country[1], self._common_name[1], self._organization_unit[1], self._state_region[1], self._organization[1]])
    ...
    def __eq__(self, other):
        ...
        return super(X500DistinguishedNameFields, self).__eq__(other) and \
               ...
               self.organization_unit == other.organization_unit and \
