    ...
    *(extends* :py:class:`v1_9_2.web.vo.NamedUserObject` *)* Represents a job
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._update_time[0] is not None and obj._update_time[0] is not obj.__undef__:
            assert isinstance(obj._update_time[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._update_time[0], type(obj._update_time[0])))
        ...
        if obj._job_state[0] is not None and obj._job_state[0] is not obj.__undef__:
            assert isinstance(obj._job_state[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._job_state[0], type(obj._job_state[0])))
        ...
        if obj._target[0] is not None and obj._target[0] is not obj.__undef__:
            assert isinstance(obj._target[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._target[0], type(obj._target[0])))
        ...
        if obj._suspendable[0] is not None and obj._suspendable[0] is not obj.__undef__:
            assert isinstance(obj._suspendable[0], bool), ("Expected one of [u'boolean'], but got %s of type %s" % (obj._suspendable[0], type(obj._suspendable[0])))
        ...
        if obj._cancel_reason[0] is not None and obj._cancel_reason[0] is not obj.__undef__:
            assert isinstance(obj._cancel_reason[0], TEXT_TYPE), ("Expected one of [u'string', u'null'], but got %s of type %s" % (obj._cancel_reason[0], type(obj._cancel_reason[0])))
        ...
        if obj._parent_action[0] is not None and obj._parent_action[0] is not obj.__undef__:
            assert isinstance(obj._parent_action[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._parent_action[0], type(obj._parent_action[0])))
        ...
        if obj._cancelable[0] is not None and obj._cancelable[0] is not obj.__undef__:
            assert isinstance(obj._cancelable[0], bool), ("Expected one of [u'boolean'], but got %s of type %s" % (obj._cancelable[0], type(obj._cancelable[0])))
        ...
        if obj._target_object_type[0] is not None and obj._target_object_type[0] is not obj.__undef__:
            assert isinstance(obj._target_object_type[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._target_object_type[0], type(obj._target_object_type[0])))
        ...
        if obj._action_type[0] is not None and obj._action_type[0] is not obj.__undef__:
            assert isinstance(obj._action_type[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._action_type[0], type(obj._action_type[0])))
        ...
        if obj._parent_action_state[0] is not None and obj._parent_action_state[0] is not obj.__undef__:
            assert isinstance(obj._parent_action_state[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._parent_action_state[0], type(obj._parent_action_state[0])))
        ...
        if obj._target_name[0] is not None and obj._target_name[0] is not obj.__undef__:
            assert isinstance(obj._target_name[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._target_name[0], type(obj._target_name[0])))
        ...
        if obj._queued[0] is not None and obj._queued[0] is not obj.__undef__:
            assert isinstance(obj._queued[0], bool), ("Expected one of [u'boolean'], but got %s of type %s" % (obj._queued[0], type(obj._queued[0])))
        ...
        if obj._percent_complete[0] is not None and obj._percent_complete[0] is not obj.__undef__:
            assert isinstance(obj._percent_complete[0], float), ("Expected one of [u'number'], but got %s of type %s" % (obj._percent_complete[0], type(obj._percent_complete[0])))
    ...
    def is_dirty(self):
        return any([self._update_time[1], self._job_state[1], self._target[1], self._suspendable[1], self._cancel_reason[1], self._title[1], self._parent_action[1], self._events[1], self._cancelable[1], self._target_object_type[1], self._action_type[1], self._user[1], self._start_time[1], self._parent_action_state[1], self._email_addresses[1], self._target_name[1], self._queued[1], self._percent_complete[1]])
