    ...
    *(extends* :py:class:`v1_6_0.web.vo.TypedObject` *)* The association
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._priority[0] is not None and obj._priority[0] is not obj.__undef__:
            assert isinstance(obj._priority[0], int), ("Expected one of [u'integer'], but got %s of type %s" % (obj._priority[0], type(obj._priority[0])))
    ...
    def is_dirty(self):
        return any([self._priority[1], self._source[1], self._name[1], self._timestamp[1]])
