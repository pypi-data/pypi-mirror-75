    ...
    *(extends* :py:class:`v1_4_0.web.vo.TypedObject` *)* Retrieve static
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        for item in data.get("enabledFeatures") or []:
            ...
            assert item in [u'XPP'], "Expected enum [u'XPP'] but got %s" % item
    ...
    def is_dirty(self):
        return any([self._enabled_features[1], self._build_version[1], self._configured[1], self._api_version[1], self._product_name[1], self._product_type[1], self._build_title[1], self._banner[1], self._build_timestamp[1]])
