    ...
    *(extends* :py:class:`v1_4_0.web.vo.TypedObject` *)* Describes a processor
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._cores[0] is not None and obj._cores[0] is not obj.__undef__:
            assert isinstance(obj._cores[0], int), ("Expected one of [u'integer'], but got %s of type %s" % (obj._cores[0], type(obj._cores[0])))
        ...
        if obj._speed[0] is not None and obj._speed[0] is not obj.__undef__:
            assert isinstance(obj._speed[0], float), ("Expected one of [u'number'], but got %s of type %s" % (obj._speed[0], type(obj._speed[0])))
