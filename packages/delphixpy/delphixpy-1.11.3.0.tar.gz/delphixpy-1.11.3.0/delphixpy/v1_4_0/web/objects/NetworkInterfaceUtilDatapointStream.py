    ...
    *(extends* :py:class:`v1_4_0.web.vo.DatapointStream` *)* A stream of
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._network_interface[0] is not None and obj._network_interface[0] is not obj.__undef__:
            assert isinstance(obj._network_interface[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._network_interface[0], type(obj._network_interface[0])))
            common.validate_format(obj._network_interface[0], "None", None, None)
        return obj

    def to_dict(self, dirty=False, belongs_to_parent=False):
        dct = super(NetworkInterfaceUtilDatapointStream, self).to_dict(dirty, belongs_to_parent)
