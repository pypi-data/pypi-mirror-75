    ...
    *(extends* :py:class:`v1_4_0.web.vo.ASESource` *)* A linked SAP ASE source.
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._load_backup_server_name[0] is not None and obj._load_backup_server_name[0] is not obj.__undef__:
            assert isinstance(obj._load_backup_server_name[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._load_backup_server_name[0], type(obj._load_backup_server_name[0])))
    ...
    def is_dirty(self):
        return any([self._load_backup_path[1], self._load_backup_server_name[1], self._staging_source[1], self._pre_script[1], self._external_file_path[1], self._monitor_location[1], self._post_script[1], self._config[1]])
