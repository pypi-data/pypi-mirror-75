    ...
    *(extends* :py:class:`v1_9_0.web.vo.TypedObject` *)* IP address assigned to
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._address_type[0] is not None and obj._address_type[0] is not obj.__undef__:
            assert isinstance(obj._address_type[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._address_type[0], type(obj._address_type[0])))
        ...
        if obj._enable_ssh[0] is not None and obj._enable_ssh[0] is not obj.__undef__:
            assert isinstance(obj._enable_ssh[0], bool), ("Expected one of [u'boolean'], but got %s of type %s" % (obj._enable_ssh[0], type(obj._enable_ssh[0])))
        ...
        if obj._session_in_use[0] is not None and obj._session_in_use[0] is not obj.__undef__:
            assert isinstance(obj._session_in_use[0], bool), ("Expected one of [u'boolean'], but got %s of type %s" % (obj._session_in_use[0], type(obj._session_in_use[0])))
