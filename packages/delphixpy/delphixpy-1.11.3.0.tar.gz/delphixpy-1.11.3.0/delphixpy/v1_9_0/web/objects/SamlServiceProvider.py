    ...
    *(extends* :py:class:`v1_9_0.web.vo.ReadonlyNamedUserObject` *)* SAML
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._signing_key[0] is not None and obj._signing_key[0] is not obj.__undef__:
            assert isinstance(obj._signing_key[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._signing_key[0], type(obj._signing_key[0])))
        ...
        if obj._issuer_id[0] is not None and obj._issuer_id[0] is not obj.__undef__:
            assert isinstance(obj._issuer_id[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._issuer_id[0], type(obj._issuer_id[0])))
        ...
        if obj._destination[0] is not None and obj._destination[0] is not obj.__undef__:
            assert isinstance(obj._destination[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._destination[0], type(obj._destination[0])))
        ...
        if obj._base_url[0] is not None and obj._base_url[0] is not obj.__undef__:
            assert isinstance(obj._base_url[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._base_url[0], type(obj._base_url[0])))
        ...
        if obj._decrypting_key[0] is not None and obj._decrypting_key[0] is not obj.__undef__:
            assert isinstance(obj._decrypting_key[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._decrypting_key[0], type(obj._decrypting_key[0])))
        ...
        if obj._entity_id[0] is not None and obj._entity_id[0] is not obj.__undef__:
            assert isinstance(obj._entity_id[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._entity_id[0], type(obj._entity_id[0])))
        ...
        if obj._hash_alg_url[0] is not None and obj._hash_alg_url[0] is not obj.__undef__:
            assert isinstance(obj._hash_alg_url[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._hash_alg_url[0], type(obj._hash_alg_url[0])))
