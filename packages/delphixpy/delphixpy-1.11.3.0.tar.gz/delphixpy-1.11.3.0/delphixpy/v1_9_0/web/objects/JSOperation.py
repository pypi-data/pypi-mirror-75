    ...
    *(extends* :py:class:`v1_9_0.web.vo.NamedUserObject` *)* An operation that
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._root_action[0] is not None and obj._root_action[0] is not obj.__undef__:
            assert isinstance(obj._root_action[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._root_action[0], type(obj._root_action[0])))
        ...
        if obj._force_option[0] is not None and obj._force_option[0] is not obj.__undef__:
            assert isinstance(obj._force_option[0], bool), ("Expected one of [u'boolean'], but got %s of type %s" % (obj._force_option[0], type(obj._force_option[0])))
        ...
        if obj._user[0] is not None and obj._user[0] is not obj.__undef__:
            assert isinstance(obj._user[0], TEXT_TYPE), ("Expected one of [u'string', u'null'], but got %s of type %s" % (obj._user[0], type(obj._user[0])))
    ...
    def is_dirty(self):
        return any([self._data_layout[1], self._data_parent[1], self._data_time[1], self._branch[1], self._bookmark[1], self._root_action[1], self._force_option[1], self._user[1], self._start_time[1], self._operation[1], self._end_time[1], self._description[1]])
