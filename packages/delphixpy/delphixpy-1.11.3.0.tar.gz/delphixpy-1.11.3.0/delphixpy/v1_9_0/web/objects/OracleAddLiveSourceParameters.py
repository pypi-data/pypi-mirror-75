...
class OracleAddLiveSourceParameters(AddLiveSourceParameters):
    ...
    *(extends* :py:class:`v1_9_0.web.vo.AddLiveSourceParameters` *)* The
    ...
    def to_dict(self, dirty=False, belongs_to_parent=False):
        dct = super(OracleAddLiveSourceParameters, self).to_dict(dirty, belongs_to_parent)
    ...
    def is_dirty(self):
        return any([self._username[1], self._source[1], self._credential[1], self._source_config[1]])
