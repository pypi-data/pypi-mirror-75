    ...
    *(extends* :py:class:`v1_9_0.web.vo.TypedObject` *)* The operating system
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._kernel[0] is not None and obj._kernel[0] is not obj.__undef__:
            assert isinstance(obj._kernel[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._kernel[0], type(obj._kernel[0])))
        ...
        if obj._release[0] is not None and obj._release[0] is not obj.__undef__:
            assert isinstance(obj._release[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._release[0], type(obj._release[0])))
        ...
        if obj._distribution[0] is not None and obj._distribution[0] is not obj.__undef__:
            assert isinstance(obj._distribution[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._distribution[0], type(obj._distribution[0])))
