...
def get_all(engine, namespace=None, page_offset=None, container=None, page_size=None):
    """
    ...
    :type namespace: ``TEXT_TYPE`` *or* ``null``
    ...
    query_params = {"container": container, "pageOffset": page_offset, "namespace": namespace, "pageSize": page_size}
