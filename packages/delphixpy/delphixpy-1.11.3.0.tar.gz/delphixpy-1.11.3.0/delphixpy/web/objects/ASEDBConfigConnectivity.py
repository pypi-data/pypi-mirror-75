...
class ASEDBConfigConnectivity(AbstractSourceConfigConnectivity):
    ...
    *)* Mechanism to test JDBC connectivity to ASE source configs.
    ...
    def __init__(self, undef_enabled=True):
        super(ASEDBConfigConnectivity, self).__init__()
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        obj = super(ASEDBConfigConnectivity, cls).from_dict(data, dirty, undef_enabled)
    ...
    def to_dict(self, dirty=False, belongs_to_parent=False):
        dct = super(ASEDBConfigConnectivity, self).to_dict(dirty, belongs_to_parent)
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ASEDBConfigConnectivity):
            return False
        return super(ASEDBConfigConnectivity, self).__eq__(other) and \
