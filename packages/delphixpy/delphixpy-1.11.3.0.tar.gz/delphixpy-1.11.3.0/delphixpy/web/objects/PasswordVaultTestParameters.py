...
class PasswordVaultTestParameters(TypedObject):
    ...
    *(extends* :py:class:`delphixpy.web.vo.TypedObject` *)* Password vault test
    ...
    def __init__(self, undef_enabled=True):
        super(PasswordVaultTestParameters, self).__init__()
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        obj = super(PasswordVaultTestParameters, cls).from_dict(data, dirty, undef_enabled)
        if "host" not in data:
    ...
    def to_dict(self, dirty=False, belongs_to_parent=False):
        dct = super(PasswordVaultTestParameters, self).to_dict(dirty, belongs_to_parent)
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PasswordVaultTestParameters):
            return False
        return super(PasswordVaultTestParameters, self).__eq__(other) and \
