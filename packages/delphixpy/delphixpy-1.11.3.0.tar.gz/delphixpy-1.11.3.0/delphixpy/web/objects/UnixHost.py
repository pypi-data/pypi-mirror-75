    ...
    *(extends* :py:class:`delphixpy.web.vo.Host` *)* The representation of a
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._oracle_jdbc_keystore_password[0] is not None and obj._oracle_jdbc_keystore_password[0] is not obj.__undef__:
            assert isinstance(obj._oracle_jdbc_keystore_password[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._oracle_jdbc_keystore_password[0], type(obj._oracle_jdbc_keystore_password[0])))
    ...
    def is_dirty(self):
        return any([self._oracle_jdbc_keystore_password[1], self._ssh_verification_strategy[1], self._toolkit_path[1]])
