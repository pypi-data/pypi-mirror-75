...
class DelphixDataServicesComponentInfo(TypedObject):
    """
    *(extends* :py:class:`delphixpy.web.vo.TypedObject` *)* Describes the
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._build_version[0] is not None and obj._build_version[0] is not obj.__undef__:
            assert isinstance(obj._build_version[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._build_version[0], type(obj._build_version[0])))
        ...
        if obj._status[0] is not None and obj._status[0] is not obj.__undef__:
            ...
            assert obj._status[0] in [u'REGISTERED', u'UNREGISTERED'], "Expected enum [u'REGISTERED', u'UNREGISTERED'] but got %s" % obj._status[0]
    ...
    def is_dirty(self):
        return any([self._build_version[1], self._status[1], self._build_timestamp[1]])
