    ...
    *(extends* :py:class:`delphixpy.web.vo.NamedUserObject` *)* An installed
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._status[0] is not None and obj._status[0] is not obj.__undef__:
            ...
            assert obj._status[0] in [u'ACTIVE', u'INACTIVE'], "Expected enum [u'ACTIVE', u'INACTIVE'] but got %s" % obj._status[0]
    ...
    def is_dirty(self):
        return any([self._status[1], self._snapshot_schema[1], self._name[1], self._language[1], self._root_squash_enabled[1], self._build_api[1], self._messages[1], self._host_types[1], self._version[1], self._default_locale[1], self._pretty_name[1]])
