...
def get_all(engine, status=None, to_date=None, page_offset=None, search_text=None, severity=None, page_size=None, ascending=None, from_date=None, sort_by=None, max_total=None, targets=None, target=None):
    """
    ...
    :type targets: ``list`` of ``TEXT_TYPE``
    ...
    query_params = {"status": status, "toDate": to_date, "pageOffset": page_offset, "searchText": search_text, "severity": severity, "pageSize": page_size, "ascending": ascending, "fromDate": from_date, "sortBy": sort_by, "maxTotal": max_total, "targets": targets, "target": target}
