...
def get_all(engine, targets=None, root_cause=None, bundle_id=None, severity=None, target=None):
    """
    ...
    query_params = {"rootCause": root_cause, "severity": severity, "target": target, "targets": targets, "bundleID": bundle_id}
