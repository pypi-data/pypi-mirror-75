    ...
    *(extends* :py:class:`v1_5_1.web.vo.TypedObject` *)* The representation of
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._port[0] is not None and obj._port[0] is not obj.__undef__:
            assert isinstance(obj._port[0], float), ("Expected one of [u'number'], but got %s of type %s" % (obj._port[0], type(obj._port[0])))
    ...
    def is_dirty(self):
        return any([self._port[1], self._name[1], self._address[1]])
