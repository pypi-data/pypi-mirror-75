    ...
    *(extends* :py:class:`v1_5_1.web.vo.TypedObject` *)* Summary authorization
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._owner_role[0] is not None and obj._owner_role[0] is not obj.__undef__:
            assert isinstance(obj._owner_role[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._owner_role[0], type(obj._owner_role[0])))
        ...
        if obj._auditor_role[0] is not None and obj._auditor_role[0] is not obj.__undef__:
            assert isinstance(obj._auditor_role[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._auditor_role[0], type(obj._auditor_role[0])))
        ...
        if obj._jet_stream_user_role[0] is not None and obj._jet_stream_user_role[0] is not obj.__undef__:
            assert isinstance(obj._jet_stream_user_role[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._jet_stream_user_role[0], type(obj._jet_stream_user_role[0])))
    ...
    def is_dirty(self):
        return any([self._owner_role[1], self._auditor_role[1], self._authorizations[1], self._jet_stream_user_role[1], self._user[1]])
