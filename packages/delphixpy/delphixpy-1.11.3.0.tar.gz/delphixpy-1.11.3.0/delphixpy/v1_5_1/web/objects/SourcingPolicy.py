    ...
    *(extends* :py:class:`v1_5_1.web.vo.TypedObject` *)* Database policies for
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._load_from_backup[0] is not None and obj._load_from_backup[0] is not obj.__undef__:
            assert isinstance(obj._load_from_backup[0], bool), ("Expected one of [u'boolean'], but got %s of type %s" % (obj._load_from_backup[0], type(obj._load_from_backup[0])))
        ...
        if obj._logsync_enabled[0] is not None and obj._logsync_enabled[0] is not obj.__undef__:
            assert isinstance(obj._logsync_enabled[0], bool), ("Expected one of [u'boolean'], but got %s of type %s" % (obj._logsync_enabled[0], type(obj._logsync_enabled[0])))
