...
class JSOperationEndpoint(TypedObject):
    """
    *(extends* :py:class:`v1_5_1.web.vo.TypedObject` *)* The first and last
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._last[0] is not None and obj._last[0] is not obj.__undef__:
            assert isinstance(obj._last[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._last[0], type(obj._last[0])))
        ...
        if obj._first[0] is not None and obj._first[0] is not obj.__undef__:
            assert isinstance(obj._first[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._first[0], type(obj._first[0])))
