    ...
    *(extends* :py:class:`v1_5_1.web.vo.IntegerConstraint` *)* Constraint
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._equals[0] is not None and obj._equals[0] is not obj.__undef__:
            assert isinstance(obj._equals[0], int), ("Expected one of [u'integer'], but got %s of type %s" % (obj._equals[0], type(obj._equals[0])))
            common.validate_format(obj._equals[0], "None", None, None)
        return obj

    def to_dict(self, dirty=False, belongs_to_parent=False):
        dct = super(IntegerEqualConstraint, self).to_dict(dirty, belongs_to_parent)
