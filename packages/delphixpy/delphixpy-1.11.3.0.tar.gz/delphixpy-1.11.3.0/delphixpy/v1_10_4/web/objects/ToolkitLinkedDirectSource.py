    ...
    *(extends* :py:class:`v1_10_4.web.vo.ToolkitLinkedSource` *)* A linked
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._uses_grandfathered_app_data_properties[0] is not None and obj._uses_grandfathered_app_data_properties[0] is not obj.__undef__:
            assert isinstance(obj._uses_grandfathered_app_data_properties[0], bool), ("Expected one of [u'boolean'], but got %s of type %s" % (obj._uses_grandfathered_app_data_properties[0], type(obj._uses_grandfathered_app_data_properties[0])))
