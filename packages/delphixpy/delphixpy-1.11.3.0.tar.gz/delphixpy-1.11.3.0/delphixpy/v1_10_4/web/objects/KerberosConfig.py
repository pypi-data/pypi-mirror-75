    ...
    *(extends* :py:class:`v1_10_4.web.vo.UserObject` *)* Kerberos Client
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._keytab[0] is not None and obj._keytab[0] is not obj.__undef__:
            assert isinstance(obj._keytab[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._keytab[0], type(obj._keytab[0])))
        ...
        if obj._realm[0] is not None and obj._realm[0] is not obj.__undef__:
            assert isinstance(obj._realm[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._realm[0], type(obj._realm[0])))
    ...
    def is_dirty(self):
        return any([self._keytab[1], self._kdcs[1], self._realm[1], self._enabled[1], self._principal[1]])
