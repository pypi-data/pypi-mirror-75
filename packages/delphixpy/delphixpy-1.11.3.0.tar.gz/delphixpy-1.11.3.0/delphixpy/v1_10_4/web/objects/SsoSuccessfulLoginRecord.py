...
class SsoSuccessfulLoginRecord(TypedObject):
    ...
    *(extends* :py:class:`v1_10_4.web.vo.TypedObject` *)* Represents a failed
    ...
    def __init__(self, undef_enabled=True):
        super(SsoSuccessfulLoginRecord, self).__init__()
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        obj = super(SsoSuccessfulLoginRecord, cls).from_dict(data, dirty, undef_enabled)
        ...
        if obj._email[0] is not None and obj._email[0] is not obj.__undef__:
            assert isinstance(obj._email[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._email[0], type(obj._email[0])))
        ...
        if obj._asserting_entity_id[0] is not None and obj._asserting_entity_id[0] is not obj.__undef__:
            assert isinstance(obj._asserting_entity_id[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._asserting_entity_id[0], type(obj._asserting_entity_id[0])))
    ...
    def to_dict(self, dirty=False, belongs_to_parent=False):
        dct = super(SsoSuccessfulLoginRecord, self).to_dict(dirty, belongs_to_parent)
        ...
        if "email" == "type" or (self.email is not self.__undef__ and (not (dirty and not self._email[1]) or isinstance(self.email, list) or belongs_to_parent)):
            dct["email"] = dictify(self.email)
        if "asserting_entity_id" == "type" or (self.asserting_entity_id is not self.__undef__ and (not (dirty and not self._asserting_entity_id[1]) or isinstance(self.asserting_entity_id, list) or belongs_to_parent)):
    ...
    def is_dirty(self):
        return any([self._user_agent[1], self._email[1], self._asserting_entity_id[1], self._origin_ip[1]])
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SsoSuccessfulLoginRecord):
            return False
        return super(SsoSuccessfulLoginRecord, self).__eq__(other) and \
               self.user_agent == other.user_agent and \
               self.email == other.email and \
               self.asserting_entity_id == other.asserting_entity_id and \
