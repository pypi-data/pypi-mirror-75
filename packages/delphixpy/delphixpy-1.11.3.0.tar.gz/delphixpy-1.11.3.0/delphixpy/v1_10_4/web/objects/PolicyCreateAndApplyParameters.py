...
class PolicyCreateAndApplyParameters(TypedObject):
    ...
    *(extends* :py:class:`v1_10_4.web.vo.TypedObject` *)* The parameters used
    ...
    def to_dict(self, dirty=False, belongs_to_parent=False):
        dct = super(PolicyCreateAndApplyParameters, self).to_dict(dirty, belongs_to_parent)
        ...
        def dictify(obj, prop_is_list_or_vo=False):
            if isinstance(obj, list):
                ...
                return obj
        if "policy" == "type" or (self.policy is not self.__undef__ and (not (dirty and not self._policy[1]) or isinstance(self.policy, list) or belongs_to_parent)):
