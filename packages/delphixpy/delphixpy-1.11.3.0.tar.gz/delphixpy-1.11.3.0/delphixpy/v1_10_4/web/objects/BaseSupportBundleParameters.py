    ...
    *(extends* :py:class:`v1_10_4.web.vo.TypedObject` *)* Parameters to be used
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._include_analytics_data[0] is not None and obj._include_analytics_data[0] is not obj.__undef__:
            assert isinstance(obj._include_analytics_data[0], bool), ("Expected one of [u'boolean'], but got %s of type %s" % (obj._include_analytics_data[0], type(obj._include_analytics_data[0])))
        ...
        if obj._bundle_type[0] is not None and obj._bundle_type[0] is not obj.__undef__:
            assert isinstance(obj._bundle_type[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._bundle_type[0], type(obj._bundle_type[0])))
            assert obj._bundle_type[0] in [u'PHONEHOME', u'MDS', u'OS', u'CORE', u'LOG', u'TOOLKIT_LOG', u'DROPBOX', u'STORAGE_TEST', u'MASKING', u'ALL'], "Expected enum [u'PHONEHOME', u'MDS', u'OS', u'CORE', u'LOG', u'TOOLKIT_LOG', u'DROPBOX', u'STORAGE_TEST', u'MASKING', u'ALL'] but got %s" % obj._bundle_type[0]
        ...
        if obj._toolkit[0] is not None and obj._toolkit[0] is not obj.__undef__:
            assert isinstance(obj._toolkit[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._toolkit[0], type(obj._toolkit[0])))
    ...
    def is_dirty(self):
        return any([self._include_analytics_data[1], self._sources[1], self._bundle_type[1], self._toolkit[1], self._environments[1]])
