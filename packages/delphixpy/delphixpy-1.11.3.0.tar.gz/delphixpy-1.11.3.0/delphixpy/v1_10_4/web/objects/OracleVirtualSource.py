...
class OracleVirtualSource(OracleManagedSource):
    ...
    *(extends* :py:class:`v1_10_4.web.vo.OracleManagedSource` *)* A virtual
    ...
    def is_dirty(self):
        return any([self._operations[1], self._redo_log_groups[1], self._file_mapping_rules[1], self._redo_log_size_in_mb[1], self._archivelog_mode[1], self._custom_env_vars[1], self._allow_auto_vdb_restart_on_host_reboot[1]])
