    ...
    *(extends* :py:class:`v1_10_4.web.vo.TypedObject` *)* Count of TimeFlow
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._count[0] is not None and obj._count[0] is not obj.__undef__:
            assert isinstance(obj._count[0], float), ("Expected one of [u'number'], but got %s of type %s" % (obj._count[0], type(obj._count[0])))
        ...
        if obj._date[0] is not None and obj._date[0] is not obj.__undef__:
            assert isinstance(obj._date[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._date[0], type(obj._date[0])))
        ...
        if obj._start_of_day[0] is not None and obj._start_of_day[0] is not obj.__undef__:
            assert isinstance(obj._start_of_day[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._start_of_day[0], type(obj._start_of_day[0])))
        ...
        if obj._end_of_day[0] is not None and obj._end_of_day[0] is not obj.__undef__:
            assert isinstance(obj._end_of_day[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._end_of_day[0], type(obj._end_of_day[0])))
