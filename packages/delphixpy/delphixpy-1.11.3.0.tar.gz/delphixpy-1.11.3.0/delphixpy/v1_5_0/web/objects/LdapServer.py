    ...
    *(extends* :py:class:`v1_5_0.web.vo.ReadonlyNamedUserObject` *)* LDAP
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._use_ssl[0] is not None and obj._use_ssl[0] is not obj.__undef__:
            assert isinstance(obj._use_ssl[0], bool), ("Expected one of [u'boolean'], but got %s of type %s" % (obj._use_ssl[0], type(obj._use_ssl[0])))
    ...
    def is_dirty(self):
        return any([self._use_ssl[1], self._host[1], self._auth_method[1], self._port[1]])
