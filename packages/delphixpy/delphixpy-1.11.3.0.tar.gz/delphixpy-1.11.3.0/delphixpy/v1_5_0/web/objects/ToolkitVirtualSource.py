    ...
    *(extends* :py:class:`v1_5_0.web.vo.TypedObject` *)* A virtual source
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._provision[0] is not None and obj._provision[0] is not obj.__undef__:
            assert isinstance(obj._provision[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._provision[0], type(obj._provision[0])))
        ...
        if obj._status_script[0] is not None and obj._status_script[0] is not obj.__undef__:
            assert isinstance(obj._status_script[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._status_script[0], type(obj._status_script[0])))
    ...
    def is_dirty(self):
        return any([self._parameters[1], self._start[1], self._stop[1], self._pre_snapshot[1], self._initialize[1], self._provision[1], self._post_snapshot[1], self._status_script[1]])
