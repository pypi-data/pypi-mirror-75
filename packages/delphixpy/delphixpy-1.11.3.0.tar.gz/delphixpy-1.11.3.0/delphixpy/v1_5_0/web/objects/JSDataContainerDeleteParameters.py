    ...
    *(extends* :py:class:`v1_5_0.web.vo.TypedObject` *)* The parameters used to
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._delete_data_sources[0] is not None and obj._delete_data_sources[0] is not obj.__undef__:
            assert isinstance(obj._delete_data_sources[0], bool), ("Expected one of [u'boolean'], but got %s of type %s" % (obj._delete_data_sources[0], type(obj._delete_data_sources[0])))
