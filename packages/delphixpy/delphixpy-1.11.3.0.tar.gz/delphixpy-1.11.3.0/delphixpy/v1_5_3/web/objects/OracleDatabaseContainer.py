    ...
    *(extends* :py:class:`v1_5_3.web.vo.DatabaseContainer` *)* Data container
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._content_type[0] is not None and obj._content_type[0] is not obj.__undef__:
            assert isinstance(obj._content_type[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._content_type[0], type(obj._content_type[0])))
            assert obj._content_type[0] in [u'PDB', u'CDB_ROOT', u'NON_CDB'], "Expected enum [u'PDB', u'CDB_ROOT', u'NON_CDB'] but got %s" % obj._content_type[0]
        ...
        if obj._physical_standby[0] is not None and obj._physical_standby[0] is not obj.__undef__:
            assert isinstance(obj._physical_standby[0], bool), ("Expected one of [u'boolean'], but got %s of type %s" % (obj._physical_standby[0], type(obj._physical_standby[0])))
        ...
        if obj._performance_mode[0] is not None and obj._performance_mode[0] is not obj.__undef__:
            assert isinstance(obj._performance_mode[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._performance_mode[0], type(obj._performance_mode[0])))
        ...
        if obj._endianness[0] is not None and obj._endianness[0] is not obj.__undef__:
            assert isinstance(obj._endianness[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._endianness[0], type(obj._endianness[0])))
        ...
        if obj._database_fraction[0] is not None and obj._database_fraction[0] is not obj.__undef__:
            assert isinstance(obj._database_fraction[0], bool), ("Expected one of [u'boolean'], but got %s of type %s" % (obj._database_fraction[0], type(obj._database_fraction[0])))
        ...
        if obj._cross_platform_ready[0] is not None and obj._cross_platform_ready[0] is not obj.__undef__:
            assert isinstance(obj._cross_platform_ready[0], bool), ("Expected one of [u'boolean'], but got %s of type %s" % (obj._cross_platform_ready[0], type(obj._cross_platform_ready[0])))
        ...
        if obj._live_source[0] is not None and obj._live_source[0] is not obj.__undef__:
            assert isinstance(obj._live_source[0], bool), ("Expected one of [u'boolean'], but got %s of type %s" % (obj._live_source[0], type(obj._live_source[0])))
    ...
    def is_dirty(self):
        return any([self._content_type[1], self._physical_standby[1], self._diagnose_no_logging_faults[1], self._sourcing_policy[1], self._performance_mode[1], self._endianness[1], self._pre_provisioning_enabled[1], self._database_fraction[1], self._runtime[1], self._cross_platform_ready[1], self._live_source[1]])
