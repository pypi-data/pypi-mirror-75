...
class AxisConstraint(TypedObject):
    ...
    *(extends* :py:class:`v1_5_3.web.vo.TypedObject` *)* Constraints placed on
    ...
    def to_dict(self, dirty=False, belongs_to_parent=False):
        dct = super(AxisConstraint, self).to_dict(dirty, belongs_to_parent)
        ...
        def dictify(obj, prop_is_list_or_vo=False):
            if isinstance(obj, list):
                ...
                return obj
        if "axis_name" == "type" or (self.axis_name is not self.__undef__ and (not (dirty and not self._axis_name[1]) or isinstance(self.axis_name, list) or belongs_to_parent)):
