    ...
    *(extends* :py:class:`v1_5_3.web.vo.NamedUserObject` *)* A node in a
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._cluster[0] is not None and obj._cluster[0] is not obj.__undef__:
            assert isinstance(obj._cluster[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._cluster[0], type(obj._cluster[0])))
    ...
    def to_dict(self, dirty=False, belongs_to_parent=False):
        dct = super(WindowsClusterNode, self).to_dict(dirty, belongs_to_parent)
