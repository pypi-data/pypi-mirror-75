...
class StatisticSlice(NamedUserObject):
    """
    *(extends* :py:class:`v1_5_3.web.vo.NamedUserObject` *)* Collects a slice
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._statistic_type[0] is not None and obj._statistic_type[0] is not obj.__undef__:
            assert isinstance(obj._statistic_type[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._statistic_type[0], type(obj._statistic_type[0])))
        ...
        if obj._collection_interval[0] is not None and obj._collection_interval[0] is not obj.__undef__:
            assert isinstance(obj._collection_interval[0], int), ("Expected one of [u'integer'], but got %s of type %s" % (obj._collection_interval[0], type(obj._collection_interval[0])))
    ...
    def is_dirty(self):
        return any([self._statistic_type[1], self._axis_constraints[1], self._state[1], self._collection_axes[1], self._collection_interval[1]])
    ...
    def axis_constraints(self):
        ...
        :rtype: ``list`` of :py:class:`v1_5_3.web.vo.AxisConstraint`
        """
