    ...
    *(extends* :py:class:`v1_11_1.web.vo.TypedObject` *)* Describes localized
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._impact[0] is not None and obj._impact[0] is not obj.__undef__:
            assert isinstance(obj._impact[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._impact[0], type(obj._impact[0])))
        ...
        if obj._unique_identifier[0] is not None and obj._unique_identifier[0] is not obj.__undef__:
            assert isinstance(obj._unique_identifier[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._unique_identifier[0], type(obj._unique_identifier[0])))
        ...
        if obj._output[0] is not None and obj._output[0] is not obj.__undef__:
            assert isinstance(obj._output[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._output[0], type(obj._output[0])))
    ...
    def is_dirty(self):
        return any([self._impact[1], self._unique_identifier[1], self._description[1], self._title[1], self._action[1], self._output[1], self._bundle_id[1], self._response[1], self._severity[1]])
    ...
    def __eq__(self, other):
        ...
        return super(LocalizedUpgradeCheckResult, self).__eq__(other) and \
               ...
               self.unique_identifier == other.unique_identifier and \
