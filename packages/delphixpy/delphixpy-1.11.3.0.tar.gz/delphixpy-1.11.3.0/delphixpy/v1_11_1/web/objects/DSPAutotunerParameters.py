...
class DSPAutotunerParameters(TypedObject):
    """
    *(extends* :py:class:`v1_11_1.web.vo.TypedObject` *)* Network information
    ...
    def is_dirty(self):
        return any([self._direction[1], self._remote_delphix_engine_info[1], self._remote_host[1], self._destination_type[1]])
