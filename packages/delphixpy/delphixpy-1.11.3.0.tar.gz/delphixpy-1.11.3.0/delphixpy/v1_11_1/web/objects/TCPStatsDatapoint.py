    ...
    *(extends* :py:class:`v1_11_1.web.vo.Datapoint` *)* An analytics datapoint
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._in_unordered_bytes[0] is not None and obj._in_unordered_bytes[0] is not obj.__undef__:
            assert isinstance(obj._in_unordered_bytes[0], int), ("Expected one of [u'integer'], but got %s of type %s" % (obj._in_unordered_bytes[0], type(obj._in_unordered_bytes[0])))
        ...
        if obj._retransmitted_bytes[0] is not None and obj._retransmitted_bytes[0] is not obj.__undef__:
            assert isinstance(obj._retransmitted_bytes[0], int), ("Expected one of [u'integer'], but got %s of type %s" % (obj._retransmitted_bytes[0], type(obj._retransmitted_bytes[0])))
        ...
        if obj._retransmitted_segs[0] is not None and obj._retransmitted_segs[0] is not obj.__undef__:
            assert isinstance(obj._retransmitted_segs[0], int), ("Expected one of [u'integer'], but got %s of type %s" % (obj._retransmitted_segs[0], type(obj._retransmitted_segs[0])))
        ...
        if obj._unsent_bytes[0] is not None and obj._unsent_bytes[0] is not obj.__undef__:
            assert isinstance(obj._unsent_bytes[0], int), ("Expected one of [u'integer'], but got %s of type %s" % (obj._unsent_bytes[0], type(obj._unsent_bytes[0])))
        ...
        if obj._in_bytes[0] is not None and obj._in_bytes[0] is not obj.__undef__:
            assert isinstance(obj._in_bytes[0], int), ("Expected one of [u'integer'], but got %s of type %s" % (obj._in_bytes[0], type(obj._in_bytes[0])))
        ...
        if obj._send_window_size[0] is not None and obj._send_window_size[0] is not obj.__undef__:
            assert isinstance(obj._send_window_size[0], int), ("Expected one of [u'integer'], but got %s of type %s" % (obj._send_window_size[0], type(obj._send_window_size[0])))
        ...
        if obj._round_trip_time[0] is not None and obj._round_trip_time[0] is not obj.__undef__:
            assert isinstance(obj._round_trip_time[0], int), ("Expected one of [u'integer'], but got %s of type %s" % (obj._round_trip_time[0], type(obj._round_trip_time[0])))
        ...
        if obj._receive_window_size[0] is not None and obj._receive_window_size[0] is not obj.__undef__:
            assert isinstance(obj._receive_window_size[0], int), ("Expected one of [u'integer'], but got %s of type %s" % (obj._receive_window_size[0], type(obj._receive_window_size[0])))
        ...
        if obj._unacknowledged_bytes[0] is not None and obj._unacknowledged_bytes[0] is not obj.__undef__:
            assert isinstance(obj._unacknowledged_bytes[0], int), ("Expected one of [u'integer'], but got %s of type %s" % (obj._unacknowledged_bytes[0], type(obj._unacknowledged_bytes[0])))
        ...
        if obj._congestion_window_size[0] is not None and obj._congestion_window_size[0] is not obj.__undef__:
            assert isinstance(obj._congestion_window_size[0], int), ("Expected one of [u'integer'], but got %s of type %s" % (obj._congestion_window_size[0], type(obj._congestion_window_size[0])))
        ...
        if obj._out_bytes[0] is not None and obj._out_bytes[0] is not obj.__undef__:
            assert isinstance(obj._out_bytes[0], int), ("Expected one of [u'integer'], but got %s of type %s" % (obj._out_bytes[0], type(obj._out_bytes[0])))
    ...
    def is_dirty(self):
        return any([self._in_unordered_bytes[1], self._retransmitted_bytes[1], self._retransmitted_segs[1], self._unsent_bytes[1], self._in_bytes[1], self._send_window_size[1], self._round_trip_time[1], self._receive_window_size[1], self._unacknowledged_bytes[1], self._congestion_window_size[1], self._out_bytes[1]])
