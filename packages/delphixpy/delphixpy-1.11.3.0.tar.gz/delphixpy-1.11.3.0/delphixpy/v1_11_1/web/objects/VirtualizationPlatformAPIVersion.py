...
class VirtualizationPlatformAPIVersion(TypedObject):
    ...
    *(extends* :py:class:`v1_11_1.web.vo.TypedObject` *)* A version of the
    ...
    def __init__(self, undef_enabled=True):
        super(VirtualizationPlatformAPIVersion, self).__init__()
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        obj = super(VirtualizationPlatformAPIVersion, cls).from_dict(data, dirty, undef_enabled)
    ...
    def to_dict(self, dirty=False, belongs_to_parent=False):
        dct = super(VirtualizationPlatformAPIVersion, self).to_dict(dirty, belongs_to_parent)
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, VirtualizationPlatformAPIVersion):
            return False
        return super(VirtualizationPlatformAPIVersion, self).__eq__(other) and \
