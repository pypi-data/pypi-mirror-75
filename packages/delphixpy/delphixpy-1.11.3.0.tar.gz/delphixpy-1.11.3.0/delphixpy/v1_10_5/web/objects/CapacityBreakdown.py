    ...
    *(extends* :py:class:`v1_10_5.web.vo.TypedObject` *)* Storage stats
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._manual_space[0] is not None and obj._manual_space[0] is not obj.__undef__:
            assert isinstance(obj._manual_space[0], float), ("Expected one of [u'number'], but got %s of type %s" % (obj._manual_space[0], type(obj._manual_space[0])))
        ...
        if obj._unvirtualized_space[0] is not None and obj._unvirtualized_space[0] is not obj.__undef__:
            assert isinstance(obj._unvirtualized_space[0], float), ("Expected one of [u'number'], but got %s of type %s" % (obj._unvirtualized_space[0], type(obj._unvirtualized_space[0])))
        ...
        if obj._active_space[0] is not None and obj._active_space[0] is not obj.__undef__:
            assert isinstance(obj._active_space[0], float), ("Expected one of [u'number'], but got %s of type %s" % (obj._active_space[0], type(obj._active_space[0])))
        ...
        if obj._policy_space[0] is not None and obj._policy_space[0] is not obj.__undef__:
            assert isinstance(obj._policy_space[0], float), ("Expected one of [u'number'], but got %s of type %s" % (obj._policy_space[0], type(obj._policy_space[0])))
        ...
        if obj._log_space[0] is not None and obj._log_space[0] is not obj.__undef__:
            assert isinstance(obj._log_space[0], float), ("Expected one of [u'number'], but got %s of type %s" % (obj._log_space[0], type(obj._log_space[0])))
        ...
        if obj._unowned_snapshot_space[0] is not None and obj._unowned_snapshot_space[0] is not obj.__undef__:
            assert isinstance(obj._unowned_snapshot_space[0], float), ("Expected one of [u'number'], but got %s of type %s" % (obj._unowned_snapshot_space[0], type(obj._unowned_snapshot_space[0])))
        ...
        if obj._timeflow_unvirtualized_space[0] is not None and obj._timeflow_unvirtualized_space[0] is not obj.__undef__:
            assert isinstance(obj._timeflow_unvirtualized_space[0], float), ("Expected one of [u'number'], but got %s of type %s" % (obj._timeflow_unvirtualized_space[0], type(obj._timeflow_unvirtualized_space[0])))
        ...
        if obj._fallback_ingested_size_timestamp[0] is not None and obj._fallback_ingested_size_timestamp[0] is not obj.__undef__:
            assert isinstance(obj._fallback_ingested_size_timestamp[0], TEXT_TYPE), ("Expected one of [u'string', u'null'], but got %s of type %s" % (obj._fallback_ingested_size_timestamp[0], type(obj._fallback_ingested_size_timestamp[0])))
        ...
        if obj._sync_space[0] is not None and obj._sync_space[0] is not obj.__undef__:
            assert isinstance(obj._sync_space[0], float), ("Expected one of [u'number'], but got %s of type %s" % (obj._sync_space[0], type(obj._sync_space[0])))
        ...
        if obj._descendant_space[0] is not None and obj._descendant_space[0] is not obj.__undef__:
            assert isinstance(obj._descendant_space[0], float), ("Expected one of [u'number'], but got %s of type %s" % (obj._descendant_space[0], type(obj._descendant_space[0])))
        ...
        if obj._ingested_size[0] is not None and obj._ingested_size[0] is not obj.__undef__:
            assert isinstance(obj._ingested_size[0], float), ("Expected one of [u'number'], but got %s of type %s" % (obj._ingested_size[0], type(obj._ingested_size[0])))
        ...
        if obj._actual_space[0] is not None and obj._actual_space[0] is not obj.__undef__:
            assert isinstance(obj._actual_space[0], float), ("Expected one of [u'number'], but got %s of type %s" % (obj._actual_space[0], type(obj._actual_space[0])))
    ...
    def is_dirty(self):
        return any([self._manual_space[1], self._unvirtualized_space[1], self._active_space[1], self._policy_space[1], self._log_space[1], self._unowned_snapshot_space[1], self._timeflow_unvirtualized_space[1], self._fallback_ingested_size_timestamp[1], self._sync_space[1], self._descendant_space[1], self._ingested_size[1], self._actual_space[1]])
