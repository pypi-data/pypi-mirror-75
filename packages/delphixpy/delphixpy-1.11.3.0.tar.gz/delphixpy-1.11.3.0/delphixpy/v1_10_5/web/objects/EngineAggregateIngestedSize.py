    ...
    *(extends* :py:class:`v1_10_5.web.vo.TypedObject` *)* Object which holds
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._aggregate_ingested_size[0] is not None and obj._aggregate_ingested_size[0] is not obj.__undef__:
            assert isinstance(obj._aggregate_ingested_size[0], float), ("Expected one of [u'number'], but got %s of type %s" % (obj._aggregate_ingested_size[0], type(obj._aggregate_ingested_size[0])))
