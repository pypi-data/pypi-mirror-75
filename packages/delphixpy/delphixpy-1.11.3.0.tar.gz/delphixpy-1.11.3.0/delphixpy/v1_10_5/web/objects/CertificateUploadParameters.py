    ...
    *(extends* :py:class:`v1_10_5.web.vo.TypedObject` *)* The parameters for
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._alias[0] is not None and obj._alias[0] is not obj.__undef__:
            assert isinstance(obj._alias[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._alias[0], type(obj._alias[0])))
        ...
        if obj._keystore_type[0] is not None and obj._keystore_type[0] is not obj.__undef__:
            assert isinstance(obj._keystore_type[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._keystore_type[0], type(obj._keystore_type[0])))
            assert obj._keystore_type[0] in [u'JKS', u'PKCS12'], "Expected enum [u'JKS', u'PKCS12'] but got %s" % obj._keystore_type[0]
        ...
        if obj._storepass[0] is not None and obj._storepass[0] is not obj.__undef__:
            assert isinstance(obj._storepass[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._storepass[0], type(obj._storepass[0])))
        ...
        if obj._keypass[0] is not None and obj._keypass[0] is not obj.__undef__:
            assert isinstance(obj._keypass[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._keypass[0], type(obj._keypass[0])))
    ...
    def is_dirty(self):
        return any([self._alias[1], self._keystore_type[1], self._storepass[1], self._keypass[1]])
    ...
    def __eq__(self, other):
        ...
        return super(CertificateUploadParameters, self).__eq__(other) and \
               ...
               self.keystore_type == other.keystore_type and \
               self.storepass == other.storepass and \
               self.keypass == other.keypass
