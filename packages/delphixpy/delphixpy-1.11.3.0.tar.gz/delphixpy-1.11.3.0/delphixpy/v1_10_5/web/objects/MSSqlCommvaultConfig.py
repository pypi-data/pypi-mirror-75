    ...
    *(extends* :py:class:`v1_10_5.web.vo.TypedObject` *)* MSSql Commvault
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._staging_client_name[0] is not None and obj._staging_client_name[0] is not obj.__undef__:
            assert isinstance(obj._staging_client_name[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._staging_client_name[0], type(obj._staging_client_name[0])))
        ...
        if obj._commserve_host_name[0] is not None and obj._commserve_host_name[0] is not obj.__undef__:
            assert isinstance(obj._commserve_host_name[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._commserve_host_name[0], type(obj._commserve_host_name[0])))
    ...
    def is_dirty(self):
        return any([self._config_params[1], self._staging_client_name[1], self._commserve_host_name[1], self._config_template[1], self._source_client_name[1]])
