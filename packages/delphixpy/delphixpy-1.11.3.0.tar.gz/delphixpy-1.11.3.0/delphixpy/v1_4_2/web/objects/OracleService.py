    ...
    *(extends* :py:class:`v1_4_2.web.vo.TypedObject` *)* The representation of
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._jdbc_connection_string[0] is not None and obj._jdbc_connection_string[0] is not obj.__undef__:
            assert isinstance(obj._jdbc_connection_string[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._jdbc_connection_string[0], type(obj._jdbc_connection_string[0])))
