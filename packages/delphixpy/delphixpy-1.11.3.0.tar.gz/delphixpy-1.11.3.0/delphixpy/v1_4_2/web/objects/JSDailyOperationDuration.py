    ...
    *(extends* :py:class:`v1_4_2.web.vo.JSUsageData` *)* Information about the
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._operation[0] is not None and obj._operation[0] is not obj.__undef__:
            ...
            assert obj._operation[0] in [u'REFRESH', u'RESET', u'CREATE_BRANCH', u'RESTORE'], "Expected enum [u'REFRESH', u'RESET', u'CREATE_BRANCH', u'RESTORE'] but got %s" % obj._operation[0]
