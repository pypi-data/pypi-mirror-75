    ...
    *(extends* :py:class:`v1_10_2.web.vo.TypedObject` *)* SAP ASE backup
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._backup_host[0] is not None and obj._backup_host[0] is not obj.__undef__:
            assert isinstance(obj._backup_host[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._backup_host[0], type(obj._backup_host[0])))
        ...
        if obj._backup_server_name[0] is not None and obj._backup_server_name[0] is not obj.__undef__:
            assert isinstance(obj._backup_server_name[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._backup_server_name[0], type(obj._backup_server_name[0])))
        ...
        if obj._backup_host_user[0] is not None and obj._backup_host_user[0] is not obj.__undef__:
            assert isinstance(obj._backup_host_user[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._backup_host_user[0], type(obj._backup_host_user[0])))
