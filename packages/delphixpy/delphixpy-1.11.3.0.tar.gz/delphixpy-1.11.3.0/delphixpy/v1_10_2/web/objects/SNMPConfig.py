    ...
    *(extends* :py:class:`v1_10_2.web.vo.TypedObject` *)* SNMP configuration.
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._authorized_network[0] is not None and obj._authorized_network[0] is not obj.__undef__:
            assert isinstance(obj._authorized_network[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._authorized_network[0], type(obj._authorized_network[0])))
        ...
        if obj._community[0] is not None and obj._community[0] is not obj.__undef__:
            assert isinstance(obj._community[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._community[0], type(obj._community[0])))
        ...
        if obj._location[0] is not None and obj._location[0] is not obj.__undef__:
            assert isinstance(obj._location[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._location[0], type(obj._location[0])))
    ...
    def is_dirty(self):
        return any([self._severity[1], self._enabled[1], self._authorized_network[1], self._community[1], self._location[1]])
