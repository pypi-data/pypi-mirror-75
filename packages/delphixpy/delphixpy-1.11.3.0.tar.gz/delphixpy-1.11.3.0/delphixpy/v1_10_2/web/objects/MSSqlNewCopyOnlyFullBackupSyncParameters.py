    ...
    *(extends* :py:class:`v1_10_2.web.vo.MSSqlSyncParameters` *)* The
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._backup_policy[0] is not None and obj._backup_policy[0] is not obj.__undef__:
            assert isinstance(obj._backup_policy[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._backup_policy[0], type(obj._backup_policy[0])))
            assert obj._backup_policy[0] in [u'PRIMARY', u'SECONDARY_ONLY', u'PREFER_SECONDARY'], "Expected enum [u'PRIMARY', u'SECONDARY_ONLY', u'PREFER_SECONDARY'] but got %s" % obj._backup_policy[0]
        ...
        if obj._compression_enabled[0] is not None and obj._compression_enabled[0] is not obj.__undef__:
            assert isinstance(obj._compression_enabled[0], bool), ("Expected one of [u'boolean'], but got %s of type %s" % (obj._compression_enabled[0], type(obj._compression_enabled[0])))
    ...
    def is_dirty(self):
        return any([self._backup_policy[1], self._compression_enabled[1]])
    ...
    def __eq__(self, other):
        ...
        return super(MSSqlNewCopyOnlyFullBackupSyncParameters, self).__eq__(other) and \
               self.backup_policy == other.backup_policy and \
