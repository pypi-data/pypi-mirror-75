    ...
    *(extends* :py:class:`v1_10_3.web.vo.TypedObject` *)* The .
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._new_mapping_memory[0] is not None and obj._new_mapping_memory[0] is not obj.__undef__:
            assert isinstance(obj._new_mapping_memory[0], float), ("Expected one of [u'number'], but got %s of type %s" % (obj._new_mapping_memory[0], type(obj._new_mapping_memory[0])))
        ...
        if obj._old_mapping_memory[0] is not None and obj._old_mapping_memory[0] is not obj.__undef__:
            assert isinstance(obj._old_mapping_memory[0], float), ("Expected one of [u'number'], but got %s of type %s" % (obj._old_mapping_memory[0], type(obj._old_mapping_memory[0])))
        ...
        if obj._old_free_bytes[0] is not None and obj._old_free_bytes[0] is not obj.__undef__:
            assert isinstance(obj._old_free_bytes[0], float), ("Expected one of [u'number'], but got %s of type %s" % (obj._old_free_bytes[0], type(obj._old_free_bytes[0])))
        ...
        if obj._new_free_bytes[0] is not None and obj._new_free_bytes[0] is not obj.__undef__:
            assert isinstance(obj._new_free_bytes[0], float), ("Expected one of [u'number'], but got %s of type %s" % (obj._new_free_bytes[0], type(obj._new_free_bytes[0])))
