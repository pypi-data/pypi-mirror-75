    ...
    *(extends* :py:class:`v1_10_3.web.vo.JSDataLayout` *)* A data template is a
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._confirm_time_consuming_operations[0] is not None and obj._confirm_time_consuming_operations[0] is not obj.__undef__:
            assert isinstance(obj._confirm_time_consuming_operations[0], bool), ("Expected one of [u'boolean'], but got %s of type %s" % (obj._confirm_time_consuming_operations[0], type(obj._confirm_time_consuming_operations[0])))
