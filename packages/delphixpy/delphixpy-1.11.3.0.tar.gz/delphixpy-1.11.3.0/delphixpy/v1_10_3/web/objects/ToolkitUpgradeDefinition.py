    ...
    *(extends* :py:class:`v1_10_3.web.vo.TypedObject` *)* The toolkit upgrade
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._upgrade_virtual_source[0] is not None and obj._upgrade_virtual_source[0] is not obj.__undef__:
            assert isinstance(obj._upgrade_virtual_source[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._upgrade_virtual_source[0], type(obj._upgrade_virtual_source[0])))
        ...
        if obj._upgrade_snapshot[0] is not None and obj._upgrade_snapshot[0] is not obj.__undef__:
            assert isinstance(obj._upgrade_snapshot[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._upgrade_snapshot[0], type(obj._upgrade_snapshot[0])))
        ...
        if obj._upgrade_manual_source_config[0] is not None and obj._upgrade_manual_source_config[0] is not obj.__undef__:
            assert isinstance(obj._upgrade_manual_source_config[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._upgrade_manual_source_config[0], type(obj._upgrade_manual_source_config[0])))
        ...
        if obj._upgrade_linked_source[0] is not None and obj._upgrade_linked_source[0] is not obj.__undef__:
            assert isinstance(obj._upgrade_linked_source[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._upgrade_linked_source[0], type(obj._upgrade_linked_source[0])))
        ...
        if obj._from_version[0] is not None and obj._from_version[0] is not obj.__undef__:
            assert isinstance(obj._from_version[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._from_version[0], type(obj._from_version[0])))
    ...
    def is_dirty(self):
        return any([self._upgrade_virtual_source[1], self._upgrade_snapshot[1], self._upgrade_manual_source_config[1], self._upgrade_linked_source[1], self._from_version[1]])
