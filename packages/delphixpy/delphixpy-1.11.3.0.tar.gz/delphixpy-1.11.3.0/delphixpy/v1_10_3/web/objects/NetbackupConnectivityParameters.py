...
class NetbackupConnectivityParameters(TypedObject):
    ...
    *(extends* :py:class:`v1_10_3.web.vo.TypedObject` *)* Parameters needed to
    ...
    def __init__(self, undef_enabled=True):
        super(NetbackupConnectivityParameters, self).__init__()
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        obj = super(NetbackupConnectivityParameters, cls).from_dict(data, dirty, undef_enabled)
        ...
        if obj._environment[0] is not None and obj._environment[0] is not obj.__undef__:
            assert isinstance(obj._environment[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._environment[0], type(obj._environment[0])))
        ...
        if obj._master_server_name[0] is not None and obj._master_server_name[0] is not obj.__undef__:
            assert isinstance(obj._master_server_name[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._master_server_name[0], type(obj._master_server_name[0])))
        ...
        if obj._source_client_name[0] is not None and obj._source_client_name[0] is not obj.__undef__:
            assert isinstance(obj._source_client_name[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._source_client_name[0], type(obj._source_client_name[0])))
            common.validate_format(obj._source_client_name[0], "None", None, None)
        return obj

    def to_dict(self, dirty=False, belongs_to_parent=False):
        dct = super(NetbackupConnectivityParameters, self).to_dict(dirty, belongs_to_parent)
        ...
        if "master_server_name" == "type" or (self.master_server_name is not self.__undef__ and (not (dirty and not self._master_server_name[1]) or isinstance(self.master_server_name, list) or belongs_to_parent)):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, NetbackupConnectivityParameters):
            return False
        return super(NetbackupConnectivityParameters, self).__eq__(other) and \
