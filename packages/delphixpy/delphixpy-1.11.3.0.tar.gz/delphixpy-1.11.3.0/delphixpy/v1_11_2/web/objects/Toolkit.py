...
class Toolkit(AbstractToolkit):
    ...
    *(extends* :py:class:`v1_11_2.web.vo.AbstractToolkit` *)* An installed Lua
    ...
    def is_dirty(self):
        return any([self._discovery_definition[1], self._virtual_source_definition[1], self._linked_source_definition[1], self._version[1], self._upgrade_definition[1], self._resources[1]])
