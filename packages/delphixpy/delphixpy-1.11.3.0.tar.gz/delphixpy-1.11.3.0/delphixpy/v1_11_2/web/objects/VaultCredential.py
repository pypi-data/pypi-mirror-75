    ...
    *(extends* :py:class:`v1_11_2.web.vo.Credential` *)* The password vault
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._vault_credential_id[0] is not None and obj._vault_credential_id[0] is not obj.__undef__:
            assert isinstance(obj._vault_credential_id[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._vault_credential_id[0], type(obj._vault_credential_id[0])))
