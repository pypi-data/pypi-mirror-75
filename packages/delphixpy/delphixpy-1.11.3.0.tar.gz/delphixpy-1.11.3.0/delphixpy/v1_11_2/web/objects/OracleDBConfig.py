    ...
    *(extends* :py:class:`v1_11_2.web.vo.OracleBaseDBConfig` *)* The source
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._tde_keystore_password[0] is not None and obj._tde_keystore_password[0] is not obj.__undef__:
            assert isinstance(obj._tde_keystore_password[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._tde_keystore_password[0], type(obj._tde_keystore_password[0])))
    ...
    def is_dirty(self):
        return any([self._repository[1], self._tde_keystore_password[1], self._cdb_type[1], self._unique_name[1], self._database_name[1]])
