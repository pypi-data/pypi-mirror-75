...
class AppDataSnapshot(TimeflowSnapshot):
    """
    *(extends* :py:class:`v1_11_2.web.vo.TimeflowSnapshot` *)* Snapshot of an
    AppData TimeFlow.
    """
    ...
    def is_dirty(self):
        return any([self._latest_change_point[1], self._runtime[1], self._first_change_point[1], self._toolkit[1], self._metadata[1]])
    ...
    def runtime(self):
        ...
        :rtype: :py:class:`v1_11_2.web.vo.AppDataSnapshotRuntime`
        """
