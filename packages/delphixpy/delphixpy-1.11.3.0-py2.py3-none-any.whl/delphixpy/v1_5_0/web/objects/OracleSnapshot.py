...
class OracleSnapshot(TimeflowSnapshot):
    ...
    *(extends* :py:class:`v1_5_0.web.vo.TimeflowSnapshot` *)* Provisionable
    ...
    def is_dirty(self):
        return any([self._from_physical_standby_vdb[1], self._latest_change_point[1], self._runtime[1], self._first_change_point[1]])
    ...
    def __eq__(self, other):
        ...
        return super(OracleSnapshot, self).__eq__(other) and \
               ...
               self.first_change_point == other.first_change_point
