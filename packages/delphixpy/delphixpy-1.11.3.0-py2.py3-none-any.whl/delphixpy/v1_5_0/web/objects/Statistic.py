...
class Statistic(TypedObject):
    """
    *(extends* :py:class:`v1_5_0.web.vo.TypedObject` *)* Multidimensional
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._min_collection_interval[0] is not None and obj._min_collection_interval[0] is not obj.__undef__:
            assert isinstance(obj._min_collection_interval[0], int), ("Expected one of [u'integer'], but got %s of type %s" % (obj._min_collection_interval[0], type(obj._min_collection_interval[0])))
    ...
    def is_dirty(self):
        return any([self._statistic_type[1], self._explanation[1], self._axes[1], self._min_collection_interval[1]])
