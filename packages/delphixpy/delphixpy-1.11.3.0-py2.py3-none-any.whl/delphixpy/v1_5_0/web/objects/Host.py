    ...
    *(extends* :py:class:`v1_5_0.web.vo.ReadonlyNamedUserObject` *)* The
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._toolkit_path[0] is not None and obj._toolkit_path[0] is not obj.__undef__:
            assert isinstance(obj._toolkit_path[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._toolkit_path[0], type(obj._toolkit_path[0])))
    ...
    def is_dirty(self):
        return any([self._host_configuration[1], self._date_added[1], self._privilege_elevation_profile[1], self._enabled[1], self._host_runtime[1], self._address[1], self._ssh_port[1], self._toolkit_path[1]])
