    ...
    *(extends* :py:class:`v1_5_0.web.vo.Operation` *)* A user-specifiable
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._variables[0] is not None and obj._variables[0] is not obj.__undef__:
            assert isinstance(obj._variables[0], dict), ("Expected one of [u'object'], but got %s of type %s" % (obj._variables[0], type(obj._variables[0])))
        ...
        if obj._command[0] is not None and obj._command[0] is not obj.__undef__:
            assert isinstance(obj._command[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._command[0], type(obj._command[0])))
    ...
    def to_dict(self, dirty=False, belongs_to_parent=False):
        dct = super(RunCommandOperation, self).to_dict(dirty, belongs_to_parent)
    ...
    def is_dirty(self):
        return any([self._environment[1], self._variables[1], self._host[1], self._command[1], self._user[1]])
