...
class Toolkit(AbstractToolkit):
    ...
    *(extends* :py:class:`v1_10_6.web.vo.AbstractToolkit` *)* An installed Lua
    ...
    def is_dirty(self):
        return any([self._upgrade_definition[1], self._linked_source_definition[1], self._virtual_source_definition[1], self._discovery_definition[1], self._resources[1]])
