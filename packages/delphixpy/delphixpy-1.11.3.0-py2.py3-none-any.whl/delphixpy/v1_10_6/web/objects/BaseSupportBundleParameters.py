    ...
    *(extends* :py:class:`v1_10_6.web.vo.TypedObject` *)* Parameters to be used
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._bundle_type[0] is not None and obj._bundle_type[0] is not obj.__undef__:
            ...
            assert obj._bundle_type[0] in [u'PHONEHOME', u'MDS', u'OS', u'CORE', u'LOG', u'PLUGIN_LOG', u'DROPBOX', u'STORAGE_TEST', u'MASKING', u'ALL'], "Expected enum [u'PHONEHOME', u'MDS', u'OS', u'CORE', u'LOG', u'PLUGIN_LOG', u'DROPBOX', u'STORAGE_TEST', u'MASKING', u'ALL'] but got %s" % obj._bundle_type[0]
        ...
        if obj._plugin[0] is not None and obj._plugin[0] is not obj.__undef__:
            assert isinstance(obj._plugin[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._plugin[0], type(obj._plugin[0])))
    ...
    def is_dirty(self):
        return any([self._include_analytics_data[1], self._sources[1], self._bundle_type[1], self._environments[1], self._plugin[1]])
