...
class StagingSourceOperations(TypedObject):
    ...
    *(extends* :py:class:`v1_10_6.web.vo.TypedObject` *)* Describes operations
    ...
    def is_dirty(self):
        return any([self._post_validated_sync[1], self._pre_validated_sync[1]])
    ...
    def __eq__(self, other):
        ...
        return super(StagingSourceOperations, self).__eq__(other) and \
               self.post_validated_sync == other.post_validated_sync and \
               self.pre_validated_sync == other.pre_validated_sync
