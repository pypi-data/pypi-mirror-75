    ...
    *(extends* :py:class:`v1_10_6.web.vo.SourceConfig` *)* Configuration
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._recovery_model[0] is not None and obj._recovery_model[0] is not obj.__undef__:
            assert isinstance(obj._recovery_model[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._recovery_model[0], type(obj._recovery_model[0])))
        ...
        if obj._repository[0] is not None and obj._repository[0] is not obj.__undef__:
            assert isinstance(obj._repository[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._repository[0], type(obj._repository[0])))
        ...
        if obj._mirroring_state[0] is not None and obj._mirroring_state[0] is not obj.__undef__:
            assert isinstance(obj._mirroring_state[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._mirroring_state[0], type(obj._mirroring_state[0])))
            assert obj._mirroring_state[0] in [u'SUSPENDED', u'DISCONNECTED', u'SYNCHRONIZING', u'PENDING_FAILOVER', u'SYNCHRONIZED', u'NOT_SYNCHRONIZED', u'FAILOVER_POSSIBLE', u'NONE'], "Expected enum [u'SUSPENDED', u'DISCONNECTED', u'SYNCHRONIZING', u'PENDING_FAILOVER', u'SYNCHRONIZED', u'NOT_SYNCHRONIZED', u'FAILOVER_POSSIBLE', u'NONE'] but got %s" % obj._mirroring_state[0]
        ...
        if obj._database_name[0] is not None and obj._database_name[0] is not obj.__undef__:
            assert isinstance(obj._database_name[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._database_name[0], type(obj._database_name[0])))
    ...
    def to_dict(self, dirty=False, belongs_to_parent=False):
        dct = super(MSSqlDBConfig, self).to_dict(dirty, belongs_to_parent)
        ...
        if "mirroring_state" == "type" or (self.mirroring_state is not self.__undef__ and (not (dirty and not self._mirroring_state[1]) or isinstance(self.mirroring_state, list) or belongs_to_parent)):
    ...
    def is_dirty(self):
        return any([self._recovery_model[1], self._repository[1], self._mirroring_state[1], self._user[1], self._database_name[1], self._credentials[1]])
