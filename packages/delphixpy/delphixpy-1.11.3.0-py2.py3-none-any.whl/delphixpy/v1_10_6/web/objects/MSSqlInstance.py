    ...
    *(extends* :py:class:`v1_10_6.web.vo.MSSqlRepository` *)* A SQL Server
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._server_name[0] is not None and obj._server_name[0] is not obj.__undef__:
            assert isinstance(obj._server_name[0], TEXT_TYPE), ("Expected one of [u'string', u'null'], but got %s of type %s" % (obj._server_name[0], type(obj._server_name[0])))
    ...
    def is_dirty(self):
        return any([self._installation_path[1], self._server_name[1], self._discovered[1], self._version[1], self._instance_owner[1], self._instance_name[1], self._port[1]])
