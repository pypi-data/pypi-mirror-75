    ...
    *(extends* :py:class:`v1_10_6.web.vo.TypedObject` *)* Parameters used for
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._default_email[0] is not None and obj._default_email[0] is not obj.__undef__:
            assert isinstance(obj._default_email[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._default_email[0], type(obj._default_email[0])))
    ...
    def is_dirty(self):
        return any([self._default_email[1], self._default_user[1], self._devices[1], self._default_password[1]])
