    ...
    *(extends* :py:class:`v1_10_6.web.vo.TypedObject` *)* This represents a
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._drive_letter[0] is not None and obj._drive_letter[0] is not obj.__undef__:
            assert isinstance(obj._drive_letter[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._drive_letter[0], type(obj._drive_letter[0])))
        ...
        if obj._label[0] is not None and obj._label[0] is not obj.__undef__:
            assert isinstance(obj._label[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._label[0], type(obj._label[0])))
