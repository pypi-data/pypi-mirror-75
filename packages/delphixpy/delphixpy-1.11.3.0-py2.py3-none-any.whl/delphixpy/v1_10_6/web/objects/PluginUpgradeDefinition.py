...
class PluginUpgradeDefinition(TypedObject):
    ...
    *(extends* :py:class:`v1_10_6.web.vo.TypedObject` *)* The plugin upgrade
    ...
    def __init__(self, undef_enabled=True):
        super(PluginUpgradeDefinition, self).__init__()
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        obj = super(PluginUpgradeDefinition, cls).from_dict(data, dirty, undef_enabled)
    ...
    def to_dict(self, dirty=False, belongs_to_parent=False):
        dct = super(PluginUpgradeDefinition, self).to_dict(dirty, belongs_to_parent)
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PluginUpgradeDefinition):
            return False
        return super(PluginUpgradeDefinition, self).__eq__(other) and \
