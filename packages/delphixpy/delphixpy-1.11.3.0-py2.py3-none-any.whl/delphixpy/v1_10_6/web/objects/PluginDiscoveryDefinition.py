...
class PluginDiscoveryDefinition(TypedObject):
    ...
    *(extends* :py:class:`v1_10_6.web.vo.TypedObject` *)* Defines the discovery
    ...
    def __init__(self, undef_enabled=True):
        super(PluginDiscoveryDefinition, self).__init__()
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        obj = super(PluginDiscoveryDefinition, cls).from_dict(data, dirty, undef_enabled)
    ...
    def to_dict(self, dirty=False, belongs_to_parent=False):
        dct = super(PluginDiscoveryDefinition, self).to_dict(dirty, belongs_to_parent)
    ...
    def is_dirty(self):
        return any([self._manual_source_config_discovery[1], self._source_config_name_field[1], self._repository_identity_fields[1], self._repository_schema[1], self._repository_name_field[1], self._source_config_schema[1], self._source_config_identity_fields[1]])
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PluginDiscoveryDefinition):
            return False
        return super(PluginDiscoveryDefinition, self).__eq__(other) and \
