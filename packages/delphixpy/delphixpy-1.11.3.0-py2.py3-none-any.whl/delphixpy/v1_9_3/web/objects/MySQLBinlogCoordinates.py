    ...
    *(extends* :py:class:`v1_9_3.web.vo.MySQLReplicationCoordinates` *)* The
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._master_log_name[0] is not None and obj._master_log_name[0] is not obj.__undef__:
            assert isinstance(obj._master_log_name[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._master_log_name[0], type(obj._master_log_name[0])))
        ...
        if obj._master_log_pos[0] is not None and obj._master_log_pos[0] is not obj.__undef__:
            assert isinstance(obj._master_log_pos[0], int), ("Expected one of [u'integer'], but got %s of type %s" % (obj._master_log_pos[0], type(obj._master_log_pos[0])))
