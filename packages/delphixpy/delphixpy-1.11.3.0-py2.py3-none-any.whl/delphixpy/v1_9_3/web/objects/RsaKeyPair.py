    ...
    *(extends* :py:class:`v1_9_3.web.vo.KeyPair` *)* A key pair generated using
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._signature_algorithm[0] is not None and obj._signature_algorithm[0] is not obj.__undef__:
            ...
            assert obj._signature_algorithm[0] in [u'SHA256withRSA', u'SHA384withRSA', u'SHA512withRSA'], "Expected enum [u'SHA256withRSA', u'SHA384withRSA', u'SHA512withRSA'] but got %s" % obj._signature_algorithm[0]
