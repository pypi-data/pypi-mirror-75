    ...
    *(extends* :py:class:`v1_9_3.web.vo.BaseConsumerCapacityData` *)* Current
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._storage_container[0] is not None and obj._storage_container[0] is not obj.__undef__:
            assert isinstance(obj._storage_container[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._storage_container[0], type(obj._storage_container[0])))
            common.validate_format(obj._storage_container[0], "None", None, None)
        return obj

    def to_dict(self, dirty=False, belongs_to_parent=False):
        dct = super(CurrentConsumerCapacityData, self).to_dict(dirty, belongs_to_parent)
