    ...
    *(extends* :py:class:`v1_9_3.web.vo.BooleanConstraint` *)* Constraints
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._equals[0] is not None and obj._equals[0] is not obj.__undef__:
            assert isinstance(obj._equals[0], bool), ("Expected one of [u'boolean'], but got %s of type %s" % (obj._equals[0], type(obj._equals[0])))
            common.validate_format(obj._equals[0], "None", None, None)
        return obj

    def to_dict(self, dirty=False, belongs_to_parent=False):
        dct = super(BooleanEqualConstraint, self).to_dict(dirty, belongs_to_parent)
