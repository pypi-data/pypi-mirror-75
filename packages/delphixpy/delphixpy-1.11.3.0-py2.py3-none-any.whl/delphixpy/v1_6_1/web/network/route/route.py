...
def get_all(engine):
    ...
    :rtype: ``list`` of :py:class:`v1_6_1.web.vo.NetworkRoute`
    """
...
def add(engine, network_route=None):
    ...
    :type network_route: :py:class:`v1_6_1.web.vo.NetworkRoute`
    """
    assert API_VERSION == engine.API_VERSION, "Wrong API version (%s) for parameter 'engine' (%s)" % (API_VERSION, engine.API_VERSION)
...
def lookup(engine, network_route_lookup_parameters):
    ...
    :type network_route_lookup_parameters:
        :py:class:`v1_6_1.web.vo.NetworkRouteLookupParameters`
    :rtype: :py:class:`v1_6_1.web.vo.NetworkRoute`
    """
    assert API_VERSION == engine.API_VERSION, "Wrong API version (%s) for parameter 'engine' (%s)" % (API_VERSION, engine.API_VERSION)
