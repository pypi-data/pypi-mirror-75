    ...
    *(extends* :py:class:`v1_6_1.web.vo.TypedObject` *)* Retrieve static
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        for item in data.get("enabledFeatures") or []:
            ...
            assert item in [u'XPP', u'CONSPRO', u'NUCARD', u'REGISTRATIONREQUIRED', u'PHONEHOMEREQUIRED', u'MSSQLHOOKS'], "Expected enum [u'XPP', u'CONSPRO', u'NUCARD', u'REGISTRATIONREQUIRED', u'PHONEHOMEREQUIRED', u'MSSQLHOOKS'] but got %s" % item
