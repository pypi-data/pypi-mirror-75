    ...
    *(extends* :py:class:`v1_6_1.web.vo.UserObject` *)* Replication setup.
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._schedule[0] is not None and obj._schedule[0] is not obj.__undef__:
            assert isinstance(obj._schedule[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._schedule[0], type(obj._schedule[0])))
        ...
        if obj._compressed[0] is not None and obj._compressed[0] is not obj.__undef__:
            assert isinstance(obj._compressed[0], bool), ("Expected one of [u'boolean'], but got %s of type %s" % (obj._compressed[0], type(obj._compressed[0])))
    ...
    def is_dirty(self):
        return any([self._target_host[1], self._object_specification[1], self._number_of_connections[1], self._description[1], self._schedule[1], self._encrypted[1], self._target_port[1], self._enabled[1], self._tag[1], self._compressed[1], self._use_system_socks_setting[1], self._target_principal[1], self._target_credential[1], self._runtime[1], self._bandwidth_limit[1]])
