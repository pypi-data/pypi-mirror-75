...
class Alert(PersistentObject):
    """
    *(extends* :py:class:`v1_6_1.web.vo.PersistentObject` *)* An alert
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._event_response[0] is not None and obj._event_response[0] is not obj.__undef__:
            assert isinstance(obj._event_response[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._event_response[0], type(obj._event_response[0])))
        ...
        if obj._event_title[0] is not None and obj._event_title[0] is not obj.__undef__:
            assert isinstance(obj._event_title[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._event_title[0], type(obj._event_title[0])))
        ...
        if obj._event_description[0] is not None and obj._event_description[0] is not obj.__undef__:
            assert isinstance(obj._event_description[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._event_description[0], type(obj._event_description[0])))
        ...
        if obj._event_severity[0] is not None and obj._event_severity[0] is not obj.__undef__:
            assert isinstance(obj._event_severity[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._event_severity[0], type(obj._event_severity[0])))
        ...
        if obj._event_command_output[0] is not None and obj._event_command_output[0] is not obj.__undef__:
            assert isinstance(obj._event_command_output[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._event_command_output[0], type(obj._event_command_output[0])))
        ...
        if obj._event_action[0] is not None and obj._event_action[0] is not obj.__undef__:
            assert isinstance(obj._event_action[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._event_action[0], type(obj._event_action[0])))
        ...
        if obj._event[0] is not None and obj._event[0] is not obj.__undef__:
            assert isinstance(obj._event[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._event[0], type(obj._event[0])))
