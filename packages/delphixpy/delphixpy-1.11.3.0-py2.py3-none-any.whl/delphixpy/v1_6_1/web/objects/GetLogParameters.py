    ...
    *(extends* :py:class:`v1_6_1.web.vo.TypedObject` *)* The parameters to use
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._log_type[0] is not None and obj._log_type[0] is not obj.__undef__:
            assert isinstance(obj._log_type[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._log_type[0], type(obj._log_type[0])))
        ...
        if obj._log_number[0] is not None and obj._log_number[0] is not obj.__undef__:
            assert isinstance(obj._log_number[0], int), ("Expected one of [u'integer'], but got %s of type %s" % (obj._log_number[0], type(obj._log_number[0])))
            common.validate_format(obj._log_number[0], "None", None, None)
        return obj

    def to_dict(self, dirty=False, belongs_to_parent=False):
        dct = super(GetLogParameters, self).to_dict(dirty, belongs_to_parent)
        ...
        def dictify(obj, prop_is_list_or_vo=False):
            if isinstance(obj, list):
                ...
                return obj
        if "log_type" == "type" or (self.log_type is not self.__undef__ and (not (dirty and not self._log_type[1]) or isinstance(self.log_type, list) or belongs_to_parent)):
            dct["logType"] = dictify(self.log_type)
        elif belongs_to_parent and self.log_type is self.__undef__:
            dct["logType"] = "debug"
        if "log_number" == "type" or (self.log_number is not self.__undef__ and (not (dirty and not self._log_number[1]) or isinstance(self.log_number, list) or belongs_to_parent)):
