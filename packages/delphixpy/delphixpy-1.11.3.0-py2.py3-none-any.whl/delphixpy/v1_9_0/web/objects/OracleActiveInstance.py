    ...
    *(extends* :py:class:`v1_9_0.web.vo.TypedObject` *)* Active instance
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._instance_number[0] is not None and obj._instance_number[0] is not obj.__undef__:
            assert isinstance(obj._instance_number[0], int), ("Expected one of [u'integer'], but got %s of type %s" % (obj._instance_number[0], type(obj._instance_number[0])))
        ...
        if obj._host_name[0] is not None and obj._host_name[0] is not obj.__undef__:
            assert isinstance(obj._host_name[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._host_name[0], type(obj._host_name[0])))
