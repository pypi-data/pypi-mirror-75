    ...
    *(extends* :py:class:`v1_9_0.web.vo.Datapoint` *)* An analytics datapoint
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._out_packets[0] is not None and obj._out_packets[0] is not obj.__undef__:
            assert isinstance(obj._out_packets[0], int), ("Expected one of [u'integer'], but got %s of type %s" % (obj._out_packets[0], type(obj._out_packets[0])))
        ...
        if obj._in_packets[0] is not None and obj._in_packets[0] is not obj.__undef__:
            assert isinstance(obj._in_packets[0], int), ("Expected one of [u'integer'], but got %s of type %s" % (obj._in_packets[0], type(obj._in_packets[0])))
    ...
    def is_dirty(self):
        return any([self._out_packets[1], self._in_bytes[1], self._out_bytes[1], self._in_packets[1]])
