    ...
    *(extends* :py:class:`v1_9_0.web.vo.TypedObject` *)* A virtual source
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._configure[0] is not None and obj._configure[0] is not obj.__undef__:
            assert isinstance(obj._configure[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._configure[0], type(obj._configure[0])))
        ...
        if obj._stop[0] is not None and obj._stop[0] is not obj.__undef__:
            assert isinstance(obj._stop[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._stop[0], type(obj._stop[0])))
        ...
        if obj._start[0] is not None and obj._start[0] is not obj.__undef__:
            assert isinstance(obj._start[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._start[0], type(obj._start[0])))
        ...
        if obj._unconfigure[0] is not None and obj._unconfigure[0] is not obj.__undef__:
            assert isinstance(obj._unconfigure[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._unconfigure[0], type(obj._unconfigure[0])))
        ...
        if obj._reconfigure[0] is not None and obj._reconfigure[0] is not obj.__undef__:
            assert isinstance(obj._reconfigure[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._reconfigure[0], type(obj._reconfigure[0])))
        ...
        if obj._initialize[0] is not None and obj._initialize[0] is not obj.__undef__:
            assert isinstance(obj._initialize[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._initialize[0], type(obj._initialize[0])))
        ...
        if obj._mount_spec[0] is not None and obj._mount_spec[0] is not obj.__undef__:
            assert isinstance(obj._mount_spec[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._mount_spec[0], type(obj._mount_spec[0])))
        ...
        if obj._post_snapshot[0] is not None and obj._post_snapshot[0] is not obj.__undef__:
            assert isinstance(obj._post_snapshot[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._post_snapshot[0], type(obj._post_snapshot[0])))
        ...
        if obj._pre_snapshot[0] is not None and obj._pre_snapshot[0] is not obj.__undef__:
            assert isinstance(obj._pre_snapshot[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._pre_snapshot[0], type(obj._pre_snapshot[0])))
    ...
    def is_dirty(self):
        return any([self._status[1], self._configure[1], self._parameters[1], self._stop[1], self._start[1], self._unconfigure[1], self._reconfigure[1], self._initialize[1], self._mount_spec[1], self._post_snapshot[1], self._pre_snapshot[1]])
