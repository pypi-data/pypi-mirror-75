    ...
    *(extends* :py:class:`v1_10_5.web.vo.NamedUserObject` *)* Parameter
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._parameters[0] is not None and obj._parameters[0] is not obj.__undef__:
            assert isinstance(obj._parameters[0], dict), ("Expected one of [u'object'], but got %s of type %s" % (obj._parameters[0], type(obj._parameters[0])))
        ...
        if obj._source_type[0] is not None and obj._source_type[0] is not obj.__undef__:
            assert isinstance(obj._source_type[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._source_type[0], type(obj._source_type[0])))
            assert obj._source_type[0] in [u'MySQLVirtualSource', u'OracleVirtualSource', u'MSSqlVirtualSource', u'MSSqlLinkedSource', u'PgSQLVirtualSource'], "Expected enum [u'MySQLVirtualSource', u'OracleVirtualSource', u'MSSqlVirtualSource', u'MSSqlLinkedSource', u'PgSQLVirtualSource'] but got %s" % obj._source_type[0]
