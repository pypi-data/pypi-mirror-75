    ...
    *(extends* :py:class:`v1_10_5.web.vo.KeyPair` *)* A key pair generated
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._key_size[0] is not None and obj._key_size[0] is not obj.__undef__:
            assert isinstance(obj._key_size[0], int), ("Expected one of [u'integer'], but got %s of type %s" % (obj._key_size[0], type(obj._key_size[0])))
        ...
        if obj._signature_algorithm[0] is not None and obj._signature_algorithm[0] is not obj.__undef__:
            assert isinstance(obj._signature_algorithm[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._signature_algorithm[0], type(obj._signature_algorithm[0])))
            assert obj._signature_algorithm[0] in [u'SHA256withECDSA', u'SHA384withECDSA', u'SHA512withECDSA'], "Expected enum [u'SHA256withECDSA', u'SHA384withECDSA', u'SHA512withECDSA'] but got %s" % obj._signature_algorithm[0]
