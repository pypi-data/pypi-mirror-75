...
class SNMPManager(PersistentObject):
    """
    *(extends* :py:class:`v1_10_5.web.vo.PersistentObject` *)* SNMP manager
    configuration.
    """
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._use_inform[0] is not None and obj._use_inform[0] is not obj.__undef__:
            assert isinstance(obj._use_inform[0], bool), ("Expected one of [u'boolean'], but got %s of type %s" % (obj._use_inform[0], type(obj._use_inform[0])))
        ...
        if obj._community_string[0] is not None and obj._community_string[0] is not obj.__undef__:
            assert isinstance(obj._community_string[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._community_string[0], type(obj._community_string[0])))
        ...
        if obj._last_send_status[0] is not None and obj._last_send_status[0] is not obj.__undef__:
            assert isinstance(obj._last_send_status[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._last_send_status[0], type(obj._last_send_status[0])))
    ...
    def to_dict(self, dirty=False, belongs_to_parent=False):
        dct = super(SNMPManager, self).to_dict(dirty, belongs_to_parent)
    ...
    def is_dirty(self):
        return any([self._use_inform[1], self._community_string[1], self._port[1], self._last_send_status[1], self._address[1]])
