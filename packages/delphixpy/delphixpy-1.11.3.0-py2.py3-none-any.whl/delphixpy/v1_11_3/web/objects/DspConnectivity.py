...
class DspConnectivity(TypedObject):
    """
    *(extends* :py:class:`v1_11_3.web.vo.TypedObject` *)* Mechanism to stress
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._number_of_threads[0] is not None and obj._number_of_threads[0] is not obj.__undef__:
            assert isinstance(obj._number_of_threads[0], int), ("Expected one of [u'integer'], but got %s of type %s" % (obj._number_of_threads[0], type(obj._number_of_threads[0])))
        ...
        if obj._number_of_consecutive_connections[0] is not None and obj._number_of_consecutive_connections[0] is not obj.__undef__:
            assert isinstance(obj._number_of_consecutive_connections[0], int), ("Expected one of [u'integer'], but got %s of type %s" % (obj._number_of_consecutive_connections[0], type(obj._number_of_consecutive_connections[0])))
        ...
        if obj._number_of_seconds[0] is not None and obj._number_of_seconds[0] is not obj.__undef__:
            assert isinstance(obj._number_of_seconds[0], int), ("Expected one of [u'integer'], but got %s of type %s" % (obj._number_of_seconds[0], type(obj._number_of_seconds[0])))
    ...
    def is_dirty(self):
        return any([self._number_of_threads[1], self._host[1], self._number_of_consecutive_connections[1], self._number_of_seconds[1], self._user[1]])
    ...
    def __eq__(self, other):
        ...
        return super(DspConnectivity, self).__eq__(other) and \
               ...
               self.number_of_seconds == other.number_of_seconds and \
