    ...
    *(extends* :py:class:`v1_11_3.web.vo.SourceRepository` *)* The SAP ASE
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._instance_owner_gid[0] is not None and obj._instance_owner_gid[0] is not obj.__undef__:
            assert isinstance(obj._instance_owner_gid[0], int), ("Expected one of [u'integer'], but got %s of type %s" % (obj._instance_owner_gid[0], type(obj._instance_owner_gid[0])))
        ...
        if obj._installation_path[0] is not None and obj._installation_path[0] is not obj.__undef__:
            assert isinstance(obj._installation_path[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._installation_path[0], type(obj._installation_path[0])))
        ...
        if obj._page_size[0] is not None and obj._page_size[0] is not obj.__undef__:
            assert isinstance(obj._page_size[0], int), ("Expected one of [u'integer'], but got %s of type %s" % (obj._page_size[0], type(obj._page_size[0])))
        ...
        if obj._dump_history_file[0] is not None and obj._dump_history_file[0] is not obj.__undef__:
            assert isinstance(obj._dump_history_file[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._dump_history_file[0], type(obj._dump_history_file[0])))
        ...
        if obj._instance_name[0] is not None and obj._instance_name[0] is not obj.__undef__:
            assert isinstance(obj._instance_name[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._instance_name[0], type(obj._instance_name[0])))
        ...
        if obj._isql_path[0] is not None and obj._isql_path[0] is not obj.__undef__:
            assert isinstance(obj._isql_path[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._isql_path[0], type(obj._isql_path[0])))
        ...
        if obj._discovered[0] is not None and obj._discovered[0] is not obj.__undef__:
            assert isinstance(obj._discovered[0], bool), ("Expected one of [u'boolean'], but got %s of type %s" % (obj._discovered[0], type(obj._discovered[0])))
        ...
        if obj._instance_owner[0] is not None and obj._instance_owner[0] is not obj.__undef__:
            assert isinstance(obj._instance_owner[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._instance_owner[0], type(obj._instance_owner[0])))
        ...
        if obj._service_principal_name[0] is not None and obj._service_principal_name[0] is not obj.__undef__:
            assert isinstance(obj._service_principal_name[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._service_principal_name[0], type(obj._service_principal_name[0])))
        ...
        if obj._instance_owner_uid[0] is not None and obj._instance_owner_uid[0] is not obj.__undef__:
            assert isinstance(obj._instance_owner_uid[0], int), ("Expected one of [u'integer'], but got %s of type %s" % (obj._instance_owner_uid[0], type(obj._instance_owner_uid[0])))
            common.validate_format(obj._instance_owner_uid[0], "None", None, None)
        obj._ports = []
        for item in data.get("ports") or []:
            assert isinstance(item, int), ("Expected one of [u'integer'], but got %s of type %s" % (item, type(item)))
    ...
    def to_dict(self, dirty=False, belongs_to_parent=False):
        ...
        if "dump_history_file" == "type" or (self.dump_history_file is not self.__undef__ and (not (dirty and not self._dump_history_file[1]) or isinstance(self.dump_history_file, list) or belongs_to_parent)):
    ...
    def is_dirty(self):
        return any([self._instance_owner_gid[1], self._installation_path[1], self._page_size[1], self._dump_history_file[1], self._instance_name[1], self._isql_path[1], self._discovered[1], self._credentials[1], self._instance_owner[1], self._service_principal_name[1], self._db_user[1], self._instance_owner_uid[1], self._ports[1]])
