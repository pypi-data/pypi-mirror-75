    ...
    *(extends* :py:class:`v1_11_3.web.vo.TypedObject` *)* The state of the
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._authentication_method[0] is not None and obj._authentication_method[0] is not obj.__undef__:
            assert isinstance(obj._authentication_method[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._authentication_method[0], type(obj._authentication_method[0])))
            assert obj._authentication_method[0] in [u'USERNAME_AND_PASSWORD', u'CHALLENGE_RESPONSE'], "Expected enum [u'USERNAME_AND_PASSWORD', u'CHALLENGE_RESPONSE'] but got %s" % obj._authentication_method[0]
        ...
        if obj._token[0] is not None and obj._token[0] is not obj.__undef__:
            assert isinstance(obj._token[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._token[0], type(obj._token[0])))
        ...
        if obj._access_type[0] is not None and obj._access_type[0] is not obj.__undef__:
            assert isinstance(obj._access_type[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._access_type[0], type(obj._access_type[0])))
    ...
    def is_dirty(self):
        return any([self._authentication_method[1], self._token[1], self._end_time[1], self._access_type[1], self._start_time[1]])
    ...
    def __eq__(self, other):
        ...
        return super(SupportAccessState, self).__eq__(other) and \
               self.authentication_method == other.authentication_method and \
