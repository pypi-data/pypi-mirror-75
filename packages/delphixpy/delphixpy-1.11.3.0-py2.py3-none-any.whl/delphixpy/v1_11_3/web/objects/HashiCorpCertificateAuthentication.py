    ...
    *(extends* :py:class:`v1_11_3.web.vo.HashiCorpAuthentication` *)* Client
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._role_name[0] is not None and obj._role_name[0] is not obj.__undef__:
            assert isinstance(obj._role_name[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._role_name[0], type(obj._role_name[0])))
    ...
    def is_dirty(self):
        return any([self._role_name[1], self._client_certificate[1]])
