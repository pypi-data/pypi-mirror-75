    ...
    *(extends* :py:class:`v1_11_3.web.vo.PublicSystemInfo` *)* Retrieve system-
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._memory_reservation[0] is not None and obj._memory_reservation[0] is not obj.__undef__:
            assert isinstance(obj._memory_reservation[0], float), ("Expected one of [u'number'], but got %s of type %s" % (obj._memory_reservation[0], type(obj._memory_reservation[0])))
        ...
        if obj._installation_time[0] is not None and obj._installation_time[0] is not obj.__undef__:
            assert isinstance(obj._installation_time[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._installation_time[0], type(obj._installation_time[0])))
        ...
        if obj._uuid[0] is not None and obj._uuid[0] is not obj.__undef__:
            assert isinstance(obj._uuid[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._uuid[0], type(obj._uuid[0])))
        ...
        if obj._storage_total[0] is not None and obj._storage_total[0] is not obj.__undef__:
            assert isinstance(obj._storage_total[0], float), ("Expected one of [u'number'], but got %s of type %s" % (obj._storage_total[0], type(obj._storage_total[0])))
        ...
        if obj._ssh_public_key[0] is not None and obj._ssh_public_key[0] is not obj.__undef__:
            assert isinstance(obj._ssh_public_key[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._ssh_public_key[0], type(obj._ssh_public_key[0])))
        ...
        if obj._hostname[0] is not None and obj._hostname[0] is not obj.__undef__:
            assert isinstance(obj._hostname[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._hostname[0], type(obj._hostname[0])))
        ...
        if obj._memory_size[0] is not None and obj._memory_size[0] is not obj.__undef__:
            assert isinstance(obj._memory_size[0], float), ("Expected one of [u'number'], but got %s of type %s" % (obj._memory_size[0], type(obj._memory_size[0])))
        ...
        if obj._platform[0] is not None and obj._platform[0] is not obj.__undef__:
            assert isinstance(obj._platform[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._platform[0], type(obj._platform[0])))
        ...
        if obj._pool_fragmentation[0] is not None and obj._pool_fragmentation[0] is not obj.__undef__:
            assert isinstance(obj._pool_fragmentation[0], float), ("Expected one of [u'number'], but got %s of type %s" % (obj._pool_fragmentation[0], type(obj._pool_fragmentation[0])))
        ...
        if obj._storage_used[0] is not None and obj._storage_used[0] is not obj.__undef__:
            assert isinstance(obj._storage_used[0], float), ("Expected one of [u'number'], but got %s of type %s" % (obj._storage_used[0], type(obj._storage_used[0])))
        ...
        if obj._cpu_reservation[0] is not None and obj._cpu_reservation[0] is not obj.__undef__:
            assert isinstance(obj._cpu_reservation[0], float), ("Expected one of [u'number'], but got %s of type %s" % (obj._cpu_reservation[0], type(obj._cpu_reservation[0])))
        ...
        if obj._hotfixes[0] is not None and obj._hotfixes[0] is not obj.__undef__:
            assert isinstance(obj._hotfixes[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._hotfixes[0], type(obj._hotfixes[0])))
    ...
    def is_dirty(self):
        return any([self._memory_reservation[1], self._up_time[1], self._installation_time[1], self._uuid[1], self._storage_total[1], self._ssh_public_key[1], self._hostname[1], self._memory_size[1], self._platform[1], self._pool_fragmentation[1], self._storage_used[1], self._cpu_reservation[1], self._hotfixes[1], self._processors[1]])
