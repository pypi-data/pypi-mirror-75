    ...
    *(extends* :py:class:`v1_11_3.web.vo.DbExportParameters` *)* The parameters
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._open_database[0] is not None and obj._open_database[0] is not obj.__undef__:
            assert isinstance(obj._open_database[0], bool), ("Expected one of [u'boolean'], but got %s of type %s" % (obj._open_database[0], type(obj._open_database[0])))
        ...
        if obj._file_parallelism[0] is not None and obj._file_parallelism[0] is not obj.__undef__:
            assert isinstance(obj._file_parallelism[0], int), ("Expected one of [u'integer'], but got %s of type %s" % (obj._file_parallelism[0], type(obj._file_parallelism[0])))
    ...
    def is_dirty(self):
        return any([self._dsp_options[1], self._source_config[1], self._open_database[1], self._file_parallelism[1], self._filesystem_layout[1]])
