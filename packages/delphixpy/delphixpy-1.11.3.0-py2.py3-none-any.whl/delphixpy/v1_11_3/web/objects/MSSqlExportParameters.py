    ...
    *(extends* :py:class:`v1_11_3.web.vo.DbExportParameters` *)* The parameters
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._enable_cdc[0] is not None and obj._enable_cdc[0] is not obj.__undef__:
            assert isinstance(obj._enable_cdc[0], bool), ("Expected one of [u'boolean'], but got %s of type %s" % (obj._enable_cdc[0], type(obj._enable_cdc[0])))
    ...
    def to_dict(self, dirty=False, belongs_to_parent=False):
        ...
        if "enable_cdc" == "type" or (self.enable_cdc is not self.__undef__ and (not (dirty and not self._enable_cdc[1]) or isinstance(self.enable_cdc, list) or belongs_to_parent)):
    ...
    def is_dirty(self):
        return any([self._source_config[1], self._enable_cdc[1], self._filesystem_layout[1], self._recovery_model[1]])
