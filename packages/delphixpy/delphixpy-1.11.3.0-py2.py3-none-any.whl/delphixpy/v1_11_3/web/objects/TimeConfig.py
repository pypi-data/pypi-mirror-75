    ...
    *(extends* :py:class:`v1_11_3.web.vo.TypedObject` *)* Get and set the
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._system_time_zone_offset[0] is not None and obj._system_time_zone_offset[0] is not obj.__undef__:
            assert isinstance(obj._system_time_zone_offset[0], int), ("Expected one of [u'integer'], but got %s of type %s" % (obj._system_time_zone_offset[0], type(obj._system_time_zone_offset[0])))
        ...
        if obj._system_time_zone[0] is not None and obj._system_time_zone[0] is not obj.__undef__:
            assert isinstance(obj._system_time_zone[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._system_time_zone[0], type(obj._system_time_zone[0])))
        ...
        if obj._system_time_zone_offset_string[0] is not None and obj._system_time_zone_offset_string[0] is not obj.__undef__:
            assert isinstance(obj._system_time_zone_offset_string[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._system_time_zone_offset_string[0], type(obj._system_time_zone_offset_string[0])))
        ...
        if obj._current_time[0] is not None and obj._current_time[0] is not obj.__undef__:
            assert isinstance(obj._current_time[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._current_time[0], type(obj._current_time[0])))
    ...
    def is_dirty(self):
        return any([self._ntp_config[1], self._system_time_zone_offset[1], self._system_time_zone[1], self._system_time_zone_offset_string[1], self._current_time[1]])
