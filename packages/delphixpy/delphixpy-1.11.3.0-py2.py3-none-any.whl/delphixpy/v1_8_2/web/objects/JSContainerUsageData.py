    ...
    *(extends* :py:class:`v1_8_2.web.vo.TypedObject` *)* The space usage
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._shared_others[0] is not None and obj._shared_others[0] is not obj.__undef__:
            assert isinstance(obj._shared_others[0], float), ("Expected one of [u'number'], but got %s of type %s" % (obj._shared_others[0], type(obj._shared_others[0])))
        ...
        if obj._shared_self[0] is not None and obj._shared_self[0] is not obj.__undef__:
            assert isinstance(obj._shared_self[0], float), ("Expected one of [u'number'], but got %s of type %s" % (obj._shared_self[0], type(obj._shared_self[0])))
