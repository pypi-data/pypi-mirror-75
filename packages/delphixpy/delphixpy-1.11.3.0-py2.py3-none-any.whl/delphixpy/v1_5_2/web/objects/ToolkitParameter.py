    ...
    *(extends* :py:class:`v1_5_2.web.vo.TypedObject` *)* Specifies input
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._default[0] is not None and obj._default[0] is not obj.__undef__:
            assert isinstance(obj._default[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._default[0], type(obj._default[0])))
        ...
        if obj._environment_variable[0] is not None and obj._environment_variable[0] is not obj.__undef__:
            assert isinstance(obj._environment_variable[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._environment_variable[0], type(obj._environment_variable[0])))
