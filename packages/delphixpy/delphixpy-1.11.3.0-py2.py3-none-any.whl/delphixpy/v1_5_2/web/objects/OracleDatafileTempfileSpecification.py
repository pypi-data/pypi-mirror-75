    ...
    *(extends* :py:class:`v1_5_2.web.vo.OracleFileSpecification` *)* Describes
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._max_size[0] is not None and obj._max_size[0] is not obj.__undef__:
            assert isinstance(obj._max_size[0], int), ("Expected one of [u'integer'], but got %s of type %s" % (obj._max_size[0], type(obj._max_size[0])))
        ...
        if obj._auto_extend_increment[0] is not None and obj._auto_extend_increment[0] is not obj.__undef__:
            assert isinstance(obj._auto_extend_increment[0], int), ("Expected one of [u'integer'], but got %s of type %s" % (obj._auto_extend_increment[0], type(obj._auto_extend_increment[0])))
        ...
        if obj._auto_extend[0] is not None and obj._auto_extend[0] is not obj.__undef__:
            assert isinstance(obj._auto_extend[0], bool), ("Expected one of [u'boolean'], but got %s of type %s" % (obj._auto_extend[0], type(obj._auto_extend[0])))
    ...
    def is_dirty(self):
        return any([self._max_size[1], self._auto_extend_increment[1], self._auto_extend[1]])
    ...
    def __eq__(self, other):
        ...
        return super(OracleDatafileTempfileSpecification, self).__eq__(other) and \
               ...
               self.auto_extend == other.auto_extend
