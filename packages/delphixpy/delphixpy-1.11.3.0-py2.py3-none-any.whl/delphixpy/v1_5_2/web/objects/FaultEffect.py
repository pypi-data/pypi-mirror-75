    ...
    *(extends* :py:class:`v1_5_2.web.vo.PersistentObject` *)* An error
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._root_cause[0] is not None and obj._root_cause[0] is not obj.__undef__:
            assert isinstance(obj._root_cause[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._root_cause[0], type(obj._root_cause[0])))
        ...
        if obj._caused_by[0] is not None and obj._caused_by[0] is not obj.__undef__:
            assert isinstance(obj._caused_by[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._caused_by[0], type(obj._caused_by[0])))
    ...
    def is_dirty(self):
        return any([self._description[1], self._title[1], self._root_cause[1], self._severity[1], self._target_name[1], self._date_diagnosed[1], self._target[1], self._action[1], self._caused_by[1], self._response[1], self._bundle_id[1]])
