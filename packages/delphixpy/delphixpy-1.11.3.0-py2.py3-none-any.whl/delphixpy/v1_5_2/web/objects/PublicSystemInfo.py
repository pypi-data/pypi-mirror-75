    ...
    *(extends* :py:class:`v1_5_2.web.vo.TypedObject` *)* Retrieve static
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        for item in data.get("enabledFeatures") or []:
            ...
            assert item in [u'XPP', u'CONSPRO', u'REGISTRATIONREQUIRED', u'PHONEHOMEREQUIRED'], "Expected enum [u'XPP', u'CONSPRO', u'REGISTRATIONREQUIRED', u'PHONEHOMEREQUIRED'] but got %s" % item
