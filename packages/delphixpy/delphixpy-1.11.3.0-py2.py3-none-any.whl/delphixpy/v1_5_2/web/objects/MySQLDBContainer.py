...
class MySQLDBContainer(DatabaseContainer):
    ...
    *(extends* :py:class:`v1_5_2.web.vo.DatabaseContainer` *)* A MySQL Database
    ...
    def __init__(self, undef_enabled=True):
        super(MySQLDBContainer, self).__init__()
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        obj = super(MySQLDBContainer, cls).from_dict(data, dirty, undef_enabled)
    ...
    def to_dict(self, dirty=False, belongs_to_parent=False):
        dct = super(MySQLDBContainer, self).to_dict(dirty, belongs_to_parent)
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, MySQLDBContainer):
            return False
        return super(MySQLDBContainer, self).__eq__(other) and \
