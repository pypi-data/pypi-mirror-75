...
from delphixpy.v1_4_1.web.analytics import statistic
try:
...
def get_data(engine, ref, number_of_datapoints=None, end_time=None, resolution=None, start_time=None):
    """
    ...
    query_params = {"numberOfDatapoints": number_of_datapoints, "resolution": resolution, "startTime": start_time, "endTime": end_time}
