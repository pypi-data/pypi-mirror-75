    ...
    *(extends* :py:class:`v1_4_1.web.vo.UserObject` *)* Round-trip latency
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._loss[0] is not None and obj._loss[0] is not obj.__undef__:
            assert isinstance(obj._loss[0], int), ("Expected one of [u'integer'], but got %s of type %s" % (obj._loss[0], type(obj._loss[0])))
        ...
        if obj._request_size[0] is not None and obj._request_size[0] is not obj.__undef__:
            assert isinstance(obj._request_size[0], int), ("Expected one of [u'integer'], but got %s of type %s" % (obj._request_size[0], type(obj._request_size[0])))
        ...
        if obj._stddev[0] is not None and obj._stddev[0] is not obj.__undef__:
            assert isinstance(obj._stddev[0], int), ("Expected one of [u'integer'], but got %s of type %s" % (obj._stddev[0], type(obj._stddev[0])))
        ...
        if obj._remote_address[0] is not None and obj._remote_address[0] is not obj.__undef__:
            assert isinstance(obj._remote_address[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._remote_address[0], type(obj._remote_address[0])))
        ...
        if obj._average[0] is not None and obj._average[0] is not obj.__undef__:
            assert isinstance(obj._average[0], int), ("Expected one of [u'integer'], but got %s of type %s" % (obj._average[0], type(obj._average[0])))
        ...
        if obj._maximum[0] is not None and obj._maximum[0] is not obj.__undef__:
            assert isinstance(obj._maximum[0], int), ("Expected one of [u'integer'], but got %s of type %s" % (obj._maximum[0], type(obj._maximum[0])))
        ...
        if obj._minimum[0] is not None and obj._minimum[0] is not obj.__undef__:
            assert isinstance(obj._minimum[0], int), ("Expected one of [u'integer'], but got %s of type %s" % (obj._minimum[0], type(obj._minimum[0])))
        ...
        if obj._request_count[0] is not None and obj._request_count[0] is not obj.__undef__:
            assert isinstance(obj._request_count[0], int), ("Expected one of [u'integer'], but got %s of type %s" % (obj._request_count[0], type(obj._request_count[0])))
        ...
        if obj._remote_host[0] is not None and obj._remote_host[0] is not obj.__undef__:
            assert isinstance(obj._remote_host[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._remote_host[0], type(obj._remote_host[0])))
    ...
    def is_dirty(self):
        return any([self._loss[1], self._request_size[1], self._stddev[1], self._remote_address[1], self._average[1], self._maximum[1], self._state[1], self._minimum[1], self._request_count[1], self._start_time[1], self._end_time[1], self._remote_host[1]])
