...
class JSBranchCapacityData(TypedObject):
    ...
    *(extends* :py:class:`v1_4_1.web.vo.TypedObject` *)* The capacity
    ...
    def __init__(self, undef_enabled=True):
        super(JSBranchCapacityData, self).__init__()
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        obj = super(JSBranchCapacityData, cls).from_dict(data, dirty, undef_enabled)
        ...
        if obj._data_container[0] is not None and obj._data_container[0] is not obj.__undef__:
            assert isinstance(obj._data_container[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._data_container[0], type(obj._data_container[0])))
        ...
        if obj._referenced_by_self[0] is not None and obj._referenced_by_self[0] is not obj.__undef__:
            assert isinstance(obj._referenced_by_self[0], float), ("Expected one of [u'number'], but got %s of type %s" % (obj._referenced_by_self[0], type(obj._referenced_by_self[0])))
        ...
        if obj._referenced_by_siblings[0] is not None and obj._referenced_by_siblings[0] is not obj.__undef__:
            assert isinstance(obj._referenced_by_siblings[0], float), ("Expected one of [u'number'], but got %s of type %s" % (obj._referenced_by_siblings[0], type(obj._referenced_by_siblings[0])))
    ...
    def to_dict(self, dirty=False, belongs_to_parent=False):
        dct = super(JSBranchCapacityData, self).to_dict(dirty, belongs_to_parent)
    ...
    def is_dirty(self):
        return any([self._data_container[1], self._referenced_by_self[1], self._unique[1], self._referenced_by_siblings[1], self._branch[1]])
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, JSBranchCapacityData):
            return False
        return super(JSBranchCapacityData, self).__eq__(other) and \
