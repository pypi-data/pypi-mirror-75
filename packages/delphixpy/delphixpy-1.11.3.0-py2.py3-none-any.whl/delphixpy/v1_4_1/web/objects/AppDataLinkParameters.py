...
class AppDataLinkParameters(LinkParameters):
    ...
    *(extends* :py:class:`v1_4_1.web.vo.LinkParameters` *)* Represents the
    ...
    def to_dict(self, dirty=False, belongs_to_parent=False):
        dct = super(AppDataLinkParameters, self).to_dict(dirty, belongs_to_parent)
    ...
    def is_dirty(self):
        return any([self._source[1], self._excludes[1], self._container[1], self._environment_user[1], self._follow_symlinks[1]])
