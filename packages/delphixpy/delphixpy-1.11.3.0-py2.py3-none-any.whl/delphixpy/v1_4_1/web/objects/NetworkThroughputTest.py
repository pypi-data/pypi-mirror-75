    ...
    *(extends* :py:class:`v1_4_1.web.vo.UserObject` *)* Bi-directional
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._direction[0] is not None and obj._direction[0] is not obj.__undef__:
            assert isinstance(obj._direction[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._direction[0], type(obj._direction[0])))
        ...
        if obj._num_connections[0] is not None and obj._num_connections[0] is not obj.__undef__:
            assert isinstance(obj._num_connections[0], int), ("Expected one of [u'integer'], but got %s of type %s" % (obj._num_connections[0], type(obj._num_connections[0])))
        ...
        if obj._duration[0] is not None and obj._duration[0] is not obj.__undef__:
            assert isinstance(obj._duration[0], int), ("Expected one of [u'integer'], but got %s of type %s" % (obj._duration[0], type(obj._duration[0])))
    ...
    def is_dirty(self):
        return any([self._direction[1], self._num_connections[1], self._remote_address[1], self._remote_host[1], self._state[1], self._throughput[1], self._start_time[1], self._duration[1], self._end_time[1]])
