...
class HostPrivilegeElevationSettings(TypedObject):
    """
    *(extends* :py:class:`v1_4_1.web.vo.TypedObject` *)* Settings for elevating
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._default_profile[0] is not None and obj._default_profile[0] is not obj.__undef__:
            assert isinstance(obj._default_profile[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._default_profile[0], type(obj._default_profile[0])))
