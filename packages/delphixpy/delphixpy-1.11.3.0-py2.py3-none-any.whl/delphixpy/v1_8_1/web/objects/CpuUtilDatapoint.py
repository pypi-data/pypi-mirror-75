    ...
    *(extends* :py:class:`v1_8_1.web.vo.Datapoint` *)* An analytics datapoint
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._dtrace[0] is not None and obj._dtrace[0] is not obj.__undef__:
            assert isinstance(obj._dtrace[0], int), ("Expected one of [u'integer'], but got %s of type %s" % (obj._dtrace[0], type(obj._dtrace[0])))
        ...
        if obj._idle[0] is not None and obj._idle[0] is not obj.__undef__:
            assert isinstance(obj._idle[0], int), ("Expected one of [u'integer'], but got %s of type %s" % (obj._idle[0], type(obj._idle[0])))
        ...
        if obj._user[0] is not None and obj._user[0] is not obj.__undef__:
            assert isinstance(obj._user[0], int), ("Expected one of [u'integer'], but got %s of type %s" % (obj._user[0], type(obj._user[0])))
        ...
        if obj._kernel[0] is not None and obj._kernel[0] is not obj.__undef__:
            assert isinstance(obj._kernel[0], int), ("Expected one of [u'integer'], but got %s of type %s" % (obj._kernel[0], type(obj._kernel[0])))
