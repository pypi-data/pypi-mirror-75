...
class ToolkitDiscoveryDefinition(TypedObject):
    ...
    *(extends* :py:class:`v1_8_1.web.vo.TypedObject` *)* Defines the discovery
    ...
    def is_dirty(self):
        return any([self._repository_identity_fields[1], self._source_config_name_field[1], self._source_config_discovery[1], self._repository_schema[1], self._repository_name_field[1], self._repository_discovery[1], self._source_config_identity_fields[1], self._source_config_schema[1]])
