    ...
    *(extends* :py:class:`v1_8_1.web.vo.DBContainerRuntime` *)* Runtime
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._last_restored_backup_date[0] is not None and obj._last_restored_backup_date[0] is not obj.__undef__:
            assert isinstance(obj._last_restored_backup_date[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._last_restored_backup_date[0], type(obj._last_restored_backup_date[0])))
        ...
        if obj._last_restored_backup_time_zone[0] is not None and obj._last_restored_backup_time_zone[0] is not obj.__undef__:
            assert isinstance(obj._last_restored_backup_time_zone[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._last_restored_backup_time_zone[0], type(obj._last_restored_backup_time_zone[0])))
