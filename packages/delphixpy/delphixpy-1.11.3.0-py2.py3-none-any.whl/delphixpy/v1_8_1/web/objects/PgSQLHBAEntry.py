    ...
    *(extends* :py:class:`v1_8_1.web.vo.TypedObject` *)* An entry in the
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._auth_options[0] is not None and obj._auth_options[0] is not obj.__undef__:
            assert isinstance(obj._auth_options[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._auth_options[0], type(obj._auth_options[0])))
        ...
        if obj._database[0] is not None and obj._database[0] is not obj.__undef__:
            assert isinstance(obj._database[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._database[0], type(obj._database[0])))
        ...
        if obj._auth_method[0] is not None and obj._auth_method[0] is not obj.__undef__:
            assert isinstance(obj._auth_method[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._auth_method[0], type(obj._auth_method[0])))
        ...
        if obj._entry_type[0] is not None and obj._entry_type[0] is not obj.__undef__:
            assert isinstance(obj._entry_type[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._entry_type[0], type(obj._entry_type[0])))
