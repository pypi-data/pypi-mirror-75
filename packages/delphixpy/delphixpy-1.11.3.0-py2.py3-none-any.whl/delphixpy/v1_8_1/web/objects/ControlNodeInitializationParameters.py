    ...
    *(extends* :py:class:`v1_8_1.web.vo.SystemInitializationParameters` *)*
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._grid[0] is not None and obj._grid[0] is not obj.__undef__:
            assert isinstance(obj._grid[0], bool), ("Expected one of [u'boolean'], but got %s of type %s" % (obj._grid[0], type(obj._grid[0])))
        ...
        if obj._default_user[0] is not None and obj._default_user[0] is not obj.__undef__:
            assert isinstance(obj._default_user[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._default_user[0], type(obj._default_user[0])))
        ...
        if obj._default_password[0] is not None and obj._default_password[0] is not obj.__undef__:
            assert isinstance(obj._default_password[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._default_password[0], type(obj._default_password[0])))
            common.validate_format(obj._default_password[0], "password", None, None)
        return obj

    def to_dict(self, dirty=False, belongs_to_parent=False):
        dct = super(ControlNodeInitializationParameters, self).to_dict(dirty, belongs_to_parent)
        ...
        def dictify(obj, prop_is_list_or_vo=False):
            if isinstance(obj, list):
                ...
                return obj
        if "grid" == "type" or (self.grid is not self.__undef__ and (not (dirty and not self._grid[1]) or isinstance(self.grid, list) or belongs_to_parent)):
