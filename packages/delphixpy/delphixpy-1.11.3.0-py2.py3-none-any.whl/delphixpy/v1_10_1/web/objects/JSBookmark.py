...
class JSBookmark(NamedUserObject):
    """
    *(extends* :py:class:`v1_10_1.web.vo.NamedUserObject` *)* A named entity
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._container_name[0] is not None and obj._container_name[0] is not obj.__undef__:
            assert isinstance(obj._container_name[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._container_name[0], type(obj._container_name[0])))
        ...
        if obj._usable[0] is not None and obj._usable[0] is not obj.__undef__:
            assert isinstance(obj._usable[0], bool), ("Expected one of [u'boolean'], but got %s of type %s" % (obj._usable[0], type(obj._usable[0])))
        ...
        if obj._timestamp[0] is not None and obj._timestamp[0] is not obj.__undef__:
            assert isinstance(obj._timestamp[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._timestamp[0], type(obj._timestamp[0])))
        ...
        if obj._template_name[0] is not None and obj._template_name[0] is not obj.__undef__:
            assert isinstance(obj._template_name[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._template_name[0], type(obj._template_name[0])))
        ...
        if obj._checkout_count[0] is not None and obj._checkout_count[0] is not obj.__undef__:
            assert isinstance(obj._checkout_count[0], int), ("Expected one of [u'integer'], but got %s of type %s" % (obj._checkout_count[0], type(obj._checkout_count[0])))
        ...
        if obj._creation_time[0] is not None and obj._creation_time[0] is not obj.__undef__:
            assert isinstance(obj._creation_time[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._creation_time[0], type(obj._creation_time[0])))
        ...
        if obj._bookmark_type[0] is not None and obj._bookmark_type[0] is not obj.__undef__:
            assert isinstance(obj._bookmark_type[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._bookmark_type[0], type(obj._bookmark_type[0])))
        ...
        if obj._expiration[0] is not None and obj._expiration[0] is not obj.__undef__:
            assert isinstance(obj._expiration[0], TEXT_TYPE), ("Expected one of [u'string', u'null'], but got %s of type %s" % (obj._expiration[0], type(obj._expiration[0])))
        ...
        if obj._shared[0] is not None and obj._shared[0] is not obj.__undef__:
            assert isinstance(obj._shared[0], bool), ("Expected one of [u'boolean'], but got %s of type %s" % (obj._shared[0], type(obj._shared[0])))
    ...
    def is_dirty(self):
        return any([self._container_name[1], self._usable[1], self._container[1], self._description[1], self._tags[1], self._timestamp[1], self._template_name[1], self._checkout_count[1], self._creation_time[1], self._bookmark_type[1], self._expiration[1], self._branch[1], self._shared[1], self._template[1]])
