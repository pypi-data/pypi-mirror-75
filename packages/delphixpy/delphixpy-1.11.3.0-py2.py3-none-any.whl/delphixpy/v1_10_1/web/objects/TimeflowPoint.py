...
class TimeflowPoint(TypedObject):
    ...
    *(extends* :py:class:`v1_10_1.web.vo.TypedObject` *)* TimeFlow points
    ...
    def to_dict(self, dirty=False, belongs_to_parent=False):
        dct = super(TimeflowPoint, self).to_dict(dirty, belongs_to_parent)
        ...
        def dictify(obj, prop_is_list_or_vo=False):
            if isinstance(obj, list):
                ...
                return obj
        if "timestamp" == "type" or (self.timestamp is not self.__undef__ and (not (dirty and not self._timestamp[1]) or isinstance(self.timestamp, list) or belongs_to_parent)):
