...
class UpgradeCheckResult(NamedUserObject):
    ...
    *(extends* :py:class:`v1_10_1.web.vo.NamedUserObject` *)* Describes
    ...
    def is_dirty(self):
        return any([self._impact[1], self._status[1], self._description[1], self._title[1], self._version[1], self._action[1], self._output[1], self._bundle_id[1], self._severity[1]])
