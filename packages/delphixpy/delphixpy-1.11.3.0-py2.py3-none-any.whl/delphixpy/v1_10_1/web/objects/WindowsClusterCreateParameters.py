    ...
    *(extends* :py:class:`v1_10_1.web.vo.SourceEnvironmentCreateParameters` *)*
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._target[0] is not None and obj._target[0] is not obj.__undef__:
            assert isinstance(obj._target[0], bool), ("Expected one of [u'boolean'], but got %s of type %s" % (obj._target[0], type(obj._target[0])))
            common.validate_format(obj._target[0], "None", None, None)
        return obj

    def to_dict(self, dirty=False, belongs_to_parent=False):
        dct = super(WindowsClusterCreateParameters, self).to_dict(dirty, belongs_to_parent)
