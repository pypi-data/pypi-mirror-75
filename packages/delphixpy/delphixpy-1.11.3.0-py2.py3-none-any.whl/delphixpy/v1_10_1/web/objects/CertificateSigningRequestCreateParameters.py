    ...
    *(extends* :py:class:`v1_10_1.web.vo.TypedObject` *)* The parameters used
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._force_replace[0] is not None and obj._force_replace[0] is not obj.__undef__:
            assert isinstance(obj._force_replace[0], bool), ("Expected one of [u'boolean'], but got %s of type %s" % (obj._force_replace[0], type(obj._force_replace[0])))
    ...
    def is_dirty(self):
        return any([self._dname[1], self._key_pair[1], self._force_replace[1], self._subject_alternative_names[1], self._end_entity[1]])
