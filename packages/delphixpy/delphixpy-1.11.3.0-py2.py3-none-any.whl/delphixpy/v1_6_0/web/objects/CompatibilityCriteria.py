    ...
    *(extends* :py:class:`v1_6_0.web.vo.TypedObject` *)* The compatibility
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._staging_enabled[0] is not None and obj._staging_enabled[0] is not obj.__undef__:
            assert isinstance(obj._staging_enabled[0], bool), ("Expected one of [u'boolean'], but got %s of type %s" % (obj._staging_enabled[0], type(obj._staging_enabled[0])))
        ...
        if obj._provisioning_enabled[0] is not None and obj._provisioning_enabled[0] is not obj.__undef__:
            assert isinstance(obj._provisioning_enabled[0], bool), ("Expected one of [u'boolean'], but got %s of type %s" % (obj._provisioning_enabled[0], type(obj._provisioning_enabled[0])))
        ...
        if obj._os[0] is not None and obj._os[0] is not obj.__undef__:
            assert isinstance(obj._os[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._os[0], type(obj._os[0])))
        ...
        if obj._processor[0] is not None and obj._processor[0] is not obj.__undef__:
            assert isinstance(obj._processor[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._processor[0], type(obj._processor[0])))
        ...
        if obj._architecture[0] is not None and obj._architecture[0] is not obj.__undef__:
            assert isinstance(obj._architecture[0], int), ("Expected one of [u'integer'], but got %s of type %s" % (obj._architecture[0], type(obj._architecture[0])))
    ...
    def is_dirty(self):
        return any([self._staging_enabled[1], self._environment[1], self._provisioning_enabled[1], self._os[1], self._processor[1], self._architecture[1]])
