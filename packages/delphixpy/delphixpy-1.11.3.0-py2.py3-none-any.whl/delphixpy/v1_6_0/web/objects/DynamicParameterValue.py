    ...
    *(extends* :py:class:`v1_6_0.web.vo.TypedObject` *)* A settable value for a
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._value[0] is not None and obj._value[0] is not obj.__undef__:
            assert isinstance(obj._value[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._value[0], type(obj._value[0])))
            common.validate_format(obj._value[0], "None", None, None)
        return obj

    def to_dict(self, dirty=False, belongs_to_parent=False):
        dct = super(DynamicParameterValue, self).to_dict(dirty, belongs_to_parent)
        ...
        def dictify(obj, prop_is_list_or_vo=False):
            if isinstance(obj, list):
                ...
                return obj
        if "definition" == "type" or (self.definition is not self.__undef__ and (not (dirty and not self._definition[1]) or isinstance(self.definition, list) or belongs_to_parent)):
            dct["definition"] = dictify(self.definition, prop_is_list_or_vo=True)
        if "value" == "type" or (self.value is not self.__undef__ and (not (dirty and not self._value[1]) or isinstance(self.value, list) or belongs_to_parent)):
