...
class OracleDBConfigConnectivity(AbstractSourceConfigConnectivity):
    ...
    *(extends* :py:class:`v1_10_3.web.vo.AbstractSourceConfigConnectivity` *)*
    ...
    def __init__(self, undef_enabled=True):
        super(OracleDBConfigConnectivity, self).__init__()
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        obj = super(OracleDBConfigConnectivity, cls).from_dict(data, dirty, undef_enabled)
    ...
    def to_dict(self, dirty=False, belongs_to_parent=False):
        dct = super(OracleDBConfigConnectivity, self).to_dict(dirty, belongs_to_parent)
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, OracleDBConfigConnectivity):
            return False
        return super(OracleDBConfigConnectivity, self).__eq__(other) and \
