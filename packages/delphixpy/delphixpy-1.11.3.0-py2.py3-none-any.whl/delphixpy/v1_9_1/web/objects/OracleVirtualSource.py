    ...
    *(extends* :py:class:`v1_9_1.web.vo.OracleSource` *)* A virtual Oracle
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._config_template[0] is not None and obj._config_template[0] is not obj.__undef__:
            assert isinstance(obj._config_template[0], TEXT_TYPE), ("Expected one of [u'string', u'null'], but got %s of type %s" % (obj._config_template[0], type(obj._config_template[0])))
