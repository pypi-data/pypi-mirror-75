...
class ToolkitDiscoveryDefinition(TypedObject):
    """
    *(extends* :py:class:`v1_9_1.web.vo.TypedObject` *)* Defines the discovery
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._manual_source_config_discovery[0] is not None and obj._manual_source_config_discovery[0] is not obj.__undef__:
            assert isinstance(obj._manual_source_config_discovery[0], bool), ("Expected one of [u'boolean'], but got %s of type %s" % (obj._manual_source_config_discovery[0], type(obj._manual_source_config_discovery[0])))
        ...
        if obj._source_config_name_field[0] is not None and obj._source_config_name_field[0] is not obj.__undef__:
            assert isinstance(obj._source_config_name_field[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._source_config_name_field[0], type(obj._source_config_name_field[0])))
        ...
        if obj._source_config_discovery[0] is not None and obj._source_config_discovery[0] is not obj.__undef__:
            assert isinstance(obj._source_config_discovery[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._source_config_discovery[0], type(obj._source_config_discovery[0])))
        ...
        if obj._repository_name_field[0] is not None and obj._repository_name_field[0] is not obj.__undef__:
            assert isinstance(obj._repository_name_field[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._repository_name_field[0], type(obj._repository_name_field[0])))
        ...
        if obj._repository_discovery[0] is not None and obj._repository_discovery[0] is not obj.__undef__:
            assert isinstance(obj._repository_discovery[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._repository_discovery[0], type(obj._repository_discovery[0])))
    ...
    def is_dirty(self):
        return any([self._manual_source_config_discovery[1], self._repository_identity_fields[1], self._source_config_name_field[1], self._source_config_discovery[1], self._repository_schema[1], self._repository_name_field[1], self._repository_discovery[1], self._source_config_schema[1], self._source_config_identity_fields[1]])
