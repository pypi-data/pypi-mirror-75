    ...
    *(extends* :py:class:`v1_9_1.web.vo.JSDataLayout` *)* A container
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._lock_user_reference[0] is not None and obj._lock_user_reference[0] is not obj.__undef__:
            assert isinstance(obj._lock_user_reference[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._lock_user_reference[0], type(obj._lock_user_reference[0])))
        ...
        if obj._owner[0] is not None and obj._owner[0] is not obj.__undef__:
            assert isinstance(obj._owner[0], TEXT_TYPE), ("Expected one of [u'string', u'null'], but got %s of type %s" % (obj._owner[0], type(obj._owner[0])))
        ...
        if obj._lock_user_name[0] is not None and obj._lock_user_name[0] is not obj.__undef__:
            assert isinstance(obj._lock_user_name[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._lock_user_name[0], type(obj._lock_user_name[0])))
        ...
        if obj._operation_count[0] is not None and obj._operation_count[0] is not obj.__undef__:
            assert isinstance(obj._operation_count[0], int), ("Expected one of [u'integer'], but got %s of type %s" % (obj._operation_count[0], type(obj._operation_count[0])))
    ...
    def is_dirty(self):
        return any([self._lock_user_reference[1], self._state[1], self._template[1], self._owner[1], self._lock_user_name[1], self._operation_count[1]])
