    ...
    *(extends* :py:class:`v1_9_1.web.vo.OracleCustomEnvVar` *)* Dictates a
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._var_name[0] is not None and obj._var_name[0] is not obj.__undef__:
            assert isinstance(obj._var_name[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._var_name[0], type(obj._var_name[0])))
        ...
        if obj._var_value[0] is not None and obj._var_value[0] is not obj.__undef__:
            assert isinstance(obj._var_value[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._var_value[0], type(obj._var_value[0])))
