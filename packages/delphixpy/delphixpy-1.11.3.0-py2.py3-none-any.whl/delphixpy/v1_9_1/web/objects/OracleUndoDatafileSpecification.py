    ...
    *)* Describes an Oracle datafile that stores undo data.
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._size[0] is not None and obj._size[0] is not obj.__undef__:
            assert isinstance(obj._size[0], int), ("Expected one of [u'integer'], but got %s of type %s" % (obj._size[0], type(obj._size[0])))
            common.validate_format(obj._size[0], "None", None, None)
        return obj

    def to_dict(self, dirty=False, belongs_to_parent=False):
        dct = super(OracleUndoDatafileSpecification, self).to_dict(dirty, belongs_to_parent)
