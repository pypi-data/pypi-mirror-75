    ...
    *(extends* :py:class:`v1_9_1.web.vo.LinkData` *)* MySQL specific parameters
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._staging_port[0] is not None and obj._staging_port[0] is not obj.__undef__:
            assert isinstance(obj._staging_port[0], int), ("Expected one of [u'integer'], but got %s of type %s" % (obj._staging_port[0], type(obj._staging_port[0])))
    ...
    def is_dirty(self):
        return any([self._config_params[1], self._operations[1], self._staging_repository[1], self._staging_port[1], self._staging_host_user[1], self._db_user[1], self._db_credentials[1], self._config[1], self._sync_parameters[1]])
