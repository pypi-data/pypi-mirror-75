    ...
    *(extends* :py:class:`v1_9_1.web.vo.NamedUserObject` *)* Trusted CA
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._valid_to[0] is not None and obj._valid_to[0] is not obj.__undef__:
            assert isinstance(obj._valid_to[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._valid_to[0], type(obj._valid_to[0])))
        ...
        if obj._valid_from[0] is not None and obj._valid_from[0] is not obj.__undef__:
            assert isinstance(obj._valid_from[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._valid_from[0], type(obj._valid_from[0])))
        ...
        if obj._issued_to_dn[0] is not None and obj._issued_to_dn[0] is not obj.__undef__:
            assert isinstance(obj._issued_to_dn[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._issued_to_dn[0], type(obj._issued_to_dn[0])))
            common.validate_format(obj._issued_to_dn[0], "None", None, None)
        return obj

    def to_dict(self, dirty=False, belongs_to_parent=False):
        dct = super(TlsCaCert, self).to_dict(dirty, belongs_to_parent)
