    ...
    *(extends* :py:class:`v1_9_1.web.vo.EmptyDatasetCreationParameters` *)* The
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._character_set[0] is not None and obj._character_set[0] is not obj.__undef__:
            assert isinstance(obj._character_set[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._character_set[0], type(obj._character_set[0])))
        ...
        if obj._timezone_file_version[0] is not None and obj._timezone_file_version[0] is not obj.__undef__:
            assert isinstance(obj._timezone_file_version[0], int), ("Expected one of [u'integer'], but got %s of type %s" % (obj._timezone_file_version[0], type(obj._timezone_file_version[0])))
        ...
        if obj._max_instances[0] is not None and obj._max_instances[0] is not obj.__undef__:
            assert isinstance(obj._max_instances[0], int), ("Expected one of [u'integer'], but got %s of type %s" % (obj._max_instances[0], type(obj._max_instances[0])))
        ...
        if obj._force_logging[0] is not None and obj._force_logging[0] is not obj.__undef__:
            assert isinstance(obj._force_logging[0], bool), ("Expected one of [u'boolean'], but got %s of type %s" % (obj._force_logging[0], type(obj._force_logging[0])))
        ...
        if obj._max_log_files[0] is not None and obj._max_log_files[0] is not obj.__undef__:
            assert isinstance(obj._max_log_files[0], int), ("Expected one of [u'integer'], but got %s of type %s" % (obj._max_log_files[0], type(obj._max_log_files[0])))
        ...
        if obj._max_data_files[0] is not None and obj._max_data_files[0] is not obj.__undef__:
            assert isinstance(obj._max_data_files[0], int), ("Expected one of [u'integer'], but got %s of type %s" % (obj._max_data_files[0], type(obj._max_data_files[0])))
        ...
        if obj._delphix_username[0] is not None and obj._delphix_username[0] is not obj.__undef__:
            assert isinstance(obj._delphix_username[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._delphix_username[0], type(obj._delphix_username[0])))
        ...
        if obj._grant_select_any_dictionary[0] is not None and obj._grant_select_any_dictionary[0] is not obj.__undef__:
            assert isinstance(obj._grant_select_any_dictionary[0], bool), ("Expected one of [u'boolean'], but got %s of type %s" % (obj._grant_select_any_dictionary[0], type(obj._grant_select_any_dictionary[0])))
        ...
        if obj._sys_password[0] is not None and obj._sys_password[0] is not obj.__undef__:
            assert isinstance(obj._sys_password[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._sys_password[0], type(obj._sys_password[0])))
        ...
        if obj._delphix_password[0] is not None and obj._delphix_password[0] is not obj.__undef__:
            assert isinstance(obj._delphix_password[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._delphix_password[0], type(obj._delphix_password[0])))
        ...
        if obj._national_character_set[0] is not None and obj._national_character_set[0] is not obj.__undef__:
            assert isinstance(obj._national_character_set[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._national_character_set[0], type(obj._national_character_set[0])))
        ...
        if obj._max_log_history[0] is not None and obj._max_log_history[0] is not obj.__undef__:
            assert isinstance(obj._max_log_history[0], int), ("Expected one of [u'integer'], but got %s of type %s" % (obj._max_log_history[0], type(obj._max_log_history[0])))
        ...
        if obj._system_password[0] is not None and obj._system_password[0] is not obj.__undef__:
            assert isinstance(obj._system_password[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._system_password[0], type(obj._system_password[0])))
    ...
    def is_dirty(self):
        return any([self._source_config[1], self._character_set[1], self._container[1], self._timezone_file_version[1], self._max_instances[1], self._source[1], self._force_logging[1], self._max_log_files[1], self._max_data_files[1], self._sys_datafile[1], self._redo_logs[1], self._temp_tablespace[1], self._delphix_username[1], self._grant_select_any_dictionary[1], self._sys_password[1], self._sysaux_datafile[1], self._delphix_password[1], self._national_character_set[1], self._undo_tablespace[1], self._max_log_history[1], self._system_password[1]])
    ...
    def __eq__(self, other):
        ...
        return super(OracleDatabaseCreationParameters, self).__eq__(other) and \
               ...
               self.system_password == other.system_password
