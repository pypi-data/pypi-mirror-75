...
class Policy(UserObject):
    """
    *(extends* :py:class:`v1_9_1.web.vo.UserObject` *)* The base policy type.
    """
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._default[0] is not None and obj._default[0] is not obj.__undef__:
            assert isinstance(obj._default[0], bool), ("Expected one of [u'boolean'], but got %s of type %s" % (obj._default[0], type(obj._default[0])))
        ...
        if obj._effective_type[0] is not None and obj._effective_type[0] is not obj.__undef__:
            assert isinstance(obj._effective_type[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._effective_type[0], type(obj._effective_type[0])))
        ...
        if obj._customized[0] is not None and obj._customized[0] is not obj.__undef__:
            assert isinstance(obj._customized[0], bool), ("Expected one of [u'boolean'], but got %s of type %s" % (obj._customized[0], type(obj._customized[0])))
