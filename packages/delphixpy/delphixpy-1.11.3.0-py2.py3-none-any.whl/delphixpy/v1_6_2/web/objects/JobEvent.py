    ...
    *(extends* :py:class:`v1_6_2.web.vo.TypedObject` *)* Represents a job event
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._message_command_output[0] is not None and obj._message_command_output[0] is not obj.__undef__:
            assert isinstance(obj._message_command_output[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._message_command_output[0], type(obj._message_command_output[0])))
        ...
        if obj._message_details[0] is not None and obj._message_details[0] is not obj.__undef__:
            assert isinstance(obj._message_details[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._message_details[0], type(obj._message_details[0])))
        ...
        if obj._message_action[0] is not None and obj._message_action[0] is not obj.__undef__:
            assert isinstance(obj._message_action[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._message_action[0], type(obj._message_action[0])))
        ...
        if obj._message_code[0] is not None and obj._message_code[0] is not obj.__undef__:
            assert isinstance(obj._message_code[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._message_code[0], type(obj._message_code[0])))
    ...
    def is_dirty(self):
        return any([self._diagnoses[1], self._message_command_output[1], self._timestamp[1], self._message_details[1], self._message_action[1], self._state[1], self._percent_complete[1], self._message_code[1]])
