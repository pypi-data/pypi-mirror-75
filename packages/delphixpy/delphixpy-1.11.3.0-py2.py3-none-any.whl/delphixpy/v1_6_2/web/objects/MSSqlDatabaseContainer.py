    ...
    *(extends* :py:class:`v1_6_2.web.vo.DatabaseContainer` *)* A MSSQL Database
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._validated_sync_mode[0] is not None and obj._validated_sync_mode[0] is not obj.__undef__:
            ...
            assert obj._validated_sync_mode[0] in [u'DELPHIX_MANAGED', u'TRANSACTION_LOG', u'FULL_OR_DIFFERENTIAL', u'FULL'], "Expected enum [u'DELPHIX_MANAGED', u'TRANSACTION_LOG', u'FULL_OR_DIFFERENTIAL', u'FULL'] but got %s" % obj._validated_sync_mode[0]
