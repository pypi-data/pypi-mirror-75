    ...
    *(extends* :py:class:`v1_6_2.web.vo.SchedulePolicy` *)* This policy
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._provision_source[0] is not None and obj._provision_source[0] is not obj.__undef__:
            assert isinstance(obj._provision_source[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._provision_source[0], type(obj._provision_source[0])))
    ...
    def to_dict(self, dirty=False, belongs_to_parent=False):
        dct = super(RefreshPolicy, self).to_dict(dirty, belongs_to_parent)
        ...
        def dictify(obj, prop_is_list_or_vo=False):
            if isinstance(obj, list):
                ...
                return obj
        if "provision_source" == "type" or (self.provision_source is not self.__undef__ and (not (dirty and not self._provision_source[1]) or isinstance(self.provision_source, list) or belongs_to_parent)):
