    ...
    *(extends* :py:class:`v1_6_2.web.vo.DBContainerRuntime` *)* Runtime
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._cross_platform_script_uploaded[0] is not None and obj._cross_platform_script_uploaded[0] is not obj.__undef__:
            assert isinstance(obj._cross_platform_script_uploaded[0], bool), ("Expected one of [u'boolean'], but got %s of type %s" % (obj._cross_platform_script_uploaded[0], type(obj._cross_platform_script_uploaded[0])))
        ...
        if obj._live_source_eligible[0] is not None and obj._live_source_eligible[0] is not obj.__undef__:
            assert isinstance(obj._live_source_eligible[0], bool), ("Expected one of [u'boolean'], but got %s of type %s" % (obj._live_source_eligible[0], type(obj._live_source_eligible[0])))
        ...
        if obj._cross_platform_eligible[0] is not None and obj._cross_platform_eligible[0] is not obj.__undef__:
            assert isinstance(obj._cross_platform_eligible[0], bool), ("Expected one of [u'boolean'], but got %s of type %s" % (obj._cross_platform_eligible[0], type(obj._cross_platform_eligible[0])))
    ...
    def is_dirty(self):
        return any([self._cross_platform_script_uploaded[1], self._live_source_eligible[1], self._cross_platform_eligible[1]])
