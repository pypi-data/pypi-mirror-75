    ...
    *(extends* :py:class:`v1_6_2.web.vo.NamedUserObject` *)* Data for a
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._creation_type[0] is not None and obj._creation_type[0] is not obj.__undef__:
            ...
            assert obj._creation_type[0] in [u'INITIAL', u'INDETERMINATE', u'REFRESH', u'ROLLBACK', u'TEMPORARY', u'V2P', u'PDB_PLUG', u'WAREHOUSE', u'ORACLE_LIVE_SOURCE_RESYNC'], "Expected enum [u'INITIAL', u'INDETERMINATE', u'REFRESH', u'ROLLBACK', u'TEMPORARY', u'V2P', u'PDB_PLUG', u'WAREHOUSE', u'ORACLE_LIVE_SOURCE_RESYNC'] but got %s" % obj._creation_type[0]
