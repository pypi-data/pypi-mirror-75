...
def get_all(engine, root_cause=None, bundle_id=None, severity=None, target=None):
    """
    ...
    query_params = {"rootCause": root_cause, "target": target, "severity": severity, "bundleID": bundle_id}
