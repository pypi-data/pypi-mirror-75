...
class Host(ReadonlyNamedUserObject):
    ...
    *(extends* :py:class:`v1_9_2.web.vo.ReadonlyNamedUserObject` *)* The
    ...
    def is_dirty(self):
        return any([self._host_configuration[1], self._date_added[1], self._privilege_elevation_profile[1], self._address[1], self._host_runtime[1], self._nfs_address_list[1], self._ssh_port[1]])
