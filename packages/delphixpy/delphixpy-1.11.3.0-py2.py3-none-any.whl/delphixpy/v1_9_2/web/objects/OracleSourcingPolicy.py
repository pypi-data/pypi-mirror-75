    ...
    *(extends* :py:class:`v1_9_2.web.vo.SourcingPolicy` *)* Database policies
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._logsync_mode[0] is not None and obj._logsync_mode[0] is not obj.__undef__:
            assert isinstance(obj._logsync_mode[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._logsync_mode[0], type(obj._logsync_mode[0])))
            assert obj._logsync_mode[0] in [u'ARCHIVE_ONLY_MODE', u'ARCHIVE_REDO_MODE', u'STAGING_MODE', u'UNDEFINED'], "Expected enum [u'ARCHIVE_ONLY_MODE', u'ARCHIVE_REDO_MODE', u'STAGING_MODE', u'UNDEFINED'] but got %s" % obj._logsync_mode[0]
        ...
        if obj._logsync_interval[0] is not None and obj._logsync_interval[0] is not obj.__undef__:
            assert isinstance(obj._logsync_interval[0], int), ("Expected one of [u'integer'], but got %s of type %s" % (obj._logsync_interval[0], type(obj._logsync_interval[0])))
