    ...
    *(extends* :py:class:`v1_9_2.web.vo.TypedObject` *)* The space usage
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._externally_referenced[0] is not None and obj._externally_referenced[0] is not obj.__undef__:
            assert isinstance(obj._externally_referenced[0], float), ("Expected one of [u'number'], but got %s of type %s" % (obj._externally_referenced[0], type(obj._externally_referenced[0])))
        ...
        if obj._shared[0] is not None and obj._shared[0] is not obj.__undef__:
            assert isinstance(obj._shared[0], float), ("Expected one of [u'number'], but got %s of type %s" % (obj._shared[0], type(obj._shared[0])))
