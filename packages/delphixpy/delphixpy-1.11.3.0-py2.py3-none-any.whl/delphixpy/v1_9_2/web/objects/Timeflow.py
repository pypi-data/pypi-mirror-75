    ...
    *(extends* :py:class:`v1_9_2.web.vo.NamedUserObject` *)* Data for a
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._parent_snapshot[0] is not None and obj._parent_snapshot[0] is not obj.__undef__:
            assert isinstance(obj._parent_snapshot[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._parent_snapshot[0], type(obj._parent_snapshot[0])))
        ...
        if obj._creation_type[0] is not None and obj._creation_type[0] is not obj.__undef__:
            assert isinstance(obj._creation_type[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._creation_type[0], type(obj._creation_type[0])))
            assert obj._creation_type[0] in [u'INITIAL', u'INDETERMINATE', u'REFRESH', u'ROLLBACK', u'TEMPORARY', u'TRANSFORMATION', u'V2P', u'PDB_PLUG', u'WAREHOUSE', u'ORACLE_LIVE_SOURCE_RESYNC', u'SOURCE_CONTINUITY'], "Expected enum [u'INITIAL', u'INDETERMINATE', u'REFRESH', u'ROLLBACK', u'TEMPORARY', u'TRANSFORMATION', u'V2P', u'PDB_PLUG', u'WAREHOUSE', u'ORACLE_LIVE_SOURCE_RESYNC', u'SOURCE_CONTINUITY'] but got %s" % obj._creation_type[0]
