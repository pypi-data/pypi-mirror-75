    ...
    *(extends* :py:class:`v1_9_2.web.vo.UserObject` *)* Replication setup.
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._description[0] is not None and obj._description[0] is not obj.__undef__:
            assert isinstance(obj._description[0], TEXT_TYPE), ("Expected one of [u'string', u'null'], but got %s of type %s" % (obj._description[0], type(obj._description[0])))
        ...
        if obj._schedule[0] is not None and obj._schedule[0] is not obj.__undef__:
            assert isinstance(obj._schedule[0], TEXT_TYPE), ("Expected one of [u'string', u'null'], but got %s of type %s" % (obj._schedule[0], type(obj._schedule[0])))
        ...
        if obj._encrypted[0] is not None and obj._encrypted[0] is not obj.__undef__:
            assert isinstance(obj._encrypted[0], bool), ("Expected one of [u'boolean'], but got %s of type %s" % (obj._encrypted[0], type(obj._encrypted[0])))
        ...
        if obj._automatic_replication[0] is not None and obj._automatic_replication[0] is not obj.__undef__:
            assert isinstance(obj._automatic_replication[0], bool), ("Expected one of [u'boolean'], but got %s of type %s" % (obj._automatic_replication[0], type(obj._automatic_replication[0])))
        ...
        if obj._tag[0] is not None and obj._tag[0] is not obj.__undef__:
            assert isinstance(obj._tag[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._tag[0], type(obj._tag[0])))
        ...
        if obj._use_system_socks_setting[0] is not None and obj._use_system_socks_setting[0] is not obj.__undef__:
            assert isinstance(obj._use_system_socks_setting[0], bool), ("Expected one of [u'boolean'], but got %s of type %s" % (obj._use_system_socks_setting[0], type(obj._use_system_socks_setting[0])))
        ...
        if obj._target_principal[0] is not None and obj._target_principal[0] is not obj.__undef__:
            assert isinstance(obj._target_principal[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._target_principal[0], type(obj._target_principal[0])))
        ...
        if obj._target_port[0] is not None and obj._target_port[0] is not obj.__undef__:
            assert isinstance(obj._target_port[0], int), ("Expected one of [u'integer'], but got %s of type %s" % (obj._target_port[0], type(obj._target_port[0])))
        ...
        if obj._target_host[0] is not None and obj._target_host[0] is not obj.__undef__:
            assert isinstance(obj._target_host[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._target_host[0], type(obj._target_host[0])))
    ...
    def is_dirty(self):
        return any([self._object_specification[1], self._target_credential[1], self._description[1], self._schedule[1], self._encrypted[1], self._number_of_connections[1], self._automatic_replication[1], self._tag[1], self._use_system_socks_setting[1], self._target_principal[1], self._target_port[1], self._target_host[1], self._runtime[1], self._bandwidth_limit[1]])
