    ...
    *(extends* :py:class:`v1_9_2.web.vo.TypedObject` *)* An Oracle log on a
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._sequence[0] is not None and obj._sequence[0] is not obj.__undef__:
            assert isinstance(obj._sequence[0], int), ("Expected one of [u'integer'], but got %s of type %s" % (obj._sequence[0], type(obj._sequence[0])))
        ...
        if obj._instance_num[0] is not None and obj._instance_num[0] is not obj.__undef__:
            assert isinstance(obj._instance_num[0], int), ("Expected one of [u'integer'], but got %s of type %s" % (obj._instance_num[0], type(obj._instance_num[0])))
        ...
        if obj._start_scn[0] is not None and obj._start_scn[0] is not obj.__undef__:
            assert isinstance(obj._start_scn[0], int), ("Expected one of [u'integer'], but got %s of type %s" % (obj._start_scn[0], type(obj._start_scn[0])))
        ...
        if obj._end_scn[0] is not None and obj._end_scn[0] is not obj.__undef__:
            assert isinstance(obj._end_scn[0], int), ("Expected one of [u'integer'], but got %s of type %s" % (obj._end_scn[0], type(obj._end_scn[0])))
