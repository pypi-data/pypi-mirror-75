...
def get(engine, ref):
    ...
    :param engine: The Delphix Engine
    :type engine: :py:class:`delphixpy.v1_8_0.delphix_engine.DelphixEngine`
    :param ref: Reference to a :py:class:`delphixpy.v1_8_0.web.objects.OracleCl
        usterNode.OracleClusterNode` object
    :type ref: ``str``
    :rtype: :py:class:`v1_8_0.web.vo.OracleClusterNode`
    """
    assert API_VERSION == engine.API_VERSION, "Wrong API version (%s) for parameter 'engine' (%s)" % (API_VERSION, engine.API_VERSION)
...
def get_all(engine, cluster=None):
    ...
    :rtype: ``list`` of :py:class:`v1_8_0.web.vo.OracleClusterNode`
    """
    assert API_VERSION == engine.API_VERSION, "Wrong API version (%s) for parameter 'engine' (%s)" % (API_VERSION, engine.API_VERSION)
    url = "/resources/json/delphix/environment/oracle/clusternode"
...
def update(engine, ref, oracle_cluster_node=None):
    ...
    :type oracle_cluster_node: :py:class:`v1_8_0.web.vo.OracleClusterNode`
    """
    assert API_VERSION == engine.API_VERSION, "Wrong API version (%s) for parameter 'engine' (%s)" % (API_VERSION, engine.API_VERSION)
    url = "/resources/json/delphix/environment/oracle/clusternode/%s" % ref
