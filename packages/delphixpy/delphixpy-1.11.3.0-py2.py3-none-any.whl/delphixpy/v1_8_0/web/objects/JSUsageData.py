...
class JSUsageData(PersistentObject):
    """
    *(extends* :py:class:`v1_8_0.web.vo.PersistentObject` *)* Usage data used
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._start_date[0] is not None and obj._start_date[0] is not obj.__undef__:
            assert isinstance(obj._start_date[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._start_date[0], type(obj._start_date[0])))
        ...
        if obj._usage_object[0] is not None and obj._usage_object[0] is not obj.__undef__:
            assert isinstance(obj._usage_object[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._usage_object[0], type(obj._usage_object[0])))
