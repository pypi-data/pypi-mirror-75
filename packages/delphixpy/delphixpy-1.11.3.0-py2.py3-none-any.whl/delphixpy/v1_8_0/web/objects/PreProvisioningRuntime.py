    ...
    *(extends* :py:class:`v1_8_0.web.vo.TypedObject` *)* Runtime properties for
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._pending_action[0] is not None and obj._pending_action[0] is not obj.__undef__:
            assert isinstance(obj._pending_action[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._pending_action[0], type(obj._pending_action[0])))
        ...
        if obj._last_update_timestamp[0] is not None and obj._last_update_timestamp[0] is not obj.__undef__:
            assert isinstance(obj._last_update_timestamp[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._last_update_timestamp[0], type(obj._last_update_timestamp[0])))
        ...
        if obj._pre_provisioning_state[0] is not None and obj._pre_provisioning_state[0] is not obj.__undef__:
            assert isinstance(obj._pre_provisioning_state[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._pre_provisioning_state[0], type(obj._pre_provisioning_state[0])))
    ...
    def is_dirty(self):
        return any([self._status[1], self._response[1], self._pending_action[1], self._last_update_timestamp[1], self._pre_provisioning_state[1]])
