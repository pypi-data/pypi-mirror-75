    ...
    *(extends* :py:class:`v1_8_0.web.vo.LinkData` *)* MSSQL specific parameters
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._backup_uuid[0] is not None and obj._backup_uuid[0] is not obj.__undef__:
            assert isinstance(obj._backup_uuid[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._backup_uuid[0], type(obj._backup_uuid[0])))
        ...
        if obj._delphix_managed[0] is not None and obj._delphix_managed[0] is not obj.__undef__:
            assert isinstance(obj._delphix_managed[0], bool), ("Expected one of [u'boolean'], but got %s of type %s" % (obj._delphix_managed[0], type(obj._delphix_managed[0])))
        ...
        if obj._shared_backup_location[0] is not None and obj._shared_backup_location[0] is not obj.__undef__:
            assert isinstance(obj._shared_backup_location[0], TEXT_TYPE), ("Expected one of [u'string', u'null'], but got %s of type %s" % (obj._shared_backup_location[0], type(obj._shared_backup_location[0])))
        ...
        if obj._validated_sync_mode[0] is not None and obj._validated_sync_mode[0] is not obj.__undef__:
            assert isinstance(obj._validated_sync_mode[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._validated_sync_mode[0], type(obj._validated_sync_mode[0])))
        ...
        if obj._ppt_repository[0] is not None and obj._ppt_repository[0] is not obj.__undef__:
            assert isinstance(obj._ppt_repository[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._ppt_repository[0], type(obj._ppt_repository[0])))
        ...
        if obj._backup_location_user[0] is not None and obj._backup_location_user[0] is not obj.__undef__:
            assert isinstance(obj._backup_location_user[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._backup_location_user[0], type(obj._backup_location_user[0])))
        ...
        if obj._staging_post_script[0] is not None and obj._staging_post_script[0] is not obj.__undef__:
            assert isinstance(obj._staging_post_script[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._staging_post_script[0], type(obj._staging_post_script[0])))
        ...
        if obj._ppt_host_user[0] is not None and obj._ppt_host_user[0] is not obj.__undef__:
            assert isinstance(obj._ppt_host_user[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._ppt_host_user[0], type(obj._ppt_host_user[0])))
        ...
        if obj._source_host_user[0] is not None and obj._source_host_user[0] is not obj.__undef__:
            assert isinstance(obj._source_host_user[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._source_host_user[0], type(obj._source_host_user[0])))
        ...
        if obj._staging_pre_script[0] is not None and obj._staging_pre_script[0] is not obj.__undef__:
            assert isinstance(obj._staging_pre_script[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._staging_pre_script[0], type(obj._staging_pre_script[0])))
        ...
        if obj._encryption_key[0] is not None and obj._encryption_key[0] is not obj.__undef__:
            assert isinstance(obj._encryption_key[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._encryption_key[0], type(obj._encryption_key[0])))
    ...
    def is_dirty(self):
        return any([self._operations[1], self._backup_uuid[1], self._external_file_path[1], self._delphix_managed[1], self._shared_backup_location[1], self._validated_sync_mode[1], self._ppt_repository[1], self._backup_location_credentials[1], self._backup_location_user[1], self._staging_post_script[1], self._ppt_host_user[1], self._db_credentials[1], self._db_user[1], self._source_host_user[1], self._staging_pre_script[1], self._config[1], self._encryption_key[1]])
