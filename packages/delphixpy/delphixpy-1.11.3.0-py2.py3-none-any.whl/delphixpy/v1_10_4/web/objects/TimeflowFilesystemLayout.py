    ...
    *(extends* :py:class:`v1_10_4.web.vo.FilesystemLayout` *)* A filesystem
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._target_directory[0] is not None and obj._target_directory[0] is not obj.__undef__:
            assert isinstance(obj._target_directory[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._target_directory[0], type(obj._target_directory[0])))
        ...
        if obj._data_directory[0] is not None and obj._data_directory[0] is not obj.__undef__:
            assert isinstance(obj._data_directory[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._data_directory[0], type(obj._data_directory[0])))
        ...
        if obj._archive_directory[0] is not None and obj._archive_directory[0] is not obj.__undef__:
            assert isinstance(obj._archive_directory[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._archive_directory[0], type(obj._archive_directory[0])))
        ...
        if obj._external_directory[0] is not None and obj._external_directory[0] is not obj.__undef__:
            assert isinstance(obj._external_directory[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._external_directory[0], type(obj._external_directory[0])))
        ...
        if obj._temp_directory[0] is not None and obj._temp_directory[0] is not obj.__undef__:
            assert isinstance(obj._temp_directory[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._temp_directory[0], type(obj._temp_directory[0])))
        ...
        if obj._script_directory[0] is not None and obj._script_directory[0] is not obj.__undef__:
            assert isinstance(obj._script_directory[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._script_directory[0], type(obj._script_directory[0])))
