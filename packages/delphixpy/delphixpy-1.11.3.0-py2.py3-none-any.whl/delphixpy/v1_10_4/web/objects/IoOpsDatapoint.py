    ...
    *(extends* :py:class:`v1_10_4.web.vo.Datapoint` *)* An analytics datapoint
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._count[0] is not None and obj._count[0] is not obj.__undef__:
            assert isinstance(obj._count[0], int), ("Expected one of [u'integer'], but got %s of type %s" % (obj._count[0], type(obj._count[0])))
        ...
        if obj._latency[0] is not None and obj._latency[0] is not obj.__undef__:
            assert isinstance(obj._latency[0], dict), ("Expected one of [u'object'], but got %s of type %s" % (obj._latency[0], type(obj._latency[0])))
        ...
        if obj._avg_latency[0] is not None and obj._avg_latency[0] is not obj.__undef__:
            assert isinstance(obj._avg_latency[0], int), ("Expected one of [u'integer'], but got %s of type %s" % (obj._avg_latency[0], type(obj._avg_latency[0])))
        ...
        if obj._throughput[0] is not None and obj._throughput[0] is not obj.__undef__:
            assert isinstance(obj._throughput[0], int), ("Expected one of [u'integer'], but got %s of type %s" % (obj._throughput[0], type(obj._throughput[0])))
        ...
        if obj._size[0] is not None and obj._size[0] is not obj.__undef__:
            assert isinstance(obj._size[0], dict), ("Expected one of [u'object'], but got %s of type %s" % (obj._size[0], type(obj._size[0])))
