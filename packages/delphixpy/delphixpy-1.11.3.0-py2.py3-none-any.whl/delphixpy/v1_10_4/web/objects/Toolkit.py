    ...
    *(extends* :py:class:`v1_10_4.web.vo.NamedUserObject` *)* An installed
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._language[0] is not None and obj._language[0] is not obj.__undef__:
            assert isinstance(obj._language[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._language[0], type(obj._language[0])))
            assert obj._language[0] in [u'LUA', u'PYTHON27'], "Expected enum [u'LUA', u'PYTHON27'] but got %s" % obj._language[0]
        ...
        if obj._root_squash_enabled[0] is not None and obj._root_squash_enabled[0] is not obj.__undef__:
            assert isinstance(obj._root_squash_enabled[0], bool), ("Expected one of [u'boolean'], but got %s of type %s" % (obj._root_squash_enabled[0], type(obj._root_squash_enabled[0])))
        ...
        if obj._default_locale[0] is not None and obj._default_locale[0] is not obj.__undef__:
            assert isinstance(obj._default_locale[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._default_locale[0], type(obj._default_locale[0])))
        ...
        if obj._entry_point[0] is not None and obj._entry_point[0] is not obj.__undef__:
            assert isinstance(obj._entry_point[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._entry_point[0], type(obj._entry_point[0])))
        ...
        if obj._pretty_name[0] is not None and obj._pretty_name[0] is not obj.__undef__:
            assert isinstance(obj._pretty_name[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._pretty_name[0], type(obj._pretty_name[0])))
        ...
        if obj._source_code[0] is not None and obj._source_code[0] is not obj.__undef__:
            assert isinstance(obj._source_code[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._source_code[0], type(obj._source_code[0])))
        ...
        if obj._resources[0] is not None and obj._resources[0] is not obj.__undef__:
            assert isinstance(obj._resources[0], dict), ("Expected one of [u'object'], but got %s of type %s" % (obj._resources[0], type(obj._resources[0])))
    ...
    def is_dirty(self):
        return any([self._discovery_definition[1], self._snapshot_schema[1], self._name[1], self._language[1], self._root_squash_enabled[1], self._build_api[1], self._virtual_source_definition[1], self._messages[1], self._host_types[1], self._version[1], self._default_locale[1], self._upgrade_definition[1], self._linked_source_definition[1], self._entry_point[1], self._pretty_name[1], self._source_code[1], self._resources[1]])
