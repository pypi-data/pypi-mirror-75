    ...
    *(extends* :py:class:`v1_10_4.web.vo.TypedObject` *)* SAML Single Sign-on
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._saml_metadata[0] is not None and obj._saml_metadata[0] is not obj.__undef__:
            assert isinstance(obj._saml_metadata[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._saml_metadata[0], type(obj._saml_metadata[0])))
        ...
        if obj._cloud_sso[0] is not None and obj._cloud_sso[0] is not obj.__undef__:
            assert isinstance(obj._cloud_sso[0], bool), ("Expected one of [u'boolean'], but got %s of type %s" % (obj._cloud_sso[0], type(obj._cloud_sso[0])))
    ...
    def is_dirty(self):
        return any([self._saml_metadata[1], self._cloud_sso[1], self._enabled[1]])
    ...
    def __eq__(self, other):
        ...
        return super(SsoConfig, self).__eq__(other) and \
               ...
               self.cloud_sso == other.cloud_sso and \
