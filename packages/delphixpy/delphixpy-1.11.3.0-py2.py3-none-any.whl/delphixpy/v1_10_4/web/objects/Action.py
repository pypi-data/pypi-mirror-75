    ...
    *(extends* :py:class:`v1_10_4.web.vo.PersistentObject` *)* Represents an
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._origin_ip[0] is not None and obj._origin_ip[0] is not obj.__undef__:
            assert isinstance(obj._origin_ip[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._origin_ip[0], type(obj._origin_ip[0])))
        ...
        if obj._failure_message_code[0] is not None and obj._failure_message_code[0] is not obj.__undef__:
            assert isinstance(obj._failure_message_code[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._failure_message_code[0], type(obj._failure_message_code[0])))
        ...
        if obj._failure_description[0] is not None and obj._failure_description[0] is not obj.__undef__:
            assert isinstance(obj._failure_description[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._failure_description[0], type(obj._failure_description[0])))
        ...
        if obj._work_source_name[0] is not None and obj._work_source_name[0] is not obj.__undef__:
            assert isinstance(obj._work_source_name[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._work_source_name[0], type(obj._work_source_name[0])))
        ...
        if obj._report[0] is not None and obj._report[0] is not obj.__undef__:
            assert isinstance(obj._report[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._report[0], type(obj._report[0])))
        ...
        if obj._work_source[0] is not None and obj._work_source[0] is not obj.__undef__:
            assert isinstance(obj._work_source[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._work_source[0], type(obj._work_source[0])))
        ...
        if obj._failure_action[0] is not None and obj._failure_action[0] is not obj.__undef__:
            assert isinstance(obj._failure_action[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._failure_action[0], type(obj._failure_action[0])))
        ...
        if obj._work_source_principal[0] is not None and obj._work_source_principal[0] is not obj.__undef__:
            assert isinstance(obj._work_source_principal[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._work_source_principal[0], type(obj._work_source_principal[0])))
    ...
    def is_dirty(self):
        return any([self._title[1], self._origin_ip[1], self._failure_message_code[1], self._state[1], self._failure_description[1], self._parent_action[1], self._action_type[1], self._user[1], self._start_time[1], self._work_source_name[1], self._report[1], self._user_agent[1], self._work_source[1], self._end_time[1], self._failure_action[1], self._work_source_principal[1], self._details[1]])
