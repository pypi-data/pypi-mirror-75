...
class PemCertificate(TypedObject):
    ...
    *(extends* :py:class:`v1_10_4.web.vo.TypedObject` *)* An X.509 Certificate
    ...
    def __init__(self, undef_enabled=True):
        super(PemCertificate, self).__init__()
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        obj = super(PemCertificate, cls).from_dict(data, dirty, undef_enabled)
    ...
    def to_dict(self, dirty=False, belongs_to_parent=False):
        dct = super(PemCertificate, self).to_dict(dirty, belongs_to_parent)
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PemCertificate):
            return False
        return super(PemCertificate, self).__eq__(other) and \
