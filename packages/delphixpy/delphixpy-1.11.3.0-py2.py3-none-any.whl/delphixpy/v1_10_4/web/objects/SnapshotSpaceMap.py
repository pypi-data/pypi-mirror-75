...
class SnapshotSpaceMap(TypedObject):
    """
    *(extends* :py:class:`v1_10_4.web.vo.TypedObject` *)* Mapping of containers
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._size_map[0] is not None and obj._size_map[0] is not obj.__undef__:
            assert isinstance(obj._size_map[0], dict), ("Expected one of [u'object'], but got %s of type %s" % (obj._size_map[0], type(obj._size_map[0])))
