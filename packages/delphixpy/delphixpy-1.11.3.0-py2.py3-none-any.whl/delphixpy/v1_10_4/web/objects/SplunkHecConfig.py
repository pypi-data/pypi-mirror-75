    ...
    *(extends* :py:class:`v1_10_4.web.vo.UserObject` *)* Splunk HTTP Event
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._metrics_push_frequency[0] is not None and obj._metrics_push_frequency[0] is not obj.__undef__:
            assert isinstance(obj._metrics_push_frequency[0], int), ("Expected one of [u'integer'], but got %s of type %s" % (obj._metrics_push_frequency[0], type(obj._metrics_push_frequency[0])))
        ...
        if obj._main_index[0] is not None and obj._main_index[0] is not obj.__undef__:
            assert isinstance(obj._main_index[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._main_index[0], type(obj._main_index[0])))
        ...
        if obj._events_push_frequency[0] is not None and obj._events_push_frequency[0] is not obj.__undef__:
            assert isinstance(obj._events_push_frequency[0], int), ("Expected one of [u'integer'], but got %s of type %s" % (obj._events_push_frequency[0], type(obj._events_push_frequency[0])))
        ...
        if obj._hec_port[0] is not None and obj._hec_port[0] is not obj.__undef__:
            assert isinstance(obj._hec_port[0], int), ("Expected one of [u'integer'], but got %s of type %s" % (obj._hec_port[0], type(obj._hec_port[0])))
        ...
        if obj._hec_token[0] is not None and obj._hec_token[0] is not obj.__undef__:
            assert isinstance(obj._hec_token[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._hec_token[0], type(obj._hec_token[0])))
        ...
        if obj._enable_metrics[0] is not None and obj._enable_metrics[0] is not obj.__undef__:
            assert isinstance(obj._enable_metrics[0], bool), ("Expected one of [u'boolean'], but got %s of type %s" % (obj._enable_metrics[0], type(obj._enable_metrics[0])))
        ...
        if obj._enable_ssl[0] is not None and obj._enable_ssl[0] is not obj.__undef__:
            assert isinstance(obj._enable_ssl[0], bool), ("Expected one of [u'boolean'], but got %s of type %s" % (obj._enable_ssl[0], type(obj._enable_ssl[0])))
        ...
        if obj._host[0] is not None and obj._host[0] is not obj.__undef__:
            assert isinstance(obj._host[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._host[0], type(obj._host[0])))
        ...
        if obj._metrics_index[0] is not None and obj._metrics_index[0] is not obj.__undef__:
            assert isinstance(obj._metrics_index[0], TEXT_TYPE), ("Expected one of [u'string', u'null'], but got %s of type %s" % (obj._metrics_index[0], type(obj._metrics_index[0])))
        ...
        if obj._performance_metrics_resolution[0] is not None and obj._performance_metrics_resolution[0] is not obj.__undef__:
            assert isinstance(obj._performance_metrics_resolution[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._performance_metrics_resolution[0], type(obj._performance_metrics_resolution[0])))
            assert obj._performance_metrics_resolution[0] in [u'SECOND', u'MINUTE'], "Expected enum [u'SECOND', u'MINUTE'] but got %s" % obj._performance_metrics_resolution[0]
    ...
    def is_dirty(self):
        return any([self._metrics_push_frequency[1], self._main_index[1], self._events_push_frequency[1], self._hec_port[1], self._hec_token[1], self._enabled[1], self._enable_metrics[1], self._enable_ssl[1], self._host[1], self._metrics_index[1], self._performance_metrics_resolution[1]])
    ...
    def __eq__(self, other):
        ...
        return super(SplunkHecConfig, self).__eq__(other) and \
               self.metrics_push_frequency == other.metrics_push_frequency and \
