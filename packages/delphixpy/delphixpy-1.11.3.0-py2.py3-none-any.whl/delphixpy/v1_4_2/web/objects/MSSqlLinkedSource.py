    ...
    *(extends* :py:class:`v1_4_2.web.vo.MSSqlSource` *)* A linked MSSQL source.
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._staging_source[0] is not None and obj._staging_source[0] is not obj.__undef__:
            assert isinstance(obj._staging_source[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._staging_source[0], type(obj._staging_source[0])))
    ...
    def is_dirty(self):
        return any([self._external_file_path[1], self._staging_source[1], self._pre_script[1], self._post_script[1], self._backup_location_credentials[1], self._backup_location_user[1], self._shared_backup_location[1], self._config[1]])
