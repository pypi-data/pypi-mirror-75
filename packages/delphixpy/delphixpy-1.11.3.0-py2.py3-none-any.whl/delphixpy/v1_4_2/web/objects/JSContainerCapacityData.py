    ...
    *(extends* :py:class:`v1_4_2.web.vo.TypedObject` *)* The capacity
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._unvirtualized[0] is not None and obj._unvirtualized[0] is not obj.__undef__:
            assert isinstance(obj._unvirtualized[0], float), ("Expected one of [u'number'], but got %s of type %s" % (obj._unvirtualized[0], type(obj._unvirtualized[0])))
    ...
    def is_dirty(self):
        return any([self._data_container[1], self._referenced_by_self[1], self._unique[1], self._referenced_by_siblings[1], self._unvirtualized[1]])
