    ...
    *(extends* :py:class:`v1_5_3.web.vo.TimeflowSnapshot` *)* Provisionable
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._backup_set_uuid[0] is not None and obj._backup_set_uuid[0] is not obj.__undef__:
            assert isinstance(obj._backup_set_uuid[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._backup_set_uuid[0], type(obj._backup_set_uuid[0])))
    ...
    def is_dirty(self):
        return any([self._latest_change_point[1], self._runtime[1], self._first_change_point[1], self._internal_version[1], self._backup_set_uuid[1]])
