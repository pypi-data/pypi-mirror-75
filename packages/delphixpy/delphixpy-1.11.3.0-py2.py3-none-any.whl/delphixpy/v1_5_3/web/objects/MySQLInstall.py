    ...
    *(extends* :py:class:`v1_5_3.web.vo.SourceRepository` *)* A MySQL
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._variant[0] is not None and obj._variant[0] is not obj.__undef__:
            ...
            assert obj._variant[0] in [u'CommunityServer'], "Expected enum [u'CommunityServer'] but got %s" % obj._variant[0]
    ...
    def is_dirty(self):
        return any([self._discovered[1], self._version[1], self._variant[1], self._installation_path[1]])
    ...
    def __eq__(self, other):
        ...
        return super(MySQLInstall, self).__eq__(other) and \
               ...
               self.installation_path == other.installation_path
