    ...
    *)* Parameters used to execute a network throughput test using the Delphix
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._compression[0] is not None and obj._compression[0] is not obj.__undef__:
            assert isinstance(obj._compression[0], bool), ("Expected one of [u'boolean'], but got %s of type %s" % (obj._compression[0], type(obj._compression[0])))
        ...
        if obj._send_socket_buffer[0] is not None and obj._send_socket_buffer[0] is not obj.__undef__:
            assert isinstance(obj._send_socket_buffer[0], int), ("Expected one of [u'integer'], but got %s of type %s" % (obj._send_socket_buffer[0], type(obj._send_socket_buffer[0])))
        ...
        if obj._encryption[0] is not None and obj._encryption[0] is not obj.__undef__:
            assert isinstance(obj._encryption[0], bool), ("Expected one of [u'boolean'], but got %s of type %s" % (obj._encryption[0], type(obj._encryption[0])))
        ...
        if obj._destination_type[0] is not None and obj._destination_type[0] is not obj.__undef__:
            assert isinstance(obj._destination_type[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._destination_type[0], type(obj._destination_type[0])))
        ...
        if obj._queue_depth[0] is not None and obj._queue_depth[0] is not obj.__undef__:
            assert isinstance(obj._queue_depth[0], int), ("Expected one of [u'integer'], but got %s of type %s" % (obj._queue_depth[0], type(obj._queue_depth[0])))
        ...
        if obj._xport_scheduler[0] is not None and obj._xport_scheduler[0] is not obj.__undef__:
            assert isinstance(obj._xport_scheduler[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._xport_scheduler[0], type(obj._xport_scheduler[0])))
            assert obj._xport_scheduler[0] in [u'ROUND_ROBIN', u'LEAST_QUEUE'], "Expected enum [u'ROUND_ROBIN', u'LEAST_QUEUE'] but got %s" % obj._xport_scheduler[0]
        ...
        if obj._receive_socket_buffer[0] is not None and obj._receive_socket_buffer[0] is not obj.__undef__:
            assert isinstance(obj._receive_socket_buffer[0], int), ("Expected one of [u'integer'], but got %s of type %s" % (obj._receive_socket_buffer[0], type(obj._receive_socket_buffer[0])))
    ...
    def is_dirty(self):
        return any([self._compression[1], self._send_socket_buffer[1], self._encryption[1], self._destination_type[1], self._block_size[1], self._queue_depth[1], self._xport_scheduler[1], self._remote_delphix_engine_info[1], self._receive_socket_buffer[1]])
    ...
    def __eq__(self, other):
        ...
        return super(NetworkDSPTestParameters, self).__eq__(other) and \
               ...
               self.xport_scheduler == other.xport_scheduler and \
