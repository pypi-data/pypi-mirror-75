...
class CloudStatus(TypedObject):
    """
    *(extends* :py:class:`delphixpy.web.vo.TypedObject` *)* Delphix Cloud
    facilities.
    """
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._delphix_data_services_component_status[0] is not None and obj._delphix_data_services_component_status[0] is not obj.__undef__:
            assert isinstance(obj._delphix_data_services_component_status[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._delphix_data_services_component_status[0], type(obj._delphix_data_services_component_status[0])))
            assert obj._delphix_data_services_component_status[0] in [u'ONLINE', u'MAINTENANCE', u'DISABLED', u'STARTING', u'UNKNOWN', u'ENABLING'], "Expected enum [u'ONLINE', u'MAINTENANCE', u'DISABLED', u'STARTING', u'UNKNOWN', u'ENABLING'] but got %s" % obj._delphix_data_services_component_status[0]
    ...
    def delphix_data_services_component_info(self):
        ...
        :rtype: :py:class:`delphixpy.web.vo.DelphixDataServicesComponentInfo`
        """
