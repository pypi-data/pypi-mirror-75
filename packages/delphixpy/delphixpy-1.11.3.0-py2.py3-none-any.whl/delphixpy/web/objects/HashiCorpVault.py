...
class HashiCorpVault(PasswordVault):
    """
    *(extends* :py:class:`delphixpy.web.vo.PasswordVault` *)* HashiCorpVault
    password vault configuration.
    """
    def __init__(self, undef_enabled=True):
        super(HashiCorpVault, self).__init__()
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        obj = super(HashiCorpVault, cls).from_dict(data, dirty, undef_enabled)
    ...
    def to_dict(self, dirty=False, belongs_to_parent=False):
        dct = super(HashiCorpVault, self).to_dict(dirty, belongs_to_parent)
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, HashiCorpVault):
            return False
        return super(HashiCorpVault, self).__eq__(other) and \
