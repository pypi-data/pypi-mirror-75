    ...
    *(extends* :py:class:`delphixpy.web.vo.SourceRepository` *)* The Oracle
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._installation_home[0] is not None and obj._installation_home[0] is not obj.__undef__:
            assert isinstance(obj._installation_home[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._installation_home[0], type(obj._installation_home[0])))
        ...
        if obj._oracle_base[0] is not None and obj._oracle_base[0] is not obj.__undef__:
            assert isinstance(obj._oracle_base[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._oracle_base[0], type(obj._oracle_base[0])))
        ...
        if obj._user_id[0] is not None and obj._user_id[0] is not obj.__undef__:
            assert isinstance(obj._user_id[0], int), ("Expected one of [u'integer'], but got %s of type %s" % (obj._user_id[0], type(obj._user_id[0])))
        ...
        if obj._logsync_possible[0] is not None and obj._logsync_possible[0] is not obj.__undef__:
            assert isinstance(obj._logsync_possible[0], bool), ("Expected one of [u'boolean'], but got %s of type %s" % (obj._logsync_possible[0], type(obj._logsync_possible[0])))
        ...
        if obj._group_name[0] is not None and obj._group_name[0] is not obj.__undef__:
            assert isinstance(obj._group_name[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._group_name[0], type(obj._group_name[0])))
        ...
        if obj._version[0] is not None and obj._version[0] is not obj.__undef__:
            assert isinstance(obj._version[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._version[0], type(obj._version[0])))
        ...
        if obj._oracle_base_config[0] is not None and obj._oracle_base_config[0] is not obj.__undef__:
            assert isinstance(obj._oracle_base_config[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._oracle_base_config[0], type(obj._oracle_base_config[0])))
        ...
        if obj._oracle_base_home[0] is not None and obj._oracle_base_home[0] is not obj.__undef__:
            assert isinstance(obj._oracle_base_home[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._oracle_base_home[0], type(obj._oracle_base_home[0])))
        ...
        if obj._bits[0] is not None and obj._bits[0] is not obj.__undef__:
            assert isinstance(obj._bits[0], int), ("Expected one of [u'integer'], but got %s of type %s" % (obj._bits[0], type(obj._bits[0])))
        ...
        if obj._group_id[0] is not None and obj._group_id[0] is not obj.__undef__:
            assert isinstance(obj._group_id[0], int), ("Expected one of [u'integer'], but got %s of type %s" % (obj._group_id[0], type(obj._group_id[0])))
        ...
        if obj._rac[0] is not None and obj._rac[0] is not obj.__undef__:
            assert isinstance(obj._rac[0], bool), ("Expected one of [u'boolean'], but got %s of type %s" % (obj._rac[0], type(obj._rac[0])))
    ...
    def is_dirty(self):
        return any([self._user_name[1], self._installation_home[1], self._oracle_base[1], self._user_id[1], self._logsync_possible[1], self._discovered[1], self._group_name[1], self._version[1], self._oracle_base_config[1], self._applied_patches[1], self._oracle_base_home[1], self._bits[1], self._group_id[1], self._rac[1]])
