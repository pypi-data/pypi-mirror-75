    ...
    *(extends* :py:class:`delphixpy.web.vo.AbstractToolkit` *)* An installed
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._lua_name[0] is not None and obj._lua_name[0] is not obj.__undef__:
            assert isinstance(obj._lua_name[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._lua_name[0], type(obj._lua_name[0])))
        ...
        if obj._build_number[0] is not None and obj._build_number[0] is not obj.__undef__:
            assert isinstance(obj._build_number[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._build_number[0], type(obj._build_number[0])))
        ...
        if obj._minimum_lua_version[0] is not None and obj._minimum_lua_version[0] is not obj.__undef__:
            assert isinstance(obj._minimum_lua_version[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._minimum_lua_version[0], type(obj._minimum_lua_version[0])))
        ...
        if obj._external_version[0] is not None and obj._external_version[0] is not obj.__undef__:
            assert isinstance(obj._external_version[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._external_version[0], type(obj._external_version[0])))
    ...
    def is_dirty(self):
        return any([self._lua_name[1], self._discovery_definition[1], self._source_code[1], self._virtual_source_definition[1], self._manifest[1], self._build_number[1], self._linked_source_definition[1], self._minimum_lua_version[1], self._entry_point[1], self._upgrade_definition[1], self._external_version[1]])
    ...
    def __eq__(self, other):
        ...
        return super(Plugin, self).__eq__(other) and \
               ...
               self.external_version == other.external_version
