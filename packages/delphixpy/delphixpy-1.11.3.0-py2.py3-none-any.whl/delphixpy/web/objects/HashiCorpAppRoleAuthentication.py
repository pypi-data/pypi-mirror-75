    ...
    *(extends* :py:class:`delphixpy.web.vo.HashiCorpAuthentication` *)* AppRole
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._role_id[0] is not None and obj._role_id[0] is not obj.__undef__:
            assert isinstance(obj._role_id[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._role_id[0], type(obj._role_id[0])))
        ...
        if obj._secret_id[0] is not None and obj._secret_id[0] is not obj.__undef__:
            assert isinstance(obj._secret_id[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._secret_id[0], type(obj._secret_id[0])))
