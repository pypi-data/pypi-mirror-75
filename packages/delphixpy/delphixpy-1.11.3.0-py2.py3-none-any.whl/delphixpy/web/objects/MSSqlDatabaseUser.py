...
class MSSqlDatabaseUser(MSSqlUser):
    ...
    *(extends* :py:class:`delphixpy.web.vo.MSSqlUser` *)* Represents the mssql
    ...
    def __init__(self, undef_enabled=True):
        super(MSSqlDatabaseUser, self).__init__()
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        obj = super(MSSqlDatabaseUser, cls).from_dict(data, dirty, undef_enabled)
    ...
    def to_dict(self, dirty=False, belongs_to_parent=False):
        dct = super(MSSqlDatabaseUser, self).to_dict(dirty, belongs_to_parent)
    ...
    def is_dirty(self):
        return any([self._password[1], self._user[1]])
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, MSSqlDatabaseUser):
            return False
        return super(MSSqlDatabaseUser, self).__eq__(other) and \
