    ...
    *(extends* :py:class:`delphixpy.web.vo.UserObject` *)* Public Key
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._sha1_fingerprint[0] is not None and obj._sha1_fingerprint[0] is not obj.__undef__:
            assert isinstance(obj._sha1_fingerprint[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._sha1_fingerprint[0], type(obj._sha1_fingerprint[0])))
        ...
        if obj._not_before[0] is not None and obj._not_before[0] is not obj.__undef__:
            assert isinstance(obj._not_before[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._not_before[0], type(obj._not_before[0])))
        ...
        if obj._serial_number[0] is not None and obj._serial_number[0] is not obj.__undef__:
            assert isinstance(obj._serial_number[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._serial_number[0], type(obj._serial_number[0])))
        ...
        if obj._issued_by_dn[0] is not None and obj._issued_by_dn[0] is not obj.__undef__:
            assert isinstance(obj._issued_by_dn[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._issued_by_dn[0], type(obj._issued_by_dn[0])))
        ...
        if obj._md5_fingerprint[0] is not None and obj._md5_fingerprint[0] is not obj.__undef__:
            assert isinstance(obj._md5_fingerprint[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._md5_fingerprint[0], type(obj._md5_fingerprint[0])))
        ...
        if obj._not_after[0] is not None and obj._not_after[0] is not obj.__undef__:
            assert isinstance(obj._not_after[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._not_after[0], type(obj._not_after[0])))
        ...
        if obj._is_certificate_authority[0] is not None and obj._is_certificate_authority[0] is not obj.__undef__:
            assert isinstance(obj._is_certificate_authority[0], bool), ("Expected one of [u'boolean'], but got %s of type %s" % (obj._is_certificate_authority[0], type(obj._is_certificate_authority[0])))
        ...
        if obj._issuer[0] is not None and obj._issuer[0] is not obj.__undef__:
            assert isinstance(obj._issuer[0], TEXT_TYPE), ("Expected one of [u'string', u'null'], but got %s of type %s" % (obj._issuer[0], type(obj._issuer[0])))
    ...
    def is_dirty(self):
        return any([self._subject_alternative_names[1], self._name[1], self._sha1_fingerprint[1], self._not_before[1], self._serial_number[1], self._issued_by_dn[1], self._md5_fingerprint[1], self._not_after[1], self._is_certificate_authority[1], self._issuer[1]])
    ...
    def __eq__(self, other):
        ...
        return super(Certificate, self).__eq__(other) and \
               self.subject_alternative_names == other.subject_alternative_names and \
