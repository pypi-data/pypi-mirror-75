    ...
    *(extends* :py:class:`delphixpy.web.vo.TimeflowSnapshot` *)* Provisionable
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._from_physical_standby_vdb[0] is not None and obj._from_physical_standby_vdb[0] is not obj.__undef__:
            assert isinstance(obj._from_physical_standby_vdb[0], bool), ("Expected one of [u'boolean'], but got %s of type %s" % (obj._from_physical_standby_vdb[0], type(obj._from_physical_standby_vdb[0])))
        ...
        if obj._redo_log_size_in_bytes[0] is not None and obj._redo_log_size_in_bytes[0] is not obj.__undef__:
            assert isinstance(obj._redo_log_size_in_bytes[0], float), ("Expected one of [u'number'], but got %s of type %s" % (obj._redo_log_size_in_bytes[0], type(obj._redo_log_size_in_bytes[0])))
    ...
    def is_dirty(self):
        return any([self._from_physical_standby_vdb[1], self._latest_change_point[1], self._runtime[1], self._first_change_point[1], self._redo_log_size_in_bytes[1]])
