    ...
    *(extends* :py:class:`delphixpy.web.vo.StorageDevice` *)* A storage device
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._boot_device[0] is not None and obj._boot_device[0] is not obj.__undef__:
            assert isinstance(obj._boot_device[0], bool), ("Expected one of [u'boolean'], but got %s of type %s" % (obj._boot_device[0], type(obj._boot_device[0])))
        ...
        if obj._fragmentation[0] is not None and obj._fragmentation[0] is not obj.__undef__:
            assert isinstance(obj._fragmentation[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._fragmentation[0], type(obj._fragmentation[0])))
        ...
        if obj._used_size[0] is not None and obj._used_size[0] is not obj.__undef__:
            assert isinstance(obj._used_size[0], float), ("Expected one of [u'number'], but got %s of type %s" % (obj._used_size[0], type(obj._used_size[0])))
        ...
        if obj._expandable_size[0] is not None and obj._expandable_size[0] is not obj.__undef__:
            assert isinstance(obj._expandable_size[0], float), ("Expected one of [u'number'], but got %s of type %s" % (obj._expandable_size[0], type(obj._expandable_size[0])))
    ...
    def is_dirty(self):
        return any([self._boot_device[1], self._fragmentation[1], self._used_size[1], self._expandable_size[1]])
