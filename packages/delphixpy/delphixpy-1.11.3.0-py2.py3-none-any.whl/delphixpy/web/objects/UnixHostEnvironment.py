...
class UnixHostEnvironment(HostEnvironment):
    ...
    *(extends* :py:class:`delphixpy.web.vo.HostEnvironment` *)* The
    ...
    def to_dict(self, dirty=False, belongs_to_parent=False):
        dct = super(UnixHostEnvironment, self).to_dict(dirty, belongs_to_parent)
        ...
        def dictify(obj, prop_is_list_or_vo=False):
            if isinstance(obj, list):
                ...
                return obj
        if "ase_host_environment_parameters" == "type" or (self.ase_host_environment_parameters is not self.__undef__ and (not (dirty and not self._ase_host_environment_parameters[1]) or isinstance(self.ase_host_environment_parameters, list) or belongs_to_parent)):
