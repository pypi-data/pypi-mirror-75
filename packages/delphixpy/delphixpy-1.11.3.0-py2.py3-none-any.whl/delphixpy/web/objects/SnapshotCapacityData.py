    ...
    *(extends* :py:class:`delphixpy.web.vo.TypedObject` *)* Capacity metrics
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._manual_retention[0] is not None and obj._manual_retention[0] is not obj.__undef__:
            assert isinstance(obj._manual_retention[0], int), ("Expected one of [u'integer'], but got %s of type %s" % (obj._manual_retention[0], type(obj._manual_retention[0])))
        ...
        if obj._space[0] is not None and obj._space[0] is not obj.__undef__:
            assert isinstance(obj._space[0], float), ("Expected one of [u'number'], but got %s of type %s" % (obj._space[0], type(obj._space[0])))
        ...
        if obj._namespace[0] is not None and obj._namespace[0] is not obj.__undef__:
            assert isinstance(obj._namespace[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._namespace[0], type(obj._namespace[0])))
        ...
        if obj._snapshot[0] is not None and obj._snapshot[0] is not obj.__undef__:
            assert isinstance(obj._snapshot[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._snapshot[0], type(obj._snapshot[0])))
        ...
        if obj._snapshot_timestamp[0] is not None and obj._snapshot_timestamp[0] is not obj.__undef__:
            assert isinstance(obj._snapshot_timestamp[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._snapshot_timestamp[0], type(obj._snapshot_timestamp[0])))
        ...
        if obj._policy_retention[0] is not None and obj._policy_retention[0] is not obj.__undef__:
            assert isinstance(obj._policy_retention[0], bool), ("Expected one of [u'boolean'], but got %s of type %s" % (obj._policy_retention[0], type(obj._policy_retention[0])))
    ...
    def is_dirty(self):
        return any([self._descendant_vd_bs[1], self._manual_retention[1], self._container[1], self._space[1], self._namespace[1], self._snapshot[1], self._snapshot_timestamp[1], self._policy_retention[1]])
