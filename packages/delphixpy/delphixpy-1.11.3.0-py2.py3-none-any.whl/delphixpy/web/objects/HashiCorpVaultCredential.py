    ...
    *(extends* :py:class:`delphixpy.web.vo.AbstractVaultCredential` *)* The
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._engine[0] is not None and obj._engine[0] is not obj.__undef__:
            assert isinstance(obj._engine[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._engine[0], type(obj._engine[0])))
        ...
        if obj._vault[0] is not None and obj._vault[0] is not obj.__undef__:
            assert isinstance(obj._vault[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._vault[0], type(obj._vault[0])))
        ...
        if obj._secret_key[0] is not None and obj._secret_key[0] is not obj.__undef__:
            assert isinstance(obj._secret_key[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._secret_key[0], type(obj._secret_key[0])))
        ...
        if obj._username_key[0] is not None and obj._username_key[0] is not obj.__undef__:
            assert isinstance(obj._username_key[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._username_key[0], type(obj._username_key[0])))
    ...
    def is_dirty(self):
        return any([self._engine[1], self._vault[1], self._secret_key[1], self._username_key[1], self._path[1]])
