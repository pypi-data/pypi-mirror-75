    ...
    *(extends* :py:class:`delphixpy.web.vo.SourceEnvironment` *)* The
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._remote_listener[0] is not None and obj._remote_listener[0] is not obj.__undef__:
            assert isinstance(obj._remote_listener[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._remote_listener[0], type(obj._remote_listener[0])))
        ...
        if obj._scan[0] is not None and obj._scan[0] is not obj.__undef__:
            assert isinstance(obj._scan[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._scan[0], type(obj._scan[0])))
        ...
        if obj._scan_manual[0] is not None and obj._scan_manual[0] is not obj.__undef__:
            assert isinstance(obj._scan_manual[0], bool), ("Expected one of [u'boolean'], but got %s of type %s" % (obj._scan_manual[0], type(obj._scan_manual[0])))
        ...
        if obj._cluster_user[0] is not None and obj._cluster_user[0] is not obj.__undef__:
            assert isinstance(obj._cluster_user[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._cluster_user[0], type(obj._cluster_user[0])))
        ...
        if obj._crs_cluster_name[0] is not None and obj._crs_cluster_name[0] is not obj.__undef__:
            assert isinstance(obj._crs_cluster_name[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._crs_cluster_name[0], type(obj._crs_cluster_name[0])))
        ...
        if obj._crs_cluster_home[0] is not None and obj._crs_cluster_home[0] is not obj.__undef__:
            assert isinstance(obj._crs_cluster_home[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._crs_cluster_home[0], type(obj._crs_cluster_home[0])))
    ...
    def is_dirty(self):
        return any([self._remote_listener[1], self._name[1], self._scan[1], self._scan_manual[1], self._cluster_user[1], self._crs_cluster_name[1], self._crs_cluster_home[1], self._version[1]])
