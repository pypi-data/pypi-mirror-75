...
class PluginVirtualSourceDefinition(TypedObject):
    ...
    *(extends* :py:class:`delphixpy.web.vo.TypedObject` *)* A virtual source
    ...
    def __init__(self, undef_enabled=True):
        super(PluginVirtualSourceDefinition, self).__init__()
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        obj = super(PluginVirtualSourceDefinition, cls).from_dict(data, dirty, undef_enabled)
    ...
    def to_dict(self, dirty=False, belongs_to_parent=False):
        dct = super(PluginVirtualSourceDefinition, self).to_dict(dirty, belongs_to_parent)
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PluginVirtualSourceDefinition):
            return False
        return super(PluginVirtualSourceDefinition, self).__eq__(other) and \
