    ...
    *(extends* :py:class:`v1_11_0.web.vo.TypedObject` *)* The status of a scrub
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._errors[0] is not None and obj._errors[0] is not obj.__undef__:
            assert isinstance(obj._errors[0], float), ("Expected one of [u'number'], but got %s of type %s" % (obj._errors[0], type(obj._errors[0])))
        ...
        if obj._completed[0] is not None and obj._completed[0] is not obj.__undef__:
            assert isinstance(obj._completed[0], float), ("Expected one of [u'number'], but got %s of type %s" % (obj._completed[0], type(obj._completed[0])))
        ...
        if obj._state[0] is not None and obj._state[0] is not obj.__undef__:
            ...
            assert obj._state[0] in [u'NONE', u'ACTIVE', u'COMPLETED', u'CANCELED', u'PAUSED'], "Expected enum [u'NONE', u'ACTIVE', u'COMPLETED', u'CANCELED', u'PAUSED'] but got %s" % obj._state[0]
        ...
        if obj._total[0] is not None and obj._total[0] is not obj.__undef__:
            assert isinstance(obj._total[0], float), ("Expected one of [u'number'], but got %s of type %s" % (obj._total[0], type(obj._total[0])))
