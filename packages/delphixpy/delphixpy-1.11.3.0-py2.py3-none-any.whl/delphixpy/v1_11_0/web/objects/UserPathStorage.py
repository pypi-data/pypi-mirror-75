    ...
    *(extends* :py:class:`v1_11_0.web.vo.PersistentObject` *)* Store
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._pathtype[0] is not None and obj._pathtype[0] is not obj.__undef__:
            assert isinstance(obj._pathtype[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._pathtype[0], type(obj._pathtype[0])))
            assert obj._pathtype[0] in [u'UPGRADE_STAGING_LOC'], "Expected enum [u'UPGRADE_STAGING_LOC'] but got %s" % obj._pathtype[0]
