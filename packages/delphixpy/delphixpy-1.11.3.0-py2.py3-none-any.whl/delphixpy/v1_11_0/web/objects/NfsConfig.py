    ...
    *(extends* :py:class:`v1_11_0.web.vo.TypedObject` *)* Get and set global
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._mount_version[0] is not None and obj._mount_version[0] is not obj.__undef__:
            assert isinstance(obj._mount_version[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._mount_version[0], type(obj._mount_version[0])))
            assert obj._mount_version[0] in [u'DEFAULT', u'NFSv3', u'NFSv4'], "Expected enum [u'DEFAULT', u'NFSv3', u'NFSv4'] but got %s" % obj._mount_version[0]
