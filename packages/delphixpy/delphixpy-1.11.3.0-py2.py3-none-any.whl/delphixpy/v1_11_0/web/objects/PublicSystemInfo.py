    ...
    *(extends* :py:class:`v1_11_0.web.vo.TypedObject` *)* Retrieve static
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._vendor_phone_number[0] is not None and obj._vendor_phone_number[0] is not obj.__undef__:
            assert isinstance(obj._vendor_phone_number[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._vendor_phone_number[0], type(obj._vendor_phone_number[0])))
        ...
        if obj._vendor_url[0] is not None and obj._vendor_url[0] is not obj.__undef__:
            assert isinstance(obj._vendor_url[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._vendor_url[0], type(obj._vendor_url[0])))
        ...
        if obj._configured[0] is not None and obj._configured[0] is not obj.__undef__:
            assert isinstance(obj._configured[0], bool), ("Expected one of [u'boolean'], but got %s of type %s" % (obj._configured[0], type(obj._configured[0])))
        ...
        if obj._engine_qualifier[0] is not None and obj._engine_qualifier[0] is not obj.__undef__:
            assert isinstance(obj._engine_qualifier[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._engine_qualifier[0], type(obj._engine_qualifier[0])))
        ...
        if obj._build_title[0] is not None and obj._build_title[0] is not obj.__undef__:
            assert isinstance(obj._build_title[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._build_title[0], type(obj._build_title[0])))
        ...
        if obj._current_locale[0] is not None and obj._current_locale[0] is not obj.__undef__:
            assert isinstance(obj._current_locale[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._current_locale[0], type(obj._current_locale[0])))
        ...
        if obj._kernel_name[0] is not None and obj._kernel_name[0] is not obj.__undef__:
            assert isinstance(obj._kernel_name[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._kernel_name[0], type(obj._kernel_name[0])))
        ...
        if obj._vendor_name[0] is not None and obj._vendor_name[0] is not obj.__undef__:
            assert isinstance(obj._vendor_name[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._vendor_name[0], type(obj._vendor_name[0])))
        ...
        if obj._sso_enabled[0] is not None and obj._sso_enabled[0] is not obj.__undef__:
            assert isinstance(obj._sso_enabled[0], bool), ("Expected one of [u'boolean'], but got %s of type %s" % (obj._sso_enabled[0], type(obj._sso_enabled[0])))
        ...
        if obj._vendor_email[0] is not None and obj._vendor_email[0] is not obj.__undef__:
            assert isinstance(obj._vendor_email[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._vendor_email[0], type(obj._vendor_email[0])))
        ...
        if obj._product_name[0] is not None and obj._product_name[0] is not obj.__undef__:
            assert isinstance(obj._product_name[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._product_name[0], type(obj._product_name[0])))
        ...
        if obj._banner[0] is not None and obj._banner[0] is not obj.__undef__:
            assert isinstance(obj._banner[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._banner[0], type(obj._banner[0])))
        ...
        if obj._support_url[0] is not None and obj._support_url[0] is not obj.__undef__:
            assert isinstance(obj._support_url[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._support_url[0], type(obj._support_url[0])))
        ...
        if obj._product_type[0] is not None and obj._product_type[0] is not obj.__undef__:
            assert isinstance(obj._product_type[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._product_type[0], type(obj._product_type[0])))
        ...
        if obj._engine_type[0] is not None and obj._engine_type[0] is not obj.__undef__:
            assert isinstance(obj._engine_type[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._engine_type[0], type(obj._engine_type[0])))
            assert obj._engine_type[0] in [u'VIRTUALIZATION', u'MASKING', u'BOTH', u'UNSET'], "Expected enum [u'VIRTUALIZATION', u'MASKING', u'BOTH', u'UNSET'] but got %s" % obj._engine_type[0]
        ...
        if obj._build_timestamp[0] is not None and obj._build_timestamp[0] is not obj.__undef__:
            assert isinstance(obj._build_timestamp[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._build_timestamp[0], type(obj._build_timestamp[0])))
    ...
    def is_dirty(self):
        return any([self._vendor_phone_number[1], self._vendor_url[1], self._configured[1], self._engine_qualifier[1], self._build_title[1], self._current_locale[1], self._support_contacts[1], self._theme[1], self._kernel_name[1], self._vendor_name[1], self._sso_enabled[1], self._vendor_address[1], self._build_version[1], self._vendor_email[1], self._product_name[1], self._banner[1], self._locales[1], self._enabled_features[1], self._support_url[1], self._api_version[1], self._product_type[1], self._engine_type[1], self._build_timestamp[1]])
