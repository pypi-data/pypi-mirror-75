    ...
    *(extends* :py:class:`v1_11_0.web.vo.NamedUserObject` *)* Describes a
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._verification_version[0] is not None and obj._verification_version[0] is not obj.__undef__:
            assert isinstance(obj._verification_version[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._verification_version[0], type(obj._verification_version[0])))
        ...
        if obj._min_reboot_optional_version[0] is not None and obj._min_reboot_optional_version[0] is not obj.__undef__:
            assert isinstance(obj._min_reboot_optional_version[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._min_reboot_optional_version[0], type(obj._min_reboot_optional_version[0])))
    ...
    def is_dirty(self):
        return any([self._status[1], self._verify_date[1], self._verification_version[1], self._build_date[1], self._install_date[1], self._min_reboot_optional_version[1], self._version[1], self._min_version[1]])
