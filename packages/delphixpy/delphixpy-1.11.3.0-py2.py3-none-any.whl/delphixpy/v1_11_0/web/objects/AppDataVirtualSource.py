...
class AppDataVirtualSource(AppDataManagedSource):
    ...
    *(extends* :py:class:`v1_11_0.web.vo.AppDataManagedSource` *)* A virtual
    ...
    def is_dirty(self):
        return any([self._operations[1], self._additional_mount_points[1], self._runtime_mount_information[1], self._allow_auto_vdb_restart_on_host_reboot[1], self._parameters[1]])
