    ...
    *(extends* :py:class:`v1_11_0.web.vo.TypedObject` *)* The status of an
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._bytes_done[0] is not None and obj._bytes_done[0] is not obj.__undef__:
            assert isinstance(obj._bytes_done[0], float), ("Expected one of [u'number'], but got %s of type %s" % (obj._bytes_done[0], type(obj._bytes_done[0])))
        ...
        if obj._bytes_est[0] is not None and obj._bytes_est[0] is not obj.__undef__:
            assert isinstance(obj._bytes_est[0], float), ("Expected one of [u'number'], but got %s of type %s" % (obj._bytes_est[0], type(obj._bytes_est[0])))
