    ...
    *(extends* :py:class:`v1_11_0.web.vo.DatapointStream` *)* A stream of
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._ver[0] is not None and obj._ver[0] is not obj.__undef__:
            assert isinstance(obj._ver[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._ver[0], type(obj._ver[0])))
            assert obj._ver[0] in [u'v3', u'v4'], "Expected enum [u'v3', u'v4'] but got %s" % obj._ver[0]
        ...
        if obj._cached[0] is not None and obj._cached[0] is not obj.__undef__:
            assert isinstance(obj._cached[0], bool), ("Expected one of [u'boolean'], but got %s of type %s" % (obj._cached[0], type(obj._cached[0])))
        ...
        if obj._sync[0] is not None and obj._sync[0] is not obj.__undef__:
            assert isinstance(obj._sync[0], bool), ("Expected one of [u'boolean'], but got %s of type %s" % (obj._sync[0], type(obj._sync[0])))
        ...
        if obj._client[0] is not None and obj._client[0] is not obj.__undef__:
            assert isinstance(obj._client[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._client[0], type(obj._client[0])))
        ...
        if obj._path[0] is not None and obj._path[0] is not obj.__undef__:
            assert isinstance(obj._path[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._path[0], type(obj._path[0])))
        ...
        if obj._op[0] is not None and obj._op[0] is not obj.__undef__:
            assert isinstance(obj._op[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._op[0], type(obj._op[0])))
    ...
    def is_dirty(self):
        return any([self._ver[1], self._cached[1], self._sync[1], self._client[1], self._path[1], self._op[1]])
