    ...
    *(extends* :py:class:`v1_11_0.web.vo.TypedObject` *)* Self-Service
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._retry_attempts[0] is not None and obj._retry_attempts[0] is not obj.__undef__:
            assert isinstance(obj._retry_attempts[0], int), ("Expected one of [u'integer'], but got %s of type %s" % (obj._retry_attempts[0], type(obj._retry_attempts[0])))
        ...
        if obj._default_bookmark_expiration[0] is not None and obj._default_bookmark_expiration[0] is not obj.__undef__:
            assert isinstance(obj._default_bookmark_expiration[0], int), ("Expected one of [u'integer'], but got %s of type %s" % (obj._default_bookmark_expiration[0], type(obj._default_bookmark_expiration[0])))
