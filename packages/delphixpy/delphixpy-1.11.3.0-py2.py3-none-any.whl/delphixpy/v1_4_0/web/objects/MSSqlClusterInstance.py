    ...
    *(extends* :py:class:`v1_4_0.web.vo.TypedObject` *)* The representation of
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._node[0] is not None and obj._node[0] is not obj.__undef__:
            assert isinstance(obj._node[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._node[0], type(obj._node[0])))
    ...
    def to_dict(self, dirty=False, belongs_to_parent=False):
        dct = super(MSSqlClusterInstance, self).to_dict(dirty, belongs_to_parent)
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, MSSqlClusterInstance):
            return False
        return super(MSSqlClusterInstance, self).__eq__(other) and \
