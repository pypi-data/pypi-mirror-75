    ...
    *(extends* :py:class:`v1_4_0.web.vo.TypedObject` *)* Specifies an
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._shared_path[0] is not None and obj._shared_path[0] is not obj.__undef__:
            assert isinstance(obj._shared_path[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._shared_path[0], type(obj._shared_path[0])))
        ...
        if obj._mount_path[0] is not None and obj._mount_path[0] is not obj.__undef__:
            assert isinstance(obj._mount_path[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._mount_path[0], type(obj._mount_path[0])))
    ...
    def is_dirty(self):
        return any([self._environment[1], self._shared_path[1], self._mount_path[1], self._environment_user[1]])
