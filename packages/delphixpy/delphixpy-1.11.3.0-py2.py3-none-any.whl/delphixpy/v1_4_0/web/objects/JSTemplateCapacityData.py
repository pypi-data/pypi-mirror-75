...
class JSTemplateCapacityData(TypedObject):
    ...
    *(extends* :py:class:`v1_4_0.web.vo.TypedObject` *)* The capacity
    ...
    def __init__(self, undef_enabled=True):
        super(JSTemplateCapacityData, self).__init__()
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        obj = super(JSTemplateCapacityData, cls).from_dict(data, dirty, undef_enabled)
        ...
        if obj._bookmarks[0] is not None and obj._bookmarks[0] is not obj.__undef__:
            assert isinstance(obj._bookmarks[0], float), ("Expected one of [u'number'], but got %s of type %s" % (obj._bookmarks[0], type(obj._bookmarks[0])))
        ...
        if obj._containers[0] is not None and obj._containers[0] is not obj.__undef__:
            assert isinstance(obj._containers[0], float), ("Expected one of [u'number'], but got %s of type %s" % (obj._containers[0], type(obj._containers[0])))
            common.validate_format(obj._containers[0], "None", None, None)
        return obj

    def to_dict(self, dirty=False, belongs_to_parent=False):
        dct = super(JSTemplateCapacityData, self).to_dict(dirty, belongs_to_parent)
    ...
    def is_dirty(self):
        return any([self._unvirtualized[1], self._bookmarks[1], self._template[1], self._containers[1]])
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, JSTemplateCapacityData):
            return False
        return super(JSTemplateCapacityData, self).__eq__(other) and \
