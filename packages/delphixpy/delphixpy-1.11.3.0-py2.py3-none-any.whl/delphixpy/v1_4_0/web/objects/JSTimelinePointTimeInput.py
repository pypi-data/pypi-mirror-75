    ...
    *(extends* :py:class:`v1_4_0.web.vo.JSTimelinePointTimeParameters` *)*
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._source_data_layout[0] is not None and obj._source_data_layout[0] is not obj.__undef__:
            assert isinstance(obj._source_data_layout[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._source_data_layout[0], type(obj._source_data_layout[0])))
    ...
    def to_dict(self, dirty=False, belongs_to_parent=False):
        dct = super(JSTimelinePointTimeInput, self).to_dict(dirty, belongs_to_parent)
