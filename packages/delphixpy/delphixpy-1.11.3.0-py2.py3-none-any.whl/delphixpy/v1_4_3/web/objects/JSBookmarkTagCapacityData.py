...
class JSBookmarkTagCapacityData(TypedObject):
    ...
    *(extends* :py:class:`v1_4_3.web.vo.TypedObject` *)* The capacity
    ...
    def __init__(self, undef_enabled=True):
        super(JSBookmarkTagCapacityData, self).__init__()
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        obj = super(JSBookmarkTagCapacityData, cls).from_dict(data, dirty, undef_enabled)
        ...
        if obj._referenced[0] is not None and obj._referenced[0] is not obj.__undef__:
            assert isinstance(obj._referenced[0], float), ("Expected one of [u'number'], but got %s of type %s" % (obj._referenced[0], type(obj._referenced[0])))
        ...
        if obj._bookmark_tag[0] is not None and obj._bookmark_tag[0] is not obj.__undef__:
            assert isinstance(obj._bookmark_tag[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._bookmark_tag[0], type(obj._bookmark_tag[0])))
            common.validate_format(obj._bookmark_tag[0], "None", None, None)
        return obj

    def to_dict(self, dirty=False, belongs_to_parent=False):
        dct = super(JSBookmarkTagCapacityData, self).to_dict(dirty, belongs_to_parent)
    ...
    def is_dirty(self):
        return any([self._referenced[1], self._unique[1], self._bookmark_tag[1]])
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, JSBookmarkTagCapacityData):
            return False
        return super(JSBookmarkTagCapacityData, self).__eq__(other) and \
