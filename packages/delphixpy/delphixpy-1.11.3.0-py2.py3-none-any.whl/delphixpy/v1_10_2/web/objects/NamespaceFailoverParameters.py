    ...
    *(extends* :py:class:`v1_10_2.web.vo.TypedObject` *)* The parameters to use
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._smart_failover[0] is not None and obj._smart_failover[0] is not obj.__undef__:
            assert isinstance(obj._smart_failover[0], bool), ("Expected one of [u'boolean'], but got %s of type %s" % (obj._smart_failover[0], type(obj._smart_failover[0])))
            common.validate_format(obj._smart_failover[0], "None", None, None)
        return obj

    def to_dict(self, dirty=False, belongs_to_parent=False):
        dct = super(NamespaceFailoverParameters, self).to_dict(dirty, belongs_to_parent)
        ...
        def dictify(obj, prop_is_list_or_vo=False):
            if isinstance(obj, list):
                ...
                return obj
        if "smart_failover" == "type" or (self.smart_failover is not self.__undef__ and (not (dirty and not self._smart_failover[1]) or isinstance(self.smart_failover, list) or belongs_to_parent)):
