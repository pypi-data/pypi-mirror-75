    ...
    *(extends* :py:class:`v1_10_2.web.vo.CompatibleRepositoriesParameters` *)*
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._source_repository[0] is not None and obj._source_repository[0] is not obj.__undef__:
            assert isinstance(obj._source_repository[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._source_repository[0], type(obj._source_repository[0])))
            common.validate_format(obj._source_repository[0], "objectReference", None, None)
        return obj

    def to_dict(self, dirty=False, belongs_to_parent=False):
        dct = super(PopulateCompatibilityParameters, self).to_dict(dirty, belongs_to_parent)
