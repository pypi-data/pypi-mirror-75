    ...
    *(extends* :py:class:`v1_10_2.web.vo.NamedUserObject` *)* Object namespace
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._failover_report[0] is not None and obj._failover_report[0] is not obj.__undef__:
            assert isinstance(obj._failover_report[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._failover_report[0], type(obj._failover_report[0])))
        ...
        if obj._failed_over[0] is not None and obj._failed_over[0] is not obj.__undef__:
            assert isinstance(obj._failed_over[0], bool), ("Expected one of [u'boolean'], but got %s of type %s" % (obj._failed_over[0], type(obj._failed_over[0])))
        ...
        if obj._namespace_type[0] is not None and obj._namespace_type[0] is not obj.__undef__:
            assert isinstance(obj._namespace_type[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._namespace_type[0], type(obj._namespace_type[0])))
        ...
        if obj._source[0] is not None and obj._source[0] is not obj.__undef__:
            assert isinstance(obj._source[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._source[0], type(obj._source[0])))
        ...
        if obj._secure_namespace[0] is not None and obj._secure_namespace[0] is not obj.__undef__:
            assert isinstance(obj._secure_namespace[0], bool), ("Expected one of [u'boolean'], but got %s of type %s" % (obj._secure_namespace[0], type(obj._secure_namespace[0])))
