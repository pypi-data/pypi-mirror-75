    ...
    *(extends* :py:class:`v1_10_2.web.vo.TypedObject` *)* Runtime, non-
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._available[0] is not None and obj._available[0] is not obj.__undef__:
            assert isinstance(obj._available[0], bool), ("Expected one of [u'boolean'], but got %s of type %s" % (obj._available[0], type(obj._available[0])))
        ...
        if obj._available_timestamp[0] is not None and obj._available_timestamp[0] is not obj.__undef__:
            assert isinstance(obj._available_timestamp[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._available_timestamp[0], type(obj._available_timestamp[0])))
        ...
        if obj._not_available_reason[0] is not None and obj._not_available_reason[0] is not obj.__undef__:
            assert isinstance(obj._not_available_reason[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._not_available_reason[0], type(obj._not_available_reason[0])))
