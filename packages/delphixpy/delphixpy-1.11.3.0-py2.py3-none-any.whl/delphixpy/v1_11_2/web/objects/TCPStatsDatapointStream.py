    ...
    *(extends* :py:class:`v1_11_2.web.vo.DatapointStream` *)* A stream of
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._remote_port[0] is not None and obj._remote_port[0] is not obj.__undef__:
            assert isinstance(obj._remote_port[0], int), ("Expected one of [u'integer'], but got %s of type %s" % (obj._remote_port[0], type(obj._remote_port[0])))
        ...
        if obj._local_port[0] is not None and obj._local_port[0] is not obj.__undef__:
            assert isinstance(obj._local_port[0], int), ("Expected one of [u'integer'], but got %s of type %s" % (obj._local_port[0], type(obj._local_port[0])))
        ...
        if obj._service[0] is not None and obj._service[0] is not obj.__undef__:
            assert isinstance(obj._service[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._service[0], type(obj._service[0])))
        ...
        if obj._local_address[0] is not None and obj._local_address[0] is not obj.__undef__:
            assert isinstance(obj._local_address[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._local_address[0], type(obj._local_address[0])))
    ...
    def is_dirty(self):
        return any([self._remote_port[1], self._remote_address[1], self._local_port[1], self._service[1], self._local_address[1]])
