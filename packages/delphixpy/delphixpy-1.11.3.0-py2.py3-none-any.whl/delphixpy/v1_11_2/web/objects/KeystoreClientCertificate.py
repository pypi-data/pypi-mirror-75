...
class KeystoreClientCertificate(ClientCertificate):
    ...
    *(extends* :py:class:`v1_11_2.web.vo.ClientCertificate` *)* Uploaded
    ...
    def __init__(self, undef_enabled=True):
        super(KeystoreClientCertificate, self).__init__()
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        obj = super(KeystoreClientCertificate, cls).from_dict(data, dirty, undef_enabled)
    ...
    def to_dict(self, dirty=False, belongs_to_parent=False):
        dct = super(KeystoreClientCertificate, self).to_dict(dirty, belongs_to_parent)
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, KeystoreClientCertificate):
            return False
        return super(KeystoreClientCertificate, self).__eq__(other) and \
