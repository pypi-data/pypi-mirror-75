    ...
    *(extends* :py:class:`v1_11_2.web.vo.SourceEnvironment` *)* A Windows
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._target_proxy[0] is not None and obj._target_proxy[0] is not obj.__undef__:
            assert isinstance(obj._target_proxy[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._target_proxy[0], type(obj._target_proxy[0])))
        ...
        if obj._proxy[0] is not None and obj._proxy[0] is not obj.__undef__:
            assert isinstance(obj._proxy[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._proxy[0], type(obj._proxy[0])))
    ...
    def is_dirty(self):
        return any([self._address[1], self._name[1], self._target_proxy[1], self._proxy[1]])
