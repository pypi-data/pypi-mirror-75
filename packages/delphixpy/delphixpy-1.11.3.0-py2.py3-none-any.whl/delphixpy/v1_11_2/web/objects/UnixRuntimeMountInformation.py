    ...
    *(extends* :py:class:`v1_11_2.web.vo.RuntimeMountInformation` *)* The
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._nfs_version_reason[0] is not None and obj._nfs_version_reason[0] is not obj.__undef__:
            assert isinstance(obj._nfs_version_reason[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._nfs_version_reason[0], type(obj._nfs_version_reason[0])))
            assert obj._nfs_version_reason[0] in [u'DEFAULT', u'OLD_REDHAT', u'UNSUPPORTED_OS', u'DNFS', u'TUNABLE_OVERRIDE', u'NO_RECOVER_LOST_LOCKS', u'UNSUPPORTED_DATA_PLATFORM'], "Expected enum [u'DEFAULT', u'OLD_REDHAT', u'UNSUPPORTED_OS', u'DNFS', u'TUNABLE_OVERRIDE', u'NO_RECOVER_LOST_LOCKS', u'UNSUPPORTED_DATA_PLATFORM'] but got %s" % obj._nfs_version_reason[0]
        ...
        if obj._nfs_version[0] is not None and obj._nfs_version[0] is not obj.__undef__:
            assert isinstance(obj._nfs_version[0], int), ("Expected one of [u'integer'], but got %s of type %s" % (obj._nfs_version[0], type(obj._nfs_version[0])))
    ...
    def is_dirty(self):
        return any([self._nfs_version_reason[1], self._nfs_version[1]])
    ...
    def __eq__(self, other):
        ...
        return super(UnixRuntimeMountInformation, self).__eq__(other) and \
               ...
               self.nfs_version == other.nfs_version
