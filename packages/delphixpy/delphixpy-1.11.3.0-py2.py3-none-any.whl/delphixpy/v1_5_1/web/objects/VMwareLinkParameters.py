...
class VMwareLinkParameters(LinkParameters):
    ...
    *(extends* :py:class:`v1_5_1.web.vo.LinkParameters` *)* Represents the
    ...
    def __init__(self, undef_enabled=True):
        super(VMwareLinkParameters, self).__init__()
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        obj = super(VMwareLinkParameters, cls).from_dict(data, dirty, undef_enabled)
    ...
    def to_dict(self, dirty=False, belongs_to_parent=False):
        dct = super(VMwareLinkParameters, self).to_dict(dirty, belongs_to_parent)
    ...
    def is_dirty(self):
        return any([self._source[1], self._container[1], self._environment_user[1]])
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, VMwareLinkParameters):
            return False
        return super(VMwareLinkParameters, self).__eq__(other) and \
