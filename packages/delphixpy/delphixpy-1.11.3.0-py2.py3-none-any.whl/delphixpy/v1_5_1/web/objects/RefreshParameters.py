    ...
    *(extends* :py:class:`v1_5_1.web.vo.TypedObject` *)* The parameters to use
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._timeflow_name[0] is not None and obj._timeflow_name[0] is not obj.__undef__:
            assert isinstance(obj._timeflow_name[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._timeflow_name[0], type(obj._timeflow_name[0])))
    ...
    def to_dict(self, dirty=False, belongs_to_parent=False):
        dct = super(RefreshParameters, self).to_dict(dirty, belongs_to_parent)
