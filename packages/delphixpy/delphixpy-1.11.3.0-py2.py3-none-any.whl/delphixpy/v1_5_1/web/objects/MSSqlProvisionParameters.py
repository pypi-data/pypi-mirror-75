...
class MSSqlProvisionParameters(ProvisionParameters):
    ...
    *(extends* :py:class:`v1_5_1.web.vo.ProvisionParameters` *)* The parameters
    ...
    def to_dict(self, dirty=False, belongs_to_parent=False):
        dct = super(MSSqlProvisionParameters, self).to_dict(dirty, belongs_to_parent)
    ...
    def is_dirty(self):
        return any([self._source_config[1], self._recovery_model[1], self._container[1], self._source[1]])
