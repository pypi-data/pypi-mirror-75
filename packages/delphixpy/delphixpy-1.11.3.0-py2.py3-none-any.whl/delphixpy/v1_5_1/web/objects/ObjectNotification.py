...
class ObjectNotification(Notification):
    """
    *(extends* :py:class:`v1_5_1.web.vo.Notification` *)* An event indicating a
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._object[0] is not None and obj._object[0] is not obj.__undef__:
            assert isinstance(obj._object[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._object[0], type(obj._object[0])))
        ...
        if obj._object_type[0] is not None and obj._object_type[0] is not obj.__undef__:
            assert isinstance(obj._object_type[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._object_type[0], type(obj._object_type[0])))
