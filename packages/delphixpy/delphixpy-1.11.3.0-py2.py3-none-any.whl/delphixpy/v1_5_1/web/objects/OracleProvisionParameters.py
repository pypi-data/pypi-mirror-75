    ...
    *(extends* :py:class:`v1_5_1.web.vo.ProvisionParameters` *)* The parameters
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._open_resetlogs[0] is not None and obj._open_resetlogs[0] is not obj.__undef__:
            assert isinstance(obj._open_resetlogs[0], bool), ("Expected one of [u'boolean'], but got %s of type %s" % (obj._open_resetlogs[0], type(obj._open_resetlogs[0])))
    ...
    def is_dirty(self):
        return any([self._username[1], self._credential[1], self._container[1], self._physical_standby[1], self._source_config[1], self._source[1], self._open_resetlogs[1]])
