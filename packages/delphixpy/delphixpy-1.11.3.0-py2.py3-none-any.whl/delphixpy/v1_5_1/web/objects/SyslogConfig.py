...
class SyslogConfig(TypedObject):
    """
    *(extends* :py:class:`v1_5_1.web.vo.TypedObject` *)* Syslog configuration.
    """
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._pattern[0] is not None and obj._pattern[0] is not obj.__undef__:
            assert isinstance(obj._pattern[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._pattern[0], type(obj._pattern[0])))
        ...
        if obj._format[0] is not None and obj._format[0] is not obj.__undef__:
            assert isinstance(obj._format[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._format[0], type(obj._format[0])))
    ...
    def is_dirty(self):
        return any([self._pattern[1], self._servers[1], self._enabled[1], self._severity[1], self._format[1]])
    ...
    def servers(self):
        ...
        :rtype: ``list`` of :py:class:`v1_5_1.web.vo.SyslogServer`
        """
