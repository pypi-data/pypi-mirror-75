    ...
    *(extends* :py:class:`v1_10_0.web.vo.OracleDBConfig` *)* Representation of
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._crs_database_name[0] is not None and obj._crs_database_name[0] is not obj.__undef__:
            assert isinstance(obj._crs_database_name[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._crs_database_name[0], type(obj._crs_database_name[0])))
