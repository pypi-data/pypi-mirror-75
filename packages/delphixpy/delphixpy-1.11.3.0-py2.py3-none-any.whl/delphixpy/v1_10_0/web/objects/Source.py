    ...
    *(extends* :py:class:`v1_10_0.web.vo.UserObject` *)* A source represents an
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._log_collection_enabled[0] is not None and obj._log_collection_enabled[0] is not obj.__undef__:
            assert isinstance(obj._log_collection_enabled[0], bool), ("Expected one of [u'boolean'], but got %s of type %s" % (obj._log_collection_enabled[0], type(obj._log_collection_enabled[0])))
        ...
        if obj._virtual[0] is not None and obj._virtual[0] is not obj.__undef__:
            assert isinstance(obj._virtual[0], bool), ("Expected one of [u'boolean'], but got %s of type %s" % (obj._virtual[0], type(obj._virtual[0])))
        ...
        if obj._staging[0] is not None and obj._staging[0] is not obj.__undef__:
            assert isinstance(obj._staging[0], bool), ("Expected one of [u'boolean'], but got %s of type %s" % (obj._staging[0], type(obj._staging[0])))
        ...
        if obj._linked[0] is not None and obj._linked[0] is not obj.__undef__:
            assert isinstance(obj._linked[0], bool), ("Expected one of [u'boolean'], but got %s of type %s" % (obj._linked[0], type(obj._linked[0])))
    ...
    def is_dirty(self):
        return any([self._status[1], self._log_collection_enabled[1], self._container[1], self._description[1], self._virtual[1], self._hosts[1], self._staging[1], self._runtime[1], self._config[1], self._linked[1]])
