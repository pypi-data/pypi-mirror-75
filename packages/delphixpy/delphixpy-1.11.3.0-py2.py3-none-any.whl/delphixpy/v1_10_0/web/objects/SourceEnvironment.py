    ...
    *(extends* :py:class:`v1_10_0.web.vo.UserObject` *)* The generic source
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._primary_user[0] is not None and obj._primary_user[0] is not obj.__undef__:
            assert isinstance(obj._primary_user[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._primary_user[0], type(obj._primary_user[0])))
    ...
    def is_dirty(self):
        return any([self._primary_user[1], self._log_collection_enabled[1], self._enabled[1], self._description[1]])
