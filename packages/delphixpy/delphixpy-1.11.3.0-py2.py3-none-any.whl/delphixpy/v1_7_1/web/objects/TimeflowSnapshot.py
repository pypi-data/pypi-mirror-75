    ...
    *(extends* :py:class:`v1_7_1.web.vo.ReadonlyNamedUserObject` *)* Snapshot
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._timeflow[0] is not None and obj._timeflow[0] is not obj.__undef__:
            assert isinstance(obj._timeflow[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._timeflow[0], type(obj._timeflow[0])))
        ...
        if obj._missing_non_logged_data[0] is not None and obj._missing_non_logged_data[0] is not obj.__undef__:
            assert isinstance(obj._missing_non_logged_data[0], bool), ("Expected one of [u'boolean'], but got %s of type %s" % (obj._missing_non_logged_data[0], type(obj._missing_non_logged_data[0])))
        ...
        if obj._consistency[0] is not None and obj._consistency[0] is not obj.__undef__:
            assert isinstance(obj._consistency[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._consistency[0], type(obj._consistency[0])))
        ...
        if obj._temporary[0] is not None and obj._temporary[0] is not obj.__undef__:
            assert isinstance(obj._temporary[0], bool), ("Expected one of [u'boolean'], but got %s of type %s" % (obj._temporary[0], type(obj._temporary[0])))
        ...
        if obj._retention[0] is not None and obj._retention[0] is not obj.__undef__:
            assert isinstance(obj._retention[0], int), ("Expected one of [u'integer'], but got %s of type %s" % (obj._retention[0], type(obj._retention[0])))
    ...
    def is_dirty(self):
        return any([self._timeflow[1], self._container[1], self._latest_change_point[1], self._missing_non_logged_data[1], self._creation_time[1], self._timezone[1], self._version[1], self._first_change_point[1], self._consistency[1], self._temporary[1], self._runtime[1], self._retention[1]])
