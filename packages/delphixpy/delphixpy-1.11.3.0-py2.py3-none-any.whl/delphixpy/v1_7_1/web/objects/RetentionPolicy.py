    ...
    *(extends* :py:class:`v1_7_1.web.vo.Policy` *)* This policy controls what
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._day_of_week[0] is not None and obj._day_of_week[0] is not obj.__undef__:
            assert isinstance(obj._day_of_week[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._day_of_week[0], type(obj._day_of_week[0])))
        ...
        if obj._log_duration[0] is not None and obj._log_duration[0] is not obj.__undef__:
            assert isinstance(obj._log_duration[0], int), ("Expected one of [u'integer'], but got %s of type %s" % (obj._log_duration[0], type(obj._log_duration[0])))
        ...
        if obj._num_of_yearly[0] is not None and obj._num_of_yearly[0] is not obj.__undef__:
            assert isinstance(obj._num_of_yearly[0], int), ("Expected one of [u'integer'], but got %s of type %s" % (obj._num_of_yearly[0], type(obj._num_of_yearly[0])))
        ...
        if obj._num_of_monthly[0] is not None and obj._num_of_monthly[0] is not obj.__undef__:
            assert isinstance(obj._num_of_monthly[0], int), ("Expected one of [u'integer'], but got %s of type %s" % (obj._num_of_monthly[0], type(obj._num_of_monthly[0])))
        ...
        if obj._num_of_daily[0] is not None and obj._num_of_daily[0] is not obj.__undef__:
            assert isinstance(obj._num_of_daily[0], int), ("Expected one of [u'integer'], but got %s of type %s" % (obj._num_of_daily[0], type(obj._num_of_daily[0])))
        ...
        if obj._day_of_year[0] is not None and obj._day_of_year[0] is not obj.__undef__:
            assert isinstance(obj._day_of_year[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._day_of_year[0], type(obj._day_of_year[0])))
        ...
        if obj._data_duration[0] is not None and obj._data_duration[0] is not obj.__undef__:
            assert isinstance(obj._data_duration[0], int), ("Expected one of [u'integer'], but got %s of type %s" % (obj._data_duration[0], type(obj._data_duration[0])))
        ...
        if obj._num_of_weekly[0] is not None and obj._num_of_weekly[0] is not obj.__undef__:
            assert isinstance(obj._num_of_weekly[0], int), ("Expected one of [u'integer'], but got %s of type %s" % (obj._num_of_weekly[0], type(obj._num_of_weekly[0])))
        ...
        if obj._data_unit[0] is not None and obj._data_unit[0] is not obj.__undef__:
            assert isinstance(obj._data_unit[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._data_unit[0], type(obj._data_unit[0])))
        ...
        if obj._log_unit[0] is not None and obj._log_unit[0] is not obj.__undef__:
            assert isinstance(obj._log_unit[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._log_unit[0], type(obj._log_unit[0])))
        ...
        if obj._day_of_month[0] is not None and obj._day_of_month[0] is not obj.__undef__:
            assert isinstance(obj._day_of_month[0], int), ("Expected one of [u'integer'], but got %s of type %s" % (obj._day_of_month[0], type(obj._day_of_month[0])))
