    ...
    *(extends* :py:class:`v1_7_0.web.vo.OracleVirtualSource` *)* An Oracle
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._resync_status[0] is not None and obj._resync_status[0] is not obj.__undef__:
            assert isinstance(obj._resync_status[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._resync_status[0], type(obj._resync_status[0])))
        ...
        if obj._data_age_warning_threshold[0] is not None and obj._data_age_warning_threshold[0] is not obj.__undef__:
            assert isinstance(obj._data_age_warning_threshold[0], int), ("Expected one of [u'integer'], but got %s of type %s" % (obj._data_age_warning_threshold[0], type(obj._data_age_warning_threshold[0])))
