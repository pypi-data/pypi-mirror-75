    ...
    *(extends* :py:class:`v1_11_1.web.vo.ReadonlyNamedUserObject` *)* The
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._date_added[0] is not None and obj._date_added[0] is not obj.__undef__:
            assert isinstance(obj._date_added[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._date_added[0], type(obj._date_added[0])))
        ...
        if obj._privilege_elevation_profile[0] is not None and obj._privilege_elevation_profile[0] is not obj.__undef__:
            assert isinstance(obj._privilege_elevation_profile[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._privilege_elevation_profile[0], type(obj._privilege_elevation_profile[0])))
        ...
        if obj._dsp_keystore_path[0] is not None and obj._dsp_keystore_path[0] is not obj.__undef__:
            assert isinstance(obj._dsp_keystore_path[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._dsp_keystore_path[0], type(obj._dsp_keystore_path[0])))
        ...
        if obj._dsp_keystore_password[0] is not None and obj._dsp_keystore_password[0] is not obj.__undef__:
            assert isinstance(obj._dsp_keystore_password[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._dsp_keystore_password[0], type(obj._dsp_keystore_password[0])))
        ...
        if obj._address[0] is not None and obj._address[0] is not obj.__undef__:
            assert isinstance(obj._address[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._address[0], type(obj._address[0])))
        ...
        if obj._dsp_truststore_path[0] is not None and obj._dsp_truststore_path[0] is not obj.__undef__:
            assert isinstance(obj._dsp_truststore_path[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._dsp_truststore_path[0], type(obj._dsp_truststore_path[0])))
        ...
        if obj._dsp_truststore_password[0] is not None and obj._dsp_truststore_password[0] is not obj.__undef__:
            assert isinstance(obj._dsp_truststore_password[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._dsp_truststore_password[0], type(obj._dsp_truststore_password[0])))
        ...
        if obj._dsp_keystore_alias[0] is not None and obj._dsp_keystore_alias[0] is not obj.__undef__:
            assert isinstance(obj._dsp_keystore_alias[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._dsp_keystore_alias[0], type(obj._dsp_keystore_alias[0])))
        ...
        if obj._ssh_port[0] is not None and obj._ssh_port[0] is not obj.__undef__:
            assert isinstance(obj._ssh_port[0], int), ("Expected one of [u'integer'], but got %s of type %s" % (obj._ssh_port[0], type(obj._ssh_port[0])))
        ...
        if obj._java_home[0] is not None and obj._java_home[0] is not obj.__undef__:
            assert isinstance(obj._java_home[0], TEXT_TYPE), ("Expected one of [u'string', u'null'], but got %s of type %s" % (obj._java_home[0], type(obj._java_home[0])))
    ...
    def is_dirty(self):
        return any([self._host_configuration[1], self._date_added[1], self._privilege_elevation_profile[1], self._dsp_keystore_path[1], self._dsp_keystore_password[1], self._address[1], self._dsp_truststore_path[1], self._dsp_truststore_password[1], self._dsp_keystore_alias[1], self._host_runtime[1], self._nfs_address_list[1], self._ssh_port[1], self._java_home[1]])
