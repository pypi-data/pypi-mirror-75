    ...
    *(extends* :py:class:`v1_11_1.web.vo.SourceRuntime` *)* Runtime (non-
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._database_mode[0] is not None and obj._database_mode[0] is not obj.__undef__:
            ...
            assert obj._database_mode[0] in [u'READ_WRITE', u'READ_ONLY', u'STANDBY_READ_ONLY', u'MOUNTED_ONLY', u'MIGRATE', u'UNKNOWN'], "Expected enum [u'READ_WRITE', u'READ_ONLY', u'STANDBY_READ_ONLY', u'MOUNTED_ONLY', u'MIGRATE', u'UNKNOWN'] but got %s" % obj._database_mode[0]
        ...
        if obj._database_role[0] is not None and obj._database_role[0] is not obj.__undef__:
            assert isinstance(obj._database_role[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._database_role[0], type(obj._database_role[0])))
    ...
    def is_dirty(self):
        return any([self._active_instances[1], self._database_mode[1], self._last_non_logged_location[1], self._database_stats[1], self._database_role[1]])
    ...
    def __eq__(self, other):
        ...
        return super(OracleBaseSourceRuntime, self).__eq__(other) and \
               ...
               self.database_role == other.database_role
