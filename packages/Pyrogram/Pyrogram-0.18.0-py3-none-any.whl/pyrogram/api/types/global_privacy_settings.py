...
class GlobalPrivacySettings(TLObject):
    ...
    See Also:
        This object can be returned by :obj:`account.GetGlobalPrivacySettings <pyrogram.api.functions.account.GetGlobalPrivacySettings>` and :obj:`account.SetGlobalPrivacySettings <pyrogram.api.functions.account.SetGlobalPrivacySettings>`.
    """
    ...
    def __init__(self, *, archive_and_mute_new_noncontact_peers: bool = None):
        self.archive_and_mute_new_noncontact_peers = archive_and_mute_new_noncontact_peers  # flags.0?Bool

    @staticmethod
    def read(b: BytesIO, *args) -> "GlobalPrivacySettings":
        flags = Int.read(b)
