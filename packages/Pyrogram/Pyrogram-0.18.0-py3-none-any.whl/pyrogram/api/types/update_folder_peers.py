...
class UpdateFolderPeers(TLObject):
    ...
    Parameters:
        folder_peers: List of :obj:`FolderPeer <pyrogram.api.types.FolderPeer>`
        pts: ``int`` ``32-bit``
    ...
    def __init__(self, *, folder_peers: list, pts: int, pts_count: int):
        self.folder_peers = folder_peers  # Vector<FolderPeer>
        self.pts = pts  # int
        self.pts_count = pts_count  # int

    @staticmethod
    def read(b: BytesIO, *args) -> "UpdateFolderPeers":
        # No flags
