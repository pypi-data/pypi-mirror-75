...
from .file_location_to_be_deprecated import FileLocationToBeDeprecated
...
from . import stats, messages, help, auth, photos, contacts, account, phone, upload, payments, updates, channels, storage
