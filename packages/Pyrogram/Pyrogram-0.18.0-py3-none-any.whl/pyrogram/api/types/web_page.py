...
class WebPage(TLObject):
    ...
    Parameters:
        ...
        cached_page (optional): :obj:`Page <pyrogram.api.types.Page>`
        attributes (optional): List of :obj:`WebPageAttributeTheme <pyrogram.api.types.WebPageAttributeTheme>`
    ...
    def __init__(self, *, id: int, url: str, display_url: str, hash: int, type: str = None, site_name: str = None, title: str = None, description: str = None, photo=None, embed_url: str = None, embed_type: str = None, embed_width: int = None, embed_height: int = None, duration: int = None, author: str = None, document=None, cached_page=None, attributes: list = None):
        self.id = id  # long
        self.url = url  # string
