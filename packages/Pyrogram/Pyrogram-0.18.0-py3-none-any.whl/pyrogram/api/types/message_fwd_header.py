...
class MessageFwdHeader(TLObject):
    ...
    __slots__ = ["date", "from_id", "from_name", "channel_id", "channel_post", "post_author", "saved_from_peer", "saved_from_msg_id", "psa_type"]

    ID = 0x353a686b
    QUALNAME = "types.MessageFwdHeader"

    def __init__(self, *, date: int, from_id: int = None, from_name: str = None, channel_id: int = None, channel_post: int = None, post_author: str = None, saved_from_peer=None, saved_from_msg_id: int = None, psa_type: str = None):
    ...
    def read(b: BytesIO, *args) -> "MessageFwdHeader":
        ...
        return MessageFwdHeader(date=date, from_id=from_id, from_name=from_name, channel_id=channel_id, channel_post=channel_post, post_author=post_author, saved_from_peer=saved_from_peer, saved_from_msg_id=saved_from_msg_id, psa_type=psa_type)
