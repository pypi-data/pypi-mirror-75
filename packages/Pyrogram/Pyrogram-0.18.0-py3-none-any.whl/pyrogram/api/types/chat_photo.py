...
class ChatPhoto(TLObject):
    ...
    __slots__ = ["photo_small", "photo_big", "dc_id", "has_video"]

    ID = 0xd20b9f3c
    QUALNAME = "types.ChatPhoto"

    def __init__(self, *, photo_small, photo_big, dc_id: int, has_video: bool = None):
    ...
    def read(b: BytesIO, *args) -> "ChatPhoto":
        ...
        return ChatPhoto(photo_small=photo_small, photo_big=photo_big, dc_id=dc_id, has_video=has_video)
