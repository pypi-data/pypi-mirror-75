...
class Update(TLObject):
    ...
    def read(b: BytesIO, *args) -> "Update":
        ...
        return Update(updates=updates, users=users, chats=chats, date=date, seq=seq)
