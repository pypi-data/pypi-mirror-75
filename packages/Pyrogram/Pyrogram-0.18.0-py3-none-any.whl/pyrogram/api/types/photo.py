...
class Photo(TLObject):
    ...
    Parameters:
        ...
        video_sizes (optional): List of :obj:`VideoSize <pyrogram.api.types.VideoSize>`
    """
    ...
    def __init__(self, *, id: int, access_hash: int, file_reference: bytes, date: int, sizes: list, dc_id: int, has_stickers: bool = None, video_sizes: list = None):
