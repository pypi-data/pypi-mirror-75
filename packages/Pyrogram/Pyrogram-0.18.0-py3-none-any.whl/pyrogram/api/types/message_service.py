...
class MessageService(TLObject):
    ...
    __slots__ = ["id", "to_id", "date", "action", "out", "mentioned", "media_unread", "silent", "post", "legacy", "from_id", "reply_to_msg_id"]

    ID = 0x9e19a1f6
    QUALNAME = "types.MessageService"

    def __init__(self, *, id: int, to_id, date: int, action, out: bool = None, mentioned: bool = None, media_unread: bool = None, silent: bool = None, post: bool = None, legacy: bool = None, from_id: int = None, reply_to_msg_id: int = None):
    ...
    def read(b: BytesIO, *args) -> "MessageService":
        ...
        return MessageService(id=id, to_id=to_id, date=date, action=action, out=out, mentioned=mentioned, media_unread=media_unread, silent=silent, post=post, legacy=legacy, from_id=from_id, reply_to_msg_id=reply_to_msg_id)
