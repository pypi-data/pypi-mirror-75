...
class SendMessage(TLObject):
    ...
    __slots__ = ["peer", "message", "random_id", "no_webpage", "silent", "background", "clear_draft", "reply_to_msg_id", "reply_markup", "entities", "schedule_date"]

    ID = 0x520c3870
    QUALNAME = "functions.messages.SendMessage"

    def __init__(self, *, peer, message: str, random_id: int, no_webpage: bool = None, silent: bool = None, background: bool = None, clear_draft: bool = None, reply_to_msg_id: int = None, reply_markup=None, entities: list = None, schedule_date: int = None):
