...
class CheckChatInvite(TLObject):
    ...
    Returns:
        Either :obj:`ChatInviteAlready <pyrogram.api.types.ChatInviteAlready>`, :obj:`ChatInvite <pyrogram.api.types.ChatInvite>` or :obj:`ChatInvitePeek <pyrogram.api.types.ChatInvitePeek>`
    """
