...
class Search(TLObject):
    ...
    Parameters:
        ...
        min_id: ``int`` ``32-bit``
        hash: ``int`` ``32-bit``
        from_id (optional): Either :obj:`InputUserEmpty <pyrogram.api.types.InputUserEmpty>`, :obj:`InputUserSelf <pyrogram.api.types.InputUserSelf>`, :obj:`InputUser <pyrogram.api.types.InputUser>` or :obj:`InputUserFromMessage <pyrogram.api.types.InputUserFromMessage>`
