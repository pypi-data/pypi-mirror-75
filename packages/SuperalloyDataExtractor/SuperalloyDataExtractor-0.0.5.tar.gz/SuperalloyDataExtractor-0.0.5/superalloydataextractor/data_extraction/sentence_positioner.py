...
class Sentence_Positioner:
    def __init__(self,filter_txt,prop_name,C_path):#path1为输入文本的路径，path2为输出excel的路径
        self.C_path = C_path
        self.dict_info = Dictionary(C_path)
        self.prop_name = prop_name#字符串的形式
