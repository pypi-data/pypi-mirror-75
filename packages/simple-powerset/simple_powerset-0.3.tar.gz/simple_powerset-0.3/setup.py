...
setup(
  name = 'simple_powerset',         # How you named your package folder (MyLib)
  ...
  url = 'https://github.com/bhatiak2050/simple_powerset',   # Provide either the link to your github or to your website
  download_url = 'https://github.com/bhatiak2050/simple_powerset/archive/v_03.tar.gz',    # I explain this later on
