...
class SectionOptions():
    def __init__(self, *, links: typing.Optional[typing.List["QuickLink"]]=None) -> None:
        """
        :param links: 
        """
        self._values = {
...
class WatchApiGatewayOptions():
    def __init__(self, *, cache_graph: typing.Optional[bool]=None, server_error_threshold: typing.Optional[jsii.Number]=None, watched_operations: typing.Optional[typing.List["WatchedOperation"]]=None) -> None:
        """
        :param cache_graph: Include a dashboard graph for caching metrics. Default: false
        :param server_error_threshold: Alarm when 5XX errors reach this threshold over 5 minutes. Default: 1 any 5xx HTTP response will trigger the alarm
        :param watched_operations: A list of operations to monitor separately. Default: - only API-level monitoring is added.
...
class WatchApiGatewayProps(WatchApiGatewayOptions):
    def __init__(self, *, cache_graph: typing.Optional[bool]=None, server_error_threshold: typing.Optional[jsii.Number]=None, watched_operations: typing.Optional[typing.List["WatchedOperation"]]=None, rest_api: aws_cdk.aws_apigateway.RestApi, title: str, watchful: "IWatchful") -> None:
        """
        :param cache_graph: Include a dashboard graph for caching metrics. Default: false
        :param server_error_threshold: Alarm when 5XX errors reach this threshold over 5 minutes. Default: 1 any 5xx HTTP response will trigger the alarm
        :param watched_operations: A list of operations to monitor separately. Default: - only API-level monitoring is added.
...
class WatchDynamoTableOptions():
    def __init__(self, *, read_capacity_threshold_percent: typing.Optional[jsii.Number]=None, write_capacity_threshold_percent: typing.Optional[jsii.Number]=None) -> None:
        """
        :param read_capacity_threshold_percent: Threshold for read capacity alarm (percentage). Default: 80
        :param write_capacity_threshold_percent: Threshold for read capacity alarm (percentage). Default: 80
        """
...
class WatchDynamoTableProps(WatchDynamoTableOptions):
    def __init__(self, *, read_capacity_threshold_percent: typing.Optional[jsii.Number]=None, write_capacity_threshold_percent: typing.Optional[jsii.Number]=None, table: aws_cdk.aws_dynamodb.Table, title: str, watchful: "IWatchful") -> None:
        """
        :param read_capacity_threshold_percent: Threshold for read capacity alarm (percentage). Default: 80
        :param write_capacity_threshold_percent: Threshold for read capacity alarm (percentage). Default: 80
        :param table: 
...
class WatchLambdaFunctionOptions():
    def __init__(self, *, duration_threshold_percent: typing.Optional[jsii.Number]=None, errors_per_minute_threshold: typing.Optional[jsii.Number]=None, throttles_per_minute_threshold: typing.Optional[jsii.Number]=None) -> None:
        """
        :param duration_threshold_percent: Threshold for the duration alarm as percentage of the function's timeout value. If this is set to 50%, the alarm will be set when p99 latency of the function exceeds 50% of the function's timeout setting. Default: 80
        :param errors_per_minute_threshold: Number of allowed errors per minute. If there are more errors than that, an alarm will trigger. Default: 0
        :param throttles_per_minute_threshold: Number of allowed throttles per minute. Default: 0
...
class WatchLambdaFunctionProps(WatchLambdaFunctionOptions):
    def __init__(self, *, duration_threshold_percent: typing.Optional[jsii.Number]=None, errors_per_minute_threshold: typing.Optional[jsii.Number]=None, throttles_per_minute_threshold: typing.Optional[jsii.Number]=None, fn: aws_cdk.aws_lambda.Function, title: str, watchful: "IWatchful") -> None:
        """
        :param duration_threshold_percent: Threshold for the duration alarm as percentage of the function's timeout value. If this is set to 50%, the alarm will be set when p99 latency of the function exceeds 50% of the function's timeout setting. Default: 80
        :param errors_per_minute_threshold: Number of allowed errors per minute. If there are more errors than that, an alarm will trigger. Default: 0
        :param throttles_per_minute_threshold: Number of allowed throttles per minute. Default: 0
...
class WatchRdsAurora(aws_cdk.core.Construct, metaclass=jsii.JSIIMeta, jsii_type="cdk-watchful.WatchRdsAurora"):
    def __init__(self, scope: aws_cdk.core.Construct, id: str, *, cluster: aws_cdk.aws_rds.DatabaseCluster, title: str, watchful: "IWatchful", cpu_maximum_threshold_percent: typing.Optional[jsii.Number]=None, db_buffer_cache_minimum_threshold: typing.Optional[jsii.Number]=None, db_connections_maximum_threshold: typing.Optional[jsii.Number]=None, db_replica_lag_maximum_threshold: typing.Optional[jsii.Number]=None, db_throughput_maximum_threshold: typing.Optional[jsii.Number]=None) -> None:
        """
        :param scope: -
        :param id: -
        :param cluster: 
        ...
        """
        props = WatchRdsAuroraProps(cluster=cluster, title=title, watchful=watchful, cpu_maximum_threshold_percent=cpu_maximum_threshold_percent, db_buffer_cache_minimum_threshold=db_buffer_cache_minimum_threshold, db_connections_maximum_threshold=db_connections_maximum_threshold, db_replica_lag_maximum_threshold=db_replica_lag_maximum_threshold, db_throughput_maximum_threshold=db_throughput_maximum_threshold)

        jsii.create(WatchRdsAurora, self, [scope, id, props])


@jsii.data_type(jsii_type="cdk-watchful.WatchRdsAuroraOptions", jsii_struct_bases=[], name_mapping={'cpu_maximum_threshold_percent': 'cpuMaximumThresholdPercent', 'db_buffer_cache_minimum_threshold': 'dbBufferCacheMinimumThreshold', 'db_connections_maximum_threshold': 'dbConnectionsMaximumThreshold', 'db_replica_lag_maximum_threshold': 'dbReplicaLagMaximumThreshold', 'db_throughput_maximum_threshold': 'dbThroughputMaximumThreshold'})
class WatchRdsAuroraOptions():
    def __init__(self, *, cpu_maximum_threshold_percent: typing.Optional[jsii.Number]=None, db_buffer_cache_minimum_threshold: typing.Optional[jsii.Number]=None, db_connections_maximum_threshold: typing.Optional[jsii.Number]=None, db_replica_lag_maximum_threshold: typing.Optional[jsii.Number]=None, db_throughput_maximum_threshold: typing.Optional[jsii.Number]=None) -> None:
        """
        :param cpu_maximum_threshold_percent: Threshold for the Cpu Maximum utilization. Default: 80
        :param db_buffer_cache_minimum_threshold: Threshold for the Minimum Db Buffer Cache. Default: - 0.
        :param db_connections_maximum_threshold: Threshold for the Maximum Db Connections. Default: - 0.
        ...
        if cpu_maximum_threshold_percent is not None: self._values["cpu_maximum_threshold_percent"] = cpu_maximum_threshold_percent
        if db_buffer_cache_minimum_threshold is not None: self._values["db_buffer_cache_minimum_threshold"] = db_buffer_cache_minimum_threshold
        if db_connections_maximum_threshold is not None: self._values["db_connections_maximum_threshold"] = db_connections_maximum_threshold
        if db_replica_lag_maximum_threshold is not None: self._values["db_replica_lag_maximum_threshold"] = db_replica_lag_maximum_threshold
        if db_throughput_maximum_threshold is not None: self._values["db_throughput_maximum_threshold"] = db_throughput_maximum_threshold
    ...
    def cpu_maximum_threshold_percent(self) -> typing.Optional[jsii.Number]:
        ...
        :default: 80
        """
        return self._values.get('cpu_maximum_threshold_percent')
    ...
    def db_buffer_cache_minimum_threshold(self) -> typing.Optional[jsii.Number]:
        ...
        -
          0.
        """
        return self._values.get('db_buffer_cache_minimum_threshold')
    ...
    def db_connections_maximum_threshold(self) -> typing.Optional[jsii.Number]:
        ...
        -
          0.
        """
        return self._values.get('db_connections_maximum_threshold')
    ...
    def db_replica_lag_maximum_threshold(self) -> typing.Optional[jsii.Number]:
        ...
        -
          0.
        """
        return self._values.get('db_replica_lag_maximum_threshold')
    ...
    def db_throughput_maximum_threshold(self) -> typing.Optional[jsii.Number]:
        ...
        -
          0.
        """
        return self._values.get('db_throughput_maximum_threshold')
    ...
    def __repr__(self) -> str:
        return 'WatchRdsAuroraOptions(%s)' % ', '.join(k + '=' + repr(v) for k, v in self._values.items())


@jsii.data_type(jsii_type="cdk-watchful.WatchRdsAuroraProps", jsii_struct_bases=[WatchRdsAuroraOptions], name_mapping={'cpu_maximum_threshold_percent': 'cpuMaximumThresholdPercent', 'db_buffer_cache_minimum_threshold': 'dbBufferCacheMinimumThreshold', 'db_connections_maximum_threshold': 'dbConnectionsMaximumThreshold', 'db_replica_lag_maximum_threshold': 'dbReplicaLagMaximumThreshold', 'db_throughput_maximum_threshold': 'dbThroughputMaximumThreshold', 'cluster': 'cluster', 'title': 'title', 'watchful': 'watchful'})
class WatchRdsAuroraProps(WatchRdsAuroraOptions):
    def __init__(self, *, cpu_maximum_threshold_percent: typing.Optional[jsii.Number]=None, db_buffer_cache_minimum_threshold: typing.Optional[jsii.Number]=None, db_connections_maximum_threshold: typing.Optional[jsii.Number]=None, db_replica_lag_maximum_threshold: typing.Optional[jsii.Number]=None, db_throughput_maximum_threshold: typing.Optional[jsii.Number]=None, cluster: aws_cdk.aws_rds.DatabaseCluster, title: str, watchful: "IWatchful") -> None:
        """
        :param cpu_maximum_threshold_percent: Threshold for the Cpu Maximum utilization. Default: 80
        :param db_buffer_cache_minimum_threshold: Threshold for the Minimum Db Buffer Cache. Default: - 0.
        :param db_connections_maximum_threshold: Threshold for the Maximum Db Connections. Default: - 0.
    ...
    def __repr__(self) -> str:
        return 'WatchRdsAuroraProps(%s)' % ', '.join(k + '=' + repr(v) for k, v in self._values.items())
...
class WatchedOperation():
    def __init__(self, *, http_method: str, resource_path: str) -> None:
...
class Watchful(aws_cdk.core.Construct, metaclass=jsii.JSIIMeta, jsii_type="cdk-watchful.Watchful"):
    def __init__(self, scope: aws_cdk.core.Construct, id: str, *, alarm_email: typing.Optional[str]=None, alarm_sns: typing.Optional[aws_cdk.aws_sns.ITopic]=None, alarm_sqs: typing.Optional[aws_cdk.aws_sqs.IQueue]=None) -> None:
        """
        :param scope: -
        :param id: -
        :param alarm_email: 
        ...
        :param alarm_sqs: 
        """
        props = WatchfulProps(alarm_email=alarm_email, alarm_sns=alarm_sns, alarm_sqs=alarm_sqs)
    ...
    def watch_rds_aurora_cluster(self, title: str, cluster: aws_cdk.aws_rds.DatabaseCluster, *, cpu_maximum_threshold_percent: typing.Optional[jsii.Number]=None, db_buffer_cache_minimum_threshold: typing.Optional[jsii.Number]=None, db_connections_maximum_threshold: typing.Optional[jsii.Number]=None, db_replica_lag_maximum_threshold: typing.Optional[jsii.Number]=None, db_throughput_maximum_threshold: typing.Optional[jsii.Number]=None) -> "WatchRdsAurora":
        """
        :param title: -
        :param cluster: -
        :param cpu_maximum_threshold_percent: Threshold for the Cpu Maximum utilization. Default: 80
        ...
        :param db_throughput_maximum_threshold: Threshold for the Maximum Db Throughput. Default: - 0.
        """
        options = WatchRdsAuroraOptions(cpu_maximum_threshold_percent=cpu_maximum_threshold_percent, db_buffer_cache_minimum_threshold=db_buffer_cache_minimum_threshold, db_connections_maximum_threshold=db_connections_maximum_threshold, db_replica_lag_maximum_threshold=db_replica_lag_maximum_threshold, db_throughput_maximum_threshold=db_throughput_maximum_threshold)

        return jsii.invoke(self, "watchRdsAuroraCluster", [title, cluster, options])

    @jsii.member(jsii_name="watchScope")
    def watch_scope(self, scope: aws_cdk.core.Construct, *, api_gateway: typing.Optional[bool]=None, dynamodb: typing.Optional[bool]=None, lambda_: typing.Optional[bool]=None, rdsaurora: typing.Optional[bool]=None) -> None:
        """
        :param scope: -
        ...
        """
        options = WatchfulAspectProps(api_gateway=api_gateway, dynamodb=dynamodb, lambda_=lambda_, rdsaurora=rdsaurora)
...
class WatchfulAspect(metaclass=jsii.JSIIMeta, jsii_type="cdk-watchful.WatchfulAspect"):
    ...
    def __init__(self, watchful: "Watchful", *, api_gateway: typing.Optional[bool]=None, dynamodb: typing.Optional[bool]=None, lambda_: typing.Optional[bool]=None, rdsaurora: typing.Optional[bool]=None) -> None:
        ...
        :param rdsaurora: Automatically watch RDS Aurora clusters in the scope. Default: true
        """
        props = WatchfulAspectProps(api_gateway=api_gateway, dynamodb=dynamodb, lambda_=lambda_, rdsaurora=rdsaurora)
...
@jsii.data_type(jsii_type="cdk-watchful.WatchfulAspectProps", jsii_struct_bases=[], name_mapping={'api_gateway': 'apiGateway', 'dynamodb': 'dynamodb', 'lambda_': 'lambda', 'rdsaurora': 'rdsaurora'})
class WatchfulAspectProps():
    def __init__(self, *, api_gateway: typing.Optional[bool]=None, dynamodb: typing.Optional[bool]=None, lambda_: typing.Optional[bool]=None, rdsaurora: typing.Optional[bool]=None) -> None:
        """
        :param api_gateway: Automatically watch API Gateway APIs in the scope. Default: true
        :param dynamodb: Automatically watch all Amazon DynamoDB tables in the scope. Default: true
        :param lambda_: Automatically watch AWS Lambda functions in the scope. Default: true
        ...
        if rdsaurora is not None: self._values["rdsaurora"] = rdsaurora
    ...
    @builtins.property
    def rdsaurora(self) -> typing.Optional[bool]:
        """Automatically watch RDS Aurora clusters in the scope.

        default
        :default: true
        """
        return self._values.get('rdsaurora')
...
@jsii.data_type(jsii_type="cdk-watchful.WatchfulProps", jsii_struct_bases=[], name_mapping={'alarm_email': 'alarmEmail', 'alarm_sns': 'alarmSns', 'alarm_sqs': 'alarmSqs'})
class WatchfulProps():
    def __init__(self, *, alarm_email: typing.Optional[str]=None, alarm_sns: typing.Optional[aws_cdk.aws_sns.ITopic]=None, alarm_sqs: typing.Optional[aws_cdk.aws_sqs.IQueue]=None) -> None:
        """
        :param alarm_email: 
        :param alarm_sns: 
        :param alarm_sqs: 
        ...
        if alarm_sns is not None: self._values["alarm_sns"] = alarm_sns
        if alarm_sqs is not None: self._values["alarm_sqs"] = alarm_sqs
    ...
    def alarm_sns(self) -> typing.Optional[aws_cdk.aws_sns.ITopic]:
        return self._values.get('alarm_sns')

    @builtins.property
    def alarm_sqs(self) -> typing.Optional[aws_cdk.aws_sqs.IQueue]:
        return self._values.get('alarm_sqs')
