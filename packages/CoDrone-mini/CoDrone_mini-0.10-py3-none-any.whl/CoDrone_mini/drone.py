    ...
    def pair(self, port_name=None):
        ...
        if port_name is None:
            ...
            if len(port_name) == 0:
                ...
                return False
            port_name = list(port_name)
            port_name.sort()

        for trying_port in port_name:
            try:
                print("Tried to pair to port \'{}\'".format(trying_port))
                ...
                if self.isOpen():
                    ...
                    # 로그 출력
                    print("Success to pair to CoDrone Mini remote. (port = \'{}\')".format(trying_port))
