...
class AuthServer:
    ...
    def auto_login(self, client_id, secret, username, password):
        response = auth_api.get_auto_token(self.auth_api, client_id=client_id, client_secret=secret, username=username,
                                  password=password)
        self.set_access_token(response.body)
