...
class MigrationPlansApi(object):
    ...
    def delete(self, migration_plan_href, **kwargs):  # noqa: E501
        ...
        :param async_req bool: execute request asynchronously
        :param str migration_plan_href: (required)
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
        :param _request_timeout: timeout setting for this request. If one
    ...
    def run(self, migration_plan_href, migration_plan_run, **kwargs):  # noqa: E501
        """Run migration plan  # noqa: E501

        Trigger an asynchronous task to run a migration from Pulp 2.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.run(migration_plan_href, migration_plan_run, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.run_with_http_info(migration_plan_href, migration_plan_run, **kwargs)  # noqa: E501

    def run_with_http_info(self, migration_plan_href, migration_plan_run, **kwargs):  # noqa: E501
        """Run migration plan  # noqa: E501

        Trigger an asynchronous task to run a migration from Pulp 2.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.run_with_http_info(migration_plan_href, migration_plan_run, async_req=True)
        >>> result = thread.get()
