...
class ListContainersPaginator(Boto3Paginator):
    """
    [Paginator.ListContainers documentation](https://boto3.amazonaws.com/v1/documentation/api/1.14.32/reference/services/mediastore.html#MediaStore.Paginator.ListContainers)
    """
    ...
    def paginate(
        ...
        """
        [ListContainers.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.14.32/reference/services/mediastore.html#MediaStore.Paginator.ListContainers.paginate)
        """
