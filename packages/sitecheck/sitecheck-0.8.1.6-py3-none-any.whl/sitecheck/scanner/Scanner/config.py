...
from sitecheck.scanner.Scanner import ROOT_DIR
from sitecheck.scanner.Scanner import logger
from sitecheck.scanner.Scanner import projectstore
...
def check_credentials():
    ...
    """
    if not os.environ['OneDriveCommercial']:
        sys.exit('Commerical OneDrive Not configured.. Exiting')
