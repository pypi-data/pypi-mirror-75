...
/* "zmq/backend/cython/error.pyx":29
...
static PyObject *__pyx_pw_3zmq_7backend_6cython_5error_1strerror(PyObject *__pyx_self, PyObject *__pyx_arg_errno) {
  ...
  assert(__pyx_arg_errno); {
    __pyx_v_errno = __Pyx_PyInt_As_int(__pyx_arg_errno); if (unlikely((__pyx_v_errno == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 29, __pyx_L3_error)
  }
...
static PyObject *__pyx_pf_3zmq_7backend_6cython_5error_strerror(CYTHON_UNUSED PyObject *__pyx_self, int __pyx_v_errno) {
  ...
  /* "zmq/backend/cython/error.pyx":35
 *     """
 ...
 */
  ...
  /* "zmq/backend/cython/error.pyx":36
 *     # This is a const char *
 *     str_e = zmq_strerror(errno)
 *     if PY_MAJOR_VERSION <= 2:             # <<<<<<<<<<<<<<
 *         # Python 2: str is bytes, so we already have the right type
 ...
 */
    ...
    __pyx_t_2 = __Pyx_PyBytes_FromString(__pyx_v_str_e); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 38, __pyx_L1_error)
 ...
 */
  /*else*/ {
    __Pyx_XDECREF(__pyx_r);
    __pyx_t_2 = __Pyx_decode_c_string(__pyx_v_str_e, 0, strlen(__pyx_v_str_e), NULL, NULL, NULL); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 41, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_2);
    __pyx_r = __pyx_t_2;
    __pyx_t_2 = 0;
    goto __pyx_L0;
...
/* "zmq/backend/cython/error.pyx":43
 *         return str_e.decode()
 * 
 * def zmq_errno():             # <<<<<<<<<<<<<<
 *     """zmq_errno()
...
static PyObject *__pyx_pf_3zmq_7backend_6cython_5error_2zmq_errno(CYTHON_UNUSED PyObject *__pyx_self) {
  ...
  /* "zmq/backend/cython/error.pyx":48
 *     Return the integer errno of the most recent zmq error.
 *     """
 *     return zmq_errno_c()             # <<<<<<<<<<<<<<
 * 
 ...
 */
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_1 = __Pyx_PyInt_From_int(zmq_errno()); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 48, __pyx_L1_error)
 ...
 * 
 */
  __pyx_tuple_ = PyTuple_Pack(3, __pyx_n_s_errno, __pyx_n_s_errno, __pyx_n_s_str_e); if (unlikely(!__pyx_tuple_)) __PYX_ERR(0, 29, __pyx_L1_error)
 ...
 * 
 */
  __pyx_codeobj__3 = (PyObject*)__Pyx_PyCode_New(0, 0, 0, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_zmq_backend_cython_error_pyx, __pyx_n_s_zmq_errno, 43, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__3)) __PYX_ERR(0, 43, __pyx_L1_error)
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
 ...
 * 
 */
  __pyx_t_1 = __Pyx_CyFunction_New(&__pyx_mdef_3zmq_7backend_6cython_5error_1strerror, 0, __pyx_n_s_strerror, NULL, __pyx_n_s_zmq_backend_cython_error, __pyx_d, ((PyObject *)__pyx_codeobj__2)); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 29, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_strerror, __pyx_t_1) < 0) __PYX_ERR(0, 29, __pyx_L1_error)
 ...
 * 
 */
  __pyx_t_1 = __Pyx_CyFunction_New(&__pyx_mdef_3zmq_7backend_6cython_5error_3zmq_errno, 0, __pyx_n_s_zmq_errno, NULL, __pyx_n_s_zmq_backend_cython_error, __pyx_d, ((PyObject *)__pyx_codeobj__3)); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 43, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_zmq_errno, __pyx_t_1) < 0) __PYX_ERR(0, 43, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;

  /* "zmq/backend/cython/error.pyx":50
 *     return zmq_errno_c()
 * 
 * __all__ = ['strerror', 'zmq_errno']             # <<<<<<<<<<<<<<
 */
  ...
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_all, __pyx_t_1) < 0) __PYX_ERR(0, 50, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
