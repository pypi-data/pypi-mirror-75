...
class WeatherInfo(threading.Thread):
    ...
    def main():
        ...
        thread1 = threading.Thread(WeatherInfo().getWeatherInfo(1,apikey,city,filepath),args=(threadLock,))
        #thread1 = WeatherInfo( 1,apikey,city,filepath).getWeatherInfo()
        #thread1 = threading.Thread(WeatherInfo( 1,"17f5118cc7342b5b6fd0abbfb058c3bd","warangal","D:/Learning/").getWeatherInfo())
        #thread2 = threading.Thread(target=getWeatherInfo,args=(threadLock,))
        thread1.start() 
        #thread2.start() 
