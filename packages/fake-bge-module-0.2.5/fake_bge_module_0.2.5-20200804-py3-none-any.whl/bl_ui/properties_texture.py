...
class TEXTURE_PT_game_influence(TextureSlotPanel, TextureButtonsPanel,
                                bpy_types.Panel, bpy_types._GenericUI):
    COMPAT_ENGINES = None
    ''' '''
...
class TEXTURE_PT_game_mapping(TextureSlotPanel, TextureButtonsPanel,
                              bpy_types.Panel, bpy_types._GenericUI):
    COMPAT_ENGINES = None
    ''' '''
...
class TEXTURE_PT_game_parallax(TextureSlotPanel, TextureButtonsPanel,
                               bpy_types.Panel, bpy_types._GenericUI):
    COMPAT_ENGINES = None
    ''' '''
