...
class GPENCIL_MT_brush_specials(bpy_types.Menu, bpy_types._GenericUI):
    bl_label = None
    ''' '''
...
class GPENCIL_MT_gpencil_edit_specials(bpy_types.Menu, bpy_types._GenericUI):
    bl_label = None
    ''' '''
...
class GPENCIL_MT_layer_specials(bpy_types.Menu, bpy_types._GenericUI):
    bl_label = None
    ''' '''
...
class GPENCIL_MT_palettecolor_specials(bpy_types.Menu, bpy_types._GenericUI):
    bl_label = None
    ''' '''
...
class GPENCIL_UL_brush(bpy_types.UIList, bpy_types._GenericUI):
    bl_rna = None
    ''' '''
...
class GPENCIL_UL_palettecolor(bpy_types.UIList, bpy_types._GenericUI):
    bl_rna = None
    ''' '''
