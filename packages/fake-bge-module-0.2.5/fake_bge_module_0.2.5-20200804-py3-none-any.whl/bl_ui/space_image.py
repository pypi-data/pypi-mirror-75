...
class IMAGE_MT_uvs_proportional(bpy_types.Menu, bpy_types._GenericUI):
    bl_label = None
    ''' '''
...
class IMAGE_PT_game_properties(bpy_types.Panel, bpy_types._GenericUI):
    bl_label = None
    ''' '''
...
class IMAGE_PT_grease_pencil_palettecolor(
...
class IMAGE_PT_tools_grease_pencil_brush(
...
class IMAGE_PT_tools_grease_pencil_brushcurves(
...
class IMAGE_PT_tools_grease_pencil_draw(
...
class IMAGE_PT_tools_grease_pencil_edit(
...
class IMAGE_PT_tools_grease_pencil_sculpt(
...
class IMAGE_PT_tools_mask(bl_ui.properties_mask_common.MASK_PT_tools,
                          bpy_types.Panel, bpy_types._GenericUI):
    bl_category = None
    ''' '''
...
class IMAGE_PT_tools_mask_add(bl_ui.properties_mask_common.MASK_PT_add,
                              bpy_types.Panel, bpy_types._GenericUI):
    bl_category = None
    ''' '''
...
class IMAGE_PT_view_properties(bpy_types.Panel, bpy_types._GenericUI):
    bl_label = None
    ''' '''
...
class IMAGE_PT_tools_brush_appearance(
...
class IMAGE_PT_tools_brush_overlay(
        BrushButtonsPanel, bl_ui.properties_paint_common.UnifiedPaintPanel,
        bpy_types.Panel, bpy_types._GenericUI):
    bl_category = None
    ''' '''
...
class IMAGE_PT_tools_brush_tool(
        BrushButtonsPanel, bl_ui.properties_paint_common.UnifiedPaintPanel,
        bpy_types.Panel, bpy_types._GenericUI):
    bl_category = None
    ''' '''
...
class IMAGE_PT_tools_paint_options(
        BrushButtonsPanel, bl_ui.properties_paint_common.UnifiedPaintPanel,
        bpy_types.Panel, bpy_types._GenericUI):
    bl_category = None
    ''' '''
...
class IMAGE_PT_uv_sculpt(ImagePaintPanel, bpy_types.Panel,
                         bpy_types._GenericUI,
                         bl_ui.properties_paint_common.UnifiedPaintPanel):
    bl_category = None
    ''' '''
...
class IMAGE_PT_options_uvs(UVToolsPanel, bpy_types.Panel,
                           bpy_types._GenericUI):
    bl_category = None
    ''' '''
...
class IMAGE_PT_tools_align_uvs(UVToolsPanel, bpy_types.Panel,
                               bpy_types._GenericUI):
    bl_category = None
    ''' '''
...
class IMAGE_PT_tools_transform_uvs(UVToolsPanel, bpy_types.Panel,
                                   bpy_types._GenericUI):
    bl_category = None
    ''' '''
...
class IMAGE_PT_tools_uvs(UVToolsPanel, bpy_types.Panel, bpy_types._GenericUI):
    bl_category = None
    ''' '''
