...
class GROUP_MT_specials(bpy_types.Menu, bpy_types._GenericUI):
    bl_label = None
    ''' '''
...
class OBJECT_PT_onion_skinning(bl_ui.properties_animviz.OnionSkinButtonsPanel):
    bl_context = None
    ''' '''
...
class OBJECT_PT_duplication(ObjectButtonsPanel, bpy_types.Panel,
                            bpy_types._GenericUI):
    bl_context = None
    ''' '''
...
class OBJECT_PT_groups(ObjectButtonsPanel, bpy_types.Panel,
                       bpy_types._GenericUI):
    bl_context = None
    ''' '''
...
class OBJECT_PT_relations_extras(ObjectButtonsPanel, bpy_types.Panel,
                                 bpy_types._GenericUI):
    bl_context = None
    ''' '''
...
class OBJECT_PT_transform_locks(ObjectButtonsPanel, bpy_types.Panel,
                                bpy_types._GenericUI):
    bl_context = None
    ''' '''
