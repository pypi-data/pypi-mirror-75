...
class SEQUENCER_MT_add_generate(bpy_types.Menu, bpy_types._GenericUI):
    bl_label = None
    ''' '''
...
class SEQUENCER_PT_edit(SequencerButtonsPanel, bpy_types.Panel,
                        bpy_types._GenericUI):
    bl_category = None
    ''' '''
...
class SEQUENCER_PT_filter(SequencerButtonsPanel, bpy_types.Panel,
                          bpy_types._GenericUI):
    bl_category = None
    ''' '''
...
class SEQUENCER_PT_input(SequencerButtonsPanel, bpy_types.Panel,
                         bpy_types._GenericUI):
    bl_category = None
    ''' '''
...
class SEQUENCER_PT_proxy(SequencerButtonsPanel, bpy_types.Panel,
                         bpy_types._GenericUI):
    bl_category = None
    ''' '''
