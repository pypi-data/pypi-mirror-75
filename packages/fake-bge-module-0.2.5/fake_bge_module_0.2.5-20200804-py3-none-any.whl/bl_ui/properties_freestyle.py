...
class RENDERLAYER_UL_linesets(bpy_types.UIList, bpy_types._GenericUI):
    bl_rna = None
    ''' '''
...
class RENDER_MT_lineset_specials(bpy_types.Menu, bpy_types._GenericUI):
    bl_label = None
    ''' '''
...
class RENDERLAYER_PT_freestyle_lineset(RenderLayerFreestyleEditorButtonsPanel,
                                       RenderLayerFreestyleButtonsPanel,
                                       bpy_types.Panel, bpy_types._GenericUI):
    COMPAT_ENGINES = None
    ''' '''
...
class RENDERLAYER_PT_freestyle_linestyle(
        RenderLayerFreestyleEditorButtonsPanel,
        RenderLayerFreestyleButtonsPanel, bpy_types.Panel,
        bpy_types._GenericUI):
    COMPAT_ENGINES = None
    ''' '''
