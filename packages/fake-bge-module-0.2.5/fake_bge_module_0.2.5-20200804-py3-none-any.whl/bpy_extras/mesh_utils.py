...
def edge_loops_from_tessfaces(
        ...
        seams=()) -> list:
    ''' Edge loops defined by faces Takes me.tessfaces or a list of faces and returns the edge loops These edge loops are the edges that sit between quads, so they don't touch 1 quad, note: not connected will make 2 edge loops, both only containing 2 edges. return a list of edge key lists [[(0, 1), (4, 8), (3, 8)], ...]
...
def mesh_linked_tessfaces(mesh: 'bpy.types.Mesh') -> list:
    ''' Splits the mesh into connected faces, use this for separating cubes from other mesh elements within 1 mesh datablock.
