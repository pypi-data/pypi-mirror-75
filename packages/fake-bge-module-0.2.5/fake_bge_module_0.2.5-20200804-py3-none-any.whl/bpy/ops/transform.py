...
def bend(value: typing.List[float] = (0.0),
    ...
    :type snap: bool
    :param snap_target: Target * CLOSEST Closest, Snap closest point onto target. * CENTER Center, Snap transormation center onto target. * MEDIAN Median, Snap median onto target. * ACTIVE Active, Snap active onto target.
...
def select_orientation(orientation: typing.Union[str, int] = 'GLOBAL'):
    ...
    :param orientation: Orientation, Transformation orientation * GLOBAL Global, Align the transformation axes to world space. * LOCAL Local, Align the transformation axes to the selected objects' local space. * NORMAL Normal, Align the transformation axes to average normal of selected elements (bone Y axis for pose mode). * GIMBAL Gimbal, Align each axis to the Euler rotation axis as used for input. * VIEW View, Align the transformation axes to the window.
