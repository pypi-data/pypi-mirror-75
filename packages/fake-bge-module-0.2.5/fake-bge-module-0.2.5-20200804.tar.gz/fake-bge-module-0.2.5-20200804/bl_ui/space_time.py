...
class TIME_HT_header(bpy_types.Header, bpy_types._GenericUI):
    bl_rna = None
    ''' '''
...
class TIME_MT_autokey(bpy_types.Menu, bpy_types._GenericUI):
    bl_label = None
    ''' '''
...
class TIME_MT_frame(bpy_types.Menu, bpy_types._GenericUI):
    bl_label = None
    ''' '''
...
class TIME_MT_playback(bpy_types.Menu, bpy_types._GenericUI):
    bl_label = None
    ''' '''
