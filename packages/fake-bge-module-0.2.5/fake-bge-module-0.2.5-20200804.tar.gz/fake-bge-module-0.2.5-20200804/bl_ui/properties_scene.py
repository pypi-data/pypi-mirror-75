...
class SCENE_MT_units_length_presets(bpy_types.Menu, bpy_types._GenericUI):
    bl_label = None
    ''' '''
...
class SCENE_PT_color_management(SceneButtonsPanel, bpy_types.Panel,
...
class SCENE_PT_rigid_body_cache(SceneButtonsPanel, bpy_types.Panel,
                                bpy_types._GenericUI):
    COMPAT_ENGINES = None
    ''' '''
...
class SCENE_PT_rigid_body_field_weights(SceneButtonsPanel, bpy_types.Panel,
                                        bpy_types._GenericUI):
    COMPAT_ENGINES = None
    ''' '''
...
class SCENE_PT_simplify(SceneButtonsPanel, bpy_types.Panel,
                        bpy_types._GenericUI):
    COMPAT_ENGINES = None
    ''' '''
