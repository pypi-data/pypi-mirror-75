...
class CLIP_MT_camera_presets(bpy_types.Menu, bpy_types._GenericUI):
    bl_label = None
    ''' '''
...
class CLIP_MT_stabilize_2d_rotation_specials(bpy_types.Menu,
...
class CLIP_MT_stabilize_2d_specials(bpy_types.Menu, bpy_types._GenericUI):
    bl_label = None
    ''' '''
...
class CLIP_MT_track_color_presets(bpy_types.Menu, bpy_types._GenericUI):
    bl_label = None
    ''' '''
...
class CLIP_MT_track_color_specials(bpy_types.Menu, bpy_types._GenericUI):
    bl_label = None
    ''' '''
...
class CLIP_MT_tracking_settings_presets(bpy_types.Menu, bpy_types._GenericUI):
    bl_label = None
    ''' '''
...
class CLIP_MT_tracking_specials(bpy_types.Menu, bpy_types._GenericUI):
    bl_label = None
    ''' '''
...
class CLIP_PT_tools_mask(bl_ui.properties_mask_common.MASK_PT_tools,
                         bpy_types.Panel, bpy_types._GenericUI):
    bl_category = None
    ''' '''
...
class CLIP_PT_tools_mask_add(bl_ui.properties_mask_common.MASK_PT_add,
                             bpy_types.Panel, bpy_types._GenericUI):
    bl_category = None
    ''' '''
...
class CLIP_PT_display(CLIP_PT_clip_view_panel, bpy_types.Panel,
                      bpy_types._GenericUI):
    bl_label = None
    ''' '''
...
class CLIP_PT_footage_info(CLIP_PT_clip_view_panel, bpy_types.Panel,
                           bpy_types._GenericUI):
    bl_label = None
    ''' '''
...
class CLIP_PT_marker_display(CLIP_PT_clip_view_panel, bpy_types.Panel,
                             bpy_types._GenericUI):
    bl_label = None
    ''' '''
