...
class MESH_MT_shape_key_specials(bpy_types.Menu, bpy_types._GenericUI):
    COMPAT_ENGINES = None
    ''' '''
...
class MESH_MT_vertex_group_specials(bpy_types.Menu, bpy_types._GenericUI):
    COMPAT_ENGINES = None
    ''' '''
...
class MESH_UL_uvmaps_vcols(bpy_types.UIList, bpy_types._GenericUI):
    bl_rna = None
    ''' '''
