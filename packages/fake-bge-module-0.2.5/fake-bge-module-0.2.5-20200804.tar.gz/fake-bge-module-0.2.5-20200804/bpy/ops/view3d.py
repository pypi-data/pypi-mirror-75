...
def move(use_mouse_init: bool = True):
    ''' Move the view
...
def rotate(use_mouse_init: bool = True):
    ''' Rotate the view
...
def zoom(mx: int = 0, my: int = 0, delta: int = 0,
         use_mouse_init: bool = True):
