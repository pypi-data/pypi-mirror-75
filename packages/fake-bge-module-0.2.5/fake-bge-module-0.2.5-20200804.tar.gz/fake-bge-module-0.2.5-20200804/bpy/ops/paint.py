...
def brush_select(paint_mode: typing.Union[str, int] = 'ACTIVE',
    ...
    :param vertex_paint_tool: Vertex Paint Tool * MIX Mix, Use mix blending mode while painting. * ADD Add, Use add blending mode while painting. * SUB Subtract, Use subtract blending mode while painting. * MUL Multiply, Use multiply blending mode while painting. * BLUR Blur, Blur the color with surrounding values. * LIGHTEN Lighten, Use lighten blending mode while painting. * DARKEN Darken, Use darken blending mode while painting. * AVERAGE Average, Use average blending mode while painting. * SMEAR Smear, Use smear blending mode while painting. * COLORDODGE Color Dodge, Use color dodge blending mode while painting. * DIFFERENCE Difference, Use difference blending mode while painting. * SCREEN Screen, Use screen blending mode while painting. * HARDLIGHT Hardlight, Use hardlight blending mode while painting. * OVERLAY Overlay, Use overlay blending mode while painting. * SOFTLIGHT Softlight, Use softlight blending mode while painting. * EXCLUSION Exclusion, Use exclusion blending mode while painting. * LUMINOCITY Luminocity, Use luminocity blending mode while painting. * SATURATION Saturation, Use saturation blending mode while painting. * HUE Hue, Use hue blending mode while painting. * ERASE_ALPHA Erase Alpha, Erase alpha while painting. * ADD_ALPHA Add Alpha, Add alpha while painting.
