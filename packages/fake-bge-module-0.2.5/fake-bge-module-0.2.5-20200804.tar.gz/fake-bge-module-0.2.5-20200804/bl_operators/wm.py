...
class BRUSH_OT_active_index_set(bpy_types.Operator):
    bl_idname = None
    ''' '''
...
class WM_OT_addon_disable(bpy_types.Operator):
    bl_idname = None
    ''' '''
...
class WM_OT_addon_enable(bpy_types.Operator):
    bl_idname = None
    ''' '''
...
class WM_OT_addon_expand(bpy_types.Operator):
    bl_idname = None
    ''' '''
...
class WM_OT_addon_install(bpy_types.Operator):
    bl_idname = None
    ''' '''
...
class WM_OT_addon_refresh(bpy_types.Operator):
    bl_idname = None
    ''' '''
...
class WM_OT_addon_remove(bpy_types.Operator):
    bl_idname = None
    ''' '''
...
class WM_OT_addon_userpref_show(bpy_types.Operator):
    bl_idname = None
    ''' '''
...
class WM_OT_app_template_install(bpy_types.Operator):
    bl_idname = None
    ''' '''
...
class WM_OT_appconfig_activate(bpy_types.Operator):
    bl_idname = None
    ''' '''
...
class WM_OT_appconfig_default(bpy_types.Operator):
    bl_idname = None
    ''' '''
...
class WM_OT_blenderplayer_start(bpy_types.Operator):
    bl_idname = None
    ''' '''
...
class WM_OT_copy_prev_settings(bpy_types.Operator):
    bl_idname = None
    ''' '''
...
class WM_OT_keyconfig_activate(bpy_types.Operator):
    bl_idname = None
    ''' '''
...
class WM_OT_keyconfig_export(bpy_types.Operator):
    all = None
    ''' '''
...
class WM_OT_keyconfig_import(bpy_types.Operator):
    bl_idname = None
    ''' '''
...
class WM_OT_keyconfig_remove(bpy_types.Operator):
    bl_idname = None
    ''' '''
...
class WM_OT_keyconfig_test(bpy_types.Operator):
    bl_idname = None
    ''' '''
...
class WM_OT_keyitem_add(bpy_types.Operator):
    bl_idname = None
    ''' '''
...
class WM_OT_keyitem_remove(bpy_types.Operator):
    bl_idname = None
    ''' '''
...
class WM_OT_keyitem_restore(bpy_types.Operator):
    bl_idname = None
    ''' '''
...
class WM_OT_keymap_restore(bpy_types.Operator):
    all = None
    ''' '''
...
class WM_OT_theme_install(bpy_types.Operator):
    bl_idname = None
    ''' '''
