...
setuptools.setup(
        ...
        scripts = [],
        entry_points = {'console_scripts': ['arid-config=arid_config:main_arid_config', 'aridity=aridity:main_aridity', 'processtemplate=processtemplate:main_processtemplate']},
        **ext_modules())
