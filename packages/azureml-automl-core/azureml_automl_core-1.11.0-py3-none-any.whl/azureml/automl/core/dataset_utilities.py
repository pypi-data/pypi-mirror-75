...
def get_datasets_json(training_data=None,
    ...
    if any(var is not None for var in df_value_list):
        ...
        if dataset_json is None:
            raise DataException("Could not convert dataflow to JSON.", has_pii=False)
...
def _save_datasets_to_json(dataset_dict):
    ...
    for name in dataset_dict:
        ...
        try:
            ...
            raise DataprepException.from_exception(e).with_generic_msg('Error when saving datasets to JSON.')
