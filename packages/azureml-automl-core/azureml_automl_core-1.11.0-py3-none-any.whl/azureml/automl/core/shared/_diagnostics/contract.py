...
class Contract:
    ...
    def assert_value(value: Any, name: str, reference_code: Optional[str] = None, log_safe: bool = True) -> None:
        ...
        :raises ValidationException (with an 'AutoMLInternal' system error)
        """
        error_details = "Expected argument {} ({}) to have a valid value.".format(name, value)
    ...
    def assert_type(value: Any, name: str,
                    expected_types: Union[type, Tuple[Union[type, Tuple[Any, ...]], ...]],
        ...
        :raises ValidationException (with an 'AutoMLInternal' system error)
        """
        error_details = "Expected {} ({}) of type {}, but is of type {}.".format(
            name, value, expected_types, type(value))
