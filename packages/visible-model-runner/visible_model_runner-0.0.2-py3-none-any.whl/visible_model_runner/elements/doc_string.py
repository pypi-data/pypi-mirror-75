...
CONFUSING_STREAMLIT_MODULES = ("visible_model_runner.DeltaGenerator", "visible_model_runner.caching")
...
def marshall(proto, obj):
    ...
    if module_name in CONFUSING_STREAMLIT_MODULES:
        proto.doc_string.module = "visible_model_runner"
...
def _get_signature(f):
    is_delta_gen = False
    try:
        is_delta_gen = f.__module__ == "visible_model_runner.DeltaGenerator"
