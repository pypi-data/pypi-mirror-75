...
from visible_model_runner.errors import StreamlitAPIException, MarkdownFormattedException
from visible_model_runner.folder_black_list import FolderBlackList
...
_CYCLE_PLACEHOLDER = b"visible_model_runner-57R34ML17-hesamagicalponyflyingthroughthesky-CYCLE"
...
class _CodeHasher:
    ...
    def _to_bytes(self, obj, context):
        ...
        if _is_magicmock(obj):
            ...
            if obj.__module__.startswith("visible_model_runner"):
                # Ignore visible_model_runner modules even if they are in the CWD
...
(https://visible_model_runner.io/docs/advanced_caching.html)
for more details.
            """
            % args
        ).strip("\n")
...
(https://github.com/visible_model_runner/visible_model_runner/issues/new/choose)
            """
            % args
        ).strip("\n")
...
here.] (https://github.com/visible_model_runner/visible_model_runner/issues/new/choose)
        """
            % args
        ).strip("\n")
