...
# source: visible_model_runner/proto/Audio.proto
...
Audio = _reflection.GeneratedProtocolMessageType('Audio', (_message.Message,), dict(
  DESCRIPTOR = _AUDIO,
  __module__ = 'visible_model_runner.proto.Audio_pb2'
