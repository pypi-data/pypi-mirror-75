...
# source: visible_model_runner/proto/Image.proto
...
Image = _reflection.GeneratedProtocolMessageType('Image', (_message.Message,), dict(
  DESCRIPTOR = _IMAGE,
  __module__ = 'visible_model_runner.proto.Image_pb2'
