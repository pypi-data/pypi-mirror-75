...
# source: visible_model_runner/proto/Initialize.proto
...
_ENVIRONMENTINFO = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='visible_model_runner_version', full_name='EnvironmentInfo.visible_model_runner_version', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_INITIALIZE.fields_by_name['session_state'].message_type = visible__model__runner_dot_proto_dot_SessionState__pb2._SESSIONSTATE
...
Initialize = _reflection.GeneratedProtocolMessageType('Initialize', (_message.Message,), dict(
  ...
  __module__ = 'visible_model_runner.proto.Initialize_pb2'
