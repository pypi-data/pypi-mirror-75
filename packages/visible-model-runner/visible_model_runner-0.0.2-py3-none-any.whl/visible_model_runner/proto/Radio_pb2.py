...
# source: visible_model_runner/proto/Radio.proto
...
Radio = _reflection.GeneratedProtocolMessageType('Radio', (_message.Message,), dict(
  DESCRIPTOR = _RADIO,
  __module__ = 'visible_model_runner.proto.Radio_pb2'
