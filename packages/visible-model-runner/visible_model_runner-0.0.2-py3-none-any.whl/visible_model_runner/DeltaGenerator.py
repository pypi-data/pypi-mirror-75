...
from visible_model_runner import caching
from visible_model_runner import config
from visible_model_runner import cursor
from visible_model_runner import type_util
from visible_model_runner.ReportThread import get_report_ctx
from visible_model_runner.errors import DuplicateWidgetID
from visible_model_runner.errors import StreamlitAPIException
from visible_model_runner.errors import NoSessionContext
from visible_model_runner.file_util import get_encoded_file_data
from visible_model_runner.js_number import JSNumber
from visible_model_runner.js_number import JSNumberBoundsException
from visible_model_runner.proto import Alert_pb2
from visible_model_runner.proto import Balloons_pb2
from visible_model_runner.proto import BlockPath_pb2
from visible_model_runner.proto import ForwardMsg_pb2
from visible_model_runner.proto.NumberInput_pb2 import NumberInput
from visible_model_runner.proto.TextInput_pb2 import TextInput
from visible_model_runner.logger import get_logger
from visible_model_runner.type_util import is_type
...
class DeltaGenerator(object):
    ...
    def text(self, element, body):
        ...
        .. output::
           https://share.visible_model_runner.io/0.25.0-2JkNY/index.html?id=PYxU1kee5ubuhGR11NsnT1
           height: 50px
    ...
    def markdown(self, element, body, unsafe_allow_html=False):
        ...
        unsafe_allow_html : bool
            ...
            https://github.com/visible_model_runner/visible_model_runner/issues/152
            ...
            *Also note that `unsafe_allow_html` is a temporary measure and may
            ...
            https://discuss.visible_model_runner.io/t/96
        ...
        .. output::
           https://share.visible_model_runner.io/0.25.0-2JkNY/index.html?id=PXz9xgY8aB88eziDVEZLyS
           height: 50px
    ...
    def latex(self, element, body):
        ...
        .. output::
           https://share.visible_model_runner.io/0.50.0-td2L/index.html?id=NJFsy6NbGTsH2RF9W6ioQ4
           height: 75px
    ...
    def code(self, element, body, language="python"):
        ...
        .. output::
           https://share.visible_model_runner.io/0.27.0-kBtt/index.html?id=VDRnaCEZWSBCNUd5gNQZv2
           height: 100px
    ...
    def json(self, element, body):
        ...
        .. output::
           https://share.visible_model_runner.io/0.25.0-2JkNY/index.html?id=CTFkMQd89hw3yZbZ4AUymS
           height: 280px
    ...
    def title(self, element, body):
        ...
        .. output::
           https://share.visible_model_runner.io/0.25.0-2JkNY/index.html?id=SFcBGANWd8kWXF28XnaEZj
           height: 100px
    ...
    def header(self, element, body):
        ...
        .. output::
           https://share.visible_model_runner.io/0.25.0-2JkNY/index.html?id=AnfQVFgSCQtGv6yMUMUYjj
           height: 100px
    ...
    def subheader(self, element, body):
        ...
        .. output::
           https://share.visible_model_runner.io/0.25.0-2JkNY/index.html?id=LBKJTfFUwudrbWENSHV6cJ
           height: 100px
    ...
    def help(self, element, obj):
        ...
        """
        import visible_model_runner.elements.doc_string as doc_string
    ...
    def exception(self, element, exception):
        ...
        """
        import visible_model_runner.elements.exception_proto as exception_proto
    ...
    def dataframe(self, data=None, width=None, height=None):
        ...
        .. output::
           https://share.visible_model_runner.io/0.25.0-2JkNY/index.html?id=165mJbzWdAC8Duf8a4tjyQ
           height: 330px
        ...
        .. output::
           https://share.visible_model_runner.io/0.29.0-dV1Y/index.html?id=Hb6UymSNuZDzojUNybzPby
           height: 285px

        """
        import visible_model_runner.elements.data_frame_proto as data_frame_proto
    ...
    def line_chart(
        ...
        .. output::
           https://share.visible_model_runner.io/0.50.0-td2L/index.html?id=BdxXG3MmrVBfJyqS2R2ki8
           height: 220px

        """

        import visible_model_runner.elements.altair as altair
    ...
    def area_chart(
        ...
        .. output::
           https://share.visible_model_runner.io/0.50.0-td2L/index.html?id=Pp65STuFj65cJRDfhGh4Jt
           height: 220px
    ...
    def bar_chart(
        ...
        .. output::
           https://share.visible_model_runner.io/0.50.0-td2L/index.html?id=5U5bjR2b3jFwnJdDfSvuRk
           height: 220px
    ...
    def vega_lite_chart(
        ...
        **kwargs : any
        ...
        .. output::
           https://share.visible_model_runner.io/0.25.0-2JkNY/index.html?id=8jmmXR8iKoZGV4kXaKGYV5
           height: 200px
        ...
        """
        import visible_model_runner.elements.vega_lite as vega_lite
    ...
    def graphviz_chart(
        ...
        .. output::
           https://share.visible_model_runner.io/0.56.0-xTAd/index.html?id=GBn3GXZie5K1kXuBKe4yQL
           height: 400px

        """
        import visible_model_runner.elements.graphviz_chart as graphviz_chart
    ...
    def plotly_chart(
        ...
        **kwargs
        ...
        sharing : {'visible_model_runner', 'private', 'secret', 'public'}
            Use 'visible_model_runner' to insert the plot and all its dependencies
        ...
        **kwargs
        ...
        .. output::
           https://share.visible_model_runner.io/0.56.0-xTAd/index.html?id=TuP96xX8JnsoQeUGAPjkGQ
           height: 400px
        ...
        import visible_model_runner.elements.plotly_chart as plotly_chart
    ...
    def pyplot(self, element, fig=None, clear_figure=None, **kwargs):
        ...
        **kwargs : any
        ...
        .. output::
           https://share.visible_model_runner.io/0.25.0-2JkNY/index.html?id=PwzFN7oLZsvb6HDdwdjkRB
           height: 530px
        ...
        """
        import visible_model_runner.elements.pyplot as pyplot
    ...
    def bokeh_chart(self, element, figure, use_container_width=False):
        ...
        .. output::
           https://share.visible_model_runner.io/0.56.0-xTAd/index.html?id=Fdhg51uMbGMLRRxXV6ubzp
           height: 600px

        """
        import visible_model_runner.elements.bokeh_chart as bokeh_chart
    ...
    def image(
        ...
        .. output::
           https://share.visible_model_runner.io/0.25.0-2JkNY/index.html?id=YCFaqPgmgpEz7jwE4tHAzY
           height: 630px
    ...
    def audio(self, element, data, format="audio/wav", start_time=0):
        ...
        .. output::
           https://share.visible_model_runner.io/0.25.0-2JkNY/index.html?id=Dv3M9sA7Cg8gwusgnVNTHb
           height: 400px
    ...
    def video(self, element, data, format="video/mp4", start_time=0):
        ...
        .. output::
           https://share.visible_model_runner.io/0.25.0-2JkNY/index.html?id=Wba9sZELKfKwXH4nDCCbMv
           height: 600px
    ...
    def beta_color_picker(self, element, label, value=None, key=None):
        ...
        https://docs.visible_model_runner.io/en/latest/pre_release_features.html for more
        information.
    ...
    def map(self, element, data=None, zoom=None, use_container_width=True):
        ...
        https://docs.visible_model_runner.io/en/latest/cli.html#view-all-config-options for more
        ...
        .. output::
           https://share.visible_model_runner.io/0.53.0-SULT/index.html?id=9gTiomqPEbvHY2huTLoQtH
           height: 600px

        """
        import visible_model_runner.elements.map as visible_model_runner_map

        element.deck_gl_json_chart.json = visible_model_runner_map.to_deckgl_json(data, zoom)
    ...
    def deck_gl_chart(self, element, spec=None, use_container_width=False, **kwargs):
        ...
        **kwargs : any
        ...
        .. output::
           https://share.visible_model_runner.io/0.50.0-td2L/index.html?id=3GfRygWqxuqB5UitZLjz9i
           height: 530px
        ...
        import visible_model_runner.elements.deck_gl as deck_gl
    ...
    def pydeck_chart(self, element, pydeck_obj=None, use_container_width=False):
        ...
        .. output::
           https://share.visible_model_runner.io/0.25.0-2JkNY/index.html?id=ASTdExBpJ1WxbGceneKN1i
           height: 530px

        """
        import visible_model_runner.elements.deck_gl_json_chart as deck_gl_json_chart
    ...
    def table(self, element, data=None):
        ...
        .. output::
           https://share.visible_model_runner.io/0.25.0-2JkNY/index.html?id=KfZvDMprL4JFKXbpjD3fpq
           height: 480px
