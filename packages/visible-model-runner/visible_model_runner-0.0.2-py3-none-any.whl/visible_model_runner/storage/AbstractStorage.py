...
from visible_model_runner import errors
...
class AbstractStorage(object):
    ...
    def __init__(self):
        ...
        self._release_hash = "%s-%s" % (
            visible_model_runner.__version__,
...
def _get_static_dir():
    """Return the path to lib/visible_model_runner/static.
    ...
    visible_model_runner_dir = os.path.normpath(os.path.join(module_dir, ".."))

    return os.path.normpath(os.path.join(visible_model_runner_dir, "static"))
...
def _get_static_files(static_dir):
    ...
    ----------
    static_dir : str
        The path to lib/visible_model_runner/static.
