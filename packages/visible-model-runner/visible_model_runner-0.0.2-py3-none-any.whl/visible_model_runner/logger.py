...
def setup_formatter(logger):
    ...
    if hasattr(logger, "visible_model_runner_console_handler"):
        logger.removeHandler(logger.visible_model_runner_console_handler)

    logger.visible_model_runner_console_handler = logging.StreamHandler()
    ...
    if development.is_development_mode:
        ...
        logger.visible_model_runner_console_handler.setFormatter(formatter)

    # Register the new console logger.
    logger.addHandler(logger.visible_model_runner_console_handler)
