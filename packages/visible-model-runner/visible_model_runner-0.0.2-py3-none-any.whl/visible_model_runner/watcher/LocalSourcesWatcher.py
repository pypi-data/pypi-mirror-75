...
try:
    ...
    from visible_model_runner.watcher.EventBasedFileWatcher import EventBasedFileWatcher
...
def get_file_watcher_class():
    ...
    if watcher_type == "auto":
        if watchdog_available:
            ...
            from visible_model_runner.watcher.PollingFileWatcher import PollingFileWatcher
