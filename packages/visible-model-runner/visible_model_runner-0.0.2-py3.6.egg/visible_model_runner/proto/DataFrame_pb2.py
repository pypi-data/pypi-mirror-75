...
# source: visible_model_runner/proto/DataFrame.proto
...
DataFrame = _reflection.GeneratedProtocolMessageType('DataFrame', (_message.Message,), dict(
  ...
  __module__ = 'visible_model_runner.proto.DataFrame_pb2'
