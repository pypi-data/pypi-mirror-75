...
# source: visible_model_runner/proto/DocString.proto
...
DocString = _reflection.GeneratedProtocolMessageType('DocString', (_message.Message,), dict(
  ...
  __module__ = 'visible_model_runner.proto.DocString_pb2'
