...
REPORT_CONTEXT_ATTR_NAME = "visible_model_runner_report_ctx"
...
class ReportThread(threading.Thread):
    ...
    def __init__(
        ...
        self.visible_model_runner_report_ctx = ReportContext(
...
def get_report_ctx():
    ...
    if ctx is None and visible_model_runner._is_running_with_visible_model_runner:
        # Only warn about a missing ReportContext if we were started
        # via `visible_model_runner run`. Otherwise, the user is likely running a
        # script "bare", and doesn't need to be warned about visible_model_runner
