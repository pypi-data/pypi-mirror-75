...
from visible_model_runner.error_util import get_nonvisible_model_runner_traceback
from visible_model_runner.errors import MarkdownFormattedException
...
def marshall(exception_proto, exception):
    ...
    stack_trace = _get_stack_trace_str_list(
        exception, strip_visible_model_runner_stack_entries=is_api_exception
    )
...
def _get_stack_trace_str_list(exception, strip_visible_model_runner_stack_entries=False):
    ...
    strip_visible_model_runner_stack_entries : bool
    ...
    if extracted_traceback is None:
        ...
        if strip_visible_model_runner_stack_entries:
            extracted_frames = get_nonvisible_model_runner_traceback(extracted_traceback)
