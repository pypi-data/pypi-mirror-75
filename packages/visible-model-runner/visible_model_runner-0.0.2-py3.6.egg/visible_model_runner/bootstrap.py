...
from visible_model_runner import net_util
...
from visible_model_runner.server.Server import Server
...
def _fix_matplotlib_crash():
    ...
    if config.get_option("runner.fixMatplotlib"):
        try:
            ...
            #  need to run without consulting visible_model_runner.config.get_option,
            #  because this would import visible_model_runner, and therefore matplotlib.
            import matplotlib
...
def _fix_sys_argv(script_path, args):
    """sys.argv needs to exclude visible_model_runner arguments and parameters
