...
if __name__ == '__main__':
    # _url = 'https://adrenaline.com.br/forum/'
    # _url = 'https://forum.outerspace.com.br/'

    # interage = Interage(_url, _header)
    cookie_file = 'cache_ign.session'
    url = 'https://www.ignboards.com/'
    _header = {
        'User-Agent': 'kkkkkkkkkkkk',
    }
    ign = Igninterage(url, cookie_file)
    ...
    # print(ign.interact_session.cookies)-
    # print(ign.interage.data)

    # ign.interage.react(react_id='1', post_id='522092468')
    # ign.interage.comentar('kk', '455548688')
    try:
        ign.ign_login()
        # ign.xenforo2_login('honrarias', 'pitango213W')
        # ign.interage.react('1', '522183399')
        # ign.react('1', '522204111')
        ign.msg_privada('pronto', 'vou upar', 'honrarias', )
        # ign.comentar('nice! uma guerrinha no oriente medio para comemorar seria dahora', '455555560')
        # ign.interage.xenforo_default_login('fabiofireflame@hotmail.com', '97454555')
        # ign.interage.xenforo_default_login('honrarias', 'pitango213W')
        # ign.interage.xenforo_default_login('fabicofuze@gmail.com', '91790170ttt')
