...
class Gerber:
    ...
    def render_files(self, outline, drill, copper, mask, silk='', filename='pcb.svg'):
        ...
        area_fill(file=mask_file,  color='grey')
        draw_macros(file=mask_file,  color='grey')
        ...
        if(silk):
            ...
            draw_macros(file=silk_file,
                        color='white')
            area_fill(file=silk_file,
                      color='white')
