...
ALL_FACTORS = GMOBIS + AMOBIS + CAUSES + STRINDEX_CATS + POLLUTS + MSMTS + ALL_RANGES
...
PER_APPENDS = ['_per_1K', '_per_1M', '_per_person_per_land_KM2', '_per_person_per_city_KM2']
...
LOG_CATS = [cat + '_log' for cat in BASE_PLUS_PER_CATS]
ALL_COUNT_CATS =  BASECOUNT_CATS + PER_CATS + LOGNAT_CATS + LOG_CATS
PER_COUNT_CATS = [cat for cat in ALL_COUNT_CATS if 'per' in cat]
DMA_COUNT_CATS = [cat for cat in ALL_COUNT_CATS if 'dma' in cat]
