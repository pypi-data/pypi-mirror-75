...
class LambdaToSqsToLambda(
    ...
    def __init__(
        ...
        id: str,
        *,
        consumer_lambda_function_props: typing.Optional[
        ...
        existing_consumer_lambda_obj: typing.Optional[
            aws_cdk.aws_lambda.Function
        ] = None,
        existing_producer_lambda_obj: typing.Optional[
            aws_cdk.aws_lambda.Function
        ] = None,
        existing_queue_obj: typing.Optional[aws_cdk.aws_sqs.Queue] = None,
        max_receive_count: typing.Optional[jsii.Number] = None,
        producer_lambda_function_props: typing.Optional[
            aws_cdk.aws_lambda.FunctionProps
        ] = None,
...
class LambdaToSqsToLambdaProps:
    def __init__(
        ...
        *,
        ...
        if isinstance(consumer_lambda_function_props, dict):
            consumer_lambda_function_props = aws_cdk.aws_lambda.FunctionProps(
                **consumer_lambda_function_props
            )
        ...
        if isinstance(producer_lambda_function_props, dict):
            producer_lambda_function_props = aws_cdk.aws_lambda.FunctionProps(
    ...
    def consumer_lambda_function_props(
        ...
        """
        return self._values.get("consumer_lambda_function_props")
    ...
    def existing_consumer_lambda_obj(
        ...
        :default: - None.
        """
        return self._values.get("existing_consumer_lambda_obj")
    ...
    def existing_producer_lambda_obj(
        ...
        :default: - None.
        """
        return self._values.get("existing_producer_lambda_obj")
    ...
    def producer_lambda_function_props(
        ...
        :default: - Default properties are used.
        """
        return self._values.get("producer_lambda_function_props")
