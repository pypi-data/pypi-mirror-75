...
TRAIN_DATA = trim_entity_spans(convert_dataturks_to_spacy("final_final_training_shuffled.json"))
...
def main(
    model=None,
    new_model_name="resumefeatures_robustt",
    output_dir='/home/yenat/Videos/pycvparser3/pycvparser3',
    n_iter=50
):
