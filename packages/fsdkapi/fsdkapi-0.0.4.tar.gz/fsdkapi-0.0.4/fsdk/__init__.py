    ...
    def get_all_info(self):
        ...
        def get_info(data):
            try:
                answer = ''
                i = data['data']
                answer += f"📌*{i['public']['name']}*\n👥Онлайн на сервере: *{i['public']['online']}*\n🗺Карта: *{i['public']['map']}*\n*❤️IP:* `{i['public']['ip']}`\n\n"
                answer += f"📌*{i['public_two']['name']}*\n👥Онлайн на сервере: *{i['public_two']['online']}*\n🗺Карта: *{i['public_two']['map']}*\n*❤️IP:* `{i['public_two']['ip']}`\n\n"
                answer += f"📌*{i['brush']['name']}*\n👥Онлайн на сервере: *{i['brush']['online']}*\n🗺Карта: *{i['brush']['map']}*\n*❤️IP:* `{i['brush']['ip']}`\n\n{data['data']['all_online']}"
                return answer
            except Exception:
                return 'Ошибка'
        try:
            ...
            return get_info(all_data)
        except Exception as e:
            return get_info('Ошибка')
