...
class APIServicer(object):
  ...
  def FileOperationV2(self, request_iterator, context):
  ...
  def GetTarV2(self, request, context):
    # missing associated documentation comment in .proto file
    pass
    context.set_code(grpc.StatusCode.UNIMPLEMENTED)
    context.set_details('Method not implemented!')
...
class ObjectAPIStub(object):
  ...
  def __init__(self, channel):
    ...
    self.PutObjDirect = channel.stream_unary(
        '/pfs.ObjectAPI/PutObjDirect',
        request_serializer=client_dot_pfs_dot_pfs__pb2.PutObjDirectRequest.SerializeToString,
        response_deserializer=google_dot_protobuf_dot_empty__pb2.Empty.FromString,
        )
    self.GetObjDirect = channel.unary_stream(
...
class ObjectAPIServicer(object):
  ...
  def PutObjDirect(self, request_iterator, context):
  ...
  def GetObjDirect(self, request, context):
