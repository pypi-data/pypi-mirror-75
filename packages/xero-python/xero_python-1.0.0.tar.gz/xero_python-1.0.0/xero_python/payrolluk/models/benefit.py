...
class Benefit(BaseModel):
    ...
    def category(self, category):
        ...
        allowed_values = ["StakeholderPension", "Other"]  # noqa: E501
    ...
    def standard_amount(self, standard_amount):
        ...
        if standard_amount is None:
            raise ValueError(
                "Invalid value for `standard_amount`, must not be `None`"
            )  # noqa: E501
    ...
    def calculation_type(self, calculation_type):
        ...
        allowed_values = ["FixedAmount", "PercentageOfGross"]  # noqa: E501
