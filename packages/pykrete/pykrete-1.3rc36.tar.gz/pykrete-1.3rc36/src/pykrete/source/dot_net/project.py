...
class Project:
    ...
    def set_default_mode(self, mode):
        ...
        """
        configuration_element_open = '<Configuration Condition=" \'$(Configuration)\' == \'\' ">'
        configuration_element_close = '</Configuration>'
        assert_true(
            File(self._path).update(
                lambda x: configuration_element_open in x,
                ReReplacement(
                    f'{configuration_element_open}.*?{configuration_element_close}',
                    f'{configuration_element_open}{mode.name.title()}{configuration_element_close}',
