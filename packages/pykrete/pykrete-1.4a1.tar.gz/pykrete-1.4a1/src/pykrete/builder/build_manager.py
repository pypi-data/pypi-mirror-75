...
class BuildManager:
    ...
    def __init__(self, version: Version, build_events=None):
        """Initializes this instance
        :param version: Build version
        """
        self._version = version
        self._build_events = build_events if build_events else BuildEvents()
    ...
    def run(self):
        ...
        self._build_events.run_pre_build()
        self._build()
        self._build_events.run_post_build()
        self._upload()
