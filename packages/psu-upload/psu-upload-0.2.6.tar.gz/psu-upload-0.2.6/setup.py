"""
Python setup file for the psu-upload app.
...
psu_upload/__init__.py and re-run the above command.
...
setup(
    ...
    url='https://github.com/PSU-OIT-ARC/django-psu-upload',
