...
To uninstall:
  pip uninstall tflite_model_maker
"""
...
if nightly:
  ...
  version = '0.1.0'  # Version prefix, usually major.minor.micro.
...
DESCRIPTION = 'TFLite Model Maker: a model customization library for on-device applications.'  # pylint: disable=line-too-long
