...
[boto3.KinesisVideoSignalingChannels 1.14.31](https://boto3.amazonaws.com/v1/documentation/api/1.14.31/reference/services/kinesis-video-signaling.html#KinesisVideoSignalingChannels) service
