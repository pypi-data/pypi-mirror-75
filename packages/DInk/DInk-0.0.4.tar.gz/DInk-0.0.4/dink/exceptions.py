...
__all__ = [
    ...
    'DInkInvalidRequest',
    'DInkNotFound',
    'DInkRequestLimitExceeded',
    'DInkUnauthorized'
]


class DInkException(Exception):
    """
    ...
    def get_class_by_status_code(cls, error_type, default=None):
        ...
        class matches the given status code then the base `DInkException`
        class is returned.
        """

        class_map = {
            400: DInkInvalidRequest,
            401: DInkUnauthorized,
            403: DInkForbidden,
            405: DInkForbidden,
            404: DInkNotFound,
            429: DInkRequestLimitExceeded
        }

        return class_map.get(error_type, default or DInkException)


class DInkForbidden(DInkException):
    """
