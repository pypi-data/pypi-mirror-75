...
long_description = 'fork of xolox coloredlogs with possibility to log to travis and jupyter'   # will be overwritten with long_description if exists !
...
setup_kwargs['description'] = 'fork of xolox coloredlogs with possibility to log to travis and jupyter'
...
setup_kwargs['entry_points'] = {'console_scripts': ['coloredlogs = bitranox_coloredlogs.cli:main']}
