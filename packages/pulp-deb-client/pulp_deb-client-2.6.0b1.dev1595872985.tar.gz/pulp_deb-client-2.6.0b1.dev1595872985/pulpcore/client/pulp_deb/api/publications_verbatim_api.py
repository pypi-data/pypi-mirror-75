...
class PublicationsVerbatimApi(object):
    ...
    def create(self, deb_verbatim_publication, **kwargs):  # noqa: E501
        """create  # noqa: E501

        Trigger an asynchronous task to publish content  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create(deb_verbatim_publication, async_req=True)
        >>> result = thread.get()

        :param async_req bool: execute request asynchronously
        :param DebVerbatimPublication deb_verbatim_publication: (required)
        ...
        return self.create_with_http_info(deb_verbatim_publication, **kwargs)  # noqa: E501

    def create_with_http_info(self, deb_verbatim_publication, **kwargs):  # noqa: E501
        """create  # noqa: E501

        Trigger an asynchronous task to publish content  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create_with_http_info(deb_verbatim_publication, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('deb_verbatim_publication' not in local_var_params or  # noqa: E501
                                                        local_var_params['deb_verbatim_publication'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `deb_verbatim_publication` when calling `create`")  # noqa: E501
        ...
        body_params = None
        if 'deb_verbatim_publication' in local_var_params:
            body_params = local_var_params['deb_verbatim_publication']
        # HTTP header `Accept`
    ...
    def delete(self, verbatim_publication_href, **kwargs):  # noqa: E501
        ...
        :param async_req bool: execute request asynchronously
        :param str verbatim_publication_href: (required)
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
        :param _request_timeout: timeout setting for this request. If one
    ...
    def read_with_http_info(self, verbatim_publication_href, **kwargs):  # noqa: E501
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(DebVerbatimPublicationResponse, status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='DebVerbatimPublicationResponse',  # noqa: E501
            auth_settings=auth_settings,
            async_req=local_var_params.get('async_req'),
            _return_http_data_only=local_var_params.get('_return_http_data_only'),  # noqa: E501
            _preload_content=local_var_params.get('_preload_content', True),
