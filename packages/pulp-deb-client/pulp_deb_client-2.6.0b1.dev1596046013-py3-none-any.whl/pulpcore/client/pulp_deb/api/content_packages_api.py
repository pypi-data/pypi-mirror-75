...
class ContentPackagesApi(object):
    ...
    def list(self, **kwargs):  # noqa: E501
        ...
        :param str auto_built_package: auto_built_package
        :param str build_essential: build_essential
        :param str built_using: built_using
        :param str essential: essential
        :param str installed_size: installed_size
        :param int limit: Number of results to return per page.
        :param str maintainer: maintainer
        :param str multi_arch: multi_arch
        :param int offset: The initial index from which to return the results.
        :param str ordering: Which field to use when ordering the results.
        :param str origin: origin
        :param str original_maintainer: original_maintainer
