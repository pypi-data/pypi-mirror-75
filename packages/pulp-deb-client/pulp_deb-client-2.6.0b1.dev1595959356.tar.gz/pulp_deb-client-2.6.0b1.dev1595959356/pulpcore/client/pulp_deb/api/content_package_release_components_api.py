...
class ContentPackageReleaseComponentsApi(object):
    ...
    def create(self, deb_package_release_component, **kwargs):  # noqa: E501
        """create  # noqa: E501

        A ViewSet for PackageReleaseComponent.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create(deb_package_release_component, async_req=True)
        >>> result = thread.get()

        :param async_req bool: execute request asynchronously
        :param DebPackageReleaseComponent deb_package_release_component: (required)
        ...
        return self.create_with_http_info(deb_package_release_component, **kwargs)  # noqa: E501

    def create_with_http_info(self, deb_package_release_component, **kwargs):  # noqa: E501
        """create  # noqa: E501

        A ViewSet for PackageReleaseComponent.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create_with_http_info(deb_package_release_component, async_req=True)
        >>> result = thread.get()
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(DebPackageReleaseComponentResponse, status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        if self.api_client.client_side_validation and ('deb_package_release_component' not in local_var_params or  # noqa: E501
                                                        local_var_params['deb_package_release_component'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `deb_package_release_component` when calling `create`")  # noqa: E501
        ...
        body_params = None
        if 'deb_package_release_component' in local_var_params:
            body_params = local_var_params['deb_package_release_component']
        # HTTP header `Accept`
        ...
        return self.api_client.call_api(
            ...
            response_type='DebPackageReleaseComponentResponse',  # noqa: E501
    ...
    def list(self, **kwargs):  # noqa: E501
        ...
        :param str package: package
        :param str release_component: release_component
    ...
    def read(self, package_release_component_href, **kwargs):  # noqa: E501
        ...
        :param async_req bool: execute request asynchronously
        :param str package_release_component_href: (required)
        :param str fields: A list of fields to include in the response.
        :param str exclude_fields: A list of fields to exclude from the response.
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
