...
- API version: v3
- Package version: 2.6.0b1.dev01596218726
...
*DistributionsAptApi* | [**partial_update**](docs/DistributionsAptApi.md#partial_update) | **PATCH** {apt_distribution_href} | Update an apt distribution
...
*RemotesAptApi* | [**partial_update**](docs/RemotesAptApi.md#partial_update) | **PATCH** {apt_remote_href} | Update an apt remote
...
*RepositoriesAptApi* | [**partial_update**](docs/RepositoriesAptApi.md#partial_update) | **PATCH** {apt_repository_href} | Update an apt repository
...
*RepositoriesDebVersionsApi* | [**list**](docs/RepositoriesDebVersionsApi.md#list) | **GET** {apt_repository_version_href}versions/ | List repository versions
