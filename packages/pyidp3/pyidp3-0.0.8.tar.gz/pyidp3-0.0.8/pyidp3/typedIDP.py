...
from pyidp3.idp_py_syntax import parse_formula
from pyidp3.idpobjects import *
...
class IDP(object):
    ...
    def refresh(self):
        ...
        out = out.split("next:")
        from pyidp3.idp_parse_out import idp_parse
        sol_list = []
        for model in out:
            if model.strip() == "nil":
                if __debug__:
    ...
    def minimize(self, term, ssh=False, remote_idp_location=None,
        ...
        if not ssh:
            ...
            from pyidp3.communicator import communicator
