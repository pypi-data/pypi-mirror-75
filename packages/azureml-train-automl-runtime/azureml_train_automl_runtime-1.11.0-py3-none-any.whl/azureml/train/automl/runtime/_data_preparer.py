...
from azureml.automl.core.shared._diagnostics.automl_error_definitions import MalformedJsonString
...
from azureml.train.automl.exceptions import AuthorizationException, ClientException, \
    DataException, DatasetServiceException, NotFoundException
from azureml.automl.core.shared import logging_utilities
from azureml.automl.core.shared import constants
from azureml.automl.core.shared.exceptions import AutoMLException, ConfigException, MemorylimitException
...
class DataPreparerFromDatasetOptions(DataPreparer):
    ...
    def _parse(self, dataprep_json_obj: Dict[str, Any]) -> None:
        ...
        from azureml.data._dataset_deprecation import silent_deprecation_warning
        with silent_deprecation_warning():
            training_dataset = Dataset.get_by_id(ws, id=dataset_id)
        self._original_training_data = training_dataset._dataflow
