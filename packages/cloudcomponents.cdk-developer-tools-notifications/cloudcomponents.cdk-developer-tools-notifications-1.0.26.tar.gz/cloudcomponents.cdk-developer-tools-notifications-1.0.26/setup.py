    ...
    """
{
    ...
    "package_data": {
        "cloudcomponents.cdk_developer_tools_notifications._jsii": [
            "cdk-developer-tools-notifications@1.0.26.jsii.tgz"
        ],
        "cloudcomponents.cdk_developer_tools_notifications": [
            "py.typed"
        ]
    ...
    "install_requires": [
        "jsii>=1.9.0, <2.0.0",
        "publication>=0.0.3",
        "aws-cdk.aws-codebuild>=1.55.0, <2.0.0",
        "aws-cdk.aws-codecommit>=1.55.0, <2.0.0",
        "aws-cdk.aws-codedeploy>=1.55.0, <2.0.0",
        "aws-cdk.aws-codepipeline>=1.55.0, <2.0.0",
        "aws-cdk.aws-codestarnotifications>=1.55.0, <2.0.0",
        "aws-cdk.aws-iam>=1.55.0, <2.0.0",
        "aws-cdk.aws-lambda>=1.55.0, <2.0.0",
        "aws-cdk.aws-lambda-event-sources>=1.55.0, <2.0.0",
        "aws-cdk.aws-sns>=1.55.0, <2.0.0",
        "aws-cdk.core>=1.55.0, <2.0.0",
        "cloudcomponents.cdk-chatops>=1.0.24, <2.0.0"
    ],
    "classifiers": [
