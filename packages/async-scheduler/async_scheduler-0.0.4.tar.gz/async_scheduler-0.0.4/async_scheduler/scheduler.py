...
class Job:
    ...
    def __init__(
            ...
            cb: typing.Callable = None, async_cb: typing.Callable = None, executor=None
    ):
...
class AsyncScheduler:
    ...
    async def create_and_run_job(
            self, job_id: str, schedule: str, cb: typing.Callable, once: bool = False, executor=None
    ):
        """
        ...
        self._jobs[job_id] = Job(schedule_entry=schedule, cb=cb, once=once, executor=executor)
    ...
    async def create_and_run_async_job(
            self, job_id: str, schedule: str, cb: typing.Callable, once: bool = False
    ):
        """
        ...
        # Создаем новое задание
        self._jobs[job_id] = Job(schedule_entry=schedule, async_cb=cb, once=once)
