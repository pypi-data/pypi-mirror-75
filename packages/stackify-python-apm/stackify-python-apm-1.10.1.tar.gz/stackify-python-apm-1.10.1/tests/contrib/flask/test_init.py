...
class TestPrefixInstrumentation(TestCase):
    ...
    def test_prefix_data(self, get_property_info_mock, queue_mock):
        ...
        assert '{"result":"index"}' in transaction_dict.get('props', {}).get('RESPONSE_BODY')
        assert '19' == transaction_dict.get('props', {}).get('RESPONSE_SIZE_BYTES')
        assert 'application/json' in transaction_dict.get('props', {}).get('RESPONSE_HEADERS')
        assert '{"foo": "bar"}' == transaction_dict.get('props', {}).get('REQUEST_BODY')
        assert '14' == transaction_dict.get('props', {}).get('REQUEST_SIZE_BYTES')
        assert 'x-test' in transaction_dict.get('props', {}).get('REQUEST_HEADERS')
    ...
    def test_prefix_data_with_exception(self, get_property_info_mock, queue_mock):
        ...
        assert not transaction_dict.get('props', {}).get('RESPONSE_BODY')
        assert not transaction_dict.get('props', {}).get('RESPONSE_SIZE_BYTES')
        assert not transaction_dict.get('props', {}).get('RESPONSE_HEADERS')
        assert '{"foo": "bar"}' == transaction_dict.get('props', {}).get('REQUEST_BODY')
        assert '14' == transaction_dict.get('props', {}).get('REQUEST_SIZE_BYTES')
        assert 'x-test' in transaction_dict.get('props', {}).get('REQUEST_HEADERS')
    ...
    def test_prefix_data_with_template(self, get_property_info_mock, queue_mock):
        ...
        assert '<html><head>Test</head></html>' in transaction_dict.get('props', {}).get('RESPONSE_BODY')
        assert '30' == transaction_dict.get('props', {}).get('RESPONSE_SIZE_BYTES')
        assert 'text/html' in transaction_dict.get('props', {}).get('RESPONSE_HEADERS')
        assert '{"foo": "bar"}' == transaction_dict.get('props', {}).get('REQUEST_BODY')
        assert '14' == transaction_dict.get('props', {}).get('REQUEST_SIZE_BYTES')
        assert 'x-test' in transaction_dict.get('props', {}).get('REQUEST_HEADERS')
