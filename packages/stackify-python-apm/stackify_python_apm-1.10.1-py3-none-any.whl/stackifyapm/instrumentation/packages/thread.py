...
from stackifyapm.conf.constants import DEFAULT_PREFIX_ENABLED
...
class DummyConfig(object):
    ...
    prefix_enabled = DEFAULT_PREFIX_ENABLED
...
class DummyClient(object):
    ...
    def get_application_info(self):
        return {
            "config_file": self.config and self.config.config_file or DEFAULT_CONFIG_FILE,
        }
