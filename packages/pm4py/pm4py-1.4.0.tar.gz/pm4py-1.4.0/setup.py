...
setup(
    ...
    packages=['pm4py', 'pm4py.algo', 'pm4py.algo.discovery', 'pm4py.algo.discovery.dfg',
              ...
              'pm4py.algo.conformance.log_skeleton.versions', 'pm4py.algo.conformance.decomp_alignments',
              'pm4py.algo.conformance.decomp_alignments.versions', 'pm4py.algo.enhancement',
              'pm4py.algo.enhancement.sna', 'pm4py.algo.enhancement.sna.versions',
