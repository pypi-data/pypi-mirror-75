...
class Question:
    ...
    def __init__(self, data: dict):
        ...
        self.incorrect_answers: list = sample([unescape(answer) for answer in data.get('incorrect_answers')], len([unescape(answer) for answer in data.get('incorrect_answers')]))
