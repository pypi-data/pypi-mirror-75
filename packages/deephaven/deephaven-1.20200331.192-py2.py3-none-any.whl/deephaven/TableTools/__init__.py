...
def emptyTable(*args):
    ...
    **Incompatible overloads text - text from the first overload:**
    ...
    Returns a new empty Deephaven Table with no columns, but with defined number of rows.
...
def readBin(*args):
    ...
    *Overload 1*  
      ...
      :return: (com.illumon.iris.db.tables.Table) an Iris table object
    ...
    *Overload 6*  
      :param key: com.illumon.iris.db.v2.locations.TableKey
      :param sourceFiles: java.io.File...
...
def show(*args):
    ...
    *Overload 1*  
      :param source: (com.illumon.iris.db.tables.Table) - an Deephaven table object
...
def writeCsv(*args):
    ...
    *Overload 5*  
      :param source: com.illumon.iris.db.tables.Table
