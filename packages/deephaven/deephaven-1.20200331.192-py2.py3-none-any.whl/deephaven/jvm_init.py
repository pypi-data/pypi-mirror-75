...
def jvm_init(devroot=None,
    ...
    :param devroot: for Illumon Java installation - must include trailing path separator
    :param workspace: Java workspace directory
    :param propfile: Illumon Java propfile
    :param userHome: User's home directory
    :param keyfile: path to private key file for Iris user authentication
