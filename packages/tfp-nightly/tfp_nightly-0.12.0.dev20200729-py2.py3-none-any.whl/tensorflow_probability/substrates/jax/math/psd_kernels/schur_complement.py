...
#   `tensorflow_probability/substrates/jax/math/psd_kernels/schur_complement.py`
...
from tensorflow_probability.substrates.jax.bijectors import cholesky_outer_product
