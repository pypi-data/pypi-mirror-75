...
#   `tensorflow_probability/substrates/jax/experimental/inference_gym/targets/model.py`
...
from tensorflow_probability.substrates.jax.experimental.inference_gym.internal import ground_truth_encoding
...
_GROUND_TRUTH_MODULE_PATTERN = (
    ...
    'tensorflow_probability.substrates.jax.experimental.inference_gym.targets.ground_truth.{}'
)
