...
#   `tensorflow_probability/substrates/numpy/optimizer/linesearch/__init__.py`
...
from tensorflow_probability.substrates.numpy.optimizer.linesearch.hager_zhang import hager_zhang
