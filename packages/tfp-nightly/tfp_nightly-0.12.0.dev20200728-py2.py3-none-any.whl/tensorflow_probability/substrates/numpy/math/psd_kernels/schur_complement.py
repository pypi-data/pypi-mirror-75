...
#   `tensorflow_probability/substrates/numpy/math/psd_kernels/schur_complement.py`
...
from tensorflow_probability.substrates.numpy.bijectors import cholesky_outer_product
