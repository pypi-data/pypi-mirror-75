...
#   `tensorflow_probability/substrates/jax/optimizer/linesearch/__init__.py`
...
from tensorflow_probability.substrates.jax.optimizer.linesearch.hager_zhang import hager_zhang
