...
#   `tensorflow_probability/substrates/jax/distributions/normal_conjugate_posteriors.py`
...
from tensorflow_probability.python.internal.backend.jax.gen import linear_operator_addition  # pylint: disable=g-direct-tensorflow-import
