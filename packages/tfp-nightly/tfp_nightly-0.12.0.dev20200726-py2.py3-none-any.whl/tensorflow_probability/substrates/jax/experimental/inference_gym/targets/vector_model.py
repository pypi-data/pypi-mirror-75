...
#   `tensorflow_probability/substrates/jax/experimental/inference_gym/targets/vector_model.py`
...
from tensorflow_probability.substrates.jax.experimental.inference_gym.targets import model as model_lib
