...
#   `tensorflow_probability/substrates/numpy/distributions/normal_conjugate_posteriors.py`
...
from tensorflow_probability.python.internal.backend.numpy.gen import linear_operator_addition  # pylint: disable=g-direct-tensorflow-import
