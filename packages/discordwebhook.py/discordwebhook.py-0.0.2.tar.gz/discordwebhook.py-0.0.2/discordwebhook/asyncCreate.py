...
import requests, json, datetime, asyncio, aiohttp
...
class Webhook():
    ...
    def allowed_mentions(self, boolean):
        """boolean if mentions are allowed from the webhook - good for making sure webhooks dont mention and vice versa - defaults true"""
        if boolean == False:
            self.webhook["allowed_mentions"] = "false"
        else:
            pass
