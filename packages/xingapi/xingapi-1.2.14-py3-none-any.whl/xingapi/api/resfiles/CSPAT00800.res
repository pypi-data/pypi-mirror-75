BEGIN_FUNCTION_MAP
	.Func,현물취소주문,CSPAT00800,SERVICE=CSPAT00800,ENCRYPT,SIGNATURE,headtype=B,CREATOR=김기종,CREDATE=2011/12/07 09:23:48;
	BEGIN_DATA_MAP
	CSPAT00800InBlock1,In(*EMPTY*),input;
	begin
	...
	CSPAT00800OutBlock1,In(*EMPTY*),output;
	begin
	...
	CSPAT00800OutBlock2,Out(*EMPTY*),output;
	begin
		레코드갯수, RecCnt, RecCnt, long, 5
