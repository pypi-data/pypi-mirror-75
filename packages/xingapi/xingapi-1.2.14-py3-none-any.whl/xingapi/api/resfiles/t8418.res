BEGIN_FUNCTION_MAP
	.Func,업종챠트(N분)(t8418),t8418,attr,block,headtype=A;
	BEGIN_DATA_MAP
	t8418InBlock,기본입력,input;
	begin
	...
	begin
		...
		연속일자,cts_date,cts_date,char,8;
		연속시간,cts_time,cts_time,char,10;
		업종시작시간(HHMMSS),s_time,s_time,char,6;
		업종종료시간(HHMMSS),e_time,e_time,char,6;
		동시호가처리시간(MM:분),dshmin,dshmin,char,2;
		레코드카운트,rec_count,rec_count,long,7;
	end
	t8418OutBlock1,출력1,output,occurs;
	begin
		날짜,date,date,char,8;
		시간,time,time,char,6;
