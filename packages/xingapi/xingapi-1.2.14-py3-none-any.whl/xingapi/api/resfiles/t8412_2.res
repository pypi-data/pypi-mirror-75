BEGIN_FUNCTION_MAP
	.Func,주식챠트(N분)(t8412),t8412,attr,block,headtype=A;
	BEGIN_DATA_MAP
	t8412InBlock,기본입력,input;
	begin
	...
	t8412OutBlock1,출력1,output,occurs;
	begin
		날짜,date,date,char,8;
		...
		종가등락구분(1:상한2:상승3:보합4:하한5:하락),sign,sign,char,1;
	end
	END_DATA_MAP
END_FUNCTION_MAP
