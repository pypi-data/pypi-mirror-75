BEGIN_FUNCTION_MAP
	.Func,CME 취소주문,CCEAT00300,SERVICE=CCEAT00300,headtype=B,CREATOR=이호섭,CREDATE=2012/04/10 10:09:15;
	BEGIN_DATA_MAP
	CCEAT00300InBlock1,In(*EMPTY*),input;
	begin
	...
	CCEAT00300OutBlock1,In(*EMPTY*),output;
	begin
	...
	CCEAT00300OutBlock2,Out(*EMPTY*),output;
	begin
		레코드갯수, RecCnt, RecCnt, long, 5
