BEGIN_FUNCTION_MAP
	.Func,CME야간선물시간대별체결조회(t2804),t2804,attr,block,headtype=A;
	BEGIN_DATA_MAP
	t2804InBlock,기본입력,input;
	begin
	...
	t2804OutBlock,출력,output;
	begin
		시간CTS,cts_time,cts_time,char,10;
	end
	t2804OutBlock1,출력1,output,occurs;
	begin
		시간,chetime,chetime,char,10;
		시간24,chetime24,chetime24,char,10;
