BEGIN_FUNCTION_MAP
	.Func,기간별주가(t1305),t1305,attr,block,headtype=A;
	BEGIN_DATA_MAP
	t1305InBlock,기본입력,input;
	begin
		단축코드,shcode,shcode,char,6;
		일주월구분,dwmcode,dwmcode,long,1;
		날짜,date,date,char,8;
		IDX,idx,idx,long,4;
		건수,cnt,cnt,long,4;
	end
	t1305OutBlock,출력,output;
	begin
		CNT,cnt,cnt,long,4;
		날짜,date,date,char,8;
		IDX,idx,idx,long,4;
	end
	t1305OutBlock1,출력1,output,occurs;
	begin
		날짜,date,date,char,8;
		시가,open,open,long,8;
		고가,high,high,long,8;
