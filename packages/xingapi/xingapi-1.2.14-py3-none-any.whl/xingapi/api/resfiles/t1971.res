BEGIN_FUNCTION_MAP
	.Func,ELW현재가호가조회(t1971),t1971,attr,block,headtype=A;
	BEGIN_DATA_MAP
	t1971InBlock,기본입력,input;
	begin
		단축코드,shcode,shcode,char,6;
	end
	t1971OutBlock,출력,output;
	begin
		...
		LP매수호가수량4,lp_bidrem4,lp_bidrem4,long,12;
		...
		예상체결수량,yevolume,yevolume,float,12;
		...
		고가,high,high,long,8;
		저가,low,low,long,8;
		ELW권리형태(1:표준2:디지털3:조기종료),invidx,invidx,char,1;
		KO베리어,koba_stdprc,koba_stdprc,float,12.2;
		KO접근도,koba_acc_rt,koba_acc_rt,float,12.2;
		KO발생여부(Y/N),koba_yn,koba_yn,char,1;
	end
	END_DATA_MAP
END_FUNCTION_MAP
