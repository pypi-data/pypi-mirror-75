BEGIN_FUNCTION_MAP
	.Func,선물옵션 정정주문,CFOAT00200,SERVICE=CFOAT00200,ENCRYPT,SIGNATURE,headtype=B,CREATOR=이인희,CREDATE=2012/03/12 13:31:21;
	BEGIN_DATA_MAP
	CFOAT00200InBlock1,In(*EMPTY*),input;
	begin
	...
	CFOAT00200OutBlock2,Out(*EMPTY*),output;
	begin
		레코드갯수, RecCnt, RecCnt, long, 5
