BEGIN_FUNCTION_MAP
	.Func,ELW거래량상위(t1961),t1961,attr,block,headtype=A;
	BEGIN_DATA_MAP
	t1961InBlock,기본입력,input;
	begin
	...
	t1961OutBlock,출력,output;
	begin
		IDX,idx,idx,long,4;
	end
	t1961OutBlock1,출력1,output,occurs;
	begin
		...
		전일거래량,jnilvolume,jnilvolume,double,12.0;
