BEGIN_FUNCTION_MAP
	.Func,CME 정상주문,CCEAT00100,SERVICE=CCEAT00100,headtype=B,CREATOR=이호섭,CREDATE=2012/04/10 10:02:33;
	BEGIN_DATA_MAP
	CCEAT00100InBlock1,In(*EMPTY*),input;
	begin
	...
	CCEAT00100OutBlock1,In(*EMPTY*),output;
	begin
	...
	CCEAT00100OutBlock2,Out(*EMPTY*),output;
	begin
		레코드갯수, RecCnt, RecCnt, long, 5
