BEGIN_FUNCTION_MAP
.Feed, KOSPI프로그램매매전체집계(PM), PM_, attr, key=1, group=1;
    BEGIN_DATA_MAP
    InBlock,입력,input;
    begin
    ...
    begin
        ...
        KOSPI200 지수,              k200jisu,       k200jisu,   float,  6.2;
        KOSPI200 전일대비구분,      k200sign,       k200sign,   char,   1;
        KOSPI200 전일대비,          change,         change,     float,  6.2;
        KOSPI200 베이시스,          k200basis,      k200basis,  float,  4.2;
