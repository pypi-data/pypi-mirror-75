BEGIN_FUNCTION_MAP
	.Func,선물옵션 계좌예탁금증거금조회,CFOBQ10500,ENCRYPT,SERVICE=CFOBQ10500,headtype=B,CREATOR=정명기,CREDATE=2012/03/12 15:03:11;
	BEGIN_DATA_MAP
	CFOBQ10500InBlock1,In(*EMPTY*),input;
	begin
		레코드갯수, RecCnt, RecCnt, long, 5
		계좌번호, AcntNo, AcntNo, char, 20;
		비밀번호, Pwd, Pwd, char, 8;
	end
	CFOBQ10500OutBlock1,In(*EMPTY*),output;
	begin
		레코드갯수, RecCnt, RecCnt, long, 5
		계좌번호, AcntNo, AcntNo, char, 20;
		비밀번호, Pwd, Pwd, char, 8;
	end
	CFOBQ10500OutBlock2,Out(*EMPTY*),output;
	begin
		레코드갯수, RecCnt, RecCnt, long, 5
	...
	CFOBQ10500OutBlock3,Out2(*EMPTY*),output,occurs;
	begin
