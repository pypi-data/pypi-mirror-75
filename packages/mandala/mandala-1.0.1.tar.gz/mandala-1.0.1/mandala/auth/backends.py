...
from mandala.auth.models import Permission
...
class ModelBackend:
    ...
    def _get_role_permissions(self, user_obj):
        ...
        20200724修改，加入status逻辑
        """
        return Permission.objects.filter(**{user_roles_query: user_obj, "status": 1})
    ...
    def _get_permissions(self, user_obj, obj, from_name):
        ...
        if not hasattr(user_obj, perm_cache_name):
            ...
            perms = perms.values_list('module__code', 'code').order_by()
