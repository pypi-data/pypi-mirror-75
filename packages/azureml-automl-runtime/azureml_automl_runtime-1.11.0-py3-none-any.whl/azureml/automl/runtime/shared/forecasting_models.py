...
from azureml.automl.core.shared._diagnostics.automl_error_definitions import MemoryExhausted
    ...
    def _get_num_parallel_process(
        ...
        if num_par_process > 1:
            if data_set_size > avail_memory and memory_per_process > avail_memory:
                raise MemorylimitException._with_error(
                    AzureMLError.create(
                        MemoryExhausted, target='available_memory',
