...
from azureml.automl.core.shared._diagnostics.automl_error_definitions import InvalidArgumentType, \
    InvalidDampingSettings, InvalidSTLFeaturizerForMultiplicativeModel
...
from azureml.automl.core.shared import forecasting_utils
...
class STLFeaturizer(AzureMLForecastTransformerBase):
    ...
    def __init__(self,
                 ...
                 seasonality: int = TimeSeriesInternal.SEASONALITY_VALUE_DETECT) -> None:
        """Constructor."""
