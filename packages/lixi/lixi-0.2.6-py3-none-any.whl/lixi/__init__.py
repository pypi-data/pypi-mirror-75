...
def get_custom_schema(
    ...
    Args:
        ...
        csv_string (:obj:`str`, optional): Customization, comma-separated, paths to keep. Defaults to None. Format accepted is 'Package,Package.Content,..........'.  
...
def get_custom_schema_from_message_folder(
    ...
    for message_name in _os.listdir(message_folder):
        ...
        if _os.path.isfile(full_message_path) and ('.xml' in message_name or '.json' in message_name):
            ...
            try:
                ...
                isvalid, result = lixi_message.validate()
                if isvalid == False:
    ...
    if message_items != '':
        ...
        message_items.sort()
        instructions = ','.join(message_items)
...
def get_schema_documentation(
    ...
    Args:
        ...
        output_name (:obj:`str`, required): Name of the sub-folder that contains the documentation.
        glossary_string (:obj:`str`, optional): LIXI Glossary update provided as a string. 
