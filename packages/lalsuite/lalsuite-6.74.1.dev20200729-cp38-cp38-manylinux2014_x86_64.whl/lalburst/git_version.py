...
id = "b8d3f86ba628d4fc974782160fcdb53b098870e9"
date = "2020-07-28 18:47:52 +0000"
branch = "None"
tag = "None"
if tag == "None":
    tag = None
...
def check_match(foreign_id, onmismatch="raise"):
    ...
    if foreign_id == "b8d3f86ba628d4fc974782160fcdb53b098870e9":
        return
    msg = "Program id (b8d3f86ba628d4fc974782160fcdb53b098870e9) does not match given id (%s)." % foreign_id
    if onmismatch == "raise":
