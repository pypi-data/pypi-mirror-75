...
id = "f068099f2868591a921274fca5102298a3a42914"
date = "2020-08-3 02:01:54 +0000"
branch = "None"
tag = "None"
if tag == "None":
    tag = None
...
def check_match(foreign_id, onmismatch="raise"):
    ...
    if foreign_id == "f068099f2868591a921274fca5102298a3a42914":
        return
    msg = "Program id (f068099f2868591a921274fca5102298a3a42914) does not match given id (%s)." % foreign_id
    if onmismatch == "raise":
