...
class card_animation:
    def __init__(self, card_obj, callback, init, dest, steps):
        ...
        for card_t in card_type:
            if list_cards[index] > 0:
                ...
                for anything in range(0, list_cards[index]):
                    self.animations.append(
                        card_animation(card_lost, None, location_start, location_end, location_steps))
            ...
            if list_cards[index] < 0:
                ...
                for anything in range(list_cards[index], 0):
                    self.animations.append(
                        card_animation(card_gained, self.add_card, location_end, location_start, location_steps))
            index += 1
