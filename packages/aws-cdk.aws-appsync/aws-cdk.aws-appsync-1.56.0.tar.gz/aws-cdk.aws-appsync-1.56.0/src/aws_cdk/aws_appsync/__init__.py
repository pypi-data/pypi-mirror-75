...
class GraphQLApi(
    ...
    def grant_mutation(
        self, grantee: aws_cdk.aws_iam.IGrantable, *fields: str
    ) -> aws_cdk.aws_iam.Grant:
...
class IamResource(
    metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-appsync.IamResource"
):
...
@jsii.enum(jsii_type="@aws-cdk/aws-appsync.SchemaDefinition")
