...
from hrflow.profile import get_files_from_dir

from ..utils import get_profile, validate_key, validate_reference
...
class ProfileParsing():
    ...
    def add(self, source_key, key=None, profile_file=None, profile_content_type=None, reference=None, created_at=None ,
        ...
        response = self.client.post("profile/parsing", data=payload, files={"file": profile_file})
    ...
    def get(self, source_key=None, key=None, reference=None, email=None):
        ...
        """
        query_params = get_profile(source_key, key, reference, email)
