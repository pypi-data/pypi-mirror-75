...
from ..utils import validate_key, validate_limit, validate_page, validate_sort_by, \
...
class ProfileScoring():
    ...
    def get(self, source_keys=None, board_key=None, job_key=None, use_agent=None, stage=None, page=1, limit=30,
        ...
        query_params = {'source_keys': json.dumps(validate_source_keys(source_keys)),
