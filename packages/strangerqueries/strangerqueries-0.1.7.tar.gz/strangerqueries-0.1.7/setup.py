...
setup(
  ...
  description = 'A package to allow users to run impala and hive queries within CSDW without leaving there enviroment and connecting to a database', # Give a short description about your library
 long_description=open('README.rst').read(),
  ...
  download_url = 'https://github.com/ShaanAu/strangerqueries/archive/v_0.1.6.tar.gz',    # I explain this later on
