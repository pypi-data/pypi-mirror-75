...
see the documentation on https://azure-saving.readthedocs.io/en/latest/
...
the class extended by each class that implements an Azure service.

    >>> import azure_saving
    >>> help(azure_saving)
    >>> import azure_saving.saving as Saving
    >>> help(Saving)

# license MIT
# support https://github.com/bilardi/azure-saving/issues
"""
__version__ = '0.0.1'
