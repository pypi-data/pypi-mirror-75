...
class OrganismRankType(object):
    ...
    allowable_values = [NO_RANK, SUPERKINGDOM, KINGDOM, SUBKINGDOM, SUPERPHYLUM, SUBPHYLUM, PHYLUM, SUPERCLASS, CLASS, SUBCLASS, INFRACLASS, COHORT, SUBCOHORT, SUPERORDER, ORDER, SUBORDER, INFRAORDER, PARVORDER, SUPERFAMILY, FAMILY, SUBFAMILY, GENUS, SUBGENUS, SPECIES_GROUP, SPECIES_SUBGROUP, SPECIES, SUBSPECIES, TRIBE, SUBTRIBE, FORMA, VARIETAS]  # noqa: E501
