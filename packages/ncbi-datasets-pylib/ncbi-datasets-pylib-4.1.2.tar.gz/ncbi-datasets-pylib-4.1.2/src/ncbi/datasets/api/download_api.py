...
class DownloadApi(object):
    ...
    def download_gene_package(self, gene_ids, **kwargs):  # noqa: E501
        ...
        :param str tax_token:
        :param list[str] symbol: Symbol must also have a tax-token specified.
        :param list[str] accessions: RNA or Protein accessions.
    ...
    def download_gene_package_with_http_info(self, gene_ids, **kwargs):  # noqa: E501
        ...
        if 'accessions' in local_var_params and local_var_params['accessions'] is not None:  # noqa: E501
            query_params.append(('accessions', local_var_params['accessions']))  # noqa: E501
            collection_formats['accessions'] = 'multi'  # noqa: E501
