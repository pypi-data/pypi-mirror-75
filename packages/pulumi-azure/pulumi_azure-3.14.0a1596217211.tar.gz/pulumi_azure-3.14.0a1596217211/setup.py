...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'azure', '3.14.0-alpha.1596217211+46b7f0d8'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource azure 3.14.0-alpha.1596217211+46b7f0d8`
                """)
            else:
                raise
