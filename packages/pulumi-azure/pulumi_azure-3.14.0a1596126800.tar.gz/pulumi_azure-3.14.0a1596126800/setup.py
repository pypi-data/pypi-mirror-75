...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'azure', '3.14.0-alpha.1596126800+4377ccb0'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource azure 3.14.0-alpha.1596126800+4377ccb0`
                """)
            else:
                raise
