...
def test_basic_parse_to_arg():
    ...
    arg_cmd = 'MyTupBasic+ --a_int 32 --a_float 0.3 --a_bool True --a_str hello --b_list_int 1 2 3 --b_set_str set1 set2 ' + \
              '--d_tuple_3 10 0.5 False --d_tuple_2 tuple 12 --e_dict_str_int size:32 area:90 --e_dict_int_bool 10:True 20:False 30:True --with_default 10 MyTupBasic-'
...
def test_optional():
    ...
    pytest.raises(SmartArgError, arg_suite, NamedTuple('InvalidOptional', no=Optional[int]))
