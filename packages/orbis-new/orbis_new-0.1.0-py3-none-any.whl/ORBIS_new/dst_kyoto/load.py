...
def load(time_now = None,date_history = 30):
    """
    This is the real time downloader in kyoto website
    ...
    dst_pdframe.columns = ['date', 'dst_kyoto']
    dst_pdframe.set_index('date', inplace=True, drop=True)
