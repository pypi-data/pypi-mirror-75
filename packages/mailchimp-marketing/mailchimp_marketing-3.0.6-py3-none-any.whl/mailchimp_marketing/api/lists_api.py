...
class ListsApi(object):
    ...
    def create_list_member_event(self, list_id, subscriber_hash, **kwargs):  # noqa: E501
        """Add event  # noqa: E501

        Add an event for a list member.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create_list_member_event(list_id, subscriber_hash, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.create_list_member_event_with_http_info(list_id, subscriber_hash, **kwargs)  # noqa: E501
        else:
            (data) = self.create_list_member_event_with_http_info(list_id, subscriber_hash, **kwargs)  # noqa: E501
            return data

    def create_list_member_event_with_http_info(self, list_id, subscriber_hash, **kwargs):  # noqa: E501
        """Add event  # noqa: E501

        Add an event for a list member.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create_list_member_event_with_http_info(list_id, subscriber_hash, async_req=True)
        >>> result = thread.get()
