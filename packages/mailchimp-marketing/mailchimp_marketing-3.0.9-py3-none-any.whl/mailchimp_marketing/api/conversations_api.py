...
class ConversationsApi(object):
    ...
    def list(self, **kwargs):  # noqa: E501
        ...
        Get a list of conversations for the account.  # noqa: E501
    ...
    def get(self, conversation_id, **kwargs):  # noqa: E501
        ...
        Get details about an individual conversation.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def get_conversation_messages(self, conversation_id, **kwargs):  # noqa: E501
        ...
        Get messages from a specific conversation.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        ...
        :param datetime before_timestamp: Restrict the response to messages created before the set time. We recommend [ISO 8601](https://en.wikipedia.org/wiki/ISO_8601) time format: 2015-10-21T15:41:36+00:00.
        :param datetime since_timestamp: Restrict the response to messages created after the set time. We recommend [ISO 8601](https://en.wikipedia.org/wiki/ISO_8601) time format: 2015-10-21T15:41:36+00:00.
    ...
    def get_conversation_message(self, conversation_id, message_id, **kwargs):  # noqa: E501
        ...
        Get an individual message in a conversation.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def create_conversation_message(self, conversation_id, body, **kwargs):  # noqa: E501
        """Post message  # noqa: E501

        Post a new message to a conversation.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create_conversation_message(conversation_id, body, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str conversation_id: The unique id for the conversation. (required)
        :param ConversationMessage1 body:  (required)
        :return: ConversationMessage
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.create_conversation_message_with_http_info(conversation_id, body, **kwargs)  # noqa: E501
        else:
            (data) = self.create_conversation_message_with_http_info(conversation_id, body, **kwargs)  # noqa: E501
            return data

    def create_conversation_message_with_http_info(self, conversation_id, body, **kwargs):  # noqa: E501
        """Post message  # noqa: E501

        Post a new message to a conversation.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create_conversation_message_with_http_info(conversation_id, body, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method create_conversation_message" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'conversation_id' is set
