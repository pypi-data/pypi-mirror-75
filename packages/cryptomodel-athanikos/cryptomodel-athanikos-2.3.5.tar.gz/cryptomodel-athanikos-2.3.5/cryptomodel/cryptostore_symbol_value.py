...
contains a list of user_grouped_symbol_value
user_grouped_symbol_value contains a list of user_symbol_value
also holds the passed in transactions that may be marked as invalid (sumbol does not exist)
"""
...
class total_symbol_value:
    ...
    def compute_transaction_value(self, transaction):
        if not transaction.validate(self.symbol_prices):
