...
There are 30 Galapagos islands and 7 variables in the dataset. The relationship between the number of plant species and several geographic variables is of interest. This is the original dataset which contains several missing values.
...
def load():
    ...
    data = datasets.loaddata(__file__, 'galamiss.csv.bz2')
    return data
