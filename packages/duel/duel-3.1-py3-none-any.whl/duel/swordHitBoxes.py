...
def getSwordLine(player): 
	...
	point2 = -1
	height = -1
	if abs(player.getPlayerState("x_velocity")) < 10 and (player.getPlayerState("ghost_counter") > 150 or player.getPlayerState("ghost_counter") == -1) and (player.getPlayerState("sword")): #if sword is ready
