...
import os
import sys
import duel.menuButtons
import duel.gameFrame
import duel.audioEngine
...
#AUDIO REMOVED FROM SETTINGS MENU TO PREVENT CRASHING IN WSL FOR FINAL SUBMISSION
...
menu_buttons = {
    "play_button": duel.menuButtons.Button(button_sprites["play_unhighl"], 400, 300, 220, 50),
    "pregame_play_button": duel.menuButtons.Button(button_sprites["play_unhighl"], 400, 300, 220, 50),
    "settings_button": duel.menuButtons.Button(button_sprites["settings_unhighl"], 400, 400, 50, 50),
    "exit_button": duel.menuButtons.Button(button_sprites["exit_unhighl"], 400, 500, 220, 50),
    "back_button": duel.menuButtons.Button(button_sprites["back_unhighl"], 400, 500, 220, 50),
    "endgame_back_button": duel.menuButtons.Button(button_sprites["back_unhighl"], 400, 500, 220, 50),
    "restart_button": duel.menuButtons.Button(button_sprites["restart_unhighl"], 0, 0, 220, 50),
    "tutorial_button": duel.menuButtons.Button(button_sprites["tutorial_unhighl"], 0, 0, 220, 50),
    "credits_button": duel.menuButtons.Button(button_sprites["credits_unhighl"], 0, 0, 220, 50),
    "minus_button": duel.menuButtons.Button(button_sprites["minus_unhighl"], 0, 0, 50, 50),
    "plus_button": duel.menuButtons.Button(button_sprites["plus_unhighl"], 0, 0, 50, 50),
    "p1_left_button": duel.menuButtons.Button(button_sprites["small_left_unhighl"], 0, 0, 35, 35),
    "p1_right_button": duel.menuButtons.Button(button_sprites["small_right_unhighl"], 0, 0, 35, 35),
    "p2_left_button": duel.menuButtons.Button(button_sprites["small_left_unhighl"], 0, 0, 35, 35),
    "p2_right_button": duel.menuButtons.Button(button_sprites["small_right_unhighl"], 0, 0, 35, 35),
    "map_left_button": duel.menuButtons.Button(button_sprites["left_unhighl"], 0, 0, 51, 51),
    "map_right_button": duel.menuButtons.Button(button_sprites["right_unhighl"], 0, 0, 51, 51),
    "p1_preview": duel.menuButtons.Button("Resources/Images/MontoyaMedR.png", 0, 0, 269, 140),
    "p2_preview": duel.menuButtons.Button("Resources/Images/MontoyaMedL.png", 0, 0, 269, 140),
}
...
def pregameMenu(screen):
    ...
    skin_count_2 = 0
    map_selection = 1
    map_title = pygame.font.Font(loadFont("Resources/Lobster.ttf"), 42)
    player_title = pygame.font.Font(loadFont("Resources/Lobster.ttf"), 36)
    ...
    while True:
        ...
        if game_state["start"]:
            ...
            duel.gameEngine.startGame(screen, map_selection, p1_skin_selection, p2_skin_selection)
        if game_state["back"]:
            pygame.time.delay(400)
...
def settingsMenu(screen):
    volume_font = pygame.font.Font(loadFont("Resources/Lobster.ttf"), 32)
    settings_label_font = pygame.font.Font(loadFont("Resources/Lobster.ttf"), 42)
    volume = 100
    ...
    while True:
        ...
        #With no music, we can't getVolume() without crashing the game.
        #volume = str(int(round(audio.getVolume(), 1)*100))
        volume_level = volume_font.render(str(volume), True, (255,255,255))
...
def pauseMenu(screen, p1_meta_info, p2_meta_info):
    ...
    while True:
        ...
        if game_state["restart"]:
            ...
            game_state["paused"] = False
            duel.gameEngine.startGame(screen, game_state["map_selection"], game_state["p1_skin"], game_state["p2_skin"])
        #if game_state["settings"]:
            #pygame.time.delay(400)
            #game_state["settings"] = False
            #game_state["paused"] = True
    ...
    while True:
        ...
        for event in pygame.event.get():
            ...
            if game_state["map_selection"] == 0:
                screen.blit(duel.gameFrame.getImage("Resources/Images/Random.png", images_dictionary), (0, 0))
            elif game_state["map_selection"] == 1:
                screen.blit(duel.gameFrame.getImage("Resources/Images/UF_Background.png", images_dictionary), (0, 0))
            elif game_state["map_selection"] == 2:
                screen.blit(duel.gameFrame.getImage("Resources/Images/DesolateDesertBG.png" , images_dictionary), (0, 0))


            #Blit a victory message for the player that won the previous match.
            if winner == 1:
                screen.blit(duel.gameFrame.getImage("Resources/Images/Player1Victory.png", images_dictionary), (0,0))
            elif winner == 2:
                screen.blit(duel.gameFrame.getImage("Resources/Images/Player2Victory.png", images_dictionary), (0,0))
...
def renderMenuButtons(menu_name, screen):
    if menu_name == "Main":
        ...
        #Draw the duel logo
        screen.blit(duel.gameFrame.getImage("Resources/Images/MenuTitle.png", images_dictionary), (0,0))
        ...
        screen.blit(duel.gameFrame.getImage("Resources/Images/TutorialScreen.png", images_dictionary), (0,0))
        drawButton(screen, "back_button", 140, 555)

    elif  menu_name == "Credits":
        screen.blit(duel.gameFrame.getImage("Resources/Images/CreditsSplashScreen.png", images_dictionary), (0, 0))
...
def drawButton(screen, button_name, x_pos, y_pos): #This function was not working when I implemented it, need to find a better way to simplify rendering function.
    ...
    screen.blit(duel.gameFrame.getImage(menu_buttons[button_name].sprite, images_dictionary), (menu_buttons[button_name].button_rect.x, menu_buttons[button_name].button_rect.y))
...
def displayPlayer(screen, skin_selection, player_number, player_title):
    if player_number == 1:
        ...
        screen.blit(duel.gameFrame.getImage(image_path, images_dictionary), (menu_buttons["p1_preview"].button_rect.x, menu_buttons["p1_preview"].button_rect.y))
        ...
        screen.blit(duel.gameFrame.getImage(image_path, images_dictionary), (menu_buttons["p2_preview"].button_rect.x, menu_buttons["p2_preview"].button_rect.y))
...
def loadFont(path):
    ...
    font_path = os.path.join(os.path.dirname(os.path.realpath(__file__)), canonicalized_path)
    return font_path
