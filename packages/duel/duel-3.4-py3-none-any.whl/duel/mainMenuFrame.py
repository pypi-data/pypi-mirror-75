...
def pregameMenu(screen, audio):
    ...
    while True:
        ...
        if game_state["start"]:
            ...
            duel.gameEngine.startGame(screen, map_selection, p1_skin_selection, p2_skin_selection, audio)
        if game_state["back"]:
            pygame.time.delay(400)
...
def pauseMenu(screen, p1_meta_info, p2_meta_info, audio):
    ...
    while True:
        ...
        if game_state["restart"]:
            ...
            game_state["paused"] = False
            duel.gameEngine.startGame(screen, game_state["map_selection"], game_state["p1_skin"], game_state["p2_skin"], audio)
        #if game_state["settings"]:
            #pygame.time.delay(400)
            #game_state["settings"] = False
            #game_state["paused"] = True
