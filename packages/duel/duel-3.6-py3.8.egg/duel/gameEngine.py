...
def mainMenu(screen):  # TODO Call Main Menu Frame instead and have it call startGame
    duel.mainMenuFrame.mainMenu(screen)
...
def startGame(screen, map_selection, skin_selection1, skin_selection2):
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.KEYDOWN:
                ...
                if event.key == pygame.K_ESCAPE:
                    duel.mainMenuFrame.pauseMenu(screen, p1_meta_info, p2_meta_info)
    ...
    if player1.getPlayerState("player_won"):
        duel.mainMenuFrame.endGameMenu(screen, 1)
    elif player2.getPlayerState("player_won"):
        duel.mainMenuFrame.endGameMenu(screen, 2)
