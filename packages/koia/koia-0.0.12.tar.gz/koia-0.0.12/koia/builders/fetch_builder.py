...
from koia.builders.utils import check_for_exist_key, sort_fetched_data
            ...
            if query_items == "innerJoin":
                ...
                if "where" in query_items:  # Handle where case
                    if len(self.query_conf[query_items]) > 0:
                        query_operations += check_for_exist_key(
    ...
    def _fetch(self, sql_query) -> dict:
        ...
        while True:
            try:
                ...
                sorted_data = sort_fetched_data(fetch=fetch, field_names=field_names)
