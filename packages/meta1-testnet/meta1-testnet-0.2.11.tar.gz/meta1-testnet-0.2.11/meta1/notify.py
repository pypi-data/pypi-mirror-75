...
from meta1api.websocket import Meta1Websocket
...
class Notify(Events, BlockchainInstance):
    """ Notifications on Blockchain events.
        ...
        :param list markets: Instances of :class:`meta1.market.Market` that identify markets to be monitored
        ...
        **Example**
        ...
        .. code-block:: python
            ...
            from meta1.notify import Notify
    ...
    def process_market(self, data):
        """ This method is used for post processing of market
            ...
            * :class:`meta1.price.Order` or
            * :class:`meta1.price.FilledOrder` or
            * :class:`meta1.price.UpdateCallOrder`
    ...
    def process_account(self, message):
        """ This is used for processing of account Updates. It will
            return instances of :class:meta1.account.AccountUpdate`
        """
