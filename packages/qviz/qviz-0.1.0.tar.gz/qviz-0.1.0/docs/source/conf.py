...
# -*- coding: utf-8 -*-
#
# qviz documentation build configuration file
#
...
project = 'qviz'
copyright = '2020, Cesare Cugnasco'
...
_version_py = os.path.join(repo, 'qviz', '_version.py')
version_ns = {}
...
latex_documents = [
    (master_doc, 'qviz.tex', 'qviz Documentation',
     'Cesare Cugnasco', 'manual'),
]
