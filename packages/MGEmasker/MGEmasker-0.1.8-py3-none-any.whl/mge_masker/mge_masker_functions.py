...
def find_pseudo_alignment_length(pseudogenome_alignment_path):
  with open(pseudogenome_alignment_path) as input_alignment:
    current_sequence = ""
...
def mask_mges(pseudogenome_alignment_path, gff_file_path, masking_character):
  ...
  alignment_length = find_pseudo_alignment_length(pseudogenome_alignment_path)  
  ...
  with open(pseudogenome_alignment_path) as input_alignment, open(masked_pseudogenome_alignment_path, 'w') as output_alignment:
    sequence = ""
    index = 0
    for line in input_alignment:
      if line.startswith(">"):
