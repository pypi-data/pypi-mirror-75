...
class User(object):
    ...
    def __init__(self, member_of=None, id=None, external_id=None, enabled=None, first_name=None, last_name=None, email=None, provider=None, roles=None, org_id=None, type=None, created=None, updated=None, auto_created=False, upstream_identities=None, local_vars_configuration=None):  # noqa: E501
    ...
    def upstream_identities(self):
        """Gets the upstream_identities of this User.  # noqa: E501
        ...
        :return: The upstream_identities of this User.  # noqa: E501
    ...
    def upstream_identities(self, upstream_identities):
        """Sets the upstream_identities of this User.

        The upstream identities this user can use to log in to the system. When a user logs in, their identity in this system will be determined by matching against this list. Note that this implies that entries in this list are globally unique.   # noqa: E501

        :param upstream_identities: The upstream_identities of this User.  # noqa: E501
