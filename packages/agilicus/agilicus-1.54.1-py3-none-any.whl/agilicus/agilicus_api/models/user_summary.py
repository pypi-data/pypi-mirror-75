...
class UserSummary(object):
    ...
    openapi_types = {
        ...
        'updated': 'datetime',
        'auto_created': 'bool',
        'upstream_identities': 'list[UpstreamUserIdentity]'
    }
    ...
    def __init__(self, id=None, external_id=None, enabled=None, first_name=None, last_name=None, email=None, provider=None, roles=None, org_id=None, type=None, created=None, updated=None, auto_created=False, upstream_identities=None, local_vars_configuration=None):  # noqa: E501
        ...
        self._upstream_identities = None
        ...
        if upstream_identities is not None:
            self.upstream_identities = upstream_identities
    ...
    @property
    def upstream_identities(self):
        """Gets the upstream_identities of this UserSummary.  # noqa: E501
        ...
        :return: The upstream_identities of this UserSummary.  # noqa: E501
        :rtype: list[UpstreamUserIdentity]
        """
        return self._upstream_identities

    @upstream_identities.setter
    def upstream_identities(self, upstream_identities):
        """Sets the upstream_identities of this UserSummary.

        The upstream identities this user can use to log in to the system. When a user logs in, their identity in this system will be determined by matching against this list. Note that this implies that entries in this list are globally unique.   # noqa: E501

        :param upstream_identities: The upstream_identities of this UserSummary.  # noqa: E501
        :type: list[UpstreamUserIdentity]
        """

        self._upstream_identities = upstream_identities
