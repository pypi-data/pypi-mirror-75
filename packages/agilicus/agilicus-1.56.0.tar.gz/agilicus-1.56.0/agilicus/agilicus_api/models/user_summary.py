...
class UserSummary(object):
    ...
    def __init__(self, id=None, external_id=None, enabled=None, first_name=None, last_name=None, email=None, provider=None, roles=None, org_id=None, type=None, created=None, updated=None, auto_created=False, upstream_user_identities=None, local_vars_configuration=None):  # noqa: E501
