...
def add_analysis(
    ...
    url = "{}/sampledb/v2/sample/{sha256}/analysis".format(
...
def add_evidence(
    ...
    url = "{}/sampledb/v2/sample/{sha256}/analysis/{analysisID}/evidence".format(
        server_url or settings["api"]["api_url"],
        sha256=sha256,
...
def add_link(
    ...
    url = "{}/sampledb/v2/sample/{sha256}/link".format(
        server_url or settings["api"]["api_url"],
        sha256=sha256
    )
    headers = {
...
def get_analysis(
    ...
    url = "{}/sampledb/v2/sample/{sha256}/analysis/{analysisID}".format(
        server_url or settings["api"]["api_url"],
        sha256=sha256,
        analysisID=analysisID
    )
...
def get_evidence(
    ...
    url = "{}/sampledb/v2/sample/{sha256}/analysis/{analysisID}/evidence/{evidenceID}".format(
        server_url or settings["api"]["api_url"],
        sha256=sha256,
        analysisID=analysisID,
...
def get_evidence_data(
    ...
    url = "{}/sampledb/v2/sample/{sha256}/analysis/{analysisID}/evidence/{evidenceID}/download".format(
        server_url or settings["api"]["api_url"],
        sha256=sha256,
        analysisID=analysisID,
        evidenceID=evidenceID
...
def get_link(
    ...
    url = "{}/sampledb/v2/sample/{sha256}/link/{linkID}".format(
        server_url or settings["api"]["api_url"],
        sha256=sha256,
        linkID=linkID
    )
