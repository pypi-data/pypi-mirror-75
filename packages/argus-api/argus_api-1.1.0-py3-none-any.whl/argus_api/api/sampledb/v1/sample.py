...
def get_evil_samples(
    ...
    url = "{}/sampledb/v1/sample/search/evil".format(
...
def get_sample(
    ...
    url = "{}/sampledb/v1/sample/{sha256}".format(
        server_url or settings["api"]["api_url"],
        sha256=sha256
    )
    headers = {
...
def get_sample_aggregated(
    ...
    url = "{}/sampledb/v1/sample/{sha256}/aggregated".format(
        server_url or settings["api"]["api_url"],
        sha256=sha256
    )
    headers = {
...
def get_sample_children(
    ...
    url = "{}/sampledb/v1/sample/{sha256}/children".format(
        server_url or settings["api"]["api_url"],
        limit=limit,
        sha256=sha256,
        offset=offset,
...
def get_sample_download(
    ...
    url = "{}/sampledb/v1/sample/{sha256}/download".format(
        server_url or settings["api"]["api_url"],
        sha256=sha256
    )
    headers = {
...
def get_sample_tags(
    ...
    url = "{}/sampledb/v1/sample/{sha256}/tags".format(
        server_url or settings["api"]["api_url"],
        limit=limit,
        sha256=sha256,
        offset=offset
...
def get_sandbox_pcap(
    ...
    url = "{}/sampledb/v1/sample/{sha256}/sandbox/pcap".format(
        server_url or settings["api"]["api_url"],
        sha256=sha256
    )
    headers = {
...
def get_sandbox_procgraph(
    ...
    url = "{}/sampledb/v1/sample/{sha256}/sandbox/{runUUID}/procgraph".format(
        server_url or settings["api"]["api_url"],
        sha256=sha256,
        runUUID=runUUID
    )
...
def get_sandbox_runs(
    ...
    url = "{}/sampledb/v1/sample/{sha256}/sandbox".format(
        server_url or settings["api"]["api_url"],
        limit=limit,
        sha256=sha256,
        offset=offset
...
def list_submissions_by_sample_id(
    ...
    url = "{}/sampledb/v1/sample/{sha256}/submission".format(
        server_url or settings["api"]["api_url"],
        limit=limit,
        sha256=sha256,
        offset=offset,
