...
def create(
    ...
    url = "{}/configurationadmin/v1/artifact".format(
...
def create_from_octet_stream(
    ...
    url = "{}/configurationadmin/v1/artifact/{groupID}/{artifactID}/{version}".format(
        server_url or settings["api"]["api_url"],
        groupID=groupID,
...
def delete_unused(
    ...
    url = "{}/configurationadmin/v1/artifact/unused".format(
        server_url or settings["api"]["api_url"],
...
def download_by_g_a_v(
    ...
    url = "{}/configurationadmin/v1/artifact/{groupID}/{artifactID}/{version}/download".format(
        server_url or settings["api"]["api_url"],
        groupID=groupID,
        artifactID=artifactID,
        version=version
...
def download_by_id(
    ...
    url = "{}/configurationadmin/v1/artifact/{id}/download".format(
        server_url or settings["api"]["api_url"],
        id=id
    )
    headers = {
...
def get_by_id(
    ...
    url = "{}/configurationadmin/v1/artifact/{id}".format(
        server_url or settings["api"]["api_url"],
        id=id,
        includeData=includeData
    )
...
def search(
    ...
    url = "{}/configurationadmin/v1/artifact/search".format(
        server_url or settings["api"]["api_url"],
