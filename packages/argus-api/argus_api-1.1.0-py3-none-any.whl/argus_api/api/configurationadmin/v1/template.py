...
def add_comment_2(
    ...
    url = "{}/configurationadmin/v1/template/{id}/comment".format(
...
def create_4(
    ...
    url = "{}/configurationadmin/v1/template".format(
        server_url or settings["api"]["api_url"],
...
def delete_3(
    ...
    url = "{}/configurationadmin/v1/template/{id}".format(
        server_url or settings["api"]["api_url"],
        id=id
    )
    headers = {
...
def duplicate_3(
    ...
    url = "{}/configurationadmin/v1/template/{id}/duplicate".format(
        server_url or settings["api"]["api_url"],
        id=id
    )
    headers = {
...
def revisions_1(
    ...
    url = "{}/configurationadmin/v1/template/{id}/revisions".format(
        server_url or settings["api"]["api_url"],
        limit=limit,
        id=id
    )
...
def search_4(
    ...
    url = "{}/configurationadmin/v1/template/search".format(
        server_url or settings["api"]["api_url"],
