...
def add_comment_1(
    ...
    url = "{}/configurationadmin/v1/instance/{id}/comment".format(
...
def create_3(
    ...
    url = "{}/configurationadmin/v1/instance".format(
        server_url or settings["api"]["api_url"],
...
def delete_2(
    ...
    url = "{}/configurationadmin/v1/instance/{id}".format(
        server_url or settings["api"]["api_url"],
        id=id
    )
    headers = {
...
def disable_monitoring_1(
    ...
    url = "{}/configurationadmin/v1/instance/{id}/monitoring/disable".format(
        server_url or settings["api"]["api_url"],
        id=id
    )
    headers = {
...
def enable_monitoring_1(
    ...
    url = "{}/configurationadmin/v1/instance/{id}/monitoring/enable".format(
        server_url or settings["api"]["api_url"],
        id=id
    )
    headers = {
...
def revisions(
    ...
    url = "{}/configurationadmin/v1/instance/{id}/revisions".format(
        server_url or settings["api"]["api_url"],
        limit=limit,
        id=id,
        offset=offset
...
def schedule_monitoring_1(
    ...
    url = "{}/configurationadmin/v1/instance/{id}/monitoring/schedule".format(
        server_url or settings["api"]["api_url"],
        id=id
    )
    headers = {
...
def search_3(
    ...
    url = "{}/configurationadmin/v1/instance/search".format(
        server_url or settings["api"]["api_url"],
