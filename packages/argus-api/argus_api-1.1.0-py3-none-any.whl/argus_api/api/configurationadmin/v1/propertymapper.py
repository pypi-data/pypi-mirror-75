...
def create_property_mapper(
    ...
    url = "{}/configurationadmin/v1/propertymapper".format(
...
def delete_property_mapper(
    ...
    url = "{}/configurationadmin/v1/propertymapper/{idOrShortName}".format(
        server_url or settings["api"]["api_url"],
...
def get_property_mapper_revision(
    ...
    url = "{}/configurationadmin/v1/propertymapper/{idOrShortName}/revisions/{revision}".format(
        server_url or settings["api"]["api_url"],
        includeConfig=includeConfig,
        idOrShortName=idOrShortName,
        revision=revision
...
def list_property_mapper_revisions(
    ...
    url = "{}/configurationadmin/v1/propertymapper/{idOrShortName}/revisions".format(
        server_url or settings["api"]["api_url"],
        limit=limit,
        idOrShortName=idOrShortName,
        offset=offset
...
def restore_property_mapper(
    ...
    url = "{}/configurationadmin/v1/propertymapper/{idOrShortName}/restore".format(
        server_url or settings["api"]["api_url"],
        idOrShortName=idOrShortName
    )
    headers = {
...
def rollback_property_mapper(
    ...
    url = "{}/configurationadmin/v1/propertymapper/{idOrShortName}/revisions/{revision}/rollback".format(
        server_url or settings["api"]["api_url"],
        idOrShortName=idOrShortName,
        revision=revision
    )
...
def search_property_mappers(
    ...
    url = "{}/configurationadmin/v1/propertymapper/search".format(
        server_url or settings["api"]["api_url"],
