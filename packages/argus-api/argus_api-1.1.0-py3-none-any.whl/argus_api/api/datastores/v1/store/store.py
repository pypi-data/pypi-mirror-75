...
def delete_data_store_entries(
    ...
    url = "{}/datastores/v1/store/{dataStore}".format(
...
def get_entries_from_store(
    ...
    url = "{}/datastores/v1/store/{dataStore}/search".format(
        server_url or settings["api"]["api_url"],
        dataStore=dataStore
    )
    headers = {
...
def get_single_entry(
    ...
    url = "{}/datastores/v1/store/{dataStore}/{key}".format(
        server_url or settings["api"]["api_url"],
        dataStore=dataStore,
        key=key,
        customerID=customerID,
...
def put_single_data_store_entry_1(
    ...
    url = "{}/datastores/v1/store/{dataStore}/{key}/{value}".format(
        server_url or settings["api"]["api_url"],
        dataStore=dataStore,
        key=key,
        value=value,
