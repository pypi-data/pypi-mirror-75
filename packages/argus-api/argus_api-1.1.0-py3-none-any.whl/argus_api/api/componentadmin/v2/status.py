...
def get_component_status(
    ...
    url = "{}/componentadmin/v2/status/component/{componentID}".format(
...
def get_host_instances(
    ...
    url = "{}/componentadmin/v2/status/host/{host}/instances".format(
        server_url or settings["api"]["api_url"],
        limit=limit,
        host=host,
        offset=offset
...
def get_host_status(
    ...
    url = "{}/componentadmin/v2/status/host/{host}".format(
        server_url or settings["api"]["api_url"],
        host=host
    )
    headers = {
...
def get_instance_status_1(
    ...
    url = "{}/componentadmin/v2/status/instance/{instanceID}".format(
        server_url or settings["api"]["api_url"],
...
def get_status_overview(
    ...
    url = "{}/componentadmin/v2/status".format(
        server_url or settings["api"]["api_url"],
...
def list_component_status(
    ...
    url = "{}/componentadmin/v2/status/component".format(
        server_url or settings["api"]["api_url"],
        limit=limit,
...
def list_host_status(
    ...
    url = "{}/componentadmin/v2/status/host".format(
        server_url or settings["api"]["api_url"],
        limit=limit,
...
def list_instance_status(
    ...
    url = "{}/componentadmin/v2/status/instance".format(
        server_url or settings["api"]["api_url"],
        limit=limit,
        instanceState=instanceState,
        offset=offset
...
def search_component_status(
    ...
    url = "{}/componentadmin/v2/status/component/search".format(
        server_url or settings["api"]["api_url"],
...
def search_host_status(
    ...
    url = "{}/componentadmin/v2/status/host/search".format(
        server_url or settings["api"]["api_url"],
...
def search_instance_status(
    ...
    url = "{}/componentadmin/v2/status/instance/search".format(
        server_url or settings["api"]["api_url"],
