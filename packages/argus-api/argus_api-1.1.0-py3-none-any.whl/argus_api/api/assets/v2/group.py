...
def attach_assets(
    ...
    url = "{}/assets/v2/group/{idOrShortName}/assets".format(
        server_url or settings["api"]["api_url"],
...
def attach_children_groups(
    ...
    url = "{}/assets/v2/group/{idOrShortName}/groups".format(
        server_url or settings["api"]["api_url"],
        idOrShortName=idOrShortName,
        customer=customer
    )
...
def delete_asset_group(
    ...
    url = "{}/assets/v2/group/{idOrShortName}".format(
        server_url or settings["api"]["api_url"],
        idOrShortName=idOrShortName,
        customer=customer,
...
def detach_single_child_asset(
    ...
    url = "{}/assets/v2/group/{idOrShortName}/assets/{assetIDOrShortName}".format(
        server_url or settings["api"]["api_url"],
        idOrShortName=idOrShortName,
...
def detach_single_child_group(
    ...
    url = "{}/assets/v2/group/{idOrShortName}/groups/{childGroupIDOrShortName}".format(
        server_url or settings["api"]["api_url"],
        idOrShortName=idOrShortName,
...
def search_asset_groups(
    ...
    url = "{}/assets/v2/group/search".format(
        server_url or settings["api"]["api_url"],
