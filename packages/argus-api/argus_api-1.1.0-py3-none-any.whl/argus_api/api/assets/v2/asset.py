...
def add_asset_definition(
    ...
    url = "{}/assets/v2/asset/definition".format(
        server_url or settings["api"]["api_url"],
...
def delete_asset(
    ...
    url = "{}/assets/v2/asset/{idOrShortName}".format(
        server_url or settings["api"]["api_url"],
...
def delete_asset_definition(
    ...
    url = "{}/assets/v2/asset/definition/{definition}".format(
        server_url or settings["api"]["api_url"],
...
def get_vulnerability_by_asset(
    ...
    url = "{}/assets/v2/asset/{asset}/vulnerability".format(
        server_url or settings["api"]["api_url"],
        asset=asset,
        customer=customer,
...
def get_vulnerability_by_asset_and_vulnerability_id(
    ...
    url = "{}/assets/v2/asset/{asset}/vulnerability/{vulnerabilityID}".format(
        server_url or settings["api"]["api_url"],
        asset=asset,
...
def search_asset_definitions(
    ...
    url = "{}/assets/v2/asset/definition/search".format(
        server_url or settings["api"]["api_url"],
...
def search_assets(
    ...
    url = "{}/assets/v2/asset/search".format(
        server_url or settings["api"]["api_url"],
