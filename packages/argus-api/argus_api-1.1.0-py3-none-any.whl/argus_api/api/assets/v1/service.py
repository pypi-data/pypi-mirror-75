...
def attach_hosts_to_service(
    ...
    url = "{}/assets/v1/service/{id}/attachhosts".format(
        server_url or settings["api"]["api_url"],
        id=id
    )
    headers = {
...
def delete_service_asset(
    ...
    url = "{}/assets/v1/service/{id}".format(
        server_url or settings["api"]["api_url"],
        id=id
    )
    headers = {
...
def detach_hosts_from_service(
    ...
    url = "{}/assets/v1/service/{id}/detachhosts".format(
        server_url or settings["api"]["api_url"],
        id=id
    )
    headers = {
...
def search_service_asset_statistics(
    ...
    url = "{}/assets/v1/service/statistics".format(
        server_url or settings["api"]["api_url"],
...
def search_service_assets(
    ...
    url = "{}/assets/v1/service/search".format(
        server_url or settings["api"]["api_url"],
