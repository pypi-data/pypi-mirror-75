...
def merge_host_asset(
    ...
    url = "{}/assets/v1/host/{mergeIntoID}/merge".format(
        server_url or settings["api"]["api_url"],
...
def search_host_asset_statistics(
    ...
    url = "{}/assets/v1/host/statistics".format(
        server_url or settings["api"]["api_url"],
...
def search_host_assets(
    ...
    url = "{}/assets/v1/host/search".format(
        server_url or settings["api"]["api_url"],
