...
def add_business_process(
    ...
    url = "{}/assets/v1/businessprocess".format(
...
def attach_services_to_business_process(
    ...
    url = "{}/assets/v1/businessprocess/{id}/attachservices".format(
        server_url or settings["api"]["api_url"],
        id=id
    )
    headers = {
...
def delete_business_process(
    ...
    url = "{}/assets/v1/businessprocess/{id}".format(
        server_url or settings["api"]["api_url"],
        id=id
    )
    headers = {
...
def detach_services_from_business_process(
    ...
    url = "{}/assets/v1/businessprocess/{id}/detachservices".format(
        server_url or settings["api"]["api_url"],
        id=id
    )
    headers = {
...
def search_business_process_statistics(
    ...
    url = "{}/assets/v1/businessprocess/statistics".format(
        server_url or settings["api"]["api_url"],
...
def search_business_processes(
    ...
    url = "{}/assets/v1/businessprocess/search".format(
        server_url or settings["api"]["api_url"],
