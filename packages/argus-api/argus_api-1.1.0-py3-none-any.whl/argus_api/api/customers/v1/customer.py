...
def add_customer(
    ...
    url = "{}/customers/v1/customer".format(
...
def add_customer_service(
    ...
    url = "{}/customers/v1/customer/{customerID}/service".format(
        server_url or settings["api"]["api_url"],
...
def disable_customer(
    ...
    url = "{}/customers/v1/customer/{id}".format(
        server_url or settings["api"]["api_url"],
        id=id
    )
    headers = {
...
def get_customer_by_shortname(
    ...
    url = "{}/customers/v1/customer/{shortName}".format(
        server_url or settings["api"]["api_url"],
        shortName=shortName
    )
    headers = {
...
def get_customer_logo_by_id(
    ...
    url = "{}/customers/v1/customer/{id}/logo".format(
        server_url or settings["api"]["api_url"],
        id=id
    )
    headers = {
...
def get_customer_logo_by_shortname(
    ...
    url = "{}/customers/v1/customer/{shortName}/logo".format(
        server_url or settings["api"]["api_url"],
        shortName=shortName
    )
    headers = {
...
def move_customer(
    ...
    url = "{}/customers/v1/customer/{customer}/move".format(
        server_url or settings["api"]["api_url"],
        customer=customer,
        domain=domain
    )
...
def reenable_customer(
    ...
    url = "{}/customers/v1/customer/{id}/reenable".format(
        server_url or settings["api"]["api_url"],
        id=id
    )
    headers = {
...
def remove_customer_service(
    ...
    url = "{}/customers/v1/customer/{customerID}/service/{service}".format(
        server_url or settings["api"]["api_url"],
        customerID=customerID,
        service=service
    )
...
def search_customers(
    ...
    url = "{}/customers/v1/customer/search".format(
        server_url or settings["api"]["api_url"],
