...
def add_function(
    ...
    url = "{}/useradmin/v2/function".format(
...
def add_function_child(
    ...
    url = "{}/useradmin/v2/function/{functionNameOrID}/children".format(
        server_url or settings["api"]["api_url"],
...
def delete_user(
    ...
    url = "{}/useradmin/v2/function/{functionNameOrID}".format(
        server_url or settings["api"]["api_url"],
        functionNameOrID=functionNameOrID
    )
    headers = {
...
def list_function_parents(
    ...
    url = "{}/useradmin/v2/function/{functionNameOrID}/parents".format(
        server_url or settings["api"]["api_url"],
        functionNameOrID=functionNameOrID
    )
    headers = {
...
def search_functions(
    ...
    url = "{}/useradmin/v2/function/search".format(
        server_url or settings["api"]["api_url"],
