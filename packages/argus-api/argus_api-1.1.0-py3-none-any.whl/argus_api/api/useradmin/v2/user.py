...
def delete_user_1(
    ...
    url = "{}/useradmin/v2/user/{shortNameOrID}".format(
        server_url or settings["api"]["api_url"],
...
def delete_user_preferences(
    ...
    url = "{}/useradmin/v2/user/{shortNameOrID}/preferences".format(
        server_url or settings["api"]["api_url"],
        shortNameOrID=shortNameOrID,
        domain=domain,
        key=key
...
def get_user_image_1(
    ...
    url = "{}/useradmin/v2/user/{shortNameOrID}/picture".format(
        server_url or settings["api"]["api_url"],
        shortNameOrID=shortNameOrID,
        domain=domain,
        width=width,
...
def get_user_preference(
    ...
    url = "{}/useradmin/v2/user/{shortNameOrID}/preferences/{key}".format(
        server_url or settings["api"]["api_url"],
        shortNameOrID=shortNameOrID,
        key=key,
        domain=domain
...
def list_permissions_for_user(
    ...
    url = "{}/useradmin/v2/user/{shortNameOrID}/permissions".format(
        server_url or settings["api"]["api_url"],
        limit=limit,
...
def list_user_preference_as_map(
    ...
    url = "{}/useradmin/v2/user/{shortNameOrID}/preferencemap".format(
        server_url or settings["api"]["api_url"],
        limit=limit,
        offset=offset,
        shortNameOrID=shortNameOrID,
...
def move_user(
    ...
    url = "{}/useradmin/v2/user/{shortNameOrID}/move".format(
        server_url or settings["api"]["api_url"],
        shortNameOrID=shortNameOrID,
        domain=domain
    )
...
def reenable_user(
    ...
    url = "{}/useradmin/v2/user/{shortNameOrID}/reenable".format(
        server_url or settings["api"]["api_url"],
        shortNameOrID=shortNameOrID,
        domain=domain
    )
...
def reset_password(
    ...
    url = "{}/useradmin/v2/user/{shortNameOrID}/resetpassword".format(
        server_url or settings["api"]["api_url"],
        shortNameOrID=shortNameOrID,
        domain=domain
    )
...
def search_users(
    ...
    url = "{}/useradmin/v2/user/search".format(
        server_url or settings["api"]["api_url"],
...
def set_user_preference(
    ...
    url = "{}/useradmin/v2/user/{shortNameOrID}/preferences/{key}/{value}".format(
        server_url or settings["api"]["api_url"],
        shortNameOrID=shortNameOrID,
        domain=domain,
        key=key,
...
def unblock_user(
    ...
    url = "{}/useradmin/v2/user/{shortNameOrID}/unblock".format(
        server_url or settings["api"]["api_url"],
        shortNameOrID=shortNameOrID,
        domain=domain
    )
