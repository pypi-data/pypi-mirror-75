...
def add_group_members(
    ...
    url = "{}/useradmin/v2/group/{shortNameOrID}/members".format(
        server_url or settings["api"]["api_url"],
...
def delete_group(
    ...
    url = "{}/useradmin/v2/group/{shortNameOrID}".format(
        server_url or settings["api"]["api_url"],
        shortNameOrID=shortNameOrID,
        domain=domain
    )
...
def list_permissions_for_group(
    ...
    url = "{}/useradmin/v2/group/{shortNameOrID}/permissions".format(
        server_url or settings["api"]["api_url"],
        limit=limit,
...
def move_group(
    ...
    url = "{}/useradmin/v2/group/{shortNameOrID}/move".format(
        server_url or settings["api"]["api_url"],
        shortNameOrID=shortNameOrID,
        domain=domain
    )
...
def reenable_group(
    ...
    url = "{}/useradmin/v2/group/{shortNameOrID}/reenable".format(
        server_url or settings["api"]["api_url"],
        shortNameOrID=shortNameOrID,
        domain=domain
    )
...
def search_groups(
    ...
    url = "{}/useradmin/v2/group/search".format(
        server_url or settings["api"]["api_url"],
