...
def authorize(
    ...
    url = "{}/authentication/v1/oauth/authorize".format(
...
def create_o_auth2_client(
    ...
    url = "{}/authentication/v1/oauth/client".format(
        server_url or settings["api"]["api_url"],
...
def delete_oauth2_client(
    ...
    url = "{}/authentication/v1/oauth/client/{idOrShortname}".format(
        server_url or settings["api"]["api_url"],
...
def get_token(
    ...
    url = "{}/authentication/v1/oauth/token".format(
        server_url or settings["api"]["api_url"],
...
def search_oauth2_clients(
    ...
    url = "{}/authentication/v1/oauth/client/search".format(
        server_url or settings["api"]["api_url"],
