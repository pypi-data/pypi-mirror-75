...
def error_stats(
    ...
    url = "{}/eventfilters/v1/filter/errorstats".format(
...
def get(
    ...
    url = "{}/eventfilters/v1/filter/{id}".format(
        server_url or settings["api"]["api_url"],
        id=id
    )
    headers = {
...
def hit_stats(
    ...
    url = "{}/eventfilters/v1/filter/hitstats".format(
        server_url or settings["api"]["api_url"],
        period=period,
        includeDetails=includeDetails
    )
...
def list(
    ...
    url = "{}/eventfilters/v1/filter".format(
        server_url or settings["api"]["api_url"],
        limit=limit,
        offset=offset,
        search=search,
...
def move_filter(
    ...
    url = "{}/eventfilters/v1/filter/{id}/move".format(
        server_url or settings["api"]["api_url"],
        id=id
    )
    headers = {
...
def revisions(
    ...
    url = "{}/eventfilters/v1/filter/{id}/revisions".format(
        server_url or settings["api"]["api_url"],
        limit=limit,
        offset=offset,
        id=id
...
def search(
    ...
    url = "{}/eventfilters/v1/filter/search".format(
        server_url or settings["api"]["api_url"],
...
def set_log_level(
    ...
    url = "{}/eventfilters/v1/filter/{id}/logging".format(
        server_url or settings["api"]["api_url"],
        id=id
    )
    headers = {
