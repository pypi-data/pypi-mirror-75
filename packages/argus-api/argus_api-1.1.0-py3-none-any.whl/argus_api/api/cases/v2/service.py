...
def bind_category(
    ...
    url = "{}/cases/v2/service/{serviceID}/categories".format(
...
def delete_service(
    ...
    url = "{}/cases/v2/service/{id}".format(
        server_url or settings["api"]["api_url"],
        id=id
    )
    headers = {
...
def get_field_policy_by_service(
    ...
    url = "{}/cases/v2/service/{service}/fieldpolicy".format(
        server_url or settings["api"]["api_url"],
        service=service,
        customer=customer,
        domain=domain
...
def list_categories_1(
    ...
    url = "{}/cases/v2/service/{id}/categories".format(
        server_url or settings["api"]["api_url"],
        limit=limit,
        id=id,
        offset=offset
...
def search_services(
    ...
    url = "{}/cases/v2/service/search".format(
        server_url or settings["api"]["api_url"],
...
def unbind_category(
    ...
    url = "{}/cases/v2/service/{serviceID}/categories/{categoryID}".format(
        server_url or settings["api"]["api_url"],
        serviceID=serviceID,
