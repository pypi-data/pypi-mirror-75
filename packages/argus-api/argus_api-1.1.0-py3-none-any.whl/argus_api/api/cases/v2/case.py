...
def acknowledge_workflow(
    ...
    url = "{}/cases/v2/case/{caseID}/workflows/{workflow}/acknowledge".format(
...
def add_attachment(
    ...
    url = "{}/cases/v2/case/{caseID}/attachments".format(
        server_url or settings["api"]["api_url"],
        caseID=caseID
    )
    headers = {
...
def add_case_link(
    ...
    url = "{}/cases/v2/case/{caseID}/links/{linkToCaseID}".format(
        server_url or settings["api"]["api_url"],
        caseID=caseID,
...
def add_case_tag(
    ...
    url = "{}/cases/v2/case/{caseID}/tags".format(
        server_url or settings["api"]["api_url"],
        caseID=caseID
    )
    headers = {
...
def add_case_watcher(
    ...
    url = "{}/cases/v2/case/{caseID}/watchers".format(
        server_url or settings["api"]["api_url"],
        caseID=caseID
    )
    headers = {
...
def add_comment(
    ...
    url = "{}/cases/v2/case/{caseID}/comments".format(
        server_url or settings["api"]["api_url"],
        caseID=caseID
    )
    headers = {
...
def advanced_case_search(
    ...
    url = "{}/cases/v2/case/search".format(
        server_url or settings["api"]["api_url"],
...
def change_access_settings(
    ...
    url = "{}/cases/v2/case/{caseID}/access".format(
        server_url or settings["api"]["api_url"],
        caseID=caseID
    )
    headers = {
...
def clear_field(
    ...
    url = "{}/cases/v2/case/{caseID}/fields/{field}".format(
        server_url or settings["api"]["api_url"],
        caseID=caseID,
        field=field
    )
...
def close_case(
    ...
    url = "{}/cases/v2/case/{caseID}/close".format(
        server_url or settings["api"]["api_url"],
        caseID=caseID
    )
    headers = {
...
def current_user_watcher_status(
    ...
    url = "{}/cases/v2/case/{caseID}/watch".format(
        server_url or settings["api"]["api_url"],
        caseID=caseID
    )
    headers = {
...
def delete_attachment(
    ...
    url = "{}/cases/v2/case/{caseID}/attachments/{attachmentID}".format(
        server_url or settings["api"]["api_url"],
        caseID=caseID,
...
def delete_case(
    ...
    url = "{}/cases/v2/case/{caseID}".format(
        server_url or settings["api"]["api_url"],
        caseID=caseID
    )
    headers = {
...
def delete_case_link(
    ...
    url = "{}/cases/v2/case/{caseID}/links/{linkID}".format(
        server_url or settings["api"]["api_url"],
        caseID=caseID,
        linkID=linkID
    )
...
def delete_comment(
    ...
    url = "{}/cases/v2/case/{caseID}/comments/{commentID}".format(
        server_url or settings["api"]["api_url"],
        caseID=caseID,
        commentID=commentID
    )
...
def download_attachment(
    ...
    url = "{}/cases/v2/case/{caseID}/attachments/{attachmentID}/download".format(
        server_url or settings["api"]["api_url"],
        caseID=caseID,
        attachmentID=attachmentID
    )
...
def get_case_comment_notifications(
    ...
    url = "{}/cases/v2/case/{caseID}/comments/{commentID}/notifications".format(
        server_url or settings["api"]["api_url"],
        caseID=caseID,
        commentID=commentID
    )
...
def get_case_service(
    ...
    url = "{}/cases/v2/case/{id}/service".format(
        server_url or settings["api"]["api_url"],
        id=id
    )
    headers = {
...
def get_case_transaction(
    ...
    url = "{}/cases/v2/case/{caseID}/history/{transactionID}".format(
        server_url or settings["api"]["api_url"],
        caseID=caseID,
...
def get_field_policy_by_case(
    ...
    url = "{}/cases/v2/case/{caseID}/fieldpolicy".format(
        server_url or settings["api"]["api_url"],
        caseID=caseID
    )
    headers = {
...
def list_case_history(
    ...
    url = "{}/cases/v2/case/{caseID}/history".format(
        server_url or settings["api"]["api_url"],
        limit=limit,
        caseID=caseID,
        type=type,
...
def list_case_links(
    ...
    url = "{}/cases/v2/case/{caseID}/links".format(
        server_url or settings["api"]["api_url"],
        limit=limit,
        caseID=caseID,
        offset=offset,
...
def list_fields(
    ...
    url = "{}/cases/v2/case/{caseID}/fields".format(
        server_url or settings["api"]["api_url"],
        caseID=caseID
    )
    headers = {
...
def list_transaction_notifications(
    ...
    url = "{}/cases/v2/case/{caseID}/history/{transactionID}/notifications".format(
        server_url or settings["api"]["api_url"],
        caseID=caseID,
        transactionID=transactionID
    )
...
def list_workflows(
    ...
    url = "{}/cases/v2/case/{caseID}/workflows".format(
        server_url or settings["api"]["api_url"],
        caseID=caseID,
...
def merge_cases(
    ...
    url = "{}/cases/v2/case/{mergeInto}/merge/{mergeFrom}".format(
        server_url or settings["api"]["api_url"],
        mergeInto=mergeInto,
        mergeFrom=mergeFrom
    )
...
def move_case(
    ...
    url = "{}/cases/v2/case/{id}/move".format(
        server_url or settings["api"]["api_url"],
        id=id
    )
    headers = {
...
def publish_case(
    ...
    url = "{}/cases/v2/case/{caseID}/publish".format(
        server_url or settings["api"]["api_url"],
        caseID=caseID
    )
    headers = {
...
def remove_access(
    ...
    url = "{}/cases/v2/case/{caseID}/access/{aclEntryID}".format(
        server_url or settings["api"]["api_url"],
        caseID=caseID,
...
def remove_case_contact_watcher(
    ...
    url = "{}/cases/v2/case/{caseID}/watchers/contact/{contactID}".format(
        server_url or settings["api"]["api_url"],
        caseID=caseID,
        contactID=contactID
    )
...
def remove_case_tag_by_id(
    ...
    url = "{}/cases/v2/case/{caseID}/tags/{tagID}".format(
        server_url or settings["api"]["api_url"],
        caseID=caseID,
        tagID=tagID
    )
...
def remove_case_tag_by_key_value(
    ...
    url = "{}/cases/v2/case/{caseID}/tags/{tagKey}/{tagValue}".format(
        server_url or settings["api"]["api_url"],
        caseID=caseID,
        tagKey=tagKey,
        tagValue=tagValue
...
def remove_case_watcher(
    ...
    url = "{}/cases/v2/case/{caseID}/watchers/{watcherID}".format(
        server_url or settings["api"]["api_url"],
        caseID=caseID,
        watcherID=watcherID
    )
...
def request_workflow(
    ...
    url = "{}/cases/v2/case/{caseID}/workflows/{workflow}/request".format(
        server_url or settings["api"]["api_url"],
        caseID=caseID,
        workflow=workflow
    )
...
def search_case_statistics(
    ...
    url = "{}/cases/v2/case/stats".format(
        server_url or settings["api"]["api_url"],
...
def update_workflow(
    ...
    url = "{}/cases/v2/case/{caseID}/workflows/{workflow}".format(
        server_url or settings["api"]["api_url"],
        caseID=caseID,
        workflow=workflow
    )
