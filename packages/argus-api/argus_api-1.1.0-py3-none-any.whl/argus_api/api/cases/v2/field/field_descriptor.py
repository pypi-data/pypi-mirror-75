...
def add_field_policy(
    ...
    url = "{}/cases/v2/field/policy".format(
...
def add_field_to_policy(
    ...
    url = "{}/cases/v2/field/policy/{policy}/fields".format(
        server_url or settings["api"]["api_url"],
        policy=policy,
        domain=domain
    )
...
def create_field_descriptor(
    ...
    url = "{}/cases/v2/field/descriptor".format(
        server_url or settings["api"]["api_url"],
...
def delete_field_descriptor(
    ...
    url = "{}/cases/v2/field/descriptor/{field}".format(
        server_url or settings["api"]["api_url"],
        field=field,
        domain=domain
    )
...
def delete_field_policy(
    ...
    url = "{}/cases/v2/field/policy/{policy}".format(
        server_url or settings["api"]["api_url"],
        policy=policy,
        domain=domain
    )
...
def list_field_source_values(
    ...
    url = "{}/cases/v2/field/values/{field}".format(
        server_url or settings["api"]["api_url"],
        limit=limit,
        field=field,
        caseID=caseID,
...
def remove_field_from_policy(
    ...
    url = "{}/cases/v2/field/policy/{policy}/fields/{field}".format(
        server_url or settings["api"]["api_url"],
        policy=policy,
        field=field,
        domain=domain
...
def search_field_descriptors(
    ...
    url = "{}/cases/v2/field/descriptor/search".format(
        server_url or settings["api"]["api_url"],
...
def search_field_policies(
    ...
    url = "{}/cases/v2/field/policy/search".format(
        server_url or settings["api"]["api_url"],
