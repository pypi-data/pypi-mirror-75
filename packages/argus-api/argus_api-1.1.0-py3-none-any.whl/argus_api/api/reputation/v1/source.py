...
def add_new_source(
    ...
    url = "{}/reputation/v1/source".format(
...
def delete_source(
    ...
    url = "{}/reputation/v1/source/{id}".format(
        server_url or settings["api"]["api_url"],
        id=id
    )
    headers = {
...
def find_sources(
    ...
    url = "{}/reputation/v1/source/search".format(
        server_url or settings["api"]["api_url"],
...
def get_source_by_alias(
    ...
    url = "{}/reputation/v1/source/{alias}".format(
        server_url or settings["api"]["api_url"],
        alias=alias
    )
    headers = {
...
def transition_source(
    ...
    url = "{}/reputation/v1/source/{source}/transition".format(
        server_url or settings["api"]["api_url"],
        source=source
    )
    headers = {
