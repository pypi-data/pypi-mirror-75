...
def add_address_overrides(
    ...
    url = "{}/reputation/v1/override/ip".format(
...
def add_domain_override(
    ...
    url = "{}/reputation/v1/override/domain".format(
        server_url or settings["api"]["api_url"],
...
def add_override_list(
    ...
    url = "{}/reputation/v1/override/list".format(
        server_url or settings["api"]["api_url"],
...
def delete_address_override(
    ...
    url = "{}/reputation/v1/override/ip/{id}".format(
        server_url or settings["api"]["api_url"],
        id=id
    )
    headers = {
...
def delete_domain_override(
    ...
    url = "{}/reputation/v1/override/domain/{id}".format(
        server_url or settings["api"]["api_url"],
        id=id
    )
    headers = {
...
def delete_override_list(
    ...
    url = "{}/reputation/v1/override/list/{id}".format(
        server_url or settings["api"]["api_url"],
        id=id
    )
    headers = {
...
def find_address_overrides(
    ...
    url = "{}/reputation/v1/override/ip/search".format(
        server_url or settings["api"]["api_url"],
...
def find_domain_overrides(
    ...
    url = "{}/reputation/v1/override/domain/search".format(
        server_url or settings["api"]["api_url"],
...
def get_overrides_for_domain(
    ...
    url = "{}/reputation/v1/override/domain/{fqdn}".format(
        server_url or settings["api"]["api_url"],
        fqdn=fqdn
    )
    headers = {
...
def get_overrides_for_i_p(
    ...
    url = "{}/reputation/v1/override/ip/{ip}".format(
        server_url or settings["api"]["api_url"],
        ip=ip
    )
    headers = {
