...
def calculate_reputation_for_domain(
    ...
    url = "{}/reputation/v1/calculated/domain/{fqdn}".format(
...
def calculate_reputation_for_i_p(
    ...
    url = "{}/reputation/v1/calculated/ip/{ip}".format(
        server_url or settings["api"]["api_url"],
        ip=ip
    )
    headers = {
...
def find_address_reputation(
    ...
    url = "{}/reputation/v1/calculated/ip/search".format(
        server_url or settings["api"]["api_url"],
...
def find_domain_reputation(
    ...
    url = "{}/reputation/v1/calculated/domain/search".format(
        server_url or settings["api"]["api_url"],
...
def list_address_reputation(
    ...
    url = "{}/reputation/v1/calculated/ip".format(
        server_url or settings["api"]["api_url"],
        limit=limit,
...
def list_domain_reputation(
    ...
    url = "{}/reputation/v1/calculated/domain".format(
        server_url or settings["api"]["api_url"],
        limit=limit,
