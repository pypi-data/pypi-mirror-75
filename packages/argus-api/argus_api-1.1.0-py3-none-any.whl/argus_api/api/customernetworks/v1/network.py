...
def add_customer_network(
    ...
    url = "{}/customernetworks/v1/network".format(
...
def add_customer_network_comment(
    ...
    url = "{}/customernetworks/v1/network/{networkID}/comments".format(
        server_url or settings["api"]["api_url"],
        networkID=networkID
    )
    headers = {
...
def bulk_add_customer_networks(
    ...
    url = "{}/customernetworks/v1/network/bulk".format(
        server_url or settings["api"]["api_url"],
...
def delete_customer_network(
    ...
    url = "{}/customernetworks/v1/network/{networkID}".format(
        server_url or settings["api"]["api_url"],
        networkID=networkID
    )
    headers = {
...
def delete_customer_network_comment(
    ...
    url = "{}/customernetworks/v1/network/{networkID}/comments/{commentID}".format(
        server_url or settings["api"]["api_url"],
        networkID=networkID,
        commentID=commentID
    )
...
def search_customer_network(
    ...
    url = "{}/customernetworks/v1/network/search".format(
        server_url or settings["api"]["api_url"],
