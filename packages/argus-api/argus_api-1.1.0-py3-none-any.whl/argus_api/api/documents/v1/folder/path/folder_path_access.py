...
def add_document(
    ...
    url = "{}/documents/v1/folder/{folderID}/documents".format(
...
def add_document_raw(
    ...
    url = "{}/documents/v1/folder/{folderID}/documents/{documentName}".format(
        server_url or settings["api"]["api_url"],
...
def add_folder(
    ...
    url = "{}/documents/v1/folder/{parentID}".format(
        server_url or settings["api"]["api_url"],
        parentID=parentID
    )
    headers = {
...
def add_folder_by_path(
    ...
    url = "{}/documents/v1/folder/path{parentFolderPath}".format(
        server_url or settings["api"]["api_url"],
...
def add_folder_watcher(
    ...
    url = "{}/documents/v1/folder/{folderID}/watchers".format(
        server_url or settings["api"]["api_url"],
        folderID=folderID
    )
    headers = {
...
def add_folder_watcher_by_path(
    ...
    url = "{}/documents/v1/folder/path/watchers{path}".format(
        server_url or settings["api"]["api_url"],
        path=path,
        customer=customer
    )
...
def browse_folder(
    ...
    url = "{}/documents/v1/folder/{folderID}/content".format(
        server_url or settings["api"]["api_url"],
        limit=limit,
        offset=offset,
        folderID=folderID
...
def browse_folder_by_path(
    ...
    url = "{}/documents/v1/folder/path/content{path}".format(
        server_url or settings["api"]["api_url"],
        limit=limit,
        path=path,
        customer=customer,
...
def delete_folder(
    ...
    url = "{}/documents/v1/folder/{folderID}".format(
        server_url or settings["api"]["api_url"],
        mode=mode,
        folderID=folderID,
...
def delete_folder_by_path(
    ...
    url = "{}/documents/v1/folder/path{parentFolderPath}/{folderName}".format(
        server_url or settings["api"]["api_url"],
        mode=mode,
        parentFolderPath=parentFolderPath,
...
def delete_folder_watcher(
    ...
    url = "{}/documents/v1/folder/{folderID}/watchers/{entryID}".format(
        server_url or settings["api"]["api_url"],
        folderID=folderID,
        entryID=entryID
    )
...
def delete_folder_watcher_by_path(
    ...
    url = "{}/documents/v1/folder/path/watchers{path}/{entryID}".format(
        server_url or settings["api"]["api_url"],
        path=path,
        customer=customer,
        entryID=entryID
...
def get_current_user_folder_watch_status(
    ...
    url = "{}/documents/v1/folder/{folderID}/watch".format(
        server_url or settings["api"]["api_url"],
        folderID=folderID
    )
    headers = {
...
def get_current_user_folder_watch_status_by_path(
    ...
    url = "{}/documents/v1/folder/path/watch{path}".format(
        server_url or settings["api"]["api_url"],
        path=path,
        customer=customer
    )
...
def get_current_user_root_folder(
    ...
    url = "{}/documents/v1/folder/root".format(
        server_url or settings["api"]["api_url"],
        limit=limit,
        offset=offset
    )
...
def get_folder_meta_info_by_path(
    ...
    url = "{}/documents/v1/folder/path/meta{path}".format(
        server_url or settings["api"]["api_url"],
        path=path,
        customer=customer
    )
...
def grant_folder_access(
    ...
    url = "{}/documents/v1/folder/{folderID}/access".format(
        server_url or settings["api"]["api_url"],
        folderID=folderID
    )
    headers = {
...
def grant_folder_access_by_path(
    ...
    url = "{}/documents/v1/folder/path/access{path}".format(
        server_url or settings["api"]["api_url"],
        path=path,
        customer=customer
    )
...
def move_folder(
    ...
    url = "{}/documents/v1/folder/{folderID}/move".format(
        server_url or settings["api"]["api_url"],
        folderID=folderID
    )
    headers = {
...
def revoke_folder_access(
    ...
    url = "{}/documents/v1/folder/{folderID}/access/{accessID}".format(
        server_url or settings["api"]["api_url"],
        folderID=folderID,
        accessID=accessID
    )
...
def revoke_folder_access_by_path(
    ...
    url = "{}/documents/v1/folder/path/access{path}/{accessID}".format(
        server_url or settings["api"]["api_url"],
        path=path,
        accessID=accessID,
        customer=customer
