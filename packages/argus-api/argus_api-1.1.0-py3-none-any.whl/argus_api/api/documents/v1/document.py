...
def add_document_by_path_raw(
    ...
    url = "{}/documents/v1/document/path{parentFolderPath}/{documentName}".format(
...
def add_document_watcher(
    ...
    url = "{}/documents/v1/document/{documentID}/watchers".format(
        server_url or settings["api"]["api_url"],
...
def add_document_watcher_by_path(
    ...
    url = "{}/documents/v1/document/path/watchers{parentFolderPath}/{documentName}".format(
        server_url or settings["api"]["api_url"],
        parentFolderPath=parentFolderPath,
        documentName=documentName,
        customer=customer
...
def commit_document(
    ...
    url = "{}/documents/v1/document/{documentID}/commit".format(
        server_url or settings["api"]["api_url"],
        documentID=documentID
    )
    headers = {
...
def delete_document(
    ...
    url = "{}/documents/v1/document/{documentID}".format(
        server_url or settings["api"]["api_url"],
        documentID=documentID
    )
    headers = {
...
def delete_document_watcher(
    ...
    url = "{}/documents/v1/document/{documentID}/watchers/{entryID}".format(
        server_url or settings["api"]["api_url"],
        documentID=documentID,
        entryID=entryID
    )
...
def delete_document_watcher_by_path(
    ...
    url = "{}/documents/v1/document/path/watchers{parentFolderPath}/{documentName}/{entryID}".format(
        server_url or settings["api"]["api_url"],
        parentFolderPath=parentFolderPath,
        documentName=documentName,
        customer=customer,
...
def get_current_user_document_watch_status(
    ...
    url = "{}/documents/v1/document/{documentID}/watch".format(
        server_url or settings["api"]["api_url"],
        documentID=documentID
    )
    headers = {
...
def get_current_user_document_watch_status_by_path(
    ...
    url = "{}/documents/v1/document/path/watch{parentFolderPath}/{documentName}".format(
        server_url or settings["api"]["api_url"],
        parentFolderPath=parentFolderPath,
        documentName=documentName,
        customer=customer
...
def get_document_content_by_id(
    ...
    url = "{}/documents/v1/document/{documentID}/content".format(
        server_url or settings["api"]["api_url"],
        documentID=documentID
    )
    headers = {
...
def get_document_content_by_path(
    ...
    url = "{}/documents/v1/document/path/content{parentFolderPath}/{documentName}".format(
        server_url or settings["api"]["api_url"],
        parentFolderPath=parentFolderPath,
        documentName=documentName,
        customer=customer
...
def get_document_revisions(
    ...
    url = "{}/documents/v1/document/{documentID}/versions".format(
        server_url or settings["api"]["api_url"],
        limit=limit,
        documentID=documentID,
        offset=offset
...
def get_meta_info_by_path(
    ...
    url = "{}/documents/v1/document/path/meta{parentFolderPath}/{documentName}".format(
        server_url or settings["api"]["api_url"],
        parentFolderPath=parentFolderPath,
        documentName=documentName,
        customer=customer
...
def grant_document_access(
    ...
    url = "{}/documents/v1/document/{documentID}/access".format(
        server_url or settings["api"]["api_url"],
        documentID=documentID
    )
    headers = {
...
def grant_document_access_by_path(
    ...
    url = "{}/documents/v1/document/path/access{parentFolderPath}/{documentName}".format(
        server_url or settings["api"]["api_url"],
        parentFolderPath=parentFolderPath,
        documentName=documentName,
        customer=customer
...
def list_documents(
    ...
    url = "{}/documents/v1/document".format(
        server_url or settings["api"]["api_url"],
        limit=limit,
...
def lock_document(
    ...
    url = "{}/documents/v1/document/{documentID}/lock".format(
        server_url or settings["api"]["api_url"],
        documentID=documentID
    )
    headers = {
...
def move_document(
    ...
    url = "{}/documents/v1/document/{documentID}/move".format(
        server_url or settings["api"]["api_url"],
        documentID=documentID
    )
    headers = {
...
def revoke_document_access(
    ...
    url = "{}/documents/v1/document/{documentID}/access/{accessID}".format(
        server_url or settings["api"]["api_url"],
        documentID=documentID,
        accessID=accessID
    )
...
def revoke_document_access_by_path(
    ...
    url = "{}/documents/v1/document/path/access{parentFolderPath}/{documentName}/{accessID}".format(
        server_url or settings["api"]["api_url"],
        parentFolderPath=parentFolderPath,
        documentName=documentName,
        accessID=accessID,
...
def search_documents(
    ...
    url = "{}/documents/v1/document/search".format(
        server_url or settings["api"]["api_url"],
