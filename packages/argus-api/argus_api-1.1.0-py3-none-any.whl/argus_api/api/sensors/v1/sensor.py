...
def acknowledge_sensor(
    ...
    url = "{}/sensors/v1/sensor/{sensorID}/acknowledge".format(
...
def acknowledge_sensors(
    ...
    url = "{}/sensors/v1/sensor/bulk/acknowledge".format(
        server_url or settings["api"]["api_url"],
        sensorID=sensorID
    )
    headers = {
...
def add_comment(
    ...
    url = "{}/sensors/v1/sensor/{sensorID}/comment".format(
        server_url or settings["api"]["api_url"],
        sensorID=sensorID
    )
    headers = {
...
def bulk_cancel_sensor_downtime(
    ...
    url = "{}/sensors/v1/sensor/bulk/downtime".format(
        server_url or settings["api"]["api_url"],
        sensorID=sensorID
    )
    headers = {
...
def cancel_sensor_downtime(
    ...
    url = "{}/sensors/v1/sensor/{sensorID}/downtime".format(
        server_url or settings["api"]["api_url"],
        sensorID=sensorID
    )
    headers = {
...
def create_sensor_interface(
    ...
    url = "{}/sensors/v1/sensor/{sensorID}/interface".format(
        server_url or settings["api"]["api_url"],
        sensorID=sensorID
    )
    headers = {
...
def delete_sensor(
    ...
    url = "{}/sensors/v1/sensor/{sensorID}".format(
        server_url or settings["api"]["api_url"],
        sensorID=sensorID
    )
    headers = {
...
def delete_sensor_comment(
    ...
    url = "{}/sensors/v1/sensor/{sensorID}/comment/{timestamp}".format(
        server_url or settings["api"]["api_url"],
        sensorID=sensorID,
        timestamp=timestamp
    )
...
def disable_monitoring(
    ...
    url = "{}/sensors/v1/sensor/{sensorID}/monitoring/disable".format(
        server_url or settings["api"]["api_url"],
        sensorID=sensorID
    )
    headers = {
...
def disable_monitoring_bulk(
    ...
    url = "{}/sensors/v1/sensor/bulk/monitoring/disable".format(
        server_url or settings["api"]["api_url"],
...
def disable_sensor(
    ...
    url = "{}/sensors/v1/sensor/{sensorID}/disable".format(
        server_url or settings["api"]["api_url"],
        sensorID=sensorID
    )
    headers = {
...
def disable_sensors(
    ...
    url = "{}/sensors/v1/sensor/bulk/disable".format(
        server_url or settings["api"]["api_url"],
...
def enable_monitoring(
    ...
    url = "{}/sensors/v1/sensor/{sensorID}/monitoring/enable".format(
        server_url or settings["api"]["api_url"],
        sensorID=sensorID,
        daytime=daytime
    )
...
def enable_monitoring_bulk(
    ...
    url = "{}/sensors/v1/sensor/bulk/monitoring/enable".format(
        server_url or settings["api"]["api_url"],
        daytime=daytime
    )
    headers = {
...
def enable_sensor(
    ...
    url = "{}/sensors/v1/sensor/{sensorID}/enable".format(
        server_url or settings["api"]["api_url"],
        sensorID=sensorID
    )
    headers = {
...
def enable_sensors(
    ...
    url = "{}/sensors/v1/sensor/bulk/enable".format(
        server_url or settings["api"]["api_url"],
...
def get_interface(
    ...
    url = "{}/sensors/v1/sensor/{sensorID}/interface/{interface}".format(
        server_url or settings["api"]["api_url"],
        sensorID=sensorID,
        interface=interface
    )
...
def get_interface_1(
    ...
    url = "{}/sensors/v1/sensor/{sensorID}/interface/{interfaceNameOrID}".format(
        server_url or settings["api"]["api_url"],
        sensorID=sensorID,
...
def get_sensor_comments(
    ...
    url = "{}/sensors/v1/sensor/{sensorID}/comments".format(
        server_url or settings["api"]["api_url"],
        limit=limit,
        sensorID=sensorID,
        offset=offset
...
def get_sensor_status(
    ...
    url = "{}/sensors/v1/sensor/{sensorID}/status".format(
        server_url or settings["api"]["api_url"],
        sensorID=sensorID
    )
    headers = {
...
def remove_acknowledgement_sensor(
    ...
    url = "{}/sensors/v1/sensor/{sensorID}/removeacknowledgement".format(
        server_url or settings["api"]["api_url"],
        sensorID=sensorID
    )
    headers = {
...
def remove_acknowledgement_sensors(
    ...
    url = "{}/sensors/v1/sensor/bulk/removeacknowledgement".format(
        server_url or settings["api"]["api_url"],
        sensorID=sensorID
    )
    headers = {
...
def search_sensors(
    ...
    url = "{}/sensors/v1/sensor/search".format(
        server_url or settings["api"]["api_url"],
