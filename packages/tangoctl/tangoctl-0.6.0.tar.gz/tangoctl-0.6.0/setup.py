...
requirements = ["pytango", "click", "treelib", "gevent", "tabulate", "colorful"]

extras_requirements = {"repl": ["prompt_toolkit>=3.0.3"]}
...
setup(
    ...
    entry_points={"console_scripts": ["tangoctl = tangoctl.cli:cli",],},
