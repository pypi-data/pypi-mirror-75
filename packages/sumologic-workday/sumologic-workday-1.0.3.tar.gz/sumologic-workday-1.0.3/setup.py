...
CONSOLE_SCRIPTS = [
    'sumoworkdaycollector=sumoworkdaycollector.main:main'
]


setup(
    name="sumologic-workday",
    ...
    description="Sumo Logic collection solution for WorkDay",
    license="PSF",
    long_description=long_description,
    long_description_content_type='text/markdown',
    keywords="sumologic python rest api log management analytics WorkDay agent collector forwarder",
    url="https://github.com/SumoLogic/sumologic-workday",
    zip_safe=True,
