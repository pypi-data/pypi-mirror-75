...
setup(
    ...
    description='Data entry and retrieval',  # Optional
    ...
    url='https://github.com/KylerKatz/KetoGator',  # Optional

    # This should be your name or the name of the organization which owns the
    # project.
     author='KGTeam',  # Optional
    ...
    #
    # packages=find_packages(where='KetoGator'),  # Required
     packages=['KetoGator'],
    ...
    install_requires=['PyQt5', 'pandas', 'xlrd', 'xlwt', 'mysql-connector-python', 'openpyxl', 'matplotlib'],  # Optional
