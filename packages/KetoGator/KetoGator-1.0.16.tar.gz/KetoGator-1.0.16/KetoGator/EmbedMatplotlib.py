...
class Canvas(FigureCanvas):
    ...
    def plot(self, patient):
        try:
            ...
            bmi_z = []
            age = []
            data = SpreadSheetAccess.getAnthropometricsDataFrame(patient)
    ...
    def medloadplot(self, patient):
        try:
            ...
            anthro = SpreadSheetAccess.getAnthropometricsDataFrame(patient)
            medData = SpreadSheetAccess.getMedDataDataFrame(patient)
            ...
            # Get Med Ranking
            path = curDir + r"/MED_RANKING_SOURCE.xlsx"
            medRankings = pd.read_excel(path)
