...
################### Event Handling ###################
    ...
    def handlelist(self,item):
        ...
        if("Anthropometrics" in item.text()):
            self.anthropometricsGraph = EmbedMatplotlib.Canvas(self.currentpatient, plot = "Anthropometrics")
            # self.anthropometricsGraph.move(0,0)
            self.anthropometricsGraph.close()
            self.middle.addWidget(self.anthropometricsGraph)
        if("Med Load" in item.text()):
            self.medloadGraph = EmbedMatplotlib.Canvas(self.currentpatient, plot = "Med Load")
    ...
    def loadgraphnames(self):
        ...
        self.graphlist.addItems(SpreadSheetAccess.getPatientGraphs(self.currentpatient))
...
######################## Sending Input To The Back End ##########################
    def submitAlertness(self,event):
        ...
        try:
            SpreadSheetAccess.saveAlertness(
            self.currentpatient,    
    ...
    def submitClinicGI(self,event):
        try:
            SpreadSheetAccess.saveClinicGI(
            self.currentpatient,
    ...
    def submitClinicalLabs(self,event):
        try:
            SpreadSheetAccess.saveClinicalLabs(
                self.currentpatient,
    ...
    def submitDailyIntake(self,event):
        ...
        try:
            SpreadSheetAccess.saveDailyIntake(
            self.currentpatient,
    ...
    def submitOtherMed(self,event):
        ...
        try:
            SpreadSheetAccess.saveOtherMed(
            self.currentpatient,
    ...
    def submitSeizureData(self,event):
        ...
        try:
            SpreadSheetAccess.saveSeizureData(
            self.currentpatient,
    ...
    def submitSeizureRanking(self,event):
        ...
        try:
            SpreadSheetAccess.saveSeizureRanking(
            self.currentpatient,
    ...
    def submitUrineKtSG(self,event):
        ...
        try:
            SpreadSheetAccess.saveUrineKtSG(
            self.currentpatient,
