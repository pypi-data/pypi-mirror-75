    ...
    restMap = {
        ...
        'image':
            {
                ...
                'cancel':#取消分享镜像 aimax del cancelShare -F aaa
                    {
                ...
                'addHarborUser':{
                    ...
                    'addargdef': (None,None),
                    'addargdesc': ("Please input harborUser:",
                                   "Please input groupId:"),
                    # @RequestBody User
        ...
        'user':{
            'add':{
                ...
                'addargdef': (None,None),
                'addargdesc': ("Please input harborUser:","Please input harborpassword:"),
                # @RequestBody User "quota":{"id":0,"userId":0,"cpu":1,"gpu":1,"gputypequota":"","internalMemory":"","dataStorage":"","taskNumber":"","isDefault":0,"":"","username":"","volumeName":""}
                'bodyjson': 'Please input User json (demo: {"count":0,"message":"","success":true,"totalSize":0,"username":"asd","password":"asdasd1","volumeName":"134nfs","groupId":"6","zoneName":"rayz5","creator":"super","mender":"super","mobile":"12341234123","email":"1@qq.com"} ):',
            },

            'quotas':{
                'addUrl': '/api/auth/quotas',
               #api/auth/quotas?token=%s
                # @RequestBody UserQuota
                # 'body':({"id":0,'userId':0,'cpu':0,'gpu':0,'internalMemory':'','dataStorage':'','taskNumber':'','isDefault':0,'':'','username':'','volumeName':'','gputype':''}),
                'bodyjson': 'Please input UserQuota json (demo: {"id":0,"userId":69,"cpu":1,"gpu":1,"gputypequota":"GeForceRTX2080Ti","internalMemory":"20GB","dataStorage":"20GB","taskNumber":5,"isDefault":0,"username":"728asd","volumeName":"134nfs"}):',
            },
            'getgpuList': # 创建任务前 获取 gpu类型列表 aimax list getgpuList -F aaa
                {
                    # %s/api/job/jobs/gputype?token=%s
