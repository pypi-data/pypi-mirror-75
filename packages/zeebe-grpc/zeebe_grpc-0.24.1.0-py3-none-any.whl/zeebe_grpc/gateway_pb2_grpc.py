...
class GatewayStub(object):
    ...
    def __init__(self, channel):
        ...
        self.CancelWorkflowInstance = channel.unary_unary(
                ...
                request_serializer=zeebe__grpc_dot_gateway__pb2.CancelWorkflowInstanceRequest.SerializeToString,
                response_deserializer=zeebe__grpc_dot_gateway__pb2.CancelWorkflowInstanceResponse.FromString,
                )
        ...
        self.CreateWorkflowInstance = channel.unary_unary(
                ...
                request_serializer=zeebe__grpc_dot_gateway__pb2.CreateWorkflowInstanceRequest.SerializeToString,
                response_deserializer=zeebe__grpc_dot_gateway__pb2.CreateWorkflowInstanceResponse.FromString,
                )
        self.CreateWorkflowInstanceWithResult = channel.unary_unary(
                '/gateway_protocol.Gateway/CreateWorkflowInstanceWithResult',
                request_serializer=zeebe__grpc_dot_gateway__pb2.CreateWorkflowInstanceWithResultRequest.SerializeToString,
                response_deserializer=zeebe__grpc_dot_gateway__pb2.CreateWorkflowInstanceWithResultResponse.FromString,
                )
        self.DeployWorkflow = channel.unary_unary(
                '/gateway_protocol.Gateway/DeployWorkflow',
                request_serializer=zeebe__grpc_dot_gateway__pb2.DeployWorkflowRequest.SerializeToString,
                response_deserializer=zeebe__grpc_dot_gateway__pb2.DeployWorkflowResponse.FromString,
                )
...
def add_GatewayServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'CancelWorkflowInstance': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=zeebe__grpc_dot_gateway__pb2.CancelWorkflowInstanceRequest.FromString,
                    response_serializer=zeebe__grpc_dot_gateway__pb2.CancelWorkflowInstanceResponse.SerializeToString,
            ),
            ...
            'CreateWorkflowInstance': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=zeebe__grpc_dot_gateway__pb2.CreateWorkflowInstanceRequest.FromString,
                    response_serializer=zeebe__grpc_dot_gateway__pb2.CreateWorkflowInstanceResponse.SerializeToString,
            ),
            'CreateWorkflowInstanceWithResult': grpc.unary_unary_rpc_method_handler(
                    servicer.CreateWorkflowInstanceWithResult,
                    request_deserializer=zeebe__grpc_dot_gateway__pb2.CreateWorkflowInstanceWithResultRequest.FromString,
                    response_serializer=zeebe__grpc_dot_gateway__pb2.CreateWorkflowInstanceWithResultResponse.SerializeToString,
            ),
            'DeployWorkflow': grpc.unary_unary_rpc_method_handler(
                    servicer.DeployWorkflow,
                    request_deserializer=zeebe__grpc_dot_gateway__pb2.DeployWorkflowRequest.FromString,
                    response_serializer=zeebe__grpc_dot_gateway__pb2.DeployWorkflowResponse.SerializeToString,
            ),
...
class Gateway(object):
    ...
    def CancelWorkflowInstance(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/gateway_protocol.Gateway/CancelWorkflowInstance',
            zeebe__grpc_dot_gateway__pb2.CancelWorkflowInstanceRequest.SerializeToString,
            zeebe__grpc_dot_gateway__pb2.CancelWorkflowInstanceResponse.FromString,
            options, channel_credentials,
            call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def CreateWorkflowInstance(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/gateway_protocol.Gateway/CreateWorkflowInstance',
            zeebe__grpc_dot_gateway__pb2.CreateWorkflowInstanceRequest.SerializeToString,
            zeebe__grpc_dot_gateway__pb2.CreateWorkflowInstanceResponse.FromString,
            options, channel_credentials,
            call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def CreateWorkflowInstanceWithResult(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/gateway_protocol.Gateway/CreateWorkflowInstanceWithResult',
            zeebe__grpc_dot_gateway__pb2.CreateWorkflowInstanceWithResultRequest.SerializeToString,
            zeebe__grpc_dot_gateway__pb2.CreateWorkflowInstanceWithResultResponse.FromString,
            options, channel_credentials,
            call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def DeployWorkflow(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/gateway_protocol.Gateway/DeployWorkflow',
            zeebe__grpc_dot_gateway__pb2.DeployWorkflowRequest.SerializeToString,
            zeebe__grpc_dot_gateway__pb2.DeployWorkflowResponse.FromString,
            options, channel_credentials,
            call_credentials, compression, wait_for_ready, timeout, metadata)
