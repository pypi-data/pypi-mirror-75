...
class LimitSetting(EcobeeObject):
   ...
   """
    ...
    attribute_name_map = {'type': 'type', 'limit': 'limit', 'enabled': 'enabled',
                          'remind_technician': 'remindTechnician', 'remindTechnician': 'remind_technician'}

    attribute_type_map = {'type': 'six.text_type', 'limit': 'int', 'enabled': 'bool', 'remind_technician': 'bool'}

    def __init__(self, type, limit=None, enabled=None, remind_technician=None):
        """
    ...
    def type(self):
        ...
        :return: The value of the type attribute of this LimitSetting instance.
        :rtype: six.text_type
        """
    ...
    def remind_technician(self):
        """
        Gets the remind_technician attribute of this LimitSetting instance.
