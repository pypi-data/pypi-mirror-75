...
class EquipmentSetting(EcobeeObject):
   ...
   """
    __slots__ = ['_type', '_filter_last_changed', '_filter_life', '_filter_life_units', '_remind_me_date', '_enabled',
                 '_remind_technician']

    attribute_name_map = {'type': 'type', 'filter_last_changed': 'filterLastChanged',
                          'filterLastChanged': 'filter_last_changed', 'filter_life': 'filterLife',
                          'filterLife': 'filter_life', 'filter_life_units': 'filterLifeUnits',
                          'filterLifeUnits': 'filter_life_units', 'remind_me_date': 'remindMeDate',
                          'remindMeDate': 'remind_me_date', 'enabled': 'enabled',
                          'remind_technician': 'remindTechnician', 'remindTechnician': 'remind_technician'}

    attribute_type_map = {'type': 'six.text_type', 'filter_last_changed': 'six.text_type', 'filter_life': 'int',
                          'filter_life_units': 'six.text_type', 'remind_me_date': 'six.text_type', 'enabled': 'bool',
                          'remind_technician': 'bool'}

    def __init__(self, type, filter_last_changed=None, filter_life=None, filter_life_units=None, remind_me_date=None,
                 enabled=None, remind_technician=None):
        """
    ...
    def type(self):
        ...
        :return: The value of the type attribute of this EquipmentSetting instance.
        :rtype: six.text_type
        """
    ...
    def filter_last_changed(self):
        """
        Gets the filter_last_changed attribute of this EquipmentSetting instance.
    ...
    def filter_life(self):
        """
        Gets the filter_life attribute of this EquipmentSetting instance.
    ...
    def filter_life_units(self):
        """
        Gets the filter_life_units attribute of this EquipmentSetting instance.
    ...
    def remind_me_date(self):
        """
        Gets the remind_me_date attribute of this EquipmentSetting instance.

        :return: The value of the remind_me_date attribute of this EquipmentSetting instance.
        :rtype: six.text_type
        """
    ...
    def remind_technician(self):
        """
        Gets the remind_technician attribute of this EquipmentSetting instance.
