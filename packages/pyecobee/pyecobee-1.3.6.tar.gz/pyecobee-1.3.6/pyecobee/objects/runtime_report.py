...
class RuntimeReport(EcobeeObject):
   ...
   """
    ...
    attribute_name_map = {'thermostat_identifier': 'thermostatIdentifier',
                          'thermostatIdentifier': 'thermostat_identifier', 'row_count': 'rowCount',
                          'rowCount': 'row_count', 'row_list': 'rowList', 'rowList': 'row_list'}

    attribute_type_map = {'thermostat_identifier': 'six.text_type', 'row_count': 'int',
    ...
    def thermostat_identifier(self):
        """
        Gets the thermostat_identifier attribute of this RuntimeReport instance.

        :return: The value of the thermostat_identifier attribute of this RuntimeReport instance.
        :rtype: six.text_type
        """
    ...
    def row_count(self):
        ...
        :return: The value of the row_count attribute of this RuntimeReport instance.
        :rtype: int
        """
    ...
    def row_list(self):
        ...
        :return: The value of the row_list attribute of this RuntimeReport instance.
