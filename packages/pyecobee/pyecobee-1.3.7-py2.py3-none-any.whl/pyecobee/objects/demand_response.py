...
class DemandResponse(EcobeeObject):
   ...
   """
    __slots__ = ['_name', '_demand_response_ref', '_comments', '_message', '_deferred_date', '_deferred_time',
                 '_show_idt', '_show_web', '_send_email', '_randomize_start_time', '_random_start_time_seconds',
                 '_randomize_end_time', '_random_end_time_seconds', '_event', '_thermostats', '_external_ref',
                 '_external_ref_type', '_priority']

    attribute_name_map = {'name': 'name', 'demand_response_ref': 'demandResponseRef',
                          'demandResponseRef': 'demand_response_ref', 'comments': 'comments', 'message': 'message',
                          'deferred_date': 'deferredDate', 'deferredDate': 'deferred_date',
                          'deferred_time': 'deferredTime', 'deferredTime': 'deferred_time', 'show_idt': 'showIdt',
                          'showIdt': 'show_idt', 'show_web': 'showWeb', 'showWeb': 'show_web',
                          'send_email': 'sendEmail', 'sendEmail': 'send_email',
                          'randomize_start_time': 'randomizeStartTime', 'randomizeStartTime': 'randomize_start_time',
                          'random_start_time_seconds': 'randomStartTimeSeconds',
                          'randomStartTimeSeconds': 'random_start_time_seconds',
                          'randomize_end_time': 'randomizeEndTime', 'randomizeEndTime': 'randomize_end_time',
                          'random_end_time_seconds': 'randomEndTimeSeconds',
                          'randomEndTimeSeconds': 'random_end_time_seconds', 'event': 'event',
                          'thermostats': 'thermostats', 'external_ref': 'externalRef', 'externalRef': 'external_ref',
                          'external_ref_type': 'externalRefType', 'externalRefType': 'external_ref_type',
                          'priority': 'priority'}

    attribute_type_map = {'name': 'six.text_type', 'demand_response_ref': 'six.text_type', 'comments': 'six.text_type',
                          'message': 'six.text_type', 'deferred_date': 'six.text_type',
                          'deferred_time': 'six.text_type', 'show_idt': 'bool', 'show_web': 'bool',
                          'send_email': 'bool', 'randomize_start_time': 'bool', 'random_start_time_seconds': 'int',
                          'randomize_end_time': 'bool', 'random_end_time_seconds': 'int', 'event': 'Event',
                          'thermostats': 'List[six.text_type]', 'external_ref': 'six.text_type',
                          'external_ref_type': 'six.text_type', 'priority': 'Long'}

    def __init__(self, name=None, demand_response_ref=None, comments=None, message=None, deferred_date=None,
                 deferred_time=None, show_idt=None, show_web=None, send_email=None, randomize_start_time=None,
                 random_start_time_seconds=None, randomize_end_time=None, random_end_time_seconds=None, event=None,
    ...
    def demand_response_ref(self):
        """
        Gets the demand_response_ref attribute of this DemandResponse instance.

        :return: The value of the demand_response_ref attribute of this DemandResponse instance.
        :rtype: six.text_type
        """
    ...
    def deferred_date(self):
        """
        Gets the deferred_date attribute of this DemandResponse instance.
    ...
    def deferred_time(self):
        """
        Gets the deferred_time attribute of this DemandResponse instance.
    ...
    def randomize_start_time(self):
        """
        Gets the randomize_start_time attribute of this DemandResponse instance.
    ...
    def random_start_time_seconds(self):
        """
        Gets the random_start_time_seconds attribute of this DemandResponse instance.
    ...
    def randomize_end_time(self):
        """
        Gets the randomize_end_time attribute of this DemandResponse instance.
    ...
    def random_end_time_seconds(self):
        """
        Gets the random_end_time_seconds attribute of this DemandResponse instance.
    ...
    def thermostats(self):
        ...
        :return: The value of the thermostats attribute of this DemandResponse instance.
    ...
    def external_ref_type(self):
        """
        Gets the external_ref_type attribute of this DemandResponse instance.
