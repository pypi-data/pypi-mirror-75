...
class NotificationSettings(EcobeeObject):
   ...
   """
    __slots__ = ['_email_addresses', '_email_notifications_enabled', '_equipment', '_general', '_limit']

    attribute_name_map = {'email_addresses': 'emailAddresses', 'emailAddresses': 'email_addresses',
                          'email_notifications_enabled': 'emailNotificationsEnabled',
                          'emailNotificationsEnabled': 'email_notifications_enabled', 'equipment': 'equipment',
                          'general': 'general', 'limit': 'limit'}

    attribute_type_map = {'email_addresses': 'List[six.text_type]', 'email_notifications_enabled': 'bool',
                          'equipment': 'List[EquipmentSetting]', 'general': 'List[GeneralSetting]',
                          'limit': 'List[LimitSetting]'}

    def __init__(self, email_addresses=None, email_notifications_enabled=None, equipment=None, general=None,
                 limit=None):
        """
    ...
    def email_addresses(self):
        """
        Gets the email_addresses attribute of this NotificationSettings instance.
    ...
    def email_notifications_enabled(self):
        """
        Gets the email_notifications_enabled attribute of this NotificationSettings instance.
    ...
    def equipment(self):
        """
        Gets the equipment attribute of this NotificationSettings instance.
    ...
    def general(self):
        """
        Gets the general attribute of this NotificationSettings instance.
