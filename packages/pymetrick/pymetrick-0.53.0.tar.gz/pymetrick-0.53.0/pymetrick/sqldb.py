...
class SQLdb(object):
    ...
    def __init__(self,*args, **kwargs):
        ...
        self.driver = kwargs.get('driver','mysql') 
        ...
        if self.driver == 'mysql':
            try:
                ...
                if 'mysql.connector' in self._sql_driver.__dict__['__name__']:
                    ...
                    self.config['collation'] = kwargs.get('collation',"utf8_spanish_ci")
...
if __name__ == "__main__":
    ...
    try:
        ...
        __db__ = SQLdb(host='mariadb',database='perezyrincon',username='root',password='headcracker_sql',driver='mysql',port='3306')
