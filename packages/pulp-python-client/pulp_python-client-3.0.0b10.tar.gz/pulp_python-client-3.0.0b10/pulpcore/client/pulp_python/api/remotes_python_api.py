...
class RemotesPythonApi(object):
    ...
    def create(self, data, **kwargs):  # noqa: E501
        ...
        :param PythonPythonRemote data: (required)
    ...
    def create_with_http_info(self, data, **kwargs):  # noqa: E501
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(PythonPythonRemote, status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        return self.api_client.call_api(
            ...
            response_type='PythonPythonRemote',  # noqa: E501
    ...
    def delete(self, python_remote_href, **kwargs):  # noqa: E501
        """Delete a python remote  # noqa: E501

        Trigger an asynchronous delete task  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.delete(python_remote_href, async_req=True)
        >>> result = thread.get()

        :param async_req bool: execute request asynchronously
        :param str python_remote_href: URI of Python Remote. e.g.: /pulp/api/v3/remotes/python/python/1/ (required)
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
        :param _request_timeout: timeout setting for this request. If one
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.delete_with_http_info(python_remote_href, **kwargs)  # noqa: E501

    def delete_with_http_info(self, python_remote_href, **kwargs):  # noqa: E501
        """Delete a python remote  # noqa: E501

        Trigger an asynchronous delete task  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.delete_with_http_info(python_remote_href, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('python_remote_href' not in local_var_params or  # noqa: E501
                                                        local_var_params['python_remote_href'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `python_remote_href` when calling `delete`")  # noqa: E501

        collection_formats = {}

        path_params = {}
        if 'python_remote_href' in local_var_params:
            path_params['python_remote_href'] = local_var_params['python_remote_href']  # noqa: E501
    ...
    def from_bandersnatch_with_http_info(self, config, name, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('name' in local_var_params and  # noqa: E501
            ...
            raise ApiValueError("Invalid value for parameter `name` when calling `from_bandersnatch`, length must be greater than or equal to `1`")  # noqa: E501
        collection_formats = {}
    ...
    def partial_update(self, python_remote_href, data, **kwargs):  # noqa: E501
        """Partially update a python remote  # noqa: E501

        Trigger an asynchronous partial update task  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.partial_update(python_remote_href, data, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.partial_update_with_http_info(python_remote_href, data, **kwargs)  # noqa: E501

    def partial_update_with_http_info(self, python_remote_href, data, **kwargs):  # noqa: E501
        """Partially update a python remote  # noqa: E501

        Trigger an asynchronous partial update task  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.partial_update_with_http_info(python_remote_href, data, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('python_remote_href' not in local_var_params or  # noqa: E501
                                                        local_var_params['python_remote_href'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `python_remote_href` when calling `partial_update`")  # noqa: E501
        # verify the required parameter 'data' is set
        if self.api_client.client_side_validation and ('data' not in local_var_params or  # noqa: E501
                                                        local_var_params['data'] is None):  # noqa: E501
    ...
    def read(self, python_remote_href, **kwargs):  # noqa: E501
        """Inspect a python remote  # noqa: E501

         Python Remotes are representations of an external repository of Python content, eg. PyPI.  Fields include upstream repository config. Python Remotes are also used to `sync` from upstream repositories, and contains sync settings.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.read(python_remote_href, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.read_with_http_info(python_remote_href, **kwargs)  # noqa: E501

    def read_with_http_info(self, python_remote_href, **kwargs):  # noqa: E501
        """Inspect a python remote  # noqa: E501

         Python Remotes are representations of an external repository of Python content, eg. PyPI.  Fields include upstream repository config. Python Remotes are also used to `sync` from upstream repositories, and contains sync settings.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.read_with_http_info(python_remote_href, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('python_remote_href' not in local_var_params or  # noqa: E501
                                                        local_var_params['python_remote_href'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `python_remote_href` when calling `read`")  # noqa: E501
    ...
    def update(self, python_remote_href, data, **kwargs):  # noqa: E501
        """Update a python remote  # noqa: E501

        Trigger an asynchronous update task  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update(python_remote_href, data, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.update_with_http_info(python_remote_href, data, **kwargs)  # noqa: E501

    def update_with_http_info(self, python_remote_href, data, **kwargs):  # noqa: E501
        """Update a python remote  # noqa: E501

        Trigger an asynchronous update task  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_with_http_info(python_remote_href, data, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('python_remote_href' not in local_var_params or  # noqa: E501
                                                        local_var_params['python_remote_href'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `python_remote_href` when calling `update`")  # noqa: E501
        # verify the required parameter 'data' is set
        if self.api_client.client_side_validation and ('data' not in local_var_params or  # noqa: E501
                                                        local_var_params['data'] is None):  # noqa: E501
