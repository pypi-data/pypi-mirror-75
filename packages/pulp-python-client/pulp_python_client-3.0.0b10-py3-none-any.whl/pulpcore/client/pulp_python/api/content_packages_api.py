...
class ContentPackagesApi(object):
    ...
    def create(self, relative_path, **kwargs):  # noqa: E501
        ...
        :param str requires_dist: A JSON list containing names of some other distutils project required by this distribution.
        :param str provides_dist: A JSON list containing names of a Distutils project which is contained within this distribution.
        :param str obsoletes_dist: A JSON list containing names of a distutils project's distribution which this distribution renders obsolete, meaning that the two projects should not be installed at the same time.
        :param str requires_external: A JSON list containing some dependency in the system that the distribution is to be used.
        :param str classifiers: A JSON list containing classification values for a Python package.
    ...
    def list(self, **kwargs):  # noqa: E501
        ...
        :param str author__in: Filter results where author is in a comma-separated list of values
        :param str packagetype: Filter results where packagetype matches value
        :param str packagetype__in: Filter results where packagetype is in a comma-separated list of values
        :param str filename: Filter results where filename matches value
        :param str filename__in: Filter results where filename is in a comma-separated list of values
        :param str filename__contains: Filter results where filename contains value
        :param str keywords__in: Filter results where keywords is in a comma-separated list of values
    ...
    def read(self, python_package_content_href, **kwargs):  # noqa: E501
        """Inspect a python package content  # noqa: E501

         PythonPackageContent represents each individually installable Python package. In the Python ecosystem, this is called a Python Distribution, sometimes (ambiguously) refered to as a package. In Pulp Python, we refer to it as PythonPackageContent. Each PythonPackageContent corresponds to a single filename, for example `pulpcore-3.0.0rc1-py3-none-any.whl` or `pulpcore-3.0.0rc1.tar.gz`.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.read(python_package_content_href, async_req=True)
        >>> result = thread.get()

        :param async_req bool: execute request asynchronously
        :param str python_package_content_href: URI of Python Package Content. e.g.: /pulp/api/v3/content/python/packages/1/ (required)
        :param str fields: A list of fields to include in the response.
        :param str exclude_fields: A list of fields to exclude from the response.
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.read_with_http_info(python_package_content_href, **kwargs)  # noqa: E501

    def read_with_http_info(self, python_package_content_href, **kwargs):  # noqa: E501
        """Inspect a python package content  # noqa: E501

         PythonPackageContent represents each individually installable Python package. In the Python ecosystem, this is called a Python Distribution, sometimes (ambiguously) refered to as a package. In Pulp Python, we refer to it as PythonPackageContent. Each PythonPackageContent corresponds to a single filename, for example `pulpcore-3.0.0rc1-py3-none-any.whl` or `pulpcore-3.0.0rc1.tar.gz`.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.read_with_http_info(python_package_content_href, async_req=True)
        >>> result = thread.get()
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(PythonPythonPackageContent, status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        if self.api_client.client_side_validation and ('python_package_content_href' not in local_var_params or  # noqa: E501
                                                        local_var_params['python_package_content_href'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `python_package_content_href` when calling `read`")  # noqa: E501

        collection_formats = {}

        path_params = {}
        if 'python_package_content_href' in local_var_params:
            path_params['python_package_content_href'] = local_var_params['python_package_content_href']  # noqa: E501
        ...
        return self.api_client.call_api(
            '{python_package_content_href}', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
            post_params=form_params,
            files=local_var_files,
            response_type='PythonPythonPackageContent',  # noqa: E501
            auth_settings=auth_settings,
            async_req=local_var_params.get('async_req'),
            _return_http_data_only=local_var_params.get('_return_http_data_only'),  # noqa: E501
            _preload_content=local_var_params.get('_preload_content', True),
