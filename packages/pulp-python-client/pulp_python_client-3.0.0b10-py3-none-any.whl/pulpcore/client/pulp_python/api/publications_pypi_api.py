...
class PublicationsPypiApi(object):
    ...
    def create(self, data, **kwargs):  # noqa: E501
        ...
        Trigger an asynchronous task to publish python content.  # noqa: E501
        ...
        :param PythonPythonPublication data: (required)
    ...
    def delete(self, python_publication_href, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.delete(python_publication_href, async_req=True)
        >>> result = thread.get()

        :param async_req bool: execute request asynchronously
        :param str python_publication_href: URI of Python Publication. e.g.: /pulp/api/v3/publications/python/pypi/1/ (required)
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
        :param _request_timeout: timeout setting for this request. If one
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.delete_with_http_info(python_publication_href, **kwargs)  # noqa: E501

    def delete_with_http_info(self, python_publication_href, **kwargs):  # noqa: E501
        """Delete a python publication  # noqa: E501

         Python Publications refer to the Python Package content in a repository version, and include metadata about that content.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.delete_with_http_info(python_publication_href, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('python_publication_href' not in local_var_params or  # noqa: E501
                                                        local_var_params['python_publication_href'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `python_publication_href` when calling `delete`")  # noqa: E501

        collection_formats = {}

        path_params = {}
        if 'python_publication_href' in local_var_params:
            path_params['python_publication_href'] = local_var_params['python_publication_href']  # noqa: E501
        ...
        return self.api_client.call_api(
            '{python_publication_href}', 'DELETE',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def read(self, python_publication_href, **kwargs):  # noqa: E501
        """Inspect a python publication  # noqa: E501

         Python Publications refer to the Python Package content in a repository version, and include metadata about that content.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.read(python_publication_href, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.read_with_http_info(python_publication_href, **kwargs)  # noqa: E501

    def read_with_http_info(self, python_publication_href, **kwargs):  # noqa: E501
        """Inspect a python publication  # noqa: E501

         Python Publications refer to the Python Package content in a repository version, and include metadata about that content.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.read_with_http_info(python_publication_href, async_req=True)
        >>> result = thread.get()
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(PythonPythonPublication, status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        if self.api_client.client_side_validation and ('python_publication_href' not in local_var_params or  # noqa: E501
                                                        local_var_params['python_publication_href'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `python_publication_href` when calling `read`")  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='PythonPythonPublication',  # noqa: E501
            auth_settings=auth_settings,
            async_req=local_var_params.get('async_req'),
            _return_http_data_only=local_var_params.get('_return_http_data_only'),  # noqa: E501
            _preload_content=local_var_params.get('_preload_content', True),
