...
def resize_bbox_based_img_size(bbox: [int, int, int, int], 
                                img_shape: (int, int)) -> [int, int, int, int]: 
    """[summary]
    ...
    """                                
    x = int((bbox[0]/416)*img_shape[1])
    y = int((bbox[1]/416)*img_shape[0])
    w = int((bbox[2]/416)*img_shape[1])
    h = int((bbox[3]/416)*img_shape[0])
