...
from py_bert.bert_classification_model import PYBERTClassifier, PYBertForSequenceClassification
...
algorithm='non_transformers' #transformers or non_transformers
#saved_training_model = 'best_model_state.bin'
#BERT authors suggests epoch from 2 to 4
num_epochs = 2
trainer = PYBERTTrainer()
trainer.train(model, device, train_data_loader, val_data_loader,
              df_val, df_train, tokenizer, num_epochs=num_epochs, algorithm=algorithm)
